/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from zcompact.cu normal z -> d, Sun May  3 11:22:58 2015
       @author Stan Tomov
*/
...
/**
    ...
    @param[in][out]
    cBlock      magma_minproductInt_ptr
...
magma_minproduct_dcompact(
    ...
    magma_minproductDouble_ptr dnorms, 
    double tol, 
    magma_minproductInt_ptr active,
    magma_minproductInt_ptr cBlock,
    magma_minproduct_queue_t queue )
{
    ...
    dim3 threads( NB );
    dim3 grid( magma_minproduct_ceildiv( m, NB ) );
    
    dcompact_kernel<<< grid, threads, 0, queue >>>(
            m, n, dA, ldda, dnorms, tol, active, active+n );

    magma_minproduct_igetvector( 1, active+n, 1, cBlock, 1 );
    return info;
}
    ...
    magma_minproduct_queue_t queue )
{
    ...
    dcompactactive_kernel<<< grid, threads, 0, queue >>>(
            m, n, dA, ldda, active);
    return info;
}
