...
__global__ void
clascl_full(int m, int n, float mul, magma_tally2FloatComplex* A, int lda)
{
...
__global__ void
clascl_lower(int m, int n, float mul, magma_tally2FloatComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
__global__ void
clascl_upper(int m, int n, float mul, magma_tally2FloatComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
magma_tally2blas_clascl(
    ...
    magma_tally2_int_t *info )
{
    magma_tally2blas_clascl_q( type, kl, ku, cfrom, cto, m, n, dA, ldda, magma_tally2_stream, info );
}
