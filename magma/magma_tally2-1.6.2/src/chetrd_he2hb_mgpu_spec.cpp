    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally2FloatComplex *dspace[Magma_tally2MaxGPUs];
    magma_tally2FloatComplex *dwork[Magma_tally2MaxGPUs], *dworkbis[Magma_tally2MaxGPUs];
    magma_tally2FloatComplex *dvall[Magma_tally2MaxGPUs], *dv[Magma_tally2MaxGPUs], *dw[Magma_tally2MaxGPUs];
    magma_tally2FloatComplex *workngpu[Magma_tally2MaxGPUs+1];
    ...
    for( magma_tally2_int_t dev = 0; dev < ngpu; ++dev ) {
        ...
        magma_tally2_cmalloc( &dspace[dev], devworksiz );
        magma_tally2_cmalloc_pinned ( &workngpu[dev], worksiz);
    ...
    magma_tally2_cmalloc_pinned ( &workngpu[ngpu], worksiz);
    magma_tally2FloatComplex *worktest = NULL;
    //magma_tally2_cmalloc_cpu( &worktest, n*nb ); // not used
    // ======================
