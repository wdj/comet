...
magma_tally4_zgeqrf3(magma_tally4_context *cntxt, magma_tally4_int_t m, magma_tally4_int_t n, 
...
/*  -- MAGMA_tally4 (version 1.6.1) --
    ...
    int k, ib;
    magma_tally4_qr_params *qr_params = (magma_tally4_qr_params *)cntxt->params;
    ...
    *info = 0;
    ...
    /* Use MAGMA_tally4 code to factor left portion of matrix, waking up threads 
       along the way to perform updates on the right portion of matrix */
    magma_tally4_zgeqrf2(cntxt, m, n - qr_params->nthreads * qr_params->ob, 
    ...
    /* Flag MAGMA_tally4 code to internally unzero upper part of each panel */
    qr_params->flag = 1;
    
    /* Use MAGMA_tally4 code to perform final factorization if necessary */
    if (qr_params->m > (qr_params->n - (qr_params->nthreads*qr_params->ob)))
      ...
      magma_tally4_zgeqrf2(cntxt, M, N,
