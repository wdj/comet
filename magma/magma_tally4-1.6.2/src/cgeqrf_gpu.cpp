...
*/
void csplit_diag_block(magma_tally4_int_t ib, magma_tally4FloatComplex *a, magma_tally4_int_t lda, magma_tally4FloatComplex *work)
{
    ...
    lapackf77_ctrtri( Magma_tally4UpperStr, Magma_tally4NonUnitStr, &ib, work, &ib, &info);
}
