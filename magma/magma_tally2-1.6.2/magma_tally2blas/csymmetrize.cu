...
*/
__global__ void
csymmetrize_lower( int m, magma_tally2FloatComplex *dA, int ldda )
{
...
__global__ void
csymmetrize_upper( int m, magma_tally2FloatComplex *dA, int ldda )
{
    // dA iterates across row i and dAT iterates down column i.
    int i = blockIdx.x*NB + threadIdx.x;
    magma_tally2FloatComplex *dAT = dA;
...
/**
    @see magma_tally2blas_csymmetrize_q
    @ingroup magma_tally2_caux2
    ********************************************************************/
extern "C" void
magma_tally2blas_csymmetrize(
    ...
    magma_tally2FloatComplex_ptr dA, magma_tally2_int_t ldda )
{
    magma_tally2blas_csymmetrize_q( uplo, m, dA, ldda, magma_tally2_stream );
}
