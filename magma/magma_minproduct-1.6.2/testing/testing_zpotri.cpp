    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* ====================================================================
               ...
               =================================================================== */
            if ( opts.warmup ) {
                magma_minproduct_zpotrf( opts.uplo, N, h_R, lda, &info );
                magma_minproduct_zpotri( opts.uplo, N, h_R, lda, &info );
                lapackf77_zlacpy( Magma_minproductUpperLowerStr, &N, &N, h_A, &lda, h_R, &lda );
            }
            ...
            //h_R[ 10 + 10*lda ] = MAGMA_minproduct_Z_MAKE( 0.0, 0.0 );
            ...
            if (info != 0)
                printf("magma_minproduct_zpotri returned error %d: %s.\n",
