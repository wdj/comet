...
static int gm_metrics_3way_section_axis(GMMetrics* metrics,
  ...
  GMAssert(j_proc >= 0);
  GMAssert(k_proc >= 0);
  GMAssert(i_proc < Env_num_proc(env));
  GMAssert(j_proc < Env_num_proc(env));
  GMAssert(k_proc < Env_num_proc(env));
...
static size_t GMMetrics_index_from_coord_all2all_2(GMMetrics* metrics,
  ...
  GMAssert(j_proc >= 0);
  GMAssert(j_proc < Env_num_proc(env));
  GMAssert(i < j || j_proc != Env_proc_num(env));
  ...
  size_t index = j_proc == i_proc
               ...
               : metrics->num_elts_0 +
                 ...
                 (j_proc - i_proc - 1 + 2*Env_num_proc(env)) %
                                          Env_num_proc(env) ));
