subs = {
  ...
  'mixed' : [
    ...
    ('pzgelqf','pdgelqf'),
    ('pzunmlq','pdormlq'),
    ('MAGMA_tally4_ZC','MAGMA_tally4_DS'),
    ('MAGMA_tally4BLAS_ZC','MAGMA_tally4BLAS_DS'),
    ('magma_tally4_z','magma_tally4_d'),
    ('magma_tally4_czgetrs','magma_tally4_sdgetrs'),
    ('magma_tally4_c','magma_tally4_s'),
    ('magma_tally4blas_z','magma_tally4blas_d'),
    ('magma_tally4blas_c','magma_tally4blas_s'),
    ('cublasZ','cublasD'),
    ('cublasC','cublasS'),
    ('MAGMA_tally4_Z','MAGMA_tally4_D'),
    ('MAGMA_tally4_C','MAGMA_tally4_S'),
    ...
    ('cuCabsf','absf'),
    ('zcaxpy','dsaxpy'),
    ('magma_tally4_get_c','magma_tally4_get_s'),
    ('magma_tally4_get_z','magma_tally4_get_d'),
  ...
  'normal' : [ ## Dictionary is keyed on substitution type
    ...
    ('magma_tally4_ssqrt','magma_tally4_dsqrt', 'magma_tally4_ssqrt','magma_tally4_dsqrt'),
    ('cpu_gpu_s','cpu_gpu_d','cpu_gpu_c','cpu_gpu_z'),
    ('spanel_to_q_tally4','dpanel_to_q_tally4','cpanel_to_q_tally4','zpanel_to_q_tally4'),
    ('sq_to_panel_tally4','dq_to_panel_tally4','cq_to_panel_tally4','zq_to_panel_tally4'),
    ...
    ('Magma_tally4Trans','Magma_tally4Trans','Magma_tally4ConjTrans','Magma_tally4ConjTrans'),
    ...
    ('MAGMA_tally4_S','MAGMA_tally4_D','MAGMA_tally4_C','MAGMA_tally4_Z'),
    ('MAGMA_tally4BLAS_S','MAGMA_tally4BLAS_D','MAGMA_tally4BLAS_C','MAGMA_tally4BLAS_Z'),
    ('magma_tally4_s','magma_tally4_d','magma_tally4_c','magma_tally4_z'),
    ('magma_tally4blas_s','magma_tally4blas_d','magma_tally4blas_c','magma_tally4blas_z'),
    ('magma_tally4_get_s','magma_tally4_get_d','magma_tally4_get_c','magma_tally4_get_z'),
    ('magma_tally4f_s','magma_tally4f_d','magma_tally4f_c','magma_tally4f_z'),
    ('ger','ger','gerc','gerc'),
    ('ger','ger','geru','geru'),
