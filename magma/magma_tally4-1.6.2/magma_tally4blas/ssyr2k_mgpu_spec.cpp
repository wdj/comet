...
/**
    ...
    ********************************************************************/
extern "C"
void magma_tally4blas_ssyr2k_mgpu_spec(
    ...
    magma_tally4_int_t ngpu, magma_tally4_int_t nb, magma_tally4_queue_t queues[][20], magma_tally4_int_t nqueue )
{
    ...
    float cbeta = MAGMA_tally4_S_MAKE( beta, 0. );
    ...
    for( magma_tally4_int_t i = 0; i < n; i += ib ) {
        ...
        magma_tally4_sgemm( Magma_tally4NoTrans, Magma_tally4Trans, n, ib, k,
    ...
    alpha = MAGMA_tally4_S_CNJG( alpha );
