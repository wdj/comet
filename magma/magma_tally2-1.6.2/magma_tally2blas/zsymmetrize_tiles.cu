...
*/
__global__ void
zsymmetrize_tiles_lower( int m, magma_tally2DoubleComplex *dA, int ldda, int mstride, int nstride )
{
    ...
    magma_tally2DoubleComplex *dAT = dA;
    if ( i < m ) {
        dA  += i;
        dAT += i*ldda;
        magma_tally2DoubleComplex *dAend = dA + i*ldda;
        while( dA < dAend ) {
...
__global__ void
zsymmetrize_tiles_upper( int m, magma_tally2DoubleComplex *dA, int ldda, int mstride, int nstride )
{
    // shift dA to tile's top-left corner
    dA += blockIdx.x*(mstride + nstride*ldda);
...
/**
    @see magma_tally2blas_zsymmetrize_tiles_q
    @ingroup magma_tally2_zaux2
    ********************************************************************/
extern "C" void
magma_tally2blas_zsymmetrize_tiles(
    ...
    magma_tally2_int_t ntile, magma_tally2_int_t mstride, magma_tally2_int_t nstride )
{
    magma_tally2blas_zsymmetrize_tiles_q( uplo, m, dA, ldda, ntile, mstride, nstride, magma_tally2_stream );
}
