...
#define dL2(j)  (dL2 + (j)*ib*lddl         )
    ...
    magma_tally2DoubleComplex_ptr dAT;
#ifndef WITHOUTTRTRI
    ...
    *info = 0;
    ...
    if ( ib >= mindim ) {
        ...
        magma_tally2_zsetmatrix( mindim, mindim, hL2, ldhl, dL2, lddl );
#endif
        ...
        for( i=0; i < s; i++ ) {
            ...
            if ( i > 0 ) {
                // download i-th panel
                magma_tally2blas_ztranspose( sb, m, AT(0,i), ldda, dwork, maxm );
                magma_tally2_zgetmatrix( m, sb, dwork, maxm, hA(0, i), ldha );
            ...
            magma_tally2blas_zlaswp( n-ii, AT(0, i), ldda, ii+1, ii+sb, ipiv, 1 );
            ...
            magma_tally2_zsetmatrix( sb, sb, hL2(i), ldhl, dL2(i), lddl );
#endif
            // upload i-th panel
            magma_tally2_zsetmatrix( rows, sb, hA(i, i), ldha, dwork, cols );
            magma_tally2blas_ztranspose( rows, sb, dwork, cols, AT(i,i), ldda );
