...
/**
    ...
    as returned by SGELQF. Q is of order M if SIDE = Magma_tally4Left and of order N
    ...
    @ingroup magma_tally4_sgelqf_comp
    ********************************************************************/
    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (*info == 0) {
        nb = magma_tally4_get_sgelqf_nb( min( m, n ));
        lwkopt = max(1,nw)*nb;
    ...
    if (nb >= k) {
        /* Use CPU code */
        lapackf77_sormlq( lapack_side_const_tally4(side), lapack_trans_const_tally4(trans),
        ...
        magma_tally4Float_ptr dwork, dV, dT, dC;
        magma_tally4_smalloc( &dwork, (nw + nq + nb)*nb + lddc*n );
        if ( dwork == NULL ) {
        ...
        magma_tally4_smalloc_cpu( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_tally4_ssetmatrix( m, n, C, ldc, dC(0,0), lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            spanel_to_q_tally4( Magma_tally4Lower, ib, A(i,i), lda, T2 );
            magma_tally4_ssetmatrix( ib, nq_i,  A(i,i), lda, dV(0,0), ib );
            sq_to_panel_tally4( Magma_tally4Lower, ib, A(i,i), lda, T2 );
            ...
            magma_tally4_ssetmatrix( ib, ib, T, ib, dT(0,0), ib );
            magma_tally4_slarfb_gpu( side, transt, Magma_tally4Forward, Magma_tally4Rowwise,
                              mi, ni, ib,
                              dV(0,0), ib,
                              dT(0,0), ib,
                              dC(ic,jc), lddc,
        ...
        magma_tally4_sgetmatrix( m, n, dC(0,0), lddc, C, ldc );
