    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    timer_start( time );
    magma_tally3_dsyevdx_gpu( jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, mout, w, A, lda,
    ...
    if (wantz && *info == 0) {
        ...
        if (dB == NULL) {
            if (MAGMA_tally3_SUCCESS != magma_tally3_dmalloc( &dB, n*lddb ) ) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally3_dtrsm( Magma_tally3Left, uplo, trans, Magma_tally3NonUnit,
        ...
        magma_tally3_dgetmatrix( n, *mout, dA, ldda, A, lda );
