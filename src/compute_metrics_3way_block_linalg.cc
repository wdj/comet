...
//        const int is_I1_in_range = I1 >= I_min && I1 < I_max;
        ...
        if (is_I_in_range) {
          ...
          MF::decode(r000, r001, numer.data[0]);
          MF::decode(r010, r011, numer.data[1]);
          MF::decode(r100, r101, numer.data[2]);
          MF::decode(r110, r111, numer.data[3]);
          ...
          MF::decode(matB00_permuted, matB01_permuted,
                              matB_permuted.data[0]);
          MF::decode(matB10_permuted, matB11_permuted,
...
//printf("        %i %i %i    %i %i %i %i %i %i %i %i\n", I, J, K, r000, r001, r010, r011, r100, r101, r110, r111);
          ...
          MF::encode(numer.data[0], r000, r001);
          MF::encode(numer.data[1], r010, r011);
          MF::encode(numer.data[2], r100, r101);
          MF::encode(numer.data[3], r110, r111);
