...
void clacpy_full_device(
    int m, int n,
    const magma_minproductFloatComplex *dA, int ldda,
    magma_minproductFloatComplex       *dB, int lddb )
{
...
void clacpy_full_kernel_batched(
    int m, int n,
    magma_minproductFloatComplex const * const *dAarray, int ldda,
...
/**
    @see magma_minproductblas_clacpy_q
    @ingroup magma_minproduct_caux2
    ********************************************************************/
extern "C" void
magma_minproductblas_clacpy(
    ...
    magma_minproductFloatComplex_ptr       dB, magma_minproduct_int_t lddb )
{
    magma_minproductblas_clacpy_q( uplo, m, n, dA, ldda, dB, lddb, magma_minproduct_stream );
}
