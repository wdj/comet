...
int main( int argc, char** argv)
{
    ...
    magma_tally4DoubleComplex *h_A, *h_A2, *h_B, *h_X, *h_R, *tau, *h_work, tmp[1];
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            lhwork2 = (magma_tally4_int_t) MAGMA_tally4_Z_REAL( tmp[0] );
            
            lhwork = -1;
            lapackf77_zunmqr( Magma_tally4LeftStr, Magma_tally4_ConjTransStr,
            ...
            magma_tally4_zgels3_gpu( Magma_tally4NoTrans, M, N, nrhs, d_A, ldda,
                              d_B, lddb, h_work, lworkgpu, &info);
            gpu_time = magma_tally4_wtime() - gpu_time;
            gpu_perf = gflops / gpu_time;
            if (info != 0)
                printf("magma_tally4_zgels3_gpu returned error %d: %s.\n",
