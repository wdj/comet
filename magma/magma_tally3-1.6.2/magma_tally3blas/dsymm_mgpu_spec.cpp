...
extern "C"
void magma_tally3blas_dsymm_mgpu_spec(
    ...
    double *work[],     magma_tally3_int_t worksiz,  // TODO unused
    ...
    magma_tally3_int_t gnode[Magma_tally3MaxGPUs][Magma_tally3MaxGPUs+2], magma_tally3_int_t nbcmplx )
{
    ...
    if(ngpu ==1){
        ...
        magma_tally3_dgemm( Magma_tally3ConjTrans, Magma_tally3NoTrans, m, n, m,
    ...
    for( magma_tally3_int_t cmplxid = 0; cmplxid < nbcmplx; ++cmplxid ) {
        ...
        for( magma_tally3_int_t idev = 0; idev < myngpu; ++idev ) {
            ...
            if(mycolsize>0){
                ...
                magma_tally3_dgemm( Magma_tally3ConjTrans, Magma_tally3NoTrans, mycolsize, n, m,
                ...
                for( magma_tally3_int_t k = 0; k < nbcmplx; ++k ) {
                    if(k!=cmplxid){
                        ...
                        if(gmaster!=-1){ //real is active
                            ...
                            magma_tally3_dcopymatrix_async(
                                mycolsize, n,
            ...
            if(mycolsize>0){ // I am an active GPU
                ...
                if(gcolsize>0){
                    ...
                    for( magma_tally3_int_t blki = 0; blki < gblk; ++blki){
                        ...
                        magma_tally3blas_dlacpy( Magma_tally3Full, ib, n, &dwork[dev][maxgsize*gdev+lcblki], gcolsize, &dC[dev][gbblki], lddc);
                    }// end blki
                }
