    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    hwork[0] = MAGMA_tally3_S_MAKE( lwkopt, 0 );
    ...
    if ( step < 0 ) {
        ...
        magma_tally3_sgetmatrix( ma, ib, dA(i,  i ), ldda, hA, ma );
        magma_tally3_sgetmatrix( mi, ni, dC(ic, jc), lddc, hC, mi );
        ...
        magma_tally3_ssetmatrix( mi, ni, hC, mi, dC(ic, jc), lddc );
    }
    ...
    // TODO sync. For cases Q*C and C*Q^T, last call is magma_tally3_slarfb_gpu,
    // which is async magma_tally3_gemm calls, so sormqr can be unfinished.
