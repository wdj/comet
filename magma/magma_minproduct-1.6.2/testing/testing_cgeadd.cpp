...
int main( int argc, char** argv)
{
    ...
    float          error, work[1];
    magma_minproductFloatComplex *h_A, *h_B, *d_A, *d_B;
    magma_minproductFloatComplex alpha = MAGMA_minproduct_C_MAKE( 3.1415, 2.718 );
    ...
    //magma_minproductblas_cgeadd( -1,  N, alpha, d_A, ldda, d_B, ldda );
    //magma_minproductblas_cgeadd(  M, -1, alpha, d_A, ldda, d_B, ldda );
    //magma_minproductblas_cgeadd(  M,  N, alpha, d_A, M-1,  d_B, ldda );
    //magma_minproductblas_cgeadd(  M,  N, alpha, d_A, ldda, d_B, N-1  );
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_minproductblas_cgeadd( M, N, alpha, d_A, ldda, d_B, ldda );
