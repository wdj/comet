...
///////////////////////////////////////////////////////////////////////////////////////
__global__ void kernel_set_pointer(magma_minproductDoubleComplex **output_array,
...
extern "C"
void zset_pointer(magma_minproductDoubleComplex **output_array,
                 magma_minproductDoubleComplex *input,
                 magma_minproduct_int_t lda,
                 magma_minproduct_int_t row, magma_minproduct_int_t column, 
                 magma_minproduct_int_t batchSize,
...
__global__ void zdisplace_pointers_kernel(magma_minproductDoubleComplex **output_array,
               magma_minproductDoubleComplex **input_array, magma_minproduct_int_t lda,
               magma_minproduct_int_t row, magma_minproduct_int_t column)
{
      magma_minproductDoubleComplex *inpt = input_array[blockIdx.x];
      output_array[blockIdx.x] = &inpt[row + column * lda];
}


extern "C"
void zset_array(magma_minproductDoubleComplex **output_array,
               magma_minproductDoubleComplex **input_array, magma_minproduct_int_t lda,
               magma_minproduct_int_t row, magma_minproduct_int_t column, 
...
extern "C"
void magma_minproduct_zdisplace_pointers(magma_minproductDoubleComplex **output_array,
               magma_minproductDoubleComplex **input_array, magma_minproduct_int_t lda,
               magma_minproduct_int_t row, magma_minproduct_int_t column, 
               magma_minproduct_int_t batchCount, magma_minproduct_queue_t queue)
