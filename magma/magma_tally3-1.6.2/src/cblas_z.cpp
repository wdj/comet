/*
    ...
    Primarily, we use the standard Fortran BLAS interface in MAGMA_tally3. However,
    ...
    magma_tally3_cblas_dzasum / dasum
    magma_tally3_cblas_dznrm2 / dnrm2
    magma_tally3_cblas_zdotc  / ddot
    magma_tally3_cblas_zdotu  / ddot
    ...
    const magma_tally3DoubleComplex *y, magma_tally3_int_t incy )
{
    ...
    magma_tally3DoubleComplex value = MAGMA_tally3_Z_ZERO;
    ...
    return value;
    //#ifdef COMPLEX
    //magma_tally3DoubleComplex value;
