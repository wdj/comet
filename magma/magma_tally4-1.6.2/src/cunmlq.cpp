...
/**
    ...
    as returned by CGELQF. Q is of order M if SIDE = Magma_tally4Left and of order N
    ...
    @ingroup magma_tally4_cgelqf_comp
    ********************************************************************/
    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb >= k) {
        /* Use CPU code */
        lapackf77_cunmlq( lapack_side_const_tally4(side), lapack_trans_const_tally4(trans),
        ...
        magma_tally4FloatComplex_ptr dwork, dV, dT, dC;
        ...
        magma_tally4_cmalloc_cpu( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_tally4_csetmatrix( m, n, C, ldc, dC(0,0), lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            cpanel_to_q_tally4( Magma_tally4Lower, ib, A(i,i), lda, T2 );
            magma_tally4_csetmatrix( ib, nq_i,  A(i,i), lda, dV(0,0), ib );
            cq_to_panel_tally4( Magma_tally4Lower, ib, A(i,i), lda, T2 );
            ...
            magma_tally4_csetmatrix( ib, ib, T, ib, dT(0,0), ib );
            magma_tally4_clarfb_gpu( side, transt, Magma_tally4Forward, Magma_tally4Rowwise,
                              mi, ni, ib,
                              dV(0,0), ib,
                              dT(0,0), ib,
                              dC(ic,jc), lddc,
        ...
        magma_tally4_cgetmatrix( m, n, dC(0,0), lddc, C, ldc );
