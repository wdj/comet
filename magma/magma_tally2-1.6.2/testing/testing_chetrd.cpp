/*
    -- MAGMA_tally2 (version 1.6.1) --
       ...
       @generated from testing_zhetrd.cpp normal z -> c, Fri Jan 30 19:00:25 2015
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally2_chetrd( opts.uplo, N, h_R, lda, diag, offdiag,
                          tau, h_work, lwork, &info );
            gpu_time = magma_tally2_wtime() - gpu_time;
            gpu_perf = gflops / gpu_time;
            if (info != 0)
                printf("magma_tally2_chetrd returned error %d: %s.\n",
            ...
            if ( opts.check ) {
                ...
                lapackf77_clacpy( lapack_uplo_const_tally2(opts.uplo), &N, &N, h_R, &lda, h_Q, &lda );
