...
#define dB(i, j) (dw + n*ldda + (j)*lddb + (i))
    ...
    *info = 0;
    ...
    if (MAGMA_tally4_SUCCESS != magma_tally4_smalloc( &dw, 2*n*n )) {
    ...
    magma_tally4_ssetmatrix( n, n, B(0, 0), ldb, dB(0, 0), lddb );
    ...
    magma_tally4_sgetmatrix( n, n, dA(0, 0), ldda, A(0, 0), lda );
