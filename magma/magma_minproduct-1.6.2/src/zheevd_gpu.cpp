    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_minproduct_zstedx( Magma_minproductRangeAll, n, 0., 0., 0, 0, w, &rwork[inde],
        ...
        magma_minproduct_zsetmatrix( n, n, &work[indwrk], n, dC, lddc );

        magma_minproduct_zunmtr_gpu( Magma_minproductLeft, uplo, Magma_minproductNoTrans, n, n, dA, ldda, &work[indtau],
                          dC, lddc, wA, ldwa, &iinfo );

        magma_minproduct_zcopymatrix( n, n, dC, lddc, dA, ldda );
