...
magma_tally3_cheevr_gpu(
    ...
    float *w,
    magma_tally3FloatComplex_ptr dZ, magma_tally3_int_t lddz, magma_tally3_int_t *isuppz,
    ...
    magma_tally3_int_t *info)
{
    ...
    magma_tally3_int_t indrd, indre;
    magma_tally3_int_t imax;
    magma_tally3_int_t lopt, itmp1, indree, indrdd;
    magma_tally3_int_t lower, wantz, tryrac;
    magma_tally3_int_t i, j, jj, i__1;
    magma_tally3_int_t alleig, valeig, indeig;
    magma_tally3_int_t iscale, indibl, indifl;
    magma_tally3_int_t indiwo, indisp, indtau;
    magma_tally3_int_t indrwk, indwk;
    magma_tally3_int_t llwork, llrwork, nsplit;
    magma_tally3_int_t lquery, ieeeok;
    ...
    *info = 0;
    ...
    work[0] = MAGMA_tally3_C_MAKE( lwmin, 0 );
    rwork[0] = lrwmin;
    iwork[0] = liwmin;
    ...
    *m = 0;
    ...
    if (MAGMA_tally3_SUCCESS != magma_tally3_smalloc( &dwork, n )) {
        fprintf (stderr, "!!!! device memory allocation error (magma_tally3_cheevr_gpu)\n");
...
#ifdef FAST_HEMV
    magma_tally3_chetrd2_gpu(uplo, n, dA, ldda, &rwork[indrd], &rwork[indre],
                      &work[indtau], wA, ldwa, &work[indwk], llwork, dZ, lddz*n, &iinfo);
#else
    magma_tally3_chetrd_gpu (uplo, n, dA, ldda, &rwork[indrd], &rwork[indre],
                      &work[indtau], wA, ldwa, &work[indwk], llwork, &iinfo);
#endif

    lopt = n + (magma_tally3_int_t)MAGMA_tally3_C_REAL(work[indwk]);
