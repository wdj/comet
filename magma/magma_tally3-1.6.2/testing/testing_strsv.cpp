...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            cublasStrsv( opts.handle, cublas_uplo_const_tally3(opts.uplo),
            ...
            if ( opts.lapack ) {
                ...
                blasf77_strsv( lapack_uplo_const_tally3(opts.uplo), lapack_trans_const_tally3(opts.transA), lapack_diag_const_tally3(opts.diag),
                               &N,
                               h_A, &lda,
                               h_x, &ione );
