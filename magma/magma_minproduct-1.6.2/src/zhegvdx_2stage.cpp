    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    timer_start( time );
    magma_minproduct_zheevdx_2stage(jobz, range, uplo, n, A, lda, vl, vu, il, iu, m, w, work, lwork, rwork, lrwork, iwork, liwork, info);
    timer_stop( time );
    ...
    if (wantz && *info == 0) {
        ...
        magma_minproduct_zsetmatrix( n, *m, A, lda, dA, ldda );
        magma_minproduct_zsetmatrix( n,  n, B, ldb, dB, lddb );
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_minproduct_ztrsm(Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit, n, *m, c_one, dB, lddb, dA, ldda);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_minproduct_ztrmm(Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit, n, *m, c_one, dB, lddb, dA, ldda);
        }

        magma_minproduct_zgetmatrix( n, *m, dA, ldda, A, lda );
