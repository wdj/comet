...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_minproduct_smake_hpd( N, h_B, N );
            ...
            if ( opts.warmup || opts.check ) {
                ...
                lapackf77_slacpy( Magma_minproductFullStr, &N, &N, h_A, &N, h_Ainit, &N );
                lapackf77_slacpy( Magma_minproductFullStr, &N, &N, h_B, &N, h_Binit, &N );
            }
            ...
            if (opts.warmup) {
                ...
                // ==================================================================
                magma_minproduct_ssygvd_m( opts.ngpu, opts.itype, opts.jobz, opts.uplo,
                                N, h_A, N, h_B, N, w1,
                                h_work, lwork,
                                #ifdef COMPLEX
                                rwork, lrwork,
                                ...
                                iwork, liwork,
                                &info);
                lapackf77_slacpy( Magma_minproductFullStr, &N, &N, h_Ainit, &N, h_A, &N );
                lapackf77_slacpy( Magma_minproductFullStr, &N, &N, h_Binit, &N, h_B, &N );
            }
            ...
            if (info != 0)
                printf("magma_minproduct_ssygvd_m returned error %d: %s.\n",
            ...
            if ( opts.lapack ) {
                ...
                magma_minproduct_ssygvd(opts.itype, opts.jobz, opts.uplo,
                             N, h_A, N, h_B, N, w2,
                             h_work, lwork,
                             #ifdef COMPLEX
                             rwork, lrwork,
                ...
                if (info != 0)
                    printf("magma_minproduct_ssygvd returned error %d: %s.\n",
                           (int) info, magma_minproduct_strerror( info ));
