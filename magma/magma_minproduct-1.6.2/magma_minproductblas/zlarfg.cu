...
// ----------------------------------------
// CUDA kernel for magma_minproduct_zlarfg.
...
// This was slightly faster (5%) than passing n to magma_minproduct_sum_reduce.
// To use number of threads = min( NB, max( 1, n-1 )), pass n as
// argument to magma_minproduct_sum_reduce, rather than as template parameter.
__global__ void
zlarfg_kernel(
    int n,
    ...
    magma_minproductDoubleComplex* dtau )
{
    ...
    __shared__ magma_minproductDoubleComplex sscale2;
    ...
    magma_minproduct_max_reduce< NB >( tx, swork );
    if ( tx == 0 )
        sscale = swork[0];
    __syncthreads();
    ...
    if ( sscale > 0 ) {
        ...
        magma_minproduct_sum_reduce< NB >( tx, swork );
        //magma_minproduct_sum_reduce( blockDim.x, tx, swork );
    }
...
/**
    ...
    @ingroup magma_minproduct_zaux1
    ********************************************************************/
extern "C"
void magma_minproductblas_zlarfg_q(
...
/**
    @see magma_minproductblas_zlarfg_q
    @ingroup magma_minproduct_zaux1
    ********************************************************************/
extern "C"
void magma_minproductblas_zlarfg(
    magma_minproduct_int_t n,
    magma_minproductDoubleComplex_ptr dalpha,
    magma_minproductDoubleComplex_ptr dx, magma_minproduct_int_t incx,
    magma_minproductDoubleComplex_ptr dtau )
