...
/**
    ...
    trans    magma_tally2_trans_t.
      ...
      -     = Magma_tally2_ConjTrans:  C := alpha*A**H*B + conj( alpha )*B**H*A + beta*C.
    ...
    k        INTEGER.
             ...
             TRANS = Magma_tally2_ConjTrans, K specifies the number of rows of the
    ...
    ********************************************************************/
extern "C"
void magma_tally2blas_cher2k_mgpu2(
    ...
    magma_tally2_int_t ngpu, magma_tally2_int_t nb, magma_tally2_queue_t queues[][20], magma_tally2_int_t nqueue )
{
    ...
    if ( uplo != Magma_tally2Lower) {
        ...
        info = -4;
                ...
                ((trans == Magma_tally2_ConjTrans) && ldda < max(1,k)) ) {
        info = -7;
    } else if ( a_offset < 0 || a_offset > ldda ) {
        info = -8;
    } else if ( ((trans == Magma_tally2NoTrans)    && lddb < max(1,n)) ||
                ((trans == Magma_tally2_ConjTrans) && lddb < max(1,k)) ) {
        info = -10;
    ...
    for( magma_tally2_int_t i = 0; i < n; i += ib ) {
        ...
        magma_tally2_cgemm( Magma_tally2NoTrans, Magma_tally2_ConjTrans, n-i, ib, k,
    ...
    alpha = MAGMA_tally2_C_CNJG( alpha );
