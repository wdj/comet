...
__global__ void
magma_tally2_clobpcg_maxpy_kernel( 
...
/**
    ...
    It replaces:
            magma_tally2_caxpy(m*n, c_one, Y, 1, X, 1);
    ...
    @param[in/out]
    Y           magma_tally2FloatComplex_ptr 
    ...
    magma_tally2_queue_t queue )
{
    ...
    magma_tally2_clobpcg_maxpy_kernel<<< grid, threads, 0, queue >>>
