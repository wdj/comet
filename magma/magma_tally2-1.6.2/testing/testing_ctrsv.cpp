...
int main( int argc, char** argv)
{
    ...
    magma_tally2FloatComplex *h_A, *h_b, *h_x, *h_xcublas;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_b,       magma_tally2FloatComplex, N     );
            ...
            cublasCtrsv( opts.handle, cublas_uplo_const_tally2(opts.uplo),
            ...
            if ( opts.lapack ) {
                ...
                blasf77_ctrsv( lapack_uplo_const_tally2(opts.uplo), lapack_trans_const_tally2(opts.transA), lapack_diag_const_tally2(opts.diag),
                               &N,
                               h_A, &lda,
                               h_x, &ione );
