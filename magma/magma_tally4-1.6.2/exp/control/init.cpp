...
extern "C" magma_tally4_context *
magma_tally4_init( void *params, void* (*func)(void *a), magma_tally4_int_t nthread, magma_tally4_int_t ncpu, magma_tally4_int_t ngpu,
...
/*  -- MAGMA_tally4 (version 1.6.1) --
    ...
    subsequent calls to routines in the MAGMA_tally4 library.
    ...
    context  = (magma_tally4_context *)malloc(sizeof(magma_tally4_context));
...
extern "C" void
magma_tally4_finalize( magma_tally4_context *cntxt)
{
/*  -- MAGMA_tally4 (version 1.6.1) --
       Univ. of Tennessee, Knoxville
       Univ. of California, Berkeley
    ...
    Purpose
    =======
    This function finalizes the MAGMA_tally4 hardware context.

    Arguments
    =========
    CNTXT  (input) MAGMA_tally4_CONTEXT
           Pointer to the MAGMA_tally4 hardware context to be closed
    ===================================================================== */
