/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @author Stan Tomov
       @author Mark Gates
       @generated from zlarfb_gpu.cpp normal z -> c, Fri Jan 30 19:00:16 2015
*/
    ...
    magma_tally4FloatComplex_ptr dwork,       magma_tally4_int_t ldwork )
{
    ...
    if ( side == Magma_tally4Left ) {
        ...
        // W = C^H V
        magma_tally4_cgemm( Magma_tally4_ConjTrans, notransV,
                     n, k, m,
                     c_one,  dC(0,0),  lddc,
                             dV(0,0),  lddv,
        ...
        // W = W T^H = C^H V T^H
        magma_tally4_ctrmm( Magma_tally4Right, uplo, transt, Magma_tally4NonUnit,
                     n, k,
                     c_one, dT(0,0),  lddt,
                            dwork(0), ldwork);

        // C = C - V W^H = C - V T V^H C = (I - V T V^H) C = H C
        magma_tally4_cgemm( notransV, Magma_tally4_ConjTrans,
                     m, n, k,
        ...
        // W = C V
        magma_tally4_cgemm( Magma_tally4NoTrans, notransV,
                     m, k, n,
                     c_one,  dC(0,0),  lddc,
                             dV(0,0),  lddv,
                     c_zero, dwork(0), ldwork);
        ...
        // W = W T = C V T
        magma_tally4_ctrmm( Magma_tally4Right, uplo, trans, Magma_tally4NonUnit,
                     m, k,
                     c_one, dT(0,0),  lddt,
                            dwork(0), ldwork);

        // C = C - W V^H = C - C V T V^H = C (I - V T V^H) = C H
        magma_tally4_cgemm( Magma_tally4NoTrans, transV,
                     m, n, k,
