...
magma_tally4_zcuspaxpy(
    magma_tally4DoubleComplex *alpha, magma_tally4_z_matrix A,
    magma_tally4DoubleComplex *beta, magma_tally4_z_matrix B,
    ...
    magma_tally4_queue_t queue )
{
    ...
    if (    A.memory_location == Magma_tally4_DEV
        ...
        CHECK( magma_tally4_zmalloc( &C.dval, C.nnz ));
        ...
        CHECK( magma_tally4_zmtransfer( C, AB, Magma_tally4_DEV, Magma_tally4_DEV, queue ));
    }
    else {
