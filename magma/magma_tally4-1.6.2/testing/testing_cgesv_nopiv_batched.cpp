...
int main(int argc, char **argv)
{
    ...
    magma_tally4FloatComplex **d_A_array, **d_B_array;
    magma_tally4_int_t *ipiv;
    magma_tally4_int_t N, n2, nrhs, lda, ldb, ldda, lddb, info, sizeA, sizeB;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_B, magma_tally4FloatComplex, ldb*nrhs*batchCount );
            TESTING_MALLOC_CPU( h_X, magma_tally4FloatComplex, ldb*nrhs*batchCount );
            ...
            magma_tally4_cgesv_nopiv_batched( N, nrhs, d_A_array, ldda, d_B_array, lddb, dinfo_magma_tally4, batchCount, queue );
