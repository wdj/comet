    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally4FloatComplex *da[Magma_tally4MaxGPUs], *dT1[Magma_tally4MaxGPUs];
    ...
    for( magma_tally4_int_t dev = 0; dev < ngpu; ++dev ) {
        ...
        // TODO check malloc
        magma_tally4_cmalloc(&da[dev], ldda*mlocal );
        magma_tally4_cmalloc(&dT1[dev], (n*nb) );
    ...
    magma_tally4_csetmatrix_1D_col_bcyclic( n, n, A, lda, da, ldda, ngpu, distblk );
    magma_tally4_setdevice(0);
    timer_stop( time_dist );

    timer_start( time_band );
    if (ver == 30) {
        magma_tally4_chetrd_he2hb_mgpu_spec(uplo, n, nb, A, lda, &work[indtau1], &work[indwrk], llwork, da, ldda, dT1, nb, ngpu, distblk, streams, nstream, info);
    } else {
        magma_tally4_chetrd_he2hb_mgpu(uplo, n, nb, A, lda, &work[indtau1], &work[indwrk], llwork, da, ldda, dT1, nb, ngpu, distblk, streams, nstream, info);
    }
    timer_stop( time_band );
...
/*
        ...
        magma_tally4_cgetmatrix( n, *m, dZ, lddz, &work[indwrk], n);

        magma_tally4_free(dZ);

*/

        magma_tally4_cbulge_back_m(ngpu, uplo, n, nb, *m, Vblksiz, &work[indwrk + n * (il-1)], n,
                            &work[indV2], ldv, &work[indTAU2], &work[indT2], ldt, info);
        ...
        magma_tally4_cunmqr_m(ngpu, Magma_tally4Left, Magma_tally4NoTrans, n-nb, *m, n-nb, A+nb, lda, &work[indtau1],
