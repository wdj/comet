    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_minproduct_dsetmatrix( n, *mout, &work[indwrk + n* (il-1) ], n, dwork, lddc );

        magma_minproduct_dormtr_gpu( Magma_minproductLeft, uplo, Magma_minproductNoTrans, n, *mout, dA, ldda, &work[indtau],
                          dwork, lddc, wA, ldwa, &iinfo );

        magma_minproduct_dcopymatrix( n, *mout, dwork, lddc, dA, ldda );
