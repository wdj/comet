...
/**
    ...
    @param[in]
    new_values  magma_tally2DoubleComplex**
...
z_transpose_csr(
    ...
    magma_tally2DoubleComplex **new_values,
    ...
    magma_tally2_queue_t queue )
{
    ...
    magma_tally2DoubleComplex *csc_values=NULL;
    ...
    CHECK( magma_tally2_zmalloc_cpu( &csc_values, nnz ) );
    ...
    magma_tally2_queue_t queue )
{
    ...
    magma_tally2_z_matrix ACSR={Magma_tally2_CSR}, BCSR={Magma_tally2_CSR};
    ...
    if( A.storage_type == Magma_tally2_CSR && A.memory_location == Magma_tally2_DEV ) {
        ...
        CHECK( magma_tally2_zmtransfer( A, &A_d, A.memory_location, Magma_tally2_DEV, queue ));
        CHECK( magma_tally2_z_cucsrtranspose( A_d, &B_d, queue ));
        CHECK( magma_tally2_zmtransfer( B_d, B, Magma_tally2_DEV, A.memory_location, queue ));
                
    }else {
        CHECK( magma_tally2_zmconvert( A, &ACSR, A.storage_type, Magma_tally2_CSR, queue ));
        CHECK( magma_tally2_z_cucsrtranspose( ACSR, &BCSR, queue ));
        CHECK( magma_tally2_zmconvert( BCSR, B, Magma_tally2_CSR, A.storage_type, queue ));
    }
cleanup:
    ...
    magma_tally2_zmfree( &BCSR, queue );
    if( info != 0 ){
