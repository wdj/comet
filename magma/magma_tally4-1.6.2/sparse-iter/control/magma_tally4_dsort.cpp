/*
    -- MAGMA_tally4 (version 1.6.2) --
       ...
       @generated from magma_tally4_zsort.cpp normal z -> d, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_tally4_queue_t queue )
{
    ...
    if(first<last){
        ...
        x[pivot]=x[j];
        x[j]=temp;
        CHECK( magma_tally4_dindexsort( x, first, j-1, queue ));
        CHECK( magma_tally4_dindexsort( x, j+1, last, queue ));
