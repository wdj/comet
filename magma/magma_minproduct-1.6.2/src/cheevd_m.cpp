    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_minproduct_chetrd_mgpu(ngpu, 1, uplo, n, A, lda, w, &rwork[inde],
    ...
    if (! wantz) {
...
#else
        magma_minproduct_cstedx_m(ngpu, Magma_minproductRangeAll, n, 0, 0, 0, 0, w, &rwork[inde],
                       &work[indwrk], n, &rwork[indrwk],
        ...
        magma_minproduct_cunmtr_m(ngpu, Magma_minproductLeft, uplo, Magma_minproductNoTrans, n, n, A, lda, &work[indtau],
