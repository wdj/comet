...
magma_tally4_ziterilu_csr_kernel(   
    ...
    magma_tally4DoubleComplex s, sp;
    int il, iu, jl, ju;
...
magma_tally4_ziterilu_csr( 
    ...
    magma_tally4_ziterilu_csr_kernel<<< grid, block, 0, magma_tally4_stream >>>
        ( A.num_rows, A.nnz, 
