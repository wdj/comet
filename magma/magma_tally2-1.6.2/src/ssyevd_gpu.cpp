    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally2_ssetmatrix( n, n, &work[indwrk], n, dwork, lddc );

        magma_tally2_sormtr_gpu( Magma_tally2Left, uplo, Magma_tally2NoTrans, n, n, dA, ldda, &work[indtau],
                          dwork, lddc, wA, ldwa, &iinfo );

        magma_tally2_scopymatrix( n, n, dwork, lddc, dA, ldda );
