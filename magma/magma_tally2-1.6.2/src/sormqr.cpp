    ...
    if (nb >= k) {
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            spanel_to_q_tally2( Magma_tally2Upper, ib, A(i,i), lda, T2 );
            magma_tally2_ssetmatrix( nq_i,  ib, A(i,i), lda, dV(0,0), nq_i );
            sq_to_panel_tally2( Magma_tally2Upper, ib, A(i,i), lda, T2 );
