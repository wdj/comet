    ...
    magma_minproductFloatComplex *A, int lda )
{
    ...
    bool full = (iby + BLK_Y <= n && (ind >= iby + BLK_Y || ind + BLK_X <= iby || MAGMA_minproduct_C_EQUAL( offdiag, diag )));
...
void claset_full_kernel(
    int m, int n,
    magma_minproductFloatComplex offdiag, magma_minproductFloatComplex diag,
    magma_minproductFloatComplex *dA, int ldda )
{
...
void claset_full_kernel_batched(
    int m, int n,
    magma_minproductFloatComplex offdiag, magma_minproductFloatComplex diag,
    magma_minproductFloatComplex **dAarray, int ldda )
{
...
/**
    ...
    ********************************************************************/
extern "C"
void magma_minproductblas_claset_q(
    ...
    magma_minproduct_queue_t queue)
{
    ...
    if (uplo == Magma_minproductLower) {
        ...
        if ( m == ldda &&
             MAGMA_minproduct_C_EQUAL( offdiag, MAGMA_minproduct_C_ZERO ) &&
             MAGMA_minproduct_C_EQUAL( diag,    MAGMA_minproduct_C_ZERO ) )
        {
            size_t size = m*n;
            cudaError_t err = cudaMemsetAsync( dA, 0, size*sizeof(magma_minproductFloatComplex), queue );
...
/**
    @see magma_minproductblas_claset_q
    @ingroup magma_minproduct_caux2
    ********************************************************************/
extern "C"
void magma_minproductblas_claset(
    magma_minproduct_uplo_t uplo, magma_minproduct_int_t m, magma_minproduct_int_t n,
    magma_minproductFloatComplex offdiag, magma_minproductFloatComplex diag,
    magma_minproductFloatComplex_ptr dA, magma_minproduct_int_t ldda )
{
    magma_minproductblas_claset_q( uplo, m, n, offdiag, diag, dA, ldda, magma_minproduct_stream );
}


////////////////////////////////////////////////////////////////////////////////////////
extern "C"
void magma_minproductblas_claset_batched(
    magma_minproduct_uplo_t uplo, magma_minproduct_int_t m, magma_minproduct_int_t n,
    magma_minproductFloatComplex offdiag, magma_minproductFloatComplex diag,
