...
magma_minproduct_ssetmatrix_internal(
    ...
    float const* hA_src, magma_minproduct_int_t lda,
    magma_minproductFloat_ptr    dB_dst, magma_minproduct_int_t ldb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
...
magma_minproduct_sgetmatrix_internal(
    magma_minproduct_int_t m, magma_minproduct_int_t n,
    magma_minproductFloat_const_ptr dA_src, magma_minproduct_int_t lda,
    float*          hB_dst, magma_minproduct_int_t ldb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
