/*
    -- MAGMA_tally2 (version 1.6.1) --
       ...
       @generated from zgemm_batched.cu normal z -> d, Fri Jan 30 19:00:10 2015
    ...
    double **dC_array, magma_tally2_int_t lddc, magma_tally2_int_t batchCount, magma_tally2_queue_t queue )
{
    ...
    //if( (k < 32) || (k == 32 && m < 256) || (k == 32 && n < 256) || (k == 32 && transA==Magma_tally2Trans) || (k == 32 && transA==Magma_tally2ConjTrans) || (m <= 32 && n <= 32) ) {
    if( (k <= 32) || (m <= 32 && n <= 32) ) {
