...
/*
*
*  magma_minproduct_dgetrf_gpu_amc:
*
*  This function allocate the workspace and call magma_minproduct_dgetrf_gpu_work_amc
*  REC: recursif Algorithm
*  ASYNC: asynchronous algorithm
*/

extern "C" magma_minproduct_int_t magma_minproduct_dgetrf_gpu_amc(magma_minproduct_int_t m, magma_minproduct_int_t n,  
...
/*  -- MAGMA_minproduct (version 1.6.1) -- 
    ...
    *info = 0; 
    ...
    magma_minproduct_dgetrf_gpu_work_amc(m, n, dA, dA_LD, ipiv, info, AWORK, AWORK_LD, AWORK_n);
...
magma_minproduct_dgetrf_gpu_work_amc(
     ...
     for(K=0;K<=N-1;K++){ 
          ...
          for(J=K+1;J<=min(K+A_N-1, N-1);J++){ 
           ...
           if(K+A_N<N) { 
              ...
              magma_minproduct_insert_dgetmatrix_transpose(gpu_nrows, ncols, dAT(K+1,K+A_N), dAT_LD, A(K+1,K+A_N), A_LD, dAP_get, dAP_LD, colptr(K+A_N)); //blocking
