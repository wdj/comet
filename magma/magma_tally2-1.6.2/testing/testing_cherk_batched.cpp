...
int main( int argc, char** argv)
{
    ...
    float          current_error, magma_tally2_error, Cnorm, work[1];
    ...
    magma_tally2FloatComplex *h_A, *h_C, *h_Cmagma_tally2;
    magma_tally2FloatComplex *d_A, *d_C;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally2_csetmatrix( An, Ak*batchCount, h_A, lda, d_A, ldda );
            magma_tally2_csetmatrix( N, N*batchCount, h_C, ldc, d_C, lddc );
            ...
            magma_tally2blas_cherk_batched(opts.uplo, opts.transA, N, K,
                             alpha, A_array, ldda,
            ...
            magma_tally2_cgetmatrix( N, NN, d_C, lddc, h_Cmagma_tally2, ldc );
            ...
            if ( opts.check ) {
                ...
                for(int i=0; i<batchCount; i++)
                {
                    Cnorm = lapackf77_clanhe("fro", lapack_uplo_const_tally2(opts.uplo), &N, h_C+i*ldc*N, &ldc, work);
                    blasf77_caxpy( &sizeC, &c_neg_one, h_C+i*ldc*N, &ione, h_Cmagma_tally2+i*ldc*N, &ione );
                    current_error = lapackf77_clanhe( "fro", lapack_uplo_const_tally2(opts.uplo), &N, h_Cmagma_tally2+i*ldc*N, &ldc, work ) / Cnorm;
