...
/**
    ...
    as returned by ZGELQF. Q is of order M if SIDE = Magma_minproductLeft and of order N
    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb >= k) {
        ...
        magma_minproductDoubleComplex_ptr dwork, dV, dT, dC;
        ...
        magma_minproduct_zmalloc_cpu( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_minproduct_zsetmatrix( m, n, C, ldc, dC(0,0), lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            zpanel_to_q( Magma_minproductLower, ib, A(i,i), lda, T2 );
            magma_minproduct_zsetmatrix( ib, nq_i,  A(i,i), lda, dV(0,0), ib );
            zq_to_panel( Magma_minproductLower, ib, A(i,i), lda, T2 );
            ...
            magma_minproduct_zsetmatrix( ib, ib, T, ib, dT(0,0), ib );
            magma_minproduct_zlarfb_gpu( side, transt, Magma_minproductForward, Magma_minproductRowwise,
                              mi, ni, ib,
                              dV(0,0), ib,
                              dT(0,0), ib,
                              dC(ic,jc), lddc,
        ...
        magma_minproduct_zgetmatrix( m, n, dC(0,0), lddc, C, ldc );
