    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        if (MAGMA_tally2_SUCCESS != magma_tally2_dmalloc( &dZ, *m*lddz)) {
            *info = MAGMA_tally2_ERR_DEVICE_ALLOC;
            return *info;
        }
        ...
        magma_tally2_dbulge_back(uplo, n, nb, *m, Vblksiz, &work[indwrk + n * (il-1)], n, dZ, lddz,
        ...
        magma_tally2_dormqr_gpu_2stages(Magma_tally2Left, Magma_tally2NoTrans, n-nb, *m, n-nb, dA+nb, ldda,
                                 dZ+nb, n, dT1, nb, info);

        magma_tally2_dgetmatrix( n, *m, dZ, lddz, A, lda );
