...
//=================================================================================================
extern "C" void
magma_minproduct_dlaswp_rowparallel_batched( magma_minproduct_int_t n, 
                       double** input_array, magma_minproduct_int_t ldi,
...
//=================================================================================================
extern "C" void
magma_minproduct_dlaswp_rowparallel_q( magma_minproduct_int_t n, 
                       double* input, magma_minproduct_int_t ldi,
                       double* output, magma_minproduct_int_t ldo,
                       magma_minproduct_int_t k1, magma_minproduct_int_t k2,
                       magma_minproduct_int_t *pivinfo, 
                       magma_minproduct_queue_t queue)
{
    ...
    {
       printf(" height=%d > %d, magma_minproduct_dlaswp_rowparallel_q not supported \n", n,MAX_NTHREADS);
...
extern "C" void
magma_minproduct_dlaswp_rowparallel( magma_minproduct_int_t n, double* input, magma_minproduct_int_t ldi,
                   double* output, magma_minproduct_int_t ldo,
                   magma_minproduct_int_t k1, magma_minproduct_int_t k2,
                   magma_minproduct_int_t *pivinfo)
{
    magma_minproduct_dlaswp_rowparallel_q(n, input, ldi, output, ldo, k1, k2, pivinfo, magma_minproduct_stream);
}
...
//=================================================================================================
__global__ void dlaswp_rowserial_kernel_batched( int n, double **dA_array, int lda, int k1, int k2, magma_minproduct_int_t** ipiv_array )
{
...
//=================================================================================================
__global__ void dlaswp_columnserial_kernel_batched( int n, double **dA_array, int lda, int k1, int k2, magma_minproduct_int_t** ipiv_array )
{
    double* dA = dA_array[blockIdx.z];
    magma_minproduct_int_t *d_ipiv = ipiv_array[blockIdx.z];
