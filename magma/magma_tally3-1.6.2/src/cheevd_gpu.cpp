    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally3_cstedx( Magma_tally3RangeAll, n, 0., 0., 0, 0, w, &rwork[inde],
        ...
        magma_tally3_csetmatrix( n, n, &work[indwrk], n, dC, lddc );

        magma_tally3_cunmtr_gpu( Magma_tally3Left, uplo, Magma_tally3NoTrans, n, n, dA, ldda, &work[indtau],
                          dC, lddc, wA, ldwa, &iinfo );

        magma_tally3_ccopymatrix( n, n, dC, lddc, dA, ldda );
