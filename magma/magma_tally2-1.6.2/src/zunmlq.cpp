...
/**
    ...
    as returned by ZGELQF. Q is of order M if SIDE = Magma_tally2Left and of order N
    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb >= k) {
        /* Use CPU code */
        lapackf77_zunmlq( lapack_side_const_tally2(side), lapack_trans_const_tally2(trans),
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            zpanel_to_q_tally2( Magma_tally2Lower, ib, A(i,i), lda, T2 );
            magma_tally2_zsetmatrix( ib, nq_i,  A(i,i), lda, dV(0,0), ib );
            zq_to_panel_tally2( Magma_tally2Lower, ib, A(i,i), lda, T2 );
            ...
            magma_tally2_zlarfb_gpu( side, transt, Magma_tally2Forward, Magma_tally2Rowwise,
                              mi, ni, ib,
                              dV(0,0), ib,
                              dT(0,0), ib,
                              dC(ic,jc), lddc,
