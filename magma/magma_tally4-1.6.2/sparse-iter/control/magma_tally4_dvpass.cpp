/*
    -- MAGMA_tally4 (version 1.6.2) --
       ...
       @generated from magma_tally4_zvpass.cpp normal z -> d, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
...
magma_tally4_dvget(
    ...
    magma_tally4_queue_t queue )
{
    magma_tally4_d_matrix v_CPU={Magma_tally4_CSR};
    ...
    if ( v.memory_location == Magma_tally4_CPU ) {
        ...
        *val = v.val;
        ...
        CHECK( magma_tally4_dmtransfer( v, &v_CPU, v.memory_location, Magma_tally4_CPU, queue ));
        CHECK( magma_tally4_dvget( v_CPU, m, n, val, queue ));
    }
    
cleanup:
    magma_tally4_dmfree( &v_CPU, queue );
    return info;
}
