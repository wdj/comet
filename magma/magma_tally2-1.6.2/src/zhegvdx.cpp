    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    timer_start( time );
    magma_tally2_zheevdx_gpu( jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, mout, w, A, lda,
    ...
    if (wantz && *info == 0) {
        ...
        if (dB == NULL) {
            if (MAGMA_tally2_SUCCESS != magma_tally2_zmalloc( &dB, n*lddb ) ) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally2_ztrsm( Magma_tally2Left, uplo, trans, Magma_tally2NonUnit,
        ...
        magma_tally2_zgetmatrix( n, *mout, dA, ldda, A, lda );
