        ...
        if (alleig) {
            ...
            while ( start < n ) {
                ...
                for (end = start+1; end < n; ++end) {
                    tiny = eps * sqrt( MAGMA_tally2_D_ABS(d[end-1]*d[end]));
                    if (MAGMA_tally2_D_ABS(e[end-1]) <= tiny)
                        break;
                }
                ...
                if (m > smlsiz) {
                    ...
                    magma_tally2_dlaex0_m( ngpu, m, &d[start], &e[start], Z(start, start), ldz, work, iwork, Magma_tally2RangeAll, vl, vu, il, iu, info);
            ...
            magma_tally2_dlaex0_m(ngpu, n, d, e, Z, ldz, work, iwork, range, vl, vu, il, iu, info);
