...
#ifndef MAGMA_minproduct_ZLAPACK_H
#define MAGMA_minproduct_ZLAPACK_H
 ...
 */
magma_minproduct_int_t blasf77_izamax(
                     const magma_minproduct_int_t *n,
                     const magma_minproductDoubleComplex *x, const magma_minproduct_int_t *incx );

void blasf77_zaxpy(  const magma_minproduct_int_t *n,
                     const magma_minproductDoubleComplex *alpha,
                     const magma_minproductDoubleComplex *x, const magma_minproduct_int_t *incx,
                           magma_minproductDoubleComplex *y, const magma_minproduct_int_t *incy );

void blasf77_zcopy(  const magma_minproduct_int_t *n,
                     const magma_minproductDoubleComplex *x, const magma_minproduct_int_t *incx,
                           magma_minproductDoubleComplex *y, const magma_minproduct_int_t *incy );
...
void blasf77_zgemm(  const char *transa, const char *transb,
                     ...
                     const magma_minproductDoubleComplex *alpha,
                     const magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                     const magma_minproductDoubleComplex *B, const magma_minproduct_int_t *ldb,
                     const magma_minproductDoubleComplex *beta,
...
void blasf77_zgerc(  const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                     const magma_minproductDoubleComplex *alpha,
                     const magma_minproductDoubleComplex *x, const magma_minproduct_int_t *incx,
                     const magma_minproductDoubleComplex *y, const magma_minproduct_int_t *incy,
                           magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda );

void blasf77_zgeru(  const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                     const magma_minproductDoubleComplex *alpha,
                     const magma_minproductDoubleComplex *x, const magma_minproduct_int_t *incx,
                     const magma_minproductDoubleComplex *y, const magma_minproduct_int_t *incy,
                           magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda );
...
void blasf77_zscal(  const magma_minproduct_int_t *n,
                     const magma_minproductDoubleComplex *alpha,
                           magma_minproductDoubleComplex *x, const magma_minproduct_int_t *incx );

void blasf77_zdscal( const magma_minproduct_int_t *n,
                     const double *alpha,
                           magma_minproductDoubleComplex *x, const magma_minproduct_int_t *incx );

void blasf77_zswap(  const magma_minproduct_int_t *n,
                     magma_minproductDoubleComplex *x, const magma_minproduct_int_t *incx,
                     magma_minproductDoubleComplex *y, const magma_minproduct_int_t *incy );
...
void blasf77_zrotg(  magma_minproductDoubleComplex *ca, const magma_minproductDoubleComplex *cb,
                     double *c, magma_minproductDoubleComplex *s );
                     
void blasf77_zrot(   const magma_minproduct_int_t *n,
                     magma_minproductDoubleComplex *x, const magma_minproduct_int_t *incx,
                     magma_minproductDoubleComplex *y, const magma_minproduct_int_t *incy,
                     const double *c, const magma_minproductDoubleComplex *s );
                     
void blasf77_zdrot(  const magma_minproduct_int_t *n,
                     magma_minproductDoubleComplex *x, const magma_minproduct_int_t *incx,
                     magma_minproductDoubleComplex *y, const magma_minproduct_int_t *incy,
...
void blasf77_ztrmm(  const char *side, const char *uplo, const char *transa, const char *diag,
                     ...
                     const magma_minproductDoubleComplex *alpha,
                     const magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                           magma_minproductDoubleComplex *B, const magma_minproduct_int_t *ldb );
...
double magma_minproduct_cblas_dzasum(
    magma_minproduct_int_t n,
    const magma_minproductDoubleComplex *x, magma_minproduct_int_t incx );

double magma_minproduct_cblas_dznrm2(
    magma_minproduct_int_t n,
    const magma_minproductDoubleComplex *x, magma_minproduct_int_t incx );

magma_minproductDoubleComplex magma_minproduct_cblas_zdotc(
    magma_minproduct_int_t n,
    const magma_minproductDoubleComplex *x, magma_minproduct_int_t incx,
    const magma_minproductDoubleComplex *y, magma_minproduct_int_t incy );

magma_minproductDoubleComplex magma_minproduct_cblas_zdotu(
    magma_minproduct_int_t n,
    const magma_minproductDoubleComplex *x, magma_minproduct_int_t incx,
    const magma_minproductDoubleComplex *y, magma_minproduct_int_t incy );
...
void   lapackf77_zbdsqr( const char *uplo,
                         ...
                         double *d, double *e,
                         magma_minproductDoubleComplex *Vt, const magma_minproduct_int_t *ldvt,
...
void   lapackf77_zgebd2( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         double *d, double *e,
...
void   lapackf77_zgebrd( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         double *d, double *e,
                         magma_minproductDoubleComplex *tauq,
                         magma_minproductDoubleComplex *taup,
...
void   lapackf77_zgbbrd( const char *vect, const magma_minproduct_int_t *m,
                         ...
                         magma_minproductDoubleComplex *Ab, const magma_minproduct_int_t *ldab,
                         double *d, double *e,
...
void   lapackf77_zgeev(  const char *jobvl, const char *jobvr,
                         ...
                         double *wr, double *wi,
                         #endif
                         magma_minproductDoubleComplex *Vl,   const magma_minproduct_int_t *ldvl,
                         magma_minproductDoubleComplex *Vr,   const magma_minproduct_int_t *ldvr,
                         magma_minproductDoubleComplex *work, const magma_minproduct_int_t *lwork,
                         #ifdef COMPLEX
                         double *rwork,
                         #endif
...
void   lapackf77_zgehd2( const magma_minproduct_int_t *n,
                         const magma_minproduct_int_t *ilo, const magma_minproduct_int_t *ihi,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
...
void   lapackf77_zgehrd( const magma_minproduct_int_t *n,
                         const magma_minproduct_int_t *ilo, const magma_minproduct_int_t *ihi,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductDoubleComplex *tau,
                         magma_minproductDoubleComplex *work, const magma_minproduct_int_t *lwork,
...
void   lapackf77_zgelqf( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductDoubleComplex *tau,
                         magma_minproductDoubleComplex *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );
...
void   lapackf77_zgeqlf( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductDoubleComplex *tau,
                         magma_minproductDoubleComplex *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_zgeqp3( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
...
void   lapackf77_zgeqrf( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductDoubleComplex *tau,
                         magma_minproductDoubleComplex *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );
...
void   lapackf77_zgesv(  const magma_minproduct_int_t *n, const magma_minproduct_int_t *nrhs,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
...
void   lapackf77_zgetrf( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproduct_int_t *ipiv,
                         magma_minproduct_int_t *info );

void   lapackf77_zgetri( const magma_minproduct_int_t *n,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
...
void   lapackf77_zhetf2( const char*, magma_minproduct_int_t*, 
                         magma_minproductDoubleComplex*, magma_minproduct_int_t*, magma_minproduct_int_t*, magma_minproduct_int_t* );
...
void   lapackf77_zheevr( const char *jobz, const char *range, const char *uplo,
                         ...
                         magma_minproduct_int_t *m, double *w, magma_minproductDoubleComplex *z__, 
...
void   lapackf77_zheevx( const char *jobz, const char *range, const char *uplo,
                         ...
                         magma_minproduct_int_t *il, magma_minproduct_int_t *iu, double *abstol,
                         magma_minproduct_int_t *m, double *w, magma_minproductDoubleComplex *z__,
                         magma_minproduct_int_t *ldz, magma_minproductDoubleComplex *work, magma_minproduct_int_t *lwork,
                         double *rwork, magma_minproduct_int_t *iwork, magma_minproduct_int_t *ifail, magma_minproduct_int_t *info);

void   lapackf77_zhegs2( const magma_minproduct_int_t *itype, const char *uplo,
                         const magma_minproduct_int_t *n,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductDoubleComplex *B, const magma_minproduct_int_t *ldb,
                         magma_minproduct_int_t *info );

void   lapackf77_zhegst( const magma_minproduct_int_t *itype, const char *uplo,
                         const magma_minproduct_int_t *n,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductDoubleComplex *B, const magma_minproduct_int_t *ldb,
                         magma_minproduct_int_t *info );

void   lapackf77_zhegvd( const magma_minproduct_int_t *itype, const char *jobz, const char *uplo,
                         const magma_minproduct_int_t *n,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductDoubleComplex *B, const magma_minproduct_int_t *ldb,
                         double *w,
...
void   lapackf77_zhesv( const char *uplo, 
                        const magma_minproduct_int_t *n, const magma_minproduct_int_t *nrhs,
                        magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda, magma_minproduct_int_t *ipiv,
                        magma_minproductDoubleComplex *B, const magma_minproduct_int_t *ldb,
                        magma_minproductDoubleComplex *work, const magma_minproduct_int_t *lwork,
                        magma_minproduct_int_t *info );
...
void   lapackf77_zhseqr( const char *job, const char *compz,
                         ...
                         double *wr, double *wi,
                         #endif
                         magma_minproductDoubleComplex *Z, const magma_minproduct_int_t *ldz,
                         magma_minproductDoubleComplex *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_zlabrd( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *nb,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         double *d, double *e,
                         magma_minproductDoubleComplex *tauq,
                         magma_minproductDoubleComplex *taup,
                         magma_minproductDoubleComplex *X, const magma_minproduct_int_t *ldx,
                         magma_minproductDoubleComplex *Y, const magma_minproduct_int_t *ldy );

#ifdef COMPLEX
void   lapackf77_zlacgv( const magma_minproduct_int_t *n,
                         magma_minproductDoubleComplex *x, const magma_minproduct_int_t *incx );
#endif
...
#ifdef COMPLEX
void   lapackf77_zlacrm( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         const magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
...
#ifdef COMPLEX
void   lapackf77_zladiv( magma_minproductDoubleComplex *ret_val,
...
void   lapackf77_zlahef( const char *uplo,
                         ...
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t lda,
                         magma_minproduct_int_t *ipiv,
                         magma_minproductDoubleComplex *work, const magma_minproduct_int_t *ldwork,
                         magma_minproduct_int_t *info );
...
double lapackf77_zlanht( const char *norm, const magma_minproduct_int_t *n,
                         const double *d, const magma_minproductDoubleComplex *e );
...
void   lapackf77_zlaqp2( magma_minproduct_int_t *m, magma_minproduct_int_t *n, magma_minproduct_int_t *offset,
                         magma_minproductDoubleComplex *a, magma_minproduct_int_t *lda, magma_minproduct_int_t *jpvt,
                         magma_minproductDoubleComplex *tau,
                         double *vn1, double *vn2,
                         magma_minproductDoubleComplex *work );

#ifdef COMPLEX
void   lapackf77_zlarcm( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         const double             *A, const magma_minproduct_int_t *lda,
                         const magma_minproductDoubleComplex *B, const magma_minproduct_int_t *ldb,
                         magma_minproductDoubleComplex       *C, const magma_minproduct_int_t *ldc,
                         double *rwork );
...
void   lapackf77_zlarf(  const char *side, const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
...
void   lapackf77_zlarfb( const char *side, const char *trans, const char *direct, const char *storev,
                         const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         const magma_minproductDoubleComplex *V, const magma_minproduct_int_t *ldv,
                         const magma_minproductDoubleComplex *T, const magma_minproduct_int_t *ldt,
                         magma_minproductDoubleComplex *C, const magma_minproduct_int_t *ldc,
                         magma_minproductDoubleComplex *work, const magma_minproduct_int_t *ldwork );

void   lapackf77_zlarfg( const magma_minproduct_int_t *n,
...
void   lapackf77_zlarft( const char *direct, const char *storev,
                         const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         magma_minproductDoubleComplex *V, const magma_minproduct_int_t *ldv,
                         const magma_minproductDoubleComplex *tau,
                         magma_minproductDoubleComplex *T, const magma_minproduct_int_t *ldt );

void   lapackf77_zlarnv( const magma_minproduct_int_t *idist, magma_minproduct_int_t *iseed, const magma_minproduct_int_t *n,
                         magma_minproductDoubleComplex *x );

void   lapackf77_zlartg( magma_minproductDoubleComplex *F,
                         magma_minproductDoubleComplex *G,
                         double *cs,
                         magma_minproductDoubleComplex *SN,
...
void   lapackf77_zlaswp( const magma_minproduct_int_t *n,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
...
void   lapackf77_zlatrs( const char *uplo, const char *trans, const char *diag,
                         ...
                         const magma_minproduct_int_t *n,
                         const magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductDoubleComplex *x, double *scale,
...
void   lapackf77_zstein( const magma_minproduct_int_t *n,
...
void   lapackf77_zung2r( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         const magma_minproductDoubleComplex *tau,
                         magma_minproductDoubleComplex *work,
                         magma_minproduct_int_t *info );
...
void   lapackf77_zunghr( const magma_minproduct_int_t *n,
                         const magma_minproduct_int_t *ilo, const magma_minproduct_int_t *ihi,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         const magma_minproductDoubleComplex *tau,
                         magma_minproductDoubleComplex *work, const magma_minproduct_int_t *lwork,
...
void   lapackf77_zunglq( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         const magma_minproductDoubleComplex *tau,
                         magma_minproductDoubleComplex *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_zungql( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         const magma_minproductDoubleComplex *tau,
                         magma_minproductDoubleComplex *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_zungqr( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         magma_minproductDoubleComplex *A, const magma_minproduct_int_t *lda,
                         const magma_minproductDoubleComplex *tau,
                         magma_minproductDoubleComplex *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );
...
#endif /* MAGMA_minproduct_ZLAPACK_H */
