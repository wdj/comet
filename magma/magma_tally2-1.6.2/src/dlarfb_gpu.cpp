    ...
    magma_tally2Double_ptr dwork,       magma_tally2_int_t ldwork )
{
    ...
    if ( side == Magma_tally2Left ) {
        ...
        // W = W T^H = C^H V T^H
        magma_tally2_dtrmm( Magma_tally2Right, uplo, transt, Magma_tally2NonUnit,
                     n, k,
                     c_one, dT(0,0),  lddt,
                            dwork(0), ldwork);

        // C = C - V W^H = C - V T V^H C = (I - V T V^H) C = H C
        magma_tally2_dgemm( notransV, Magma_tally2Trans,
                     m, n, k,
        ...
        // W = W T = C V T
        magma_tally2_dtrmm( Magma_tally2Right, uplo, trans, Magma_tally2NonUnit,
                     m, k,
                     c_one, dT(0,0),  lddt,
                            dwork(0), ldwork);
