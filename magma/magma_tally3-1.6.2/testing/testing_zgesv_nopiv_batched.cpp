...
int main(int argc, char **argv)
{
    ...
    magma_tally3DoubleComplex **d_A_array, **d_B_array;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_B, magma_tally3DoubleComplex, ldb*nrhs*batchCount );
            TESTING_MALLOC_CPU( h_X, magma_tally3DoubleComplex, ldb*nrhs*batchCount );
            ...
            magma_tally3_zgesv_nopiv_batched( N, nrhs, d_A_array, ldda, d_B_array, lddb, dinfo_magma_tally3, batchCount, queue );
