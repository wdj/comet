    ...
    magma_tally2_int_t *info )
{
    ...
    float dummy[1], eps;
    magma_tally2FloatComplex cdummy[1];
    ...
    *info = 0;
    ...
    maxwrk = (magma_tally2_int_t) MAGMA_tally2_C_REAL( work[0] );
    if (*info == 0) {
        // Return required workspace in WORK[0]
        nb = magma_tally2_get_cgesvd_nb(n);
        minwrk = (m + n)*nb + 2*minmn;
        
        // multiply by 1+eps (in Double!) to ensure length gets rounded up,
        // if it cannot be exactly represented in floating point.
        real_Double_t one_eps = 1. + lapackf77_slamch("Epsilon");
        work[0] = MAGMA_tally2_C_MAKE( minwrk * one_eps, 0 );
    ...
    if (m >= n) {
        ...
        if (m >= mnthr) {
            if (want_un) {
                ...
                lwork2 = lwork - iwork + 1;
                //printf( "path 1\n" );
                magma_tally2_cgebrd(n, n, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                ...
                if (lwork >= n*n + wrkbrd) {
                    ...
                    magma_tally2_cungqr2(m, n, n, A, lda, &work[itau], &ierr);
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 2-a\n" );
                    magma_tally2_cgebrd(n, n, &work[ir], ldwrkr, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 2-b\n" );
                    magma_tally2_cgebrd(m, n, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                ...
                if (lwork >= n*n + wrkbrd) {
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 3-a\n" );
                    magma_tally2_cgebrd(n, n, VT, ldvt, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                ...
                if (want_vn) {
                    ...
                    if (lwork >= n*n + wrkbrd) {
                        ...
                        magma_tally2_cungqr2(m, n, n, U, ldu, &work[itau], &ierr);
                    ...
                    if (lwork >= 2*n*n + wrkbrd) {
                        ...
                        lwork2 = lwork - iwork + 1;
                        //printf( "path 5-a\n" );
                        magma_tally2_cgebrd(n, n, &work[iu], ldwrku, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                ...
                if (want_vn) {
                    ...
                    if (lwork >= n*n + max(n + m, wrkbrd)) {
                        ...
                        magma_tally2_cungqr2(m, m, n, U, ldu, &work[itau], &ierr);
        ...
        if (n >= mnthr) {
            if (want_vn) {
                ...
                lwork2 = lwork - iwork + 1;
                //printf( "path 1t\n" );
                magma_tally2_cgebrd(m, m, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                ...
                if (lwork >= m*m + wrkbrd) {
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 2t-a\n" );
                    magma_tally2_cgebrd(m, m, &work[ir], ldwrkr, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                ...
                if (lwork >= m*m + wrkbrd) {
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 3t-a\n" );
                    magma_tally2_cgebrd(m, m, U, ldu, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                ...
                if (want_un) {
                    ...
                    if (lwork >= 2*m*m + wrkbrd) {
                        ...
                        lwork2 = lwork - iwork + 1;
                        //printf( "path 5t-a\n" );
                        magma_tally2_cgebrd(m, m, &work[iu], ldwrku, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
