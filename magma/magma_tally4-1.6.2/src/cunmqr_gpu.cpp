    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    hwork[0] = MAGMA_tally4_C_MAKE( lwkopt, 0 );
    ...
    if ( step < 0 ) {
        ...
        magma_tally4FloatComplex* hA = hwork;
        magma_tally4FloatComplex* hC = hwork + ma*ib;
        magma_tally4FloatComplex* hW = hwork + ma*ib + mi*ni;
        magma_tally4_int_t lhwork = lwork - (ma*ib + mi*ni);
        
        magma_tally4_cgetmatrix( ma, ib, dA(i,  i ), ldda, hA, ma );
        magma_tally4_cgetmatrix( mi, ni, dC(ic, jc), lddc, hC, mi );
        ...
        magma_tally4_csetmatrix( mi, ni, hC, mi, dC(ic, jc), lddc );
    }
    ...
    // TODO sync. For cases Q*C and C*Q^T, last call is magma_tally4_clarfb_gpu,
    // which is async magma_tally4_gemm calls, so cunmqr can be unfinished.
