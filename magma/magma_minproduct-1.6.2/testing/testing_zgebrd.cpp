...
int main( int argc, char** argv)
{
    ...
    magma_minproductDoubleComplex *h_A, *h_Q, *h_PT, *h_work;
    magma_minproductDoubleComplex *taup, *tauq;
    double      *diag, *offdiag;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( tauq,    magma_minproductDoubleComplex, minmn );
            TESTING_MALLOC_CPU( taup,    magma_minproductDoubleComplex, minmn );
            ...
            TESTING_MALLOC_PIN( h_work,  magma_minproductDoubleComplex, lhwork );
            
            /* Initialize the matrices */
            lapackf77_zlarnv( &ione, ISEED, &n2, h_A );
            lapackf77_zlacpy( Magma_minproductUpperLowerStr, &M, &N, h_A, &lda, h_Q, &lda );
            
            /* ====================================================================
               Performs operation using MAGMA_minproduct
               =================================================================== */
            gpu_time = magma_minproduct_wtime();
            magma_minproduct_zgebrd( M, N, h_Q, lda,
            ...
            if ( opts.check ) {
                ...
                TESTING_MALLOC_CPU( h_PT,       magma_minproductDoubleComplex, lda*N     );
                ...
                lapackf77_zlacpy(Magma_minproductUpperLowerStr, &M, &N, h_Q, &lda, h_PT, &lda);
