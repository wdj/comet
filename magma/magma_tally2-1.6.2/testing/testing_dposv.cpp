...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally2_dposv( opts.uplo, N, opts.nrhs, h_R, lda, h_X, ldb, &info );
            ...
            blasf77_dgemm( Magma_tally2NoTransStr, Magma_tally2NoTransStr, &N, &opts.nrhs, &N,
                           &c_one,     h_A, &lda,
                                       h_X, &ldb,
                           &c_neg_one, h_B, &ldb );
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_dposv( lapack_uplo_const_tally2(opts.uplo), &N, &opts.nrhs, h_A, &lda, h_B, &ldb, &info );
