...
void magma_tally4_ctrdtype1cbHLsym_withQ(
    magma_tally4_int_t N, magma_tally4_int_t NB,
    magma_tally4FloatComplex *A, magma_tally4_int_t LDA,
    magma_tally4FloatComplex *V, magma_tally4FloatComplex *TAU,
    magma_tally4_int_t st, magma_tally4_int_t ed, magma_tally4_int_t sweep, magma_tally4_int_t Vblksiz);

void magma_tally4_ctrdtype2cbHLsym_withQ(
    magma_tally4_int_t N, magma_tally4_int_t NB,
    magma_tally4FloatComplex *A, magma_tally4_int_t LDA,
    magma_tally4FloatComplex *V, magma_tally4FloatComplex *TAU,
    magma_tally4_int_t st, magma_tally4_int_t ed, magma_tally4_int_t sweep, magma_tally4_int_t Vblksiz);
   
void magma_tally4_ctrdtype3cbHLsym_withQ(
    magma_tally4_int_t N, magma_tally4_int_t NB,
    magma_tally4FloatComplex *A, magma_tally4_int_t LDA,
    magma_tally4FloatComplex *V, magma_tally4FloatComplex *TAU,
    magma_tally4_int_t st, magma_tally4_int_t ed, magma_tally4_int_t sweep, magma_tally4_int_t Vblksiz);

void magma_tally4_clarfxsym(
...
extern "C" void
magma_tally4_clarfxsym(
    magma_tally4_int_t N,
    magma_tally4FloatComplex *A, magma_tally4_int_t LDA,
    magma_tally4FloatComplex *V, magma_tally4FloatComplex *TAU)
{
    magma_tally4_int_t IONE=1;
    magma_tally4FloatComplex dtmp;
    magma_tally4FloatComplex Z_ZERO =  MAGMA_tally4_C_ZERO;
    //magma_tally4FloatComplex Z_ONE  =  MAGMA_tally4_C_ONE;
    magma_tally4FloatComplex Z_MONE =  MAGMA_tally4_C_NEG_ONE;
    magma_tally4FloatComplex Z_HALF =  MAGMA_tally4_C_HALF;
    //magma_tally4FloatComplex WORK[N];
    magma_tally4FloatComplex *WORK;
    magma_tally4_cmalloc_cpu( &WORK, N );
    
    /* apply left and right on A(st:ed,st:ed)*/
    //magma_tally4_clarfxsym(len,A(st,st),LDX,V(st),TAU(st));
    /* X = AVtau */
    blasf77_chemv("L",&N, TAU, A, &LDA, V, &IONE, &Z_ZERO, WORK, &IONE);
    /* je calcul dtmp= X'*V */
    dtmp = magma_tally4_cblas_cdotc(N, WORK, IONE, V, IONE);
...
#define TAU(m)   &(TAU[(m)])
extern "C" void
magma_tally4_ctrdtype1cbHLsym_withQ(
    magma_tally4_int_t N, magma_tally4_int_t NB,
    magma_tally4FloatComplex *A, magma_tally4_int_t LDA,
    magma_tally4FloatComplex *V, magma_tally4FloatComplex *TAU,
    magma_tally4_int_t st, magma_tally4_int_t ed, magma_tally4_int_t sweep, magma_tally4_int_t Vblksiz)
{
    ...
    //magma_tally4FloatComplex conjtmp;
    magma_tally4FloatComplex Z_ONE  =  MAGMA_tally4_C_ONE;
    magma_tally4FloatComplex *WORK;
    magma_tally4_cmalloc_cpu( &WORK, N );
    ...
    len     = ed-st+1;
    *V(vpos)  = Z_ONE;
    memcpy(V(vpos+1), A(st+1, st-1), (len-1)*sizeof(magma_tally4FloatComplex));
    memset(A(st+1, st-1), 0, (len-1)*sizeof(magma_tally4FloatComplex));
    /* Eliminate the col  at st-1 */
    lapackf77_clarfg( &len, A(st, st-1), V(vpos+1), &IONE, TAU(taupos) );
    /* apply left and right on A(st:ed,st:ed)*/
    magma_tally4_clarfxsym(len,A(st,st),LDX,V(vpos),TAU(taupos));
    //conjtmp = MAGMA_tally4_C_CNJG(*TAU(taupos));
    //lapackf77_clarfy("L", &len, V(vpos), &IONE, &conjtmp, A(st,st), &LDX, WORK); //&(MAGMA_tally4_C_CNJG(*TAU(taupos)))
    magma_tally4_free_cpu(WORK);
}
#undef A
#undef V
...
#define TAU(m)   &(TAU[(m)])
extern "C" void
magma_tally4_ctrdtype2cbHLsym_withQ(
    magma_tally4_int_t N, magma_tally4_int_t NB,
    magma_tally4FloatComplex *A, magma_tally4_int_t LDA,
    magma_tally4FloatComplex *V, magma_tally4FloatComplex *TAU,
    magma_tally4_int_t st, magma_tally4_int_t ed, magma_tally4_int_t sweep, magma_tally4_int_t Vblksiz)
{
    ...
    magma_tally4FloatComplex conjtmp;
    magma_tally4FloatComplex Z_ONE  =  MAGMA_tally4_C_ONE;
    //magma_tally4FloatComplex WORK[NB];
    magma_tally4FloatComplex *WORK;
    magma_tally4_cmalloc_cpu( &WORK, NB );
    ...
    if (lem > 1) {
        ...
        *V(vpos)  = Z_ONE;
        memcpy(V(vpos+1), A(J1+1, st), (lem-1)*sizeof(magma_tally4FloatComplex));
        memset(A(J1+1, st),0,(lem-1)*sizeof(magma_tally4FloatComplex));
...
#define TAU(m)   &(TAU[(m)])
extern "C" void
magma_tally4_ctrdtype3cbHLsym_withQ(
    magma_tally4_int_t N, magma_tally4_int_t NB,
    magma_tally4FloatComplex *A, magma_tally4_int_t LDA,
    magma_tally4FloatComplex *V, magma_tally4FloatComplex *TAU,
    magma_tally4_int_t st, magma_tally4_int_t ed, magma_tally4_int_t sweep, magma_tally4_int_t Vblksiz)
{
    ...
    magma_tally4_clarfxsym(len,A(st,st),LDX,V(vpos),TAU(taupos));
    //conjtmp = MAGMA_tally4_C_CNJG(*TAU(taupos));
    //lapackf77_clarfy("L", &len, V(vpos), &IONE,  &(MAGMA_tally4_C_CNJG(*TAU(taupos))), A(st,st), &LDX, WORK);
    magma_tally4_free_cpu(WORK);
}
#undef A
#undef V
