...
int main( int argc, char** argv)
{
    ...
    magma_tally2_int_t M, N, n2, lda, lwork, j, info, min_mn, nb;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            #if defined(PRECISION_z) || defined(PRECISION_c)
            magma_tally2_cgeqp3(M, N, h_R, lda, jpvt, tau, h_work, lwork, rwork, &info);
            #else
            magma_tally2_cgeqp3(M, N, h_R, lda, jpvt, tau, h_work, lwork, &info);
            #endif
