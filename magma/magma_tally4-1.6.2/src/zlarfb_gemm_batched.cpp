...
magma_tally4_zlarfb_gemm_batched_magem(
...
extern "C" magma_tally4_int_t
magma_tally4_zlarfb_gemm_batched_cugem(
    magma_tally4_side_t side, magma_tally4_trans_t trans, magma_tally4_direct_t direct, magma_tally4_storev_t storev,
    magma_tally4_int_t m, magma_tally4_int_t n, magma_tally4_int_t k,
    magma_tally4DoubleComplex_const_ptr dV_array[],    magma_tally4_int_t lddv,
    magma_tally4DoubleComplex_const_ptr dT_array[],    magma_tally4_int_t lddt,
    ...
    magma_tally4_int_t batchCount, cublasHandle_t myhandle, magma_tally4_queue_t queue)
{
    ...
    if(m >= 32 && n >= 32 && k >= 32)
    {
        magma_tally4_zlarfb_gemm_batched_magem(
            ...
            m, n,  k,
            (magma_tally4DoubleComplex_const_ptr *) dV_array, lddv,
            (magma_tally4DoubleComplex_const_ptr *) dT_array, lddt,
            dC_array, lddc,
            dwork_array, ldwork,
    ...
    magma_tally4_int_t batchCount, magma_tally4_queue_t queue)
{
    ...
    if ( side == Magma_tally4Left ) {
        ...
        // W = V' C                              
        magma_tally4blas_zgemm_batched( Magma_tally4_ConjTrans,notransV, /*NontransLeft*/
                     k, n, m,
                     c_one,  dV_array,    lddv,
                             dC_array,    lddc,
        ...
        if (m <= n) {
            // W2 = V T
            magma_tally4blas_zgemm_batched( notransV, trans, /* (NoTrans), trans(ConjTrans),*/
                         m, k, k,
                         c_one,  dV_array, lddv,
                                 dT_array, lddt,
        ...
        {
            // W2 = T W  = T  V' C
            magma_tally4blas_zgemm_batched( trans, Magma_tally4NoTrans,
                         k, n, k,
                         c_one,  dT_array, lddt,
                                 dwork_array, ldw,
                         c_zero, dworkvt_array, ldwvt, batchCount, queue);
            ...
            magma_tally4blas_zgemm_batched( notransV, Magma_tally4NoTrans,
                         m, n, k,
        ...
        // W = C V
        magma_tally4blas_zgemm_batched( Magma_tally4NoTrans, notransV,
                     m, k, n,
                     c_one,  dC_array,    lddc,
                             dV_array,    lddv,
                     c_zero, dwork_array, ldw, batchCount, queue);
        if (m <= n) {
            // W2 = W T = C V T
            magma_tally4blas_zgemm_batched( Magma_tally4NoTrans, trans,
                         m, k, k,
            ...
            magma_tally4blas_zgemm_batched( Magma_tally4NoTrans, transV,
                         m, n, k,
                         c_neg_one, dworkvt_array, ldwvt,
                                    dV_array,    lddv,
                         c_one,     dC_array,    lddc, batchCount, queue);
            ...
            // W2 = T V'
            magma_tally4blas_zgemm_batched( trans, transV,
                         k, n, k,
                         c_one,  dT_array, lddt,
                                 dV_array, lddv,
                         c_zero, dworkvt_array, ldwvt, batchCount, queue);
    ...
    magma_tally4_int_t batchCount, cublasHandle_t myhandle, magma_tally4_queue_t queue)
{
    ...
    if ( side == Magma_tally4Left ) {
        ...
        // W = V' C
        cublasZgemmBatched(myhandle, cublas_trans_const_tally4(Magma_tally4_ConjTrans), cublas_trans_const_tally4(notransV),
                     k, n, m,
                     &c_one,  (const magma_tally4DoubleComplex**)dV_array,    lddv,
                              (const magma_tally4DoubleComplex**)dC_array,    lddc,
                     &c_zero, dwork_array, ldw, batchCount);
        if (m <= n) {
            // W2 = V T
            cublasZgemmBatched(myhandle, cublas_trans_const_tally4(notransV), cublas_trans_const_tally4(trans),
                         m, k, k,
                         &c_one,  (const magma_tally4DoubleComplex**)dV_array, lddv,
                                  (const magma_tally4DoubleComplex**)dT_array, lddt,
                         &c_zero, dworkvt_array, ldwvt, batchCount);
            // C = C - W2 W = C - V T V' C = (I - V T V') C = H C
            cublasZgemmBatched(myhandle, cublas_trans_const_tally4(Magma_tally4NoTrans), cublas_trans_const_tally4(Magma_tally4NoTrans),
                         m, n, k,
                         &c_neg_one, (const magma_tally4DoubleComplex**)dworkvt_array,  ldwvt,
                                     (const magma_tally4DoubleComplex**)dwork_array,    ldw,
                         &c_one,     dC_array,       lddc, batchCount);
        } else {
            // W2 = T W  = T  V' C
            cublasZgemmBatched(myhandle, cublas_trans_const_tally4(trans), cublas_trans_const_tally4(Magma_tally4NoTrans),
                         k, n, k,
                         &c_one,  (const magma_tally4DoubleComplex**)dT_array, lddt,
                                  (const magma_tally4DoubleComplex**)dwork_array, ldw,
                         &c_zero, dworkvt_array, ldwvt, batchCount);
            // C = C - V W2 = C - V T V' C = (I - V T V') C = H C
            cublasZgemmBatched(myhandle, cublas_trans_const_tally4(notransV), cublas_trans_const_tally4(Magma_tally4NoTrans),
                         m, n, k,
                         &c_neg_one, (const magma_tally4DoubleComplex**)dV_array,  lddv,
                                     (const magma_tally4DoubleComplex**)dworkvt_array,  ldwvt,
                         &c_one,     dC_array,       lddc, batchCount);
        }
    }
    else {
        ...
        // W = C V
        cublasZgemmBatched(myhandle, cublas_trans_const_tally4(Magma_tally4NoTrans), cublas_trans_const_tally4(notransV),
                     m, k, n,
                     &c_one,  (const magma_tally4DoubleComplex**)dC_array,    lddc,
                              (const magma_tally4DoubleComplex**)dV_array,    lddv,
                     &c_zero, dwork_array, ldw, batchCount);
        if (m <= n) {
            // W2 = W T = C V T
           cublasZgemmBatched(myhandle, cublas_trans_const_tally4(Magma_tally4NoTrans), cublas_trans_const_tally4(trans),
                         m, k, k,
                         &c_one,  (const magma_tally4DoubleComplex**)dwork_array, ldw,
                                  (const magma_tally4DoubleComplex**)dT_array, lddt,
                         &c_zero, dworkvt_array, ldwvt, batchCount);
            // C = C - W2 V' = C - C V T V' = C (I - V T V') = C H
            cublasZgemmBatched(myhandle, cublas_trans_const_tally4(Magma_tally4NoTrans), cublas_trans_const_tally4(transV),
                         m, n, k,
                         &c_neg_one, (const magma_tally4DoubleComplex**)dworkvt_array, ldwvt,
                                     (const magma_tally4DoubleComplex**)dV_array,    lddv,
                         &c_one,     dC_array,    lddc, batchCount);
            ...
            // W2 = T V'
            cublasZgemmBatched(myhandle, cublas_trans_const_tally4(trans), cublas_trans_const_tally4(transV),
                         k, n, k,
                         &c_one,  (const magma_tally4DoubleComplex**)dT_array, lddt,
                                  (const magma_tally4DoubleComplex**)dV_array, lddv,
                         &c_zero, dworkvt_array, ldwvt, batchCount);
           ...
           cublasZgemmBatched(myhandle, cublas_trans_const_tally4(Magma_tally4NoTrans), cublas_trans_const_tally4(Magma_tally4NoTrans),
                         m, n, k,
                         &c_neg_one, (const magma_tally4DoubleComplex**)dwork_array,   ldw,
                                     (const magma_tally4DoubleComplex**)dworkvt_array, ldwvt,
                         &c_one,     dC_array,      lddc, batchCount);
        }
    }
