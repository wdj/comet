    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_minproduct_int_t nb = magma_minproduct_get_dbulge_nb(n, parallel_threads);
    magma_minproduct_int_t Vblksiz = magma_minproduct_dbulge_get_Vblksiz(n, nb, parallel_threads);
    ...
    magma_minproduct_int_t lq2 = magma_minproduct_dbulge_get_lq2(n, parallel_threads);
    ...
    double *dT1;
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_dmalloc( &dT1, n*nb)) {
        *info = MAGMA_minproduct_ERR_DEVICE_ALLOC;
        return *info;
    }
    magma_minproduct_dsytrd_sy2sb(uplo, n, nb, A, lda, &work[indtau1], &work[indwrk], llwork, dT1, info);
    ...
    double *dA[Magma_minproductMaxGPUs], *dT1[Magma_minproductMaxGPUs];
    ...
    for( magma_minproduct_int_t dev = 0; dev < ngpu; ++dev ) {
        ...
        // TODO check malloc
        magma_minproduct_dmalloc(&dA[dev], ldda*mlocal );
        magma_minproduct_dmalloc(&dT1[dev], (n*nb) );
    ...
    magma_minproduct_dsetmatrix_1D_col_bcyclic( n, n, A, lda, dA, ldda, ngpu, distblk );
    magma_minproduct_setdevice(0);
    timer_stop( time_dist );

    timer_start( time_band );
    if (ver == 30) {
        magma_minproduct_dsytrd_sy2sb_mgpu_spec(uplo, n, nb, A, lda, &work[indtau1], &work[indwrk], llwork, dA, ldda, dT1, nb, ngpu, distblk, streams, nstream, info);
    } else {
        magma_minproduct_dsytrd_sy2sb_mgpu(uplo, n, nb, A, lda, &work[indtau1], &work[indwrk], llwork, dA, ldda, dT1, nb, ngpu, distblk, streams, nstream, info);
    }
    ...
    magma_minproduct_dsytrd_sb2st(uplo, n, nb, Vblksiz, A2, lda2, w, &work[inde], &work[indV2], ldv, &work[indTAU2], wantz, &work[indT2], ldt);
    ...
    if (! wantz) {
        ...
        magma_minproduct_dstedx_m(ngpu, range, n, vl, vu, il, iu, w, &work[inde],
        ...
        magma_minproduct_dbulge_back_m(ngpu, uplo, n, nb, *m, Vblksiz, &work[indwrk + n * (il-1)], n,
        ...
        magma_minproduct_dormqr_m(ngpu, Magma_minproductLeft, Magma_minproductNoTrans, n-nb, *m, n-nb, A+nb, lda, &work[indtau1],
