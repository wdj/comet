...
int main( int argc, char** argv)
{
    ...
    magma_minproductFloatComplex *h_A, *h_R, *h_B, *h_X;
    magma_minproduct_int_t N, lda, ldb, info, sizeA, sizeB;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_R, magma_minproductFloatComplex, lda*N         );
            ...
            magma_minproduct_cposv( opts.uplo, N, opts.nrhs, h_R, lda, h_X, ldb, &info );
