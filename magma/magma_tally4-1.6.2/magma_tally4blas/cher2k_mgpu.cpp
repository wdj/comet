/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from zher2k_mgpu.cpp normal z -> c, Fri Jan 30 19:00:10 2015
       @author Mark Gates
       @author Azzam Haidar 
*/
...
/**
    ...
    trans    magma_tally4_trans_t.
      ...
      -     = Magma_tally4_ConjTrans:  C := alpha*A**H*B + conj( alpha )*B**H*A + beta*C.
    ...
    k        INTEGER.
             ...
             TRANS = Magma_tally4_ConjTrans, K specifies the number of rows of the
    ...
    ********************************************************************/
extern "C"
void magma_tally4blas_cher2k_mgpu2(
    ...
    magma_tally4_int_t ngpu, magma_tally4_int_t nb, magma_tally4_queue_t queues[][20], magma_tally4_int_t nqueue )
{
    ...
    if ( uplo != Magma_tally4Lower) {
        ...
        info = -4;
                ...
                ((trans == Magma_tally4_ConjTrans) && ldda < max(1,k)) ) {
        info = -7;
    } else if ( a_offset < 0 || a_offset > ldda ) {
        info = -8;
    } else if ( ((trans == Magma_tally4NoTrans)    && lddb < max(1,n)) ||
                ((trans == Magma_tally4_ConjTrans) && lddb < max(1,k)) ) {
        info = -10;
    ...
    magma_tally4FloatComplex cbeta = MAGMA_tally4_C_MAKE( beta, 0. );
    ...
    for( magma_tally4_int_t i = 0; i < n; i += ib ) {
        ...
        magma_tally4_cgemm( Magma_tally4NoTrans, Magma_tally4_ConjTrans, n-i, ib, k,
    ...
    alpha = MAGMA_tally4_C_CNJG( alpha );
