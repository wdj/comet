/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_z_blaswrapper.cpp normal z -> s, Sun May  3 11:22:57 2015
       @author Hartwig Anzt
    ...
    magma_tally2_queue_t queue )
{
    ...
    magma_tally2_s_matrix x2={Magma_tally2_CSR};
    ...
    if ( A.memory_location == Magma_tally2_DEV ) {
        if ( A.num_cols == x.num_rows && x.num_cols == 1 ) {
             ...
             if ( A.storage_type == Magma_tally2_CSR
                 ...
                 //magma_tally2_sgecsrmv( Magma_tally2NoTrans, A.num_rows, A.num_cols, alpha,
                ...
                cusparseScsrmv( cusparseHandle,CUSPARSE_OPERATION_NON_TRANSPOSE,
                 ...
                 CHECK( magma_tally2_sgeelltmv( Magma_tally2NoTrans, A.num_rows, A.num_cols,
                 ...
                 CHECK( magma_tally2_sgeellmv( Magma_tally2NoTrans, A.num_rows, A.num_cols,
                    A.max_nnz_row, alpha, A.dval, A.dcol, x.dval, beta,
                    y.dval, queue ));
                 //printf("done.\n");
             }
                 ...
                 CHECK( magma_tally2_sgeellrtmv( Magma_tally2NoTrans, A.num_rows, A.num_cols,
                 ...
                 CHECK( magma_tally2_sgesellpmv( Magma_tally2NoTrans, A.num_rows, A.num_cols,
                 ...
                 magma_tally2blas_sgemv( Magma_tally2NoTrans, A.num_rows, A.num_cols, alpha,
                 ...
                 //printf("using DENSE kernel for SpMV: ");
                 CHECK( magma_tally2_scustomspmv( alpha, x, beta, y, queue ));
                 //printf("done.\n");
             }
            ...
            if ( A.storage_type == Magma_tally2_CSR ) {
                ...
                if ( x.major == Magma_tally2RowMajor) {
                 CHECK( magma_tally2_smgesellpmv( Magma_tally2NoTrans, A.num_rows, A.num_cols,
                    num_vecs, A.blocksize, A.numblocks, A.alignment,
                    alpha, A.dval, A.dcol, A.drow, x.dval, beta, y.dval, queue ));
                }
                else if ( x.major == Magma_tally2ColMajor) {
                    // transpose first to row major
                    CHECK( magma_tally2_svtranspose( x, &x2, queue ));
                    CHECK( magma_tally2_smgesellpmv( Magma_tally2NoTrans, A.num_rows, A.num_cols,
                    num_vecs, A.blocksize, A.numblocks, A.alignment,
             ...
             /*if ( A.storage_type == Magma_tally2_DENSE ) {
                 //printf("using DENSE kernel for SpMV: ");
                 magma_tally2blas_smgemv( Magma_tally2NoTrans, A.num_rows, A.num_cols,
    ...
    magma_tally2_queue_t queue )
{
    ...
    if ( A.memory_location == Magma_tally2_DEV ) {
         if ( A.storage_type == Magma_tally2_CSR ) {
             //printf("using CSR kernel for SpMV: ");
             CHECK( magma_tally2_sgecsrmv_shift( Magma_tally2NoTrans, A.num_rows, A.num_cols,
             ...
             //printf("using ELLPACKT kernel for SpMV: ");
             CHECK( magma_tally2_sgeellmv_shift( Magma_tally2NoTrans, A.num_rows, A.num_cols,
             ...
             //printf("using ELL kernel for SpMV: ");
             CHECK( magma_tally2_sgeelltmv_shift( Magma_tally2NoTrans, A.num_rows, A.num_cols,
                A.max_nnz_row, alpha, lambda, A.dval, A.dcol, x.dval, beta, offset,
                blocksize, add_rows, y.dval, queue ));
             //printf("done.\n");
         }
    ...
    if ( A.memory_location == Magma_tally2_DEV ) {
        if ( A.num_cols == B.num_rows ) {
             ...
             if ( A.storage_type == Magma_tally2_CSR
                ...
                CHECK( magma_tally2_scuspmm( A, B, C, queue ));
