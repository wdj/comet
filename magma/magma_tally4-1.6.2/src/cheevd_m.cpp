    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
...
#else
        magma_tally4_cstedx_m(ngpu, Magma_tally4RangeAll, n, 0, 0, 0, 0, w, &rwork[inde],
                       &work[indwrk], n, &rwork[indrwk],
        ...
        magma_tally4_cunmtr_m(ngpu, Magma_tally4Left, uplo, Magma_tally4NoTrans, n, n, A, lda, &work[indtau],
