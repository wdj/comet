...
int main( int argc, char** argv)
{
    ...
    magma_tally4FloatComplex *h_A, *h_R, *h_work, aux_work[1];
    #ifdef COMPLEX
    ...
    magma_tally4_int_t N, n2, info, lwork, liwork, lda;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally4_cheevd( opts.jobz, opts.uplo,
                          N, NULL, lda, NULL,
                          aux_work,  -1,
                          #ifdef COMPLEX
                          aux_rwork, -1,
            ...
            if ( opts.warmup ) {
                magma_tally4_cheevd( opts.jobz, opts.uplo,
                              ...
                              &info );
                if (info != 0)
                    printf("magma_tally4_cheevd returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_tally4NoVec ) {
                ...
                //
                //lapackf77_clacpy( Magma_tally4FullStr, &N, &N, h_A, &lda, h_R, &lda );
                //magma_tally4_cheevd( Magma_tally4NoVec, opts.uplo,
                //              N, h_R, lda, w2,
                //              h_work, lwork,
                //              #ifdef COMPLEX
                //              rwork, lrwork,
