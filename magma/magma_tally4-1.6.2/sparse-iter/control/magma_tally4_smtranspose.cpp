/*
    -- MAGMA_tally4 (version 1.6.2) --
       ...
       @generated from magma_tally4_zmtranspose.cpp normal z -> s, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
       @author Mark Gates
    ...
    magma_tally4_queue_t queue )
{
    ...
    CHECK( magma_tally4_smalloc_cpu( &csc_values, nnz ) );
    ...
    magma_tally4_queue_t queue )
{
    ...
    magma_tally4_s_matrix ACSR={Magma_tally4_CSR}, BCSR={Magma_tally4_CSR};
    ...
    if( A.storage_type == Magma_tally4_CSR && A.memory_location == Magma_tally4_DEV ) {
        ...
        CHECK( magma_tally4_smtransfer( A, &A_d, A.memory_location, Magma_tally4_DEV, queue ));
        CHECK( magma_tally4_s_cucsrtranspose( A_d, &B_d, queue ));
        CHECK( magma_tally4_smtransfer( B_d, B, Magma_tally4_DEV, A.memory_location, queue ));
                
    }else {
        CHECK( magma_tally4_smconvert( A, &ACSR, A.storage_type, Magma_tally4_CSR, queue ));
        CHECK( magma_tally4_s_cucsrtranspose( ACSR, &BCSR, queue ));
        CHECK( magma_tally4_smconvert( BCSR, B, Magma_tally4_CSR, A.storage_type, queue ));
    }
cleanup:
    ...
    magma_tally4_smfree( &BCSR, queue );
    if( info != 0 ){
