...
cswapdblk_kernel( int nb,
                  magma_tally4FloatComplex *dA, int ldda, int inca,
                  magma_tally4FloatComplex *dB, int lddb, int incb )
{
...
/**
    @see magma_tally4blas_cswapdblk_q
    @ingroup magma_tally4_caux2
    ********************************************************************/
extern "C" void 
magma_tally4blas_cswapdblk(
    ...
    magma_tally4FloatComplex_ptr dB, magma_tally4_int_t lddb, magma_tally4_int_t incb )
{
    magma_tally4blas_cswapdblk_q( n, nb, dA, ldda, inca, dB, lddb, incb, magma_tally4_stream );
}
