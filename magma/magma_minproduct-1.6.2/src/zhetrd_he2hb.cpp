    ...
    magma_minproduct_int_t *info)
{
    ...
    magma_minproduct_int_t pm_old=0, pn_old=0, indi_old=0, indj_old=0;
    ...
    *info = 0;
    ...
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_zmalloc( &dA, (n + 2*nb)*ldda )) {
    ...
    magma_minproductDoubleComplex *dwork = dA + n*ldda;
    magma_minproductDoubleComplex *dW    = dwork + nb*ldda;
    ...
    magma_minproduct_event_t Pupdate_event;
    cudaEventCreateWithFlags(&Pupdate_event,cudaEventDisableTiming);
    //magma_minproduct_event_create(&Pupdate_event);
    ...
    if (upper) {
        ...
        if (1 <= n-nb) {
            ...
            magma_minproduct_zsetmatrix_async( (n-nb), (n-nb),
                                    A(nb+1, nb+1),  lda,
        ...
        for (i = 1; i <= n-nb; i += nb) {
             ...
             if (i > 1 ) {
                 ...
                 magma_minproduct_queue_wait_event(stream[1], Pupdate_event);  //, 0);
                 ...
                 magma_minproduct_zher2k(Magma_minproductLower, Magma_minproductNoTrans, pm_old-pn_old, pn_old, c_neg_one,
             ...
             if (i + nb <= n-nb) {
                 ...
                 magma_minproduct_zgemm(Magma_minproductNoTrans, Magma_minproductConjTrans, pm, pn, pn, c_neg_one,
                             ...
                             dA(indi, indi), ldda);
                 trace_gpu_end( 0, 2 );
                 magma_minproduct_event_record(Pupdate_event, stream[0]);
             }
             else {
    ...
    magma_minproduct_event_destroy( Pupdate_event );
