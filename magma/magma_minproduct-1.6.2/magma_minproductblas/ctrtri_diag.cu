    ...
    magma_minproduct_queue_t queue)
{
    ...
    cudaMemset( d_dinvA, 0, ((n+NB-1)/NB)*NB*NB * sizeof(magma_minproductFloatComplex) );
...
/**
    @see magma_minproductblas_ctrtri_diag_q
    @ingroup magma_minproduct_cblas3
    ********************************************************************/
extern "C" void
magma_minproductblas_ctrtri_diag(
    ...
    magma_minproductFloatComplex_ptr d_dinvA)
{
    magma_minproductblas_ctrtri_diag_q( uplo, diag, n, dA, ldda, d_dinvA, magma_minproduct_stream );
}
