...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_minproduct_dsyevd( opts.jobz, opts.uplo,
                          N, NULL, lda, NULL,
                          aux_work,  -1,
                          #ifdef COMPLEX
                          aux_rwork, -1,
                          ...
                          aux_iwork, -1,
                          &info );
            lwork  = (magma_minproduct_int_t) MAGMA_minproduct_D_REAL( aux_work[0] );
            #ifdef COMPLEX
            ...
            lapackf77_dlacpy( Magma_minproductFullStr, &N, &N, h_A, &lda, h_R, &lda );
            ...
            if ( opts.warmup ) {
                magma_minproduct_dsyevd( opts.jobz, opts.uplo,
                              ...
                              &info );
                if (info != 0)
                    printf("magma_minproduct_dsyevd returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_minproductNoVec ) {
                ...
                //
                //lapackf77_dlacpy( Magma_minproductFullStr, &N, &N, h_A, &lda, h_R, &lda );
                //magma_minproduct_dsyevd( Magma_minproductNoVec, opts.uplo,
                //              N, h_R, lda, w2,
                //              h_work, lwork,
                //              #ifdef COMPLEX
                //              rwork, lrwork,
