...
*  =====================================================================
     ...
     $                    LDVR, MM, M, WORK, LWORK, RWORK, INFO )
      IMPLICIT NONE
*     .. Scalar Arguments ..
      CHARACTER          HOWMNY, SIDE
      INTEGER            INFO, LDT, LDVL, LDVR, LWORK, M, MM, N
...
*     .. Local Scalars ..
      ...
      INTEGER            I, II, IS, J, K, KI, IV, NB, VERSION
...
*
      ...
      ELSE IF( MM.LT.M ) THEN
         INFO = -11
      ELSE IF( LWORK.LT.MAX( 1, 2*N ) ) THEN
         INFO = -14
      END IF
      IF( INFO.NE.0 ) THEN
...
**       print *, 'ztrevc3 blocked lwork', lwork, 'n', n, 'nb', nb
      ELSE
         VERSION = 1
**       print *, 'ztrevc3 non-blocked lwork', lwork,
**   $            'n', n, 'nbmin', nbmin
      END IF
*
