...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_A,       magma_minproductFloatComplex, lda*Ak  );
            TESTING_MALLOC_CPU( h_B,       magma_minproductFloatComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_X,       magma_minproductFloatComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_Blapack, magma_minproductFloatComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_Bcublas, magma_minproductFloatComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_Bmagma_minproduct,  magma_minproductFloatComplex, ldb*N   );
            TESTING_MALLOC_CPU( ipiv,      magma_minproduct_int_t,        Ak      );
            
            TESTING_MALLOC_DEV( d_A,       magma_minproductFloatComplex, ldda*Ak );
            TESTING_MALLOC_DEV( d_B,       magma_minproductFloatComplex, lddb*N  );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_minproduct_csetmatrix( Ak, Ak, h_A, lda, d_A, ldda );
            magma_minproduct_csetmatrix( M, N, h_B, ldb, d_B, lddb );
            
            magma_minproduct_time = magma_minproduct_sync_wtime( NULL );
            magma_minproductblas_ctrsm( opts.side, opts.uplo, opts.transA, opts.diag, 
                             M, N,
                             alpha, d_A, ldda,
                                    d_B, lddb );
            ...
            magma_minproduct_cgetmatrix( M, N, d_B, lddb, h_Bmagma_minproduct, ldb );
            ...
            magma_minproduct_cgetmatrix( M, N, d_B, lddb, h_Bcublas, ldb );
            ...
            normX = lapackf77_clange( "M", &M, &N, h_Bmagma_minproduct, &ldb, work );
