...
extern "C"
void dpanel_to_q(magma_minproduct_uplo_t uplo, magma_minproduct_int_t ib, double *A, magma_minproduct_int_t lda, double *work)
{
...
extern "C"
void dq_to_panel(magma_minproduct_uplo_t uplo, magma_minproduct_int_t ib, double *A, magma_minproduct_int_t lda, double *work)
{
    magma_minproduct_int_t i, j, k = 0;
    double *col;
