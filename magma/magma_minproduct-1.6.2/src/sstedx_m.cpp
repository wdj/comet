        ...
        if (alleig) {
            ...
            while ( start < n ) {
                ...
                if (m > smlsiz) {
                    ...
                    magma_minproduct_slaex0_m( ngpu, m, &d[start], &e[start], Z(start, start), ldz, work, iwork, Magma_minproductRangeAll, vl, vu, il, iu, info);
            ...
            magma_minproduct_slaex0_m(ngpu, n, d, e, Z, ldz, work, iwork, range, vl, vu, il, iu, info);
