...
# LAPACK to MAGMA_minproduct code.
...
#       ****************************************************************************************************
#       % MAGMA_minproduct 1.4.0 svn compiled for CUDA capability >= 3.0
#       % CUDA runtime 6000, driver 6000. MAGMA_minproduct not compiled with OpenMP.
