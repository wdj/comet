...
#define dL2(j)  (dL2 + (j)*ib*lddl         )
    ...
    *info = 0;
    ...
    if ( ib >= mindim ) {
        ...
        magma_tally2_ssetmatrix( mindim, mindim, hL2, ldhl, dL2, lddl );
#endif
        ...
        for( i=0; i < s; i++ ) {
            ...
            if ( i > 0 ) {
                // download i-th panel
                magma_tally2blas_stranspose( sb, m, AT(0,i), ldda, dwork, maxm );
                magma_tally2_sgetmatrix( m, sb, dwork, maxm, hA(0, i), ldha );
            ...
            magma_tally2blas_slaswp( n-ii, AT(0, i), ldda, ii+1, ii+sb, ipiv, 1 );
            ...
            magma_tally2_ssetmatrix( sb, sb, hL2(i), ldhl, dL2(i), lddl );
#endif
            // upload i-th panel
            magma_tally2_ssetmatrix( rows, sb, hA(i, i), ldha, dwork, cols );
            magma_tally2blas_stranspose( rows, sb, dwork, cols, AT(i,i), ldda );
