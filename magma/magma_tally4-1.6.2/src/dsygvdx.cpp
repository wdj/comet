    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally4_dsetmatrix_async( n, n,
                            A,  lda,
                            dA, ldda, stream );
    ...
    magma_tally4_dpotrf_gpu( uplo, n, dB, lddb, info );
    if (*info != 0) {
        *info = n + *info;
        return *info;
    }
    ...
    magma_tally4_dgetmatrix_async( n, n,
                            dB, lddb,
                            B,  ldb, stream );
    ...
    magma_tally4_dsygst_gpu( itype, uplo, n, dA, ldda, dB, lddb, info );
    ...
    timer_start( time );
    magma_tally4_dsyevdx_gpu( jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, mout, w, A, lda,
    ...
    if (wantz && *info == 0) {
        ...
        if (dB == NULL) {
            if (MAGMA_tally4_SUCCESS != magma_tally4_dmalloc( &dB, n*lddb ) ) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally4_dtrsm( Magma_tally4Left, uplo, trans, Magma_tally4NonUnit,
        ...
        magma_tally4_dgetmatrix( n, *mout, dA, ldda, A, lda );
