...
!
      ...
      magma_tally2_devptr_t                :: devptrA, devptrB
...
!---- Call magma_tally2 LU ----------------
      call magma_tally2_wtime_f(tstart)
      call magma_tally2f_cgetrf_gpu(n, n, devptrA, ldda, ipiv, info)
      call magma_tally2_wtime_f(tend)

      if ( info .ne. 0 )  then
         write(*,*) "Info : ", info
      end if

!---- Call magma_tally2 solve -------------
      call magma_tally2f_cgetrs_gpu('n', n, nrhs, devptrA, ldda, ipiv, devptrB, ldda, info)
