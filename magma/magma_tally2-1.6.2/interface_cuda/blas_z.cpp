...
*/
extern "C"
magma_tally2DoubleComplex magma_tally2_zdotc(
    magma_tally2_int_t n,
    magma_tally2DoubleComplex_const_ptr dx, magma_tally2_int_t incx,
...
*/
extern "C"
magma_tally2DoubleComplex magma_tally2_zdotu(
    magma_tally2_int_t n,
    magma_tally2DoubleComplex_const_ptr dx, magma_tally2_int_t incx,
    magma_tally2DoubleComplex_const_ptr dy, magma_tally2_int_t incy )
{
...
magma_tally2_zrotm(
    magma_tally2_int_t n,
    double *dx, magma_tally2_int_t incx,
    double *dy, magma_tally2_int_t incy,
    const double *param )
{
...
/** Perform Hermitian matrix-matrix product.
    ...
    @param[in]
    dA      COMPLEX_16 array on GPU device.
            If side == Magma_tally2Left, the m-by-m Hermitian matrix A of dimension (ldda,m), ldda >= max(1,m); \n
