/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zsymmetrize_tiles.cu normal z -> c, Fri Jan 30 19:00:09 2015
       @author Mark Gates
*/
...
*/
__global__ void
csymmetrize_tiles_lower( int m, magma_minproductFloatComplex *dA, int ldda, int mstride, int nstride )
{
    ...
    magma_minproductFloatComplex *dAT = dA;
    if ( i < m ) {
        dA  += i;
        dAT += i*ldda;
        magma_minproductFloatComplex *dAend = dA + i*ldda;
        while( dA < dAend ) {
...
__global__ void
csymmetrize_tiles_upper( int m, magma_minproductFloatComplex *dA, int ldda, int mstride, int nstride )
{
    // shift dA to tile's top-left corner
    dA += blockIdx.x*(mstride + nstride*ldda);
...
/**
    @see magma_minproductblas_csymmetrize_tiles_q
    @ingroup magma_minproduct_caux2
    ********************************************************************/
extern "C" void
magma_minproductblas_csymmetrize_tiles(
    ...
    magma_minproduct_int_t ntile, magma_minproduct_int_t mstride, magma_minproduct_int_t nstride )
{
    magma_minproductblas_csymmetrize_tiles_q( uplo, m, dA, ldda, ntile, mstride, nstride, magma_minproduct_stream );
}
