    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally4_dstedx( Magma_tally4RangeAll, n, 0., 0., 0, 0, w, &work[inde],
        ...
        magma_tally4_dsetmatrix( n, n, &work[indwrk], n, dwork, lddc );

        magma_tally4_dormtr_gpu( Magma_tally4Left, uplo, Magma_tally4NoTrans, n, n, dA, ldda, &work[indtau],
                          dwork, lddc, wA, ldwa, &iinfo );

        magma_tally4_dcopymatrix( n, n, dwork, lddc, dA, ldda );
