/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from magma_minproduct_zlapack.h normal z -> d, Fri Jan 30 19:00:06 2015
*/

#ifndef MAGMA_minproduct_DLAPACK_H
#define MAGMA_minproduct_DLAPACK_H
 ...
 */
magma_minproduct_int_t blasf77_idamax(
                     const magma_minproduct_int_t *n,
                     const double *x, const magma_minproduct_int_t *incx );

void blasf77_daxpy(  const magma_minproduct_int_t *n,
                     const double *alpha,
                     const double *x, const magma_minproduct_int_t *incx,
                           double *y, const magma_minproduct_int_t *incy );

void blasf77_dcopy(  const magma_minproduct_int_t *n,
                     const double *x, const magma_minproduct_int_t *incx,
                           double *y, const magma_minproduct_int_t *incy );

void blasf77_dgemm(  const char *transa, const char *transb,
                     const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                     const double *alpha,
                     const double *A, const magma_minproduct_int_t *lda,
                     const double *B, const magma_minproduct_int_t *ldb,
                     const double *beta,
                           double *C, const magma_minproduct_int_t *ldc );

void blasf77_dgemv(  const char *transa,
                     const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                     const double *alpha,
                     const double *A, const magma_minproduct_int_t *lda,
                     const double *x, const magma_minproduct_int_t *incx,
                     const double *beta,
...
void blasf77_dger(  const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                     const double *alpha,
                     const double *x, const magma_minproduct_int_t *incx,
                     const double *y, const magma_minproduct_int_t *incy,
                           double *A, const magma_minproduct_int_t *lda );
...
void blasf77_dsyr2k( const char *uplo, const char *trans,
                     const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                     const double *alpha,
                     const double *A, const magma_minproduct_int_t *lda,
                     const double *B, const magma_minproduct_int_t *ldb,
                     const double *beta,
...
void blasf77_dscal(  const magma_minproduct_int_t *n,
                     const double *alpha,
                           double *x, const magma_minproduct_int_t *incx );

void blasf77_dscal( const magma_minproduct_int_t *n,
                     const double *alpha,
                           double *x, const magma_minproduct_int_t *incx );

void blasf77_dswap(  const magma_minproduct_int_t *n,
                     double *x, const magma_minproduct_int_t *incx,
                     double *y, const magma_minproduct_int_t *incy );
...
void blasf77_drot(   const magma_minproduct_int_t *n,
                     double *x, const magma_minproduct_int_t *incx,
                     double *y, const magma_minproduct_int_t *incy,
...
void blasf77_dtrmm(  const char *side, const char *uplo, const char *transa, const char *diag,
                     ...
                     const double *alpha,
                     const double *A, const magma_minproduct_int_t *lda,
                           double *B, const magma_minproduct_int_t *ldb );
...
/* ////////////////////////////////////////////////////////////////////////////
 -- MAGMA_minproduct wrappers around BLAS functions (alphabetical order)
    The Fortran interface for these is not portable, so we
    provide a C interface identical to the Fortran interface.
*/

double magma_minproduct_cblas_dasum(
    magma_minproduct_int_t n,
    const double *x, magma_minproduct_int_t incx );

double magma_minproduct_cblas_dnrm2(
    magma_minproduct_int_t n,
    const double *x, magma_minproduct_int_t incx );

double magma_minproduct_cblas_ddot(
    magma_minproduct_int_t n,
    const double *x, magma_minproduct_int_t incx,
    const double *y, magma_minproduct_int_t incy );
...
void   lapackf77_dbdsdc( const char *uplo, const char *compq,
                         const magma_minproduct_int_t *n,
                         double *d, double *e,
                         double *U,  const magma_minproduct_int_t *ldu,
                         double *VT, const magma_minproduct_int_t *ldvt,
                         double *Q, magma_minproduct_int_t *IQ,
                         double *work, magma_minproduct_int_t *iwork,
                         magma_minproduct_int_t *info );
#endif

void   lapackf77_dbdsqr( const char *uplo,
                         const magma_minproduct_int_t *n, const magma_minproduct_int_t *ncvt, const magma_minproduct_int_t *nru,  const magma_minproduct_int_t *ncc,
                         double *d, double *e,
                         double *Vt, const magma_minproduct_int_t *ldvt,
                         double *U, const magma_minproduct_int_t *ldu,
                         double *C, const magma_minproduct_int_t *ldc,
...
void   lapackf77_dgebak( const char *job, const char *side,
                         const magma_minproduct_int_t *n,
                         const magma_minproduct_int_t *ilo, const magma_minproduct_int_t *ihi,
                         const double *scale, const magma_minproduct_int_t *m,
                         double *V, const magma_minproduct_int_t *ldv,
                         magma_minproduct_int_t *info );

void   lapackf77_dgebal( const char *job,
                         const magma_minproduct_int_t *n,
                         double *A, const magma_minproduct_int_t *lda,
                         magma_minproduct_int_t *ilo, magma_minproduct_int_t *ihi,
                         double *scale,
                         magma_minproduct_int_t *info );

void   lapackf77_dgebd2( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         double *A, const magma_minproduct_int_t *lda,
                         double *d, double *e,
                         double *tauq,
                         double *taup,
...
void   lapackf77_dgebrd( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         double *A, const magma_minproduct_int_t *lda,
                         double *d, double *e,
                         double *tauq,
                         double *taup,
                         double *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_dgbbrd( const char *vect, const magma_minproduct_int_t *m,
                         const magma_minproduct_int_t *n, const magma_minproduct_int_t *ncc,
                         const magma_minproduct_int_t *kl, const magma_minproduct_int_t *ku,
                         double *Ab, const magma_minproduct_int_t *ldab,
                         double *d, double *e,
                         double *Q, const magma_minproduct_int_t *ldq,
                         double *PT, const magma_minproduct_int_t *ldpt,
                         double *C, const magma_minproduct_int_t *ldc,
                         double *work,
                         #ifdef COMPLEX
                         double *rwork,
...
void   lapackf77_dgeev(  const char *jobvl, const char *jobvr,
                         ...
                         double *wr, double *wi,
                         #endif
                         double *Vl,   const magma_minproduct_int_t *ldvl,
                         double *Vr,   const magma_minproduct_int_t *ldvr,
                         double *work, const magma_minproduct_int_t *lwork,
                         #ifdef COMPLEX
                         double *rwork,
                         #endif
...
void   lapackf77_dgehd2( const magma_minproduct_int_t *n,
                         const magma_minproduct_int_t *ilo, const magma_minproduct_int_t *ihi,
                         double *A, const magma_minproduct_int_t *lda,
                         double *tau,
                         double *work,
...
void   lapackf77_dgehrd( const magma_minproduct_int_t *n,
                         const magma_minproduct_int_t *ilo, const magma_minproduct_int_t *ihi,
                         double *A, const magma_minproduct_int_t *lda,
                         double *tau,
                         double *work, const magma_minproduct_int_t *lwork,
...
void   lapackf77_dgelqf( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         double *A, const magma_minproduct_int_t *lda,
                         double *tau,
                         double *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );
...
void   lapackf77_dgels(  const char *trans,
                         const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *nrhs,
                         double *A, const magma_minproduct_int_t *lda,
                         double *B, const magma_minproduct_int_t *ldb,
                         double *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_dgeqlf( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         double *A, const magma_minproduct_int_t *lda,
                         double *tau,
                         double *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_dgeqp3( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         double *A, const magma_minproduct_int_t *lda,
...
void   lapackf77_dgeqrf( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         double *A, const magma_minproduct_int_t *lda,
                         double *tau,
                         double *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );
...
void   lapackf77_dgesdd( const char *jobz,
                         ...
                         double *rwork,
                         #endif
                         magma_minproduct_int_t *iwork, magma_minproduct_int_t *info );

void   lapackf77_dgesv(  const magma_minproduct_int_t *n, const magma_minproduct_int_t *nrhs,
                         double *A, const magma_minproduct_int_t *lda,
...
void   lapackf77_dgetrf( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         double *A, const magma_minproduct_int_t *lda,
                         magma_minproduct_int_t *ipiv,
                         magma_minproduct_int_t *info );

void   lapackf77_dgetri( const magma_minproduct_int_t *n,
                         double *A, const magma_minproduct_int_t *lda,
                         const magma_minproduct_int_t *ipiv,
                         double *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_dgetrs( const char *trans,
                         const magma_minproduct_int_t *n, const magma_minproduct_int_t *nrhs,
                         const double *A, const magma_minproduct_int_t *lda,
                         const magma_minproduct_int_t *ipiv,
                         double *B, const magma_minproduct_int_t *ldb,
                         magma_minproduct_int_t *info );

void   lapackf77_dsytf2( const char*, magma_minproduct_int_t*, 
                         double*, magma_minproduct_int_t*, magma_minproduct_int_t*, magma_minproduct_int_t* );
...
void   lapackf77_dsbtrd( const char *vect, const char *uplo,
                         const magma_minproduct_int_t *n, const magma_minproduct_int_t *kd,
                         double *Ab, const magma_minproduct_int_t *ldab,
                         double *d, double *e,
                         double *Q, const magma_minproduct_int_t *ldq,
                         double *work,
...
void   lapackf77_dsyevd( const char *jobz, const char *uplo,
                         ...
                         double *work, const magma_minproduct_int_t *lwork,
                         #ifdef COMPLEX
                         double *rwork, const magma_minproduct_int_t *lrwork,
                         #endif
                         magma_minproduct_int_t *iwork, const magma_minproduct_int_t *liwork,
                         magma_minproduct_int_t *info );
...
void   lapackf77_dsyevr( const char *jobz, const char *range, const char *uplo,
                         ...
                         double *A, const magma_minproduct_int_t *lda,
                         double *vl, double *vu, 
                         magma_minproduct_int_t *il, magma_minproduct_int_t *iu, double *abstol, 
                         magma_minproduct_int_t *m, double *w, double *z__, 
                         magma_minproduct_int_t *ldz, magma_minproduct_int_t *isuppz, 
...
void   lapackf77_dsyevx( const char *jobz, const char *range, const char *uplo,
                         ...
                         magma_minproduct_int_t *il, magma_minproduct_int_t *iu, double *abstol,
                         magma_minproduct_int_t *m, double *w, double *z__,
                         magma_minproduct_int_t *ldz, double *work, magma_minproduct_int_t *lwork,
                         double *rwork, magma_minproduct_int_t *iwork, magma_minproduct_int_t *ifail, magma_minproduct_int_t *info);

void   lapackf77_dsygs2( const magma_minproduct_int_t *itype, const char *uplo,
                         const magma_minproduct_int_t *n,
                         double *A, const magma_minproduct_int_t *lda,
                         double *B, const magma_minproduct_int_t *ldb,
                         magma_minproduct_int_t *info );

void   lapackf77_dsygst( const magma_minproduct_int_t *itype, const char *uplo,
                         const magma_minproduct_int_t *n,
                         double *A, const magma_minproduct_int_t *lda,
                         double *B, const magma_minproduct_int_t *ldb,
                         magma_minproduct_int_t *info );

void   lapackf77_dsygvd( const magma_minproduct_int_t *itype, const char *jobz, const char *uplo,
                         const magma_minproduct_int_t *n,
                         double *A, const magma_minproduct_int_t *lda,
                         double *B, const magma_minproduct_int_t *ldb,
                         double *w,
...
void   lapackf77_dsysv( const char *uplo, 
                        const magma_minproduct_int_t *n, const magma_minproduct_int_t *nrhs,
                        double *A, const magma_minproduct_int_t *lda, magma_minproduct_int_t *ipiv,
                        double *B, const magma_minproduct_int_t *ldb,
                        double *work, const magma_minproduct_int_t *lwork,
                        magma_minproduct_int_t *info );
...
void   lapackf77_dhseqr( const char *job, const char *compz,
                         const magma_minproduct_int_t *n,
                         const magma_minproduct_int_t *ilo, const magma_minproduct_int_t *ihi,
                         double *H, const magma_minproduct_int_t *ldh,
                         #ifdef COMPLEX
                         double *w,
                         #else
                         double *wr, double *wi,
                         #endif
                         double *Z, const magma_minproduct_int_t *ldz,
                         double *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_dlabrd( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *nb,
                         double *A, const magma_minproduct_int_t *lda,
                         double *d, double *e,
                         double *tauq,
                         double *taup,
                         double *X, const magma_minproduct_int_t *ldx,
                         double *Y, const magma_minproduct_int_t *ldy );

#ifdef COMPLEX
void   lapackf77_dlacgv( const magma_minproduct_int_t *n,
                         double *x, const magma_minproduct_int_t *incx );
#endif
...
#ifdef COMPLEX
void   lapackf77_dlacrm( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         const double *A, const magma_minproduct_int_t *lda,
                         const double             *B, const magma_minproduct_int_t *ldb,
                         double       *C, const magma_minproduct_int_t *ldc,
                         double *rwork );
...
void   lapackf77_dlasyf( const char *uplo,
                         const magma_minproduct_int_t *n, const magma_minproduct_int_t *kn,
                         magma_minproduct_int_t *kb,
                         double *A, const magma_minproduct_int_t lda,
                         magma_minproduct_int_t *ipiv,
                         double *work, const magma_minproduct_int_t *ldwork,
                         magma_minproduct_int_t *info );
...
double lapackf77_dlanst( const char *norm, const magma_minproduct_int_t *n,
...
void   lapackf77_dlaqp2( magma_minproduct_int_t *m, magma_minproduct_int_t *n, magma_minproduct_int_t *offset,
                         double *a, magma_minproduct_int_t *lda, magma_minproduct_int_t *jpvt,
                         double *tau,
                         double *vn1, double *vn2,
                         double *work );

#ifdef COMPLEX
void   lapackf77_dlarcm( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         const double             *A, const magma_minproduct_int_t *lda,
                         const double *B, const magma_minproduct_int_t *ldb,
                         double       *C, const magma_minproduct_int_t *ldc,
                         double *rwork );
...
void   lapackf77_dlarf(  const char *side, const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         double *v, const magma_minproduct_int_t *incv,
                         double *tau,
                         double *C, const magma_minproduct_int_t *ldc,
                         double *work );
...
void   lapackf77_dlarfb( const char *side, const char *trans, const char *direct, const char *storev,
                         const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         const double *V, const magma_minproduct_int_t *ldv,
                         const double *T, const magma_minproduct_int_t *ldt,
                         double *C, const magma_minproduct_int_t *ldc,
                         double *work, const magma_minproduct_int_t *ldwork );

void   lapackf77_dlarfg( const magma_minproduct_int_t *n,
                         double *alpha,
                         double *x, const magma_minproduct_int_t *incx,
                         double *tau );
...
void   lapackf77_dlarft( const char *direct, const char *storev,
                         ...
                         double *V, const magma_minproduct_int_t *ldv,
                         const double *tau,
                         double *T, const magma_minproduct_int_t *ldt );

void   lapackf77_dlarnv( const magma_minproduct_int_t *idist, magma_minproduct_int_t *iseed, const magma_minproduct_int_t *n,
                         double *x );
...
void   lapackf77_dlaswp( const magma_minproduct_int_t *n,
                         double *A, const magma_minproduct_int_t *lda,
                         const magma_minproduct_int_t *k1, const magma_minproduct_int_t *k2,
                         magma_minproduct_int_t *ipiv,
                         const magma_minproduct_int_t *incx );

void   lapackf77_dlatrd( const char *uplo,
                         const magma_minproduct_int_t *n, const magma_minproduct_int_t *nb,
                         double *A, const magma_minproduct_int_t *lda,
                         double *e,
                         double *tau,
                         double *work, const magma_minproduct_int_t *ldwork );
...
void   lapackf77_dlatrs( const char *uplo, const char *trans, const char *diag,
                         ...
                         double *cnorm, magma_minproduct_int_t *info );
...
void   lapackf77_dstein( const magma_minproduct_int_t *n,
                         const double *d, const double *e,
                         const magma_minproduct_int_t *m,
                         const double *w,
                         const magma_minproduct_int_t *iblock,
                         const magma_minproduct_int_t *isplit,
                         double *Z, const magma_minproduct_int_t *ldz,
                         double *work, magma_minproduct_int_t *iwork, magma_minproduct_int_t *ifailv,
                         magma_minproduct_int_t *info );
...
void   lapackf77_dstemr( const char *jobz, const char *range,
                         ...
                         const magma_minproduct_int_t *il, const magma_minproduct_int_t *iu,
                         magma_minproduct_int_t *m,
                         double *w,
                         double *Z, const magma_minproduct_int_t *ldz,
                         const magma_minproduct_int_t *nzc, magma_minproduct_int_t *isuppz, magma_minproduct_int_t *tryrac,
                         double *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *iwork, const magma_minproduct_int_t *liwork,
                         magma_minproduct_int_t *info );
...
void   lapackf77_dtrevc( const char *side, const char *howmny,
                         magma_minproduct_int_t *select, const magma_minproduct_int_t *n,
                         double *T,  const magma_minproduct_int_t *ldt,
                         double *Vl, const magma_minproduct_int_t *ldvl,
                         double *Vr, const magma_minproduct_int_t *ldvr,
                         const magma_minproduct_int_t *mm, magma_minproduct_int_t *m,
                         double *work,
                         #ifdef COMPLEX
                         double *rwork,
                         #endif
...
void   lapackf77_dtrevc3( const char *side, const char *howmny,
                          ...
                          double *VL, const magma_minproduct_int_t *ldvl, 
                          double *VR, const magma_minproduct_int_t *ldvr,
                          const magma_minproduct_int_t *mm,
                          const magma_minproduct_int_t *mout,
                          double *work, const magma_minproduct_int_t *lwork,
                          #ifdef COMPLEX
                          double *rwork,
                          #endif
...
void   lapackf77_dorg2r( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         double *A, const magma_minproduct_int_t *lda,
                         const double *tau,
                         double *work,
                         magma_minproduct_int_t *info );
...
void   lapackf77_dorghr( const magma_minproduct_int_t *n,
                         const magma_minproduct_int_t *ilo, const magma_minproduct_int_t *ihi,
                         double *A, const magma_minproduct_int_t *lda,
                         const double *tau,
                         double *work, const magma_minproduct_int_t *lwork,
...
void   lapackf77_dorglq( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         double *A, const magma_minproduct_int_t *lda,
                         const double *tau,
                         double *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_dorgql( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         double *A, const magma_minproduct_int_t *lda,
                         const double *tau,
                         double *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_dorgqr( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         double *A, const magma_minproduct_int_t *lda,
                         const double *tau,
                         double *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );
...
void   lapackf77_dstebz( const char *range, const char *order,
                         ...
                         double *abstol,
                         double *d, double *e,
                         const magma_minproduct_int_t *m, const magma_minproduct_int_t *nsplit,
                         double *w,
                         magma_minproduct_int_t *iblock, magma_minproduct_int_t *isplit,
                         double *work,
                         magma_minproduct_int_t *iwork,
                         magma_minproduct_int_t *info );

void   lapackf77_dlaln2( const magma_minproduct_int_t *ltrans,
                         const magma_minproduct_int_t *na, const magma_minproduct_int_t *nw,
                         ...
                         double *x, const magma_minproduct_int_t *ldx,
                         double *scale, double *xnorm, magma_minproduct_int_t *info );

double lapackf77_dlamc3( double *a, double *b );

void   lapackf77_dlamrg( magma_minproduct_int_t *n1, magma_minproduct_int_t *n2,
                         double *a,
                         magma_minproduct_int_t *dtrd1, magma_minproduct_int_t *dtrd2, magma_minproduct_int_t *index );

double lapackf77_dlapy3( double *x, double *y, double *z );

void   lapackf77_dlaed2( magma_minproduct_int_t *k, magma_minproduct_int_t *n, magma_minproduct_int_t *cutpnt,
                         double *d, double *q, magma_minproduct_int_t *ldq, magma_minproduct_int_t *indxq,
                         double *rho, double *z,
                         double *dlmda, double *w, double *q2,
                         magma_minproduct_int_t *indx, magma_minproduct_int_t *indxc, magma_minproduct_int_t *indxp,
                         magma_minproduct_int_t *coltyp, magma_minproduct_int_t *info);

void   lapackf77_dlaed4( magma_minproduct_int_t *n, magma_minproduct_int_t *i,
                         double *d,
                         double *z,
                         double *delta,
                         double *rho,
                         double *dlam, magma_minproduct_int_t *info );

void   lapackf77_dlasrt( const char *id, const magma_minproduct_int_t *n, double *d, magma_minproduct_int_t *info );

/*
 * Testing functions
 */
#ifdef COMPLEX
void   lapackf77_dbdt01( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *kd,
                         double *A, const magma_minproduct_int_t *lda,
                         double *Q, const magma_minproduct_int_t *ldq,
                         double *d, double *e,
                         double *Pt, const magma_minproduct_int_t *ldpt,
...
void   lapackf77_dget22( const char *transa, const char *transe, const char *transw, const magma_minproduct_int_t *n,
                         double *A, const magma_minproduct_int_t *lda,
                         double *E, const magma_minproduct_int_t *lde,
                         double *w,
                         double *work,
                         double *rwork,
                         double *result );

void   lapackf77_dsyt21( const magma_minproduct_int_t *itype, const char *uplo,
...
void   lapackf77_dhst01( const magma_minproduct_int_t *n, const magma_minproduct_int_t *ilo, const magma_minproduct_int_t *ihi,
                         double *A, const magma_minproduct_int_t *lda,
                         double *H, const magma_minproduct_int_t *ldh,
                         double *Q, const magma_minproduct_int_t *ldq,
                         double *work, const magma_minproduct_int_t *lwork,
...
void   lapackf77_dstt21( const magma_minproduct_int_t *n, const magma_minproduct_int_t *kband,
                         double *AD,
                         double *AE,
                         double *SD,
                         double *SE,
...
void   lapackf77_dort01( const char *rowcol, const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         double *U, const magma_minproduct_int_t *ldu,
                         double *work, const magma_minproduct_int_t *lwork,
                         double *rwork,
                         double *resid );
...
void   lapackf77_dsyt21( magma_minproduct_int_t *itype, const char *uplo, const magma_minproduct_int_t *n, const magma_minproduct_int_t *kband,
                         double *A, const magma_minproduct_int_t *lda,
                         double *d, double *e,
                         double *U, const magma_minproduct_int_t *ldu,
                         double *V, const magma_minproduct_int_t *ldv,
...
void   lapackf77_dlarfy( const char *uplo, const magma_minproduct_int_t *n,
                         double *V, const magma_minproduct_int_t *incv,
                         double *tau,
                         double *C, const magma_minproduct_int_t *ldc,
                         double *work );

void   lapackf77_dlarfx( const char *side, const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         double *V,
                         double *tau,
                         double *C, const magma_minproduct_int_t *ldc,
                         double *work );

double lapackf77_dqpt01( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         double *A,
                         double *Af, const magma_minproduct_int_t *lda,
                         double *tau, magma_minproduct_int_t *jpvt,
                         double *work, const magma_minproduct_int_t *lwork );

void   lapackf77_dqrt02( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         double *A,
                         double *AF,
                         double *Q,
                         double *R, const magma_minproduct_int_t *lda,
                         double *tau,
                         double *work, const magma_minproduct_int_t *lwork,
                         double *rwork,
                         double *result );

void   lapackf77_dlatms( magma_minproduct_int_t *m, magma_minproduct_int_t *n,
                         ...
                         double *a, magma_minproduct_int_t *lda, double *work, magma_minproduct_int_t *info );
...
#endif /* MAGMA_minproduct_DLAPACK_H */
