    ...
    magma_tally3FloatComplex *A, int lda )
{
    ...
    bool full = (iby + BLK_Y <= n && (ind >= iby + BLK_Y || ind + BLK_X <= iby || MAGMA_tally3_C_EQUAL( offdiag, diag )));
...
void claset_full_kernel(
    int m, int n,
    magma_tally3FloatComplex offdiag, magma_tally3FloatComplex diag,
    magma_tally3FloatComplex *dA, int ldda )
{
...
void claset_full_kernel_batched(
    int m, int n,
    magma_tally3FloatComplex offdiag, magma_tally3FloatComplex diag,
    magma_tally3FloatComplex **dAarray, int ldda )
{
...
/**
    ...
    ********************************************************************/
extern "C"
void magma_tally3blas_claset_q(
    ...
    magma_tally3_queue_t queue)
{
    ...
    if (uplo == Magma_tally3Lower) {
        ...
        if ( m == ldda &&
             MAGMA_tally3_C_EQUAL( offdiag, MAGMA_tally3_C_ZERO ) &&
             MAGMA_tally3_C_EQUAL( diag,    MAGMA_tally3_C_ZERO ) )
        {
            size_t size = m*n;
            cudaError_t err = cudaMemsetAsync( dA, 0, size*sizeof(magma_tally3FloatComplex), queue );
...
/**
    @see magma_tally3blas_claset_q
    @ingroup magma_tally3_caux2
    ********************************************************************/
extern "C"
void magma_tally3blas_claset(
    magma_tally3_uplo_t uplo, magma_tally3_int_t m, magma_tally3_int_t n,
    magma_tally3FloatComplex offdiag, magma_tally3FloatComplex diag,
    magma_tally3FloatComplex_ptr dA, magma_tally3_int_t ldda )
{
    magma_tally3blas_claset_q( uplo, m, n, offdiag, diag, dA, ldda, magma_tally3_stream );
}


////////////////////////////////////////////////////////////////////////////////////////
extern "C"
void magma_tally3blas_claset_batched(
    magma_tally3_uplo_t uplo, magma_tally3_int_t m, magma_tally3_int_t n,
    magma_tally3FloatComplex offdiag, magma_tally3FloatComplex diag,
