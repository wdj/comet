...
/**
    ...
    @ingroup magma_minproduct_ssygv_driver
    ********************************************************************/
    ...
    magma_minproduct_int_t *info)
{
    ...
    float d_one = MAGMA_minproduct_S_ONE;
    ...
    *info = 0;
    ...
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_smalloc( &dA, n*ldda ) ||
        MAGMA_minproduct_SUCCESS != magma_minproduct_smalloc( &dB, n*lddb )) {
        *info = MAGMA_minproduct_ERR_DEVICE_ALLOC;
        return *info;
    }

    /* Form a Cholesky factorization of B. */
    magma_minproduct_ssetmatrix( n, n, B, ldb, dB, lddb );
    magma_minproduct_ssetmatrix_async( n, n,
                            A,  lda,
                            dA, ldda, stream );
    ...
    magma_minproduct_spotrf_gpu(uplo, n, dB, lddb, info);
    if (*info != 0) {
        *info = n + *info;
        return *info;
    }
    ...
    magma_minproduct_sgetmatrix_async( n, n,
                            dB, lddb,
                            B,  ldb, stream );
    ...
    magma_minproduct_ssygst_gpu(itype, uplo, n, dA, ldda, dB, lddb, info);

    timer_stop( time );
    timer_printf( "time ssygst_gpu = %6.2f\n", time );

    magma_minproduct_sgetmatrix( n, n, dA, ldda, A, lda );
    magma_minproduct_queue_sync( stream );
    ...
    magma_minproduct_ssyevdx_2stage(jobz, range, uplo, n, A, lda, vl, vu, il, iu, m, w, work, lwork, iwork, liwork, info);
    ...
    if (wantz && *info == 0) {
        ...
        magma_minproduct_ssetmatrix( n, *m, A, lda, dA, ldda );
        magma_minproduct_ssetmatrix( n,  n, B, ldb, dB, lddb );
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_minproduct_strsm(Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_minproduct_strmm(Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }

        magma_minproduct_sgetmatrix( n, *m, dA, ldda, A, lda );
