    ...
    double *C, magma_minproduct_int_t ldc )
{
    ...
    if ( alpha == 0.0 ) {
        if ( beta == 0.0 ) {
            magma_minproductblas_dgemm_ab_0(
                C, A, B, m, n, k, lda, ldb, ldc, alpha, beta );
            return;
        }
        else {
            magma_minproductblas_dgemm_a_0(
                C, A, B, m, n, k, lda, ldb, ldc, alpha, beta );
            return;
        }
    }
    ...
    if ( transA == Magma_minproductNoTrans ) {
        if ( transB == Magma_minproductNoTrans ) {
            ...
            if ( m > 512 && n > 512 ) {
                if ( m % 64 == 0 && n % 16 == 0 && k % 16 == 0 )
                    magma_minproductblas_dgemm_N_N_64_16_16_16_4_special(
                        C, A, B, m, n, k, lda, ldb, ldc, alpha, beta );
                else
                    magma_minproductblas_dgemm_N_N_64_16_16_16_4(
                        C, A, B, m, n, k, lda, ldb, ldc, alpha, beta );
            }
            else {
                magma_minproduct_dgemm(transA, transB,
            ...
            if ( m > 512 && n > 512 ) {
                ...
                //    magma_minproductblas_dgemm_N_T_64_16_4_16_4(
                //        C, A, B, m, n, k, lda, ldb, ldc, alpha, beta );
                //else
                    magma_minproductblas_dgemm_N_T_64_16_4_16_4(
                        C, A, B, m, n, k, lda, ldb, ldc, alpha, beta );
        ...
        if ( transB == Magma_minproductNoTrans ) {
            ...
            if ( m > 512 && n > 512 ) {
                ...
                //    magma_minproductblas_dgemm_T_N_32_32_8_8_8(
                //        C, A, B, m, n, k, lda, ldb, ldc, alpha, beta );
                //else
                    magma_minproductblas_dgemm_T_N_32_32_8_8_8(
                        C, A, B, m, n, k, lda, ldb, ldc, alpha, beta );
            ...
            if ( m > 512 && n > 512 ) {
                if ( m % 64 == 0 && n % 16 == 0 && k % 16 == 0 )
                    magma_minproductblas_dgemm_T_T_64_16_16_16_4_special(
                        C, B, A, n, m, k, ldb, lda, ldc, alpha, beta );
                else
                    magma_minproductblas_dgemm_T_T_64_16_16_16_4(
                        C, B, A, n, m, k, ldb, lda, ldc, alpha, beta );
            }
            else {
                magma_minproduct_dgemm(transA, transB,
