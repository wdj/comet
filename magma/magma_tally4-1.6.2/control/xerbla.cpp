...
/**
    Purpose
    -------
    magma_tally4_xerbla is an error handler for the MAGMA_tally4 routines.
    It is called by a MAGMA_tally4 routine if an input parameter has an
    ...
    minfo   INTEGER
            ...
            - minfo >= -MAGMA_tally4_ERR: Pre-defined MAGMA_tally4 error, such as malloc failure.
            - minfo == 0:          No error.

    @ingroup magma_tally4_util
    ********************************************************************/
extern "C"
void magma_tally4_xerbla(const char *srname , magma_tally4_int_t minfo)
{
    ...
    else if ( minfo >= -MAGMA_tally4_ERR ) {
        fprintf( stderr, "Error in %s, %s (info = %d)\n",
                 srname, magma_tally4_strerror(-minfo), (int) -minfo );
    }
    else {
