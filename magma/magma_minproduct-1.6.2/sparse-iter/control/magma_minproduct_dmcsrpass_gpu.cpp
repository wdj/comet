/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from magma_minproduct_zmcsrpass_gpu.cpp normal z -> d, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
...
/**
    ...
    @param[in]
    val         magma_minproductDouble_ptr
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproduct_d_matrix A_DEV={Magma_minproduct_CSR}, A_CSR={Magma_minproduct_CSR};
    ...
    if ( A.memory_location == Magma_minproduct_DEV && A.storage_type == Magma_minproduct_CSR ) {
        ...
        *row = A.drow;
        ...
        CHECK( magma_minproduct_dmconvert( A, &A_CSR, A.storage_type, Magma_minproduct_CSR, queue ));
        CHECK( magma_minproduct_dmtransfer( A_CSR, &A_DEV, A.memory_location, Magma_minproduct_DEV, queue ));
        magma_minproduct_dcsrget_gpu( A_DEV, m, n, row, col, val, queue );
    }
    
cleanup:
    magma_minproduct_dmfree( &A_CSR, queue );
    magma_minproduct_dmfree( &A_DEV, queue );
    return info;
}
