...
magma_tally3_dsysv_nopiv_gpu(magma_tally3_uplo_t uplo,  magma_tally3_int_t n, magma_tally3_int_t nrhs, 
                 ...
                 magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    ret = magma_tally3_dsytrf_nopiv_tally3_gpu(uplo, n, dA, ldda, info);
    if ( (ret != MAGMA_tally3_SUCCESS) || (*info != 0) ) {
        return ret;
    }
        
    ret = magma_tally3_dsytrs_nopiv_gpu( uplo, n, nrhs, dA, ldda, dB, lddb, info );
    if ( (ret != MAGMA_tally3_SUCCESS) || (*info != 0) ) {
        return ret;
    }
