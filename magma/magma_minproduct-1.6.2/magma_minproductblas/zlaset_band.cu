    ...
    magma_minproductDoubleComplex *A, int lda)
{
    ...
    magma_minproductDoubleComplex value = offdiag;
    if (threadIdx.x == k-1)
        value = diag;
    ...
    magma_minproduct_queue_t queue)
{
    ...
    else if (uplo == Magma_minproductLower) {
...
/**
    @see magma_minproductblas_zlaset_band_q
    @ingroup magma_minproduct_zaux2
    ********************************************************************/
extern "C" void
magma_minproductblas_zlaset_band(
    ...
    magma_minproductDoubleComplex_ptr dA, magma_minproduct_int_t ldda)
{
    magma_minproductblas_zlaset_band_q(uplo, m, n, k, offdiag, diag, dA, ldda, magma_minproduct_stream);
}
