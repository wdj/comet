...
__global__ void
magma_tally4int_clag2z_sparse(  int M, int N,
...
magma_tally4blas_clag2z_sparse(
    ...
    const magma_tally4FloatComplex *SA, magma_tally4_int_t ldsa,
    ...
    magma_tally4_queue_t queue )
{
    ...
    *info = 0;
    ...
    dim3 grid( magma_tally4_ceildiv( M, blksize ) );
    cudaMemcpyToSymbol( flag, info, sizeof(flag) );    // flag = 0
    magma_tally4int_clag2z_sparse<<< dimGrid , dimBlock, 0, queue >>>
