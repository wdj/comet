...
magma_tally3_dsetmatrix_internal(
    ...
    double const* hA_src, magma_tally3_int_t lda,
    magma_tally3Double_ptr    dB_dst, magma_tally3_int_t ldb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
...
magma_tally3_dgetmatrix_internal(
    magma_tally3_int_t m, magma_tally3_int_t n,
    magma_tally3Double_const_ptr dA_src, magma_tally3_int_t lda,
    double*          hB_dst, magma_tally3_int_t ldb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
