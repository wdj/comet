/*
    -- MAGMA_tally2 (version 1.6.1) --
       ...
       @generated from testing_zhegvdx.cpp normal z -> d, Fri Jan 30 19:00:26 2015
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            // ==================================================================
            if ( opts.warmup ) {
                lapackf77_dlacpy( Magma_tally2FullStr, &N, &N, h_A, &N, h_R, &N );
                lapackf77_dlacpy( Magma_tally2FullStr, &N, &N, h_B, &N, h_S, &N );
                
                magma_tally2_dsygvdx( opts.itype, opts.jobz, Magma_tally2RangeI, opts.uplo,
                               ...
                               &info );
                if (info != 0)
                    printf("magma_tally2_dsygvdx returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_tally2NoVec ) {
                ...
                // TODO: add comparison to LAPACK, as in testing_dsygvd.cpp?
                //
                //lapackf77_dlacpy( Magma_tally2FullStr, &N, &N, h_A, &N, h_R, &N );
                //lapackf77_dlacpy( Magma_tally2FullStr, &N, &N, h_B, &N, h_S, &N );
                //
                //magma_tally2_int_t m2;
                //magma_tally2_dsygvdx( opts.itype, Magma_tally2NoVec, Magma_tally2RangeI, opts.uplo,
