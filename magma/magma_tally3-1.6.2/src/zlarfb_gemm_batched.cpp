...
magma_tally3_zlarfb_gemm_batched_magem(
...
extern "C" magma_tally3_int_t
magma_tally3_zlarfb_gemm_batched_cugem(
    magma_tally3_side_t side, magma_tally3_trans_t trans, magma_tally3_direct_t direct, magma_tally3_storev_t storev,
    magma_tally3_int_t m, magma_tally3_int_t n, magma_tally3_int_t k,
    magma_tally3DoubleComplex_const_ptr dV_array[],    magma_tally3_int_t lddv,
    magma_tally3DoubleComplex_const_ptr dT_array[],    magma_tally3_int_t lddt,
    ...
    magma_tally3_int_t batchCount, cublasHandle_t myhandle, magma_tally3_queue_t queue)
{
    ...
    if(m >= 32 && n >= 32 && k >= 32)
    {
        magma_tally3_zlarfb_gemm_batched_magem(
            ...
            m, n,  k,
            (magma_tally3DoubleComplex_const_ptr *) dV_array, lddv,
            (magma_tally3DoubleComplex_const_ptr *) dT_array, lddt,
            dC_array, lddc,
            dwork_array, ldwork,
    ...
    magma_tally3_int_t batchCount, magma_tally3_queue_t queue)
{
    ...
    if ( side == Magma_tally3Left ) {
        ...
        // W = V' C                              
        magma_tally3blas_zgemm_batched( Magma_tally3_ConjTrans,notransV, /*NontransLeft*/
                     k, n, m,
                     c_one,  dV_array,    lddv,
                             dC_array,    lddc,
        ...
        if (m <= n) {
            // W2 = V T
            magma_tally3blas_zgemm_batched( notransV, trans, /* (NoTrans), trans(ConjTrans),*/
                         m, k, k,
                         c_one,  dV_array, lddv,
                                 dT_array, lddt,
        ...
        {
            // W2 = T W  = T  V' C
            magma_tally3blas_zgemm_batched( trans, Magma_tally3NoTrans,
                         k, n, k,
                         c_one,  dT_array, lddt,
                                 dwork_array, ldw,
                         c_zero, dworkvt_array, ldwvt, batchCount, queue);
            ...
            magma_tally3blas_zgemm_batched( notransV, Magma_tally3NoTrans,
                         m, n, k,
        ...
        // W = C V
        magma_tally3blas_zgemm_batched( Magma_tally3NoTrans, notransV,
                     m, k, n,
                     c_one,  dC_array,    lddc,
                             dV_array,    lddv,
                     c_zero, dwork_array, ldw, batchCount, queue);
        if (m <= n) {
            // W2 = W T = C V T
            magma_tally3blas_zgemm_batched( Magma_tally3NoTrans, trans,
                         m, k, k,
            ...
            magma_tally3blas_zgemm_batched( Magma_tally3NoTrans, transV,
                         m, n, k,
                         c_neg_one, dworkvt_array, ldwvt,
                                    dV_array,    lddv,
                         c_one,     dC_array,    lddc, batchCount, queue);
            ...
            // W2 = T V'
            magma_tally3blas_zgemm_batched( trans, transV,
                         k, n, k,
                         c_one,  dT_array, lddt,
                                 dV_array, lddv,
                         c_zero, dworkvt_array, ldwvt, batchCount, queue);
    ...
    magma_tally3_int_t batchCount, cublasHandle_t myhandle, magma_tally3_queue_t queue)
{
    ...
    if ( side == Magma_tally3Left ) {
        ...
        // W = V' C
        cublasZgemmBatched(myhandle, cublas_trans_const_tally3(Magma_tally3_ConjTrans), cublas_trans_const_tally3(notransV),
                     k, n, m,
                     &c_one,  (const magma_tally3DoubleComplex**)dV_array,    lddv,
                              (const magma_tally3DoubleComplex**)dC_array,    lddc,
                     &c_zero, dwork_array, ldw, batchCount);
        if (m <= n) {
            // W2 = V T
            cublasZgemmBatched(myhandle, cublas_trans_const_tally3(notransV), cublas_trans_const_tally3(trans),
                         m, k, k,
                         &c_one,  (const magma_tally3DoubleComplex**)dV_array, lddv,
                                  (const magma_tally3DoubleComplex**)dT_array, lddt,
                         &c_zero, dworkvt_array, ldwvt, batchCount);
            // C = C - W2 W = C - V T V' C = (I - V T V') C = H C
            cublasZgemmBatched(myhandle, cublas_trans_const_tally3(Magma_tally3NoTrans), cublas_trans_const_tally3(Magma_tally3NoTrans),
                         m, n, k,
                         &c_neg_one, (const magma_tally3DoubleComplex**)dworkvt_array,  ldwvt,
                                     (const magma_tally3DoubleComplex**)dwork_array,    ldw,
                         &c_one,     dC_array,       lddc, batchCount);
        } else {
            // W2 = T W  = T  V' C
            cublasZgemmBatched(myhandle, cublas_trans_const_tally3(trans), cublas_trans_const_tally3(Magma_tally3NoTrans),
                         k, n, k,
                         &c_one,  (const magma_tally3DoubleComplex**)dT_array, lddt,
                                  (const magma_tally3DoubleComplex**)dwork_array, ldw,
                         &c_zero, dworkvt_array, ldwvt, batchCount);
            // C = C - V W2 = C - V T V' C = (I - V T V') C = H C
            cublasZgemmBatched(myhandle, cublas_trans_const_tally3(notransV), cublas_trans_const_tally3(Magma_tally3NoTrans),
                         m, n, k,
                         &c_neg_one, (const magma_tally3DoubleComplex**)dV_array,  lddv,
                                     (const magma_tally3DoubleComplex**)dworkvt_array,  ldwvt,
                         &c_one,     dC_array,       lddc, batchCount);
        }
    }
    else {
        ...
        // W = C V
        cublasZgemmBatched(myhandle, cublas_trans_const_tally3(Magma_tally3NoTrans), cublas_trans_const_tally3(notransV),
                     m, k, n,
                     &c_one,  (const magma_tally3DoubleComplex**)dC_array,    lddc,
                              (const magma_tally3DoubleComplex**)dV_array,    lddv,
                     &c_zero, dwork_array, ldw, batchCount);
        if (m <= n) {
            // W2 = W T = C V T
           cublasZgemmBatched(myhandle, cublas_trans_const_tally3(Magma_tally3NoTrans), cublas_trans_const_tally3(trans),
                         m, k, k,
                         &c_one,  (const magma_tally3DoubleComplex**)dwork_array, ldw,
                                  (const magma_tally3DoubleComplex**)dT_array, lddt,
                         &c_zero, dworkvt_array, ldwvt, batchCount);
            // C = C - W2 V' = C - C V T V' = C (I - V T V') = C H
            cublasZgemmBatched(myhandle, cublas_trans_const_tally3(Magma_tally3NoTrans), cublas_trans_const_tally3(transV),
                         m, n, k,
                         &c_neg_one, (const magma_tally3DoubleComplex**)dworkvt_array, ldwvt,
                                     (const magma_tally3DoubleComplex**)dV_array,    lddv,
                         &c_one,     dC_array,    lddc, batchCount);
            ...
            // W2 = T V'
            cublasZgemmBatched(myhandle, cublas_trans_const_tally3(trans), cublas_trans_const_tally3(transV),
                         k, n, k,
                         &c_one,  (const magma_tally3DoubleComplex**)dT_array, lddt,
                                  (const magma_tally3DoubleComplex**)dV_array, lddv,
                         &c_zero, dworkvt_array, ldwvt, batchCount);
           ...
           cublasZgemmBatched(myhandle, cublas_trans_const_tally3(Magma_tally3NoTrans), cublas_trans_const_tally3(Magma_tally3NoTrans),
                         m, n, k,
                         &c_neg_one, (const magma_tally3DoubleComplex**)dwork_array,   ldw,
                                     (const magma_tally3DoubleComplex**)dworkvt_array, ldwvt,
                         &c_one,     dC_array,      lddc, batchCount);
        }
    }
