/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zvpass_gpu.cpp normal z -> d, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_tally2_queue_t queue )
{
    ...
    magma_tally2_d_matrix v_DEV={Magma_tally2_CSR};
    ...
    if ( v.memory_location == Magma_tally2_DEV ) {
        ...
        *val = v.dval;
        ...
        CHECK( magma_tally2_dmtransfer( v, &v_DEV, v.memory_location, Magma_tally2_DEV, queue ));
        CHECK( magma_tally2_dvget_dev( v_DEV, m, n, val, queue ));
    }
    
cleanup:
    magma_tally2_dmfree( &v_DEV, queue );
    return info;
}
