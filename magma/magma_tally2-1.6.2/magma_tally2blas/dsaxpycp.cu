    ...
    const double *b, double *w )
{
    ...
    if ( i < m ) {
        x[i] = MAGMA_tally2_D_ADD( x[i], (double)( r[i] ) );
        w[i] = b[i];
    }
}
...
magma_tally2blas_dsaxpycp(
    ...
    magma_tally2Double_ptr w)
{
    magma_tally2blas_dsaxpycp_q( m, r, x, b, w, magma_tally2_stream );
}
...
magma_tally2blas_daxpycp(
    ...
    magma_tally2Double_const_ptr b)
{
    magma_tally2blas_daxpycp_q( m, r, x, b, magma_tally2_stream );
}
