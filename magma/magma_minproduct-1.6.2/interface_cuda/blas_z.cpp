...
*/
extern "C"
magma_minproductDoubleComplex magma_minproduct_zdotc(
    magma_minproduct_int_t n,
    magma_minproductDoubleComplex_const_ptr dx, magma_minproduct_int_t incx,
...
*/
extern "C"
magma_minproductDoubleComplex magma_minproduct_zdotu(
    magma_minproduct_int_t n,
    magma_minproductDoubleComplex_const_ptr dx, magma_minproduct_int_t incx,
    magma_minproductDoubleComplex_const_ptr dy, magma_minproduct_int_t incy )
{
...
/** Perform Hermitian matrix-matrix product.
    ...
    @param[in]
    dA      COMPLEX_16 array on GPU device.
            If side == Magma_minproductLeft, the m-by-m Hermitian matrix A of dimension (ldda,m), ldda >= max(1,m); \n
