#==============================================================================#
#                       README FILE FOR MAGMA_tally2-SPARSE                           #
#==============================================================================#
...
3) compile magma_tally2 using "make -j8" (in case you want to use 8 cores...)

4) "cd sparse-iter"

5) compile magma_tally2-sparse using "make -j8" (in case you want to use 8 cores...)
...
"--blocksize k"
    for Magma_tally2_SELL-P: k denotes the number of rows in one slice of the matrix
                      and the number of rows assigned to one multiprocessor

"--alignment k"
    for Magma_tally2_SELL-P: k denotes the number of threads assigned to one row
