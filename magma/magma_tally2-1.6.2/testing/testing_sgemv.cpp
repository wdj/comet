...
int main(int argc, char **argv)
{
    ...
    float *A, *X, *Y, *Ydev, *Ymagma_tally2;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally2_ssetmatrix( M, N, A, lda, dA, lda );
            magma_tally2_ssetvector( Xm, X, incx, dX, incx );
            magma_tally2_ssetvector( Ym, Y, incy, dY, incy );
            
            #ifdef HAVE_CUBLAS
                dev_time = magma_tally2_sync_wtime( 0 );
                cublasSgemv( opts.handle, cublas_trans_const_tally2(opts.transA),
                ...
                magma_tally2_sgemv( opts.transA, M, N,
                             &alpha, dA, lda,
                                     dX, incx,
                             &beta,  dY, incy );
            ...
            magma_tally2_sgetvector( Ym, dY, incy, Ydev, incy );
            ...
            /* =====================================================================
               ...
               =================================================================== */
                ...
                magma_tally2blas_sgemv( opts.transA, M, N, alpha, dA, lda, dX, incx, beta, dY, incy );
                magma_tally2_time = magma_tally2_sync_wtime( 0 ) - magma_tally2_time;
                magma_tally2_perf = gflops / magma_tally2_time;
                
                magma_tally2_sgetvector( Ym, dY, incy, Ymagma_tally2, incy );
            #endif
            ...
            blasf77_sgemv( lapack_trans_const_tally2(opts.transA), &M, &N,
                           &alpha, A, &lda,
                                   X, &incx,
                           &beta,  Y, &incy );
            ...
            #ifdef HAVE_CUBLAS
                blasf77_saxpy( &Ym, &c_neg_one, Y, &incy, Ymagma_tally2, &incy );
                magma_tally2_error = lapackf77_slange( "F", &Ym, &ione, Ymagma_tally2, &Ym, work ) / (Anorm * Xnorm);
