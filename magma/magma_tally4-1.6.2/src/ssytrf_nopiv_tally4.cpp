/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from zhetrf_nopiv_tally4.cpp normal z -> s, Fri Jan 30 19:00:16 2015
*/
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        for (j=0; j<n; j += nb) {
            ...
            ssytrf_nopiv_tally4_cpu(Magma_tally4Upper, jb, ib, A(j, j), lda, info);
            trace_cpu_end( 0 );
            if (*info != 0){
                *info = *info + j;
                break;
        ...
        for (j=0; j<n; j+=nb) {
            ...
            magma_tally4_queue_sync(stream[1]);
            trace_cpu_start( 0, "potrf", "potrf" );
            ssytrf_nopiv_tally4_cpu(Magma_tally4Lower, jb, ib, A(j, j), lda, info);
            trace_cpu_end( 0 );
            if (*info != 0){
                *info = *info + j;
                break;
