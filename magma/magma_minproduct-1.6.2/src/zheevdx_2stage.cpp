    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_minproduct_timer_t time=0, time_total=0;
    ...
    if (! wantz) {
        ...
        magma_minproduct_zstedx(range, n, vl, vu, il, iu, w, &rwork[inde],
        ...
        magma_minproductDoubleComplex *da;
        ...
        magma_minproduct_zunmqr_gpu_2stages(Magma_minproductLeft, Magma_minproductNoTrans, n-nb, *m, n-nb, da+nb, ldda,
                                 dZ+nb, n, dT1, nb, info);

        magma_minproduct_zgetmatrix( n, *m, dZ, lddz, A, lda );
