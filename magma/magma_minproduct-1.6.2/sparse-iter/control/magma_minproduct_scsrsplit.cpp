/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from magma_minproduct_zcsrsplit.cpp normal z -> s, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
    ...
    magma_minproduct_queue_t queue )
{
    ...
    if (  A.memory_location == Magma_minproduct_CPU &&
        ...
        magma_minproduct_s_matrix Ah={Magma_minproduct_CSR}, ACSR={Magma_minproduct_CSR}, DCSR={Magma_minproduct_CSR}, RCSR={Magma_minproduct_CSR}, Dh={Magma_minproduct_CSR}, Rh={Magma_minproduct_CSR};
        CHECK( magma_minproduct_smtransfer( A, &Ah, A.memory_location, Magma_minproduct_CPU, queue ));
        CHECK( magma_minproduct_smconvert( Ah, &ACSR, A.storage_type, Magma_minproduct_CSR, queue ));

        CHECK( magma_minproduct_scsrsplit( bsize, ACSR, &DCSR, &RCSR, queue ));

        CHECK( magma_minproduct_smconvert( DCSR, &Dh, Magma_minproduct_CSR, A.storage_type, queue ));
        CHECK( magma_minproduct_smconvert( RCSR, &Rh, Magma_minproduct_CSR, A.storage_type, queue ));

        CHECK( magma_minproduct_smtransfer( Dh, D, Magma_minproduct_CPU, A.memory_location, queue ));
        CHECK( magma_minproduct_smtransfer( Rh, R, Magma_minproduct_CPU, A.memory_location, queue ));

        magma_minproduct_smfree( &Ah, queue );
        magma_minproduct_smfree( &ACSR, queue );
        magma_minproduct_smfree( &Dh, queue );
        magma_minproduct_smfree( &DCSR, queue );
        magma_minproduct_smfree( &Rh, queue );
        magma_minproduct_smfree( &RCSR, queue );
    }
cleanup:
    if( info != 0 ){
