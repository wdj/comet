...
#define dA(i, j) (dA + (j)*ldda + (i))
    ...
    *info = 0;
    ...
    if (nb <= 1 || nb >= n) {
        magma_tally2_dgetmatrix( n, n, dA, ldda, work, n );
        lapackf77_dlauum(uplo_, &n, work, &n, info);
        magma_tally2_dsetmatrix( n, n, work, n, dA, ldda );
    }
    else {
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally2_dtrmm( Magma_tally2Right, Magma_tally2Upper,
                             Magma_tally2ConjTrans, Magma_tally2NonUnit, i, ib,
                             c_one, dA(i,i), ldda, dA(0, i),ldda);

                magma_tally2_dgetmatrix( ib, ib,
                                  dA(i, i), ldda,
                                  work,     ib );

                lapackf77_dlauum(Magma_tally2UpperStr, &ib, work, &ib, info);

                magma_tally2_dsetmatrix( ib, ib,
                                  work,     ib,
                                  dA(i, i), ldda );
                ...
                if (i+ib < n) {
                    ...
                    magma_tally2_dsyrk( Magma_tally2Upper, Magma_tally2NoTrans, ib,(n-i-ib),
            ...
            for (i=0; i < n; i += nb) {
                ...
                lapackf77_dlauum(Magma_tally2LowerStr, &ib, work, &ib, info);
                ...
                if (i+ib < n) {
                    magma_tally2_dgemm( Magma_tally2ConjTrans, Magma_tally2NoTrans,
                                 ...
                                 dA(i,0), ldda);
                    magma_tally2_dsyrk( Magma_tally2Lower, Magma_tally2ConjTrans, ib, (n-i-ib),
