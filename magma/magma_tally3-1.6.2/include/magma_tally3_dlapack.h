/*
    -- MAGMA_tally3 (version 1.6.1) --
       ...
       @generated from magma_tally3_zlapack.h normal z -> d, Fri Jan 30 19:00:06 2015
*/

#ifndef MAGMA_tally3_DLAPACK_H
#define MAGMA_tally3_DLAPACK_H
 ...
 */
magma_tally3_int_t blasf77_idamax(
                     const magma_tally3_int_t *n,
                     const double *x, const magma_tally3_int_t *incx );

void blasf77_daxpy(  const magma_tally3_int_t *n,
                     const double *alpha,
                     const double *x, const magma_tally3_int_t *incx,
                           double *y, const magma_tally3_int_t *incy );

void blasf77_dcopy(  const magma_tally3_int_t *n,
                     const double *x, const magma_tally3_int_t *incx,
                           double *y, const magma_tally3_int_t *incy );
...
void blasf77_dger(  const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                     const double *alpha,
                     const double *x, const magma_tally3_int_t *incx,
                     const double *y, const magma_tally3_int_t *incy,
...
void blasf77_dscal(  const magma_tally3_int_t *n,
                     const double *alpha,
                           double *x, const magma_tally3_int_t *incx );

void blasf77_dscal( const magma_tally3_int_t *n,
                     const double *alpha,
                           double *x, const magma_tally3_int_t *incx );

void blasf77_dswap(  const magma_tally3_int_t *n,
                     double *x, const magma_tally3_int_t *incx,
                     double *y, const magma_tally3_int_t *incy );
...
void blasf77_drot(   const magma_tally3_int_t *n,
                     double *x, const magma_tally3_int_t *incx,
                     double *y, const magma_tally3_int_t *incy,
...
void blasf77_dtrmm(  const char *side, const char *uplo, const char *transa, const char *diag,
                     ...
                     const double *alpha,
                     const double *A, const magma_tally3_int_t *lda,
                           double *B, const magma_tally3_int_t *ldb );
...
double magma_tally3_cblas_dasum(
    magma_tally3_int_t n,
    const double *x, magma_tally3_int_t incx );

double magma_tally3_cblas_dnrm2(
    magma_tally3_int_t n,
    const double *x, magma_tally3_int_t incx );

double magma_tally3_cblas_ddot(
    magma_tally3_int_t n,
    const double *x, magma_tally3_int_t incx,
    const double *y, magma_tally3_int_t incy );
...
void   lapackf77_dgebd2( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         double *A, const magma_tally3_int_t *lda,
                         double *d, double *e,
                         double *tauq,
                         double *taup,
...
void   lapackf77_dgebrd( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         double *A, const magma_tally3_int_t *lda,
                         double *d, double *e,
                         double *tauq,
                         double *taup,
...
void   lapackf77_dgeev(  const char *jobvl, const char *jobvr,
                         ...
                         double *wr, double *wi,
                         #endif
                         double *Vl,   const magma_tally3_int_t *ldvl,
                         double *Vr,   const magma_tally3_int_t *ldvr,
                         double *work, const magma_tally3_int_t *lwork,
                         #ifdef COMPLEX
                         double *rwork,
                         #endif
...
void   lapackf77_dgehd2( const magma_tally3_int_t *n,
                         const magma_tally3_int_t *ilo, const magma_tally3_int_t *ihi,
                         double *A, const magma_tally3_int_t *lda,
                         double *tau,
                         double *work,
...
void   lapackf77_dgehrd( const magma_tally3_int_t *n,
                         const magma_tally3_int_t *ilo, const magma_tally3_int_t *ihi,
                         double *A, const magma_tally3_int_t *lda,
                         double *tau,
                         double *work, const magma_tally3_int_t *lwork,
...
void   lapackf77_dgelqf( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         double *A, const magma_tally3_int_t *lda,
                         double *tau,
                         double *work, const magma_tally3_int_t *lwork,
                         magma_tally3_int_t *info );
...
void   lapackf77_dgeqlf( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         double *A, const magma_tally3_int_t *lda,
                         double *tau,
                         double *work, const magma_tally3_int_t *lwork,
                         magma_tally3_int_t *info );

void   lapackf77_dgeqp3( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         double *A, const magma_tally3_int_t *lda,
...
void   lapackf77_dgeqrf( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         double *A, const magma_tally3_int_t *lda,
                         double *tau,
                         double *work, const magma_tally3_int_t *lwork,
                         magma_tally3_int_t *info );
...
void   lapackf77_dgesv(  const magma_tally3_int_t *n, const magma_tally3_int_t *nrhs,
                         double *A, const magma_tally3_int_t *lda,
...
void   lapackf77_dgetrf( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         double *A, const magma_tally3_int_t *lda,
                         magma_tally3_int_t *ipiv,
                         magma_tally3_int_t *info );

void   lapackf77_dgetri( const magma_tally3_int_t *n,
                         double *A, const magma_tally3_int_t *lda,
...
void   lapackf77_dsytf2( const char*, magma_tally3_int_t*, 
                         double*, magma_tally3_int_t*, magma_tally3_int_t*, magma_tally3_int_t* );
...
void   lapackf77_dsyevr( const char *jobz, const char *range, const char *uplo,
                         ...
                         magma_tally3_int_t *m, double *w, double *z__, 
...
void   lapackf77_dsyevx( const char *jobz, const char *range, const char *uplo,
                         ...
                         magma_tally3_int_t *il, magma_tally3_int_t *iu, double *abstol,
                         magma_tally3_int_t *m, double *w, double *z__,
                         magma_tally3_int_t *ldz, double *work, magma_tally3_int_t *lwork,
                         double *rwork, magma_tally3_int_t *iwork, magma_tally3_int_t *ifail, magma_tally3_int_t *info);

void   lapackf77_dsygs2( const magma_tally3_int_t *itype, const char *uplo,
                         const magma_tally3_int_t *n,
                         double *A, const magma_tally3_int_t *lda,
                         double *B, const magma_tally3_int_t *ldb,
                         magma_tally3_int_t *info );

void   lapackf77_dsygst( const magma_tally3_int_t *itype, const char *uplo,
                         const magma_tally3_int_t *n,
                         double *A, const magma_tally3_int_t *lda,
                         double *B, const magma_tally3_int_t *ldb,
                         magma_tally3_int_t *info );

void   lapackf77_dsygvd( const magma_tally3_int_t *itype, const char *jobz, const char *uplo,
                         const magma_tally3_int_t *n,
                         double *A, const magma_tally3_int_t *lda,
                         double *B, const magma_tally3_int_t *ldb,
                         double *w,
...
void   lapackf77_dsysv( const char *uplo, 
                        const magma_tally3_int_t *n, const magma_tally3_int_t *nrhs,
                        double *A, const magma_tally3_int_t *lda, magma_tally3_int_t *ipiv,
                        double *B, const magma_tally3_int_t *ldb,
                        double *work, const magma_tally3_int_t *lwork,
                        magma_tally3_int_t *info );
...
void   lapackf77_dhseqr( const char *job, const char *compz,
                         ...
                         double *wr, double *wi,
                         #endif
                         double *Z, const magma_tally3_int_t *ldz,
                         double *work, const magma_tally3_int_t *lwork,
                         magma_tally3_int_t *info );

void   lapackf77_dlabrd( const magma_tally3_int_t *m, const magma_tally3_int_t *n, const magma_tally3_int_t *nb,
                         double *A, const magma_tally3_int_t *lda,
                         double *d, double *e,
                         double *tauq,
                         double *taup,
                         double *X, const magma_tally3_int_t *ldx,
                         double *Y, const magma_tally3_int_t *ldy );

#ifdef COMPLEX
void   lapackf77_dlacgv( const magma_tally3_int_t *n,
                         double *x, const magma_tally3_int_t *incx );
#endif
...
#ifdef COMPLEX
void   lapackf77_dlacrm( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         const double *A, const magma_tally3_int_t *lda,
                         const double             *B, const magma_tally3_int_t *ldb,
                         double       *C, const magma_tally3_int_t *ldc,
                         double *rwork );
...
void   lapackf77_dlasyf( const char *uplo,
                         ...
                         double *A, const magma_tally3_int_t lda,
                         magma_tally3_int_t *ipiv,
                         double *work, const magma_tally3_int_t *ldwork,
                         magma_tally3_int_t *info );
...
double lapackf77_dlanst( const char *norm, const magma_tally3_int_t *n,
...
void   lapackf77_dlaqp2( magma_tally3_int_t *m, magma_tally3_int_t *n, magma_tally3_int_t *offset,
                         double *a, magma_tally3_int_t *lda, magma_tally3_int_t *jpvt,
                         double *tau,
                         double *vn1, double *vn2,
                         double *work );

#ifdef COMPLEX
void   lapackf77_dlarcm( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         const double             *A, const magma_tally3_int_t *lda,
                         const double *B, const magma_tally3_int_t *ldb,
                         double       *C, const magma_tally3_int_t *ldc,
                         double *rwork );
...
void   lapackf77_dlarf(  const char *side, const magma_tally3_int_t *m, const magma_tally3_int_t *n,
...
void   lapackf77_dlarfb( const char *side, const char *trans, const char *direct, const char *storev,
                         const magma_tally3_int_t *m, const magma_tally3_int_t *n, const magma_tally3_int_t *k,
                         const double *V, const magma_tally3_int_t *ldv,
                         const double *T, const magma_tally3_int_t *ldt,
                         double *C, const magma_tally3_int_t *ldc,
                         double *work, const magma_tally3_int_t *ldwork );

void   lapackf77_dlarfg( const magma_tally3_int_t *n,
                         double *alpha,
                         double *x, const magma_tally3_int_t *incx,
                         double *tau );
...
void   lapackf77_dlarft( const char *direct, const char *storev,
                         ...
                         double *V, const magma_tally3_int_t *ldv,
                         const double *tau,
                         double *T, const magma_tally3_int_t *ldt );

void   lapackf77_dlarnv( const magma_tally3_int_t *idist, magma_tally3_int_t *iseed, const magma_tally3_int_t *n,
                         double *x );
...
void   lapackf77_dlaswp( const magma_tally3_int_t *n,
                         double *A, const magma_tally3_int_t *lda,
...
void   lapackf77_dstein( const magma_tally3_int_t *n,
                         const double *d, const double *e,
...
void   lapackf77_dorg2r( const magma_tally3_int_t *m, const magma_tally3_int_t *n, const magma_tally3_int_t *k,
                         double *A, const magma_tally3_int_t *lda,
                         const double *tau,
                         double *work,
                         magma_tally3_int_t *info );
...
void   lapackf77_dorghr( const magma_tally3_int_t *n,
                         const magma_tally3_int_t *ilo, const magma_tally3_int_t *ihi,
                         double *A, const magma_tally3_int_t *lda,
                         const double *tau,
                         double *work, const magma_tally3_int_t *lwork,
...
void   lapackf77_dorglq( const magma_tally3_int_t *m, const magma_tally3_int_t *n, const magma_tally3_int_t *k,
                         double *A, const magma_tally3_int_t *lda,
                         const double *tau,
                         double *work, const magma_tally3_int_t *lwork,
                         magma_tally3_int_t *info );

void   lapackf77_dorgql( const magma_tally3_int_t *m, const magma_tally3_int_t *n, const magma_tally3_int_t *k,
                         double *A, const magma_tally3_int_t *lda,
                         const double *tau,
                         double *work, const magma_tally3_int_t *lwork,
                         magma_tally3_int_t *info );

void   lapackf77_dorgqr( const magma_tally3_int_t *m, const magma_tally3_int_t *n, const magma_tally3_int_t *k,
                         double *A, const magma_tally3_int_t *lda,
                         const double *tau,
                         double *work, const magma_tally3_int_t *lwork,
                         magma_tally3_int_t *info );
