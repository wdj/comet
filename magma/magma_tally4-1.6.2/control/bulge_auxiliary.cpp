...
extern "C" {
    /////////////////////////////////////////
    magma_tally4_int_t magma_tally4_sbulge_get_lq2(magma_tally4_int_t n, magma_tally4_int_t threads)
    {
        magma_tally4_int_t nb = magma_tally4_get_sbulge_nb(n, threads);
        magma_tally4_int_t Vblksiz = magma_tally4_sbulge_get_Vblksiz(n, nb, threads);
        magma_tally4_int_t ldv = nb + Vblksiz;
        magma_tally4_int_t ldt = Vblksiz;
        return magma_tally4_bulge_get_blkcnt(n, nb, Vblksiz) * Vblksiz * (ldt + ldv + 1);
    }

    magma_tally4_int_t magma_tally4_dbulge_get_lq2(magma_tally4_int_t n, magma_tally4_int_t threads)
    {
        magma_tally4_int_t nb = magma_tally4_get_dbulge_nb(n, threads);
        magma_tally4_int_t Vblksiz = magma_tally4_dbulge_get_Vblksiz(n, nb, threads);
        magma_tally4_int_t ldv = nb + Vblksiz;
        magma_tally4_int_t ldt = Vblksiz;
        return magma_tally4_bulge_get_blkcnt(n, nb, Vblksiz) * Vblksiz * (ldt + ldv + 1);
    }

    magma_tally4_int_t magma_tally4_cbulge_get_lq2(magma_tally4_int_t n, magma_tally4_int_t threads)
    {
        magma_tally4_int_t nb = magma_tally4_get_cbulge_nb(n, threads);
        magma_tally4_int_t Vblksiz = magma_tally4_cbulge_get_Vblksiz(n, nb, threads);
        magma_tally4_int_t ldv = nb + Vblksiz;
        magma_tally4_int_t ldt = Vblksiz;
        return magma_tally4_bulge_get_blkcnt(n, nb, Vblksiz) * Vblksiz * (ldt + ldv + 1);
    }

    magma_tally4_int_t magma_tally4_zbulge_get_lq2(magma_tally4_int_t n, magma_tally4_int_t threads)
    {
        magma_tally4_int_t nb = magma_tally4_get_zbulge_nb(n, threads);
        magma_tally4_int_t Vblksiz = magma_tally4_zbulge_get_Vblksiz(n, nb, threads);
        magma_tally4_int_t ldv = nb + Vblksiz;
        magma_tally4_int_t ldt = Vblksiz;
        return magma_tally4_bulge_get_blkcnt(n, nb, Vblksiz) * Vblksiz * (ldt + ldv + 1);
    }
    ...
    {
        magma_tally4_int_t prevGblkid, mastersweep;
        magma_tally4_int_t locblknb   = 0;
        magma_tally4_int_t prevblkcnt = 0;
        magma_tally4_int_t myblknb    = 0;
        magma_tally4_int_t lstGblkid  = magma_tally4_ceildiv((n-1),Vblksiz)-1;//nbGblk-1;
        magma_tally4_int_t myGblkid   = sweep/Vblksiz;
        ...
        for (prevGblkid = lstGblkid; prevGblkid > myGblkid; prevGblkid--)
        {
            ...
            if(prevGblkid==lstGblkid)
                locblknb = magma_tally4_ceildiv((n-(mastersweep+1)),nb);
            else
                locblknb = magma_tally4_ceildiv((n-(mastersweep+2)),nb);
        ...
        //===================================================
        */
        myblknb = magma_tally4_ceildiv((st-sweep),nb);
    ...
    {
        magma_tally4_int_t locblknb, prevblkcnt, prevGblkid;
        magma_tally4_int_t myblknb, nbprevGblk, mastersweep;
    ...
    {
        magma_tally4_int_t myblkid;
        magma_tally4_int_t locj = sweep%Vblksiz;

        if(applyQver==113)
            magma_tally4_bulge_findpos113(n, nb, Vblksiz, sweep, st, &myblkid);
        else
            magma_tally4_bulge_findpos(n, nb, Vblksiz, sweep, st, &myblkid);
    ...
    {
        magma_tally4_int_t colblk, nbcolblk;
        magma_tally4_int_t myblknb, mastersweep;

        magma_tally4_int_t blkcnt = 0;
        nbcolblk = magma_tally4_ceildiv((n-1),Vblksiz);
        for (colblk = 0; colblk<nbcolblk; colblk++)
        {
            mastersweep = colblk * Vblksiz;
            if(colblk == (nbcolblk-1))
                myblknb = magma_tally4_ceildiv((n-(mastersweep+1)),nb);
            else
                myblknb = magma_tally4_ceildiv((n-(mastersweep+2)),nb);
    ...
    {
        return magma_tally4_ceildiv(a,b);
    }
    ...
    void findVTpos(magma_tally4_int_t N, magma_tally4_int_t NB, magma_tally4_int_t Vblksiz, magma_tally4_int_t sweep, magma_tally4_int_t st, magma_tally4_int_t *Vpos, magma_tally4_int_t *TAUpos, magma_tally4_int_t *Tpos, magma_tally4_int_t *myblkid)
    {
        ...
        magma_tally4_int_t ldv = NB + Vblksiz;
        magma_tally4_int_t ldt = Vblksiz;
        magma_tally4_bulge_findVTAUTpos(N,  NB, Vblksiz,  sweep,  st,  ldv, ldt,
        ...
        magma_tally4_int_t locblknb, prevblkcnt, prevGblkid;
        magma_tally4_int_t myblknb, nbprevGblk, mastersweep;
        magma_tally4_int_t blkid, locj, LDV;
        locblknb = 0;
        prevblkcnt   = 0;
        myblknb  = 0;
