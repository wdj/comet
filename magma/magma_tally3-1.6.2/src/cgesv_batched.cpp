                  ...
                  magma_tally3_int_t batchCount, magma_tally3_queue_t queue)
{
    ...
    info = magma_tally3_cgetrf_batched( n, n, dA_array, ldda, dipiv_array, dinfo_array, batchCount, queue);
    ...
    info = magma_tally3_cgetrs_batched( Magma_tally3NoTrans, n, nrhs, dA_array, ldda, dipiv_array, dB_array, lddb,  batchCount, queue );
    return info;
}
