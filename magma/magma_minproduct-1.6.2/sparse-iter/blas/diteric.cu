/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from ziteric.cu normal z -> d, Sun May  3 11:22:58 2015
...
__global__ void 
magma_minproduct_diteric_csr_kernel(    
    magma_minproduct_int_t n, 
    magma_minproduct_int_t nnz, 
    magma_minproduct_index_t *Arowidx, 
    magma_minproduct_index_t *Acolidx, 
    ...
    {     
        ...
        // modify entry
        if (i == j)
            val[il-1] = MAGMA_minproduct_D_MAKE(sqrt(abs(MAGMA_minproduct_D_REAL(s))), 0.0);
        else
            val[il-1] =  s / val[iu-1];
...
/**
    ...
    The input format of the initial guess matrix A is Magma_minproduct_CSRCOO,
...
magma_minproduct_diteric_csr( 
    ...
    magma_minproduct_diteric_csr_kernel<<< grid, block, 0, magma_minproduct_stream >>>
            ( A.num_rows, A.nnz, 
