...
#include "magma_minproduct_task_d.h"
  ...
  void magma_minproduct_insert_dmalloc_pinned(magma_minproduct_int_t size, double **A, void *A_dep_ptr)
 {
    ...
    //  schedule_Task_Flag_Set (&task_flags, THREAD_SET_TO MANUAL_SCHEDULING, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_minproduct_task_dmalloc_pinned, &task_flags,
 ...
 void magma_minproduct_insert_dfree_pinned(double *A, void *A_dep_ptr)
 {
    ...
    //  schedule_Task_Flag_Set (&task_flags, THREAD_SET_TO MANUAL_SCHEDULING, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_minproduct_task_dfree_pinned, &task_flags,
              ///sizeof(double**),                A,            OUTPUT,//*size
 ...
 void magma_minproduct_insert_dfree_pinned_index(double **A, int index, void *A_dep_ptr)
 {
    ...
    //  schedule_Task_Flag_Set (&task_flags, THREAD_SET_TO MANUAL_SCHEDULING, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_minproduct_task_dfree_pinned_index, &task_flags,
              ///sizeof(double**),                A,            OUTPUT,//*size
  ...
  void magma_minproduct_insert_dsetmatrix(magma_minproduct_int_t m, magma_minproduct_int_t nb, double *A_src, magma_minproduct_int_t LDA, double *dA_dst, magma_minproduct_int_t dA_LD)
 {
    ...
    //  schedule_Task_Flag_Set (&task_flags, THREAD_SET_TO MANUAL_SCHEDULING, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_minproduct_task_dsetmatrix, &task_flags,
 ...
 schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"indigo");
           ...
           schedule_Insert_Task(sched_obj, magma_minproduct_task_dgetmatrix, &task_flags,
              sizeof(magma_minproduct_int_t),             &m,       VALUE,
              sizeof(magma_minproduct_int_t),             &nb,      VALUE,
 ...
 void magma_minproduct_insert_dsetmatrix_transpose(magma_minproduct_int_t m, magma_minproduct_int_t nb, double *A_src, magma_minproduct_int_t LDA, double *dA_dst, magma_minproduct_int_t dA_LD, double *dwork, magma_minproduct_int_t dwork_LD, void *A_src_dep_ptr, void *dA_dst_dep_ptr)
 {
    ...
    //  schedule_Task_Flag_Set (&task_flags, THREAD_SET_TO MANUAL_SCHEDULING, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_minproduct_task_dsetmatrix_transpose, &task_flags,
              sizeof(magma_minproduct_int_t),             &m,       VALUE,
              sizeof(magma_minproduct_int_t),             &nb,      VALUE,
              sizeof(double)*LDA*nb,           A_src,    INPUT,
              sizeof(magma_minproduct_int_t),             &LDA,     VALUE,
 ...
 schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"indigo");
           ...
           schedule_Insert_Task(sched_obj, magma_minproduct_task_dgetmatrix_transpose, &task_flags,
              sizeof(magma_minproduct_int_t),             &m,       VALUE,
              sizeof(magma_minproduct_int_t),             &nb,      VALUE,
              sizeof(double)*dA_LD*nb,         dA_src,   INPUT,
              sizeof(magma_minproduct_int_t),             &dA_LD,   VALUE,
...
Schedule_Task_Flags  task_flags = Schedule_Task_Flags_Initializer;
        ...
        schedule_Insert_Task(sched_obj, magma_minproduct_task_dlaswp, &task_flags,
...
/**/
void magma_minproduct_insert_dtrsm(magma_minproduct_side_t side, magma_minproduct_uplo_t uplo, magma_minproduct_trans_t trans, magma_minproduct_diag_t diag, magma_minproduct_int_t m, magma_minproduct_int_t n, double alpha, double *dA, magma_minproduct_int_t lda, double *dB, magma_minproduct_int_t ldb )
{
             ...
             schedule_Insert_Task(sched_obj, magma_minproduct_task_dtrsm, &task_flags,
...
void magma_minproduct_insert_dgemm(magma_minproduct_trans_t transA, magma_minproduct_trans_t transB, magma_minproduct_int_t m, magma_minproduct_int_t n, magma_minproduct_int_t k, double alpha, double *dA, magma_minproduct_int_t lda, double *dB, magma_minproduct_int_t ldb, double beta, double *dC, magma_minproduct_int_t ldc )
{
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"greenyellow");
              ...
              schedule_Insert_Task(sched_obj, magma_minproduct_task_dgemm, &task_flags,
