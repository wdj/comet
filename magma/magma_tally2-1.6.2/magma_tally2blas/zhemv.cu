...
/**
    Purpose
    -------
    magma_tally2blas_zhemv_work performs the matrix-vector operation:
    ...
    MAGMA_tally2 implements zhemv through two steps:
    ...
    magma_tally2blas_zhemv is a wrapper routine allocating the workspace inside the
    routine and provides the same interface as cublas.
    
    If users need to call zhemv frequently, we suggest using
    magma_tally2blas_zhemv_work instead of magma_tally2blas_zhemv. As the overhead to
    allocate and free in device memory in magma_tally2blas_zhemv would hurt performance.
    ...
    magma_tally2_queue_t queue )
{
    ...
    if ( arch < 200 ) {
        magma_tally2_zhemv( uplo, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
...
// end magma_tally2blas_zhemv_work


/**
    Purpose
    -------
    magma_tally2blas_zhemv performs the matrix-vector operation:
    ...
    magma_tally2DoubleComplex_ptr dy, magma_tally2_int_t incy)
{
    ...
    magma_tally2blas_zhemv_work( uplo, n, alpha, dA, ldda, dx, incx, beta, dy, incy,
