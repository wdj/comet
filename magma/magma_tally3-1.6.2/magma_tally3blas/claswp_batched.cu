...
void claswp_rowparallel_devfunc(  
                              ...
                              magma_tally3FloatComplex *dout, int ldo,
                              magma_tally3_int_t* pivinfo)
{
    ...
    magma_tally3FloatComplex *sdata = shared_data;
...
void claswp_rowparallel_kernel( 
                                int n, int width, int height,
                                magma_tally3FloatComplex *dinput, int ldi, 
                                magma_tally3FloatComplex *doutput, int ldo,
                                magma_tally3_int_t*  pivinfo)
{
...
void claswp_rowparallel_kernel_batched(
                                int n, int width, int height,
                                magma_tally3FloatComplex **input_array, int ldi, 
                                magma_tally3FloatComplex **output_array, int ldo,
...
//=================================================================================================
extern "C" void
magma_tally3_claswp_rowparallel_batched( magma_tally3_int_t n, 
                       magma_tally3FloatComplex** input_array, magma_tally3_int_t ldi,
                       ...
                       magma_tally3_int_t batchCount, magma_tally3_queue_t queue)
{
    ...
    if( n < SWP_WIDTH)
    {
        claswp_rowparallel_kernel_batched<<<grid, height, sizeof(magma_tally3FloatComplex) * height * n, queue >>>
                                           ( n, n, height, input_array, ldi, output_array, ldo, pivinfo_array ); 
    }
    else
    {
        claswp_rowparallel_kernel_batched<<< grid, height, sizeof(magma_tally3FloatComplex) * height * SWP_WIDTH , queue >>>
...
//=================================================================================================
extern "C" void
magma_tally3_claswp_rowparallel_q( magma_tally3_int_t n, 
                       magma_tally3FloatComplex* input, magma_tally3_int_t ldi,
                       magma_tally3FloatComplex* output, magma_tally3_int_t ldo,
                       magma_tally3_int_t k1, magma_tally3_int_t k2,
                       magma_tally3_int_t *pivinfo, 
                       magma_tally3_queue_t queue)
{
    ...
    {
       printf(" height=%d > %d, magma_tally3_claswp_rowparallel_q not supported \n", n,MAX_NTHREADS);
    ...
    if( n < SWP_WIDTH)
    {
        claswp_rowparallel_kernel<<<grid, height, sizeof(magma_tally3FloatComplex) * height * n, queue >>>
                                   ( n, n, height, input, ldi, output, ldo, pivinfo ); 
    }
    else
    {
        claswp_rowparallel_kernel<<< grid, height, sizeof(magma_tally3FloatComplex) * height * SWP_WIDTH , queue >>>
...
extern "C" void
magma_tally3_claswp_rowparallel( magma_tally3_int_t n, magma_tally3FloatComplex* input, magma_tally3_int_t ldi,
                   magma_tally3FloatComplex* output, magma_tally3_int_t ldo,
                   magma_tally3_int_t k1, magma_tally3_int_t k2,
                   magma_tally3_int_t *pivinfo)
{
    magma_tally3_claswp_rowparallel_q(n, input, ldi, output, ldo, k1, k2, pivinfo, magma_tally3_stream);
}
...
//=================================================================================================
__global__ void claswp_rowserial_kernel_batched( int n, magma_tally3FloatComplex **dA_array, int lda, int k1, int k2, magma_tally3_int_t** ipiv_array )
{
    magma_tally3FloatComplex* dA = dA_array[blockIdx.z];
...
//=================================================================================================
__global__ void claswp_columnserial_kernel_batched( int n, magma_tally3FloatComplex **dA_array, int lda, int k1, int k2, magma_tally3_int_t** ipiv_array )
{
    magma_tally3FloatComplex* dA = dA_array[blockIdx.z];
    magma_tally3_int_t *d_ipiv = ipiv_array[blockIdx.z];
