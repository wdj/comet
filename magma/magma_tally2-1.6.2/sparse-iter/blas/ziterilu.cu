...
magma_tally2_ziterilu_csr_kernel(   
    ...
    magma_tally2DoubleComplex s, sp;
    int il, iu, jl, ju;
...
magma_tally2_ziterilu_csr( 
    ...
    magma_tally2_ziterilu_csr_kernel<<< grid, block, 0, magma_tally2_stream >>>
        ( A.num_rows, A.nnz, 
