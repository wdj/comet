...
int main( int argc, char** argv)
{
    ...
    magma_tally2_int_t N, n2, info, il, iu, m1, nb, lwork, liwork;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            // ==================================================================
            if ( opts.warmup ) {
                lapackf77_clacpy( Magma_tally2FullStr, &N, &N, h_A, &N, h_R, &N );
                lapackf77_clacpy( Magma_tally2FullStr, &N, &N, h_B, &N, h_S, &N );
                
                magma_tally2_chegvdx( opts.itype, opts.jobz, Magma_tally2RangeI, opts.uplo,
                               ...
                               &info );
                if (info != 0)
                    printf("magma_tally2_chegvdx returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_tally2NoVec ) {
                ...
                //lapackf77_clacpy( Magma_tally2FullStr, &N, &N, h_B, &N, h_S, &N );
                //
                //magma_tally2_int_t m2;
                //magma_tally2_chegvdx( opts.itype, Magma_tally2NoVec, Magma_tally2RangeI, opts.uplo,
