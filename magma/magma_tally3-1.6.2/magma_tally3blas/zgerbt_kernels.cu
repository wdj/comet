...
magma_tally3blas_zelementary_multiplication_devfunc(
    magma_tally3_int_t n,
    magma_tally3DoubleComplex *dA, magma_tally3_int_t ldda, 
    magma_tally3DoubleComplex *du, 
    magma_tally3DoubleComplex *dv)
{    
    magma_tally3_int_t idx, idy;
    ...
    if ((idx < n/2)&&(idy < n/2)){
        ...
        magma_tally3DoubleComplex a00, a10, a01, a11, b1, b2, b3, b4;
        __shared__ magma_tally3DoubleComplex u1[block_height], u2[block_height], v1[block_width], v2[block_width];
...
{    
    magma_tally3blas_zelementary_multiplication_devfunc( n, dA+offsetA, ldda, du+offsetu, dv+offsetv);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
__global__ void 
...
{    
    ...
    magma_tally3blas_zelementary_multiplication_devfunc( n, dA_array[batchid]+offsetA, ldda, du+offsetu, dv+offsetv);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
static __device__ void 
magma_tally3blas_zapply_vector_devfunc(
    magma_tally3_int_t n,
    magma_tally3DoubleComplex *du, magma_tally3DoubleComplex *db)
{
    ...
    if (idx < n/2){
        ...
        magma_tally3DoubleComplex a1,a2;
...
{
    magma_tally3blas_zapply_vector_devfunc(n, du+offsetu, db+offsetb);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
__global__ void 
    ...
    magma_tally3DoubleComplex *du, magma_tally3_int_t offsetu, magma_tally3DoubleComplex **db_array, magma_tally3_int_t offsetb )
{
    ...
    magma_tally3blas_zapply_vector_devfunc(n, du+offsetu, db_array[batchid]+offsetb);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////

static __device__ void 
magma_tally3blas_zapply_transpose_vector_devfunc(
    magma_tally3_int_t n,
    magma_tally3DoubleComplex *du,magma_tally3DoubleComplex *db )
{
    magma_tally3_int_t idx;
...
magma_tally3blas_zapply_transpose_vector_kernel(
    ...
    magma_tally3DoubleComplex *du, magma_tally3_int_t offsetu, magma_tally3DoubleComplex *db, magma_tally3_int_t offsetb )
{
    magma_tally3blas_zapply_transpose_vector_devfunc(n, du+offsetu, db+offsetb);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
__global__ void 
    ...
    magma_tally3DoubleComplex *du, magma_tally3_int_t offsetu, magma_tally3DoubleComplex **db_array, magma_tally3_int_t offsetb )
{
    ...
    int batchid = blockIdx.y;
    magma_tally3blas_zapply_transpose_vector_devfunc(n, du+offsetu, db_array[batchid]+offsetb);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
