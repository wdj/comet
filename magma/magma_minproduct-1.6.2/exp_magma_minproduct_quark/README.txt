...
Notice:
======
exp_magma_minproduct_quark is a temporary name. We are still looking for a better name, so if you have a better suggestion, just let us know.

Purpose:
========
exp_magma_minproduct_quark proposes a new scheduling strategy for hybrid CPU/GPU computations.
...
magma_minproduct_insert: The wrapper for any task insertion. e.g magma_minproduct_insert_dgemm(...)
magma_minproduct_task: The GPU routines called by the scheduler. e.g magma_minproduct_task_dgemm(...)
...
Test:
====
1. Compile magma_minproduct
	cd <magma_minproduct_dir>/trunk
	make
...
3. Compile magma_minproduct_quark
	cd exp_magma_minproduct_quark
	make
