...
def getlatexdoc(funcdoc):
  latexdoc = "\\textsf{magma_tally2\_int\_t} "
...
def getoutputdoc(fdoc, output):
  ...
  doc += output.ret_type("magma_tally2_int_t")
