...
magma_tally2blas_dlaswp(
    ...
    const magma_tally2_int_t *ipiv, magma_tally2_int_t inci )
{
    magma_tally2blas_dlaswp_q( n, dAT, ldda, k1, k2, ipiv, inci, magma_tally2_stream );
}
...
/**
    @see magma_tally2blas_dlaswpx_q
    @ingroup magma_tally2_daux2
    ********************************************************************/
extern "C" void
magma_tally2blas_dlaswpx(
    ...
    const magma_tally2_int_t *ipiv, magma_tally2_int_t inci )
{
    return magma_tally2blas_dlaswpx_q( n, dA, ldx, ldy, k1, k2, ipiv, inci, magma_tally2_stream );
}
...
// batches of pivots. On Fermi, it is faster than magma_tally2blas_dlaswp
...
/**
    @see magma_tally2blas_dlaswp2_q
    @ingroup magma_tally2_daux2
    ********************************************************************/
extern "C" void
magma_tally2blas_dlaswp2(
    ...
    magma_tally2Int_const_ptr d_ipiv, magma_tally2_int_t inci )
{
    magma_tally2blas_dlaswp2_q( n, dAT, ldda, k1, k2, d_ipiv, inci, magma_tally2_stream );
}
