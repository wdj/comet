    ...
    if (nb <= 1 || nb >= n) {
        ...
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally2_ztrmm( Magma_tally2Right, Magma_tally2Upper,
                             Magma_tally2ConjTrans, Magma_tally2NonUnit, i, ib,
                             c_one, dA(i,i), ldda, dA(0, i),ldda);

                magma_tally2_zgetmatrix( ib, ib,
                                  dA(i, i), ldda,
                                  work,     ib );

                lapackf77_zlauum(Magma_tally2UpperStr, &ib, work, &ib, info);

                magma_tally2_zsetmatrix( ib, ib,
                                  work,     ib,
                                  dA(i, i), ldda );
                ...
                if (i+ib < n) {
                    ...
                    magma_tally2_zherk( Magma_tally2Upper, Magma_tally2NoTrans, ib,(n-i-ib),
            ...
            for (i=0; i < n; i += nb) {
                ...
                lapackf77_zlauum(Magma_tally2LowerStr, &ib, work, &ib, info);
                ...
                if (i+ib < n) {
                    magma_tally2_zgemm( Magma_tally2ConjTrans, Magma_tally2NoTrans,
                                 ...
                                 dA(i,0), ldda);
                    magma_tally2_zherk( Magma_tally2Lower, Magma_tally2ConjTrans, ib, (n-i-ib),
