/*
    -- MAGMA_tally3 (version 1.6.1) --
       ...
       @generated from testing_zpotf2_gpu.cpp normal z -> s, Fri Jan 30 19:00:24 2015
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
...
int main( int argc, char** argv)
{
    ...
    printf("    N   CPU GFlop/s (ms)    GPU GFlop/s (ms)    ||R_magma_tally3 - R_lapack||_F / ||R_lapack||_F\n");
    printf("========================================================\n");
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally3_spotf2_gpu( opts.uplo, N, d_A, ldda, &info );
            gpu_time = magma_tally3_wtime() - gpu_time;
            gpu_perf = gflops / gpu_time;
            if (info != 0)
                printf("magma_tally3_spotf2_gpu returned error %d: %s.\n",
