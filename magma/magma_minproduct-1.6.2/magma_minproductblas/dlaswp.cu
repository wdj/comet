...
/**
    @see magma_minproductblas_dlaswp_q
    @ingroup magma_minproduct_daux2
    ********************************************************************/
extern "C" void
magma_minproductblas_dlaswp(
    ...
    const magma_minproduct_int_t *ipiv, magma_minproduct_int_t inci )
{
    magma_minproductblas_dlaswp_q( n, dAT, ldda, k1, k2, ipiv, inci, magma_minproduct_stream );
}
...
/**
    @see magma_minproductblas_dlaswpx_q
    @ingroup magma_minproduct_daux2
    ********************************************************************/
extern "C" void
magma_minproductblas_dlaswpx(
    ...
    const magma_minproduct_int_t *ipiv, magma_minproduct_int_t inci )
{
    return magma_minproductblas_dlaswpx_q( n, dA, ldx, ldy, k1, k2, ipiv, inci, magma_minproduct_stream );
}
...
// batches of pivots. On Fermi, it is faster than magma_minproductblas_dlaswp
...
/**
    @see magma_minproductblas_dlaswp2_q
    @ingroup magma_minproduct_daux2
    ********************************************************************/
extern "C" void
magma_minproductblas_dlaswp2(
    ...
    magma_minproductInt_const_ptr d_ipiv, magma_minproduct_int_t inci )
{
    magma_minproductblas_dlaswp2_q( n, dAT, ldda, k1, k2, d_ipiv, inci, magma_minproduct_stream );
}
