/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from ziterilu.cu normal z -> c, Sun May  3 11:22:58 2015
...
__global__ void 
magma_minproduct_citerilu_csr_kernel(   
    magma_minproduct_int_t num_rows, 
    magma_minproduct_int_t nnz,  
    magma_minproduct_index_t *rowidxA, 
    magma_minproduct_index_t *colidxA,
    const magma_minproductFloatComplex * __restrict__ A, 
    magma_minproduct_index_t *rowptrL, 
    magma_minproduct_index_t *colidxL, 
    magma_minproductFloatComplex *valL, 
    magma_minproduct_index_t *rowptrU, 
    magma_minproduct_index_t *rowidxU, 
    magma_minproductFloatComplex *valU ){
    ...
    magma_minproductFloatComplex s, sp;
    int il, iu, jl, ju;
...
/**
    ...
    The input format of the matrix is Magma_minproduct_CSRCOO for the upper and lower 
    ...
    @param[in]
    A_CSR       magma_minproduct_c_matrix
...
magma_minproduct_citerilu_csr( 
    ...
    magma_minproduct_citerilu_csr_kernel<<< grid, block, 0, magma_minproduct_stream >>>
        ( A.num_rows, A.nnz, 
