...
int main(  int argc, char** argv )
{
    ...
    magma_minproduct_z_matrix a={Magma_minproduct_CSR}, b={Magma_minproduct_CSR}, x={Magma_minproduct_CSR}, y={Magma_minproduct_CSR}, skp={Magma_minproduct_CSR};
    ...
    for( magma_minproduct_int_t num_vecs=5; num_vecs<6; num_vecs+=1 ) {
        for( magma_minproduct_int_t n=10000; n<100000001; n=n+10000 ) {
            ...
            CHECK( magma_minproduct_zvinit( &a, Magma_minproduct_DEV, n, num_vecs, one, queue ));
            CHECK( magma_minproduct_zvinit( &b, Magma_minproduct_DEV, num_vecs, 1, one, queue ));
            int min_ten = min(num_vecs, 15);
            CHECK( magma_minproduct_zvinit( &x, Magma_minproduct_DEV, min_ten, n, one, queue ));
            CHECK( magma_minproduct_zvinit( &y, Magma_minproduct_DEV, min_ten, n, one, queue ));
            CHECK( magma_minproduct_zvinit( &skp, Magma_minproduct_DEV, num_vecs, 1, zero, queue ));

            // warm up
            CHECK( magma_minproduct_zgemvmdot( n, num_vecs, a.dval, b.dval, x.dval, y.dval, skp.dval, queue ));
            ...
            for( int h=0; h<iters; h++) {
                for( int l=0; l<num_vecs; l++)
                    alpha = magma_minproduct_zdotc(n, a.dval, 1, b.dval, 1);
            }
            #ifdef ENABLE_TIMER
            ...
            #endif
            for( int h=0; h<iters; h++) {
                magma_minproduct_zgemv(Magma_minproductTrans, n, num_vecs, one, a.dval, n, b.dval, 1, zero, skp.dval, 1);
                //h++;
            }
            #ifdef ENABLE_TIMER
            ...
            #endif
            for( int h=0; h<iters; h++) {
                magma_minproductblas_zgemv(Magma_minproductTrans, n, num_vecs, one, a.dval, n, b.dval, 1, zero, skp.dval, 1);
                //h++;
            }
            #ifdef ENABLE_TIMER
            ...
            #endif
            for( int h=0; h<iters; h++) {
                //magma_minproduct_zmdotc( n, num_vecs, a.dval, b.dval, x.dval, y.dval, skp.dval, queue );
                CHECK( magma_minproduct_zmdotc( n, 2, a.dval, b.dval, x.dval, y.dval, skp.dval, queue ));
                CHECK( magma_minproduct_zmdotc( n, 2, a.dval, b.dval, x.dval, y.dval, skp.dval, queue ));
                CHECK( magma_minproduct_zmdotc( n, 1, a.dval, b.dval, x.dval, y.dval, skp.dval, queue ));
                //h++;
            }
            #ifdef ENABLE_TIMER
            ...
            //magma_minproduct_zprint_gpu(num_vecs,1,skp.dval,num_vecs);
            ...
            printf("%d  %d  %e  %e  %e  %e  %e  %e  %e  %e  %e  %e\n",
                    ...
                    (double)(computations)/(magma_minproductgemv_time*(1.e+09)),
            ...
            magma_minproduct_zmfree(&skp, queue );
        }
