    ...
    if (nb >= k) {
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            cpanel_to_q( Magma_minproductUpper, ib, A(i,i), lda, T2 );
            magma_minproduct_csetmatrix( nq_i,  ib, A(i,i), lda, dV(0,0), nq_i );
            cq_to_panel( Magma_minproductUpper, ib, A(i,i), lda, T2 );
