    ...
    double *A, int lda )
{
    ...
    bool full = (iby + BLK_Y <= n && (ind >= iby + BLK_Y || ind + BLK_X <= iby || MAGMA_tally3_D_EQUAL( offdiag, diag )));
...
/**
    ...
    ********************************************************************/
extern "C"
void magma_tally3blas_dlaset_q(
    ...
    magma_tally3_queue_t queue)
{
    ...
    if (uplo == Magma_tally3Lower) {
        ...
        if ( m == ldda &&
             MAGMA_tally3_D_EQUAL( offdiag, MAGMA_tally3_D_ZERO ) &&
             MAGMA_tally3_D_EQUAL( diag,    MAGMA_tally3_D_ZERO ) )
        {
            size_t size = m*n;
...
/**
    @see magma_tally3blas_dlaset_q
    @ingroup magma_tally3_daux2
    ********************************************************************/
extern "C"
void magma_tally3blas_dlaset(
    magma_tally3_uplo_t uplo, magma_tally3_int_t m, magma_tally3_int_t n,
    double offdiag, double diag,
    magma_tally3Double_ptr dA, magma_tally3_int_t ldda )
{
    magma_tally3blas_dlaset_q( uplo, m, n, offdiag, diag, dA, ldda, magma_tally3_stream );
}


////////////////////////////////////////////////////////////////////////////////////////
extern "C"
void magma_tally3blas_dlaset_batched(
    magma_tally3_uplo_t uplo, magma_tally3_int_t m, magma_tally3_int_t n,
    double offdiag, double diag,
