/*
    -- MAGMA_tally4 (version 1.6.2) --
       ...
       @generated from magma_tally4_zsolverinfo.cpp normal z -> d, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
    ...
    magma_tally4_queue_t queue )
{
    ...
    if ( solver_par->solver == Magma_tally4_LOBPCG ) {
        CHECK( magma_tally4_dmalloc_cpu( &solver_par->eigenvalues ,
        ...
        CHECK( magma_tally4_dmalloc_cpu( &initial_guess, ev ));
        CHECK( magma_tally4_dmalloc( &solver_par->eigenvectors, ev ));
        magma_tally4_int_t ISEED[4] = {0,0,0,1}, ione = 1;
        lapackf77_dlarnv( &ione, ISEED, &ev, initial_guess );

        magma_tally4_dsetmatrix( solver_par->ev_length, solver_par->num_eigenvalues,
