/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zmtranspose.cpp normal z -> d, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
       @author Mark Gates
    ...
    magma_tally2_queue_t queue )
{
    ...
    CHECK( magma_tally2_dmalloc_cpu( &csc_values, nnz ) );
    ...
    magma_tally2_queue_t queue )
{
    ...
    magma_tally2_d_matrix ACSR={Magma_tally2_CSR}, BCSR={Magma_tally2_CSR};
    ...
    if( A.storage_type == Magma_tally2_CSR && A.memory_location == Magma_tally2_DEV ) {
        ...
        CHECK( magma_tally2_dmtransfer( A, &A_d, A.memory_location, Magma_tally2_DEV, queue ));
        CHECK( magma_tally2_d_cucsrtranspose( A_d, &B_d, queue ));
        CHECK( magma_tally2_dmtransfer( B_d, B, Magma_tally2_DEV, A.memory_location, queue ));
                
    }else {
        CHECK( magma_tally2_dmconvert( A, &ACSR, A.storage_type, Magma_tally2_CSR, queue ));
        CHECK( magma_tally2_d_cucsrtranspose( ACSR, &BCSR, queue ));
        CHECK( magma_tally2_dmconvert( BCSR, B, Magma_tally2_CSR, A.storage_type, queue ));
    }
cleanup:
    ...
    magma_tally2_dmfree( &BCSR, queue );
    if( info != 0 ){
