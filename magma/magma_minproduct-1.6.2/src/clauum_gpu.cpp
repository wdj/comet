...
#define dA(i, j) (dA + (j)*ldda + (i))
    ...
    *info = 0;
    ...
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_cmalloc_pinned( &work, nb*nb )) {
    ...
    if (nb <= 1 || nb >= n) {
        magma_minproduct_cgetmatrix( n, n, dA, ldda, work, n );
        lapackf77_clauum(uplo_, &n, work, &n, info);
        magma_minproduct_csetmatrix( n, n, work, n, dA, ldda );
    }
    else {
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_minproduct_cgetmatrix( ib, ib,
                                  dA(i, i), ldda,
                                  work,     ib );

                lapackf77_clauum(Magma_minproductUpperStr, &ib, work, &ib, info);

                magma_minproduct_csetmatrix( ib, ib,
                                  work,     ib,
                                  dA(i, i), ldda );
            ...
            for (i=0; i < n; i += nb) {
                ...
                lapackf77_clauum(Magma_minproductLowerStr, &ib, work, &ib, info);
