/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zgehrd.cpp normal z -> s, Fri Jan 30 19:00:19 2015
...
/**
    ...
    This version stores the T matrices in dT, for later use in magma_minproduct_sorghr.
    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb == 1 || nb > nh) {
        ...
        //   n*ldda  for dA
        float *dwork;
        if (MAGMA_minproduct_SUCCESS != magma_minproduct_smalloc( &dwork, 2*nb*ldda + n*ldda )) {
        ...
        float *T;
        magma_minproduct_smalloc_cpu( &T, nb*nb );
        if ( T == NULL ) {
        ...
        magma_minproductblas_slaset( Magma_minproductFull, nb, nb, c_zero, c_zero, dV, ldda );
        ...
        magma_minproductblas_slaset( Magma_minproductFull, nb, n, c_zero, c_zero, dT, nb );
        
        // Copy the matrix to the GPU
        magma_minproduct_ssetmatrix( n, n-ilo, A(0,ilo), lda, dA, ldda );
        ...
        for (i = ilo; i < ihi-1 - nb; i += nb) {
            ...
            magma_minproduct_slahr2( ihi, i+1, nb,
                          dA(0,i-ilo), ldda,
                          dV,          ldda,
                          A(0,i),      lda,
                          &tau[i], T, nb, work, n);
            ...
            dTi = dT + (i - ilo)*nb;
            magma_minproduct_ssetmatrix( nb, nb, T, nb, dTi, nb );
            
            magma_minproduct_slahru( n, ihi, i, nb,
                          A(0,i),      lda,
                          dA(0,i-ilo), ldda, // dA
        ...
        magma_minproduct_sgetmatrix( n, n-i,
                          dA(0,i-ilo), ldda,
                          A(0,i), lda );
