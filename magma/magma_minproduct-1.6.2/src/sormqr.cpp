    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb >= k) {
        ...
        magma_minproductFloat_ptr dwork, dV, dT, dC;
        ...
        magma_minproduct_smalloc_cpu( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_minproduct_ssetmatrix( m, n, C, ldc, dC(0,0), lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            spanel_to_q( Magma_minproductUpper, ib, A(i,i), lda, T2 );
            magma_minproduct_ssetmatrix( nq_i,  ib, A(i,i), lda, dV(0,0), nq_i );
            sq_to_panel( Magma_minproductUpper, ib, A(i,i), lda, T2 );
            ...
            magma_minproduct_ssetmatrix( ib, ib, T, ib, dT(0,0), ib );
        ...
        magma_minproduct_sgetmatrix( m, n, dC(0,0), lddc, C, ldc );
