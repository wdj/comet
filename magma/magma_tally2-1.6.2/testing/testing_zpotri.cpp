    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* ====================================================================
               ...
               =================================================================== */
            if ( opts.warmup ) {
                magma_tally2_zpotrf( opts.uplo, N, h_R, lda, &info );
                magma_tally2_zpotri( opts.uplo, N, h_R, lda, &info );
                lapackf77_zlacpy( Magma_tally2UpperLowerStr, &N, &N, h_A, &lda, h_R, &lda );
            }
            ...
            //h_R[ 10 + 10*lda ] = MAGMA_tally2_Z_MAKE( 0.0, 0.0 );
            ...
            if (info != 0)
                printf("magma_tally2_zpotri returned error %d: %s.\n",
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_zpotri( lapack_uplo_const_tally2(opts.uplo), &N, h_A, &lda, &info );
