    ...
    if ( ind < m ) {
        ...
        if ( full ) {
            ...
            for( int j=0; j < BLK_Y; ++j ) {
                A[j*lda] = MAGMA_minproduct_D_MAKE( MAGMA_minproduct_S_REAL( SA[j*ldsa] ), MAGMA_minproduct_S_IMAG( SA[j*ldsa] ));
            }
        }
        else {
...
/**
    @see magma_minproductblas_slag2d_q
    @ingroup magma_minproduct_saux2
    ********************************************************************/
extern "C" void
magma_minproductblas_slag2d(
    ...
    magma_minproduct_int_t *info)
{
    magma_minproductblas_slag2d_q( m, n, SA, ldsa, A, lda, info, magma_minproduct_stream );
}
