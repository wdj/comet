...
/**
    ...
    @ingroup magma_tally4_dsysv_driver
    ********************************************************************/
...
magma_tally4_dsysv_nopiv_gpu(magma_tally4_uplo_t uplo,  magma_tally4_int_t n, magma_tally4_int_t nrhs, 
                 ...
                 magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    ret = magma_tally4_dsytrf_nopiv_tally4_gpu(uplo, n, dA, ldda, info);
    if ( (ret != MAGMA_tally4_SUCCESS) || (*info != 0) ) {
        return ret;
    }
        
    ret = magma_tally4_dsytrs_nopiv_gpu( uplo, n, nrhs, dA, ldda, dB, lddb, info );
    if ( (ret != MAGMA_tally4_SUCCESS) || (*info != 0) ) {
        return ret;
    }
