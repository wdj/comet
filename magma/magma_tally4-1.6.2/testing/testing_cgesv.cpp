/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from testing_zgesv.cpp normal z -> c, Fri Jan 30 19:00:25 2015
       @author Mark Gates
*/
// includes, system
#include <stdio.h>
...
int main(int argc, char **argv)
{
    ...
    magma_tally4FloatComplex *h_A, *h_LU, *h_B, *h_X;
    magma_tally4_int_t *ipiv;
    magma_tally4_int_t N, nrhs, lda, ldb, info, sizeA, sizeB;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_LU, magma_tally4FloatComplex, lda*N    );
            ...
            magma_tally4_cgesv( N, nrhs, h_LU, lda, ipiv, h_X, ldb, &info );
            gpu_time = magma_tally4_wtime() - gpu_time;
            gpu_perf = gflops / gpu_time;
            if (info != 0)
                printf("magma_tally4_cgesv returned error %d: %s.\n",
