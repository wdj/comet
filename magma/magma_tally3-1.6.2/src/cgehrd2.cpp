    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb == 1 || nb > nh) {
        ...
        if (MAGMA_tally3_SUCCESS != magma_tally3_cmalloc( &dwork, 2*nb*ldda + n*ldda + nb*nb )) {
            *info = MAGMA_tally3_ERR_DEVICE_ALLOC;
            return *info;
        }
        magma_tally3FloatComplex *dV = dwork + nb*ldda;
        magma_tally3FloatComplex *dA = dwork + nb*ldda*2;
        magma_tally3FloatComplex *dT = dwork + nb*ldda*2 + n*ldda;
        ldwork = ldda;
        ...
        for (i = ilo; i < ihi-1 - nb; i += nb) {
            ...
            magma_tally3_csetmatrix( nb, nb, T, nb, dT, nb );
