    ...
    magma_tally4_int_t *info)
{
    ...
    */
    magma_tally4blas_zswapdblk(k-1, nb, dA(0,0), ldda, 1, dT(0), nb, 0);
    if ( nrhs == 1 ) {
        magma_tally4_ztrsv(Magma_tally4Upper, Magma_tally4NoTrans, Magma_tally4NonUnit,
                    n, dA(0,0), ldda, dB, 1);
    } else {
        magma_tally4_ztrsm(Magma_tally4Left, Magma_tally4Upper, Magma_tally4NoTrans, Magma_tally4NonUnit,
                    n, nrhs, c_one, dA(0,0), ldda, dB, lddb);
    }
    magma_tally4blas_zswapdblk(k-1, nb, dT(0), nb, 0, dA(0,0), ldda, 1);
