...
__global__ void
magma_tally3int_clag2z_sparse(  int M, int N,
...
magma_tally3blas_clag2z_sparse(
    ...
    const magma_tally3FloatComplex *SA, magma_tally3_int_t ldsa,
    ...
    magma_tally3_queue_t queue )
{
    ...
    *info = 0;
    ...
    dim3 grid( magma_tally3_ceildiv( M, blksize ) );
    cudaMemcpyToSymbol( flag, info, sizeof(flag) );    // flag = 0
    magma_tally3int_clag2z_sparse<<< dimGrid , dimBlock, 0, queue >>>
