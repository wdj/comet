...
/**
    ...
    @ingroup magma_tally4_ssygv_driver
    ********************************************************************/
    ...
    magma_tally4_int_t *info)
{
    ...
    float d_one = MAGMA_tally4_S_ONE;
    ...
    *info = 0;
    ...
    if (MAGMA_tally4_SUCCESS != magma_tally4_smalloc( &dA, n*ldda ) ||
        MAGMA_tally4_SUCCESS != magma_tally4_smalloc( &dB, n*lddb )) {
        *info = MAGMA_tally4_ERR_DEVICE_ALLOC;
        return *info;
    }

    /* Form a Cholesky factorization of B. */
    magma_tally4_ssetmatrix( n, n, B, ldb, dB, lddb );
    magma_tally4_ssetmatrix_async( n, n,
                            A,  lda,
                            dA, ldda, stream );
    ...
    magma_tally4_spotrf_gpu(uplo, n, dB, lddb, info);
    if (*info != 0) {
        *info = n + *info;
        return *info;
    }
    ...
    magma_tally4_sgetmatrix_async( n, n,
                            dB, lddb,
                            B,  ldb, stream );
    ...
    magma_tally4_ssygst_gpu(itype, uplo, n, dA, ldda, dB, lddb, info);
    ...
    magma_tally4_ssyevdx_2stage(jobz, range, uplo, n, A, lda, vl, vu, il, iu, m, w, work, lwork, iwork, liwork, info);
    ...
    if (wantz && *info == 0) {
        ...
        magma_tally4_ssetmatrix( n, *m, A, lda, dA, ldda );
        magma_tally4_ssetmatrix( n,  n, B, ldb, dB, lddb );
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally4_strsm(Magma_tally4Left, uplo, trans, Magma_tally4NonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally4_strmm(Magma_tally4Left, uplo, trans, Magma_tally4NonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }

        magma_tally4_sgetmatrix( n, *m, dA, ldda, A, lda );
