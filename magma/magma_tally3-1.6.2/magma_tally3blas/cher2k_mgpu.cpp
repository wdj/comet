...
/**
    ...
    trans    magma_tally3_trans_t.
      ...
      -     = Magma_tally3_ConjTrans:  C := alpha*A**H*B + conj( alpha )*B**H*A + beta*C.
    ...
    k        INTEGER.
             ...
             TRANS = Magma_tally3_ConjTrans, K specifies the number of rows of the
    ...
    ********************************************************************/
extern "C"
void magma_tally3blas_cher2k_mgpu2(
    ...
    magma_tally3_int_t ngpu, magma_tally3_int_t nb, magma_tally3_queue_t queues[][20], magma_tally3_int_t nqueue )
{
    ...
    if ( uplo != Magma_tally3Lower) {
        ...
        info = -4;
                ...
                ((trans == Magma_tally3_ConjTrans) && ldda < max(1,k)) ) {
        info = -7;
    } else if ( a_offset < 0 || a_offset > ldda ) {
        info = -8;
    } else if ( ((trans == Magma_tally3NoTrans)    && lddb < max(1,n)) ||
                ((trans == Magma_tally3_ConjTrans) && lddb < max(1,k)) ) {
        info = -10;
    ...
    for( magma_tally3_int_t i = 0; i < n; i += ib ) {
        ...
        magma_tally3_cgemm( Magma_tally3NoTrans, Magma_tally3_ConjTrans, n-i, ib, k,
    ...
    alpha = MAGMA_tally3_C_CNJG( alpha );
