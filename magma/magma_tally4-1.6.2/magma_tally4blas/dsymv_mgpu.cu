/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from zhemv_mgpu.cu normal z -> d, Fri Jan 30 19:00:10 2015
    ...
    int block_offset )
{
    ...
    double psum, psum_t;
    double total = MAGMA_tally4_D_ZERO;
...
/**************************************************************
    ...
    Note beta*y is not included here; see magma_tally4blas_dsymv_mgpu_sync.
    ...
    int block_offset)
{
    ...
    if ( ind >= block_offset && ind < n+block_offset ) {
        ...
        y[ind * incy] = alpha*Ax;  // see magma_tally4blas_dsymv_sync for beta*y
    }
}
...
/**
    Purpose
    -------
    magma_tally4blas_dsymv_mgpu performs the matrix-vector operation:
...
magma_tally4blas_dsymv_mgpu(
    ...
    double alpha,
    magma_tally4Double_const_ptr const d_lA[], magma_tally4_int_t ldda,
    magma_tally4_int_t offset,
    double const *x,       magma_tally4_int_t incx,
    double beta,                                         // unused, see magma_tally4blas_dsymv_mgpu_sync
    double       *y,       magma_tally4_int_t incy,             // unused
    ...
    magma_tally4_queue_t queues[] )
{
    ...
    for(dev=0; dev < ngpu; dev++) {
        ...
        // copy x to each GPU
        magma_tally4_dsetvector_async( n, x, incx, dx_dev + block_offset, 1, queues[dev] );
    ...
    for(dev=0; dev < ngpu; dev++) {
        ...
        magma_tally4_setdevice( dev );
        double       *dx_dev    = dwork[dev];
        magma_tally4_dgetvector_async( n, dx_dev + block_offset, 1, &hwork[dev*n], 1, queues[dev] );
    }
    
    // see magma_tally4blas_dsymv_mgpu_sync for final row sums
...
/**
    ...
    For convenience, the parameters are identical to magma_tally4blas_dsymv_mgpu
    (though some are unused here).
    
    @see magma_tally4blas_dsymv_mgpu
    @ingroup magma_tally4_dblas2
    ********************************************************************/
extern "C" magma_tally4_int_t
magma_tally4blas_dsymv_mgpu_sync(
    magma_tally4_uplo_t uplo,                                               // unused, see magma_tally4blas_dsymv_mgpu
    magma_tally4_int_t n,
    double alpha,                                        // unused
    magma_tally4Double_const_ptr const d_lA[], magma_tally4_int_t ldda,
    magma_tally4_int_t offset,                                              // unused
    double const *x,       magma_tally4_int_t incx,             // unused
    double beta,
    double       *y,       magma_tally4_int_t incy,             // unused
    double       *hwork,   magma_tally4_int_t lhwork,
    magma_tally4Double_ptr    dwork[], magma_tally4_int_t ldwork,           // unused
    magma_tally4_int_t ngpu,
