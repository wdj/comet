    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally4_zpotrf_m( ngpu, uplo, n, B, ldb, info );
    if (*info != 0) {
        *info = n + *info;
        return *info;
    }
    ...
    magma_tally4_zhegst_m( ngpu, itype, uplo, n, A, lda, B, ldb, info );

    timer_stop( time );
    timer_printf( "time zhegst_m = %6.2f\n", time );
    timer_start( time );

    magma_tally4_zheevdx_2stage_m( ngpu, jobz, range, uplo, n, A, lda, vl, vu, il, iu, mout, w, work, lwork, rwork, lrwork, iwork, liwork, info );
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally4_ztrsm_m( ngpu, Magma_tally4Left, uplo, trans, Magma_tally4NonUnit, n, *mout, c_one, B, ldb, A, lda );
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            //magma_tally4_ztrmm_m(ngpu, Magma_tally4Left, uplo, trans, Magma_tally4NonUnit, n, *mout, c_one, B, ldb, A, lda);
