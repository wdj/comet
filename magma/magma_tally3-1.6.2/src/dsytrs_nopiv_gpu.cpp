    ...
    magma_tally3_int_t *info)
{
  ...
  if (upper) {
            magma_tally3blas_dtrsm( Magma_tally3Left, Magma_tally3Upper, 
                           Magma_tally3ConjTrans, Magma_tally3Unit, 
                           n, nrhs, c_one,
                           dA, ldda, dB, lddb );
            magma_tally3blas_dlascl_diag(Magma_tally3Upper, 1, n, dA, ldda, dB,1, info);
            magma_tally3blas_dtrsm( Magma_tally3Left, Magma_tally3Upper, 
            ...
            magma_tally3_dtrsm( Magma_tally3Left, Magma_tally3Lower, 
                           Magma_tally3NoTrans, Magma_tally3Unit, 
                           n, nrhs, c_one,
                           dA, ldda, dB, lddb );
            magma_tally3blas_dlascl_diag(Magma_tally3Lower, 1, n, dA, ldda, dB,1, info);
            magma_tally3blas_dtrsm( Magma_tally3Left, Magma_tally3Lower, 
                           Magma_tally3ConjTrans, Magma_tally3Unit, 
                           n, nrhs, c_one,
                           dA, ldda, dB, lddb );
        }
