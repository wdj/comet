...
void clacpy_full_device(
    int m, int n,
    const magma_tally3FloatComplex *dA, int ldda,
    magma_tally3FloatComplex       *dB, int lddb )
{
...
void clacpy_full_kernel_batched(
    int m, int n,
    magma_tally3FloatComplex const * const *dAarray, int ldda,
...
magma_tally3blas_clacpy(
    ...
    magma_tally3FloatComplex_ptr       dB, magma_tally3_int_t lddb )
{
    magma_tally3blas_clacpy_q( uplo, m, n, dA, ldda, dB, lddb, magma_tally3_stream );
}
