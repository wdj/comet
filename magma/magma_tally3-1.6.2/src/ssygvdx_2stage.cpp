    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally3_ssyevdx_2stage(jobz, range, uplo, n, A, lda, vl, vu, il, iu, m, w, work, lwork, iwork, liwork, info);
    ...
    if (wantz && *info == 0) {
        ...
        magma_tally3_ssetmatrix( n, *m, A, lda, dA, ldda );
        magma_tally3_ssetmatrix( n,  n, B, ldb, dB, lddb );
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally3_strsm(Magma_tally3Left, uplo, trans, Magma_tally3NonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally3_strmm(Magma_tally3Left, uplo, trans, Magma_tally3NonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }

        magma_tally3_sgetmatrix( n, *m, dA, ldda, A, lda );
