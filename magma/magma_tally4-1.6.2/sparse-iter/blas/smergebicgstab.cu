...
__global__ void
magma_tally4_sbicgmerge1_kernel(  
    int n, 
    float * skp,
    float * v, 
    float * r, 
...
magma_tally4_sbicgmerge1(  
    ...
    magma_tally4_sbicgmerge1_kernel<<<Gs, Bs, 0>>>( n, skp, v, r, p );
...
__global__ void
magma_tally4_sbicgmerge2_kernel(  
    int n, 
    float * skp, 
    float * r,
    float * v, 
    ...
    magma_tally4Float_ptr s )
{
    ...
    magma_tally4_sbicgmerge2_kernel<<<Gs, Bs, 0>>>( n, skp, r, v, s );
...
__global__ void
magma_tally4_sbicgmerge3_kernel(  
    int n, 
    float * skp, 
    float * p,
    float * se,
    ...
    magma_tally4Float_ptr r )
{
    ...
    dim3 Bs( BLOCK_SIZE );
    dim3 Gs( magma_tally4_ceildiv( n, BLOCK_SIZE ) );
    magma_tally4_sbicgmerge3_kernel<<<Gs, Bs, 0>>>( n, skp, p, s, t, x, r );
...
__global__ void
magma_tally4_sbicgmerge4_kernel_1(  
    float * skp )
{
    int i = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void
magma_tally4_sbicgmerge4_kernel_2(  
    float * skp )
{
    int i = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void
magma_tally4_sbicgmerge4_kernel_3(  
    float * skp )
{
    int i = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    magma_tally4Float_ptr skp )
{
    ...
    dim3 Gs( 1 );
    if( type == 1 )
        magma_tally4_sbicgmerge4_kernel_1<<<Gs, Bs, 0>>>( skp );
    else if( type == 2 )
        magma_tally4_sbicgmerge4_kernel_2<<<Gs, Bs, 0>>>( skp );
    else if( type == 3 )
        magma_tally4_sbicgmerge4_kernel_3<<<Gs, Bs, 0>>>( skp );
    else
