...
/**
    ...
    minfo   INTEGER
            ...
            - minfo >= -MAGMA_tally3_ERR: Pre-defined MAGMA_tally3 error, such as malloc failure.
            - minfo == 0:          No error.

    @ingroup magma_tally3_util
    ********************************************************************/
extern "C"
void magma_tally3_xerbla(const char *srname , magma_tally3_int_t minfo)
{
    ...
    else if ( minfo >= -MAGMA_tally3_ERR ) {
        fprintf( stderr, "Error in %s, %s (info = %d)\n",
                 srname, magma_tally3_strerror(-minfo), (int) -minfo );
    }
    else {
