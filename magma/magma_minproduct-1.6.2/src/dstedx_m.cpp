        ...
        if (alleig) {
            ...
            while ( start < n ) {
                ...
                for (end = start+1; end < n; ++end) {
                    tiny = eps * sqrt( MAGMA_minproduct_D_ABS(d[end-1]*d[end]));
                    if (MAGMA_minproduct_D_ABS(e[end-1]) <= tiny)
                        break;
                }
                ...
                if (m > smlsiz) {
                    ...
                    magma_minproduct_dlaex0_m( ngpu, m, &d[start], &e[start], Z(start, start), ldz, work, iwork, Magma_minproductRangeAll, vl, vu, il, iu, info);
            ...
            magma_minproduct_dlaex0_m(ngpu, n, d, e, Z, ldz, work, iwork, range, vl, vu, il, iu, info);
