...
/**
    ...
    minfo   INTEGER
            ...
            - minfo >= -MAGMA_tally2_ERR: Pre-defined MAGMA_tally2 error, such as malloc failure.
            - minfo == 0:          No error.

    @ingroup magma_tally2_util
    ********************************************************************/
extern "C"
void magma_tally2_xerbla(const char *srname , magma_tally2_int_t minfo)
{
    ...
    else if ( minfo >= -MAGMA_tally2_ERR ) {
        fprintf( stderr, "Error in %s, %s (info = %d)\n",
                 srname, magma_tally2_strerror(-minfo), (int) -minfo );
    }
    else {
