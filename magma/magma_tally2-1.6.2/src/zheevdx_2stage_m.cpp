    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally2DoubleComplex *da[Magma_tally2MaxGPUs], *dT1[Magma_tally2MaxGPUs];
    ...
    for( magma_tally2_int_t dev = 0; dev < ngpu; ++dev ) {
        ...
        // TODO check malloc
        magma_tally2_zmalloc(&da[dev], ldda*mlocal );
        magma_tally2_zmalloc(&dT1[dev], (n*nb) );
    ...
    magma_tally2_zsetmatrix_1D_col_bcyclic( n, n, A, lda, da, ldda, ngpu, distblk );
    magma_tally2_setdevice(0);
    timer_stop( time_dist );

    timer_start( time_band );
    if (ver == 30) {
        magma_tally2_zhetrd_he2hb_mgpu_spec(uplo, n, nb, A, lda, &work[indtau1], &work[indwrk], llwork, da, ldda, dT1, nb, ngpu, distblk, streams, nstream, info);
    } else {
        magma_tally2_zhetrd_he2hb_mgpu(uplo, n, nb, A, lda, &work[indtau1], &work[indwrk], llwork, da, ldda, dT1, nb, ngpu, distblk, streams, nstream, info);
    }
    timer_stop( time_band );
    ...
    if (! wantz) {
        ...
        magma_tally2_zstedx_m(ngpu, range, n, vl, vu, il, iu, w, &rwork[inde],
...
/*
        ...
        magma_tally2_zgetmatrix( n, *m, dZ, lddz, &work[indwrk], n);

        magma_tally2_free(dZ);

*/

        magma_tally2_zbulge_back_m(ngpu, uplo, n, nb, *m, Vblksiz, &work[indwrk + n * (il-1)], n,
                            &work[indV2], ldv, &work[indTAU2], &work[indT2], ldt, info);
        ...
        magma_tally2_zunmqr_m(ngpu, Magma_tally2Left, Magma_tally2NoTrans, n-nb, *m, n-nb, A+nb, lda, &work[indtau1],
