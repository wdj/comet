/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from magma_minproduct_zlapack.h normal z -> c, Fri Jan 30 19:00:06 2015
*/

#ifndef MAGMA_minproduct_CLAPACK_H
#define MAGMA_minproduct_CLAPACK_H
 ...
 */
magma_minproduct_int_t blasf77_icamax(
                     const magma_minproduct_int_t *n,
                     const magma_minproductFloatComplex *x, const magma_minproduct_int_t *incx );

void blasf77_caxpy(  const magma_minproduct_int_t *n,
                     const magma_minproductFloatComplex *alpha,
                     const magma_minproductFloatComplex *x, const magma_minproduct_int_t *incx,
                           magma_minproductFloatComplex *y, const magma_minproduct_int_t *incy );

void blasf77_ccopy(  const magma_minproduct_int_t *n,
                     const magma_minproductFloatComplex *x, const magma_minproduct_int_t *incx,
                           magma_minproductFloatComplex *y, const magma_minproduct_int_t *incy );
...
void blasf77_cgemm(  const char *transa, const char *transb,
                     ...
                     const magma_minproductFloatComplex *alpha,
                     const magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                     const magma_minproductFloatComplex *B, const magma_minproduct_int_t *ldb,
                     const magma_minproductFloatComplex *beta,
...
void blasf77_cgerc(  const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                     const magma_minproductFloatComplex *alpha,
                     const magma_minproductFloatComplex *x, const magma_minproduct_int_t *incx,
                     const magma_minproductFloatComplex *y, const magma_minproduct_int_t *incy,
                           magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda );

void blasf77_cgeru(  const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                     const magma_minproductFloatComplex *alpha,
                     const magma_minproductFloatComplex *x, const magma_minproduct_int_t *incx,
                     const magma_minproductFloatComplex *y, const magma_minproduct_int_t *incy,
                           magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda );
...
void blasf77_cscal(  const magma_minproduct_int_t *n,
                     const magma_minproductFloatComplex *alpha,
                           magma_minproductFloatComplex *x, const magma_minproduct_int_t *incx );

void blasf77_csscal( const magma_minproduct_int_t *n,
                     const float *alpha,
                           magma_minproductFloatComplex *x, const magma_minproduct_int_t *incx );

void blasf77_cswap(  const magma_minproduct_int_t *n,
                     magma_minproductFloatComplex *x, const magma_minproduct_int_t *incx,
                     magma_minproductFloatComplex *y, const magma_minproduct_int_t *incy );
...
void blasf77_crotg(  magma_minproductFloatComplex *ca, const magma_minproductFloatComplex *cb,
                     float *c, magma_minproductFloatComplex *s );
                     
void blasf77_crot(   const magma_minproduct_int_t *n,
                     magma_minproductFloatComplex *x, const magma_minproduct_int_t *incx,
                     magma_minproductFloatComplex *y, const magma_minproduct_int_t *incy,
                     const float *c, const magma_minproductFloatComplex *s );
                     
void blasf77_csrot(  const magma_minproduct_int_t *n,
                     magma_minproductFloatComplex *x, const magma_minproduct_int_t *incx,
                     magma_minproductFloatComplex *y, const magma_minproduct_int_t *incy,
...
void blasf77_ctrmm(  const char *side, const char *uplo, const char *transa, const char *diag,
                     ...
                     const magma_minproductFloatComplex *alpha,
                     const magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                           magma_minproductFloatComplex *B, const magma_minproduct_int_t *ldb );
...
float magma_minproduct_cblas_scasum(
    magma_minproduct_int_t n,
    const magma_minproductFloatComplex *x, magma_minproduct_int_t incx );

float magma_minproduct_cblas_scnrm2(
    magma_minproduct_int_t n,
    const magma_minproductFloatComplex *x, magma_minproduct_int_t incx );

magma_minproductFloatComplex magma_minproduct_cblas_cdotc(
    magma_minproduct_int_t n,
    const magma_minproductFloatComplex *x, magma_minproduct_int_t incx,
    const magma_minproductFloatComplex *y, magma_minproduct_int_t incy );

magma_minproductFloatComplex magma_minproduct_cblas_cdotu(
    magma_minproduct_int_t n,
    const magma_minproductFloatComplex *x, magma_minproduct_int_t incx,
    const magma_minproductFloatComplex *y, magma_minproduct_int_t incy );
...
void   lapackf77_cbdsqr( const char *uplo,
                         ...
                         float *d, float *e,
                         magma_minproductFloatComplex *Vt, const magma_minproduct_int_t *ldvt,
...
void   lapackf77_cgebd2( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         float *d, float *e,
...
void   lapackf77_cgebrd( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         float *d, float *e,
                         magma_minproductFloatComplex *tauq,
                         magma_minproductFloatComplex *taup,
...
void   lapackf77_cgbbrd( const char *vect, const magma_minproduct_int_t *m,
                         ...
                         magma_minproductFloatComplex *Ab, const magma_minproduct_int_t *ldab,
                         float *d, float *e,
...
void   lapackf77_cgeev(  const char *jobvl, const char *jobvr,
                         ...
                         float *wr, float *wi,
                         #endif
                         magma_minproductFloatComplex *Vl,   const magma_minproduct_int_t *ldvl,
                         magma_minproductFloatComplex *Vr,   const magma_minproduct_int_t *ldvr,
                         magma_minproductFloatComplex *work, const magma_minproduct_int_t *lwork,
                         #ifdef COMPLEX
                         float *rwork,
                         #endif
...
void   lapackf77_cgehd2( const magma_minproduct_int_t *n,
                         const magma_minproduct_int_t *ilo, const magma_minproduct_int_t *ihi,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
...
void   lapackf77_cgehrd( const magma_minproduct_int_t *n,
                         const magma_minproduct_int_t *ilo, const magma_minproduct_int_t *ihi,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductFloatComplex *tau,
                         magma_minproductFloatComplex *work, const magma_minproduct_int_t *lwork,
...
void   lapackf77_cgelqf( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductFloatComplex *tau,
                         magma_minproductFloatComplex *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );
...
void   lapackf77_cgeqlf( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductFloatComplex *tau,
                         magma_minproductFloatComplex *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_cgeqp3( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
...
void   lapackf77_cgeqrf( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductFloatComplex *tau,
                         magma_minproductFloatComplex *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );
...
void   lapackf77_cgesv(  const magma_minproduct_int_t *n, const magma_minproduct_int_t *nrhs,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
...
void   lapackf77_cgetrf( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproduct_int_t *ipiv,
                         magma_minproduct_int_t *info );

void   lapackf77_cgetri( const magma_minproduct_int_t *n,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
...
void   lapackf77_chetf2( const char*, magma_minproduct_int_t*, 
                         magma_minproductFloatComplex*, magma_minproduct_int_t*, magma_minproduct_int_t*, magma_minproduct_int_t* );
...
void   lapackf77_cheevr( const char *jobz, const char *range, const char *uplo,
                         ...
                         magma_minproduct_int_t *m, float *w, magma_minproductFloatComplex *z__, 
...
void   lapackf77_cheevx( const char *jobz, const char *range, const char *uplo,
                         ...
                         magma_minproduct_int_t *il, magma_minproduct_int_t *iu, float *abstol,
                         magma_minproduct_int_t *m, float *w, magma_minproductFloatComplex *z__,
                         magma_minproduct_int_t *ldz, magma_minproductFloatComplex *work, magma_minproduct_int_t *lwork,
                         float *rwork, magma_minproduct_int_t *iwork, magma_minproduct_int_t *ifail, magma_minproduct_int_t *info);

void   lapackf77_chegs2( const magma_minproduct_int_t *itype, const char *uplo,
                         const magma_minproduct_int_t *n,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductFloatComplex *B, const magma_minproduct_int_t *ldb,
                         magma_minproduct_int_t *info );

void   lapackf77_chegst( const magma_minproduct_int_t *itype, const char *uplo,
                         const magma_minproduct_int_t *n,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductFloatComplex *B, const magma_minproduct_int_t *ldb,
                         magma_minproduct_int_t *info );

void   lapackf77_chegvd( const magma_minproduct_int_t *itype, const char *jobz, const char *uplo,
                         const magma_minproduct_int_t *n,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductFloatComplex *B, const magma_minproduct_int_t *ldb,
                         float *w,
...
void   lapackf77_chesv( const char *uplo, 
                        const magma_minproduct_int_t *n, const magma_minproduct_int_t *nrhs,
                        magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda, magma_minproduct_int_t *ipiv,
                        magma_minproductFloatComplex *B, const magma_minproduct_int_t *ldb,
                        magma_minproductFloatComplex *work, const magma_minproduct_int_t *lwork,
                        magma_minproduct_int_t *info );
...
void   lapackf77_chseqr( const char *job, const char *compz,
                         ...
                         float *wr, float *wi,
                         #endif
                         magma_minproductFloatComplex *Z, const magma_minproduct_int_t *ldz,
                         magma_minproductFloatComplex *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_clabrd( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *nb,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         float *d, float *e,
                         magma_minproductFloatComplex *tauq,
                         magma_minproductFloatComplex *taup,
                         magma_minproductFloatComplex *X, const magma_minproduct_int_t *ldx,
                         magma_minproductFloatComplex *Y, const magma_minproduct_int_t *ldy );

#ifdef COMPLEX
void   lapackf77_clacgv( const magma_minproduct_int_t *n,
                         magma_minproductFloatComplex *x, const magma_minproduct_int_t *incx );
#endif
...
#ifdef COMPLEX
void   lapackf77_clacrm( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         const magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
...
#ifdef COMPLEX
void   lapackf77_cladiv( magma_minproductFloatComplex *ret_val,
...
void   lapackf77_clahef( const char *uplo,
                         ...
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t lda,
                         magma_minproduct_int_t *ipiv,
                         magma_minproductFloatComplex *work, const magma_minproduct_int_t *ldwork,
                         magma_minproduct_int_t *info );
...
float lapackf77_clanht( const char *norm, const magma_minproduct_int_t *n,
                         const float *d, const magma_minproductFloatComplex *e );
...
void   lapackf77_claqp2( magma_minproduct_int_t *m, magma_minproduct_int_t *n, magma_minproduct_int_t *offset,
                         magma_minproductFloatComplex *a, magma_minproduct_int_t *lda, magma_minproduct_int_t *jpvt,
                         magma_minproductFloatComplex *tau,
                         float *vn1, float *vn2,
                         magma_minproductFloatComplex *work );

#ifdef COMPLEX
void   lapackf77_clarcm( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
                         const float             *A, const magma_minproduct_int_t *lda,
                         const magma_minproductFloatComplex *B, const magma_minproduct_int_t *ldb,
                         magma_minproductFloatComplex       *C, const magma_minproduct_int_t *ldc,
                         float *rwork );
...
void   lapackf77_clarf(  const char *side, const magma_minproduct_int_t *m, const magma_minproduct_int_t *n,
...
void   lapackf77_clarfb( const char *side, const char *trans, const char *direct, const char *storev,
                         const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         const magma_minproductFloatComplex *V, const magma_minproduct_int_t *ldv,
                         const magma_minproductFloatComplex *T, const magma_minproduct_int_t *ldt,
                         magma_minproductFloatComplex *C, const magma_minproduct_int_t *ldc,
                         magma_minproductFloatComplex *work, const magma_minproduct_int_t *ldwork );

void   lapackf77_clarfg( const magma_minproduct_int_t *n,
...
void   lapackf77_clarft( const char *direct, const char *storev,
                         const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         magma_minproductFloatComplex *V, const magma_minproduct_int_t *ldv,
                         const magma_minproductFloatComplex *tau,
                         magma_minproductFloatComplex *T, const magma_minproduct_int_t *ldt );

void   lapackf77_clarnv( const magma_minproduct_int_t *idist, magma_minproduct_int_t *iseed, const magma_minproduct_int_t *n,
                         magma_minproductFloatComplex *x );

void   lapackf77_clartg( magma_minproductFloatComplex *F,
                         magma_minproductFloatComplex *G,
                         float *cs,
                         magma_minproductFloatComplex *SN,
...
void   lapackf77_claswp( const magma_minproduct_int_t *n,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
...
void   lapackf77_clatrs( const char *uplo, const char *trans, const char *diag,
                         ...
                         const magma_minproduct_int_t *n,
                         const magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         magma_minproductFloatComplex *x, float *scale,
...
void   lapackf77_cstein( const magma_minproduct_int_t *n,
...
void   lapackf77_cung2r( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         const magma_minproductFloatComplex *tau,
                         magma_minproductFloatComplex *work,
                         magma_minproduct_int_t *info );
...
void   lapackf77_cunghr( const magma_minproduct_int_t *n,
                         const magma_minproduct_int_t *ilo, const magma_minproduct_int_t *ihi,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         const magma_minproductFloatComplex *tau,
                         magma_minproductFloatComplex *work, const magma_minproduct_int_t *lwork,
...
void   lapackf77_cunglq( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         const magma_minproductFloatComplex *tau,
                         magma_minproductFloatComplex *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_cungql( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         const magma_minproductFloatComplex *tau,
                         magma_minproductFloatComplex *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );

void   lapackf77_cungqr( const magma_minproduct_int_t *m, const magma_minproduct_int_t *n, const magma_minproduct_int_t *k,
                         magma_minproductFloatComplex *A, const magma_minproduct_int_t *lda,
                         const magma_minproductFloatComplex *tau,
                         magma_minproductFloatComplex *work, const magma_minproduct_int_t *lwork,
                         magma_minproduct_int_t *info );
...
#endif /* MAGMA_minproduct_CLAPACK_H */
