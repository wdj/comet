    ...
    magma_tally4_int_t *info)
{
  ...
  if (upper) {
            magma_tally4blas_dtrsm( Magma_tally4Left, Magma_tally4Upper, 
                           Magma_tally4ConjTrans, Magma_tally4Unit, 
                           n, nrhs, c_one,
                           dA, ldda, dB, lddb );
            magma_tally4blas_dlascl_diag(Magma_tally4Upper, 1, n, dA, ldda, dB,1, info);
            magma_tally4blas_dtrsm( Magma_tally4Left, Magma_tally4Upper, 
            ...
            magma_tally4_dtrsm( Magma_tally4Left, Magma_tally4Lower, 
                           Magma_tally4NoTrans, Magma_tally4Unit, 
                           n, nrhs, c_one,
                           dA, ldda, dB, lddb );
            magma_tally4blas_dlascl_diag(Magma_tally4Lower, 1, n, dA, ldda, dB,1, info);
            magma_tally4blas_dtrsm( Magma_tally4Left, Magma_tally4Lower, 
                           Magma_tally4ConjTrans, Magma_tally4Unit, 
                           n, nrhs, c_one,
                           dA, ldda, dB, lddb );
        }
