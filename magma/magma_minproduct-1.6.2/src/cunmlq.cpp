...
/**
    ...
    as returned by CGELQF. Q is of order M if SIDE = Magma_minproductLeft and of order N
    ...
    magma_minproduct_int_t *info)
{
    ...
    magma_minproductFloatComplex *T, *T2;
    ...
    *info = 0;
    ...
    if (*info == 0) {
        nb = magma_minproduct_get_cgelqf_nb( min( m, n ));
        lwkopt = max(1,nw)*nb;
    ...
    if (nb >= k) {
        ...
        magma_minproductFloatComplex_ptr dwork, dV, dT, dC;
        magma_minproduct_cmalloc( &dwork, (nw + nq + nb)*nb + lddc*n );
        if ( dwork == NULL ) {
        ...
        magma_minproduct_cmalloc_cpu( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_minproduct_csetmatrix( m, n, C, ldc, dC(0,0), lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            cpanel_to_q( Magma_minproductLower, ib, A(i,i), lda, T2 );
            magma_minproduct_csetmatrix( ib, nq_i,  A(i,i), lda, dV(0,0), ib );
            cq_to_panel( Magma_minproductLower, ib, A(i,i), lda, T2 );
            ...
            magma_minproduct_csetmatrix( ib, ib, T, ib, dT(0,0), ib );
            magma_minproduct_clarfb_gpu( side, transt, Magma_minproductForward, Magma_minproductRowwise,
                              mi, ni, ib,
                              dV(0,0), ib,
                              dT(0,0), ib,
                              dC(ic,jc), lddc,
        ...
        magma_minproduct_cgetmatrix( m, n, dC(0,0), lddc, C, ldc );
