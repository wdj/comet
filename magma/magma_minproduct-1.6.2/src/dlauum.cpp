    ...
    if (nb <= 1 || nb >= n)
        ...
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_minproduct_dsetmatrix_async( ib, (n-i-ib),
                                        A(i,i+ib),  lda,
                                        dA(i,i+ib), ldda, stream[0] );

                magma_minproduct_queue_sync( stream[1] );

                magma_minproduct_dtrmm( Magma_minproductRight, Magma_minproductUpper,
                             Magma_minproductConjTrans, Magma_minproductNonUnit, i, ib,
                             c_one, dA(i,i), ldda, dA(0, i),ldda);


                lapackf77_dlauum(Magma_minproductUpperStr, &ib, A(i,i), &lda, info);
                ...
                if (i+ib < n) {
                    ...
                    magma_minproduct_dsyrk( Magma_minproductUpper, Magma_minproductNoTrans, ib,(n-i-ib),
                                 d_one, dA(i, i+ib), ldda,
                                 d_one, dA(i, i), ldda);
                }

                magma_minproduct_dgetmatrix( i+ib, ib,
                                  dA(0, i), ldda,
                                  A(0, i),  lda );
            }
        }
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_minproduct_dsetmatrix_async( (n-i-ib), ib,
                                        A(i+ib, i),  lda,
                                        dA(i+ib, i), ldda, stream[0] );

                magma_minproduct_queue_sync( stream[1] );

                magma_minproduct_dtrmm( Magma_minproductLeft, Magma_minproductLower,
                             Magma_minproductConjTrans, Magma_minproductNonUnit, ib,
                             i, c_one, dA(i,i), ldda,
                             dA(i, 0),ldda);


                lapackf77_dlauum(Magma_minproductLowerStr, &ib, A(i,i), &lda, info);
                ...
                if (i+ib < n) {
                    ...
                    magma_minproduct_dsyrk(Magma_minproductLower, Magma_minproductConjTrans, ib, (n-i-ib),
                                    d_one, dA(i+ib, i), ldda,
                                    d_one, dA(i, i), ldda);
                }
                magma_minproduct_dgetmatrix( ib, i+ib,
                                  dA(i, 0), ldda,
                                  A(i, 0),  lda );
            }
        }
