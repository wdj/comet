    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally3_SUCCESS != magma_tally3_smalloc( &dwork, lddw*nb )) {
    ...
    if (upper) {
        ...
        for (i = n - nb; i >= kk; i -= nb) {
            ...
            magma_tally3_slatrd( uplo, i+nb, nb, A(0, 0), lda, e, tau,
        ...
        for (i = 0; i < n-nx; i += nb) {
            ...
            magma_tally3_slatrd( uplo, n-i, nb, A(i, i), lda, &e[i], &tau[i],
