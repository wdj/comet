    ...
    if ( incx == 1 && incy == 1 && beta == 0 ) {
        if ( trans == Magma_tally4NoTrans ) {
            if ( alpha == 1. ) {
                ...
                sgemv_kernel_tesla<<< grid, threads, 0, magma_tally4_stream >>>
                    (m, n, (n/gemv_bs)*gemv_bs, A, lda, x, y);
            }
            else {
                magma_tally4_sgemv( trans, m, n, alpha, A, lda, x, incx, beta, y, incy);
            }
        }
        else {
            magma_tally4blas_sgemvt_tesla(m, n, alpha, A, lda, x, y);
        }
    }
    else {
        magma_tally4_sgemv( trans, m, n, alpha, A, lda, x, incx, beta, y, incy);
...
/**
    ...
    @ingroup magma_tally4_sblas2_internal
    ********************************************************************/
extern "C" void
magma_tally4blas_sgemv2_tesla(
    ...
    float       *y )
{
    ...
    sgemv_kernel2_tesla<<< grid, threads, 0, magma_tally4_stream >>>
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_tally4blas_sgemvt1_tesla(
    magma_tally4_int_t m, magma_tally4_int_t n, float alpha,
    const float *A, magma_tally4_int_t lda,
    const float *x,
    float       *y )
{
    ...
    dim3 grid( blocks, 1, 1 );
    dim3 threads( 32, 2, 1 );
    sgemvt_kernel1_tesla<<< grid, threads, 0, magma_tally4_stream >>>
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_tally4blas_sgemvt2_tesla(
    magma_tally4_int_t m, magma_tally4_int_t n, float alpha,
    const float *A, magma_tally4_int_t lda,
    const float *x,
    float       *y )
{
    ...
    dim3 grid( blocks, 1, 1 );
    dim3 threads( 16, 4, 1 );
    sgemvt_kernel2_tesla<<< grid, threads, 0, magma_tally4_stream >>>
...
{
    if ( n <= 128 )
        magma_tally4blas_sgemvt2_tesla(m, n, alpha, A, lda, x, y);
    else
        magma_tally4blas_sgemvt1_tesla(m, n, alpha, A, lda, x, y);
}
