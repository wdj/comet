    ...
    magma_tally4_int_t *info)
{
    ...
    */
    magma_tally4blas_cswapdblk(k-1, nb, dA(0,0), ldda, 1, dT(0), nb, 0);
    if ( nrhs == 1 ) {
        magma_tally4_ctrsv(Magma_tally4Upper, Magma_tally4NoTrans, Magma_tally4NonUnit,
                    n, dA(0,0), ldda, dB, 1);
    } else {
    ...
    magma_tally4blas_cswapdblk(k-1, nb, dT(0), nb, 0, dA(0,0), ldda, 1);
