...
/**
    ...
    @ingroup magma_tally2_chesv_driver
    ********************************************************************/
...
magma_tally2_chesv_nopiv_gpu(magma_tally2_uplo_t uplo,  magma_tally2_int_t n, magma_tally2_int_t nrhs, 
                 ...
                 magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    ret = magma_tally2_chetrf_nopiv_tally2_gpu(uplo, n, dA, ldda, info);
    if ( (ret != MAGMA_tally2_SUCCESS) || (*info != 0) ) {
        return ret;
    }
        
    ret = magma_tally2_chetrs_nopiv_gpu( uplo, n, nrhs, dA, ldda, dB, lddb, info );
    if ( (ret != MAGMA_tally2_SUCCESS) || (*info != 0) ) {
        return ret;
    }
