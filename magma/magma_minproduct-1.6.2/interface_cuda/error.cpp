...
void magma_minproduct_xerror( CUresult err, const char* func, const char* file, int line )
{
    if ( err != CUDA_SUCCESS ) {
        fprintf( stderr, "CUDA driver error: %s (%d) in %s at %s:%d\n",
                 magma_minproduct_cuGetErrorString( err ), err, func, file, line );
    }
}
...
void magma_minproduct_xerror( cublasStatus_t err, const char* func, const char* file, int line )
{
    if ( err != CUBLAS_STATUS_SUCCESS ) {
        fprintf( stderr, "CUBLAS error: %s (%d) in %s at %s:%d\n",
                 magma_minproduct_cublasGetErrorString( err ), err, func, file, line );
    }
}
...
{
    if ( err != MAGMA_minproduct_SUCCESS ) {
        fprintf( stderr, "MAGMA_minproduct error: %s (%d) in %s at %s:%d\n",
                 magma_minproduct_strerror( err ), (int) err, func, file, line );
    }
}
...
const char* magma_minproduct_strerror( magma_minproduct_int_t error )
{
    ...
    else if ( error < 0 && error > MAGMA_minproduct_ERR ) {
        return "invalid argument";
    }
    // MAGMA_minproduct-specific errors
    switch( error ) {
        case MAGMA_minproduct_SUCCESS:
            return "success";
        
        case MAGMA_minproduct_ERR:
            return "unknown error";
        
        case MAGMA_minproduct_ERR_NOT_INITIALIZED:
            return "not initialized";
        
        case MAGMA_minproduct_ERR_REINITIALIZED:
            return "reinitialized";
        
        case MAGMA_minproduct_ERR_NOT_SUPPORTED:
            return "not supported";
        
        case MAGMA_minproduct_ERR_ILLEGAL_VALUE:
            return "illegal value";
        
        case MAGMA_minproduct_ERR_NOT_FOUND:
            return "not found";
        
        case MAGMA_minproduct_ERR_ALLOCATION:
            return "allocation";
        
        case MAGMA_minproduct_ERR_INTERNAL_LIMIT:
            return "internal limit";
        
        case MAGMA_minproduct_ERR_UNALLOCATED:
            return "unallocated error";
        
        case MAGMA_minproduct_ERR_FILESYSTEM:
            return "filesystem error";
        
        case MAGMA_minproduct_ERR_UNEXPECTED:
            return "unexpected error";
        
        case MAGMA_minproduct_ERR_SEQUENCE_FLUSHED:
            return "sequence flushed";
        
        case MAGMA_minproduct_ERR_HOST_ALLOC:
            return "cannot allocate memory on CPU host";
        
        case MAGMA_minproduct_ERR_DEVICE_ALLOC:
            return "cannot allocate memory on GPU device";
        
        case MAGMA_minproduct_ERR_CUDASTREAM:
            return "CUDA stream error";
        
        case MAGMA_minproduct_ERR_INVALID_PTR:
            return "invalid pointer";
        
        case MAGMA_minproduct_ERR_UNKNOWN:
            return "unknown error";
                        
        case MAGMA_minproduct_ERR_NOT_IMPLEMENTED:
            return "not implemented";
        
        // some sparse-iter errors
        case MAGMA_minproduct_SLOW_CONVERGENCE:
            return "stopping criterion not reached";
        
        case MAGMA_minproduct_DIVERGENCE:
            return "divergence";
        
        case MAGMA_minproduct_NONSPD:
            return "not positive definite (SPD/HPD)";
        
        case MAGMA_minproduct_ERR_BADPRECOND:
            return "bad preconditioner";
        
        // map cusparse errors to magma_minproduct errors
        case MAGMA_minproduct_ERR_CUSPARSE_NOT_INITIALIZED:
            return "cusparse: not initialized";

        case MAGMA_minproduct_ERR_CUSPARSE_ALLOC_FAILED:
            return "cusparse: allocation failed";

        case MAGMA_minproduct_ERR_CUSPARSE_INVALID_VALUE:
            return "cusparse: invalid value";

        case MAGMA_minproduct_ERR_CUSPARSE_ARCH_MISMATCH:
            return "cusparse: architecture mismatch";

        case MAGMA_minproduct_ERR_CUSPARSE_MAPPING_ERROR:
            return "cusparse: mapping error";

        case MAGMA_minproduct_ERR_CUSPARSE_EXECUTION_FAILED:
            return "cusparse: execution failed";

        case MAGMA_minproduct_ERR_CUSPARSE_INTERNAL_ERROR:
            return "cusparse: internal error";

        case MAGMA_minproduct_ERR_CUSPARSE_MATRIX_TYPE_NOT_SUPPORTED:
            return "cusparse: matrix type not supported";

        case MAGMA_minproduct_ERR_CUSPARSE_ZERO_PIVOT:
            return "cusparse: zero pivot";
        
        default:
            return "unknown MAGMA_minproduct error code";
    }
}
