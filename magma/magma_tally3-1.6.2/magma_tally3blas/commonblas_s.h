...
// Tesla GEMM kernels
#define MAGMA_tally3BLAS_SGEMM( name ) \
void magma_tally3blas_sgemm_##name( \
...
MAGMA_tally3BLAS_SGEMM( a_0  );
MAGMA_tally3BLAS_SGEMM( ab_0 );
MAGMA_tally3BLAS_SGEMM( N_N_64_16_16_16_4_special );
MAGMA_tally3BLAS_SGEMM( N_N_64_16_16_16_4         );
MAGMA_tally3BLAS_SGEMM( N_T_64_16_4_16_4          );
MAGMA_tally3BLAS_SGEMM( T_N_32_32_8_8_8           );
MAGMA_tally3BLAS_SGEMM( T_T_64_16_16_16_4_special );
MAGMA_tally3BLAS_SGEMM( T_T_64_16_16_16_4         );
                   
void magma_tally3blas_sgemm_tesla(
    ...
    const float *B, magma_tally3_int_t ldb,
    float beta,
    float *C, magma_tally3_int_t ldc );

void magma_tally3blas_sgemv_tesla(
...
__global__ void
magma_tally3_sgemv_kernel3(int m, const float * __restrict__ V, int ldv,
                    float *c, float *dwork,
                    float *tau);

__global__ void
magma_tally3_strmv_tkernel(float *T, int ldt, float *v,
                                    float *y);

__global__ void
magma_tally3_strmv_kernel2(const float *T, int ldt,
