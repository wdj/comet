/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from testing_zgesvd.cpp normal z -> d, Fri Jan 30 19:00:26 2015
       @author Mark Gates
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            switch( opts.svd_work ) {
                case 0: {  // query for workspace size
                    lwork = -1;
                    magma_tally4_dgesvd( jobu, jobvt, M, N,
            ...
            if (info != 0)
                printf("magma_tally4_dgesvd returned error %d: %s.\n",
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_dgesvd( lapack_vec_const_tally4(jobu), lapack_vec_const_tally4(jobvt), &M, &N,
