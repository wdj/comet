    ...
    magma_tally4DoubleComplex_ptr dworkvt,     magma_tally4_int_t ldworkvt)
{
    ...
    if ( side == Magma_tally4Left ) {
        ...
        if (m <= n) {
            // W2 = V T
            magma_tally4_zgemm( notransV, trans,
                         m, k, k,
                         c_one,  dV, lddv,
                                 dT, lddt,
            ...
            // W2 = T W  = T  V^H C
            magma_tally4_zgemm( trans, Magma_tally4NoTrans,
                         k, n, k,
                         c_one,  dT, lddt,
                                 dwork, ldw,
                         c_zero, dworkvt, ldwvt);
            // C = C - V W2 = C - V T V^H C = (I - V T V^H) C = H C
            magma_tally4_zgemm( notransV, Magma_tally4NoTrans,
                         m, n, k,
                         c_neg_one, dV,  lddv,
                                    dworkvt,  ldwvt,
                         c_one,     dC,       lddc);
        ...
        if (m <= n) {
            // W2 = W T = C V T
            magma_tally4_zgemm( Magma_tally4NoTrans, trans,
                         m, k, k,
                         c_one,  dwork, ldw,
                                 dT, lddt,
                         c_zero, dworkvt, ldwvt);
            ...
            // W2 = T V^H
            magma_tally4_zgemm( trans, transV,
                         k, n, k,
                         c_one,  dT, lddt,
                                 dV, lddv,
                         c_zero, dworkvt, ldwvt);
