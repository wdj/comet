...
//=================================================================================================
extern "C" void
magma_tally2_slaswp_rowparallel_batched( magma_tally2_int_t n, 
                       float** input_array, magma_tally2_int_t ldi,
...
//=================================================================================================
extern "C" void
magma_tally2_slaswp_rowparallel_q( magma_tally2_int_t n, 
                       float* input, magma_tally2_int_t ldi,
                       float* output, magma_tally2_int_t ldo,
                       magma_tally2_int_t k1, magma_tally2_int_t k2,
                       magma_tally2_int_t *pivinfo, 
                       magma_tally2_queue_t queue)
{
    ...
    {
       printf(" height=%d > %d, magma_tally2_slaswp_rowparallel_q not supported \n", n,MAX_NTHREADS);
...
extern "C" void
magma_tally2_slaswp_rowparallel( magma_tally2_int_t n, float* input, magma_tally2_int_t ldi,
                   float* output, magma_tally2_int_t ldo,
                   magma_tally2_int_t k1, magma_tally2_int_t k2,
                   magma_tally2_int_t *pivinfo)
{
    magma_tally2_slaswp_rowparallel_q(n, input, ldi, output, ldo, k1, k2, pivinfo, magma_tally2_stream);
}
...
//=================================================================================================
__global__ void slaswp_rowserial_kernel_batched( int n, float **dA_array, int lda, int k1, int k2, magma_tally2_int_t** ipiv_array )
{
...
//=================================================================================================
__global__ void slaswp_columnserial_kernel_batched( int n, float **dA_array, int lda, int k1, int k2, magma_tally2_int_t** ipiv_array )
{
    float* dA = dA_array[blockIdx.z];
    magma_tally2_int_t *d_ipiv = ipiv_array[blockIdx.z];
