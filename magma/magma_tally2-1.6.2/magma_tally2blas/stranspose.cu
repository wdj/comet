...
/**
    @see magma_tally2blas_stranspose_q
    @ingroup magma_tally2_saux2
    ********************************************************************/
extern "C" void
magma_tally2blas_stranspose(
    ...
    magma_tally2Float_ptr       dAT, magma_tally2_int_t lddat )
{
    magma_tally2blas_stranspose_q( m, n, dA, ldda, dAT, lddat, magma_tally2_stream );
}
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_tally2blas_stranspose_batched_q(
    magma_tally2_int_t m, magma_tally2_int_t n,
    float **dA_array,  magma_tally2_int_t ldda,
    float **dAT_array, magma_tally2_int_t lddat, magma_tally2_int_t batchCount, magma_tally2_queue_t queue )
{
    magma_tally2_int_t info = 0;
    if ( m < 0 )
        info = -1;
...
/**
    @see magma_tally2blas_stranspose_batched_q
    @ingroup magma_tally2_saux2
    ********************************************************************/
extern "C" void
...
{
    magma_tally2blas_stranspose_batched_q( m, n, dA_array, ldda, dAT_array, lddat, batchCount, magma_tally2_stream );
}
