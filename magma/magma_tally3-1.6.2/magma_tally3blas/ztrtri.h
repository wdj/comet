...
zaxpy16(
    ...
    const magma_tally3DoubleComplex * __restrict__ b,
    magma_tally3DoubleComplex       * __restrict__ c )
{
    c[0]  += alpha * b[0];
    c[1]  += alpha * b[1];
    c[2]  += alpha * b[2];
...
zgemm_kernel_16(
    ...
    magma_tally3DoubleComplex *B, int ldb,
    magma_tally3DoubleComplex *C, int ldc,
    magma_tally3DoubleComplex alpha, int jb, int tx, int ty)
{
...
ztrtri_diag_lower_kernel(
    magma_tally3_diag_t diag, int n, const magma_tally3DoubleComplex *A, int lda, magma_tally3DoubleComplex *d_invA);

__global__ void
triple_zgemm16_part1_lower_kernel(
    int n, const magma_tally3DoubleComplex *Ain, int lda, magma_tally3DoubleComplex *d_invA, int jb, int npages);
