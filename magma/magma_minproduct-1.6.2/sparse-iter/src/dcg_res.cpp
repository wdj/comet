    ...
    magma_minproduct_queue_t queue )
{
    ...
    // GPU workspace
    magma_minproduct_d_matrix r={Magma_minproduct_CSR}, p={Magma_minproduct_CSR}, q={Magma_minproduct_CSR};
    ...
    magma_minproduct_dcopy( dofs, r.dval, 1, p.dval, 1 );                     // p = r
    ...
    {
        solver_par->numiter++;
        alpha = MAGMA_minproduct_D_MAKE(nom/den, 0.);
        ...
        res = betanom = magma_minproduct_dnrm2(dofs, r.dval, 1);        // betanom = || r ||
        ...
        beta = MAGMA_minproduct_D_MAKE(betanomsq/nom, 0.);                       // beta = betanoms/nom
