...
int main(  int argc, char** argv )
{
    ...
    magma_minproduct_c_matrix A={Magma_minproduct_CSR};
    ...
    printf("sorting...");
    CHECK( magma_minproduct_cindexsort(x, 0, n-1, queue ));
    printf("done.\n\n");
    ...
    while(  i < argc ) {
        ...
        CHECK( magma_minproduct_cdomainoverlap( A.num_rows, &num_ind, A.row, A.col, x, queue ));
