...
*/
__global__ void
zsymmetrize_tiles_lower( int m, magma_minproductDoubleComplex *dA, int ldda, int mstride, int nstride )
{
    ...
    magma_minproductDoubleComplex *dAT = dA;
    if ( i < m ) {
        dA  += i;
        dAT += i*ldda;
        magma_minproductDoubleComplex *dAend = dA + i*ldda;
        while( dA < dAend ) {
...
__global__ void
zsymmetrize_tiles_upper( int m, magma_minproductDoubleComplex *dA, int ldda, int mstride, int nstride )
{
    // shift dA to tile's top-left corner
    dA += blockIdx.x*(mstride + nstride*ldda);
...
/**
    @see magma_minproductblas_zsymmetrize_tiles_q
    @ingroup magma_minproduct_zaux2
    ********************************************************************/
extern "C" void
magma_minproductblas_zsymmetrize_tiles(
    ...
    magma_minproduct_int_t ntile, magma_minproduct_int_t mstride, magma_minproduct_int_t nstride )
{
    magma_minproductblas_zsymmetrize_tiles_q( uplo, m, dA, ldda, ntile, mstride, nstride, magma_minproduct_stream );
}
