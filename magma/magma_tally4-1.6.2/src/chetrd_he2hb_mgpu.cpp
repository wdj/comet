    ...
    if (upper) {
        ...
        for (i = 1; i <= n-nb; i += nb) {
             ...
             if (i > 1 ) {
                 ...
                 cpanel_to_q(Magma_tally4Upper, pn-1, A(i, i+1), lda, work);
                 ...
                 //magma_tally4_setdevice( 0 );
                 cq_to_panel(Magma_tally4Upper, pn-1, A(i, i+1), lda, work);
             }
             ...
             cpanel_to_q(Magma_tally4Upper, pk, A(indi, indj), lda, work);
             ...
             cq_to_panel(Magma_tally4Upper, pk, A(indi, indj), lda, work);
             // ===============================================
             ...
             if (i + nb <= n-nb) {
                 ...
                 cpanel_to_q(Magma_tally4Upper, pk-1, A(n-pk+1, n-pk+2), lda, work);
                 magma_tally4_cgetmatrix( pk, pk,
                                   dA(idev, indi, di+1), ldda,
                                   A(n-pk+1, n-pk+1),  lda );
                 cq_to_panel(Magma_tally4Upper, pk-1, A(n-pk+1, n-pk+2), lda, work);
             }
