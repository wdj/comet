    ...
    if (nb <= 1 || nb >= n)
        ...
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally3_csetmatrix_async( ib, (n-i-ib),
                                        A(i,i+ib),  lda,
                                        dA(i,i+ib), ldda, stream[0] );

                magma_tally3_queue_sync( stream[1] );

                magma_tally3_ctrmm( Magma_tally3Right, Magma_tally3Upper,
                             Magma_tally3ConjTrans, Magma_tally3NonUnit, i, ib,
                             c_one, dA(i,i), ldda, dA(0, i),ldda);


                lapackf77_clauum(Magma_tally3UpperStr, &ib, A(i,i), &lda, info);
                ...
                if (i+ib < n) {
                    ...
                    magma_tally3_cherk( Magma_tally3Upper, Magma_tally3NoTrans, ib,(n-i-ib),
                                 d_one, dA(i, i+ib), ldda,
                                 d_one, dA(i, i), ldda);
                }

                magma_tally3_cgetmatrix( i+ib, ib,
                                  dA(0, i), ldda,
                                  A(0, i),  lda );
            }
        }
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally3_csetmatrix_async( (n-i-ib), ib,
                                        A(i+ib, i),  lda,
                ...
                lapackf77_clauum(Magma_tally3LowerStr, &ib, A(i,i), &lda, info);
                ...
                if (i+ib < n) {
                    ...
                    magma_tally3_cherk(Magma_tally3Lower, Magma_tally3ConjTrans, ib, (n-i-ib),
                                    d_one, dA(i+ib, i), ldda,
                                    d_one, dA(i, i), ldda);
                }
                magma_tally3_cgetmatrix( ib, i+ib,
                                  dA(i, 0), ldda,
                                  A(i, 0),  lda );
            }
        }
