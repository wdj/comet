...
/**
    ...
    lwork   INTEGER
            ...
            the optimal blocksize returned by magma_tally4_get_zgetri_nb(n).
    \n
       ...
       
{
    ...
    magma_tally4DoubleComplex **dinvdiagA_array = NULL;
    ...
    magma_tally4DoubleComplex* dinvdiagA;
    magma_tally4DoubleComplex* dwork;// dinvdiagA and dwork are workspace in ztrsm
    ...
    magma_tally4_zmalloc( &dinvdiagA, invdiagA_msize * batchCount);
    ...
    magma_tally4blas_zlaset_q(Magma_tally4Full, invdiagA_msize, batchCount, MAGMA_tally4_Z_ZERO, MAGMA_tally4_Z_ZERO, dinvdiagA, invdiagA_msize, queue);
    ...
    magma_tally4blas_zlaset_batched(Magma_tally4UpperLower, n, n, MAGMA_tally4_Z_ZERO, MAGMA_tally4_Z_ONE, dinvA_array, lddia, batchCount, queue);
    ...
    for(j = 0; j < n; j+=nb) {
        ...
        // solve dwork = L^-1 * I
        magma_tally4blas_zlaset_batched(Magma_tally4UpperLower, j, ib, MAGMA_tally4_Z_ZERO, MAGMA_tally4_Z_ZERO, dwork_array, n, batchCount, queue);
        magma_tally4_zdisplace_pointers(dW5_displ, dwork_array, n, j, 0, batchCount, queue);
        magma_tally4_zdisplace_pointers(dW0_displ, dinvA_array, lddia, j, j, batchCount, queue);
        magma_tally4_zdisplace_pointers(dA_displ, dA_array, ldda, j, j, batchCount, queue);
        
        magma_tally4blas_ztrsm_outofplace_batched(Magma_tally4Left, Magma_tally4Lower, Magma_tally4NoTrans, Magma_tally4Unit, 1,
                n-j, ib,
                MAGMA_tally4_Z_ONE,
                dA_displ,       ldda, // dA
                dW0_displ,   lddia, // dB
        ...
        magma_tally4_zdisplace_pointers(dW5_displ, dwork_array, n, 0, 0, batchCount, queue);
        magma_tally4_zdisplace_pointers(dW0_displ, dinvA_array, lddia, 0, j, batchCount, queue);
        magma_tally4_zdisplace_pointers(dA_displ, dA_array, ldda, 0, 0, batchCount, queue);
    ...
    magma_tally4_zlaswp_columnserial_batched( n, dinvA_array, lddia, max(1,n-1), 1, dipiv_array, batchCount, queue);
