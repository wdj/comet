    ...
    double **Cval)
{
    ...
    double xxB[4];
    magma_tally3Double_ptr B;

    int trackA = __mul24( ty2, lda) + tx2 ;
    magma_tally3Double_ptr Aval = Avals[blockIdx.z];
    ...
    for(int k=0; k<kblocks; k++){
        ...
        magma_tally3Double_ptr C = Cval[blockIdx.z * kblocks + k];
...
/**
    ...
    @param[in]
    dA          magma_tally3DoubleComplex**
                input blocks of matrix A
                
    @param[in]
    dB          magma_tally3DoubleComplex**
                input blocks of matrix B
                
    @param[in]
    dC          magma_tally3DoubleComplex**
    ...
    magma_tally3_queue_t queue )
{
    ...
    if ( arch < 200  ) {
        printf("error: magma_tally3_zbcsrluegemm needs a CUDA architecture"
