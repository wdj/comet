/*
    -- MAGMA_tally2 (version 1.6.1) --
       ...
       @generated from zunmlq.cpp normal z -> c, Fri Jan 30 19:00:16 2015
...
/**
    ...
    as returned by CGELQF. Q is of order M if SIDE = Magma_tally2Left and of order N
    ...
    @ingroup magma_tally2_cgelqf_comp
    ********************************************************************/
    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (*info == 0) {
        nb = magma_tally2_get_cgelqf_nb( min( m, n ));
        lwkopt = max(1,nw)*nb;
    ...
    if (nb >= k) {
        /* Use CPU code */
        lapackf77_cunmlq( lapack_side_const_tally2(side), lapack_trans_const_tally2(trans),
        ...
        magma_tally2FloatComplex_ptr dwork, dV, dT, dC;
        magma_tally2_cmalloc( &dwork, (nw + nq + nb)*nb + lddc*n );
        if ( dwork == NULL ) {
        ...
        magma_tally2_cmalloc_cpu( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_tally2_csetmatrix( m, n, C, ldc, dC(0,0), lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            cpanel_to_q_tally2( Magma_tally2Lower, ib, A(i,i), lda, T2 );
            magma_tally2_csetmatrix( ib, nq_i,  A(i,i), lda, dV(0,0), ib );
            cq_to_panel_tally2( Magma_tally2Lower, ib, A(i,i), lda, T2 );
            ...
            magma_tally2_csetmatrix( ib, ib, T, ib, dT(0,0), ib );
            magma_tally2_clarfb_gpu( side, transt, Magma_tally2Forward, Magma_tally2Rowwise,
                              mi, ni, ib,
                              dV(0,0), ib,
                              dT(0,0), ib,
                              dC(ic,jc), lddc,
        ...
        magma_tally2_cgetmatrix( m, n, dC(0,0), lddc, C, ldc );
