...
#define dB(i, j) (dw + n*ldda + (j)*lddb + (i))
    ...
    *info = 0;
    ...
    if (MAGMA_tally2_SUCCESS != magma_tally2_dmalloc( &dw, 2*n*n )) {
    ...
    magma_tally2_dsetmatrix( n, n, B(0, 0), ldb, dB(0, 0), lddb );
    ...
    magma_tally2_dgetmatrix( n, n, dA(0, 0), ldda, A(0, 0), lda );
