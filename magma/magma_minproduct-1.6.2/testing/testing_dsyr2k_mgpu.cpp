...
/* ////////////////////////////////////////////////////////////////////////////
   -- Testing magma_minproduct_dsyr2k_mgpu
*/
int main( int argc, char** argv)
{
    ...
    double alpha = MAGMA_minproduct_D_MAKE( 1.2345, 4.321 );
    double beta = 3.14159;
    
    real_Double_t    gflops, gpu_perf, cpu_perf, gpu_time, cpu_time;
    double           error, work[1];
    double *hA, *hR, *hR2, *hV, *hW;
    magma_minproductDouble_ptr dV[Magma_minproductMaxGPUs], dW[Magma_minproductMaxGPUs], dA[Magma_minproductMaxGPUs];
    ...
    printf( "version 1: magma_minproductblas_dsyr2k_mgpu2     %s\n", (opts.version==1 ? "(enabled)" : ""));
    printf( "version 2: magma_minproductblas_dsyr2k_mgpu_spec %s\n", (opts.version==2 ? "(enabled)" : ""));
#ifdef ICHI
    printf( "version 3: magma_minproduct_dsyr2k_mgpu (Ichi)   %s\n", (opts.version==3 ? "(enabled)" : ""));
#endif
    printf( "\n" );
        ...
        for( int offset = 0; offset < n; offset += min(k,nb) ) {
            for( int iter = 0; iter < opts.niter; ++iter ) {
                ...
                /* ====================================================================
                   ...
                   =================================================================== */
                magma_minproduct_dsetmatrix_1D_col_bcyclic( n, n, hA, lda, dA, ldda, ngpu, nb );
                for( int d = 0; d < ngpu; ++d ) {
                    magma_minproduct_setdevice( d );
                    dW[d] = dV[d] + ldda*k;
                    magma_minproduct_dsetmatrix( n, k, hV, lda, dV[d], ldda );
                    magma_minproduct_dsetmatrix( n, k, hW, lda, dW[d], ldda );
                }
                ...
                magma_minproduct_dgetmatrix_1D_col_bcyclic( n, n, dA, ldda, hR, lda, ngpu, nb );
