/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zdomainoverlap.cpp normal z -> c, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_tally2_queue_t queue )
{
    ...
    CHECK( magma_tally2_cindexsort( tmp_x, 0, num_copy-1, queue ));
    ...
    for(magma_tally2_int_t i=0; i<num_rows; i++){
        ...
        for(magma_tally2_int_t j=rowptr[row]; j<rowptr[row+1]; j++){
            ...
            if( num_ind == blocksize || j == rowptr[num_rows]-1 ){
                magma_tally2_cindexcopy( num_ind, offset, tmp_x, x, queue );
