/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from testing_ztrmv.cpp normal z -> s, Fri Jan 30 19:00:23 2015
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            cublasStrmv( opts.handle, cublas_uplo_const_tally4(opts.uplo), cublas_trans_const_tally4(opts.transA),
