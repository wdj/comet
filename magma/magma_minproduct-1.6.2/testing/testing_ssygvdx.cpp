...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            // ==================================================================
            if ( opts.warmup ) {
                lapackf77_slacpy( Magma_minproductFullStr, &N, &N, h_A, &N, h_R, &N );
                lapackf77_slacpy( Magma_minproductFullStr, &N, &N, h_B, &N, h_S, &N );
                
                magma_minproduct_ssygvdx( opts.itype, opts.jobz, Magma_minproductRangeI, opts.uplo,
                               ...
                               &info );
                if (info != 0)
                    printf("magma_minproduct_ssygvdx returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_minproductNoVec ) {
                ...
                //magma_minproduct_ssygvdx( opts.itype, Magma_minproductNoVec, Magma_minproductRangeI, opts.uplo,
