...
/**
    ...
    @ingroup magma_tally4_sgels_driver
    ********************************************************************/
    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally4_SUCCESS != magma_tally4_smalloc( &dT, ldtwork )) {
        *info = MAGMA_tally4_ERR_DEVICE_ALLOC;
        return *info;
    }
    
    magma_tally4_smalloc_cpu( &tau, k );
    if ( tau == NULL ) {
    ...
    magma_tally4_sgeqrf3_gpu( m, n, dA, ldda, tau, dT, info );
    if ( *info == 0 ) {
        magma_tally4_sgeqrs3_gpu( m, n, nrhs,
                           dA, ldda, tau, dT,
