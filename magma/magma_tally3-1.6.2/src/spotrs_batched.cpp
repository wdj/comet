                  ...
                  magma_tally3_int_t batchCount, magma_tally3_queue_t queue)
{
   ...
   /* check allocation */
    ...
    if ( uplo == Magma_tally3Upper) {
        ...
        magma_tally3blas_strsm_outofplace_batched(Magma_tally3Left, Magma_tally3Upper, Magma_tally3ConjTrans, Magma_tally3NonUnit, 1,
                n, nrhs,
                c_one,
                dA_array,       ldda, // dA
                dB_array,      lddb, // dB
        ...
        magma_tally3blas_strsm_outofplace_batched(Magma_tally3Left, Magma_tally3Lower, Magma_tally3NoTrans, Magma_tally3NonUnit, 1,
                n, nrhs,
                c_one,
                dA_array,       ldda, // dA
                dB_array,      lddb, // dB
        ...
        magma_tally3blas_strsm_outofplace_batched(Magma_tally3Left, Magma_tally3Lower, Magma_tally3ConjTrans, Magma_tally3NonUnit, 1,
                n, nrhs,
                c_one,
                dA_array,       ldda, // dA
                dwork_array,        n, // dB 
