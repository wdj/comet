...
int main( int argc, char** argv)
{
    ...
    magma_tally2Double_ptr d_A, d_x;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally2_dsetvector( N, h_x, 1, d_x, 1 );
            
            cublas_time = magma_tally2_sync_wtime( NULL );
            cublasDtrsv( opts.handle, cublas_uplo_const_tally2(opts.uplo),
            ...
            magma_tally2_dgetvector( N, d_x, 1, h_xcublas, 1 );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_dtrsv( lapack_uplo_const_tally2(opts.uplo), lapack_trans_const_tally2(opts.transA), lapack_diag_const_tally2(opts.diag),
                               &N,
                               h_A, &lda,
                               h_x, &ione );
            ...
            blasf77_dtrmv( lapack_uplo_const_tally2(opts.uplo), lapack_trans_const_tally2(opts.transA), lapack_diag_const_tally2(opts.diag),
                           &N,
                           h_A, &lda,
                           h_xcublas, &ione );
