...
#define dA(i, j) (dA + (j)*ldda + (i))
    ...
    *info = 0;
    ...
    if (nb <= 1 || nb >= n) {
        magma_minproduct_dgetmatrix( n, n, dA, ldda, work, n );
        lapackf77_dlauum(uplo_, &n, work, &n, info);
        magma_minproduct_dsetmatrix( n, n, work, n, dA, ldda );
    }
    else {
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_minproduct_dgetmatrix( ib, ib,
                                  dA(i, i), ldda,
                                  work,     ib );

                lapackf77_dlauum(Magma_minproductUpperStr, &ib, work, &ib, info);

                magma_minproduct_dsetmatrix( ib, ib,
                                  work,     ib,
                                  dA(i, i), ldda );
            ...
            for (i=0; i < n; i += nb) {
                ...
                lapackf77_dlauum(Magma_minproductLowerStr, &ib, work, &ib, info);
