    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    ldda = ((n+31)/32)*32;
    lddb = ldda;
    if ( MAGMA_tally4_SUCCESS != magma_tally4_dmalloc( &dA, ldda*n )) {
        goto CPU_INTERFACE;
    }
    if ( MAGMA_tally4_SUCCESS != magma_tally4_dmalloc( &dB, lddb*nrhs )) {
    ...
    if ( *info == 0 ) {
        magma_tally4_dsetmatrix( n, nrhs, B, ldb, dB, lddb );
        magma_tally4_dgetrs_gpu( Magma_tally4NoTrans, n, nrhs, dA, ldda, ipiv, dB, lddb, info );
        magma_tally4_dgetmatrix( n, nrhs, dB, lddb, B, ldb );
    }
    magma_tally4_free( dA );
    magma_tally4_free( dB );
    return *info;
...
CPU_INTERFACE:
    ...
    magma_tally4_dgetrf( n, n, A, lda, ipiv, info );
    if ( *info == 0 ) {
        lapackf77_dgetrs( Magma_tally4NoTransStr, &n, &nrhs, A, &lda, ipiv, B, &ldb, info );
    }
    return *info;
}
