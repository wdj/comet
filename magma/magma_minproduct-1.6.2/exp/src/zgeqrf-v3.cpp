...
magma_minproduct_zgeqrf3(magma_minproduct_context *cntxt, magma_minproduct_int_t m, magma_minproduct_int_t n, 
...
/*  -- MAGMA_minproduct (version 1.6.1) --
    ...
    *info = 0;
    ...
    /* Use MAGMA_minproduct code to factor left portion of matrix, waking up threads 
       along the way to perform updates on the right portion of matrix */
    magma_minproduct_zgeqrf2(cntxt, m, n - qr_params->nthreads * qr_params->ob, 
    ...
    for (k = 0; k < qr_params->np_gpu-1; k++){
      ...
      zq_to_panel(Magma_minproductUpper, ib, a + k*qr_params->nb*lda + k*qr_params->nb, lda, 
    ...
    /* Flag MAGMA_minproduct code to internally unzero upper part of each panel */
    qr_params->flag = 1;
    
    /* Use MAGMA_minproduct code to perform final factorization if necessary */
    if (qr_params->m > (qr_params->n - (qr_params->nthreads*qr_params->ob)))
      ...
      magma_minproduct_zgeqrf2(cntxt, M, N,
