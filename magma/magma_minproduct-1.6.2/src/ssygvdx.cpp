...
/**
    ...
    B       REAL array, dimension (LDB, N)
            On entry, the symmetric matrix B.  If UPLO = Magma_minproductUpper, the
    ...
    lwork   INTEGER
            ...
            NB can be obtained through magma_minproduct_get_ssytrd_nb(N).
    \n
    ...
    magma_minproduct_int_t *info)
{
    ...
    magma_minproduct_int_t wantz, lquery;
    ...
    *info = 0;
    ...
    timer_start( time );
    magma_minproduct_ssyevdx_gpu( jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, mout, w, A, lda,
    ...
    if (wantz && *info == 0) {
        ...
        if (dB == NULL) {
            if (MAGMA_minproduct_SUCCESS != magma_minproduct_smalloc( &dB, n*lddb ) ) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_minproduct_strsm( Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit,
        ...
        magma_minproduct_sgetmatrix( n, *mout, dA, ldda, A, lda );
