...
static void *magma_minproduct_chetrd_hb2st_parallel_section(void *arg);

static void magma_minproduct_ctile_bulge_parallel(
    magma_minproduct_int_t my_core_id, magma_minproduct_int_t cores_num,
    magma_minproductFloatComplex *A, magma_minproduct_int_t lda,
    magma_minproductFloatComplex *V, magma_minproduct_int_t ldv,
    magma_minproductFloatComplex *TAU, magma_minproduct_int_t n, magma_minproduct_int_t nb, magma_minproduct_int_t nbtiles,
    magma_minproduct_int_t grsiz, magma_minproduct_int_t Vblksiz, volatile magma_minproduct_int_t *prog);

static void magma_minproduct_ctile_bulge_computeT_parallel(
    magma_minproduct_int_t my_core_id, magma_minproduct_int_t cores_num,
    magma_minproductFloatComplex *V, magma_minproduct_int_t ldv, magma_minproductFloatComplex *TAU,
    magma_minproductFloatComplex *T, magma_minproduct_int_t ldt,
    magma_minproduct_int_t n, magma_minproduct_int_t nb, magma_minproduct_int_t Vblksiz);

//////////////////////////////////////////////////////////////////////////////////////////////////////////

typedef struct magma_minproduct_cbulge_data_s {
    magma_minproduct_int_t threads_num;
    magma_minproduct_int_t n;
    magma_minproduct_int_t nb;
    magma_minproduct_int_t nbtiles;
    magma_minproduct_int_t grsiz;
    magma_minproduct_int_t Vblksiz;
    magma_minproduct_int_t compT;
    ...
    magma_minproduct_int_t ldt;
    volatile magma_minproduct_int_t *prog;
    pthread_barrier_t barrier;
} magma_minproduct_cbulge_data;

void magma_minproduct_cbulge_data_init(
    magma_minproduct_cbulge_data *cbulge_data_S,
    magma_minproduct_int_t threads_num, magma_minproduct_int_t n, magma_minproduct_int_t nb, magma_minproduct_int_t nbtiles,
    magma_minproduct_int_t grsiz, magma_minproduct_int_t Vblksiz, magma_minproduct_int_t compT,
    magma_minproductFloatComplex *A, magma_minproduct_int_t lda,
    magma_minproductFloatComplex *V, magma_minproduct_int_t ldv, magma_minproductFloatComplex *TAU,
    magma_minproductFloatComplex *T, magma_minproduct_int_t ldt,
    volatile magma_minproduct_int_t* prog)
...
void magma_minproduct_cbulge_data_destroy(magma_minproduct_cbulge_data *cbulge_data_S)
{
    pthread_barrier_destroy(&(cbulge_data_S->barrier));
}
typedef struct magma_minproduct_cbulge_id_data_s {
    magma_minproduct_int_t id;
    magma_minproduct_cbulge_data* data;
} magma_minproduct_cbulge_id_data;

void magma_minproduct_cbulge_id_data_init(magma_minproduct_cbulge_id_data *id_data, magma_minproduct_int_t id, magma_minproduct_cbulge_data* data)
{
    id_data->id = id;
    id_data->data = data;
}
...
/**
    ...
    uplo    magma_minproduct_uplo_t
      -     = Magma_minproductUpper:  Upper triangles of A is stored;
      -     = Magma_minproductLower:  Lower triangles of A is stored.
    ...
    e       DOUBLE array, dimension (N-1)
            ...
            E(i) = A(i,i+1) if UPLO = Magma_minproductUpper, E(i) = A(i+1,i) if UPLO = Magma_minproductLower.

    @param[out]
    V       COMPLEX array, dimension (BLKCNT, LDV, VBLKSIZ)
            On exit it contains the blocks of householder reflectors
            BLKCNT is the number of block and it is returned by the funtion MAGMA_minproduct_BULGE_GET_BLKCNT.
    ...
    @ingroup magma_minproduct_cheev_2stage
    ********************************************************************/
...
magma_minproduct_chetrd_hb2st(
    ...
    magma_minproductFloatComplex *A, magma_minproduct_int_t lda, float *d, float *e,
    magma_minproductFloatComplex *V, magma_minproduct_int_t ldv, magma_minproductFloatComplex *TAU,
    magma_minproduct_int_t compT, magma_minproductFloatComplex *T, magma_minproduct_int_t ldt)
{
    #ifdef ENABLE_TIMER
    ...
    magma_minproduct_int_t INgrsiz=1;
    magma_minproduct_int_t blkcnt = magma_minproduct_bulge_get_blkcnt(n, nb, Vblksiz);
    magma_minproduct_int_t nbtiles = magma_minproduct_ceildiv(n, nb);

    memset(T,   0, blkcnt*ldt*Vblksiz*sizeof(magma_minproductFloatComplex));
    memset(TAU, 0, blkcnt*Vblksiz*sizeof(magma_minproductFloatComplex));
    memset(V,   0, blkcnt*ldv*Vblksiz*sizeof(magma_minproductFloatComplex));

    volatile magma_minproduct_int_t* prog;
    magma_minproduct_malloc_cpu((void**) &prog, (2*nbtiles+threads+10)*sizeof(magma_minproduct_int_t));
    memset((void *) prog, 0, (2*nbtiles+threads+10)*sizeof(magma_minproduct_int_t));

    magma_minproduct_cbulge_id_data* arg;
    magma_minproduct_malloc_cpu((void**) &arg, threads*sizeof(magma_minproduct_cbulge_id_data));

    pthread_t* thread_id;
    magma_minproduct_malloc_cpu((void**) &thread_id, threads*sizeof(pthread_t));
    pthread_attr_t thread_attr;

    magma_minproduct_cbulge_data data_bulge;
    magma_minproduct_cbulge_data_init(&data_bulge, threads, n, nb, nbtiles, INgrsiz, Vblksiz, compT,
    ...
    //timing
    #ifdef ENABLE_TIMER
    timeblg = magma_minproduct_wtime();
    #endif

    // Launch threads
    for (magma_minproduct_int_t thread = 1; thread < threads; thread++) {
        magma_minproduct_cbulge_id_data_init(&(arg[thread]), thread, &data_bulge);
        pthread_create(&thread_id[thread], &thread_attr, magma_minproduct_chetrd_hb2st_parallel_section, &arg[thread]);
    }
    magma_minproduct_cbulge_id_data_init(&(arg[0]), 0, &data_bulge);
    magma_minproduct_chetrd_hb2st_parallel_section(&arg[0]);
    ...
    // timing
    #ifdef ENABLE_TIMER
    timeblg = magma_minproduct_wtime()-timeblg;
    printf("  time BULGE+T = %f\n", timeblg);
    #endif

    magma_minproduct_free_cpu(thread_id);
    magma_minproduct_free_cpu(arg);
    magma_minproduct_free_cpu((void *) prog);
    magma_minproduct_cbulge_data_destroy(&data_bulge);
    ...
    if (uplo == Magma_minproductLower) {
        for (magma_minproduct_int_t i=0; i < n-1; i++) {
            d[i] = MAGMA_minproduct_C_REAL( A[i*lda  ] );
            e[i] = MAGMA_minproduct_C_REAL( A[i*lda+1] );
        }
        d[n-1] = MAGMA_minproduct_C_REAL(A[(n-1)*lda]);
    } else { /* Magma_minproductUpper not tested yet */
        for (magma_minproduct_int_t i=0; i < n-1; i++) {
            d[i] = MAGMA_minproduct_C_REAL( A[i*lda+nb]   );
            e[i] = MAGMA_minproduct_C_REAL( A[i*lda+nb-1] );
        }
        d[n-1] = MAGMA_minproduct_C_REAL(A[(n-1)*lda+nb]);
    } /* end Magma_minproductUpper */
#else
    if ( uplo == Magma_minproductLower ) {
        for (magma_minproduct_int_t i=0; i < n-1; i++) {
            d[i] = A[i*lda];   // diag
...
static void *magma_minproduct_chetrd_hb2st_parallel_section(void *arg)
{
    magma_minproduct_int_t my_core_id  = ((magma_minproduct_cbulge_id_data*)arg) -> id;
    magma_minproduct_cbulge_data* data = ((magma_minproduct_cbulge_id_data*)arg) -> data;

    magma_minproduct_int_t allcores_num   = data -> threads_num;
    magma_minproduct_int_t n              = data -> n;
    magma_minproduct_int_t nb             = data -> nb;
    magma_minproduct_int_t nbtiles        = data -> nbtiles;
    magma_minproduct_int_t grsiz          = data -> grsiz;
    magma_minproduct_int_t Vblksiz        = data -> Vblksiz;
    magma_minproduct_int_t compT          = data -> compT;
    magma_minproductFloatComplex *A      = data -> A;
    magma_minproduct_int_t lda            = data -> lda;
    ...
    volatile magma_minproduct_int_t* prog = data -> prog;

    pthread_barrier_t* barrier = &(data -> barrier);

    //magma_minproduct_int_t sys_corenbr    = 1;
...
//#define PRINTAFFINITY
    ...
    if (compT == 1) {
        ...
        if (allcores_num == 1) {
            ...
            //=========================
            #ifdef ENABLE_TIMER
            timeB = magma_minproduct_wtime();
            #endif
            
            magma_minproduct_ctile_bulge_parallel(0, 1, A, lda, V, ldv, TAU, n, nb, nbtiles, grsiz, Vblksiz, prog);

            #ifdef ENABLE_TIMER
            timeB = magma_minproduct_wtime()-timeB;
            ...
            //=========================
            #ifdef ENABLE_TIMER
            timeT = magma_minproduct_wtime();
            #endif

            magma_minproduct_ctile_bulge_computeT_parallel(0, 1, V, ldv, TAU, T, ldt, n, nb, Vblksiz);

            #ifdef ENABLE_TIMER
            timeT = magma_minproduct_wtime()-timeT;
            printf("  Finish T's     timing= %f\n", timeT);
            #endif
        } else { // allcore_num > 1
            magma_minproduct_int_t id  = my_core_id;
            magma_minproduct_int_t tot = allcores_num;
                ...
                magma_minproduct_ctile_bulge_parallel(id, tot, A, lda, V, ldv, TAU, n, nb, nbtiles, grsiz, Vblksiz, prog);
                ...
                magma_minproduct_ctile_bulge_computeT_parallel(id, tot, V, ldv, TAU, T, ldt, n, nb, Vblksiz);
                pthread_barrier_wait(barrier);
        ...
        magma_minproduct_ctile_bulge_parallel(my_core_id, allcores_num, A, lda, V, ldv, TAU, n, nb, nbtiles, grsiz, Vblksiz, prog);
        pthread_barrier_wait(barrier);
...
static void magma_minproduct_ctile_bulge_parallel(
    ...
    magma_minproduct_int_t grsiz, magma_minproduct_int_t Vblksiz, volatile magma_minproduct_int_t *prog)
{
    magma_minproduct_int_t sweepid, myid, shift, stt, st, ed, stind, edind;
    magma_minproduct_int_t blklastind, colpt;
    magma_minproduct_int_t stepercol;
    magma_minproduct_int_t i, j, m, k;
    magma_minproduct_int_t thgrsiz, thgrnb, thgrid, thed;
    magma_minproduct_int_t coreid;
    magma_minproduct_int_t colblktile, maxrequiredcores, colpercore, mycoresnb;
    magma_minproduct_int_t fin;
    ...
    magma_minproduct_cmalloc_cpu(&work, n);
    mycoresnb = cores_num;
    ...
    thgrsiz = n;
    stepercol = magma_minproduct_ceildiv(shift, grsiz);
    thgrnb  = magma_minproduct_ceildiv(n-1, thgrsiz);
                            ...
                            while(fin == 0) {
                                if (myid == 1) {
                                    if ( prog[myid+shift-1] == (sweepid-1) ) {
                                        magma_minproduct_ctrdtype1cbHLsym_withQ_v2(n, nb, A, lda, V, ldv, TAU, stind, edind, sweepid, Vblksiz, work);
                                    ...
                                    if ( (prog[myid-1] == sweepid) && (prog[myid+shift-1] == (sweepid-1)) ) {
                                        if (myid%2 == 0)
                                            magma_minproduct_ctrdtype2cbHLsym_withQ_v2(n, nb, A, lda, V, ldv, TAU, stind, edind, sweepid, Vblksiz, work);
                                        else
                                            magma_minproduct_ctrdtype3cbHLsym_withQ_v2(n, nb, A, lda, V, ldv, TAU, stind, edind, sweepid, Vblksiz, work);
    ...
    magma_minproduct_int_t n, magma_minproduct_int_t nb, magma_minproduct_int_t Vblksiz)
{
    ...
    //%   local variables
    //%===========================
    magma_minproduct_int_t Vm, Vn, mt, nt;
    magma_minproduct_int_t myrow, mycol, blkj, blki, firstrow;
    magma_minproduct_int_t blkid, vpos, taupos, tpos;
    magma_minproduct_int_t blkpercore, myid;
     ...
     * ======================================== */
    nt  = magma_minproduct_ceildiv((n-1), Vblksiz);
    for (blkj=nt-1; blkj >= 0; blkj--) {
        ...
        if ( blkj == nt-1 )
            mt = magma_minproduct_ceildiv( n -  firstrow,    nb);
        else
            mt = magma_minproduct_ceildiv( n - (firstrow+1), nb);
        ...
        for (blki=mt; blki > 0; blki--) {
            ...
            magma_minproduct_bulge_findVTAUTpos(n, nb, Vblksiz, mycol, myrow, ldv, ldt, &vpos, &taupos, &tpos, &blkid);
