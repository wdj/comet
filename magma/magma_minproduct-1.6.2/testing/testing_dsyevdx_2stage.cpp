...
static magma_minproduct_int_t check_orthogonality(magma_minproduct_int_t M, magma_minproduct_int_t N, double *Q, magma_minproduct_int_t LDQ, double eps);
static magma_minproduct_int_t check_reduction(magma_minproduct_uplo_t uplo, magma_minproduct_int_t N, magma_minproduct_int_t bw, double *A, double *D, magma_minproduct_int_t LDA, double *Q, double eps );
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (opts.warmup) {
                ...
                // ==================================================================
                lapackf77_dlacpy( Magma_minproductUpperLowerStr, &N, &N, h_A, &N, h_R, &N );
                if (opts.ngpu == 1) {
                    ...
                    magma_minproduct_dsyevdx_2stage_m(opts.ngpu, opts.jobz, range, opts.uplo, N, 
                                    h_R, N, 
                                    vl, vu, il, iu, 
                                    &m1, w1, 
                                    h_work, lwork, 
            ...
            if ( opts.check && opts.jobz != Magma_minproductNoVec ) {
                ...
                //printf("\n");
                //printf("------ TESTS FOR MAGMA_minproduct DSYEVD ROUTINE -------  \n");
...
static magma_minproduct_int_t check_orthogonality(magma_minproduct_int_t M, magma_minproduct_int_t N, double *Q, magma_minproduct_int_t LDQ, double eps)
{
    ...
    double *Id;
    magma_minproduct_dmalloc_cpu( &Id, minMN*minMN );
...
static magma_minproduct_int_t check_reduction(magma_minproduct_uplo_t uplo, magma_minproduct_int_t N, magma_minproduct_int_t bw, double *A, double *D, magma_minproduct_int_t LDA, double *Q, double eps )
{
    ...
    magma_minproduct_dmalloc_cpu( &TEMP, N*N );
    magma_minproduct_dmalloc_cpu( &Residual, N*N );
