...
magma_tally4_zhegvx(
    ...
    magma_tally4DoubleComplex *A, magma_tally4_int_t lda, magma_tally4DoubleComplex *B, magma_tally4_int_t ldb,
    double vl, double vu, magma_tally4_int_t il, magma_tally4_int_t iu, double abstol,
    magma_tally4_int_t *m, double *w,  magma_tally4DoubleComplex *Z, magma_tally4_int_t ldz,
    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally4_SUCCESS != magma_tally4_zmalloc( &dA, n*ldda ) ||
        ...
        MAGMA_tally4_SUCCESS != magma_tally4_zmalloc( &dZ, n*lddz )) {
    ...
    magma_tally4_zheevx_gpu(jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, abstol, m, w, dZ, lddz, A, lda, Z, ldz, work, lwork, rwork, iwork, ifail, info);
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally4_ztrsm(Magma_tally4Left, uplo, trans, Magma_tally4NonUnit, n, *m, c_one, dB, lddb, dZ, lddz);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally4_ztrmm(Magma_tally4Left, uplo, trans, Magma_tally4NonUnit, n, *m, c_one, dB, lddb, dZ, lddz);
        }
        
        magma_tally4_zgetmatrix( n, *m, dZ, lddz, Z, ldz );
    }
