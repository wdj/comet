...
extern "C"
void spanel_to_q(magma_minproduct_uplo_t uplo, magma_minproduct_int_t ib, float *A, magma_minproduct_int_t lda, float *work)
{
...
extern "C"
void sq_to_panel(magma_minproduct_uplo_t uplo, magma_minproduct_int_t ib, float *A, magma_minproduct_int_t lda, float *work)
{
    magma_minproduct_int_t i, j, k = 0;
    float *col;
