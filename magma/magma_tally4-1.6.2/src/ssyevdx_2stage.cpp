    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally4_timer_t time_total=0, time=0;
    ...
    if (! wantz) {
        ...
        magma_tally4_sstedx(range, n, vl, vu, il, iu, w, &work[inde],
        ...
        if (MAGMA_tally4_SUCCESS != magma_tally4_smalloc( &dZ, *m*lddz)) {
            *info = MAGMA_tally4_ERR_DEVICE_ALLOC;
            return *info;
        }
        if (MAGMA_tally4_SUCCESS != magma_tally4_smalloc( &dA, n*ldda )) {
            *info = MAGMA_tally4_ERR_DEVICE_ALLOC;
            return *info;
        }

        magma_tally4_sbulge_back(uplo, n, nb, *m, Vblksiz, &work[indwrk + n * (il-1)], n, dZ, lddz,
        ...
        magma_tally4_sormqr_gpu_2stages(Magma_tally4Left, Magma_tally4NoTrans, n-nb, *m, n-nb, dA+nb, ldda,
                                 dZ+nb, n, dT1, nb, info);

        magma_tally4_sgetmatrix( n, *m, dZ, lddz, A, lda );
