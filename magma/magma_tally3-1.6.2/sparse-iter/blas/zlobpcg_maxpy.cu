...
__global__ void
magma_tally3_zlobpcg_maxpy_kernel( 
...
/**
    ...
    It replaces:
            magma_tally3_zaxpy(m*n, c_one, Y, 1, X, 1);
    ...
    @param[in/out]
    Y           magma_tally3DoubleComplex_ptr 
    ...
    magma_tally3_queue_t queue )
{
    ...
    magma_tally3_zlobpcg_maxpy_kernel<<< grid, threads, 0, queue >>>
