...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_Bmagma_tally4,  double, ldb*N   );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally4_dsetmatrix( Ak, Ak, h_A, lda, d_A, ldda );
            magma_tally4_dsetmatrix( M, N, h_B, ldb, d_B, lddb );
            
            magma_tally4_time = magma_tally4_sync_wtime( NULL );
            magma_tally4blas_dtrsm( opts.side, opts.uplo, opts.transA, opts.diag, 
                             M, N,
                             alpha, d_A, ldda,
                                    d_B, lddb );
            ...
            magma_tally4_dgetmatrix( M, N, d_B, lddb, h_Bmagma_tally4, ldb );
            ...
            cublasDtrsm( opts.handle, cublas_side_const_tally4(opts.side), cublas_uplo_const_tally4(opts.uplo),
            ...
            magma_tally4_dgetmatrix( M, N, d_B, lddb, h_Bcublas, ldb );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_dtrsm( lapack_side_const_tally4(opts.side), lapack_uplo_const_tally4(opts.uplo),
                               lapack_trans_const_tally4(opts.transA), lapack_diag_const_tally4(opts.diag), 
                               &M, &N,
                               &alpha, h_A, &lda,
                                       h_Blapack, &ldb );
            ...
            blasf77_dtrmm( lapack_side_const_tally4(opts.side), lapack_uplo_const_tally4(opts.uplo),
                           lapack_trans_const_tally4(opts.transA), lapack_diag_const_tally4(opts.diag), 
                           &M, &N,
                           &alpha2, h_A, &lda,
                                    h_X, &ldb );
            ...
            normX = lapackf77_dlange( "M", &M, &N, h_Bmagma_tally4, &ldb, work );
