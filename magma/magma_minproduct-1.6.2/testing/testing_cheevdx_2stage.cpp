...
static magma_minproduct_int_t check_orthogonality(magma_minproduct_int_t M, magma_minproduct_int_t N, magma_minproductFloatComplex *Q, magma_minproduct_int_t LDQ, float eps);
static magma_minproduct_int_t check_reduction(magma_minproduct_uplo_t uplo, magma_minproduct_int_t N, magma_minproduct_int_t bw, magma_minproductFloatComplex *A, float *D, magma_minproduct_int_t LDA, magma_minproductFloatComplex *Q, float eps );
...
int main( int argc, char** argv)
{
    ...
    magma_minproductFloatComplex *h_A, *h_R, *h_work;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_minproduct_cmake_hermitian( N, h_A, N );
            ...
            if (opts.warmup) {
                ...
                // ==================================================================
                lapackf77_clacpy( Magma_minproductUpperLowerStr, &N, &N, h_A, &N, h_R, &N );
                if (opts.ngpu == 1) {
                    ...
                    magma_minproduct_cheevdx_2stage_m(opts.ngpu, opts.jobz, range, opts.uplo, N, 
                                    h_R, N, 
                                    vl, vu, il, iu, 
                                    &m1, w1, 
                                    h_work, lwork, 
            ...
            if ( opts.check && opts.jobz != Magma_minproductNoVec ) {
                ...
                //printf("\n");
                //printf("------ TESTS FOR MAGMA_minproduct CHEEVD ROUTINE -------  \n");
...
static magma_minproduct_int_t check_orthogonality(magma_minproduct_int_t M, magma_minproduct_int_t N, magma_minproductFloatComplex *Q, magma_minproduct_int_t LDQ, float eps)
{
    ...
    magma_minproductFloatComplex *Id;
    magma_minproduct_cmalloc_cpu( &Id, minMN*minMN );
...
static magma_minproduct_int_t check_reduction(magma_minproduct_uplo_t uplo, magma_minproduct_int_t N, magma_minproduct_int_t bw, magma_minproductFloatComplex *A, float *D, magma_minproduct_int_t LDA, magma_minproductFloatComplex *Q, float eps )
{
    ...
    magma_minproductFloatComplex *TEMP, *Residual;
    float *work;
    ...
    magma_minproduct_cmalloc_cpu( &TEMP, N*N );
    magma_minproduct_cmalloc_cpu( &Residual, N*N );
