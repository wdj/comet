...
#ifndef MAGMA_tally3_ZLAPACK_H
#define MAGMA_tally3_ZLAPACK_H
 ...
 */
magma_tally3_int_t blasf77_izamax(
                     const magma_tally3_int_t *n,
                     const magma_tally3DoubleComplex *x, const magma_tally3_int_t *incx );

void blasf77_zaxpy(  const magma_tally3_int_t *n,
                     const magma_tally3DoubleComplex *alpha,
                     const magma_tally3DoubleComplex *x, const magma_tally3_int_t *incx,
                           magma_tally3DoubleComplex *y, const magma_tally3_int_t *incy );

void blasf77_zcopy(  const magma_tally3_int_t *n,
                     const magma_tally3DoubleComplex *x, const magma_tally3_int_t *incx,
                           magma_tally3DoubleComplex *y, const magma_tally3_int_t *incy );
...
void blasf77_zgemm(  const char *transa, const char *transb,
                     ...
                     const magma_tally3DoubleComplex *alpha,
                     const magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                     const magma_tally3DoubleComplex *B, const magma_tally3_int_t *ldb,
                     const magma_tally3DoubleComplex *beta,
...
void blasf77_zgerc(  const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                     const magma_tally3DoubleComplex *alpha,
                     const magma_tally3DoubleComplex *x, const magma_tally3_int_t *incx,
                     const magma_tally3DoubleComplex *y, const magma_tally3_int_t *incy,
                           magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda );

void blasf77_zgeru(  const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                     const magma_tally3DoubleComplex *alpha,
                     const magma_tally3DoubleComplex *x, const magma_tally3_int_t *incx,
                     const magma_tally3DoubleComplex *y, const magma_tally3_int_t *incy,
                           magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda );
...
void blasf77_zscal(  const magma_tally3_int_t *n,
                     const magma_tally3DoubleComplex *alpha,
                           magma_tally3DoubleComplex *x, const magma_tally3_int_t *incx );

void blasf77_zdscal( const magma_tally3_int_t *n,
                     const double *alpha,
                           magma_tally3DoubleComplex *x, const magma_tally3_int_t *incx );

void blasf77_zswap(  const magma_tally3_int_t *n,
                     magma_tally3DoubleComplex *x, const magma_tally3_int_t *incx,
                     magma_tally3DoubleComplex *y, const magma_tally3_int_t *incy );
...
void blasf77_zrotg(  magma_tally3DoubleComplex *ca, const magma_tally3DoubleComplex *cb,
                     double *c, magma_tally3DoubleComplex *s );
                     
void blasf77_zrot(   const magma_tally3_int_t *n,
                     magma_tally3DoubleComplex *x, const magma_tally3_int_t *incx,
                     magma_tally3DoubleComplex *y, const magma_tally3_int_t *incy,
                     const double *c, const magma_tally3DoubleComplex *s );
                     
void blasf77_zdrot(  const magma_tally3_int_t *n,
                     magma_tally3DoubleComplex *x, const magma_tally3_int_t *incx,
                     magma_tally3DoubleComplex *y, const magma_tally3_int_t *incy,
...
void blasf77_ztrmm(  const char *side, const char *uplo, const char *transa, const char *diag,
                     ...
                     const magma_tally3DoubleComplex *alpha,
                     const magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                           magma_tally3DoubleComplex *B, const magma_tally3_int_t *ldb );
...
double magma_tally3_cblas_dzasum(
    magma_tally3_int_t n,
    const magma_tally3DoubleComplex *x, magma_tally3_int_t incx );

double magma_tally3_cblas_dznrm2(
    magma_tally3_int_t n,
    const magma_tally3DoubleComplex *x, magma_tally3_int_t incx );

magma_tally3DoubleComplex magma_tally3_cblas_zdotc(
    magma_tally3_int_t n,
    const magma_tally3DoubleComplex *x, magma_tally3_int_t incx,
    const magma_tally3DoubleComplex *y, magma_tally3_int_t incy );

magma_tally3DoubleComplex magma_tally3_cblas_zdotu(
    magma_tally3_int_t n,
    const magma_tally3DoubleComplex *x, magma_tally3_int_t incx,
    const magma_tally3DoubleComplex *y, magma_tally3_int_t incy );
...
void   lapackf77_dbdsdc( const char *uplo, const char *compq,
                         ...
                         double *VT, const magma_tally3_int_t *ldvt,
                         double *Q, magma_tally3_int_t *IQ,
...
void   lapackf77_zbdsqr( const char *uplo,
                         ...
                         double *d, double *e,
                         magma_tally3DoubleComplex *Vt, const magma_tally3_int_t *ldvt,
...
void   lapackf77_zgebak( const char *job, const char *side,
                         ...
                         const double *scale, const magma_tally3_int_t *m,
...
void   lapackf77_zgebd2( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         double *d, double *e,
...
void   lapackf77_zgebrd( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         double *d, double *e,
                         magma_tally3DoubleComplex *tauq,
                         magma_tally3DoubleComplex *taup,
...
void   lapackf77_zgbbrd( const char *vect, const magma_tally3_int_t *m,
                         const magma_tally3_int_t *n, const magma_tally3_int_t *ncc,
                         const magma_tally3_int_t *kl, const magma_tally3_int_t *ku,
                         magma_tally3DoubleComplex *Ab, const magma_tally3_int_t *ldab,
                         double *d, double *e,
...
void   lapackf77_zgeev(  const char *jobvl, const char *jobvr,
                         ...
                         double *wr, double *wi,
                         #endif
                         magma_tally3DoubleComplex *Vl,   const magma_tally3_int_t *ldvl,
                         magma_tally3DoubleComplex *Vr,   const magma_tally3_int_t *ldvr,
                         magma_tally3DoubleComplex *work, const magma_tally3_int_t *lwork,
                         #ifdef COMPLEX
                         double *rwork,
                         #endif
...
void   lapackf77_zgehd2( const magma_tally3_int_t *n,
                         const magma_tally3_int_t *ilo, const magma_tally3_int_t *ihi,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
...
void   lapackf77_zgehrd( const magma_tally3_int_t *n,
                         const magma_tally3_int_t *ilo, const magma_tally3_int_t *ihi,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         magma_tally3DoubleComplex *tau,
                         magma_tally3DoubleComplex *work, const magma_tally3_int_t *lwork,
...
void   lapackf77_zgelqf( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         magma_tally3DoubleComplex *tau,
                         magma_tally3DoubleComplex *work, const magma_tally3_int_t *lwork,
                         magma_tally3_int_t *info );
...
void   lapackf77_zgeqlf( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         magma_tally3DoubleComplex *tau,
                         magma_tally3DoubleComplex *work, const magma_tally3_int_t *lwork,
                         magma_tally3_int_t *info );

void   lapackf77_zgeqp3( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
...
void   lapackf77_zgeqrf( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         magma_tally3DoubleComplex *tau,
                         magma_tally3DoubleComplex *work, const magma_tally3_int_t *lwork,
                         magma_tally3_int_t *info );
...
void   lapackf77_zgesv(  const magma_tally3_int_t *n, const magma_tally3_int_t *nrhs,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
...
void   lapackf77_zgetrf( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         magma_tally3_int_t *ipiv,
                         magma_tally3_int_t *info );

void   lapackf77_zgetri( const magma_tally3_int_t *n,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
...
void   lapackf77_zhetf2( const char*, magma_tally3_int_t*, 
                         magma_tally3DoubleComplex*, magma_tally3_int_t*, magma_tally3_int_t*, magma_tally3_int_t* );
...
void   lapackf77_zheevd( const char *jobz, const char *uplo,
                         ...
                         magma_tally3DoubleComplex *work, const magma_tally3_int_t *lwork,
                         #ifdef COMPLEX
                         double *rwork, const magma_tally3_int_t *lrwork,
                         #endif
...
void   lapackf77_zheevr( const char *jobz, const char *range, const char *uplo,
                         ...
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         double *vl, double *vu, 
                         magma_tally3_int_t *il, magma_tally3_int_t *iu, double *abstol, 
                         magma_tally3_int_t *m, double *w, magma_tally3DoubleComplex *z__, 
...
void   lapackf77_zheevx( const char *jobz, const char *range, const char *uplo,
                         ...
                         magma_tally3_int_t *il, magma_tally3_int_t *iu, double *abstol,
                         magma_tally3_int_t *m, double *w, magma_tally3DoubleComplex *z__,
                         magma_tally3_int_t *ldz, magma_tally3DoubleComplex *work, magma_tally3_int_t *lwork,
                         double *rwork, magma_tally3_int_t *iwork, magma_tally3_int_t *ifail, magma_tally3_int_t *info);

void   lapackf77_zhegs2( const magma_tally3_int_t *itype, const char *uplo,
                         const magma_tally3_int_t *n,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         magma_tally3DoubleComplex *B, const magma_tally3_int_t *ldb,
                         magma_tally3_int_t *info );

void   lapackf77_zhegst( const magma_tally3_int_t *itype, const char *uplo,
                         const magma_tally3_int_t *n,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         magma_tally3DoubleComplex *B, const magma_tally3_int_t *ldb,
                         magma_tally3_int_t *info );

void   lapackf77_zhegvd( const magma_tally3_int_t *itype, const char *jobz, const char *uplo,
                         const magma_tally3_int_t *n,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         magma_tally3DoubleComplex *B, const magma_tally3_int_t *ldb,
                         double *w,
...
void   lapackf77_zhesv( const char *uplo, 
                        const magma_tally3_int_t *n, const magma_tally3_int_t *nrhs,
                        magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda, magma_tally3_int_t *ipiv,
                        magma_tally3DoubleComplex *B, const magma_tally3_int_t *ldb,
                        magma_tally3DoubleComplex *work, const magma_tally3_int_t *lwork,
                        magma_tally3_int_t *info );
...
void   lapackf77_zhseqr( const char *job, const char *compz,
                         ...
                         double *wr, double *wi,
                         #endif
                         magma_tally3DoubleComplex *Z, const magma_tally3_int_t *ldz,
                         magma_tally3DoubleComplex *work, const magma_tally3_int_t *lwork,
                         magma_tally3_int_t *info );

void   lapackf77_zlabrd( const magma_tally3_int_t *m, const magma_tally3_int_t *n, const magma_tally3_int_t *nb,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         double *d, double *e,
                         magma_tally3DoubleComplex *tauq,
                         magma_tally3DoubleComplex *taup,
                         magma_tally3DoubleComplex *X, const magma_tally3_int_t *ldx,
                         magma_tally3DoubleComplex *Y, const magma_tally3_int_t *ldy );

#ifdef COMPLEX
void   lapackf77_zlacgv( const magma_tally3_int_t *n,
                         magma_tally3DoubleComplex *x, const magma_tally3_int_t *incx );
#endif
...
void   lapackf77_zlacp2( const char *uplo,
                         const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         const double *A, const magma_tally3_int_t *lda,
                         magma_tally3DoubleComplex *B, const magma_tally3_int_t *ldb );
#endif
...
#ifdef COMPLEX
void   lapackf77_zlacrm( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         const magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         const double             *B, const magma_tally3_int_t *ldb,
                         magma_tally3DoubleComplex       *C, const magma_tally3_int_t *ldc,
                         double *rwork );
#endif

#ifdef COMPLEX
void   lapackf77_zladiv( magma_tally3DoubleComplex *ret_val,
...
void   lapackf77_zlahef( const char *uplo,
                         ...
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t lda,
                         magma_tally3_int_t *ipiv,
                         magma_tally3DoubleComplex *work, const magma_tally3_int_t *ldwork,
                         magma_tally3_int_t *info );
...
double lapackf77_zlanht( const char *norm, const magma_tally3_int_t *n,
                         const double *d, const magma_tally3DoubleComplex *e );
...
void   lapackf77_zlaqp2( magma_tally3_int_t *m, magma_tally3_int_t *n, magma_tally3_int_t *offset,
                         magma_tally3DoubleComplex *a, magma_tally3_int_t *lda, magma_tally3_int_t *jpvt,
                         magma_tally3DoubleComplex *tau,
                         double *vn1, double *vn2,
                         magma_tally3DoubleComplex *work );

#ifdef COMPLEX
void   lapackf77_zlarcm( const magma_tally3_int_t *m, const magma_tally3_int_t *n,
                         const double             *A, const magma_tally3_int_t *lda,
                         const magma_tally3DoubleComplex *B, const magma_tally3_int_t *ldb,
                         magma_tally3DoubleComplex       *C, const magma_tally3_int_t *ldc,
                         double *rwork );
...
void   lapackf77_zlarf(  const char *side, const magma_tally3_int_t *m, const magma_tally3_int_t *n,
...
void   lapackf77_zlarfb( const char *side, const char *trans, const char *direct, const char *storev,
                         const magma_tally3_int_t *m, const magma_tally3_int_t *n, const magma_tally3_int_t *k,
                         const magma_tally3DoubleComplex *V, const magma_tally3_int_t *ldv,
                         const magma_tally3DoubleComplex *T, const magma_tally3_int_t *ldt,
                         magma_tally3DoubleComplex *C, const magma_tally3_int_t *ldc,
                         magma_tally3DoubleComplex *work, const magma_tally3_int_t *ldwork );

void   lapackf77_zlarfg( const magma_tally3_int_t *n,
...
void   lapackf77_zlarft( const char *direct, const char *storev,
                         const magma_tally3_int_t *n, const magma_tally3_int_t *k,
                         magma_tally3DoubleComplex *V, const magma_tally3_int_t *ldv,
                         const magma_tally3DoubleComplex *tau,
                         magma_tally3DoubleComplex *T, const magma_tally3_int_t *ldt );

void   lapackf77_zlarnv( const magma_tally3_int_t *idist, magma_tally3_int_t *iseed, const magma_tally3_int_t *n,
                         magma_tally3DoubleComplex *x );

void   lapackf77_zlartg( magma_tally3DoubleComplex *F,
                         magma_tally3DoubleComplex *G,
                         double *cs,
                         magma_tally3DoubleComplex *SN,
...
void   lapackf77_zlaswp( const magma_tally3_int_t *n,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
...
void   lapackf77_zlatrs( const char *uplo, const char *trans, const char *diag,
                         ...
                         const magma_tally3_int_t *n,
                         const magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         magma_tally3DoubleComplex *x, double *scale,
                         double *cnorm, magma_tally3_int_t *info );
...
void   lapackf77_zstein( const magma_tally3_int_t *n,
                         ...
                         magma_tally3DoubleComplex *Z, const magma_tally3_int_t *ldz,
                         double *work, magma_tally3_int_t *iwork, magma_tally3_int_t *ifailv,
                         magma_tally3_int_t *info );
...
void   lapackf77_zung2r( const magma_tally3_int_t *m, const magma_tally3_int_t *n, const magma_tally3_int_t *k,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         const magma_tally3DoubleComplex *tau,
                         magma_tally3DoubleComplex *work,
                         magma_tally3_int_t *info );
...
void   lapackf77_zunghr( const magma_tally3_int_t *n,
                         const magma_tally3_int_t *ilo, const magma_tally3_int_t *ihi,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         const magma_tally3DoubleComplex *tau,
                         magma_tally3DoubleComplex *work, const magma_tally3_int_t *lwork,
...
void   lapackf77_zunglq( const magma_tally3_int_t *m, const magma_tally3_int_t *n, const magma_tally3_int_t *k,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         const magma_tally3DoubleComplex *tau,
                         magma_tally3DoubleComplex *work, const magma_tally3_int_t *lwork,
                         magma_tally3_int_t *info );

void   lapackf77_zungql( const magma_tally3_int_t *m, const magma_tally3_int_t *n, const magma_tally3_int_t *k,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         const magma_tally3DoubleComplex *tau,
                         magma_tally3DoubleComplex *work, const magma_tally3_int_t *lwork,
                         magma_tally3_int_t *info );

void   lapackf77_zungqr( const magma_tally3_int_t *m, const magma_tally3_int_t *n, const magma_tally3_int_t *k,
                         magma_tally3DoubleComplex *A, const magma_tally3_int_t *lda,
                         const magma_tally3DoubleComplex *tau,
                         magma_tally3DoubleComplex *work, const magma_tally3_int_t *lwork,
                         magma_tally3_int_t *info );
...
void   lapackf77_dlaln2( const magma_tally3_int_t *ltrans,
                         ...
                         double *x, const magma_tally3_int_t *ldx,
                         double *scale, double *xnorm, magma_tally3_int_t *info );

double lapackf77_dlamc3( double *a, double *b );

void   lapackf77_dlamrg( magma_tally3_int_t *n1, magma_tally3_int_t *n2,
                         double *a,
...
void   lapackf77_dlaed2( magma_tally3_int_t *k, magma_tally3_int_t *n, magma_tally3_int_t *cutpnt,
                         double *d, double *q, magma_tally3_int_t *ldq, magma_tally3_int_t *indxq,
                         double *rho, double *z,
...
void   lapackf77_dlaed4( magma_tally3_int_t *n, magma_tally3_int_t *i,
                         double *d,
                         double *z,
                         double *delta,
                         double *rho,
                         double *dlam, magma_tally3_int_t *info );

void   lapackf77_dlasrt( const char *id, const magma_tally3_int_t *n, double *d, magma_tally3_int_t *info );
