    ...
    magma_tally3_queue_t queue )
{
    ...
    // GPU workspace
    magma_tally3_z_matrix r={Magma_tally3_CSR}, p={Magma_tally3_CSR}, q={Magma_tally3_CSR};
    ...
    magma_tally3_zcopy( dofs, r.dval, 1, p.dval, 1 );                    // p = r
    betanom = nom0;
    ...
    do
    {
        ...
        beta = MAGMA_tally3_Z_MAKE(betanomsq/nom, 0.);           // beta = betanoms/nom
