/*
    -- MAGMA_tally3 (version 1.6.2) --
       ...
       @generated from magma_tally3_zcsrsplit.cpp normal z -> s, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
    ...
    magma_tally3_queue_t queue )
{
    ...
    if (  A.memory_location == Magma_tally3_CPU &&
        ...
        magma_tally3_s_matrix Ah={Magma_tally3_CSR}, ACSR={Magma_tally3_CSR}, DCSR={Magma_tally3_CSR}, RCSR={Magma_tally3_CSR}, Dh={Magma_tally3_CSR}, Rh={Magma_tally3_CSR};
        CHECK( magma_tally3_smtransfer( A, &Ah, A.memory_location, Magma_tally3_CPU, queue ));
        CHECK( magma_tally3_smconvert( Ah, &ACSR, A.storage_type, Magma_tally3_CSR, queue ));

        CHECK( magma_tally3_scsrsplit( bsize, ACSR, &DCSR, &RCSR, queue ));

        CHECK( magma_tally3_smconvert( DCSR, &Dh, Magma_tally3_CSR, A.storage_type, queue ));
        CHECK( magma_tally3_smconvert( RCSR, &Rh, Magma_tally3_CSR, A.storage_type, queue ));

        CHECK( magma_tally3_smtransfer( Dh, D, Magma_tally3_CPU, A.memory_location, queue ));
        CHECK( magma_tally3_smtransfer( Rh, R, Magma_tally3_CPU, A.memory_location, queue ));

        magma_tally3_smfree( &Ah, queue );
        magma_tally3_smfree( &ACSR, queue );
        magma_tally3_smfree( &Dh, queue );
        magma_tally3_smfree( &DCSR, queue );
        magma_tally3_smfree( &Rh, queue );
        magma_tally3_smfree( &RCSR, queue );
    }
cleanup:
    if( info != 0 ){
