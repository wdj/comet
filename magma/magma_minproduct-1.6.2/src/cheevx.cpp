...
magma_minproduct_cheevx(
    ...
    magma_minproductFloatComplex *A, magma_minproduct_int_t lda, float vl, float vu,
    magma_minproduct_int_t il, magma_minproduct_int_t iu, float abstol, magma_minproduct_int_t *m,
    float *w, magma_minproductFloatComplex *Z, magma_minproduct_int_t ldz, magma_minproductFloatComplex *work, magma_minproduct_int_t lwork,
    ...
    magma_minproduct_int_t *info)
{
    ...
    *m = 0;
    ...
    magma_minproduct_chetrd(uplo, n, A, lda, &rwork[indd], &rwork[inde], &work[indtau], &work[indwrk], llwork, &iinfo);
