/*
    -- MAGMA_tally3 (version 1.6.2) --
       ...
       @generated from magma_tally3_zvpass_gpu.cpp normal z -> s, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_tally3_queue_t queue )
{
    ...
    magma_tally3_s_matrix v_DEV={Magma_tally3_CSR};
    ...
    if ( v.memory_location == Magma_tally3_DEV ) {
        ...
        *val = v.dval;
        ...
        CHECK( magma_tally3_smtransfer( v, &v_DEV, v.memory_location, Magma_tally3_DEV, queue ));
        CHECK( magma_tally3_svget_dev( v_DEV, m, n, val, queue ));
    }
    
cleanup:
    magma_tally3_smfree( &v_DEV, queue );
    return info;
}
