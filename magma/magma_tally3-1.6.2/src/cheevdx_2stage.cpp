    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally3_timer_t time=0, time_total=0;
    ...
    if (! wantz) {
        ...
        magma_tally3_cstedx(range, n, vl, vu, il, iu, w, &rwork[inde],
        ...
        magma_tally3_cunmqr_gpu_2stages(Magma_tally3Left, Magma_tally3NoTrans, n-nb, *m, n-nb, da+nb, ldda,
                                 dZ+nb, n, dT1, nb, info);

        magma_tally3_cgetmatrix( n, *m, dZ, lddz, A, lda );
