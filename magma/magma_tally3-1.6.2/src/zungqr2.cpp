...
#define dA(i,j) (dA + (i) + (j)*ldda)
    ...
    magma_tally3DoubleComplex *dA, *dV, *dW, *dT, *T;
    ...
    *info = 0;
    ...
    ldda    = ((m + 31) / 32) * 32;
    lddwork = ((n + 31) / 32) * 32;
    if (MAGMA_tally3_SUCCESS != magma_tally3_zmalloc( &dA, ldda*n + ldda*nb + lddwork*nb + nb*nb)) {
    ...
    magma_tally3DoubleComplex *V = work + (n+nb)*nb;
    ...
    if (kk < n) {
        ...
        */
        lapackf77_zlacpy( Magma_tally3UpperLowerStr, &m_kk, &k_kk, A(kk,kk), &lda, V, &m_kk);
        lapackf77_zlaset( Magma_tally3UpperLowerStr, &m_kk, &n_kk, &c_zero, &c_one, A(kk, kk), &lda );

        lapackf77_zlarft( Magma_tally3ForwardStr, Magma_tally3ColumnwiseStr,
                          &m_kk, &k_kk,
                          V, &m_kk, &tau[kk], work, &k_kk);
        lapackf77_zlarfb( Magma_tally3LeftStr, Magma_tally3NoTransStr, Magma_tally3ForwardStr, Magma_tally3ColumnwiseStr,
                          &m_kk, &n_kk, &k_kk,
