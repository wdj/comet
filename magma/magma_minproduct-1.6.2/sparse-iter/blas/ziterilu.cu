...
__global__ void 
magma_minproduct_ziterilu_csr_kernel(   
    ...
    magma_minproductDoubleComplex s, sp;
    int il, iu, jl, ju;
...
/**
    ...
    @param[in]
    A_CSR       magma_minproduct_z_matrix
...
magma_minproduct_ziterilu_csr( 
    ...
    magma_minproduct_ziterilu_csr_kernel<<< grid, block, 0, magma_minproduct_stream >>>
        ( A.num_rows, A.nnz, 
