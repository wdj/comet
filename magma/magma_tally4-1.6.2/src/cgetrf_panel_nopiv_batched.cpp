    ...
    magma_tally4_int_t batchCount, cublasHandle_t myhandle, magma_tally4_queue_t queue )
{
    ...
    //===============================================
    if(m < nb){
        printf("magma_tally4_cgetrf_panel_nopiv_batched_q m < nb %d < %d \n",(int) m, (int) nb);
        return -101;
    }

#if 0
    arginfo = magma_tally4_cgetf2_nopiv_batched(
                       m, nb,
                       dA_array, ldda,
    ...
    if((m-nb) > 0){
        ...
        magma_tally4blas_ctrsm_work_batched(Magma_tally4Right, Magma_tally4Upper, Magma_tally4NoTrans, Magma_tally4NonUnit,
                              1, m-nb, nb, 
                              MAGMA_tally4_C_ONE,
                              dA_array,    ldda, 
                              dW0_displ,   ldda, 
