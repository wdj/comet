...
magma_tally4_dcompact(
    ...
    magma_tally4Double_ptr dnorms, 
    double tol, 
    magma_tally4Int_ptr active,
    magma_tally4Int_ptr cBlock,
    magma_tally4_queue_t queue )
{
    ...
    dim3 threads( NB );
    dim3 grid( magma_tally4_ceildiv( m, NB ) );
    
    dcompact_kernel<<< grid, threads, 0, queue >>>(
            m, n, dA, ldda, dnorms, tol, active, active+n );

    magma_tally4_igetvector( 1, active+n, 1, cBlock, 1 );
    return info;
}
