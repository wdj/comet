...
int main( int argc, char** argv)
{
    ...
    magma_tally2DoubleComplex *h_A, *h_R, *h_B, *h_X;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_R, magma_tally2DoubleComplex, lda*N         );
            TESTING_MALLOC_CPU( h_B, magma_tally2DoubleComplex, ldb*opts.nrhs );
            TESTING_MALLOC_CPU( h_X, magma_tally2DoubleComplex, ldb*opts.nrhs );
            ...
            magma_tally2_zposv( opts.uplo, N, opts.nrhs, h_R, lda, h_X, ldb, &info );
            ...
            blasf77_zgemm( Magma_tally2NoTransStr, Magma_tally2NoTransStr, &N, &opts.nrhs, &N,
                           &c_one,     h_A, &lda,
                                       h_X, &ldb,
                           &c_neg_one, h_B, &ldb );
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_zposv( lapack_uplo_const_tally2(opts.uplo), &N, &opts.nrhs, h_A, &lda, h_B, &ldb, &info );
