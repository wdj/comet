    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb == 1 || nb > nh) {
        ...
        if (MAGMA_tally2_SUCCESS != magma_tally2_zmalloc( &dwork, 2*nb*ldda + n*ldda + nb*nb )) {
            *info = MAGMA_tally2_ERR_DEVICE_ALLOC;
            return *info;
        }
        magma_tally2DoubleComplex *dV = dwork + nb*ldda;
        magma_tally2DoubleComplex *dA = dwork + nb*ldda*2;
        magma_tally2DoubleComplex *dT = dwork + nb*ldda*2 + n*ldda;
        ldwork = ldda;
        ...
        for (i = ilo; i < ihi-1 - nb; i += nb) {
            ...
            magma_tally2_zsetmatrix( nb, nb, T, nb, dT, nb );
