    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_minproduct_smalloc_cpu( &work, n * nrhs );
    if ( work == NULL ) {
    ...
    if (notran) {
        ...
        /* Solve A * X = B. */
        magma_minproduct_sgetmatrix( n, nrhs, dB, lddb, work, n );
        lapackf77_slaswp(&nrhs, work, &n, &i1, &i2, ipiv, &inc);
        magma_minproduct_ssetmatrix( n, nrhs, work, n, dB, lddb );

        if ( nrhs == 1) {
            magma_minproduct_strsv(Magma_minproductLower, Magma_minproductNoTrans, Magma_minproductUnit,    n, dA, ldda, dB, 1 );
            magma_minproduct_strsv(Magma_minproductUpper, Magma_minproductNoTrans, Magma_minproductNonUnit, n, dA, ldda, dB, 1 );
        } else {
            magma_minproduct_strsm(Magma_minproductLeft, Magma_minproductLower, Magma_minproductNoTrans, Magma_minproductUnit,    n, nrhs, c_one, dA, ldda, dB, lddb );
        ...
        if ( nrhs == 1) {
            magma_minproduct_strsv(Magma_minproductUpper, trans, Magma_minproductNonUnit, n, dA, ldda, dB, 1 );
            magma_minproduct_strsv(Magma_minproductLower, trans, Magma_minproductUnit,    n, dA, ldda, dB, 1 );
        } else {
            magma_minproduct_strsm(Magma_minproductLeft, Magma_minproductUpper, trans, Magma_minproductNonUnit, n, nrhs, c_one, dA, ldda, dB, lddb );
            magma_minproduct_strsm(Magma_minproductLeft, Magma_minproductLower, trans, Magma_minproductUnit,    n, nrhs, c_one, dA, ldda, dB, lddb );
        }
