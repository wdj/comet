    ...
    magma_minproduct_int_t *info)
{
    ...
    *info  = 0;
    ...
    if ( nb >= k ) {
        ...
        magma_minproductFloatComplex *dwork, *dV, *dT, *dC;
        ...
        magma_minproduct_cmalloc_pinned( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_minproduct_csetmatrix( m, n, C, ldc, dC, lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set lower triangle of panel in A to identity,
               ...
               3) restore A                                      */
            cpanel_to_q( Magma_minproductLower, ib, A(nq_i-ib,i), lda, T2 );
            magma_minproduct_csetmatrix( nq_i,  ib, A(0,      i), lda, dV, nq_i );
            cq_to_panel( Magma_minproductLower, ib, A(nq_i-ib,i), lda, T2 );
        ...
        magma_minproduct_cgetmatrix( m, n, dC, lddc, C, ldc );
