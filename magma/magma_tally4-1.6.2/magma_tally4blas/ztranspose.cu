...
ztranspose_device(
    ...
    magma_tally4DoubleComplex *AT,      int ldat)
{
    __shared__ magma_tally4DoubleComplex sA[NB][NX+1];
...
void ztranspose_kernel_batched(
    ...
    magma_tally4DoubleComplex **dAT_array,      int ldat)
{
...
/**
    @see magma_tally4blas_ztranspose_q
    @ingroup magma_tally4_zaux2
    ********************************************************************/
extern "C" void
magma_tally4blas_ztranspose(
    ...
    magma_tally4DoubleComplex_ptr       dAT, magma_tally4_int_t lddat )
{
    magma_tally4blas_ztranspose_q( m, n, dA, ldda, dAT, lddat, magma_tally4_stream );
}
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_tally4blas_ztranspose_batched_q(
    magma_tally4_int_t m, magma_tally4_int_t n,
    magma_tally4DoubleComplex **dA_array,  magma_tally4_int_t ldda,
    magma_tally4DoubleComplex **dAT_array, magma_tally4_int_t lddat, magma_tally4_int_t batchCount, magma_tally4_queue_t queue )
{
    magma_tally4_int_t info = 0;
    if ( m < 0 )
        info = -1;
...
/**
    @see magma_tally4blas_ztranspose_batched_q
    @ingroup magma_tally4_zaux2
    ********************************************************************/
extern "C" void
...
{
    magma_tally4blas_ztranspose_batched_q( m, n, dA_array, ldda, dAT_array, lddat, batchCount, magma_tally4_stream );
}
