/*
    -- MAGMA_tally3 (version 1.6.1) --
       ...
       @generated from zgeqrf3_gpu.cpp normal z -> s, Fri Jan 30 19:00:15 2015
 ...
 */
void ssplit_diag_block3(int ib, float *a, int lda, float *work) {
    int i, j;
    float *cola, *colw;
    ...
    *info = 0;
    ...
    if ( (nb > 1) && (nb < k) ) {
        ...
        for (i = 0; i < k-nb; i += nb) {
            ...
            ssplit_diag_block3(ib, work(i), ldwork, ut);
