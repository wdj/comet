/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from zgeqrs3_gpu.cpp normal z -> d, Fri Jan 30 19:00:15 2015
    ...
    magma_tally4_int_t *info)
{
    ...
    */
    magma_tally4blas_dswapdblk(k-1, nb, dA(0,0), ldda, 1, dT(0), nb, 0);
    if ( nrhs == 1 ) {
        magma_tally4_dtrsv(Magma_tally4Upper, Magma_tally4NoTrans, Magma_tally4NonUnit,
                    n, dA(0,0), ldda, dB, 1);
    } else {
        magma_tally4_dtrsm(Magma_tally4Left, Magma_tally4Upper, Magma_tally4NoTrans, Magma_tally4NonUnit,
                    n, nrhs, c_one, dA(0,0), ldda, dB, lddb);
    }
    magma_tally4blas_dswapdblk(k-1, nb, dT(0), nb, 0, dA(0,0), ldda, 1);
