    ...
    magma_minproduct_queue_t queue )
{
    ...
    // workspace
    magma_minproduct_c_matrix r={Magma_minproduct_CSR}, rr={Magma_minproduct_CSR}, p={Magma_minproduct_CSR}, v={Magma_minproduct_CSR}, s={Magma_minproduct_CSR}, t={Magma_minproduct_CSR}, ms={Magma_minproduct_CSR}, mt={Magma_minproduct_CSR}, y={Magma_minproduct_CSR}, z={Magma_minproduct_CSR};
    ...
    CHECK( magma_minproduct_cvinit( &ms,Magma_minproduct_DEV, A.num_rows, b.num_cols, c_zero, queue ));
    CHECK( magma_minproduct_cvinit( &mt,Magma_minproduct_DEV, A.num_rows, b.num_cols, c_zero, queue ));
    CHECK( magma_minproduct_cvinit( &y, Magma_minproduct_DEV, A.num_rows, b.num_cols, c_zero, queue ));
    ...
    betanom = nom0;
    nom = nom0*nom0;
    rho_new = omega = alpha = MAGMA_minproduct_C_MAKE( 1.0, 0. );
    ...
    do
    {
        ...
        // preconditioner
        CHECK( magma_minproduct_c_applyprecond_left( A, p, &mt, precond_par, queue ));
        CHECK( magma_minproduct_c_applyprecond_right( A, mt, &y, precond_par, queue ));

        CHECK( magma_minproduct_c_spmv( c_one, A, y, c_zero, v, queue ));      // v = Ap
        ...
        // preconditioner
        CHECK( magma_minproduct_c_applyprecond_left( A, s, &ms, precond_par, queue ));
        CHECK( magma_minproduct_c_applyprecond_right( A, ms, &z, precond_par, queue ));

        CHECK( magma_minproduct_c_spmv( c_one, A, z, c_zero, t, queue ));       // t=As

        // preconditioner
        CHECK( magma_minproduct_c_applyprecond_left( A, s, &ms, precond_par, queue ));
        CHECK( magma_minproduct_c_applyprecond_left( A, t, &mt, precond_par, queue ));

        // omega = <ms,mt>/<mt,mt>
        omega = magma_minproduct_cdotc( dofs, mt.dval, 1, ms.dval, 1 )
                   / magma_minproduct_cdotc( dofs, mt.dval, 1, mt.dval, 1 );

        magma_minproduct_caxpy( dofs, alpha, y.dval, 1 , x->dval, 1 );     // x=x+alpha*p
        magma_minproduct_caxpy( dofs, omega, z.dval, 1 , x->dval, 1 );     // x=x+omega*s
...
cleanup:
    ...
    magma_minproduct_cmfree(&ms, queue );
    magma_minproduct_cmfree(&mt, queue );
