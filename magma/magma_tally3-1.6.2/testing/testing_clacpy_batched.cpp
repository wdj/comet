...
int main( int argc, char** argv)
{
    ...
    magma_tally3FloatComplex *h_A, *h_B;
    magma_tally3FloatComplex_ptr d_A, d_B;
    magma_tally3FloatComplex **hAarray, **hBarray, **dAarray, **dBarray;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_B, magma_tally3FloatComplex, lda *N );
            TESTING_MALLOC_DEV( d_A, magma_tally3FloatComplex, ldda*N );
            TESTING_MALLOC_DEV( d_B, magma_tally3FloatComplex, ldda*N );
            
            TESTING_MALLOC_CPU( hAarray, magma_tally3FloatComplex*, ntile );
            TESTING_MALLOC_CPU( hBarray, magma_tally3FloatComplex*, ntile );
            TESTING_MALLOC_DEV( dAarray, magma_tally3FloatComplex*, ntile );
            TESTING_MALLOC_DEV( dBarray, magma_tally3FloatComplex*, ntile );
            ...
            magma_tally3_csetmatrix( M, N, h_B, lda, d_B, ldda );
            ...
            magma_tally3_setvector( ntile, sizeof(magma_tally3FloatComplex*), hAarray, 1, dAarray, 1 );
            magma_tally3_setvector( ntile, sizeof(magma_tally3FloatComplex*), hBarray, 1, dBarray, 1 );
            
            gpu_time = magma_tally3_sync_wtime( 0 );
            magma_tally3blas_clacpy_batched( Magma_tally3UpperLower, mb, nb, dAarray, ldda, dBarray, ldda, ntile, queue );
            ...
            for( int tile = 0; tile < ntile; ++tile ) {
                ...
                lapackf77_clacpy( Magma_tally3UpperLowerStr, &mb, &nb,
                                  &h_A[offset], &lda,
                                  &h_B[offset], &lda );
            }
            ...
            /* =====================================================================
               Check the result
               =================================================================== */
            magma_tally3_cgetmatrix( M, N, d_B, ldda, h_A, lda );
