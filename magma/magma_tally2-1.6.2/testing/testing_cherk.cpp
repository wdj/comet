...
int main( int argc, char** argv)
{
    ...
    magma_tally2FloatComplex *h_A, *h_C, *h_Ccublas;
    magma_tally2FloatComplex_ptr d_A, d_C;
    magma_tally2FloatComplex c_neg_one = MAGMA_tally2_C_NEG_ONE;
    float alpha = MAGMA_tally2_D_MAKE(  0.29, -0.86 );
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            cublasCherk( opts.handle, cublas_uplo_const_tally2(opts.uplo), cublas_trans_const_tally2(opts.transA), N, K,
                         &alpha, d_A, ldda,
                         &beta,  d_C, lddc );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_cherk( lapack_uplo_const_tally2(opts.uplo), lapack_trans_const_tally2(opts.transA), &N, &K,
                               &alpha, h_A, &lda,
                               &beta,  h_C, &ldc );
            ...
            if ( opts.lapack ) {
                ...
                Cnorm = lapackf77_clanhe("fro", lapack_uplo_const_tally2(opts.uplo), &N, h_C, &ldc, work);

                blasf77_caxpy( &sizeC, &c_neg_one, h_C, &ione, h_Ccublas, &ione );
                cublas_error = lapackf77_clanhe( "fro", lapack_uplo_const_tally2(opts.uplo), &N, h_Ccublas, &ldc, work ) / Cnorm;
