/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zhetrd_he2hb_mgpu_spec.cpp normal z -> s, Fri Jan 30 19:00:18 2015
    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    float *dspace[Magma_minproductMaxGPUs];
    float *dwork[Magma_minproductMaxGPUs], *dworkbis[Magma_minproductMaxGPUs];
    float *dvall[Magma_minproductMaxGPUs], *dv[Magma_minproductMaxGPUs], *dw[Magma_minproductMaxGPUs];
    float *workngpu[Magma_minproductMaxGPUs+1];
    ...
    for( magma_minproduct_int_t dev = 0; dev < ngpu; ++dev ) {
        ...
        magma_minproduct_smalloc( &dspace[dev], devworksiz );
        magma_minproduct_smalloc_pinned ( &workngpu[dev], worksiz);
    ...
    magma_minproduct_smalloc_pinned ( &workngpu[ngpu], worksiz);
    float *worktest = NULL;
    //magma_minproduct_smalloc_cpu( &worktest, n*nb ); // not used
    // ======================
    ...
    if (upper) {
        ...
        for (i = 1; i <= n-nb; i += nb) {
            ...
            if (i > 1 ) {
                ...
                spanel_to_q(Magma_minproductUpper, pn-1, A(i, i+1), lda, work);
                ...
                magma_minproduct_sgetmatrix_async( (pm+pn), pn,
                                        dA(idev, i, di+1), ldda,
                ...
                //magma_minproduct_setdevice( 0 );
                sq_to_panel(Magma_minproductUpper, pn-1, A(i, i+1), lda, work);
            }
            ...
            spanel_to_q(Magma_minproductUpper, pk, A(indi, indj), lda, work);
            ...
            for( magma_minproduct_int_t dev = 0; dev < ngpu; ++dev ) {
                magma_minproduct_setdevice( dev );
                // send V
                magma_minproduct_ssetmatrix_async( pm, pk,
                                        A(indi, indj), lda,
                                        dv[dev], pm, queues[dev][nqueue-1] );

                // Send the triangular factor T to the GPU
                magma_minproduct_ssetmatrix_async( pk, pk,
                                        hT, nb,
            ...
            for( magma_minproduct_int_t dev = 0; dev < ngpu; ++dev ) {
                ...
                magma_minproduct_sgemm(Magma_minproductNoTrans, Magma_minproductNoTrans, pm, pk, pk,
                        c_one, dv[dev], pm,
                        dT(dev, 1, i), lddt,
                        c_zero, dwork[dev], pm);
            }
            ...
            for( magma_minproduct_int_t dev = 0; dev < ngpu; ++dev ) {
                ...
                magma_minproduct_sgemm(Magma_minproductConjTrans, Magma_minproductNoTrans, pk, pk, pm,
                            c_one, dwork[dev], pm,
                            dw[dev], pm,
            ...
            sq_to_panel(Magma_minproductUpper, pk, A(indi, indj), lda, work);
            // ===============================================
            ...
            if (i + nb <= n-nb) {
                ...
                magma_minproduct_sgemm(Magma_minproductNoTrans, Magma_minproductConjTrans, pm, pn, pn, c_neg_one,
                            dv[idev], pm,
                            dw[idev], pm, c_one,
                ...
                magma_minproduct_ssyr2k(Magma_minproductLower, Magma_minproductNoTrans, pk, pk, c_neg_one,
                             dv[idev], pm,
                             dw[idev], pm, d_one,
                             dA(idev, indi, di+1), ldda);
                ...
                spanel_to_q(Magma_minproductUpper, pk-1, A(n-pk+1, n-pk+2), lda, work);
                magma_minproduct_sgetmatrix( pk, pk,
                                  dA(idev, indi, di+1), ldda,
                                  A(n-pk+1, n-pk+1),  lda );
                sq_to_panel(Magma_minproductUpper, pk-1, A(n-pk+1, n-pk+2), lda, work);
            }
