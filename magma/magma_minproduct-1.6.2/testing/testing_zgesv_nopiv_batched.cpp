...
int main(int argc, char **argv)
{
    ...
    magma_minproductDoubleComplex **d_A_array, **d_B_array;
    magma_minproduct_int_t *ipiv;
    magma_minproduct_int_t N, n2, nrhs, lda, ldb, ldda, lddb, info, sizeA, sizeB;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_B, magma_minproductDoubleComplex, ldb*nrhs*batchCount );
            TESTING_MALLOC_CPU( h_X, magma_minproductDoubleComplex, ldb*nrhs*batchCount );
            ...
            TESTING_MALLOC_DEV( d_B, magma_minproductDoubleComplex, lddb*nrhs*batchCount );
            ...
            magma_minproduct_zsetmatrix( N, columns,    h_A, lda, d_A, ldda );
            magma_minproduct_zsetmatrix( N, nrhs*batchCount, h_B, ldb, d_B, lddb );
            ...
            magma_minproduct_zgesv_nopiv_batched( N, nrhs, d_A_array, ldda, d_B_array, lddb, dinfo_magma_minproduct, batchCount, queue );
            ...
            double err = 0;
            error = 0;
            magma_minproduct_zgetmatrix( N, nrhs*batchCount, d_B, lddb, h_X, ldb );
            for(magma_minproduct_int_t s = 0; s < batchCount; s++)
            {
                ...
                blasf77_zgemm( Magma_minproductNoTransStr, Magma_minproductNoTransStr, &N, &nrhs, &N,
