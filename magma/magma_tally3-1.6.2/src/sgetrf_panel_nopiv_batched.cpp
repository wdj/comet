    ...
    magma_tally3_int_t batchCount, cublasHandle_t myhandle, magma_tally3_queue_t queue )
{
    ...
    //===============================================
    if(m < nb){
        printf("magma_tally3_sgetrf_panel_nopiv_batched_q m < nb %d < %d \n",(int) m, (int) nb);
        return -101;
    }

#if 0
    arginfo = magma_tally3_sgetf2_nopiv_batched(
                       m, nb,
                       dA_array, ldda,
    ...
    if((m-nb) > 0){
        ...
        magma_tally3blas_strsm_work_batched(Magma_tally3Right, Magma_tally3Upper, Magma_tally3NoTrans, Magma_tally3NonUnit,
                              1, m-nb, nb, 
                              MAGMA_tally3_S_ONE,
                              dA_array,    ldda, 
                              dW0_displ,   ldda, 
