    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally3_sstedx( Magma_tally3RangeAll, n, 0., 0., 0, 0, w, &work[inde],
        ...
        magma_tally3_ssetmatrix( n, n, &work[indwrk], n, dwork, lddc );

        magma_tally3_sormtr_gpu( Magma_tally3Left, uplo, Magma_tally3NoTrans, n, n, dA, ldda, &work[indtau],
                          dwork, lddc, wA, ldwa, &iinfo );

        magma_tally3_scopymatrix( n, n, dwork, lddc, dA, ldda );
