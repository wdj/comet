    ...
    magma_minproduct_int_t *info)
{
    ...
    magma_minproductDoubleComplex T[2*4160]        /* was [65][64] */;
    ...
    *info = 0;
    ...
    if (left) {
        nq = m;
        //nw = n;
        magma_minproduct_zmalloc( &dwork, (n + 64)*64 );  // TODO after checking args, else memory leak!
    } else {
        nq = n;
        //nw = m;
        magma_minproduct_zmalloc( &dwork, (m + 64)*64 );  // TODO after checking args, else memory leak!
    }
    ...
    magma_minproductblas_zlaset_band( Magma_minproductUpper, k, k, nb, c_zero, c_one, dA, ldda );
    ...
    for (i = i1; (step < 0 ? i >= i2 : i <= i2); i += step) {
        ...
        magma_minproduct_zsetmatrix( ib, ib, T, ib, dwork, ib );
