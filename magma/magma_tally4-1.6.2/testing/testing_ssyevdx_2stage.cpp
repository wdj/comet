...
static magma_tally4_int_t check_orthogonality(magma_tally4_int_t M, magma_tally4_int_t N, float *Q, magma_tally4_int_t LDQ, float eps);
static magma_tally4_int_t check_reduction(magma_tally4_uplo_t uplo, magma_tally4_int_t N, magma_tally4_int_t bw, float *A, float *D, magma_tally4_int_t LDA, float *Q, float eps );
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (opts.warmup) {
                ...
                if (opts.ngpu == 1) {
                    ...
                    magma_tally4_ssyevdx_2stage_m(opts.ngpu, opts.jobz, range, opts.uplo, N, 
                                    h_R, N, 
                                    vl, vu, il, iu, 
                                    &m1, w1, 
                                    h_work, lwork, 
            ...
            if ( opts.check && opts.jobz != Magma_tally4NoVec ) {
                ...
                //printf("\n");
                //printf("------ TESTS FOR MAGMA_tally4 SSYEVD ROUTINE -------  \n");
...
static magma_tally4_int_t check_orthogonality(magma_tally4_int_t M, magma_tally4_int_t N, float *Q, magma_tally4_int_t LDQ, float eps)
{
    ...
    float *Id;
    magma_tally4_smalloc_cpu( &Id, minMN*minMN );
...
static magma_tally4_int_t check_reduction(magma_tally4_uplo_t uplo, magma_tally4_int_t N, magma_tally4_int_t bw, float *A, float *D, magma_tally4_int_t LDA, float *Q, float eps )
{
    ...
    magma_tally4_smalloc_cpu( &TEMP, N*N );
    magma_tally4_smalloc_cpu( &Residual, N*N );
    ...
    Rnorm = lapackf77_slansy("1", lapack_uplo_const_tally4(uplo), &N, Residual, &N, work);
    Anorm = lapackf77_slansy("1", lapack_uplo_const_tally4(uplo), &N, A,        &LDA, work);
