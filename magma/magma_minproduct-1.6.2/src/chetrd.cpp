    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    #endif
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_cmalloc( &dA, ldda*n + 2*lddw*nb + ldwork2 )) {
        *info = MAGMA_minproduct_ERR_DEVICE_ALLOC;
        return *info;
    }

    magma_minproductFloatComplex *dwork  = dA + ldda*n;
    #ifdef FAST_HEMV
    magma_minproductFloatComplex *dwork2 = dwork + 2*lddw*nb;
    #endif
    ...
    if (upper) {
        ...
        magma_minproduct_csetmatrix( n, n, A(0, 0), lda, dA(0, 0), ldda );
        ...
        for (i = n - nb; i >= kk; i -= nb) {
            ...
            magma_minproduct_clatrd2( uplo, i+nb, nb, A(0, 0), lda, e, tau,
                           ...
                           dwork2, ldwork2 );
            #else
            magma_minproduct_clatrd(  uplo, i+nb, nb, A(0, 0), lda, e, tau,
                           work, ldw, dA(0, 0), ldda, dwork, lddw );
            #endif
        ...
        for (i = 0; i < n-nx; i += nb) {
            ...
            magma_minproduct_clatrd2( uplo, n-i, nb, A(i, i), lda, &e[i], &tau[i],
                           ...
                           dwork2, ldwork2 );
            #else
            magma_minproduct_clatrd(  uplo, n-i, nb, A(i, i), lda, &e[i], &tau[i],
                           work, ldw, dA(i, i), ldda, dwork, lddw );
            #endif
