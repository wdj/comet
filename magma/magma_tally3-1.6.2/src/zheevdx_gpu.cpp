    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally3_SUCCESS != magma_tally3_dmalloc( &dwork, ldwork_real )) {
        *info = MAGMA_tally3_ERR_DEVICE_ALLOC;
        return *info;
    }
    dC = (magma_tally3DoubleComplex*) dwork;
    ...
    if (iscale == 1) {
        magma_tally3blas_zlascl( uplo, 0, 0, 1., sigma, n, n, dA, ldda, info );
    }
...
#ifdef FAST_HEMV
    magma_tally3_zhetrd2_gpu( uplo, n, dA, ldda, w, &rwork[inde],
                       &work[indtau], wA, ldwa, &work[indwrk], llwork,
                       dC, ldwork, &iinfo );
#else
    magma_tally3_zhetrd_gpu ( uplo, n, dA, ldda, w, &rwork[inde],
                       &work[indtau], wA, ldwa, &work[indwrk], llwork,
                       &iinfo );
#endif
    ...
    if (! wantz) {
        ...
        magma_tally3_zsetmatrix( n, *mout, &work[indwrk + n * (il-1) ], n, dC, lddc );

        magma_tally3_zunmtr_gpu( Magma_tally3Left, uplo, Magma_tally3NoTrans, n, *mout, dA, ldda, &work[indtau],
                          dC, lddc, wA, ldwa, &iinfo );

        magma_tally3_zcopymatrix( n, *mout, dC, lddc, dA, ldda );
