...
int main( int argc, char** argv)
{
    ...
    magma_tally4DoubleComplex *h_A, *h_R, *d_R, *h_work, aux_work[1];
    #ifdef COMPLEX
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally4_zheevd_gpu( opts.jobz, opts.uplo,
                              N, NULL, ldda, NULL,
                              NULL, lda,
                              aux_work,  -1,
                              #ifdef COMPLEX
                              ...
                              aux_iwork, -1,
                              &info );
            lwork  = (magma_tally4_int_t) MAGMA_tally4_Z_REAL( aux_work[0] );
            #ifdef COMPLEX
            ...
            TESTING_MALLOC_CPU( h_A,    magma_tally4DoubleComplex, N*lda  );
            ...
            TESTING_MALLOC_PIN( h_R,    magma_tally4DoubleComplex, N*lda  );
            TESTING_MALLOC_PIN( h_work, magma_tally4DoubleComplex, lwork  );
            
            TESTING_MALLOC_DEV( d_R,    magma_tally4DoubleComplex, N*ldda );
            
            /* Initialize the matrix */
            lapackf77_zlarnv( &ione, ISEED, &n2, h_A );
            magma_tally4_zmake_hermitian( N, h_A, N );
            
            magma_tally4_zsetmatrix( N, N, h_A, lda, d_R, ldda );
            ...
            if ( opts.warmup ) {
                magma_tally4_zheevd_gpu( opts.jobz, opts.uplo,
                                  ...
                                  &info );
                if (info != 0)
                    printf("magma_tally4_zheevd_gpu returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_tally4NoVec ) {
                /* =====================================================================
                   ...
                   =================================================================== */
                magma_tally4_zgetmatrix( N, N, d_R, ldda, h_R, lda );
                ...
                //
                //magma_tally4_zsetmatrix( N, N, h_A, lda, d_R, ldda );
                //magma_tally4_zheevd_gpu( Magma_tally4NoVec, opts.uplo,
                //                  N, d_R, ldda, w2,
                //                  h_R, lda,
                //                  h_work, lwork,
                //                  #ifdef COMPLEX
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_zheevd( lapack_vec_const_tally4(opts.jobz), lapack_uplo_const_tally4(opts.uplo),
                                  &N, h_A, &lda, w2,
                                  h_work, &lwork,
                                  #ifdef COMPLEX
                                  rwork, &lrwork,
