    ...
    magma_tally4_queue_t queue)
{
    ...
    magma_tally4blas_capply_transpose_vector_kernel<<< grid, threads, 0, queue >>>(n/2, du, n, db, 0);
    magma_tally4blas_capply_transpose_vector_kernel<<< grid, threads, 0, queue >>>(n/2, du, n+n/2, db, n/2);

    threads = block_length;
    grid = n/(2*block_length) + ((n%(2*block_length))!=0);
    magma_tally4blas_capply_transpose_vector_kernel<<< grid, threads, 0, queue >>>(n, du, 0, db, 0);
}

/**
    @see magma_tally4blas_cprbt_mtv_q
    ********************************************************************/
extern "C" void
magma_tally4blas_cprbt_mtv(
    ...
    magma_tally4FloatComplex *du, magma_tally4FloatComplex *db)
{
    magma_tally4blas_cprbt_mtv_q(n, du, db, magma_tally4_stream);
}
    ...
    magma_tally4_queue_t queue)
{
    ...
    magma_tally4blas_capply_vector_kernel<<< grid, threads, 0, queue >>>(n, dv, 0, db, 0);


    threads = block_length;
    grid = n/(4*block_length) + ((n%(4*block_length))!=0);

    magma_tally4blas_capply_vector_kernel<<< grid, threads, 0, queue >>>(n/2, dv, n, db, 0);
    magma_tally4blas_capply_vector_kernel<<< grid, threads, 0, queue >>>(n/2, dv, n+n/2, db, n/2);
}
...
magma_tally4blas_cprbt_mv(
    ...
    magma_tally4FloatComplex *dv, magma_tally4FloatComplex *db)
{
    magma_tally4blas_cprbt_mv_q(n, dv, db, magma_tally4_stream);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
    Purpose
    ...
    magma_tally4_queue_t queue)
{
    ...
    magma_tally4blas_celementary_multiplication_kernel<<< grid, threads, 0, queue >>>(n/2, dA,            0, ldda, du,   0, dv,   0);
    magma_tally4blas_celementary_multiplication_kernel<<< grid, threads, 0, queue >>>(n/2, dA,     ldda*n/2, ldda, du,   0, dv, n/2);
    magma_tally4blas_celementary_multiplication_kernel<<< grid, threads, 0, queue >>>(n/2, dA,          n/2, ldda, du, n/2, dv,   0);
    magma_tally4blas_celementary_multiplication_kernel<<< grid, threads, 0, queue >>>(n/2, dA, ldda*n/2+n/2, ldda, du, n/2, dv, n/2);

    dim3 threads2(block_height, block_width);
    dim3 grid2(n/(2*block_height) + ((n%(2*block_height))!=0), 
            n/(2*block_width)  + ((n%(2*block_width))!=0));
    magma_tally4blas_celementary_multiplication_kernel<<< grid2, threads2, 0, queue >>>(n, dA, 0, ldda, du, -ldda, dv, -ldda);
}


/**
    @see magma_tally4blas_cprbt_q
    ********************************************************************/
extern "C" void 
magma_tally4blas_cprbt(
    ...
    magma_tally4FloatComplex *du, magma_tally4FloatComplex *dv)
{
    magma_tally4blas_cprbt_q(n, dA, ldda, du, dv, magma_tally4_stream);
}
...
__global__ void
caxpycp2_kernel(
    int m, magma_tally4FloatComplex *r, magma_tally4FloatComplex *x,
    const magma_tally4FloatComplex *b)
{
    const int i = threadIdx.x + blockIdx.x*NB;
    if ( i < m ) {
        x[i] = MAGMA_tally4_C_ADD( x[i], r[i] );
        r[i] = b[i];
    }
}
...
magma_tally4blas_caxpycp2(
    ...
    const magma_tally4FloatComplex *b)
{
    magma_tally4blas_caxpycp2_q( m, r, x, b, magma_tally4_stream );
}
