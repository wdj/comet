...
static magma_tally4_int_t check_orthogonality(magma_tally4_int_t M, magma_tally4_int_t N, double *Q, magma_tally4_int_t LDQ, double eps);
static magma_tally4_int_t check_reduction(magma_tally4_uplo_t uplo, magma_tally4_int_t N, magma_tally4_int_t bw, double *A, double *D, magma_tally4_int_t LDA, double *Q, double eps );
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (opts.warmup) {
                ...
                if (opts.ngpu == 1) {
                    ...
                    magma_tally4_dsyevdx_2stage_m(opts.ngpu, opts.jobz, range, opts.uplo, N, 
                                    h_R, N, 
                                    vl, vu, il, iu, 
                                    &m1, w1, 
                                    h_work, lwork, 
            ...
            if ( opts.check && opts.jobz != Magma_tally4NoVec ) {
                ...
                //printf("\n");
                //printf("------ TESTS FOR MAGMA_tally4 DSYEVD ROUTINE -------  \n");
...
static magma_tally4_int_t check_orthogonality(magma_tally4_int_t M, magma_tally4_int_t N, double *Q, magma_tally4_int_t LDQ, double eps)
{
    ...
    double *Id;
    magma_tally4_dmalloc_cpu( &Id, minMN*minMN );
...
static magma_tally4_int_t check_reduction(magma_tally4_uplo_t uplo, magma_tally4_int_t N, magma_tally4_int_t bw, double *A, double *D, magma_tally4_int_t LDA, double *Q, double eps )
{
    ...
    magma_tally4_dmalloc_cpu( &TEMP, N*N );
    magma_tally4_dmalloc_cpu( &Residual, N*N );
    ...
    Rnorm = lapackf77_dlansy("1", lapack_uplo_const_tally4(uplo), &N, Residual, &N, work);
    Anorm = lapackf77_dlansy("1", lapack_uplo_const_tally4(uplo), &N, A,        &LDA, work);
