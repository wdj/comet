...
/**
    ...
    ********************************************************************/
extern "C"
magma_minproduct_int_t magma_minproduct_ztrevc3(
    ...
    if ( rightv ) {
        ...
        for( ki=n-1; ki >= 0; --ki ) {
            ...
            *work(ki,iv) = c_one;
            ...
            for( k=0; k < ki; ++k ) {
                *T(k,k) -= *T(ki,ki);
                if ( MAGMA_minproduct_Z_ABS1( *T(k,k) ) < smin ) {
                    *T(k,k) = MAGMA_minproduct_Z_MAKE( smin, 0. );
                }
            }
            ...
            if ( ki > 0 ) {
                ...
                *work(ki,iv) = MAGMA_minproduct_Z_MAKE( scale, 0. );
            }
