...
/**
    ...
    B       DOUBLE PRECISION array, dimension (LDB, N)
            On entry, the symmetric matrix B.  If UPLO = Magma_tally2Upper, the
    ...
    @ingroup magma_tally2_dsygv_driver
    ********************************************************************/
    ...
    magma_tally2_int_t *info)
{
    ...
    magma_tally2_int_t wantz, lquery;
    ...
    *info = 0;
    ...
    if (MAGMA_tally2_SUCCESS != magma_tally2_dmalloc( &dA, n*ldda ) ||
        MAGMA_tally2_SUCCESS != magma_tally2_dmalloc( &dB, n*lddb )) {
    ...
    magma_tally2_dsetmatrix( n, n, B, ldb, dB, lddb );
    magma_tally2_dsetmatrix_async( n, n,
                            A,  lda,
                            dA, ldda, stream );
    ...
    magma_tally2_dpotrf_gpu( uplo, n, dB, lddb, info );
    if (*info != 0) {
        *info = n + *info;
        return *info;
    }
    ...
    magma_tally2_dgetmatrix_async( n, n,
                            dB, lddb,
                            B,  ldb, stream );
    ...
    magma_tally2_dsygst_gpu( itype, uplo, n, dA, ldda, dB, lddb, info );
    ...
    timer_start( time );
    magma_tally2_dsyevdx_gpu( jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, mout, w, A, lda,
    ...
    if (wantz && *info == 0) {
        ...
        if (dB == NULL) {
            if (MAGMA_tally2_SUCCESS != magma_tally2_dmalloc( &dB, n*lddb ) ) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally2_dtrsm( Magma_tally2Left, uplo, trans, Magma_tally2NonUnit,
            ...
            magma_tally2_dtrmm( Magma_tally2Left, uplo, trans, Magma_tally2NonUnit,
                         n, *mout, d_one, dB, lddb, dA, ldda );
        }
        magma_tally2_dgetmatrix( n, *mout, dA, ldda, A, lda );
