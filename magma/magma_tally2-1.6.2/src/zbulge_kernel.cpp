...
void magma_tally2_ztrdtype1cbHLsym_withQ(
    magma_tally2_int_t N, magma_tally2_int_t NB,
    magma_tally2DoubleComplex *A, magma_tally2_int_t LDA,
    magma_tally2DoubleComplex *V, magma_tally2DoubleComplex *TAU,
    magma_tally2_int_t st, magma_tally2_int_t ed, magma_tally2_int_t sweep, magma_tally2_int_t Vblksiz);

void magma_tally2_ztrdtype2cbHLsym_withQ(
    magma_tally2_int_t N, magma_tally2_int_t NB,
    magma_tally2DoubleComplex *A, magma_tally2_int_t LDA,
    magma_tally2DoubleComplex *V, magma_tally2DoubleComplex *TAU,
    magma_tally2_int_t st, magma_tally2_int_t ed, magma_tally2_int_t sweep, magma_tally2_int_t Vblksiz);
   
void magma_tally2_ztrdtype3cbHLsym_withQ(
    magma_tally2_int_t N, magma_tally2_int_t NB,
    magma_tally2DoubleComplex *A, magma_tally2_int_t LDA,
    magma_tally2DoubleComplex *V, magma_tally2DoubleComplex *TAU,
    magma_tally2_int_t st, magma_tally2_int_t ed, magma_tally2_int_t sweep, magma_tally2_int_t Vblksiz);

void magma_tally2_zlarfxsym(
...
extern "C" void
magma_tally2_zlarfxsym(
    magma_tally2_int_t N,
    magma_tally2DoubleComplex *A, magma_tally2_int_t LDA,
    magma_tally2DoubleComplex *V, magma_tally2DoubleComplex *TAU)
{
    magma_tally2_int_t IONE=1;
    magma_tally2DoubleComplex dtmp;
    magma_tally2DoubleComplex Z_ZERO =  MAGMA_tally2_Z_ZERO;
    //magma_tally2DoubleComplex Z_ONE  =  MAGMA_tally2_Z_ONE;
    magma_tally2DoubleComplex Z_MONE =  MAGMA_tally2_Z_NEG_ONE;
    magma_tally2DoubleComplex Z_HALF =  MAGMA_tally2_Z_HALF;
    //magma_tally2DoubleComplex WORK[N];
    magma_tally2DoubleComplex *WORK;
    magma_tally2_zmalloc_cpu( &WORK, N );
    
    /* apply left and right on A(st:ed,st:ed)*/
    //magma_tally2_zlarfxsym(len,A(st,st),LDX,V(st),TAU(st));
    /* X = AVtau */
    blasf77_zhemv("L",&N, TAU, A, &LDA, V, &IONE, &Z_ZERO, WORK, &IONE);
    /* je calcul dtmp= X'*V */
    dtmp = magma_tally2_cblas_zdotc(N, WORK, IONE, V, IONE);
...
#define TAU(m)   &(TAU[(m)])
extern "C" void
magma_tally2_ztrdtype1cbHLsym_withQ(
    magma_tally2_int_t N, magma_tally2_int_t NB,
    magma_tally2DoubleComplex *A, magma_tally2_int_t LDA,
    magma_tally2DoubleComplex *V, magma_tally2DoubleComplex *TAU,
    magma_tally2_int_t st, magma_tally2_int_t ed, magma_tally2_int_t sweep, magma_tally2_int_t Vblksiz)
{
    ...
    //magma_tally2DoubleComplex conjtmp;
    magma_tally2DoubleComplex Z_ONE  =  MAGMA_tally2_Z_ONE;
    magma_tally2DoubleComplex *WORK;
    magma_tally2_zmalloc_cpu( &WORK, N );
    ...
    len     = ed-st+1;
    *V(vpos)  = Z_ONE;
    memcpy(V(vpos+1), A(st+1, st-1), (len-1)*sizeof(magma_tally2DoubleComplex));
    memset(A(st+1, st-1), 0, (len-1)*sizeof(magma_tally2DoubleComplex));
    /* Eliminate the col  at st-1 */
    lapackf77_zlarfg( &len, A(st, st-1), V(vpos+1), &IONE, TAU(taupos) );
    /* apply left and right on A(st:ed,st:ed)*/
    magma_tally2_zlarfxsym(len,A(st,st),LDX,V(vpos),TAU(taupos));
    //conjtmp = MAGMA_tally2_Z_CNJG(*TAU(taupos));
    //lapackf77_zlarfy("L", &len, V(vpos), &IONE, &conjtmp, A(st,st), &LDX, WORK); //&(MAGMA_tally2_Z_CNJG(*TAU(taupos)))
    magma_tally2_free_cpu(WORK);
}
#undef A
#undef V
...
#define TAU(m)   &(TAU[(m)])
extern "C" void
magma_tally2_ztrdtype2cbHLsym_withQ(
    magma_tally2_int_t N, magma_tally2_int_t NB,
    magma_tally2DoubleComplex *A, magma_tally2_int_t LDA,
    magma_tally2DoubleComplex *V, magma_tally2DoubleComplex *TAU,
    magma_tally2_int_t st, magma_tally2_int_t ed, magma_tally2_int_t sweep, magma_tally2_int_t Vblksiz)
{
    ...
    magma_tally2DoubleComplex conjtmp;
    magma_tally2DoubleComplex Z_ONE  =  MAGMA_tally2_Z_ONE;
    //magma_tally2DoubleComplex WORK[NB];
    magma_tally2DoubleComplex *WORK;
    magma_tally2_zmalloc_cpu( &WORK, NB );
    ...
    if (lem > 1) {
        ...
        *V(vpos)  = Z_ONE;
        memcpy(V(vpos+1), A(J1+1, st), (lem-1)*sizeof(magma_tally2DoubleComplex));
        memset(A(J1+1, st),0,(lem-1)*sizeof(magma_tally2DoubleComplex));
...
#define TAU(m)   &(TAU[(m)])
extern "C" void
magma_tally2_ztrdtype3cbHLsym_withQ(
    magma_tally2_int_t N, magma_tally2_int_t NB,
    magma_tally2DoubleComplex *A, magma_tally2_int_t LDA,
    magma_tally2DoubleComplex *V, magma_tally2DoubleComplex *TAU,
    magma_tally2_int_t st, magma_tally2_int_t ed, magma_tally2_int_t sweep, magma_tally2_int_t Vblksiz)
{
    ...
    magma_tally2_zlarfxsym(len,A(st,st),LDX,V(vpos),TAU(taupos));
    //conjtmp = MAGMA_tally2_Z_CNJG(*TAU(taupos));
    //lapackf77_zlarfy("L", &len, V(vpos), &IONE,  &(MAGMA_tally2_Z_CNJG(*TAU(taupos))), A(st,st), &LDX, WORK);
    magma_tally2_free_cpu(WORK);
}
#undef A
#undef V
