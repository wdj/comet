    ...
    magma_tally2_queue_t queue)
{
    ...
    cudaMemset( d_dinvA, 0, ((n+NB-1)/NB)*NB*NB * sizeof(magma_tally2FloatComplex) );
...
/**
    @see magma_tally2blas_ctrtri_diag_q
    @ingroup magma_tally2_cblas3
    ********************************************************************/
extern "C" void
magma_tally2blas_ctrtri_diag(
    ...
    magma_tally2FloatComplex_ptr d_dinvA)
{
    magma_tally2blas_ctrtri_diag_q( uplo, diag, n, dA, ldda, d_dinvA, magma_tally2_stream );
}
