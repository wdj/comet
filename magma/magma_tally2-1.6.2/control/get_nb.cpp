...
magma_tally2_int_t magma_tally2_get_zpotrf_right_nb( magma_tally2_int_t m )
{
    return 128;
}

magma_tally2_int_t magma_tally2_get_cpotrf_right_nb( magma_tally2_int_t m )
{
    return 128;
}

magma_tally2_int_t magma_tally2_get_dpotrf_right_nb( magma_tally2_int_t m )
{
    return 320;
}

magma_tally2_int_t magma_tally2_get_spotrf_right_nb( magma_tally2_int_t m )
{
    return 128;
}
