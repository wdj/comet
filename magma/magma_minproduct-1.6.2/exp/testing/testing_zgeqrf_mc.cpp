...
int main( magma_minproduct_int_t argc, char** argv) 
{
    ...
    magma_minproduct_int_t lwork = n2;
    ...
    for(i=0; i<10; i++){
      ...
      lapackf77_zlacpy( Magma_minproductUpperLowerStr, &M, &N, h_A2, &M, h_A3, &M );
     ...
     =================================================================== */
      ...
      start = get_current_time();
      magma_minproduct_zgeqrf_mc(context, &M, &N, h_A2, &M, tau, h_work2, &lwork, info);
      end = get_current_time();
