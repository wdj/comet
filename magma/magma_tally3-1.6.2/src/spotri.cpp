/*
    -- MAGMA_tally3 (version 1.6.1) --
       ...
       @generated from zpotri.cpp normal z -> s, Fri Jan 30 19:00:14 2015
    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally3_strtri( uplo, Magma_tally3NonUnit, n, A, lda, info );
    if ( *info == 0 ) {
        /* Form inv(U) * inv(U)**T or inv(L)**T * inv(L) */
        magma_tally3_slauum( uplo, n, A, lda, info );
    }
