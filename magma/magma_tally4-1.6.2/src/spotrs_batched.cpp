                  ...
                  magma_tally4_int_t batchCount, magma_tally4_queue_t queue)
{
   ...
   /* check allocation */
    ...
    if ( uplo == Magma_tally4Upper) {
        ...
        magma_tally4blas_strsm_outofplace_batched(Magma_tally4Left, Magma_tally4Upper, Magma_tally4ConjTrans, Magma_tally4NonUnit, 1,
                n, nrhs,
                c_one,
                dA_array,       ldda, // dA
                dB_array,      lddb, // dB
        ...
        magma_tally4blas_strsm_outofplace_batched(Magma_tally4Left, Magma_tally4Lower, Magma_tally4NoTrans, Magma_tally4NonUnit, 1,
                n, nrhs,
                c_one,
                dA_array,       ldda, // dA
                dB_array,      lddb, // dB
        ...
        magma_tally4blas_strsm_outofplace_batched(Magma_tally4Left, Magma_tally4Lower, Magma_tally4ConjTrans, Magma_tally4NonUnit, 1,
                n, nrhs,
                c_one,
                dA_array,       ldda, // dA
                dwork_array,        n, // dB 
