...
*/
void zsplit_diag_block(magma_tally2_int_t ib, magma_tally2DoubleComplex *a, magma_tally2_int_t lda, magma_tally2DoubleComplex *work)
{
    magma_tally2_int_t i, j, info;
    magma_tally2DoubleComplex *cola, *colw;
    ...
    lapackf77_ztrtri( Magma_tally2UpperStr, Magma_tally2NonUnitStr, &ib, work, &ib, &info);
}
    ...
    magma_tally2_int_t *info )
{
    ...
    magma_tally2DoubleComplex *work, *ut;
    ...
    *info = 0;
    ...
    ut = hwork+nb*(n);
    memset( ut, 0, nb*nb*sizeof(magma_tally2DoubleComplex));
    ...
    if ( (nb > 1) && (nb < k) ) {
        ...
        for (i = 0; i < k-nb; i += nb) {
            ...
            magma_tally2_zsetmatrix( rows, ib, work(i), ldwork, dA(i,i), ldda );

            if (i + ib < n) {
                /* Send the triangular factor T to the GPU */
                magma_tally2_zsetmatrix( ib, ib, hwork, ib, dT(i), nb );
                ...
                if (i+nb < k-nb) {
                    ...
                    magma_tally2_zsetmatrix( ib, ib, ut, ib, d_ref(i), ib );
                }
                old_i  = i;
                old_ib = ib;
            }
    ...
    if (i < k) {
        ib   = n-i;
        rows = m-i;
        magma_tally2_zgetmatrix( rows, ib, dA(i, i), ldda, work, rows );
        lhwork = lwork - rows*ib;
        lapackf77_zgeqrf(&rows, &ib, work, &rows, tau+i, work+ib*rows, &lhwork, info);
        
        magma_tally2_zsetmatrix( rows, ib, work, rows, dA(i, i), ldda );
    }
