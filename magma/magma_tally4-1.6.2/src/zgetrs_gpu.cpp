    ...
    magma_tally4_int_t *info)
{
    ...
    magma_tally4DoubleComplex *work = NULL;
    ...
    *info = 0;
    ...
    magma_tally4_zmalloc_cpu( &work, n * nrhs );
    if ( work == NULL ) {
    ...
    if (notran) {
        ...
        /* Solve A * X = B. */
        magma_tally4_zgetmatrix( n, nrhs, dB, lddb, work, n );
        lapackf77_zlaswp(&nrhs, work, &n, &i1, &i2, ipiv, &inc);
        magma_tally4_zsetmatrix( n, nrhs, work, n, dB, lddb );

        if ( nrhs == 1) {
            magma_tally4_ztrsv(Magma_tally4Lower, Magma_tally4NoTrans, Magma_tally4Unit,    n, dA, ldda, dB, 1 );
            magma_tally4_ztrsv(Magma_tally4Upper, Magma_tally4NoTrans, Magma_tally4NonUnit, n, dA, ldda, dB, 1 );
        } else {
            magma_tally4_ztrsm(Magma_tally4Left, Magma_tally4Lower, Magma_tally4NoTrans, Magma_tally4Unit,    n, nrhs, c_one, dA, ldda, dB, lddb );
        ...
        if ( nrhs == 1) {
            magma_tally4_ztrsv(Magma_tally4Upper, trans, Magma_tally4NonUnit, n, dA, ldda, dB, 1 );
            magma_tally4_ztrsv(Magma_tally4Lower, trans, Magma_tally4Unit,    n, dA, ldda, dB, 1 );
        } else {
            magma_tally4_ztrsm(Magma_tally4Left, Magma_tally4Upper, trans, Magma_tally4NonUnit, n, nrhs, c_one, dA, ldda, dB, lddb );
            magma_tally4_ztrsm(Magma_tally4Left, Magma_tally4Lower, trans, Magma_tally4Unit,    n, nrhs, c_one, dA, ldda, dB, lddb );
        }
