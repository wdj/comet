/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zlaqps.cpp normal z -> s, Fri Jan 30 19:00:16 2015
    ...
    while( k < nb && lsticc == 0 ) {
        ...
        *A(rk, k) = c_one;
        ...
        if (k > 0) {
            i__1 = m - rk;
            i__2 = k;
            z__1 = MAGMA_minproduct_S_NEGATE( tau[k] );
    ...
    *kb = k + 1;
    ...
    while( lsticc > 0 ) {
        ...
        if (lsticc <= nb)
            ...
            //vn1[lsticc] = magma_minproduct_snrm2(i__1, dA(rk + 1, lsticc), ione);
