...
static    float neg_one = MAGMA_minproduct_S_NEG_ONE;
...

{
    ...
    magma_minproductblas_sgemm_batched(Magma_minproductConjTrans, Magma_minproductNoTrans, k, n, m,
                             one, (const float**) dV_array, ldv,
                                    (const float**) dA_array, lda,
                             zero,  W_array, ldw, batchCount );
    ...
    // W2 = T^H * W        
    magma_minproductblas_sgemm_batched(Magma_minproductConjTrans, Magma_minproductNoTrans, k, n, k,
                             one, (const float**) dT_array, ldt,
                                    (const float**) W_array, ldw,
                             zero,  W2_array, ldw2, batchCount );
    ...
    // A = A - V * W2 
    magma_minproductblas_sgemm_batched(Magma_minproductNoTrans, Magma_minproductNoTrans, m, n, k,
                             neg_one, (const float**) dV_array, ldv,
                                    (const float**) W2_array, ldw2,
                             one,  dA_array, lda, batchCount );
