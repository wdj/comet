...
__global__ void
magma_minproduct_zlobpcg_maxpy_kernel( 
...
/**
    ...
    It replaces:
            magma_minproduct_zaxpy(m*n, c_one, Y, 1, X, 1);
    ...
    @param[in/out]
    Y           magma_minproductDoubleComplex_ptr 
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproduct_zlobpcg_maxpy_kernel<<< grid, threads, 0, queue >>>
