    ...
    magma_tally3_queue_t queue)
{
    ...
    magma_tally3blas_zapply_transpose_vector_kernel<<< grid, threads, 0, queue >>>(n/2, du, n, db, 0);
    magma_tally3blas_zapply_transpose_vector_kernel<<< grid, threads, 0, queue >>>(n/2, du, n+n/2, db, n/2);

    threads = block_length;
    grid = n/(2*block_length) + ((n%(2*block_length))!=0);
    magma_tally3blas_zapply_transpose_vector_kernel<<< grid, threads, 0, queue >>>(n, du, 0, db, 0);
}

/**
    @see magma_tally3blas_zprbt_mtv_q
    ********************************************************************/
extern "C" void
magma_tally3blas_zprbt_mtv(
    ...
    magma_tally3DoubleComplex *du, magma_tally3DoubleComplex *db)
{
    magma_tally3blas_zprbt_mtv_q(n, du, db, magma_tally3_stream);
}
    ...
    magma_tally3_queue_t queue)
{
    ...
    magma_tally3blas_zapply_vector_kernel<<< grid, threads, 0, queue >>>(n, dv, 0, db, 0);


    threads = block_length;
    grid = n/(4*block_length) + ((n%(4*block_length))!=0);

    magma_tally3blas_zapply_vector_kernel<<< grid, threads, 0, queue >>>(n/2, dv, n, db, 0);
    magma_tally3blas_zapply_vector_kernel<<< grid, threads, 0, queue >>>(n/2, dv, n+n/2, db, n/2);
}
...
magma_tally3blas_zprbt_mv(
    ...
    magma_tally3DoubleComplex *dv, magma_tally3DoubleComplex *db)
{
    magma_tally3blas_zprbt_mv_q(n, dv, db, magma_tally3_stream);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
    Purpose
    ...
    magma_tally3_queue_t queue)
{
    ...
    magma_tally3blas_zelementary_multiplication_kernel<<< grid, threads, 0, queue >>>(n/2, dA,            0, ldda, du,   0, dv,   0);
    magma_tally3blas_zelementary_multiplication_kernel<<< grid, threads, 0, queue >>>(n/2, dA,     ldda*n/2, ldda, du,   0, dv, n/2);
    magma_tally3blas_zelementary_multiplication_kernel<<< grid, threads, 0, queue >>>(n/2, dA,          n/2, ldda, du, n/2, dv,   0);
    magma_tally3blas_zelementary_multiplication_kernel<<< grid, threads, 0, queue >>>(n/2, dA, ldda*n/2+n/2, ldda, du, n/2, dv, n/2);

    dim3 threads2(block_height, block_width);
    dim3 grid2(n/(2*block_height) + ((n%(2*block_height))!=0), 
            n/(2*block_width)  + ((n%(2*block_width))!=0));
    magma_tally3blas_zelementary_multiplication_kernel<<< grid2, threads2, 0, queue >>>(n, dA, 0, ldda, du, -ldda, dv, -ldda);
}


/**
    @see magma_tally3blas_zprbt_q
    ********************************************************************/
extern "C" void 
magma_tally3blas_zprbt(
    ...
    magma_tally3DoubleComplex *du, magma_tally3DoubleComplex *dv)
{
    magma_tally3blas_zprbt_q(n, dA, ldda, du, dv, magma_tally3_stream);
}
...
magma_tally3blas_zaxpycp2(
    ...
    const magma_tally3DoubleComplex *b)
{
    magma_tally3blas_zaxpycp2_q( m, r, x, b, magma_tally3_stream );
}
