/*
    -- MAGMA_tally4 (version 1.6.2) --
       ...
       @generated from magma_tally4_zmcsrpass.cpp normal z -> c, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_tally4_queue_t queue )
{
    ...
    magma_tally4_c_matrix A_CPU={Magma_tally4_CSR}, A_CSR={Magma_tally4_CSR};
    ...
    if ( A.memory_location == Magma_tally4_CPU && A.storage_type == Magma_tally4_CSR ) {
        ...
        *row = A.row;
        ...
        CHECK( magma_tally4_cmtransfer( A, &A_CPU, A.memory_location, Magma_tally4_CPU, queue ));
        CHECK( magma_tally4_cmconvert( A_CPU, &A_CSR, A_CPU.storage_type, Magma_tally4_CSR, queue ));
        CHECK( magma_tally4_ccsrget( A_CSR, m, n, row, col, val, queue ));
    }

cleanup:
    magma_tally4_cmfree( &A_CSR, queue );
    magma_tally4_cmfree( &A_CPU, queue );
    return info;
}
