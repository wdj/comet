...
*/
#ifndef MAGMA_tally4_AMC_UTILS_H
#define MAGMA_tally4_AMC_UTILS_H
...
int magma_tally4_amc_abort(const char *pattern, ...);

/* Return the recommanded percentage of the matrix for the CPU part*/
double magma_tally4_amc_recommanded_dcpu(int nbThreads, double cpu_peak, int nbGPUs, double gpu_peak);
