    ...
    float **dC_array, magma_minproduct_int_t lddc, magma_minproduct_int_t batchCount, magma_minproduct_queue_t queue )
{
    ...
    if      ( transB == Magma_minproductTrans )
        ...
        magma_minproduct_getvector( min(2,batchCount), sizeof(float*), dA_array, 1, cpuAarray, 1);
        magma_minproduct_getvector( min(2,batchCount), sizeof(float*), dB_array, 1, cpuBarray, 1);
             ...
             sizeB >= CUBLAS_MAX_1DBUF_SIZE )
        {
            ...
            return;
            /*
            magma_minproduct_sgemm( transA, transB, m, n, k, alpha,
