    ...
    magma_minproduct_queue_t queue )
{
    ...
    // workspace
    magma_minproduct_s_matrix r={Magma_minproduct_CSR}, rr={Magma_minproduct_CSR}, p={Magma_minproduct_CSR}, v={Magma_minproduct_CSR}, s={Magma_minproduct_CSR}, t={Magma_minproduct_CSR};
    ...
    do
    {
        ...
        omega = magma_minproduct_sdot( dofs, t.dval, 1, s.dval, 1 )   // omega = <s,t>/<t,t>
                   / magma_minproduct_sdot( dofs, t.dval, 1, t.dval, 1 );

        magma_minproduct_saxpy( dofs, alpha, p.dval, 1 , x->dval, 1 );     // x=x+alpha*p
        magma_minproduct_saxpy( dofs, omega, s.dval, 1 , x->dval, 1 );     // x=x+omega*s
