...
int main( int argc, char** argv)
{
    ...
    double alpha = MAGMA_tally4_D_MAKE( 3.1415, 2.718 );
    ...
    //magma_tally4blas_dgeadd( -1,  N, alpha, d_A, ldda, d_B, ldda );
    //magma_tally4blas_dgeadd(  M, -1, alpha, d_A, ldda, d_B, ldda );
    //magma_tally4blas_dgeadd(  M,  N, alpha, d_A, M-1,  d_B, ldda );
    //magma_tally4blas_dgeadd(  M,  N, alpha, d_A, ldda, d_B, N-1  );
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally4blas_dgeadd( M, N, alpha, d_A, ldda, d_B, ldda );
