...
__global__ void
magma_tally2_cbajac_csr_ls_kernel(int localiters, int n, 
                            magma_tally2FloatComplex * valD, 
                            magma_tally2_index_t * rowD, 
                            magma_tally2_index_t * colD, 
                            magma_tally2FloatComplex * valR, 
    ...
    if(index<n){
        ...
        magma_tally2FloatComplex bl, tmp = zero, v = zero; 
        ...
        __shared__ magma_tally2FloatComplex local_x[ BLOCKSIZE ];
...
__global__ void
magma_tally2_cbajac_csr_kernel(    
    int n, 
    magma_tally2FloatComplex * valD, 
    magma_tally2_index_t * rowD, 
    magma_tally2_index_t * colD, 
    ...
    magma_tally2_queue_t queue )
{
    ...
    if ( R.nnz > 0 ) { 
        if ( localiters == 1 )
        magma_tally2_cbajac_csr_kernel<<< grid, block, 0, queue >>>
            ( D.num_rows, D.dval, D.drow, D.dcol, 
                            R.dval, R.drow, R.dcol, b.dval, x->dval );
        else
            magma_tally2_cbajac_csr_ls_kernel<<< grid, block, 0, queue >>>
