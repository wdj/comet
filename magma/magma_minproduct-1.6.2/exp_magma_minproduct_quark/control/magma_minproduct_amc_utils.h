...
*/
#ifndef MAGMA_minproduct_AMC_UTILS_H
#define MAGMA_minproduct_AMC_UTILS_H
...
int magma_minproduct_amc_abort(const char *pattern, ...);

/* Return the recommanded percentage of the matrix for the CPU part*/
double magma_minproduct_amc_recommanded_dcpu(int nbThreads, double cpu_peak, int nbGPUs, double gpu_peak);
