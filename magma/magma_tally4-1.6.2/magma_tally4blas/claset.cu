    ...
    magma_tally4FloatComplex *A, int lda )
{
    ...
    bool full = (iby + BLK_Y <= n && (ind >= iby + BLK_Y || ind + BLK_X <= iby || MAGMA_tally4_C_EQUAL( offdiag, diag )));
...
void claset_full_kernel(
    int m, int n,
    magma_tally4FloatComplex offdiag, magma_tally4FloatComplex diag,
    magma_tally4FloatComplex *dA, int ldda )
{
...
void claset_full_kernel_batched(
    int m, int n,
    magma_tally4FloatComplex offdiag, magma_tally4FloatComplex diag,
    magma_tally4FloatComplex **dAarray, int ldda )
{
...
/**
    ...
    ********************************************************************/
extern "C"
void magma_tally4blas_claset_q(
    ...
    magma_tally4_queue_t queue)
{
    ...
    if (uplo == Magma_tally4Lower) {
        ...
        if ( m == ldda &&
             MAGMA_tally4_C_EQUAL( offdiag, MAGMA_tally4_C_ZERO ) &&
             MAGMA_tally4_C_EQUAL( diag,    MAGMA_tally4_C_ZERO ) )
        {
            size_t size = m*n;
            cudaError_t err = cudaMemsetAsync( dA, 0, size*sizeof(magma_tally4FloatComplex), queue );
...
/**
    @see magma_tally4blas_claset_q
    @ingroup magma_tally4_caux2
    ********************************************************************/
extern "C"
void magma_tally4blas_claset(
    magma_tally4_uplo_t uplo, magma_tally4_int_t m, magma_tally4_int_t n,
    magma_tally4FloatComplex offdiag, magma_tally4FloatComplex diag,
    magma_tally4FloatComplex_ptr dA, magma_tally4_int_t ldda )
{
    magma_tally4blas_claset_q( uplo, m, n, offdiag, diag, dA, ldda, magma_tally4_stream );
}


////////////////////////////////////////////////////////////////////////////////////////
extern "C"
void magma_tally4blas_claset_batched(
    magma_tally4_uplo_t uplo, magma_tally4_int_t m, magma_tally4_int_t n,
    magma_tally4FloatComplex offdiag, magma_tally4FloatComplex diag,
