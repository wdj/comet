...
ztranspose_device(
    int m, int n,
    const magma_tally2DoubleComplex *A, int lda,
    magma_tally2DoubleComplex *AT,      int ldat)
{
    __shared__ magma_tally2DoubleComplex sA[NB][NX+1];
...
void ztranspose_kernel_batched(
    ...
    magma_tally2DoubleComplex **dAT_array,      int ldat)
{
...
/**
    @see magma_tally2blas_ztranspose_q
    @ingroup magma_tally2_zaux2
    ********************************************************************/
extern "C" void
magma_tally2blas_ztranspose(
    ...
    magma_tally2DoubleComplex_ptr       dAT, magma_tally2_int_t lddat )
{
    magma_tally2blas_ztranspose_q( m, n, dA, ldda, dAT, lddat, magma_tally2_stream );
}
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_tally2blas_ztranspose_batched_q(
    magma_tally2_int_t m, magma_tally2_int_t n,
    magma_tally2DoubleComplex **dA_array,  magma_tally2_int_t ldda,
    magma_tally2DoubleComplex **dAT_array, magma_tally2_int_t lddat, magma_tally2_int_t batchCount, magma_tally2_queue_t queue )
{
    magma_tally2_int_t info = 0;
    if ( m < 0 )
        info = -1;
...
/**
    @see magma_tally2blas_ztranspose_batched_q
    @ingroup magma_tally2_zaux2
    ********************************************************************/
extern "C" void
...
{
    magma_tally2blas_ztranspose_batched_q( m, n, dA_array, ldda, dAT_array, lddat, batchCount, magma_tally2_stream );
}
