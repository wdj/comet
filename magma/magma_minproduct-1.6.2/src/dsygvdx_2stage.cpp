...
/**
    ...
    @ingroup magma_minproduct_dsygv_driver
    ********************************************************************/
    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_dmalloc( &dA, n*ldda ) ||
        MAGMA_minproduct_SUCCESS != magma_minproduct_dmalloc( &dB, n*lddb )) {
        *info = MAGMA_minproduct_ERR_DEVICE_ALLOC;
        return *info;
    }

    /* Form a Cholesky factorization of B. */
    magma_minproduct_dsetmatrix( n, n, B, ldb, dB, lddb );
    magma_minproduct_dsetmatrix_async( n, n,
                            A,  lda,
                            dA, ldda, stream );
    ...
    magma_minproduct_dpotrf_gpu(uplo, n, dB, lddb, info);
    if (*info != 0) {
        *info = n + *info;
        return *info;
    }
    ...
    magma_minproduct_dgetmatrix_async( n, n,
                            dB, lddb,
                            B,  ldb, stream );
    ...
    magma_minproduct_dsygst_gpu(itype, uplo, n, dA, ldda, dB, lddb, info);
    ...
    magma_minproduct_dsyevdx_2stage(jobz, range, uplo, n, A, lda, vl, vu, il, iu, m, w, work, lwork, iwork, liwork, info);
    ...
    if (wantz && *info == 0) {
        ...
        magma_minproduct_dsetmatrix( n, *m, A, lda, dA, ldda );
        magma_minproduct_dsetmatrix( n,  n, B, ldb, dB, lddb );
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_minproduct_dtrsm(Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_minproduct_dtrmm(Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }

        magma_minproduct_dgetmatrix( n, *m, dA, ldda, A, lda );
