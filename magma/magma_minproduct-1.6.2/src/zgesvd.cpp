...
/**
    ...
    jobvt   magma_minproduct_vec_t
      ...
      -     = Magma_minproductAllVec:        all N rows of V**H are returned in the array VT;
      -     = Magma_minproductSomeVec:       the first min(m,n) rows of V**H (the right singular
                                  vectors) are returned in the array VT;
      -     = Magma_minproductOverwriteVec:  the first min(m,n) rows of V**H (the right singular
                                  vectors) are overwritten on the array A;
      -     = Magma_minproductNoVec:         no rows of V**H (no right singular vectors) are
                                  computed.
    \n
    ...
    U       COMPLEX_16 array, dimension (LDU,UCOL)
      ...
      -     If JOBU = Magma_minproductAllVec, U contains the M-by-M unitary matrix U;
    ...
    VT      COMPLEX_16 array, dimension (LDVT,N)
      -     If JOBVT = Magma_minproductAllVec, VT contains the N-by-N unitary matrix
            V**H;
    ...
    magma_minproduct_int_t *info )
{
    ...
    double dummy[1], eps;
    magma_minproductDoubleComplex cdummy[1];
    ...
    *info = 0;
    ...
    maxwrk = (magma_minproduct_int_t) MAGMA_minproduct_Z_REAL( work[0] );
    if (*info == 0) {
        // Return required workspace in WORK[0]
        nb = magma_minproduct_get_zgesvd_nb(n);
        minwrk = (m + n)*nb + 2*minmn;
        
        // multiply by 1+eps (in Double!) to ensure length gets rounded up,
        // if it cannot be exactly represented in floating point.
        real_Double_t one_eps = 1. + lapackf77_dlamch("Epsilon");
        work[0] = MAGMA_minproduct_Z_MAKE( minwrk * one_eps, 0 );
    ...
    smlnum = magma_minproduct_dsqrt(lapackf77_dlamch("S")) / eps;
    bignum = 1. / smlnum;
    ...
    if (m >= n) {
        ...
        if (m >= mnthr) {
            if (want_un) {
                ...
                lwork2 = lwork - iwork + 1;
                //printf( "path 1\n" );
                magma_minproduct_zgebrd(n, n, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                ...
                if (lwork >= n*n + wrkbrd) {
                    ...
                    magma_minproduct_zungqr2(m, n, n, A, lda, &work[itau], &ierr);
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 2-a\n" );
                    magma_minproduct_zgebrd(n, n, &work[ir], ldwrkr, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                    ...
                    for (i = 1; (ldwrku < 0 ? i >= m : i <= m); i += ldwrku) {
                        ...
                        blasf77_zgemm("N", "N", &chunk, &n, &n, &c_one, A(i-1,0), &lda, &work[ir], &ldwrkr, &c_zero, &work[iu], &ldwrku);
                        lapackf77_zlacpy("F", &chunk, &n, &work[iu], &ldwrku, A(i-1,0), &lda);
                    }
                }
                else {
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 2-b\n" );
                    magma_minproduct_zgebrd(m, n, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                ...
                if (lwork >= n*n + wrkbrd) {
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 3-a\n" );
                    magma_minproduct_zgebrd(n, n, VT, ldvt, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                ...
                if (want_vn) {
                    ...
                    if (lwork >= n*n + wrkbrd) {
                        ...
                        magma_minproduct_zungqr2(m, n, n, U, ldu, &work[itau], &ierr);
                    ...
                    if (lwork >= 2*n*n + wrkbrd) {
                        ...
                        lwork2 = lwork - iwork + 1;
                        //printf( "path 5-a\n" );
                        magma_minproduct_zgebrd(n, n, &work[iu], ldwrku, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                ...
                if (want_vn) {
                    ...
                    if (lwork >= n*n + max(n + m, wrkbrd)) {
                        ...
                        magma_minproduct_zungqr2(m, m, n, U, ldu, &work[itau], &ierr);
        ...
        if (n >= mnthr) {
            if (want_vn) {
                ...
                lwork2 = lwork - iwork + 1;
                //printf( "path 1t\n" );
                magma_minproduct_zgebrd(m, m, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                ...
                if (lwork >= m*m + wrkbrd) {
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 2t-a\n" );
                    magma_minproduct_zgebrd(m, m, &work[ir], ldwrkr, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                    ...
                    for (i = 1; (chunk < 0 ? i >= n : i <= n); i += chunk) {
                        blk = min(n - i + 1, chunk);
                        blasf77_zgemm("N", "N", &m, &blk, &m, &c_one, &work[ir], &ldwrkr, A(0,i-1), &lda, &c_zero, &work[iu], &ldwrku);
                        lapackf77_zlacpy("F", &m, &blk, &work[iu], &ldwrku, A(0,i-1), &lda);
                    }
                }
                else {
                    // Insufficient workspace for a fast algorithm
                ...
                if (lwork >= m*m + wrkbrd) {
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 3t-a\n" );
                    magma_minproduct_zgebrd(m, m, U, ldu, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                ...
                if (want_un) {
                    ...
                    if (lwork >= 2*m*m + wrkbrd) {
                        ...
                        lwork2 = lwork - iwork + 1;
                        //printf( "path 5t-a\n" );
                        magma_minproduct_zgebrd(m, m, &work[iu], ldwrku, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
