    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally2_zpotrf_m( ngpu, uplo, n, B, ldb, info );
    if (*info != 0) {
        *info = n + *info;
        return *info;
    }
    ...
    magma_tally2_zhegst_m( ngpu, itype, uplo, n, A, lda, B, ldb, info );

    timer_stop( time );
    timer_printf( "time zhegst_m = %6.2f\n", time );
    timer_start( time );

    magma_tally2_zheevdx_2stage_m( ngpu, jobz, range, uplo, n, A, lda, vl, vu, il, iu, mout, w, work, lwork, rwork, lrwork, iwork, liwork, info );
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally2_ztrsm_m( ngpu, Magma_tally2Left, uplo, trans, Magma_tally2NonUnit, n, *mout, c_one, B, ldb, A, lda );
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            #endif
            magma_tally2DoubleComplex *dA=NULL, *dB=NULL;
            ...
            magma_tally2_ztrmm( Magma_tally2Left, uplo, trans, Magma_tally2NonUnit,
                         n, n, c_one, dB, lddb, dA, ldda );
            magma_tally2_zgetmatrix( n, n, dA, ldda, A, lda );

            //magma_tally2_ztrmm_m(ngpu, Magma_tally2Left, uplo, trans, Magma_tally2NonUnit, n, *mout, c_one, B, ldb, A, lda);
