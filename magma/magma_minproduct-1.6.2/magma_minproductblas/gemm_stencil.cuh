...
///////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  #define TRANS_B
  #define batched_herk_kernel_name_(p)  magma_minproductblas_ ## p ## _herk_kernel_fermi_nt_batched
  ...
  #define TRANS_B
  #define CONJ_B
  #define batched_herk_kernel_name_(p)  magma_minproductblas_ ## p ## _herk_kernel_fermi_nc_batched
  ...
  #define TRANS_A
  #define batched_herk_kernel_name_(p)  magma_minproductblas_ ## p ## _herk_kernel_fermi_tn_batched
  ...
  #define TRANS_A
  #define CONJ_A
  #define batched_herk_kernel_name_(p)  magma_minproductblas_ ## p ## _herk_kernel_fermi_cn_batched
