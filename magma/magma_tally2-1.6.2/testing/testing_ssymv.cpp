...
int main(int argc, char **argv)
{
    ...
    float          magma_tally2_error, atomics_error, cublas_error, work[1];
    ...
    float *A, *X, *Y, *Yatomics, *Ycublas, *Ymagma_tally2;
    magma_tally2Float_ptr dA, dX, dY, dwork;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( Ymagma_tally2,   float, sizeY );
            ...
            magma_tally2blas_slaset( Magma_tally2Full, ldwork, 1, MAGMA_tally2_S_NAN, MAGMA_tally2_S_NAN, dwork, ldwork );
            magma_tally2blas_slaset( Magma_tally2Full, ldda,   N, MAGMA_tally2_S_NAN, MAGMA_tally2_S_NAN, dA,    ldda   );
            
            /* Initialize the matrix */
            lapackf77_slarnv( &ione, ISEED, &sizeA, A );
            magma_tally2_smake_symmetric( N, A, lda );
            ...
            if ( opts.uplo == Magma_tally2Upper ) {
                lapackf77_slaset( "Lower", &N1, &N1, &MAGMA_tally2_S_NAN, &MAGMA_tally2_S_NAN, &A[1], &lda );
            }
            else {
                lapackf77_slaset( "Upper", &N1, &N1, &MAGMA_tally2_S_NAN, &MAGMA_tally2_S_NAN, &A[lda], &lda );
            }
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally2_ssetmatrix( N, N, A, lda, dA, ldda );
            magma_tally2_ssetvector( N, X, incx, dX, incx );
            magma_tally2_ssetvector( N, Y, incy, dY, incy );
            
            cublas_time = magma_tally2_sync_wtime( 0 );
            cublasSsymv( opts.handle, cublas_uplo_const_tally2(opts.uplo),
                         N, &alpha, dA, ldda, dX, incx, &beta, dY, incy );
            cublas_time = magma_tally2_sync_wtime( 0 ) - cublas_time;
            cublas_perf = gflops / cublas_time;
            
            magma_tally2_sgetvector( N, dY, incy, Ycublas, incy );
            ...
            magma_tally2_sgetvector( N, dY, incy, Yatomics, incy );
            ...
            if ( opts.version == 1 ) {
                magma_tally2blas_ssymv_work( opts.uplo, N, alpha, dA, ldda, dX, incx, beta, dY, incy, dwork, ldwork, opts.queue );
            }
            else {
                // non-work interface (has added overhead)
                magma_tally2blas_ssymv( opts.uplo, N, alpha, dA, ldda, dX, incx, beta, dY, incy );
            }
            magma_tally2_time = magma_tally2_sync_wtime( 0 ) - magma_tally2_time;
            magma_tally2_perf = gflops / magma_tally2_time;
            
            magma_tally2_sgetvector( N, dY, incy, Ymagma_tally2, incy );
            
            /* =====================================================================
               Performs operation using CPU BLAS
               =================================================================== */
            cpu_time = magma_tally2_wtime();
            blasf77_ssymv( lapack_uplo_const_tally2(opts.uplo), &N, &alpha, A, &lda, X, &incx, &beta, Y, &incy );
            ...
            /* =====================================================================
               Check the result
               =================================================================== */
            blasf77_saxpy( &N, &c_neg_one, Y, &incy, Ymagma_tally2, &incy );
            magma_tally2_error = lapackf77_slange( "M", &N, &ione, Ymagma_tally2, &N, work ) / N;
