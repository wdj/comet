    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if ( uplo == Magma_minproductUpper ) {
        if ( nrhs == 1) {
            magma_minproduct_ctrsv(Magma_minproductUpper, Magma_minproductConjTrans, Magma_minproductNonUnit, n, dA, ldda, dB, 1 );
            magma_minproduct_ctrsv(Magma_minproductUpper, Magma_minproductNoTrans,   Magma_minproductNonUnit, n, dA, ldda, dB, 1 );
        } else {
            magma_minproduct_ctrsm(Magma_minproductLeft, Magma_minproductUpper, Magma_minproductConjTrans, Magma_minproductNonUnit, n, nrhs, c_one, dA, ldda, dB, lddb);
        ...
        if ( nrhs == 1) {
            magma_minproduct_ctrsv(Magma_minproductLower, Magma_minproductNoTrans,   Magma_minproductNonUnit, n, dA, ldda, dB, 1 );
            magma_minproduct_ctrsv(Magma_minproductLower, Magma_minproductConjTrans, Magma_minproductNonUnit, n, dA, ldda, dB, 1 );
        } else {
            magma_minproduct_ctrsm(Magma_minproductLeft, Magma_minproductLower, Magma_minproductNoTrans,   Magma_minproductNonUnit, n, nrhs, c_one, dA, ldda, dB, lddb);
            magma_minproduct_ctrsm(Magma_minproductLeft, Magma_minproductLower, Magma_minproductConjTrans, Magma_minproductNonUnit, n, nrhs, c_one, dA, ldda, dB, lddb);
        }
    }
