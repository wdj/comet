...
/**
    ...
    dA      REAL array on the GPU, dimension (LDDA,N)
            ...
            On exit, if UPLO = Magma_tally2Upper, the upper triangle of dA is
            overwritten with the upper triangle of the product U * U';
            if UPLO = Magma_tally2Lower, the lower triangle of dA is overwritten with
...
#define dA(i, j) (dA + (j)*ldda + (i))
    ...
    *info = 0;
    ...
    if (MAGMA_tally2_SUCCESS != magma_tally2_cmalloc_pinned( &work, nb*nb )) {
    ...
    if (nb <= 1 || nb >= n) {
        magma_tally2_cgetmatrix( n, n, dA, ldda, work, n );
        lapackf77_clauum(uplo_, &n, work, &n, info);
        magma_tally2_csetmatrix( n, n, work, n, dA, ldda );
    }
    else {
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally2_ctrmm( Magma_tally2Right, Magma_tally2Upper,
                             Magma_tally2ConjTrans, Magma_tally2NonUnit, i, ib,
                             c_one, dA(i,i), ldda, dA(0, i),ldda);

                magma_tally2_cgetmatrix( ib, ib,
                                  dA(i, i), ldda,
                                  work,     ib );

                lapackf77_clauum(Magma_tally2UpperStr, &ib, work, &ib, info);

                magma_tally2_csetmatrix( ib, ib,
                                  work,     ib,
                                  dA(i, i), ldda );
                ...
                if (i+ib < n) {
                    ...
                    magma_tally2_cherk( Magma_tally2Upper, Magma_tally2NoTrans, ib,(n-i-ib),
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally2_ctrmm( Magma_tally2Left, Magma_tally2Lower,
                ...
                lapackf77_clauum(Magma_tally2LowerStr, &ib, work, &ib, info);
                ...
                if (i+ib < n) {
                    magma_tally2_cgemm( Magma_tally2ConjTrans, Magma_tally2NoTrans,
                                 ...
                                 dA(i,0), ldda);
                    magma_tally2_cherk( Magma_tally2Lower, Magma_tally2ConjTrans, ib, (n-i-ib),
