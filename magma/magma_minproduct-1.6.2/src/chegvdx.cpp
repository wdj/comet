    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    timer_start( time );
    magma_minproduct_cheevdx_gpu( jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, mout, w, A, lda,
    ...
    if (wantz && *info == 0) {
        ...
        if (dB == NULL) {
            if (MAGMA_minproduct_SUCCESS != magma_minproduct_cmalloc( &dB, n*lddb ) ) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_minproduct_ctrsm( Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit,
        ...
        magma_minproduct_cgetmatrix( n, *mout, dA, ldda, A, lda );
