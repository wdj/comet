...
/**
    ...
    ldda    INTEGER
            ...
            LDDA >= max(1,M) if SIDE = Magma_tally3Left;
            LDDA >= max(1,N) if SIDE = Magma_tally3Right.
    ...
    magma_tally3_int_t *info)
{
    ...
    magma_tally3_zmalloc( &dwork, 2*(m + 64)*64 );

    magma_tally3DoubleComplex c_zero = MAGMA_tally3_Z_ZERO;
    magma_tally3DoubleComplex c_one  = MAGMA_tally3_Z_ONE;
    
    magma_tally3_int_t i, i__4;
    magma_tally3DoubleComplex T[2*4160]        /* was [65][64] */;
    magma_tally3_int_t i1, i2, step, ib, nb, mi, ni, nq, nw;
    ...
    *info  = 0;
    ...
    magma_tally3blas_zlaset_band( Magma_tally3Lower, k, k, nb, c_zero, c_one, dA, ldda );
    ...
    for (i = i1; (step < 0 ? i >= i2 : i <= i2); i += step) {
        ...
        magma_tally3_zsetmatrix( ib, ib, T, ib, dwork+i__4*ib, ib );
