    ...
    magma_tally4_int_t *info )
{
    ...
    *info = 0;
    ...
    if ( *info == 0 ) {
        ...
        magma_tally4_zpotrs_gpu( uplo, n, nrhs, dA, ldda, dB, lddb, info );
...
CPU_INTERFACE:
    ...
    magma_tally4_zpotrf( uplo, n, A, lda, info );
    if ( *info == 0 ) {
        lapackf77_zpotrs( lapack_uplo_const_tally4(uplo), &n, &nrhs, A, &lda, B, &ldb, info );
    }
