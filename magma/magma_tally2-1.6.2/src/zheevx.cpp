...
magma_tally2_zheevx(
    ...
    magma_tally2DoubleComplex *A, magma_tally2_int_t lda, double vl, double vu,
    magma_tally2_int_t il, magma_tally2_int_t iu, double abstol, magma_tally2_int_t *m,
    double *w, magma_tally2DoubleComplex *Z, magma_tally2_int_t ldz, magma_tally2DoubleComplex *work, magma_tally2_int_t lwork,
    ...
    magma_tally2_int_t *info)
{
    ...
    *m = 0;
    ...
    magma_tally2_zhetrd(uplo, n, A, lda, &rwork[indd], &rwork[inde], &work[indtau], &work[indwrk], llwork, &iinfo);
    ...
    if (*m == 0) {
        *info = 0;
        ...
        if (wantz) {
            ...
            magma_tally2_zunmtr(Magma_tally2Left, uplo, Magma_tally2NoTrans, n, *m, A, lda, &work[indtau],
