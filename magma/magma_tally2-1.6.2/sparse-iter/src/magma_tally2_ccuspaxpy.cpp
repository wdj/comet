/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zcuspaxpy.cpp normal z -> c, Sun May  3 11:22:59 2015
       @author Hartwig Anzt
...
magma_tally2_ccuspaxpy(
    magma_tally2FloatComplex *alpha, magma_tally2_c_matrix A,
    magma_tally2FloatComplex *beta, magma_tally2_c_matrix B,
    ...
    magma_tally2_queue_t queue )
{
    ...
    if (    A.memory_location == Magma_tally2_DEV
        ...
        CHECK( magma_tally2_cmalloc( &C.dval, C.nnz ));
        ...
        CHECK( magma_tally2_cmtransfer( C, AB, Magma_tally2_DEV, Magma_tally2_DEV, queue ));
    }
    else {
