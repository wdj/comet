   ...
   /* check allocation */
    ...
    if (uplo == Magma_tally2Upper) {
        ...
        for(j = 0; j < n; j+=nb) {
            ...
            #if 0
            arginfo = magma_tally2_spotrf_panel_batched(
                               uplo, n-j, ib,
                               dA_displ, ldda,
            ...
            #else
            //arginfo = magma_tally2_spotrf_rectile_batched(
            arginfo = magma_tally2_spotrf_recpanel_batched(
                               uplo, n-j, ib, 32,
                               dA_displ, ldda,
                               dwork_array, dwork_msize,
                               dinvA_array, invA_msize,
            ...
            if( (n-j-ib) > 0){
                ...
                { 
                    ...
                    for(k=0; k<batchCount; k++)
                    {
                        ...
                        magma_tally2_ssyrk(Magma_tally2Lower, Magma_tally2NoTrans, n-j-ib, ib, 
                            d_alpha, 
                ...
                else
                {
                    ...
                    //-------------------------------------------
                    magma_tally2_sdisplace_pointers(dA_displ, dA_array, ldda, j+ib, j, batchCount, queue);
                    magma_tally2_sdisplace_pointers(dW1_displ, dA_array, ldda, j+ib, j+ib, batchCount, queue);
                    magma_tally2blas_ssyrk_batched(uplo, Magma_tally2NoTrans, n-j-ib, ib,
