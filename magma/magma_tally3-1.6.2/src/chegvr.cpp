    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally3_cheevr_gpu(jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, abstol,
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally3_ctrsm(Magma_tally3Left, uplo, trans, Magma_tally3NonUnit, n, *m, c_one,
                          dB, lddb, dZ, lddz);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally3_ctrmm(Magma_tally3Left, uplo, trans, Magma_tally3NonUnit, n, *m, c_one,
                          dB, lddb, dZ, lddz);
        }
