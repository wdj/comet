...
/**
    ...
    @ingroup magma_minproduct_dposv_driver
    ********************************************************************/
    ...
    magma_minproduct_int_t *info)
{
    ...
    magma_minproduct_int_t     i, j, iiter, lddsa, lddsx, lddr;
    ...
    *info = 0;
    ...
    Anrm = magma_minproductblas_dlansy(Magma_minproductInfNorm, uplo, n, dA, ldda, (double*)dworkd );
    cte  = Anrm * eps * pow((double)n, 0.5) * BWDMAX;

    /*
     * Convert to single precision
     */
    magma_minproductblas_dlag2s( n, nrhs, dB, lddb, dSX, lddsx, info );
    if (*info != 0) {
        *iter = -2;
        goto FALLBACK;
    }

    magma_minproductblas_dlat2s( uplo, n, dA, ldda, dSA, lddsa, info );
    if (*info != 0) {
        *iter = -2;
        goto FALLBACK;
    }
    ...
    magma_minproduct_spotrf_gpu( uplo, n, dSA, lddsa, info );
    if (*info != 0) {
        *iter = -3;
        goto FALLBACK;
    }
    ...
    magma_minproduct_spotrs_gpu( uplo, n, nrhs, dSA, lddsa, dSX, lddsx, info );
    ...
    if ( nrhs == 1 ) {
        magma_minproduct_dsymv( uplo, n,
                     c_neg_one, dA, ldda,
                                dX, 1,
                     c_one,     dR, 1 );
    }
    else {
        magma_minproduct_dsymm( Magma_minproductLeft, uplo, n, nrhs,
                     c_neg_one, dA, ldda,
                                dX, lddx,
                     c_one,     dR, lddr );
    }
...
REFINEMENT:
    for( iiter=1; iiter < ITERMAX; ) {
        *info = 0;
        ...
        magma_minproductblas_dlag2s( n, nrhs, dR, lddr, dSX, lddsx, info );
        if (*info != 0) {
            *iter = -2;
            goto FALLBACK;
        }
...
FALLBACK:
    ...
    magma_minproduct_dpotrf_gpu( uplo, n, dA, ldda, info );
    if (*info == 0) {
        magma_minproductblas_dlacpy( Magma_minproductUpperLower, n, nrhs, dB, lddb, dX, lddx );
        magma_minproduct_dpotrs_gpu( uplo, n, nrhs, dA, ldda, dX, lddx, info );
    }
