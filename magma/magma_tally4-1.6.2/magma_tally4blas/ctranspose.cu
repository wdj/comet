...
ctranspose_device(
    int m, int n,
    const magma_tally4FloatComplex *A, int lda,
    magma_tally4FloatComplex *AT,      int ldat)
{
    __shared__ magma_tally4FloatComplex sA[NB][NX+1];
...
void ctranspose_kernel_batched(
    ...
    magma_tally4FloatComplex **dAT_array,      int ldat)
{
...
/**
    @see magma_tally4blas_ctranspose_q
    @ingroup magma_tally4_caux2
    ********************************************************************/
extern "C" void
magma_tally4blas_ctranspose(
    ...
    magma_tally4FloatComplex_ptr       dAT, magma_tally4_int_t lddat )
{
    magma_tally4blas_ctranspose_q( m, n, dA, ldda, dAT, lddat, magma_tally4_stream );
}
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_tally4blas_ctranspose_batched_q(
    magma_tally4_int_t m, magma_tally4_int_t n,
    magma_tally4FloatComplex **dA_array,  magma_tally4_int_t ldda,
    magma_tally4FloatComplex **dAT_array, magma_tally4_int_t lddat, magma_tally4_int_t batchCount, magma_tally4_queue_t queue )
{
    magma_tally4_int_t info = 0;
    if ( m < 0 )
        info = -1;
...
/**
    @see magma_tally4blas_ctranspose_batched_q
    @ingroup magma_tally4_caux2
    ********************************************************************/
extern "C" void
...
{
    magma_tally4blas_ctranspose_batched_q( m, n, dA_array, ldda, dAT_array, lddat, batchCount, magma_tally4_stream );
}
