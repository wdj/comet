    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally4FloatComplex *dspace[Magma_tally4MaxGPUs];
    magma_tally4FloatComplex *dwork[Magma_tally4MaxGPUs], *dworkbis[Magma_tally4MaxGPUs];
    magma_tally4FloatComplex *dvall[Magma_tally4MaxGPUs], *dv[Magma_tally4MaxGPUs], *dw[Magma_tally4MaxGPUs];
    magma_tally4FloatComplex *workngpu[Magma_tally4MaxGPUs+1];
    ...
    magma_tally4_int_t dwrk2siz    = ldda*nb*(ngpu+1);
    ...
    for( magma_tally4_int_t dev = 0; dev < ngpu; ++dev ) {
        ...
        magma_tally4_cmalloc( &dspace[dev], devworksiz );
        magma_tally4_cmalloc_pinned ( &workngpu[dev], worksiz);
    ...
    magma_tally4_cmalloc_pinned ( &workngpu[ngpu], worksiz);
    magma_tally4FloatComplex *worktest = NULL;
    //magma_tally4_cmalloc_cpu( &worktest, n*nb ); // not used
    // ======================
