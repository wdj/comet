...
/**
    @see magma_minproductblas_dtranspose_q
    @ingroup magma_minproduct_daux2
    ********************************************************************/
extern "C" void
magma_minproductblas_dtranspose(
    ...
    magma_minproductDouble_ptr       dAT, magma_minproduct_int_t lddat )
{
    magma_minproductblas_dtranspose_q( m, n, dA, ldda, dAT, lddat, magma_minproduct_stream );
}
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_minproductblas_dtranspose_batched_q(
    magma_minproduct_int_t m, magma_minproduct_int_t n,
    double **dA_array,  magma_minproduct_int_t ldda,
    double **dAT_array, magma_minproduct_int_t lddat, magma_minproduct_int_t batchCount, magma_minproduct_queue_t queue )
{
    magma_minproduct_int_t info = 0;
    if ( m < 0 )
        info = -1;
...
/**
    @see magma_minproductblas_dtranspose_batched_q
    @ingroup magma_minproduct_daux2
    ********************************************************************/
extern "C" void
...
{
    magma_minproductblas_dtranspose_batched_q( m, n, dA_array, ldda, dAT_array, lddat, batchCount, magma_minproduct_stream );
}
