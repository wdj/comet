       ...
       
{
    ...
    magma_minproductFloatComplex **dinvdiagA_array = NULL;
    ...
    magma_minproductFloatComplex* dinvdiagA;
    magma_minproductFloatComplex* dwork;// dinvdiagA and dwork are workspace in ctrsm
    ...
    magma_minproduct_cmalloc( &dinvdiagA, invdiagA_msize * batchCount);
    ...
    magma_minproductblas_claset_q(Magma_minproductFull, invdiagA_msize, batchCount, MAGMA_minproduct_C_ZERO, MAGMA_minproduct_C_ZERO, dinvdiagA, invdiagA_msize, queue);
    ...
    magma_minproductblas_claset_batched(Magma_minproductUpperLower, n, n, MAGMA_minproduct_C_ZERO, MAGMA_minproduct_C_ONE, dinvA_array, lddia, batchCount, queue);
    ...
    for(j = 0; j < n; j+=nb) {
        ...
        // solve dwork = L^-1 * I
        magma_minproductblas_claset_batched(Magma_minproductUpperLower, j, ib, MAGMA_minproduct_C_ZERO, MAGMA_minproduct_C_ZERO, dwork_array, n, batchCount, queue);
        magma_minproduct_cdisplace_pointers(dW5_displ, dwork_array, n, j, 0, batchCount, queue);
        magma_minproduct_cdisplace_pointers(dW0_displ, dinvA_array, lddia, j, j, batchCount, queue);
        ...
        magma_minproduct_cdisplace_pointers(dW5_displ, dwork_array, n, 0, 0, batchCount, queue);
        magma_minproduct_cdisplace_pointers(dW0_displ, dinvA_array, lddia, 0, j, batchCount, queue);
        magma_minproduct_cdisplace_pointers(dA_displ, dA_array, ldda, 0, 0, batchCount, queue);
        magma_minproductblas_ctrsm_outofplace_batched(Magma_minproductLeft, Magma_minproductUpper, Magma_minproductNoTrans, Magma_minproductNonUnit, 1,
                n, ib,
                MAGMA_minproduct_C_ONE,
                dA_displ,       ldda, // dA
                dW5_displ,        n, // dB 
    ...
    magma_minproduct_claswp_columnserial_batched( n, dinvA_array, lddia, max(1,n-1), 1, dipiv_array, batchCount, queue);
