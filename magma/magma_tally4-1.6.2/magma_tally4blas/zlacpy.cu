...
void zlacpy_full_device(
    int m, int n,
    const magma_tally4DoubleComplex *dA, int ldda,
    magma_tally4DoubleComplex       *dB, int lddb )
{
...
void zlacpy_full_kernel_batched(
    int m, int n,
    magma_tally4DoubleComplex const * const *dAarray, int ldda,
...
magma_tally4blas_zlacpy(
    ...
    magma_tally4DoubleComplex_ptr       dB, magma_tally4_int_t lddb )
{
    magma_tally4blas_zlacpy_q( uplo, m, n, dA, ldda, dB, lddb, magma_tally4_stream );
}
