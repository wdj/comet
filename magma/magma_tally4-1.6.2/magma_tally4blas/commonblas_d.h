...
// Tesla GEMM kernels
#define MAGMA_tally4BLAS_DGEMM( name ) \
void magma_tally4blas_dgemm_##name( \
...
MAGMA_tally4BLAS_DGEMM( a_0  );
MAGMA_tally4BLAS_DGEMM( ab_0 );
MAGMA_tally4BLAS_DGEMM( N_N_64_16_16_16_4_special );
MAGMA_tally4BLAS_DGEMM( N_N_64_16_16_16_4         );
MAGMA_tally4BLAS_DGEMM( N_T_64_16_4_16_4          );
MAGMA_tally4BLAS_DGEMM( T_N_32_32_8_8_8           );
MAGMA_tally4BLAS_DGEMM( T_T_64_16_16_16_4_special );
MAGMA_tally4BLAS_DGEMM( T_T_64_16_16_16_4         );
                   
void magma_tally4blas_dgemm_tesla(
...
void magma_tally4blas_dgemv_tesla(
...
__global__ void
magma_tally4_dgemv_kernel3(int m, const double * __restrict__ V, int ldv,
                    double *c, double *dwork,
                    double *tau);

__global__ void
magma_tally4_dtrmv_tkernel(double *T, int ldt, double *v,
                                    double *y);

__global__ void
magma_tally4_dtrmv_kernel2(const double *T, int ldt,
