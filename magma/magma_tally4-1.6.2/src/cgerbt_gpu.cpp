/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from zgerbt_gpu.cpp normal z -> c, Fri Jan 30 19:00:14 2015
       @author Adrien REMY
*/
        ...
        magma_tally4FloatComplex* u, magma_tally4FloatComplex* v)
{
    ...
    for (idx=0; idx<n; idx++){
        ...
        u[idx] = MAGMA_tally4_C_MAKE(u1,u1);

        v[idx] = MAGMA_tally4_C_MAKE(v1,v1);
    }
}
    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally4FloatComplex *du, *dv;

    /* Allocate memory for the buterfly matrices */
    if (MAGMA_tally4_SUCCESS != magma_tally4_cmalloc( &du, 2*n )) {
    ...
    magma_tally4_csetvector( 2*n, U, 1, du, 1);
    magma_tally4_csetvector( 2*n, V, 1, dv, 1);

    /* Perform Partial Random Butterfly Transformation on the GPU*/
    magma_tally4blas_cprbt(n, dA, ldda, du, dv);

    /* Compute U^T.b on the GPU*/
    for(int i= 0; i < nrhs; i++)
        magma_tally4blas_cprbt_mtv(n, du, dB+(i*lddb));
