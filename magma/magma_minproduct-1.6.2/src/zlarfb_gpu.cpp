    ...
    magma_minproductDoubleComplex_ptr dwork,       magma_minproduct_int_t ldwork )
{
    ...
    if ( side == Magma_minproductLeft ) {
        ...
        // W = W T^H = C^H V T^H
        magma_minproduct_ztrmm( Magma_minproductRight, uplo, transt, Magma_minproductNonUnit,
                     n, k,
                     c_one, dT(0,0),  lddt,
                            dwork(0), ldwork);

        // C = C - V W^H = C - V T V^H C = (I - V T V^H) C = H C
        magma_minproduct_zgemm( notransV, Magma_minproduct_ConjTrans,
                     m, n, k,
        ...
        // W = W T = C V T
        magma_minproduct_ztrmm( Magma_minproductRight, uplo, trans, Magma_minproductNonUnit,
                     m, k,
                     c_one, dT(0,0),  lddt,
                            dwork(0), ldwork);
