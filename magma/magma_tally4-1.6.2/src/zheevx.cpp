...
magma_tally4_zheevx(
    ...
    magma_tally4DoubleComplex *A, magma_tally4_int_t lda, double vl, double vu,
    magma_tally4_int_t il, magma_tally4_int_t iu, double abstol, magma_tally4_int_t *m,
    double *w, magma_tally4DoubleComplex *Z, magma_tally4_int_t ldz, magma_tally4DoubleComplex *work, magma_tally4_int_t lwork,
    ...
    magma_tally4_int_t *info)
{
    ...
    *m = 0;
    ...
    magma_tally4_zhetrd(uplo, n, A, lda, &rwork[indd], &rwork[inde], &work[indtau], &work[indwrk], llwork, &iinfo);
