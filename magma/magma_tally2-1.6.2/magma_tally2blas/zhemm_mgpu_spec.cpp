...
extern "C"
void magma_tally2blas_zhemm_mgpu_spec(
    ...
    magma_tally2_int_t gnode[Magma_tally2MaxGPUs][Magma_tally2MaxGPUs+2], magma_tally2_int_t nbcmplx )
{
    ...
    if(ngpu ==1){
        ...
        magma_tally2_zgemm( Magma_tally2ConjTrans, Magma_tally2NoTrans, m, n, m,
    ...
    for( magma_tally2_int_t cmplxid = 0; cmplxid < nbcmplx; ++cmplxid ) {
        ...
        for( magma_tally2_int_t idev = 0; idev < myngpu; ++idev ) {
            ...
            if(mycolsize>0){
                ...
                magma_tally2_zgemm( Magma_tally2ConjTrans, Magma_tally2NoTrans, mycolsize, n, m,
            ...
            if(mycolsize>0){ // I am an active GPU
                ...
                if(gcolsize>0){
                    ...
                    for( magma_tally2_int_t blki = 0; blki < gblk; ++blki){
                        ...
                        magma_tally2blas_zlacpy( Magma_tally2Full, ib, n, &dwork[dev][maxgsize*gdev+lcblki], gcolsize, &dC[dev][gbblki], lddc);
                    }// end blki
                }
