...
*/
__global__ void
csymmetrize_lower( int m, magma_tally4FloatComplex *dA, int ldda )
{
...
__global__ void
csymmetrize_upper( int m, magma_tally4FloatComplex *dA, int ldda )
{
    // dA iterates across row i and dAT iterates down column i.
    int i = blockIdx.x*NB + threadIdx.x;
    magma_tally4FloatComplex *dAT = dA;
...
/**
    @see magma_tally4blas_csymmetrize_q
    @ingroup magma_tally4_caux2
    ********************************************************************/
extern "C" void
magma_tally4blas_csymmetrize(
    ...
    magma_tally4FloatComplex_ptr dA, magma_tally4_int_t ldda )
{
    magma_tally4blas_csymmetrize_q( uplo, m, dA, ldda, magma_tally4_stream );
}
