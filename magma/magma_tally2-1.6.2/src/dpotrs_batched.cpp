                  ...
                  magma_tally2_int_t batchCount, magma_tally2_queue_t queue)
{
   ...
   /* check allocation */
    ...
    if ( uplo == Magma_tally2Upper) {
        ...
        magma_tally2blas_dtrsm_outofplace_batched(Magma_tally2Left, Magma_tally2Upper, Magma_tally2ConjTrans, Magma_tally2NonUnit, 1,
                n, nrhs,
                c_one,
                dA_array,       ldda, // dA
                dB_array,      lddb, // dB
        ...
        magma_tally2blas_dtrsm_outofplace_batched(Magma_tally2Left, Magma_tally2Lower, Magma_tally2NoTrans, Magma_tally2NonUnit, 1,
                n, nrhs,
                c_one,
                dA_array,       ldda, // dA
                dB_array,      lddb, // dB
        ...
        magma_tally2blas_dtrsm_outofplace_batched(Magma_tally2Left, Magma_tally2Lower, Magma_tally2ConjTrans, Magma_tally2NonUnit, 1,
                n, nrhs,
                c_one,
                dA_array,       ldda, // dA
                dwork_array,        n, // dB 
