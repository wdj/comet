...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_X,       magma_tally4DoubleComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_Blapack, magma_tally4DoubleComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_Bcublas, magma_tally4DoubleComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_Bmagma_tally4,  magma_tally4DoubleComplex, ldb*N   );
            ...
            magma_tally4blas_ztrsm( opts.side, opts.uplo, opts.transA, opts.diag, 
                             M, N,
                             alpha, d_A, ldda,
                                    d_B, lddb );
            ...
            magma_tally4_zgetmatrix( M, N, d_B, lddb, h_Bmagma_tally4, ldb );
            ...
            cublasZtrsm( opts.handle, cublas_side_const_tally4(opts.side), cublas_uplo_const_tally4(opts.uplo),
            ...
            if ( opts.lapack ) {
                ...
                blasf77_ztrsm( lapack_side_const_tally4(opts.side), lapack_uplo_const_tally4(opts.uplo),
                               lapack_trans_const_tally4(opts.transA), lapack_diag_const_tally4(opts.diag), 
                               &M, &N,
                               &alpha, h_A, &lda,
                                       h_Blapack, &ldb );
            ...
            normX = lapackf77_zlange( "M", &M, &N, h_Bmagma_tally4, &ldb, work );
