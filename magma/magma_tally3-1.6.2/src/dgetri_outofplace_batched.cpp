...
/**
    ...
    lwork   INTEGER
            ...
            the optimal blocksize returned by magma_tally3_get_dgetri_nb(n).
    \n
       ...
       
{
    ...
    magma_tally3_dmalloc( &dinvdiagA, invdiagA_msize * batchCount);
    ...
    magma_tally3blas_dlaset_q(Magma_tally3Full, invdiagA_msize, batchCount, MAGMA_tally3_D_ZERO, MAGMA_tally3_D_ZERO, dinvdiagA, invdiagA_msize, queue);
    ...
    magma_tally3blas_dlaset_batched(Magma_tally3UpperLower, n, n, MAGMA_tally3_D_ZERO, MAGMA_tally3_D_ONE, dinvA_array, lddia, batchCount, queue);
    ...
    for(j = 0; j < n; j+=nb) {
        ...
        // solve dwork = L^-1 * I
        magma_tally3blas_dlaset_batched(Magma_tally3UpperLower, j, ib, MAGMA_tally3_D_ZERO, MAGMA_tally3_D_ZERO, dwork_array, n, batchCount, queue);
        magma_tally3_ddisplace_pointers(dW5_displ, dwork_array, n, j, 0, batchCount, queue);
        magma_tally3_ddisplace_pointers(dW0_displ, dinvA_array, lddia, j, j, batchCount, queue);
        magma_tally3_ddisplace_pointers(dA_displ, dA_array, ldda, j, j, batchCount, queue);
        ...
        magma_tally3_ddisplace_pointers(dW5_displ, dwork_array, n, 0, 0, batchCount, queue);
        magma_tally3_ddisplace_pointers(dW0_displ, dinvA_array, lddia, 0, j, batchCount, queue);
        magma_tally3_ddisplace_pointers(dA_displ, dA_array, ldda, 0, 0, batchCount, queue);
    ...
    magma_tally3_dlaswp_columnserial_batched( n, dinvA_array, lddia, max(1,n-1), 1, dipiv_array, batchCount, queue);
