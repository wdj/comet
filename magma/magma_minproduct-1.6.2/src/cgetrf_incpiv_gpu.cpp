...
#define dL2(j)  (dL2 + (j)*ib*lddl         )
    ...
    magma_minproductFloatComplex_ptr dAT;
#ifndef WITHOUTTRTRI
    ...
    *info = 0;
    ...
    if ( ib >= mindim ) {
        ...
        magma_minproduct_csetmatrix( mindim, mindim, hL2, ldhl, dL2, lddl );
#endif
        ...
        for( i=0; i < s; i++ ) {
            ...
            if ( i > 0 ) {
                // download i-th panel
                magma_minproductblas_ctranspose( sb, m, AT(0,i), ldda, dwork, maxm );
                magma_minproduct_cgetmatrix( m, sb, dwork, maxm, hA(0, i), ldha );
            ...
            magma_minproductblas_claswp( n-ii, AT(0, i), ldda, ii+1, ii+sb, ipiv, 1 );
            ...
            magma_minproduct_csetmatrix( sb, sb, hL2(i), ldhl, dL2(i), lddl );
#endif
            // upload i-th panel
            magma_minproduct_csetmatrix( rows, sb, hA(i, i), ldha, dwork, cols );
            magma_minproductblas_ctranspose( rows, sb, dwork, cols, AT(i,i), ldda );
