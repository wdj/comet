    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally2_ssytrd_mgpu(ngpu, 1, uplo, n, A, lda, w, &work[inde],
    ...
    if (! wantz) {
...
#else
        magma_tally2_sstedx_m(ngpu, Magma_tally2RangeAll, n, 0., 0., 0, 0, w, &work[inde],
                       &work[indwrk], n, &work[indwk2],
        ...
        magma_tally2_sormtr_m(ngpu, Magma_tally2Left, uplo, Magma_tally2NoTrans, n, n, A, lda, &work[indtau],
