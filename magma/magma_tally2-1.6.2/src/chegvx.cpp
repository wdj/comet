...
magma_tally2_chegvx(
    ...
    magma_tally2FloatComplex *A, magma_tally2_int_t lda, magma_tally2FloatComplex *B, magma_tally2_int_t ldb,
    float vl, float vu, magma_tally2_int_t il, magma_tally2_int_t iu, float abstol,
    magma_tally2_int_t *m, float *w,  magma_tally2FloatComplex *Z, magma_tally2_int_t ldz,
    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally2_SUCCESS != magma_tally2_cmalloc( &dA, n*ldda ) ||
        ...
        MAGMA_tally2_SUCCESS != magma_tally2_cmalloc( &dZ, n*lddz )) {
    ...
    magma_tally2_cheevx_gpu(jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, abstol, m, w, dZ, lddz, A, lda, Z, ldz, work, lwork, rwork, iwork, ifail, info);
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally2_ctrsm(Magma_tally2Left, uplo, trans, Magma_tally2NonUnit, n, *m, c_one, dB, lddb, dZ, lddz);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally2_ctrmm(Magma_tally2Left, uplo, trans, Magma_tally2NonUnit, n, *m, c_one, dB, lddb, dZ, lddz);
        }
        
        magma_tally2_cgetmatrix( n, *m, dZ, lddz, Z, ldz );
    }
