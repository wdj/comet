...
ctranspose_device(
    int m, int n,
    const magma_minproductFloatComplex *A, int lda,
    magma_minproductFloatComplex *AT,      int ldat)
{
    __shared__ magma_minproductFloatComplex sA[NB][NX+1];
...
void ctranspose_kernel_batched(
    ...
    magma_minproductFloatComplex **dAT_array,      int ldat)
{
...
/**
    @see magma_minproductblas_ctranspose_q
    @ingroup magma_minproduct_caux2
    ********************************************************************/
extern "C" void
magma_minproductblas_ctranspose(
    ...
    magma_minproductFloatComplex_ptr       dAT, magma_minproduct_int_t lddat )
{
    magma_minproductblas_ctranspose_q( m, n, dA, ldda, dAT, lddat, magma_minproduct_stream );
}
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_minproductblas_ctranspose_batched_q(
    magma_minproduct_int_t m, magma_minproduct_int_t n,
    magma_minproductFloatComplex **dA_array,  magma_minproduct_int_t ldda,
    magma_minproductFloatComplex **dAT_array, magma_minproduct_int_t lddat, magma_minproduct_int_t batchCount, magma_minproduct_queue_t queue )
{
    magma_minproduct_int_t info = 0;
    if ( m < 0 )
        info = -1;
...
/**
    @see magma_minproductblas_ctranspose_batched_q
    @ingroup magma_minproduct_caux2
    ********************************************************************/
extern "C" void
...
{
    magma_minproductblas_ctranspose_batched_q( m, n, dA_array, ldda, dAT_array, lddat, batchCount, magma_minproduct_stream );
}
