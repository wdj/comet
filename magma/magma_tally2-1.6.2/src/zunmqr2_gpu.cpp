    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (left) {
        nq = m;
        //nw = n;
        magma_tally2_zmalloc( &dwork, (n + 64)*64 );  // TODO after checking args, else memory leak!
    } else {
        nq = n;
        //nw = m;
        magma_tally2_zmalloc( &dwork, (m + 64)*64 );  // TODO after checking args, else memory leak!
    }
    ...
    magma_tally2blas_zlaset_band( Magma_tally2Upper, k, k, nb, c_zero, c_one, dA, ldda );
    ...
    for (i = i1; (step < 0 ? i >= i2 : i <= i2); i += step) {
        ...
        magma_tally2_zsetmatrix( ib, ib, T, ib, dwork, ib );
