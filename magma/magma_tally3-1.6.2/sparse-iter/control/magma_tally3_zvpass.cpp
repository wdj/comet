...
magma_tally3_zvget(
    ...
    magma_tally3_queue_t queue )
{
    magma_tally3_z_matrix v_CPU={Magma_tally3_CSR};
    ...
    if ( v.memory_location == Magma_tally3_CPU ) {
        ...
        *val = v.val;
        ...
        CHECK( magma_tally3_zmtransfer( v, &v_CPU, v.memory_location, Magma_tally3_CPU, queue ));
        CHECK( magma_tally3_zvget( v_CPU, m, n, val, queue ));
    }
    
cleanup:
    magma_tally3_zmfree( &v_CPU, queue );
    return info;
}
