...
*/
__global__ void
csymmetrize_lower( int m, magma_minproductFloatComplex *dA, int ldda )
{
...
__global__ void
csymmetrize_upper( int m, magma_minproductFloatComplex *dA, int ldda )
{
    // dA iterates across row i and dAT iterates down column i.
    int i = blockIdx.x*NB + threadIdx.x;
    magma_minproductFloatComplex *dAT = dA;
...
/**
    @see magma_minproductblas_csymmetrize_q
    @ingroup magma_minproduct_caux2
    ********************************************************************/
extern "C" void
magma_minproductblas_csymmetrize(
    ...
    magma_minproductFloatComplex_ptr dA, magma_minproduct_int_t ldda )
{
    magma_minproductblas_csymmetrize_q( uplo, m, dA, ldda, magma_minproduct_stream );
}
