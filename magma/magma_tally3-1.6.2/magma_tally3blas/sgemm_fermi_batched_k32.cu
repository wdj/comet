    ...
    float **dC_array, magma_tally3_int_t lddc, magma_tally3_int_t batchCount, magma_tally3_queue_t queue )
{
    ...
    if      ( transB == Magma_tally3Trans )
        ...
        magma_tally3_getvector( min(2,batchCount), sizeof(float*), dA_array, 1, cpuAarray, 1);
        magma_tally3_getvector( min(2,batchCount), sizeof(float*), dB_array, 1, cpuBarray, 1);
             ...
             sizeB >= CUBLAS_MAX_1DBUF_SIZE )
        {
            ...
            return;
            /*
            magma_tally3_sgemm( transA, transB, m, n, k, alpha,
