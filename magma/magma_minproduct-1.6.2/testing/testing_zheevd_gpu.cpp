...
int main( int argc, char** argv)
{
    ...
    magma_minproductDoubleComplex *h_A, *h_R, *d_R, *h_work, aux_work[1];
    #ifdef COMPLEX
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_minproduct_zheevd_gpu( opts.jobz, opts.uplo,
                              N, NULL, ldda, NULL,
                              NULL, lda,
                              aux_work,  -1,
                              #ifdef COMPLEX
                              ...
                              aux_iwork, -1,
                              &info );
            lwork  = (magma_minproduct_int_t) MAGMA_minproduct_Z_REAL( aux_work[0] );
            #ifdef COMPLEX
            ...
            TESTING_MALLOC_CPU( h_A,    magma_minproductDoubleComplex, N*lda  );
            ...
            TESTING_MALLOC_PIN( h_R,    magma_minproductDoubleComplex, N*lda  );
            TESTING_MALLOC_PIN( h_work, magma_minproductDoubleComplex, lwork  );
            
            TESTING_MALLOC_DEV( d_R,    magma_minproductDoubleComplex, N*ldda );
            
            /* Initialize the matrix */
            lapackf77_zlarnv( &ione, ISEED, &n2, h_A );
            magma_minproduct_zmake_hermitian( N, h_A, N );
            
            magma_minproduct_zsetmatrix( N, N, h_A, lda, d_R, ldda );
            ...
            if ( opts.warmup ) {
                magma_minproduct_zheevd_gpu( opts.jobz, opts.uplo,
                                  ...
                                  &info );
                if (info != 0)
                    printf("magma_minproduct_zheevd_gpu returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_minproductNoVec ) {
                /* =====================================================================
                   ...
                   =================================================================== */
                magma_minproduct_zgetmatrix( N, N, d_R, ldda, h_R, lda );
                
                magma_minproductDoubleComplex *work;
                TESTING_MALLOC_CPU( work, magma_minproductDoubleComplex, 2*N*N );
                ...
                //
                //magma_minproduct_zsetmatrix( N, N, h_A, lda, d_R, ldda );
                //magma_minproduct_zheevd_gpu( Magma_minproductNoVec, opts.uplo,
                //                  N, d_R, ldda, w2,
                //                  h_R, lda,
                //                  h_work, lwork,
                //                  #ifdef COMPLEX
