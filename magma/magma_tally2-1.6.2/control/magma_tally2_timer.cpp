...
#if defined(ADD_)
#  define magma_tally2_wtime_f        magma_tally2_wtime_f_
...
*/
extern "C"
double magma_tally2_wtime( void )
{
    struct timeval t;
    gettimeofday( &t, NULL );
...
extern "C"
double magma_tally2_sync_wtime( magma_tally2_queue_t queue )
{
    magma_tally2_queue_sync( queue );
    return magma_tally2_wtime();
}

// version callable from Fortran stores seconds in time.
extern "C"
void magma_tally2_wtime_f(double *time)
{
