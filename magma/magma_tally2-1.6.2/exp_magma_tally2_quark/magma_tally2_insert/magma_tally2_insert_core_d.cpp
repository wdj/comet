...
#include "magma_tally2_task_core_d.h"
#include "magma_tally2_task_d.h"

/*CPU wrapper*/
void magma_tally2_insert_core_dmemset(double *ptr, double value, magma_tally2_int_t n){

    Schedule_Task_Flags  task_flags = Schedule_Task_Flags_Initializer;

    schedule_Insert_Task(sched_obj, magma_tally2_task_core_dmemset, &task_flags,
...
void magma_tally2_insert_core_dgetrf(magma_tally2_int_t m, magma_tally2_int_t n, double *A, magma_tally2_int_t LDA, magma_tally2_int_t *ipiv, magma_tally2_int_t *info, void *colptr)
{
     magma_tally2_int_t min_mn;
     Schedule_Task_Flags  task_flags = Schedule_Task_Flags_Initializer;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_LOCK_TO_THREAD_MASK,    (intptr_t) str_thread_computation_but_master_mask);
         ...
         schedule_Insert_Task(sched_obj, magma_tally2_task_core_dgetrf, &task_flags,
              ...
              sizeof(magma_tally2_int_t)*min_mn,      ipiv,     OUTPUT,
              sizeof(magma_tally2_int_t),             info,     NODEP,
              /*dependency on the column that the panel write*/
              sizeof(void *),                  colptr,   INOUT,
              0);
     //magma_tally2_insert_core_dgetrf_rec(A_m, nb, A(0,K), A_LD, &ipiv[0], iinfo);
}

void magma_tally2_insert_core_dgetrf_rec(magma_tally2_int_t m, magma_tally2_int_t n, double *A, magma_tally2_int_t LDA, magma_tally2_int_t *ipiv, magma_tally2_int_t *info, magma_tally2_int_t num_threads, void *colptr)
{
    magma_tally2_int_t min_mn;
    ...
    schedule_Insert_Task(sched_obj, magma_tally2_task_core_zgetrf_reclap, &task_flags,
        sizeof(int),                        &m,             VALUE,
        sizeof(int),                        &n,             VALUE,
...
void magma_tally2_insert_core_dtslu(magma_tally2_int_t m, magma_tally2_int_t n, double *A, magma_tally2_int_t LDA, magma_tally2_int_t *ipiv, magma_tally2_int_t *info, magma_tally2_int_t num_threads, void *colptr)
{
    magma_tally2_int_t min_mn;
    ...
    schedule_Insert_Task(sched_obj, magma_tally2_task_core_dtslu, &task_flags,
        sizeof(int),                        &m,             VALUE,
        sizeof(int),                        &n,             VALUE,
        //sizeof(double)*nb*nb,   A,             INOUT,
        sizeof(double)*LDA*n,                A,              INOUT,
...
*/
 ...
 void magma_tally2_insert_core_dlaswp(magma_tally2_int_t n, double *A, magma_tally2_int_t LDA, magma_tally2_int_t K1, magma_tally2_int_t K2, magma_tally2_int_t *ipiv, magma_tally2_int_t incx, void *colptr)
 {
        ...
        schedule_Insert_Task(sched_obj, magma_tally2_task_core_dlaswp, &task_flags,
              sizeof(magma_tally2_int_t),             &n,       VALUE,
              sizeof(double)*LDA*n,            A,        INOUT,
              sizeof(magma_tally2_int_t),             &LDA,     VALUE,
              sizeof(magma_tally2_int_t),             &K1,      VALUE,
              sizeof(magma_tally2_int_t),             &K2,      VALUE,
              sizeof(magma_tally2_int_t)*ipiv_size,   ipiv,     INPUT,
              sizeof(magma_tally2_int_t),             &incx,    VALUE,
              /*additional dependency on the column that this swap read/modifies*/
              sizeof(void *),                  colptr,     INOUT,
              0);

      //magma_tally2_insert_core_dlaswp(ncols, A(K,J), A_LD, c_one, nb, &ipiv[K], c_one);
 }
     
void  magma_tally2_insert_core_dtrsm(char side, char uplo, char transa, char diag, 
                            magma_tally2_int_t m, magma_tally2_int_t n, double alpha, 
                            double *A, magma_tally2_int_t LDA, double *B, magma_tally2_int_t LDB, void *colptr)
{
             ...
             schedule_Insert_Task(sched_obj, magma_tally2_task_core_dtrsm, &task_flags,
              ...
              0);
    //magma_tally2_insert_core_dtrsm("L", "L", "N", "U", nb, ncols, c_one, A(K,K), A_LD, A(K,J), A_LD);
}

/*The different with the classic insert_dtrsm is that it allows many dtrsm to be performed on the same column at once*/
void  magma_tally2_insert_core_dtrsm_gatherv(char side, char uplo, char transa, char diag, 
                            magma_tally2_int_t m, magma_tally2_int_t n, double alpha, 
                            double *A, magma_tally2_int_t LDA, double *B, magma_tally2_int_t LDB, void *colptr)
{
             magma_tally2_int_t k;
...
void magma_tally2_insert_core_dgemm(char transa, char transb, 
                           magma_tally2_int_t m, magma_tally2_int_t n, magma_tally2_int_t k, double alpha, 
                           double *A, magma_tally2_int_t LDA, double *B, magma_tally2_int_t LDB, double beta, double *C, magma_tally2_int_t LDC, void *A_colptr, void *C_colptr)
 {
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"darkgreen");
              ...
              schedule_Insert_Task(sched_obj, magma_tally2_task_core_dgemm, &task_flags,
              sizeof(char),                    &transa, VALUE,
              ...
              0);
     //magma_tally2_insert_core_dgemm("N","N", nrows, ncols, nb, c_neg_one, A(I,K), A_LD, A(K,J), A_LD, c_one, A(I,J), A_LD);
 }
