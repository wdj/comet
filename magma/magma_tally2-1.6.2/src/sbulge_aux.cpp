...
//////////////////////////////////////////////////////////////
extern "C" void  magma_tally2_sstedc_withZ(magma_tally2_vec_t JOBZ, magma_tally2_int_t N, float *D, float * E, float *Z, magma_tally2_int_t LDZ)
{
    float *WORK;
    ...
    if (JOBZ == Magma_tally2Vec) {
        LWORK  = 1 + 3*N + 3*N*((magma_tally2_int_t)(log( (float)N )/log_2) + 1) + 4*N*N + 256*N;
    ...
    lapackf77_sstedc( lapack_vec_const_tally2(JOBZ), &N, D, E, Z, &LDZ, WORK, &LWORK, IWORK, &LIWORK, &INFO);
...
//////////////////////////////////////////////////////////////
extern "C" void  magma_tally2_sstedx_withZ(magma_tally2_int_t N, magma_tally2_int_t NE, float *D, float * E, float *Z, magma_tally2_int_t LDZ)
{
    float *WORK;
    float *dwork;
    magma_tally2_int_t *IWORK;
    ...
    printf("using magma_tally2_sstedx\n");
    ...
    magma_tally2_sstedx(Magma_tally2RangeI, N, 0., 0., 1, NE, D, E, Z, LDZ, WORK, LWORK, IWORK, LIWORK, dwork, &INFO);
