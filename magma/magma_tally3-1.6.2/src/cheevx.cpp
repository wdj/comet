...
magma_tally3_cheevx(
    ...
    magma_tally3FloatComplex *A, magma_tally3_int_t lda, float vl, float vu,
    magma_tally3_int_t il, magma_tally3_int_t iu, float abstol, magma_tally3_int_t *m,
    float *w, magma_tally3FloatComplex *Z, magma_tally3_int_t ldz, magma_tally3FloatComplex *work, magma_tally3_int_t lwork,
    ...
    magma_tally3_int_t *info)
{
    ...
    *m = 0;
    ...
    magma_tally3_chetrd(uplo, n, A, lda, &rwork[indd], &rwork[inde], &work[indtau], &work[indwrk], llwork, &iinfo);
    ...
    if (*m == 0) {
        *info = 0;
        ...
        if (wantz) {
            ...
            magma_tally3_cunmtr(Magma_tally3Left, uplo, Magma_tally3NoTrans, n, *m, A, lda, &work[indtau],
