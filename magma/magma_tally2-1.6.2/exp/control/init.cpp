...
extern "C" magma_tally2_context *
magma_tally2_init( void *params, void* (*func)(void *a), magma_tally2_int_t nthread, magma_tally2_int_t ncpu, magma_tally2_int_t ngpu,
...
/*  -- MAGMA_tally2 (version 1.6.1) --
    ...
    subsequent calls to routines in the MAGMA_tally2 library.
    ...
    context  = (magma_tally2_context *)malloc(sizeof(magma_tally2_context));
...
extern "C" void
magma_tally2_finalize( magma_tally2_context *cntxt)
{
/*  -- MAGMA_tally2 (version 1.6.1) --
       Univ. of Tennessee, Knoxville
       Univ. of California, Berkeley
    ...
    Purpose
    =======
    This function finalizes the MAGMA_tally2 hardware context.

    Arguments
    =========
    CNTXT  (input) MAGMA_tally2_CONTEXT
           Pointer to the MAGMA_tally2 hardware context to be closed
    ===================================================================== */
