    ...
    magma_minproduct_int_t *info)
{
    ...
    magma_minproduct_int_t i, i__4, lddwork;
    magma_minproductFloatComplex T[2*4160]        /* was [65][64] */;
    magma_minproduct_int_t i1, i2, step, ib, ic, jc, nb, mi, ni, nq;
    int left, notran;
    ...
    *info = 0;
    ...
    if (left) {
        nq = m;
        //nw = n;
        magma_minproduct_cmalloc( &dwork, (n + 64)*64 );  // TODO after checking args, else memory leak!
    } else {
        nq = n;
        //nw = m;
        magma_minproduct_cmalloc( &dwork, (m + 64)*64 );  // TODO after checking args, else memory leak!
    }
    ...
    magma_minproductblas_claset_band( Magma_minproductUpper, k, k, nb, c_zero, c_one, dA, ldda );
    ...
    for (i = i1; (step < 0 ? i >= i2 : i <= i2); i += step) {
        ...
        magma_minproduct_csetmatrix( ib, ib, T, ib, dwork, ib );
