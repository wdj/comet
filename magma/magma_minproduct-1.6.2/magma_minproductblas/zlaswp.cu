...
__global__ void zlaswp_kernel(
    int n, magma_minproductDoubleComplex *dAT, int ldda, zlaswp_params_t params )
{
    int tid = threadIdx.x + blockDim.x*blockIdx.x;
    if ( tid < n ) {
        dAT += tid;
        magma_minproductDoubleComplex *A1  = dAT;
        
        for( int i1 = 0; i1 < params.npivots; ++i1 ) {
            int i2 = params.ipiv[i1];
            magma_minproductDoubleComplex *A2 = dAT + i2*ldda;
            magma_minproductDoubleComplex temp = *A1;
            *A1 = *A2;
            *A2 = temp;
...
/**
    @see magma_minproductblas_zlaswp_q
    @ingroup magma_minproduct_zaux2
    ********************************************************************/
extern "C" void
magma_minproductblas_zlaswp(
    ...
    const magma_minproduct_int_t *ipiv, magma_minproduct_int_t inci )
{
    magma_minproductblas_zlaswp_q( n, dAT, ldda, k1, k2, ipiv, inci, magma_minproduct_stream );
}
...
__global__ void zlaswpx_kernel(
    int n, magma_minproductDoubleComplex *dA, int ldx, int ldy, zlaswp_params_t params )
{
    int tid = threadIdx.x + blockDim.x*blockIdx.x;
    if ( tid < n ) {
        dA += tid*ldy;
        magma_minproductDoubleComplex *A1  = dA;
        
        for( int i1 = 0; i1 < params.npivots; ++i1 ) {
            int i2 = params.ipiv[i1];
            magma_minproductDoubleComplex *A2 = dA + i2*ldx;
            magma_minproductDoubleComplex temp = *A1;
            *A1 = *A2;
            *A2 = temp;
            A1 += ldx;  // A1 = dA + i1*ldx
...
/**
    @see magma_minproductblas_zlaswpx_q
    @ingroup magma_minproduct_zaux2
    ********************************************************************/
extern "C" void
magma_minproductblas_zlaswpx(
    ...
    const magma_minproduct_int_t *ipiv, magma_minproduct_int_t inci )
{
    return magma_minproductblas_zlaswpx_q( n, dA, ldx, ldy, k1, k2, ipiv, inci, magma_minproduct_stream );
}
...
// batches of pivots. On Fermi, it is faster than magma_minproductblas_zlaswp
// (including copying pivots to the GPU).

__global__ void zlaswp2_kernel(
    int n, magma_minproductDoubleComplex *dAT, int ldda, int npivots,
...
/**
    @see magma_minproductblas_zlaswp2_q
    @ingroup magma_minproduct_zaux2
    ********************************************************************/
extern "C" void
magma_minproductblas_zlaswp2(
    ...
    magma_minproductInt_const_ptr d_ipiv, magma_minproduct_int_t inci )
{
    magma_minproductblas_zlaswp2_q( n, dAT, ldda, k1, k2, d_ipiv, inci, magma_minproduct_stream );
}
