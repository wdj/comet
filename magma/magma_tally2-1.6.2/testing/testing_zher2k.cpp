...
int main( int argc, char** argv)
{
    ...
    magma_tally2DoubleComplex *h_A, *h_B, *h_C, *h_Ccublas;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_B,       magma_tally2DoubleComplex, ldb*Bk );
            ...
            TESTING_MALLOC_DEV( d_B, magma_tally2DoubleComplex, lddb*Bk );
            ...
            magma_tally2_zsetmatrix( Bn, Bk, h_B, ldb, d_B, lddb );
            magma_tally2_zsetmatrix( N, N, h_C, ldc, d_C, lddc );
            
            cublas_time = magma_tally2_sync_wtime( NULL );
            cublasZher2k( opts.handle, cublas_uplo_const_tally2(opts.uplo), cublas_trans_const_tally2(opts.transA), N, K,
                          &alpha, d_A, ldda,
                                  d_B, lddb,
                          &beta,  d_C, lddc );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_zher2k( lapack_uplo_const_tally2(opts.uplo), lapack_trans_const_tally2(opts.transA), &N, &K,
                               &alpha, h_A, &lda,
                                       h_B, &ldb,
                               &beta,  h_C, &ldc );
