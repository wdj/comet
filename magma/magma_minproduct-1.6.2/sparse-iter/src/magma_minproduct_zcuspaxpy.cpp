...
magma_minproduct_zcuspaxpy(
    magma_minproductDoubleComplex *alpha, magma_minproduct_z_matrix A,
    magma_minproductDoubleComplex *beta, magma_minproduct_z_matrix B,
    ...
    magma_minproduct_queue_t queue )
{
    ...
    if (    A.memory_location == Magma_minproduct_DEV
        ...
        CHECK( magma_minproduct_zmalloc( &C.dval, C.nnz ));
        ...
        CHECK( magma_minproduct_zmtransfer( C, AB, Magma_minproduct_DEV, Magma_minproduct_DEV, queue ));
    }
    else {
