    ...
    magma_minproduct_int_t *info)
{
  ...
  if (upper) {
            magma_minproductblas_ctrsm( Magma_minproductLeft, Magma_minproductUpper, 
                           Magma_minproductConjTrans, Magma_minproductUnit, 
                           n, nrhs, c_one,
                           dA, ldda, dB, lddb );
            magma_minproductblas_clascl_diag(Magma_minproductUpper, 1, n, dA, ldda, dB,1, info);
            magma_minproductblas_ctrsm( Magma_minproductLeft, Magma_minproductUpper, 
            ...
            magma_minproduct_ctrsm( Magma_minproductLeft, Magma_minproductLower, 
                           Magma_minproductNoTrans, Magma_minproductUnit, 
                           n, nrhs, c_one,
                           dA, ldda, dB, lddb );
            magma_minproductblas_clascl_diag(Magma_minproductLower, 1, n, dA, ldda, dB,1, info);
            magma_minproductblas_ctrsm( Magma_minproductLeft, Magma_minproductLower, 
                           Magma_minproductConjTrans, Magma_minproductUnit, 
                           n, nrhs, c_one,
                           dA, ldda, dB, lddb );
        }
