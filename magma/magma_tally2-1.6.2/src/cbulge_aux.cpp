...
//////////////////////////////////////////////////////////////
extern "C" void  magma_tally2_cstedc_withZ(magma_tally2_vec_t JOBZ, magma_tally2_int_t N, float *D, float * E, magma_tally2FloatComplex *Z, magma_tally2_int_t LDZ)
{
    ...
    if (JOBZ == Magma_tally2Vec) {
        LWORK  = N*N;
        LRWORK = 1 + 3*N + 3*N*((magma_tally2_int_t)(log( (float)N )/log_2) + 1) + 4*N*N + 256*N;
        LIWORK = 6 + 6*N + 6*N*((magma_tally2_int_t)(log( (float)N )/log_2) + 1) + 256*N;
    ...
    magma_tally2_smalloc_cpu( &RWORK, LRWORK );
    magma_tally2_cmalloc_cpu( &WORK,  LWORK  );
    magma_tally2_imalloc_cpu( &IWORK, LIWORK );
    
    lapackf77_cstedc( lapack_vec_const_tally2(JOBZ), &N, D, E, Z, &LDZ, WORK, &LWORK, RWORK, &LRWORK, IWORK, &LIWORK, &INFO);
...
//          CSTEDC          Divide and Conquer for tridiag
//////////////////////////////////////////////////////////////
extern "C" void  magma_tally2_cstedx_withZ(magma_tally2_int_t N, magma_tally2_int_t NE, float *D, float * E, magma_tally2FloatComplex *Z, magma_tally2_int_t LDZ)
{
    float *RWORK;
    float *dwork;
    magma_tally2_int_t *IWORK;
    ...
    printf("using magma_tally2_cstedx\n");
    ...
    magma_tally2_cstedx(job, N, 0., 0., 1, NE, D, E, Z, LDZ, RWORK, LRWORK, IWORK, LIWORK, dwork, &INFO);
