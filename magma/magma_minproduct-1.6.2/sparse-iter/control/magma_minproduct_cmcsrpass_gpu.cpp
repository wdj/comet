/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from magma_minproduct_zmcsrpass_gpu.cpp normal z -> c, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproduct_c_matrix A_DEV={Magma_minproduct_CSR}, A_CSR={Magma_minproduct_CSR};
    ...
    if ( A.memory_location == Magma_minproduct_DEV && A.storage_type == Magma_minproduct_CSR ) {
        ...
        *row = A.drow;
        ...
        CHECK( magma_minproduct_cmconvert( A, &A_CSR, A.storage_type, Magma_minproduct_CSR, queue ));
        CHECK( magma_minproduct_cmtransfer( A_CSR, &A_DEV, A.memory_location, Magma_minproduct_DEV, queue ));
        magma_minproduct_ccsrget_gpu( A_DEV, m, n, row, col, val, queue );
    }
    
cleanup:
    magma_minproduct_cmfree( &A_CSR, queue );
    magma_minproduct_cmfree( &A_DEV, queue );
    return info;
}
