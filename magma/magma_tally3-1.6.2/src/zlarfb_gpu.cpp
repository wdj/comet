    ...
    magma_tally3DoubleComplex_ptr dwork,       magma_tally3_int_t ldwork )
{
    ...
    if ( side == Magma_tally3Left ) {
        ...
        // W = W T^H = C^H V T^H
        magma_tally3_ztrmm( Magma_tally3Right, uplo, transt, Magma_tally3NonUnit,
                     n, k,
                     c_one, dT(0,0),  lddt,
                            dwork(0), ldwork);

        // C = C - V W^H = C - V T V^H C = (I - V T V^H) C = H C
        magma_tally3_zgemm( notransV, Magma_tally3_ConjTrans,
                     m, n, k,
        ...
        // W = W T = C V T
        magma_tally3_ztrmm( Magma_tally3Right, uplo, trans, Magma_tally3NonUnit,
                     m, k,
                     c_one, dT(0,0),  lddt,
                            dwork(0), ldwork);
