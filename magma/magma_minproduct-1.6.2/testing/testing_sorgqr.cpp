/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from testing_zungqr.cpp normal z -> s, Fri Jan 30 19:00:26 2015
...
int main( int argc, char** argv )
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (opts.version == 1)
                magma_minproduct_sorgqr( m, n, k, hR, lda, tau, dT, nb, &info );
            else
                magma_minproduct_sorgqr2(m, n, k, hR, lda, tau, &info );
