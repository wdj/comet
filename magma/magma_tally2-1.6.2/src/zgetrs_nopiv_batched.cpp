                  ...
                  magma_tally2_int_t batchCount,  magma_tally2_queue_t queue)
{
   ...
   /* check allocation */
    ...
    if (notran) {
        ...
        // solve 
        magma_tally2blas_ztrsm_outofplace_batched(Magma_tally2Left, Magma_tally2Upper, trans, Magma_tally2Unit, 1,
                n, nrhs,
                MAGMA_tally2_Z_ONE,
                dA_displ,       ldda, // dA
                dB_displ,      lddb, // dB
        ...
        // solve 
        magma_tally2blas_ztrsm_outofplace_batched(Magma_tally2Left, Magma_tally2Lower, trans, Magma_tally2NonUnit, 1,
                n, nrhs,
                MAGMA_tally2_Z_ONE,
                dA_displ,       ldda, // dA
                dwork_array,        n, // dB 
