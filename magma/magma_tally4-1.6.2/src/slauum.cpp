    ...
    if (nb <= 1 || nb >= n)
        ...
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally4_ssetmatrix_async( ib, (n-i-ib),
                                        A(i,i+ib),  lda,
                ...
                lapackf77_slauum(Magma_tally4UpperStr, &ib, A(i,i), &lda, info);
                ...
                magma_tally4_sgetmatrix( i+ib, ib,
                                  dA(0, i), ldda,
                                  A(0, i),  lda );
            }
        }
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally4_ssetmatrix_async( (n-i-ib), ib,
                                        A(i+ib, i),  lda,
                ...
                lapackf77_slauum(Magma_tally4LowerStr, &ib, A(i,i), &lda, info);
                ...
                magma_tally4_sgetmatrix( ib, i+ib,
                                  dA(i, 0), ldda,
                                  A(i, 0),  lda );
            }
        }
