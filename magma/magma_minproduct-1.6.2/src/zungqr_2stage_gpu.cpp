...
/**
    ...
    dT      COMPLEX_16 work space array on the GPU device,
            ...
            This must be the 6th argument of magma_minproduct_zgeqrf_gpu
            [ note that if N here is bigger than N in magma_minproduct_zgeqrf_gpu,
              the workspace requirement DT in magma_minproduct_zgeqrf_gpu must be
    ...
    magma_minproduct_int_t *info)
{
    ...
    magma_minproduct_int_t  i__1, i__2, i__3;
    //magma_minproduct_int_t lwork;
    magma_minproduct_int_t i, ib, ki, kk;  //, iinfo;
    //magma_minproduct_int_t lddwork = min(m, n);
    //magma_minproductDoubleComplex *work, *panel;
    magma_minproductDoubleComplex_ptr dwork;
    //magma_minproduct_queue_t stream[2];
    magma_minproduct_int_t ldt=nb; // need to be an input parameter
    ...
    *info = 0;
    ...
    if ( (nb > 1) && (nb < k) ) {
        ...
        magma_minproductblas_zlaset( Magma_minproductFull, kk,   n-kk, c_zero, c_zero, dA(0, kk), ldda );
        magma_minproductblas_zlaset( Magma_minproductFull, m-kk, n-kk, c_zero, c_one,  dA(kk,kk), ldda );
    }
    else {
        ki = 0;
        kk = 0;
    ...
    //if (MAGMA_minproduct_SUCCESS != magma_minproduct_zmalloc_pinned( &work, (lwork) )) {
    ...
    if (kk < n) {
        ...
        i__2 = n - kk;
        i__3 = k - kk;
        //magma_minproduct_zgetmatrix(i__1, i__2, dA(kk, kk), ldda, panel, i__1);
        //lapackf77_zungqr(&i__1, &i__2, &i__3, panel, &i__1, &tau[kk],
        //                 work, &lwork, &iinfo);
        //
        //magma_minproduct_zsetmatrix(i__1, i__2, panel, i__1, dA(kk, kk), ldda);
        
        magma_minproduct_zlarfb_gpu( Magma_minproductLeft, Magma_minproductNoTrans, Magma_minproductForward, Magma_minproductColumnwise,
                          i__1, i__2, i__3,
                          dA(kk, kk-nb), ldda, dT(kk-nb), ldt,
                          dA(kk, kk), ldda, dwork, i__2);
        
        //magma_minproductblas_zlaset(Magma_minproductFull, kk-nb,     nb, c_zero, c_zero, dA(0,kk-nb),     ldda);
        //magma_minproductblas_zlaset(Magma_minproductFull, m-(kk-nb), nb, c_zero, c_one,  dA(kk-nb,kk-nb), ldda);
    }
    ...
    if (kk > 0) {
        ...
        for (i = ki; i >= nb; i -= nb) {
            ...
            i__2 = m - i;
            //magma_minproduct_zgetmatrix_async( i__2, ib, dA(i,i), ldda, panel, i__2, stream[0] );  // verify
            if (i + ib < n) {
                /* Apply H to A(i:m,i+ib:n) from the left */
                i__3 = n - i;

                magma_minproductblas_zlaset( Magma_minproductFull, i,   ib, c_zero, c_zero, dA(0,i), ldda );
                magma_minproductblas_zlaset( Magma_minproductFull, m-i, ib, c_zero, c_one,  dA(i,i), ldda );
            ...
            //                 work, &lwork, &iinfo);
            //magma_minproduct_zsetmatrix_async( i__2, ib, panel, i__2, dA(i,i), ldda, stream[1] );  // verify

            /* Set rows 1:i-1 of current block to zero */
            i__2 = i + ib;
            //magma_minproductblas_zlaset(Magma_minproductFull, i-ib,     ib, c_zero, c_zero, dA(0,i-ib),    ldda);
            //magma_minproductblas_zlaset(Magma_minproductFull, m-(i-ib), ib, c_zero, c_one,  dA(i-ib,i-ib), ldda);
        }
    }

    magma_minproductblas_zlaset( Magma_minproductFull, m, nb, c_zero, c_one, dA(0,0), ldda );
