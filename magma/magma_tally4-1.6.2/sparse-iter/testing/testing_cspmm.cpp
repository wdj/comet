...
int main(  int argc, char** argv )
{
    ...
    while( i < argc ) {
        ...
        // init CPU vectors
        CHECK( magma_tally4_cvinit( &hx, Magma_tally4_CPU, m, n, c_one, queue ));
        CHECK( magma_tally4_cvinit( &hy, Magma_tally4_CPU, m, n, c_zero, queue ));

        // init DEV vectors
        CHECK( magma_tally4_cvinit( &dx, Magma_tally4_DEV, m, n, c_one, queue ));
        CHECK( magma_tally4_cvinit( &dy, Magma_tally4_DEV, m, n, c_zero, queue ));
        ...
        CHECK( magma_tally4_cvinit( &dy, Magma_tally4_DEV, dx.num_rows, dx.num_cols, c_zero, queue ));
        // SpMV on GPU (SELLP)
        start = magma_tally4_sync_wtime( queue );
        for (j=0; j<10; j++)
