...
magma_minproduct_dsetmatrix_internal(
    ...
    double const* hA_src, magma_minproduct_int_t lda,
    magma_minproductDouble_ptr    dB_dst, magma_minproduct_int_t ldb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
...
magma_minproduct_dgetmatrix_internal(
    magma_minproduct_int_t m, magma_minproduct_int_t n,
    magma_minproductDouble_const_ptr dA_src, magma_minproduct_int_t lda,
    double*          hB_dst, magma_minproduct_int_t ldb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
