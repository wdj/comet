...
static    double neg_one = MAGMA_tally4_D_NEG_ONE;
...

{
    ...
    magma_tally4blas_dgemm_batched(Magma_tally4ConjTrans, Magma_tally4NoTrans, k, n, m,
                             one, (const double**) dV_array, ldv,
                                    (const double**) dA_array, lda,
                             zero,  W_array, ldw, batchCount );
    ...
    // W2 = T^H * W        
    magma_tally4blas_dgemm_batched(Magma_tally4ConjTrans, Magma_tally4NoTrans, k, n, k,
                             one, (const double**) dT_array, ldt,
                                    (const double**) W_array, ldw,
                             zero,  W2_array, ldw2, batchCount );
    ...
    // A = A - V * W2 
    magma_tally4blas_dgemm_batched(Magma_tally4NoTrans, Magma_tally4NoTrans, m, n, k,
                             neg_one, (const double**) dV_array, ldv,
                                    (const double**) W2_array, ldw2,
                             one,  dA_array, lda, batchCount );
