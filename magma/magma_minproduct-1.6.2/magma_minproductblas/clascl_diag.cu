...
__global__ void
clascl_diag_lower(int m, int n, magma_minproductFloatComplex_const_ptr D, int ldd, 
                                      magma_minproductFloatComplex_ptr A, int lda)
{
...
__global__ void
clascl_diag_upper(int m, int n, magma_minproductFloatComplex_const_ptr D, int ldd, 
                                      magma_minproductFloatComplex_ptr A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_minproductblas_clascl_diag_q(
...
{
    magma_minproductblas_clascl_diag_q( type, m, n, dD, lddd, dA, ldda, info, magma_minproduct_stream );
}
