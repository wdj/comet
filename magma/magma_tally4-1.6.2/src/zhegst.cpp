...
#define dB(i, j) (dw + n*ldda + (j)*lddb + (i))
    ...
    *info = 0;
    ...
    if (MAGMA_tally4_SUCCESS != magma_tally4_zmalloc( &dw, 2*n*n )) {
    ...
    magma_tally4_zsetmatrix( n, n, A(0, 0), lda, dA(0, 0), ldda );
    magma_tally4_zsetmatrix( n, n, B(0, 0), ldb, dB(0, 0), lddb );
    ...
    magma_tally4_zgetmatrix( n, n, dA(0, 0), ldda, A(0, 0), lda );
