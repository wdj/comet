...
int main(int argc, char **argv)
{
    ...
    double *A, *X, *Y, *Ydev, *Ymagma_tally2;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally2_dsetmatrix( M, N, A, lda, dA, lda );
            magma_tally2_dsetvector( Xm, X, incx, dX, incx );
            magma_tally2_dsetvector( Ym, Y, incy, dY, incy );
            
            #ifdef HAVE_CUBLAS
                dev_time = magma_tally2_sync_wtime( 0 );
                cublasDgemv( opts.handle, cublas_trans_const_tally2(opts.transA),
                ...
                magma_tally2_dgemv( opts.transA, M, N,
                             &alpha, dA, lda,
                                     dX, incx,
                             &beta,  dY, incy );
            ...
            magma_tally2_dgetvector( Ym, dY, incy, Ydev, incy );
            ...
            /* =====================================================================
               ...
               =================================================================== */
                ...
                magma_tally2blas_dgemv( opts.transA, M, N, alpha, dA, lda, dX, incx, beta, dY, incy );
                magma_tally2_time = magma_tally2_sync_wtime( 0 ) - magma_tally2_time;
                magma_tally2_perf = gflops / magma_tally2_time;
                
                magma_tally2_dgetvector( Ym, dY, incy, Ymagma_tally2, incy );
            #endif
            ...
            blasf77_dgemv( lapack_trans_const_tally2(opts.transA), &M, &N,
                           &alpha, A, &lda,
                                   X, &incx,
                           &beta,  Y, &incy );
            ...
            #ifdef HAVE_CUBLAS
                blasf77_daxpy( &Ym, &c_neg_one, Y, &incy, Ymagma_tally2, &incy );
                magma_tally2_error = lapackf77_dlange( "F", &Ym, &ione, Ymagma_tally2, &Ym, work ) / (Anorm * Xnorm);
