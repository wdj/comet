...
static void *magma_minproduct_dapplyQ_m_parallel_section(void *arg);
...
class magma_minproduct_dapplyQ_m_data {

public:

    magma_minproduct_dapplyQ_m_data(magma_minproduct_int_t ngpu_, magma_minproduct_int_t threads_num_, magma_minproduct_int_t n_, magma_minproduct_int_t ne_, magma_minproduct_int_t n_gpu_,
                         magma_minproduct_int_t nb_, magma_minproduct_int_t Vblksiz_, double *E_, magma_minproduct_int_t lde_,
                         double *V_, magma_minproduct_int_t ldv_, double *TAU_,
                         double *T_, magma_minproduct_int_t ldt_)
    :
    ngpu(ngpu_),
    ...
    ~magma_minproduct_dapplyQ_m_data()
    {
...
private:
    ...
    magma_minproduct_dapplyQ_m_data(magma_minproduct_dapplyQ_m_data& data); // disable copy
};

class magma_minproduct_dapplyQ_m_id_data {

public:

    magma_minproduct_dapplyQ_m_id_data()
    : id(-1), data(NULL)
    {}

    magma_minproduct_dapplyQ_m_id_data(magma_minproduct_int_t id_, magma_minproduct_dapplyQ_m_data* data_)
    : id(id_), data(data_)
    {}

    magma_minproduct_int_t id;
    magma_minproduct_dapplyQ_m_data* data;
};
...
//n_gpu = ne;
    if (n_gpu < ne) {
        ...
        #endif
        magma_minproduct_dapplyQ_m_data data_applyQ(ngpu, threads, n, ne, n_gpu, nb, Vblksiz, Z, ldz, V, ldv, TAU, T, ldt);

        magma_minproduct_dapplyQ_m_id_data* arg;
        magma_minproduct_malloc_cpu((void**) &arg, threads*sizeof(magma_minproduct_dapplyQ_m_id_data));
        ...
        for (magma_minproduct_int_t thread = 1; thread < threads; thread++) {
            arg[thread] = magma_minproduct_dapplyQ_m_id_data(thread, &data_applyQ);
            pthread_create(&thread_id[thread], &thread_attr, magma_minproduct_dapplyQ_m_parallel_section, &arg[thread]);
        }
        arg[0] = magma_minproduct_dapplyQ_m_id_data(0, &data_applyQ);
        magma_minproduct_dapplyQ_m_parallel_section(&arg[0]);
        ...
        magma_minproduct_dbulge_applyQ_v2_m(ngpu, Magma_minproductLeft, ne, n, nb, Vblksiz, Z, ldz, V, ldv, T, ldt, info);
...
static void *magma_minproduct_dapplyQ_m_parallel_section(void *arg)
{
    magma_minproduct_int_t my_core_id     = ((magma_minproduct_dapplyQ_m_id_data*)arg) -> id;
    magma_minproduct_dapplyQ_m_data* data = ((magma_minproduct_dapplyQ_m_id_data*)arg) -> data;
    ...
    if (my_core_id == 0) {
        ...
        magma_minproduct_dbulge_applyQ_v2_m(ngpu, Magma_minproductLeft, n_gpu, n, nb, Vblksiz, E, lde, V, ldv, T, ldt, &info);
        magma_minproduct_device_sync();
