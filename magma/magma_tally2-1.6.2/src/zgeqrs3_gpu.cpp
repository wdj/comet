    ...
    magma_tally2_int_t *info)
{
    ...
    */
    magma_tally2blas_zswapdblk(k-1, nb, dA(0,0), ldda, 1, dT(0), nb, 0);
    if ( nrhs == 1 ) {
        magma_tally2_ztrsv(Magma_tally2Upper, Magma_tally2NoTrans, Magma_tally2NonUnit,
                    n, dA(0,0), ldda, dB, 1);
    } else {
        magma_tally2_ztrsm(Magma_tally2Left, Magma_tally2Upper, Magma_tally2NoTrans, Magma_tally2NonUnit,
                    n, nrhs, c_one, dA(0,0), ldda, dB, lddb);
    }
    magma_tally2blas_zswapdblk(k-1, nb, dT(0), nb, 0, dA(0,0), ldda, 1);
