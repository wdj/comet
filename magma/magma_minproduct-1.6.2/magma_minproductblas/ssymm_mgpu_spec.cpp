...
extern "C"
void magma_minproductblas_ssymm_mgpu_spec(
    ...
    magma_minproduct_int_t gnode[Magma_minproductMaxGPUs][Magma_minproductMaxGPUs+2], magma_minproduct_int_t nbcmplx )
{
    ...
    if(ngpu ==1){
        ...
        magma_minproduct_sgemm( Magma_minproductConjTrans, Magma_minproductNoTrans, m, n, m,
    ...
    for( magma_minproduct_int_t cmplxid = 0; cmplxid < nbcmplx; ++cmplxid ) {
        ...
        for( magma_minproduct_int_t idev = 0; idev < myngpu; ++idev ) {
            ...
            if(mycolsize>0){
                ...
                magma_minproduct_sgemm( Magma_minproductConjTrans, Magma_minproductNoTrans, mycolsize, n, m,
            ...
            if(mycolsize>0){ // I am an active GPU
                ...
                if(gcolsize>0){
                    ...
                    for( magma_minproduct_int_t blki = 0; blki < gblk; ++blki){
                        ...
                        magma_minproductblas_slacpy( Magma_minproductFull, ib, n, &dwork[dev][maxgsize*gdev+lcblki], gcolsize, &dC[dev][gbblki], lddc);
                    }// end blki
                }
