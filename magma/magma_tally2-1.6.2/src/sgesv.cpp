    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally2_sgetrf_gpu( n, n, dA, ldda, ipiv, info );
    ...
    if ( *info == 0 ) {
        ...
        magma_tally2_sgetrs_gpu( Magma_tally2NoTrans, n, nrhs, dA, ldda, ipiv, dB, lddb, info );
...
CPU_INTERFACE:
    ...
    magma_tally2_sgetrf( n, n, A, lda, ipiv, info );
    if ( *info == 0 ) {
        lapackf77_sgetrs( Magma_tally2NoTransStr, &n, &nrhs, A, &lda, ipiv, B, &ldb, info );
    }
    return *info;
}
