/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from magma_minproduct_zmcsrpass.cpp normal z -> s, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproduct_s_matrix A_CPU={Magma_minproduct_CSR}, A_CSR={Magma_minproduct_CSR};
    ...
    if ( A.memory_location == Magma_minproduct_CPU && A.storage_type == Magma_minproduct_CSR ) {
        ...
        *row = A.row;
        ...
        CHECK( magma_minproduct_smtransfer( A, &A_CPU, A.memory_location, Magma_minproduct_CPU, queue ));
        CHECK( magma_minproduct_smconvert( A_CPU, &A_CSR, A_CPU.storage_type, Magma_minproduct_CSR, queue ));
        CHECK( magma_minproduct_scsrget( A_CSR, m, n, row, col, val, queue ));
    }

cleanup:
    magma_minproduct_smfree( &A_CSR, queue );
    magma_minproduct_smfree( &A_CPU, queue );
    return info;
}
