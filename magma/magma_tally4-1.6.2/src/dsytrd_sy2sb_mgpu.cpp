    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    double *dspace[Magma_tally4MaxGPUs];
    double *dwork[Magma_tally4MaxGPUs], *dworkbis[Magma_tally4MaxGPUs];
    double *dvall[Magma_tally4MaxGPUs], *dv[Magma_tally4MaxGPUs], *dw[Magma_tally4MaxGPUs];
    double *workngpu[Magma_tally4MaxGPUs+1];
    ...
    for( magma_tally4_int_t dev = 0; dev < ngpu; ++dev ) {
        ...
        magma_tally4_dmalloc( &dspace[dev], devworksiz );
        magma_tally4_dmalloc_pinned ( &workngpu[dev], worksiz);
    ...
    magma_tally4_dmalloc_pinned ( &workngpu[ngpu], worksiz);
    double *worktest = NULL;
    //magma_tally4_dmalloc_cpu( &worktest, n*nb ); // not used
    // ======================
