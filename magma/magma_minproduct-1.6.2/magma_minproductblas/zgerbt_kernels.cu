...
magma_minproductblas_zelementary_multiplication_devfunc(
    magma_minproduct_int_t n,
    magma_minproductDoubleComplex *dA, magma_minproduct_int_t ldda, 
    magma_minproductDoubleComplex *du, 
...
{    
    ...
    if ((idx < n/2)&&(idy < n/2)){
        ...
        magma_minproductDoubleComplex a00, a10, a01, a11, b1, b2, b3, b4;
        __shared__ magma_minproductDoubleComplex u1[block_height], u2[block_height], v1[block_width], v2[block_width];
...
{    
    magma_minproductblas_zelementary_multiplication_devfunc( n, dA+offsetA, ldda, du+offsetu, dv+offsetv);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
__global__ void 
...
{    
    ...
    magma_minproductblas_zelementary_multiplication_devfunc( n, dA_array[batchid]+offsetA, ldda, du+offsetu, dv+offsetv);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
static __device__ void 
magma_minproductblas_zapply_vector_devfunc(
    magma_minproduct_int_t n,
    magma_minproductDoubleComplex *du, magma_minproductDoubleComplex *db)
{
    ...
    if (idx < n/2){
        ...
        magma_minproductDoubleComplex a1,a2;
...
{
    magma_minproductblas_zapply_vector_devfunc(n, du+offsetu, db+offsetb);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
__global__ void 
    ...
    magma_minproductDoubleComplex *du, magma_minproduct_int_t offsetu, magma_minproductDoubleComplex **db_array, magma_minproduct_int_t offsetb )
{
    ...
    magma_minproductblas_zapply_vector_devfunc(n, du+offsetu, db_array[batchid]+offsetb);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////

static __device__ void 
magma_minproductblas_zapply_transpose_vector_devfunc(
    magma_minproduct_int_t n,
    magma_minproductDoubleComplex *du,magma_minproductDoubleComplex *db )
{
    magma_minproduct_int_t idx;
...
magma_minproductblas_zapply_transpose_vector_kernel(
    ...
    magma_minproductDoubleComplex *du, magma_minproduct_int_t offsetu, magma_minproductDoubleComplex *db, magma_minproduct_int_t offsetb )
{
    magma_minproductblas_zapply_transpose_vector_devfunc(n, du+offsetu, db+offsetb);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
__global__ void 
    ...
    magma_minproductDoubleComplex *du, magma_minproduct_int_t offsetu, magma_minproductDoubleComplex **db_array, magma_minproduct_int_t offsetb )
{
    ...
    int batchid = blockIdx.y;
    magma_minproductblas_zapply_transpose_vector_devfunc(n, du+offsetu, db_array[batchid]+offsetb);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
