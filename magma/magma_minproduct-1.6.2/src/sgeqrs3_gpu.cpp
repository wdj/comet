    ...
    magma_minproduct_int_t *info)
{
    ...
    */
    magma_minproductblas_sswapdblk(k-1, nb, dA(0,0), ldda, 1, dT(0), nb, 0);
    if ( nrhs == 1 ) {
        magma_minproduct_strsv(Magma_minproductUpper, Magma_minproductNoTrans, Magma_minproductNonUnit,
                    n, dA(0,0), ldda, dB, 1);
    } else {
    ...
    magma_minproductblas_sswapdblk(k-1, nb, dT(0), nb, 0, dA(0,0), ldda, 1);
