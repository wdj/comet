/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zssssm_gpu.cpp normal z -> c, Fri Jan 30 19:00:15 2015
...
#define L2(i,j)  (dL2  + (i)*lddl2i + (j)*lddl2j)
    ...
    int ip, ii, sb;
    magma_minproductFloatComplex_ptr dA1T, dA2T;
    magma_minproduct_trans_t transL;
    int lddl2i, lddl2j;
    
    MAGMA_minproduct_UNUSED( ip );  // used only if NOSWAPBLK
    ...
    *info = 0;
    ...
    if ( order == Magma_minproductColMajor ) {
        magma_minproductblas_cgetmo_in( dA1, dA1T, ldda1, m1, n1 );
        magma_minproductblas_cgetmo_in( dA2, dA2T, ldda2, m2, n2 );
        transL = Magma_minproductTrans;
        lddl2i = 1; lddl2j = lddl2;
    } else {
        dA1T = dA1;
        dA2T = dA2;
        transL = Magma_minproductNoTrans;
    ...
    for( ii=0; ii < k; ii += ib ) {
...
#ifndef NOSWAPBLK
        magma_minproductblas_cswapblk( Magma_minproductRowMajor, n1,
                            A1T(0, 0), ldda1,
                            A2T(0, 0), ldda2,
...
#else
        {
            ...
            for (i=0; i < ib; i++) {
                ...
                if (im != (ii+i)) {
                    ...
                    magma_minproductblas_cswap( n1, A1T(ii+i, 0), 1, A2T(im, 0), 1 );
                }
                ip++;
            }
        }
        ...
        magma_minproduct_cgemm( Magma_minproductNoTrans, transL,
                     n2, m2, sb,
    ...
    if ( order == Magma_minproductColMajor ) {
        magma_minproductblas_cgetmo_out( dA1, dA1T, ldda1, m1, n1 );
        magma_minproductblas_cgetmo_out( dA2, dA2T, ldda2, m2, n2 );
    }
    return *info;
}
