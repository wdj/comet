    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally3_zstedx( Magma_tally3RangeAll, n, 0., 0., 0, 0, w, &rwork[inde],
        ...
        magma_tally3_zsetmatrix( n, n, &work[indwrk], n, dC, lddc );

        magma_tally3_zunmtr_gpu( Magma_tally3Left, uplo, Magma_tally3NoTrans, n, n, dA, ldda, &work[indtau],
                          dC, lddc, wA, ldwa, &iinfo );

        magma_tally3_zcopymatrix( n, n, dC, lddc, dA, ldda );
