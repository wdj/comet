    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    double *dA;
    if (MAGMA_tally4_SUCCESS != magma_tally4_dmalloc( &dA, (n + 2*nb)*ldda )) {
    ...
    if (upper) {
        ...
        if (1 <= n-nb) {
            ...
            magma_tally4_dsetmatrix_async( (n-nb), (n-nb),
                                    A(nb+1, nb+1),  lda,
        ...
        for (i = 1; i <= n-nb; i += nb) {
             ...
             if (i > 1 ) {
                 ...
                 magma_tally4_dgetmatrix_async( (pm+pn), pn,
                                         dA( i, i), ldda,
                                         A ( i, i), lda, stream[1] );
                 trace_gpu_end( 0, 1 );

                 trace_gpu_start( 0, 2, "her2k", "her2k" );
                 magma_tally4_dsyr2k(Magma_tally4Lower, Magma_tally4NoTrans, pm_old-pn_old, pn_old, c_neg_one,
             ...
             magma_tally4_dsetmatrix_async( pm, pk,
                                     A(indi, indj),  lda,
                                     dA(indi, indj), ldda, stream[0] );

             /* Send the triangular factor T to the GPU */
             magma_tally4_dsetmatrix_async( pk, pk,
                                     hT,       nb,
                                     dT(i), lddt, stream[0] );
             trace_gpu_end( 0, 0 );
             ...
             // because below we made a restore dq_to_panel_tally4 and this restore need
             ...
             magma_tally4_dgemm(Magma_tally4NoTrans, Magma_tally4NoTrans, pm, pk, pk,
             ...
             magma_tally4_dsymm(Magma_tally4Left, uplo, pm, pk,
             ...
             magma_tally4_dgemm(Magma_tally4ConjTrans, Magma_tally4NoTrans, pk, pk, pm,
                         c_one, dwork, pm,
                         dW, pm,
             ...
             if (i + nb <= n-nb) {
                 ...
                 magma_tally4_dgemm(Magma_tally4NoTrans, Magma_tally4ConjTrans, pm, pn, pn, c_neg_one,
                             dA(indi, indj), ldda,
                             dW,                 pm, c_one,
                             dA(indi, indi), ldda);
                 trace_gpu_end( 0, 2 );
                 ...
                 magma_tally4_dsyr2k(Magma_tally4Lower, Magma_tally4NoTrans, pk, pk, c_neg_one,
                              dA(indi, indj), ldda,
                              dW,                 pm, d_one,
                              dA(indi, indi), ldda);
                 trace_gpu_end( 0, 2 );
