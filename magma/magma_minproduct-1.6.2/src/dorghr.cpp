/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zunghr.cpp normal z -> d, Fri Jan 30 19:00:18 2015
    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nh > 0) {
        ...
        magma_minproduct_dorgqr(nh, nh, nh,
                     A(ilo, ilo), lda,
