    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    timer_start( time );
    magma_tally2_cheevdx_2stage(jobz, range, uplo, n, A, lda, vl, vu, il, iu, m, w, work, lwork, rwork, lrwork, iwork, liwork, info);
    timer_stop( time );
    ...
    if (wantz && *info == 0) {
        ...
        magma_tally2_csetmatrix( n, *m, A, lda, dA, ldda );
        magma_tally2_csetmatrix( n,  n, B, ldb, dB, lddb );
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally2_ctrsm(Magma_tally2Left, uplo, trans, Magma_tally2NonUnit, n, *m, c_one, dB, lddb, dA, ldda);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally2_ctrmm(Magma_tally2Left, uplo, trans, Magma_tally2NonUnit, n, *m, c_one, dB, lddb, dA, ldda);
        }

        magma_tally2_cgetmatrix( n, *m, dA, ldda, A, lda );
