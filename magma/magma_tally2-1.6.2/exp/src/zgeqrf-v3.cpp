...
magma_tally2_zgeqrf3(magma_tally2_context *cntxt, magma_tally2_int_t m, magma_tally2_int_t n, 
...
/*  -- MAGMA_tally2 (version 1.6.1) --
    ...
    *info = 0;
    ...
    /* Use MAGMA_tally2 code to factor left portion of matrix, waking up threads 
       along the way to perform updates on the right portion of matrix */
    magma_tally2_zgeqrf2(cntxt, m, n - qr_params->nthreads * qr_params->ob, 
    ...
    for (k = 0; k < qr_params->np_gpu-1; k++){
      ...
      zq_to_panel_tally2(Magma_tally2Upper, ib, a + k*qr_params->nb*lda + k*qr_params->nb, lda, 
    ...
    /* Flag MAGMA_tally2 code to internally unzero upper part of each panel */
    qr_params->flag = 1;
    
    /* Use MAGMA_tally2 code to perform final factorization if necessary */
    if (qr_params->m > (qr_params->n - (qr_params->nthreads*qr_params->ob)))
      ...
      magma_tally2_zgeqrf2(cntxt, M, N,
