...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_Bmagma_tally3,  float, ldb*N   );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally3_ssetmatrix( Ak, Ak, h_A, lda, d_A, ldda );
            magma_tally3_ssetmatrix( M, N, h_B, ldb, d_B, lddb );
            
            magma_tally3_time = magma_tally3_sync_wtime( NULL );
            magma_tally3blas_strsm( opts.side, opts.uplo, opts.transA, opts.diag, 
                             M, N,
                             alpha, d_A, ldda,
                                    d_B, lddb );
            ...
            magma_tally3_sgetmatrix( M, N, d_B, lddb, h_Bmagma_tally3, ldb );
            ...
            cublasStrsm( opts.handle, cublas_side_const_tally3(opts.side), cublas_uplo_const_tally3(opts.uplo),
            ...
            magma_tally3_sgetmatrix( M, N, d_B, lddb, h_Bcublas, ldb );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_strsm( lapack_side_const_tally3(opts.side), lapack_uplo_const_tally3(opts.uplo),
                               lapack_trans_const_tally3(opts.transA), lapack_diag_const_tally3(opts.diag), 
                               &M, &N,
                               &alpha, h_A, &lda,
                                       h_Blapack, &ldb );
            ...
            blasf77_strmm( lapack_side_const_tally3(opts.side), lapack_uplo_const_tally3(opts.uplo),
                           lapack_trans_const_tally3(opts.transA), lapack_diag_const_tally3(opts.diag), 
                           &M, &N,
                           &alpha2, h_A, &lda,
                                    h_X, &ldb );
            ...
            normX = lapackf77_slange( "M", &M, &N, h_Bmagma_tally3, &ldb, work );
