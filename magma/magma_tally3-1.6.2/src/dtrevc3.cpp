...
/**
    ...
    ********************************************************************/
extern "C"
magma_tally3_int_t magma_tally3_dtrevc3(
...
#define work(i,j) (work + (i) + (j)*n)
    ...
    magma_tally3_int_t i, ierr, ii, ip, is, j, k, ki, ki2,
    ...
    if ( rightv ) {
        ...
        for( ki=n-1; ki >= 0; --ki ) {
            ...
            if ( ip == 0 ) {
                ...
                magma_tally3_dlaqtrsd( Magma_tally3NoTrans, ki+1, T(0,0), ldt,
    ...
    if ( leftv ) {
        ...
        for( ki=0; ki < n; ++ki ) {
            ...
            if ( ip == 0 ) {
                ...
                magma_tally3_dlaqtrsd( Magma_tally3Trans, n-ki, T(ki,ki), ldt,
