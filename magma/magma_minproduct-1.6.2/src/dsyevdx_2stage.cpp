    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_minproduct_dstedx(range, n, vl, vu, il, iu, w, &work[inde],
        ...
        if (MAGMA_minproduct_SUCCESS != magma_minproduct_dmalloc( &dZ, *m*lddz)) {
            *info = MAGMA_minproduct_ERR_DEVICE_ALLOC;
            return *info;
        }
        ...
        magma_minproduct_dbulge_back(uplo, n, nb, *m, Vblksiz, &work[indwrk + n * (il-1)], n, dZ, lddz,
        ...
        magma_minproduct_dormqr_gpu_2stages(Magma_minproductLeft, Magma_minproductNoTrans, n-nb, *m, n-nb, dA+nb, ldda,
                                 dZ+nb, n, dT1, nb, info);

        magma_minproduct_dgetmatrix( n, *m, dZ, lddz, A, lda );
