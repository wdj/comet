...
__global__ void
magma_tally3_cbicgmerge1_kernel(  
    int n, 
    ...
    magma_tally3FloatComplex * p )
{
    ...
    magma_tally3FloatComplex beta=skp[1];
...
magma_tally3_cbicgmerge1(  
    ...
    magma_tally3_cbicgmerge1_kernel<<<Gs, Bs, 0>>>( n, skp, v, r, p );
...
__global__ void
magma_tally3_cbicgmerge2_kernel(  
    int n, 
    magma_tally3FloatComplex * skp, 
    magma_tally3FloatComplex * r,
    magma_tally3FloatComplex * v, 
    ...
    magma_tally3FloatComplex_ptr s )
{
    ...
    magma_tally3_cbicgmerge2_kernel<<<Gs, Bs, 0>>>( n, skp, r, v, s );
...
__global__ void
magma_tally3_cbicgmerge3_kernel(  
    int n, 
    magma_tally3FloatComplex * skp, 
    magma_tally3FloatComplex * p,
    magma_tally3FloatComplex * se,
    ...
    magma_tally3FloatComplex_ptr r )
{
    ...
    dim3 Bs( BLOCK_SIZE );
    dim3 Gs( magma_tally3_ceildiv( n, BLOCK_SIZE ) );
    magma_tally3_cbicgmerge3_kernel<<<Gs, Bs, 0>>>( n, skp, p, s, t, x, r );
...
__global__ void
magma_tally3_cbicgmerge4_kernel_1(  
    magma_tally3FloatComplex * skp )
{
    int i = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void
magma_tally3_cbicgmerge4_kernel_2(  
    magma_tally3FloatComplex * skp )
{
    int i = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void
magma_tally3_cbicgmerge4_kernel_3(  
    magma_tally3FloatComplex * skp )
{
    int i = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    magma_tally3FloatComplex_ptr skp )
{
    ...
    dim3 Gs( 1 );
    if( type == 1 )
        magma_tally3_cbicgmerge4_kernel_1<<<Gs, Bs, 0>>>( skp );
    else if( type == 2 )
        magma_tally3_cbicgmerge4_kernel_2<<<Gs, Bs, 0>>>( skp );
    else if( type == 3 )
        magma_tally3_cbicgmerge4_kernel_3<<<Gs, Bs, 0>>>( skp );
    else
