...
///////////////////////////////////////////////////////////////////////////////////////
__global__ void kernel_set_pointer(magma_tally4DoubleComplex **output_array,
...
extern "C"
void zset_pointer(magma_tally4DoubleComplex **output_array,
                 magma_tally4DoubleComplex *input,
                 magma_tally4_int_t lda,
                 magma_tally4_int_t row, magma_tally4_int_t column, 
                 magma_tally4_int_t batchSize,
...
__global__ void zdisplace_pointers_kernel(magma_tally4DoubleComplex **output_array,
               magma_tally4DoubleComplex **input_array, magma_tally4_int_t lda,
               magma_tally4_int_t row, magma_tally4_int_t column)
{
      magma_tally4DoubleComplex *inpt = input_array[blockIdx.x];
      output_array[blockIdx.x] = &inpt[row + column * lda];
}


extern "C"
void zset_array(magma_tally4DoubleComplex **output_array,
               magma_tally4DoubleComplex **input_array, magma_tally4_int_t lda,
               magma_tally4_int_t row, magma_tally4_int_t column, 
...
extern "C"
void magma_tally4_zdisplace_pointers(magma_tally4DoubleComplex **output_array,
               magma_tally4DoubleComplex **input_array, magma_tally4_int_t lda,
               magma_tally4_int_t row, magma_tally4_int_t column, 
               magma_tally4_int_t batchCount, magma_tally4_queue_t queue)
