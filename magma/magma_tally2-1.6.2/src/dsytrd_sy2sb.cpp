    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    double *dA;
    if (MAGMA_tally2_SUCCESS != magma_tally2_dmalloc( &dA, (n + 2*nb)*ldda )) {
    ...
    if (upper) {
        ...
        if (1 <= n-nb) {
            ...
            magma_tally2_dsetmatrix_async( (n-nb), (n-nb),
                                    A(nb+1, nb+1),  lda,
        ...
        for (i = 1; i <= n-nb; i += nb) {
             ...
             if (i > 1 ) {
                 ...
                 magma_tally2_dsyr2k(Magma_tally2Lower, Magma_tally2NoTrans, pm_old-pn_old, pn_old, c_neg_one,
             ...
             // because below we made a restore dq_to_panel_tally2 and this restore need
