...
*/
__global__ void
csymmetrize_tiles_lower( int m, magma_tally4FloatComplex *dA, int ldda, int mstride, int nstride )
{
    ...
    magma_tally4FloatComplex *dAT = dA;
    if ( i < m ) {
        dA  += i;
        dAT += i*ldda;
        magma_tally4FloatComplex *dAend = dA + i*ldda;
        while( dA < dAend ) {
...
__global__ void
csymmetrize_tiles_upper( int m, magma_tally4FloatComplex *dA, int ldda, int mstride, int nstride )
{
    // shift dA to tile's top-left corner
    dA += blockIdx.x*(mstride + nstride*ldda);
...
/**
    @see magma_tally4blas_csymmetrize_tiles_q
    @ingroup magma_tally4_caux2
    ********************************************************************/
extern "C" void
magma_tally4blas_csymmetrize_tiles(
    ...
    magma_tally4_int_t ntile, magma_tally4_int_t mstride, magma_tally4_int_t nstride )
{
    magma_tally4blas_csymmetrize_tiles_q( uplo, m, dA, ldda, ntile, mstride, nstride, magma_tally4_stream );
}
