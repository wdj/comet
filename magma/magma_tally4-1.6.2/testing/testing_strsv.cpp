...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally4_ssetvector( N, h_x, 1, d_x, 1 );
            
            cublas_time = magma_tally4_sync_wtime( NULL );
            cublasStrsv( opts.handle, cublas_uplo_const_tally4(opts.uplo),
            ...
            magma_tally4_sgetvector( N, d_x, 1, h_xcublas, 1 );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_strsv( lapack_uplo_const_tally4(opts.uplo), lapack_trans_const_tally4(opts.transA), lapack_diag_const_tally4(opts.diag),
                               &N,
                               h_A, &lda,
                               h_x, &ione );
            ...
            blasf77_strmv( lapack_uplo_const_tally4(opts.uplo), lapack_trans_const_tally4(opts.transA), lapack_diag_const_tally4(opts.diag),
                           &N,
                           h_A, &lda,
                           h_xcublas, &ione );
