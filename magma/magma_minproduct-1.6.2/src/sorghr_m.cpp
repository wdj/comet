/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zunghr_m.cpp normal z -> s, Fri Jan 30 19:00:18 2015
    ...
    magma_minproduct_int_t *info)
{
    ...
    magma_minproduct_int_t i, j, nh, iinfo;
    ...
    *info = 0;
    ...
    if (nh > 0) {
        ...
        magma_minproduct_sorgqr_m( nh, nh, nh,
                        A(ilo, ilo), lda,
