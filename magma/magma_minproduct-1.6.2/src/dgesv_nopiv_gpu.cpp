/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zgesv_nopiv_gpu.cpp normal z -> d, Fri Jan 30 19:00:14 2015
*/
    ...
    magma_minproduct_int_t *info )
{
    *info = 0;
    ...
    magma_minproduct_dgetrf_nopiv_gpu( n, n, dA, ldda, info );
    if ( *info == MAGMA_minproduct_SUCCESS ) {
        magma_minproduct_dgetrs_nopiv_gpu( Magma_minproductNoTrans, n, nrhs, dA, ldda, dB, lddb, info );
    }
