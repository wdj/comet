...
/**
    Purpose
    -------
    magma_minproductblas_zhemv_work performs the matrix-vector operation:
    ...
    MAGMA_minproduct implements zhemv through two steps:
    ...
    magma_minproductblas_zhemv is a wrapper routine allocating the workspace inside the
    routine and provides the same interface as cublas.
    
    If users need to call zhemv frequently, we suggest using
    magma_minproductblas_zhemv_work instead of magma_minproductblas_zhemv. As the overhead to
    allocate and free in device memory in magma_minproductblas_zhemv would hurt performance.
    ...
    magma_minproduct_queue_t queue )
{
    ...
    if ( arch < 200 ) {
        magma_minproduct_zhemv( uplo, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
...
// end magma_minproductblas_zhemv_work


/**
    Purpose
    -------
    magma_minproductblas_zhemv performs the matrix-vector operation:
    ...
    magma_minproductDoubleComplex_ptr dy, magma_minproduct_int_t incy)
{
    ...
    magma_minproductblas_zhemv_work( uplo, n, alpha, dA, ldda, dx, incx, beta, dy, incy,
...
// end magma_minproductblas_zhemv
