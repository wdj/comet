/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from testing_zposv.cpp normal z -> s, Fri Jan 30 19:00:24 2015
*/
// includes, system
#include <stdio.h>
#include <stdlib.h>
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_R, float, lda*N         );
            ...
            magma_tally4_sposv( opts.uplo, N, opts.nrhs, h_R, lda, h_X, ldb, &info );
            ...
            blasf77_sgemm( Magma_tally4NoTransStr, Magma_tally4NoTransStr, &N, &opts.nrhs, &N,
                           &c_one,     h_A, &lda,
                                       h_X, &ldb,
                           &c_neg_one, h_B, &ldb );
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_sposv( lapack_uplo_const_tally4(opts.uplo), &N, &opts.nrhs, h_A, &lda, h_B, &ldb, &info );
