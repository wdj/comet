/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zgeqr2x_gpu-v2.cpp normal z -> c, Fri Jan 30 19:00:14 2015
    ...
    magma_minproduct_int_t *info)
{
    ...
    magma_minproductFloatComplex *work = (magma_minproductFloatComplex *)dwork;
    magma_minproductFloat_ptr dnorm = dwork + 4*(n);
    ...
    *info = 0;
    ...
    for (i = 0; i < k; ++i) {
        ...
        if (i > 0) {
            magma_minproduct_clarfbx_gpu(m, i, dA(0, 0), ldda,
                              dT, k, dA(0, i), work);
