/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from magma_minproduct_zmlumerge.cpp normal z -> d, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
    ...
    magma_minproduct_queue_t queue )
{
    ...
    if( L.storage_type == Magma_minproduct_CSR && U.storage_type == Magma_minproduct_CSR ){
        if( L.memory_location == Magma_minproduct_CPU && U.memory_location == Magma_minproduct_CPU ){
            ...
            CHECK( magma_minproduct_dmtransfer( L, A, Magma_minproduct_CPU, Magma_minproduct_CPU, queue ));
