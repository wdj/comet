    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb == 1 || nb > nh) {
        ...
        if (MAGMA_minproduct_SUCCESS != magma_minproduct_zmalloc( &dwork, 2*nb*ldda + n*ldda + nb*nb )) {
        ...
        magma_minproductDoubleComplex *dT = dwork + nb*ldda*2 + n*ldda;
        ldwork = ldda;
        ...
        for (i = ilo; i < ihi-1 - nb; i += nb) {
            ...
            magma_minproduct_zsetmatrix( nb, nb, T, nb, dT, nb );
