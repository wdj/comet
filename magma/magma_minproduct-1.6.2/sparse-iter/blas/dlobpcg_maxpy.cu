...
__global__ void
magma_minproduct_dlobpcg_maxpy_kernel( 
...
/**
    ...
    It replaces:
            magma_minproduct_daxpy(m*n, c_one, Y, 1, X, 1);
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproduct_dlobpcg_maxpy_kernel<<< grid, threads, 0, queue >>>
