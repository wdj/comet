...
int main(  int argc, char** argv )
{
    ...
    while( i < argc ) {
        ...
        // init CPU vectors
        CHECK( magma_tally2_svinit( &hx, Magma_tally2_CPU, m, n, c_one, queue ));
        CHECK( magma_tally2_svinit( &hy, Magma_tally2_CPU, m, n, c_zero, queue ));

        // init DEV vectors
        CHECK( magma_tally2_svinit( &dx, Magma_tally2_DEV, m, n, c_one, queue ));
        CHECK( magma_tally2_svinit( &dy, Magma_tally2_DEV, m, n, c_zero, queue ));
        ...
        CHECK( magma_tally2_svinit( &dy, Magma_tally2_DEV, dx.num_rows, dx.num_cols, c_zero, queue ));
        // SpMV on GPU (SELLP)
        start = magma_tally2_sync_wtime( queue );
        for (j=0; j<10; j++)
