...
int main( int argc, char** argv )
{
    ...
    magma_tally2_int_t m, n, lda, ldda, size, info;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            gbytes = (real_Double_t) m*n * (sizeof(magma_tally2DoubleComplex) + sizeof(magma_tally2FloatComplex)) / 1e9;
            ...
            magma_tally2_csetmatrix( m, n, SA, lda, dSA, ldda );
            ...
            /* ====================================================================
               Performs operation using MAGMA_tally2 zlag2c
               =================================================================== */            
            gpu_time = magma_tally2_sync_wtime(0);
            magma_tally2blas_zlag2c( m, n, dA, ldda, dSA, ldda, &info );
            gpu_time = magma_tally2_sync_wtime(0) - gpu_time;
            gpu_perf = gbytes / gpu_time;
            if (info != 0)
                printf("magma_tally2blas_zlag2c returned error %d: %s.\n",
                       (int) info, magma_tally2_strerror( info ));
            
            magma_tally2_cgetmatrix( m, n, dSA, ldda, SR, lda );
            ...
            /* ====================================================================
               Performs operation using MAGMA_tally2 clag2z
               =================================================================== */
            magma_tally2_csetmatrix( m, n, SA, lda, dSA, ldda );
            
            gpu_time = magma_tally2_sync_wtime(0);
            magma_tally2blas_clag2z( m, n, dSA, ldda, dA, ldda, &info );
            gpu_time = magma_tally2_sync_wtime(0) - gpu_time;
            gpu_perf = gbytes / gpu_time;
            if (info != 0)
                printf("magma_tally2blas_clag2z returned error %d: %s.\n",
                       (int) info, magma_tally2_strerror( info ));
            
            magma_tally2_zgetmatrix( m, n, dA, ldda, R, lda );
