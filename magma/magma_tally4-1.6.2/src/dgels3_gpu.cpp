    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally4_SUCCESS != magma_tally4_dmalloc( &dT, ldtwork )) {
        *info = MAGMA_tally4_ERR_DEVICE_ALLOC;
        return *info;
    }
    
    magma_tally4_dmalloc_cpu( &tau, k );
    if ( tau == NULL ) {
    ...
    magma_tally4_dgeqrf3_gpu( m, n, dA, ldda, tau, dT, info );
    if ( *info == 0 ) {
        magma_tally4_dgeqrs3_gpu( m, n, nrhs,
                           dA, ldda, tau, dT,
