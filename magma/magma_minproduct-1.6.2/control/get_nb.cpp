...
magma_minproduct_int_t magma_minproduct_get_zpotrf_right_nb( magma_minproduct_int_t m )
{
    return 128;
}

magma_minproduct_int_t magma_minproduct_get_cpotrf_right_nb( magma_minproduct_int_t m )
{
    return 128;
}

magma_minproduct_int_t magma_minproduct_get_dpotrf_right_nb( magma_minproduct_int_t m )
{
    return 320;
}

magma_minproduct_int_t magma_minproduct_get_spotrf_right_nb( magma_minproduct_int_t m )
{
    return 128;
}
