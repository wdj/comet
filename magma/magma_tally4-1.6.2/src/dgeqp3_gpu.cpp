    ...
    magma_tally4_int_t *info )
{
    ...
    *info = 0;
    ...
    #endif
    magma_tally4Double_ptr df;
    if (MAGMA_tally4_SUCCESS != magma_tally4_dmalloc( &df, (n+1)*nb )) {
    ...
    if (nfxd < minmn) {
        ...
        magma_tally4blas_dnrm2_cols(sm, sn, dA(nfxd,nfxd), ldda, &rwork[nfxd]);
        ...
        //if (nb < sminmn)
        {
            ...
            while(j < topbmn) {
                ...
                //magma_tally4_dlaqps_gpu    // this is a cpp-file
                magma_tally4_dlaqps2_gpu   // this is a cuda-file
                    ( m, n_j, j, jb, &fjb,
                      dA(0, j), ldda,
