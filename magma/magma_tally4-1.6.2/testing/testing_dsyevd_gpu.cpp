...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally4_dsyevd_gpu( opts.jobz, opts.uplo,
                              N, NULL, ldda, NULL,
                              NULL, lda,
                              aux_work,  -1,
                              #ifdef COMPLEX
                              ...
                              aux_iwork, -1,
                              &info );
            lwork  = (magma_tally4_int_t) MAGMA_tally4_D_REAL( aux_work[0] );
            #ifdef COMPLEX
            ...
            if ( opts.warmup ) {
                magma_tally4_dsyevd_gpu( opts.jobz, opts.uplo,
                                  ...
                                  &info );
                if (info != 0)
                    printf("magma_tally4_dsyevd_gpu returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_tally4NoVec ) {
                ...
                //
                //magma_tally4_dsetmatrix( N, N, h_A, lda, d_R, ldda );
                //magma_tally4_dsyevd_gpu( Magma_tally4NoVec, opts.uplo,
                //                  N, d_R, ldda, w2,
                //                  h_R, lda,
                //                  h_work, lwork,
                //                  #ifdef COMPLEX
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_dsyevd( lapack_vec_const_tally4(opts.jobz), lapack_uplo_const_tally4(opts.uplo),
                                  &N, h_A, &lda, w2,
                                  h_work, &lwork,
                                  #ifdef COMPLEX
                                  rwork, &lrwork,
