    ...
    magma_tally2_int_t *info)
{
    ...
    *info  = 0;
    ...
    if ( nb >= k ) {
        /* Use CPU code */
        lapackf77_sormql( lapack_side_const_tally2(side), lapack_trans_const_tally2(trans),
        ...
        magma_tally2_smalloc_pinned( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_tally2_ssetmatrix( m, n, C, ldc, dC, lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set lower triangle of panel in A to identity,
               ...
               3) restore A                                      */
            spanel_to_q_tally2( Magma_tally2Lower, ib, A(nq_i-ib,i), lda, T2 );
            magma_tally2_ssetmatrix( nq_i,  ib, A(0,      i), lda, dV, nq_i );
            sq_to_panel_tally2( Magma_tally2Lower, ib, A(nq_i-ib,i), lda, T2 );
        ...
        magma_tally2_sgetmatrix( m, n, dC, lddc, C, ldc );
