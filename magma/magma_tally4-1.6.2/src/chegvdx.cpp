    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    timer_start( time );
    magma_tally4_cheevdx_gpu( jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, mout, w, A, lda,
    ...
    if (wantz && *info == 0) {
        ...
        if (dB == NULL) {
            if (MAGMA_tally4_SUCCESS != magma_tally4_cmalloc( &dB, n*lddb ) ) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally4_ctrsm( Magma_tally4Left, uplo, trans, Magma_tally4NonUnit,
        ...
        magma_tally4_cgetmatrix( n, *mout, dA, ldda, A, lda );
