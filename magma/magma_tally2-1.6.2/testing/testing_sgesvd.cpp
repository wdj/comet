        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            switch( opts.svd_work ) {
                case 0: {  // query for workspace size
                    lwork = -1;
                    magma_tally2_sgesvd( jobu, jobvt, M, N,
                                  h_R, lda, S1, U, ldu, VT, ldv, dummy, lwork,
                                  #ifdef COMPLEX
                                  rwork,
                                  #endif
                                  &info );
                    lwork = (int) MAGMA_tally2_S_REAL( dummy[0] );
                    break;
                }
            ...
            if (info != 0)
                printf("magma_tally2_sgesvd returned error %d: %s.\n",
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_sgesvd( lapack_vec_const_tally2(jobu), lapack_vec_const_tally2(jobvt), &M, &N,
