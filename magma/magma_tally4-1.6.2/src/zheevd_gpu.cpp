    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally4_zsetmatrix( n, n, &work[indwrk], n, dC, lddc );

        magma_tally4_zunmtr_gpu( Magma_tally4Left, uplo, Magma_tally4NoTrans, n, n, dA, ldda, &work[indtau],
                          dC, lddc, wA, ldwa, &iinfo );

        magma_tally4_zcopymatrix( n, n, dC, lddc, dA, ldda );
