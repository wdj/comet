...
// ----------------------------------------
// CUDA kernel for magma_minproduct_clarfg.
    ...
    magma_minproductFloatComplex* dtau )
{
    ...
    __shared__ magma_minproductFloatComplex sscale2;
...
/**
    ...
    @ingroup magma_minproduct_caux1
    ********************************************************************/
extern "C"
void magma_minproductblas_clarfg_q(
...
/**
    @see magma_minproductblas_clarfg_q
    @ingroup magma_minproduct_caux1
    ********************************************************************/
extern "C"
void magma_minproductblas_clarfg(
    magma_minproduct_int_t n,
    magma_minproductFloatComplex_ptr dalpha,
    magma_minproductFloatComplex_ptr dx, magma_minproduct_int_t incx,
    magma_minproductFloatComplex_ptr dtau )
