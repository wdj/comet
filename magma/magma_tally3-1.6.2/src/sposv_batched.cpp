/*
    -- MAGMA_tally3 (version 1.6.1) --
       ...
       @generated from zposv_batched.cpp normal z -> s, Fri Jan 30 19:00:19 2015
*/
                  ...
                  magma_tally3_int_t batchCount, magma_tally3_queue_t queue)
{
    ...
    info = magma_tally3_spotrf_batched( uplo, n, dA_array, ldda, dinfo_array, batchCount, queue);
    ...
    {
        if(cpu_info[i] != 0 ){
            printf("magma_tally3_spotrf_batched matrix %d returned error %d\n",i, (int)cpu_info[i] );
            info = cpu_info[i];
            free (cpu_info);
            return info;
        }
    ...
    info = magma_tally3_spotrs_batched( uplo, n, nrhs, dA_array, ldda, dB_array, lddb,  batchCount, queue );
    return info;
}
