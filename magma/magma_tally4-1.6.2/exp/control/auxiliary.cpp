...
#if defined(ADD_)
#    define magma_tally4_gettime_f        magma_tally4_gettime_f_
#    define magma_tally4_gettimervalue_f  magma_tally4_gettimervalue_f_
...
extern "C"
void magma_tally4_gettime_f(unsigned int *time) {
  magma_tally4_timestr_t tmp = get_current_time();
  time[0] = tmp.sec;
  time[1] = tmp.usec;
}
...
extern "C"
void magma_tally4_gettimervalue_f(unsigned int *start, unsigned int *end, double *result) {
  magma_tally4_timestr_t time1, time2;
  time1.sec  = start[0];
  time1.usec = start[1];
  time2.sec  = end[0];
  time2.usec = end[1];
...
*/
extern "C"
int sp_cat(char *lp, char *rpp[], magma_tally4_int_t *rnp, magma_tally4_int_t*np, magma_tally4_int_t ll)
{
  magma_tally4_int_t i, n, nc;
  char *f__rp;
