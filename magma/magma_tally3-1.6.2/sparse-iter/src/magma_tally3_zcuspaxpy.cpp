...
magma_tally3_zcuspaxpy(
    magma_tally3DoubleComplex *alpha, magma_tally3_z_matrix A,
    magma_tally3DoubleComplex *beta, magma_tally3_z_matrix B,
    ...
    magma_tally3_queue_t queue )
{
    ...
    if (    A.memory_location == Magma_tally3_DEV
        ...
        CHECK( magma_tally3_zmalloc( &C.dval, C.nnz ));
        ...
        CHECK( magma_tally3_zmtransfer( C, AB, Magma_tally3_DEV, Magma_tally3_DEV, queue ));
    }
    else {
