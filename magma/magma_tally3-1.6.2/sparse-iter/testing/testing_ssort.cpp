...
int main(  int argc, char** argv )
{
    ...
    magma_tally3_s_matrix A={Magma_tally3_CSR};
    ...
    printf("sorting...");
    CHECK( magma_tally3_sindexsort(x, 0, n-1, queue ));
    printf("done.\n\n");
    ...
    while(  i < argc ) {
        ...
        CHECK( magma_tally3_sdomainoverlap( A.num_rows, &num_ind, A.row, A.col, x, queue ));
