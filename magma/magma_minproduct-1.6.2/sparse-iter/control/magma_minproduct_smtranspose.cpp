/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from magma_minproduct_zmtranspose.cpp normal z -> s, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
       @author Mark Gates
    ...
    magma_minproduct_queue_t queue )
{
    ...
    CHECK( magma_minproduct_smalloc_cpu( &csc_values, nnz ) );
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproduct_s_matrix ACSR={Magma_minproduct_CSR}, BCSR={Magma_minproduct_CSR};
    ...
    if( A.storage_type == Magma_minproduct_CSR && A.memory_location == Magma_minproduct_DEV ) {
        ...
        CHECK( magma_minproduct_smtransfer( A, &A_d, A.memory_location, Magma_minproduct_DEV, queue ));
        CHECK( magma_minproduct_s_cucsrtranspose( A_d, &B_d, queue ));
        CHECK( magma_minproduct_smtransfer( B_d, B, Magma_minproduct_DEV, A.memory_location, queue ));
                
    }else {
        CHECK( magma_minproduct_smconvert( A, &ACSR, A.storage_type, Magma_minproduct_CSR, queue ));
        CHECK( magma_minproduct_s_cucsrtranspose( ACSR, &BCSR, queue ));
        CHECK( magma_minproduct_smconvert( BCSR, B, Magma_minproduct_CSR, A.storage_type, queue ));
    }
cleanup:
    ...
    magma_minproduct_smfree( &BCSR, queue );
    if( info != 0 ){
