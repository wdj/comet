...
/* ////////////////////////////////////////////////////////////////////////////
   -- Testing magma_tally4_dsyr2k_mgpu
*/
int main( int argc, char** argv)
{
    ...
    double alpha = MAGMA_tally4_D_MAKE( 1.2345, 4.321 );
    double beta = 3.14159;
    
    real_Double_t    gflops, gpu_perf, cpu_perf, gpu_time, cpu_time;
    double           error, work[1];
    double *hA, *hR, *hR2, *hV, *hW;
    magma_tally4Double_ptr dV[Magma_tally4MaxGPUs], dW[Magma_tally4MaxGPUs], dA[Magma_tally4MaxGPUs];
    ...
    printf( "version 1: magma_tally4blas_dsyr2k_mgpu2     %s\n", (opts.version==1 ? "(enabled)" : ""));
    printf( "version 2: magma_tally4blas_dsyr2k_mgpu_spec %s\n", (opts.version==2 ? "(enabled)" : ""));
#ifdef ICHI
    printf( "version 3: magma_tally4_dsyr2k_mgpu (Ichi)   %s\n", (opts.version==3 ? "(enabled)" : ""));
#endif
    printf( "\n" );
        ...
        for( int offset = 0; offset < n; offset += min(k,nb) ) {
            for( int iter = 0; iter < opts.niter; ++iter ) {
                ...
                /* ====================================================================
                   ...
                   =================================================================== */
                magma_tally4_dsetmatrix_1D_col_bcyclic( n, n, hA, lda, dA, ldda, ngpu, nb );
                for( int d = 0; d < ngpu; ++d ) {
                    magma_tally4_setdevice( d );
                    dW[d] = dV[d] + ldda*k;
                    magma_tally4_dsetmatrix( n, k, hV, lda, dV[d], ldda );
                    magma_tally4_dsetmatrix( n, k, hW, lda, dW[d], ldda );
                }
                ...
                magma_tally4_dgetmatrix_1D_col_bcyclic( n, n, dA, ldda, hR, lda, ngpu, nb );
