/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zmcsrpass_gpu.cpp normal z -> d, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_tally2_queue_t queue )
{
    ...
    magma_tally2_d_matrix A_DEV={Magma_tally2_CSR}, A_CSR={Magma_tally2_CSR};
    ...
    if ( A.memory_location == Magma_tally2_DEV && A.storage_type == Magma_tally2_CSR ) {
        ...
        *row = A.drow;
        ...
        CHECK( magma_tally2_dmconvert( A, &A_CSR, A.storage_type, Magma_tally2_CSR, queue ));
        CHECK( magma_tally2_dmtransfer( A_CSR, &A_DEV, A.memory_location, Magma_tally2_DEV, queue ));
        magma_tally2_dcsrget_gpu( A_DEV, m, n, row, col, val, queue );
    }
    
cleanup:
    magma_tally2_dmfree( &A_CSR, queue );
    magma_tally2_dmfree( &A_DEV, queue );
    return info;
}
