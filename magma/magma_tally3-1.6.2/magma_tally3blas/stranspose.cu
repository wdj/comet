...
/**
    @see magma_tally3blas_stranspose_q
    @ingroup magma_tally3_saux2
    ********************************************************************/
extern "C" void
magma_tally3blas_stranspose(
    ...
    magma_tally3Float_ptr       dAT, magma_tally3_int_t lddat )
{
    magma_tally3blas_stranspose_q( m, n, dA, ldda, dAT, lddat, magma_tally3_stream );
}
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_tally3blas_stranspose_batched_q(
    magma_tally3_int_t m, magma_tally3_int_t n,
    float **dA_array,  magma_tally3_int_t ldda,
    float **dAT_array, magma_tally3_int_t lddat, magma_tally3_int_t batchCount, magma_tally3_queue_t queue )
{
    magma_tally3_int_t info = 0;
    if ( m < 0 )
        info = -1;
...
/**
    @see magma_tally3blas_stranspose_batched_q
    @ingroup magma_tally3_saux2
    ********************************************************************/
extern "C" void
...
{
    magma_tally3blas_stranspose_batched_q( m, n, dA_array, ldda, dAT_array, lddat, batchCount, magma_tally3_stream );
}
