    ...
    magma_tally4DoubleComplex *A, int lda)
{
    ...
    magma_tally4DoubleComplex value = offdiag;
    if (threadIdx.x == k-1)
        value = diag;
...
/**
    @see magma_tally4blas_zlaset_band_q
    @ingroup magma_tally4_zaux2
    ********************************************************************/
extern "C" void
magma_tally4blas_zlaset_band(
    ...
    magma_tally4DoubleComplex_ptr dA, magma_tally4_int_t ldda)
{
    magma_tally4blas_zlaset_band_q(uplo, m, n, k, offdiag, diag, dA, ldda, magma_tally4_stream);
}
