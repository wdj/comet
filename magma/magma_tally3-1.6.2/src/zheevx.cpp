...
magma_tally3_zheevx(
    ...
    magma_tally3DoubleComplex *A, magma_tally3_int_t lda, double vl, double vu,
    magma_tally3_int_t il, magma_tally3_int_t iu, double abstol, magma_tally3_int_t *m,
    double *w, magma_tally3DoubleComplex *Z, magma_tally3_int_t ldz, magma_tally3DoubleComplex *work, magma_tally3_int_t lwork,
    ...
    magma_tally3_int_t *info)
{
    ...
    *m = 0;
    ...
    magma_tally3_zhetrd(uplo, n, A, lda, &rwork[indd], &rwork[inde], &work[indtau], &work[indwrk], llwork, &iinfo);
    ...
    if (*m == 0) {
        *info = 0;
        ...
        if (wantz) {
            ...
            magma_tally3_zunmtr(Magma_tally3Left, uplo, Magma_tally3NoTrans, n, *m, A, lda, &work[indtau],
