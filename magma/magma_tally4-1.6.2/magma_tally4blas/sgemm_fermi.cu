    ...
    magma_tally4Float_ptr       dC, magma_tally4_int_t lddc )
{
    ...
    if ( TransA == 0 && TransB == 0 ) {
        dim3 dimGrid( (m - 1)/BLK_M_nn + 1,
                      (n - 1)/BLK_N_nn + 1 );
        sgemm_kernel_fermi_nn<<< dimGrid, dimBlock, 0, magma_tally4_stream >>>(
        ...
        dim3 dimGrid( (m - 1)/BLK_M_nt + 1,
                      (n - 1)/BLK_N_nt + 1 );
        sgemm_kernel_fermi_nt<<< dimGrid, dimBlock, 0, magma_tally4_stream >>>(
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
        ...
        dim3 dimGrid( (m - 1)/BLK_M_nc + 1,
                      (n - 1)/BLK_N_nc + 1 );
        sgemm_kernel_fermi_nc<<< dimGrid, dimBlock, 0, magma_tally4_stream >>>(
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
        ...
        dim3 dimGrid( (m - 1)/BLK_M_tn + 1,
                      (n - 1)/BLK_N_tn + 1 );
        sgemm_kernel_fermi_tn<<< dimGrid, dimBlock, 0, magma_tally4_stream >>>(
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
        ...
        dim3 dimGrid( (m - 1)/BLK_M_tt + 1,
                      (n - 1)/BLK_N_tt + 1 );
        sgemm_kernel_fermi_tt<<< dimGrid, dimBlock, 0, magma_tally4_stream >>>(
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
        ...
        dim3 dimGrid( (m - 1)/BLK_M_tc + 1,
                      (n - 1)/BLK_N_tc + 1 );
        sgemm_kernel_fermi_tc<<< dimGrid, dimBlock, 0, magma_tally4_stream >>>(
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
        ...
        dim3 dimGrid( (m - 1)/BLK_M_cn + 1,
                      (n - 1)/BLK_N_cn + 1 );
        sgemm_kernel_fermi_cn<<< dimGrid, dimBlock, 0, magma_tally4_stream >>>(
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
        ...
        dim3 dimGrid( (m - 1)/BLK_M_ct + 1,
                      (n - 1)/BLK_N_ct + 1 );
        sgemm_kernel_fermi_ct<<< dimGrid, dimBlock, 0, magma_tally4_stream >>>(
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
        ...
        dim3 dimGrid( (m - 1)/BLK_M_cc + 1,
                      (n - 1)/BLK_N_cc + 1 );
        sgemm_kernel_fermi_cc<<< dimGrid, dimBlock, 0, magma_tally4_stream >>>(
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
