...
/**
    ...
    as returned by SGEQLF. Q is of order M if SIDE = Magma_tally4Left and of order N
    ...
    magma_tally4_int_t *info)
{
    ...
    *info  = 0;
    ...
    if ( nb >= k ) {
        ...
        magma_tally4_smalloc_pinned( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_tally4_ssetmatrix( m, n, C, ldc, dC, lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            magma_tally4_slarfb_gpu( side, trans, Magma_tally4Backward, Magma_tally4Columnwise,
                              mi, ni, ib,
                              dV, nq_i,
                              dT, ib,
                              dC, lddc,
        ...
        magma_tally4_sgetmatrix( m, n, dC, lddc, C, ldc );
