    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    ldda = ((n+31)/32)*32;
    nb = magma_tally4_get_zhetrf_nopiv_tally4_nb(n);
    ...
    if (upper) {
        ...
        for (j=0; j<n; j += nb) {
            ...
            zhetrf_nopiv_tally4_cpu(Magma_tally4Upper, jb, ib, A(j, j), lda, info);
            trace_cpu_end( 0 );
            if (*info != 0){
                *info = *info + j;
                break;
        ...
        for (j=0; j<n; j+=nb) {
            ...
            magma_tally4_queue_sync(stream[1]);
            trace_cpu_start( 0, "potrf", "potrf" );
            zhetrf_nopiv_tally4_cpu(Magma_tally4Lower, jb, ib, A(j, j), lda, info);
            trace_cpu_end( 0 );
            if (*info != 0){
                *info = *info + j;
                break;
