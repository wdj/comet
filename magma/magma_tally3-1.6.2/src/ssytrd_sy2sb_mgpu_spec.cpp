    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    float *dspace[Magma_tally3MaxGPUs];
    float *dwork[Magma_tally3MaxGPUs], *dworkbis[Magma_tally3MaxGPUs];
    float *dvall[Magma_tally3MaxGPUs], *dv[Magma_tally3MaxGPUs], *dw[Magma_tally3MaxGPUs];
    float *workngpu[Magma_tally3MaxGPUs+1];
    ...
    for( magma_tally3_int_t dev = 0; dev < ngpu; ++dev ) {
        ...
        magma_tally3_smalloc( &dspace[dev], devworksiz );
        magma_tally3_smalloc_pinned ( &workngpu[dev], worksiz);
    ...
    magma_tally3_smalloc_pinned ( &workngpu[ngpu], worksiz);
    float *worktest = NULL;
    //magma_tally3_smalloc_cpu( &worktest, n*nb ); // not used
    // ======================
    ...
    if (upper) {
        ...
        for (i = 1; i <= n-nb; i += nb) {
            ...
            if (i > 1 ) {
                // spanel_to_q_tally3 copy the upper oof diagonal part of
                ...
                spanel_to_q_tally3(Magma_tally3Upper, pn-1, A(i, i+1), lda, work);
                ...
                magma_tally3_sgetmatrix_async( (pm+pn), pn,
                                        dA(idev, i, di+1), ldda,
                ...
                //magma_tally3_setdevice( 0 );
                sq_to_panel_tally3(Magma_tally3Upper, pn-1, A(i, i+1), lda, work);
            }
            ...
            spanel_to_q_tally3(Magma_tally3Upper, pk, A(indi, indj), lda, work);
            ...
            for( magma_tally3_int_t dev = 0; dev < ngpu; ++dev ) {
                magma_tally3_setdevice( dev );
                // send V
                magma_tally3_ssetmatrix_async( pm, pk,
                                        A(indi, indj), lda,
                                        dv[dev], pm, queues[dev][nqueue-1] );

                // Send the triangular factor T to the GPU
                magma_tally3_ssetmatrix_async( pk, pk,
                                        hT, nb,
            ...
            for( magma_tally3_int_t dev = 0; dev < ngpu; ++dev ) {
                ...
                magma_tally3_sgemm(Magma_tally3NoTrans, Magma_tally3NoTrans, pm, pk, pk,
                        c_one, dv[dev], pm,
                        dT(dev, 1, i), lddt,
                        c_zero, dwork[dev], pm);
            }
            ...
            for( magma_tally3_int_t dev = 0; dev < ngpu; ++dev ) {
                ...
                magma_tally3_sgemm(Magma_tally3ConjTrans, Magma_tally3NoTrans, pk, pk, pm,
                            c_one, dwork[dev], pm,
                            dw[dev], pm,
            ...
            sq_to_panel_tally3(Magma_tally3Upper, pk, A(indi, indj), lda, work);
            // ===============================================
            ...
            if (i + nb <= n-nb) {
                ...
                magma_tally3_sgemm(Magma_tally3NoTrans, Magma_tally3ConjTrans, pm, pn, pn, c_neg_one,
                            dv[idev], pm,
                            dw[idev], pm, c_one,
                ...
                magma_tally3_ssyr2k(Magma_tally3Lower, Magma_tally3NoTrans, pk, pk, c_neg_one,
                             dv[idev], pm,
                             dw[idev], pm, d_one,
                             dA(idev, indi, di+1), ldda);
                ...
                spanel_to_q_tally3(Magma_tally3Upper, pk-1, A(n-pk+1, n-pk+2), lda, work);
                magma_tally3_sgetmatrix( pk, pk,
                                  dA(idev, indi, di+1), ldda,
                                  A(n-pk+1, n-pk+1),  lda );
                sq_to_panel_tally3(Magma_tally3Upper, pk-1, A(n-pk+1, n-pk+2), lda, work);
            }
