    ...
    if (nb >= k) {
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            zpanel_to_q_tally3( Magma_tally3Upper, ib, A(i,i), lda, T2 );
            magma_tally3_zsetmatrix( nq_i,  ib, A(i,i), lda, dV(0,0), nq_i );
            zq_to_panel_tally3( Magma_tally3Upper, ib, A(i,i), lda, T2 );
