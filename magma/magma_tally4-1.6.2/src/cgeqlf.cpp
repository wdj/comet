...
/**
    ...
    lwork   INTEGER
            ...
            through magma_tally4_get_cgeqlf_nb(M).
    \n
    ...
    magma_tally4_int_t *info)
{
    ...
    magma_tally4FloatComplex_ptr dA, dwork;
    ...
    *info = 0;
    ...
    if (*info == 0) {
        if (k == 0)
            ...
            work[0] = MAGMA_tally4_C_MAKE( max(n*nb, 2*nb*nb), 0 );
        }
    ...
    if (MAGMA_tally4_SUCCESS != magma_tally4_cmalloc( &dA, (n)*ldda + nb*lddwork )) {
    ...
    if ( (nb > 1) && (nb < k) ) {
        ...
        for (i = k - kk + ki; i >= k -kk; i -= nb) {
            ...
            if (i < k - kk + ki) {
                ...
                magma_tally4_cgetmatrix_async( m-rows, ib,
                                        dA(rows, n-k+i), ldda,
                ...
                magma_tally4_clarfb_gpu( Magma_tally4Left, Magma_tally4ConjTrans, Magma_tally4Backward, Magma_tally4Columnwise,
                                  rows, cols, old_ib,
            ...
            if (cols > 0) {
                ...
                lapackf77_clarft( Magma_tally4BackwardStr, Magma_tally4ColumnwiseStr,
                                  &rows, &ib,
        ...
        magma_tally4_cgetmatrix( m, nu, dA(0,0), ldda, A(0,0), lda );
    } else {
        mu = m;
        nu = n;
    }
