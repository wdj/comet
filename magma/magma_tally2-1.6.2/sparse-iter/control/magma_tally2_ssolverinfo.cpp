/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zsolverinfo.cpp normal z -> s, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
...
/**
    ...
    @param[in,out]
    precond_par magma_tally2_s_preconditioner*
    ...
    magma_tally2_queue_t queue )
{
    ...
    if ( solver_par->solver == Magma_tally2_LOBPCG ) {
        ...
        CHECK( magma_tally2_smalloc_cpu( &initial_guess, ev ));
        CHECK( magma_tally2_smalloc( &solver_par->eigenvectors, ev ));
        magma_tally2_int_t ISEED[4] = {0,0,0,1}, ione = 1;
        lapackf77_slarnv( &ione, ISEED, &ev, initial_guess );

        magma_tally2_ssetmatrix( solver_par->ev_length, solver_par->num_eigenvalues,
