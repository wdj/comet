#==============================================================================#
#                       README FILE FOR MAGMA_minproduct-SPARSE                           #
#==============================================================================#
...
2) "cd magma_minproduct-x.y.z-lll/"
...
3) compile magma_minproduct using "make -j8" (in case you want to use 8 cores...)

4) "cd sparse-iter"

5) compile magma_minproduct-sparse using "make -j8" (in case you want to use 8 cores...)
...
"--blocksize k"
    for Magma_minproduct_SELL-P: k denotes the number of rows in one slice of the matrix
                      and the number of rows assigned to one multiprocessor

"--alignment k"
    for Magma_minproduct_SELL-P: k denotes the number of threads assigned to one row
