...
//////////////////////////////////////////////////////////////
extern "C" void  magma_minproduct_dstedc_withZ(magma_minproduct_vec_t JOBZ, magma_minproduct_int_t N, double *D, double * E, double *Z, magma_minproduct_int_t LDZ)
{
    double *WORK;
    ...
    if (JOBZ == Magma_minproductVec) {
        LWORK  = 1 + 3*N + 3*N*((magma_minproduct_int_t)(log( (double)N )/log_2) + 1) + 4*N*N + 256*N;
...
//////////////////////////////////////////////////////////////
extern "C" void  magma_minproduct_dstedx_withZ(magma_minproduct_int_t N, magma_minproduct_int_t NE, double *D, double * E, double *Z, magma_minproduct_int_t LDZ)
{
    double *WORK;
    double *dwork;
    magma_minproduct_int_t *IWORK;
    ...
    printf("using magma_minproduct_dstedx\n");
    ...
    magma_minproduct_dstedx(Magma_minproductRangeI, N, 0., 0., 1, NE, D, E, Z, LDZ, WORK, LWORK, IWORK, LIWORK, dwork, &INFO);
