/*
    -- MAGMA_tally2 (version 1.6.1) --
       ...
       @generated from testing_zpotri.cpp normal z -> c, Fri Jan 30 19:00:24 2015
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* ====================================================================
               ...
               =================================================================== */
            if ( opts.warmup ) {
                magma_tally2_cpotrf( opts.uplo, N, h_R, lda, &info );
                magma_tally2_cpotri( opts.uplo, N, h_R, lda, &info );
                lapackf77_clacpy( Magma_tally2UpperLowerStr, &N, &N, h_A, &lda, h_R, &lda );
            }
            ...
            if (info != 0)
                printf("magma_tally2_cpotri returned error %d: %s.\n",
