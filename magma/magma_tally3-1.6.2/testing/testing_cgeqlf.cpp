/*
    -- MAGMA_tally3 (version 1.6.1) --
       ...
       @generated from testing_zgeqlf.cpp normal z -> c, Fri Jan 30 19:00:26 2015
...
int main( int argc, char** argv)
{
    ...
    magma_tally3_int_t M, N, n2, lda, lwork, info, min_mn, nb;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally3_cgeqlf( M, N, h_R, lda, tau, h_work, lwork, &info);
            ...
            if ( opts.check ) {
                ...
                magma_tally3_int_t ldl = min_mn;
                magma_tally3FloatComplex *Q, *L;
                float *work;
                TESTING_MALLOC_CPU( Q,    magma_tally3FloatComplex, ldq*min_mn );  // M by K
                TESTING_MALLOC_CPU( L,    magma_tally3FloatComplex, ldl*N );       // K by N
