    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        //magma_tally2_dormql_m(ngpu, side, trans, mi, ni, i__2, A(0,1), lda, tau,
        //               C, ldc, work, lwork, &iinfo);
        magma_tally2_dormql(side, trans, mi, ni, i__2, A(0,1), lda, tau,
                       C, ldc, work, lwork, &iinfo); 
    }
    else {
        ...
        i__2 = nq - 1;
        magma_tally2_dormqr_m(ngpu, side, trans, mi, ni, i__2, A(1,0), lda, tau,
