...
int main( int argc, char** argv)
{
    ...
    float *h_A, *h_R, *h_Amagma_minproduct;
    float *dA;
    float **dA_array = NULL;
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
      ...
      for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_minproduct_ssetmatrix( M, columns, h_R, lda, dA, ldda );
            ...
            info = magma_minproduct_sgetrf_batched( M, N, dA_array, ldda, dipiv_array,  dinfo_magma_minproduct, batchCount, queue);
            ...
            magma_minproduct_sgetmatrix( M, N*batchCount, dA, ldda, h_Amagma_minproduct, lda );
