/*
    -- MAGMA_tally3 (version 1.6.2) --
       ...
       @generated from magma_tally3_zmcsrpass_gpu.cpp normal z -> c, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
...
/**
    ...
    @param[in]
    val         magma_tally3FloatComplex_ptr
    ...
    magma_tally3_queue_t queue )
{
    ...
    magma_tally3_c_matrix A_DEV={Magma_tally3_CSR}, A_CSR={Magma_tally3_CSR};
    ...
    if ( A.memory_location == Magma_tally3_DEV && A.storage_type == Magma_tally3_CSR ) {
        ...
        *row = A.drow;
        ...
        CHECK( magma_tally3_cmconvert( A, &A_CSR, A.storage_type, Magma_tally3_CSR, queue ));
        CHECK( magma_tally3_cmtransfer( A_CSR, &A_DEV, A.memory_location, Magma_tally3_DEV, queue ));
        magma_tally3_ccsrget_gpu( A_DEV, m, n, row, col, val, queue );
    }
    
cleanup:
    magma_tally3_cmfree( &A_CSR, queue );
    magma_tally3_cmfree( &A_DEV, queue );
    return info;
}
