    ...
    magma_minproduct_int_t *info)
{
    ...
    magma_minproduct_zmalloc( &dwork, 2*(m + 64)*64 );
    ...
    *info  = 0;
    ...
    magma_minproductblas_zlaset_band( Magma_minproductLower, k, k, nb, c_zero, c_one, dA, ldda );
    ...
    for (i = i1; (step < 0 ? i >= i2 : i <= i2); i += step) {
        ...
        magma_minproduct_zsetmatrix( ib, ib, T, ib, dwork+i__4*ib, ib );
