 ...
 */
#ifndef MAGMA_tally4_FLOPS_H
#define MAGMA_tally4_FLOPS_H
...
#define FMULS_SYMM(side_, m_, n_) ( ( (side_) == Magma_tally4Left ) ? FMULS_GEMM((m_), (m_), (n_)) : FMULS_GEMM((m_), (n_), (n_)) )
#define FADDS_SYMM(side_, m_, n_) ( ( (side_) == Magma_tally4Left ) ? FADDS_GEMM((m_), (m_), (n_)) : FADDS_GEMM((m_), (n_), (n_)) )
...
#define FMULS_TRMM(side_, m_, n_) ( ( (side_) == Magma_tally4Left ) ? FMULS_TRMM_2((m_), (n_)) : FMULS_TRMM_2((n_), (m_)) )
#define FADDS_TRMM(side_, m_, n_) ( ( (side_) == Magma_tally4Left ) ? FADDS_TRMM_2((m_), (n_)) : FADDS_TRMM_2((n_), (m_)) )
...
#define FMULS_UNMQR(m_, n_, k_, side_) (( (side_) == Magma_tally4Left ) \
    ?  (2.*(n_)*(m_)*(k_) - (n_)*(k_)*(k_) + 2.*(n_)*(k_)) \
    :  (2.*(n_)*(m_)*(k_) - (m_)*(k_)*(k_) + (m_)*(k_) + (n_)*(k_) - 0.5*(k_)*(k_) + 0.5*(k_)))
#define FADDS_UNMQR(m_, n_, k_, side_) (( ((side_)) == Magma_tally4Left ) \
