/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zmcsrpass_gpu.cpp normal z -> c, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_tally2_queue_t queue )
{
    ...
    magma_tally2_c_matrix A_DEV={Magma_tally2_CSR}, A_CSR={Magma_tally2_CSR};
    ...
    if ( A.memory_location == Magma_tally2_DEV && A.storage_type == Magma_tally2_CSR ) {
        ...
        *row = A.drow;
        ...
        CHECK( magma_tally2_cmconvert( A, &A_CSR, A.storage_type, Magma_tally2_CSR, queue ));
        CHECK( magma_tally2_cmtransfer( A_CSR, &A_DEV, A.memory_location, Magma_tally2_DEV, queue ));
        magma_tally2_ccsrget_gpu( A_DEV, m, n, row, col, val, queue );
    }
    
cleanup:
    magma_tally2_cmfree( &A_CSR, queue );
    magma_tally2_cmfree( &A_DEV, queue );
    return info;
}
