    ...
    magma_tally2_int_t batchCount, cublasHandle_t myhandle, magma_tally2_queue_t queue )
{
    ...
    //===============================================
    if(m < nb){
        printf("magma_tally2_cgetrf_panel_nopiv_batched_q m < nb %d < %d \n",(int) m, (int) nb);
        return -101;
    }

#if 0
    arginfo = magma_tally2_cgetf2_nopiv_batched(
                       m, nb,
                       dA_array, ldda,
    ...
    if((m-nb) > 0){
        ...
        magma_tally2blas_ctrsm_work_batched(Magma_tally2Right, Magma_tally2Upper, Magma_tally2NoTrans, Magma_tally2NonUnit,
                              1, m-nb, nb, 
                              MAGMA_tally2_C_ONE,
                              dA_array,    ldda, 
                              dW0_displ,   ldda, 
