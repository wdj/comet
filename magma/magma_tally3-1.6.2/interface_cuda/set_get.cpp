...
// copying vectors
extern "C" void
magma_tally3_setvector_internal(
    magma_tally3_int_t n, magma_tally3_int_t elemSize,
    void const* hx_src, magma_tally3_int_t incx,
    magma_tally3_ptr   dy_dst, magma_tally3_int_t incy,
...
// --------------------
extern "C" void
magma_tally3_setvector_async_internal(
    magma_tally3_int_t n, magma_tally3_int_t elemSize,
    void const* hx_src, magma_tally3_int_t incx,
    magma_tally3_ptr   dy_dst, magma_tally3_int_t incy,
...
// --------------------
extern "C" void
magma_tally3_getvector_internal(
    magma_tally3_int_t n, magma_tally3_int_t elemSize,
    magma_tally3_const_ptr dx_src, magma_tally3_int_t incx,
...
// --------------------
extern "C" void
magma_tally3_getvector_async_internal(
    magma_tally3_int_t n, magma_tally3_int_t elemSize,
    magma_tally3_const_ptr dx_src, magma_tally3_int_t incx,
    void*           hy_dst, magma_tally3_int_t incy,
    magma_tally3_queue_t queue,
...
extern "C" void
magma_tally3_copyvector_internal(
    magma_tally3_int_t n, magma_tally3_int_t elemSize,
    magma_tally3_const_ptr dx_src, magma_tally3_int_t incx,
    magma_tally3_ptr       dy_dst, magma_tally3_int_t incy,
    const char* func, const char* file, int line )
{
    if ( incx == 1 && incy == 1 ) {
        ...
        magma_tally3_copymatrix_internal(
...
// --------------------
extern "C" void
magma_tally3_copyvector_async_internal(
    magma_tally3_int_t n, magma_tally3_int_t elemSize,
    magma_tally3_const_ptr dx_src, magma_tally3_int_t incx,
    magma_tally3_ptr       dy_dst, magma_tally3_int_t incy,
    magma_tally3_queue_t queue,
    const char* func, const char* file, int line )
{
    if ( incx == 1 && incy == 1 ) {
        ...
        magma_tally3_copymatrix_async_internal(
...
extern "C" void
magma_tally3_setmatrix_internal(
    magma_tally3_int_t m, magma_tally3_int_t n, magma_tally3_int_t elemSize,
    void const* hA_src, magma_tally3_int_t ldha,
    magma_tally3_ptr   dB_dst, magma_tally3_int_t lddb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
...
// --------------------
extern "C" void
magma_tally3_setmatrix_async_internal(
    magma_tally3_int_t m, magma_tally3_int_t n, magma_tally3_int_t elemSize,
    void const* hA_src, magma_tally3_int_t ldha,
    magma_tally3_ptr   dB_dst, magma_tally3_int_t lddb,
    magma_tally3_queue_t queue,
...
// --------------------
extern "C" void
magma_tally3_getmatrix_internal(
    magma_tally3_int_t m, magma_tally3_int_t n, magma_tally3_int_t elemSize,
    magma_tally3_const_ptr dA_src, magma_tally3_int_t ldda,
    void*           hB_dst, magma_tally3_int_t ldhb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
...
// --------------------
extern "C" void
magma_tally3_getmatrix_async_internal(
    magma_tally3_int_t m, magma_tally3_int_t n, magma_tally3_int_t elemSize,
    magma_tally3_const_ptr dA_src, magma_tally3_int_t ldda,
    void*           hB_dst, magma_tally3_int_t ldhb,
    magma_tally3_queue_t queue,
