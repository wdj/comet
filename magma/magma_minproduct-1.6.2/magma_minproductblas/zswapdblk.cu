...
zswapdblk_kernel( int nb,
                  magma_minproductDoubleComplex *dA, int ldda, int inca,
                  magma_minproductDoubleComplex *dB, int lddb, int incb )
{
...
/**
    @see magma_minproductblas_zswapdblk_q
    @ingroup magma_minproduct_zaux2
    ********************************************************************/
extern "C" void 
magma_minproductblas_zswapdblk(
    ...
    magma_minproductDoubleComplex_ptr dB, magma_minproduct_int_t lddb, magma_minproduct_int_t incb )
{
    magma_minproductblas_zswapdblk_q( n, nb, dA, ldda, inca, dB, lddb, incb, magma_minproduct_stream );
}
