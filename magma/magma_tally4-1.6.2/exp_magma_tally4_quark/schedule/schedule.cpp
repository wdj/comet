...
void magma_tally4_schedule_init(int nbcores, int ngpu)
{
    int i,nbites;
     /*Initialize Schedule*/
...
void magma_tally4_schedule_barrier()
{
     schedule_Barrier(sched_obj);
}

void magma_tally4_schedule_delete()
{
...
void magma_tally4_schedule_set_task_priority(int priority)
{
...
void magma_tally4_schedule_insert_RW_dependencies(void *ptr1, void *ptr2)
{

             schedule_Insert_Task(sched_obj, magma_tally4_task_core_void, 0,
...
void magma_tally4_schedule_insert_gatherv_dependency(void *ptr1, void *ptr2)
{
            ...
            schedule_Task_Flag_Set(&task_flags, TASK_PRIORITY, SCHEDULE_TASK_MAX_PRIORITY);//SCHEDULE_TASK_MAX_PRIORITY - k 
             ...
             schedule_Insert_Task(sched_obj, magma_tally4_task_core_void, &task_flags,
              sizeof(void*),             ptr1,     INPUT,
