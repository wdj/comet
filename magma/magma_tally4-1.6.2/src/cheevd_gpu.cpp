    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally4_cstedx( Magma_tally4RangeAll, n, 0., 0., 0, 0, w, &rwork[inde],
        ...
        magma_tally4_csetmatrix( n, n, &work[indwrk], n, dC, lddc );

        magma_tally4_cunmtr_gpu( Magma_tally4Left, uplo, Magma_tally4NoTrans, n, n, dA, ldda, &work[indtau],
                          dC, lddc, wA, ldwa, &iinfo );

        magma_tally4_ccopymatrix( n, n, dC, lddc, dA, ldda );
