...
int main( int argc, char** argv)
{
    ...
    magma_minproductFloatComplex *h_A, *h_Ainit, *h_B, *h_Binit, *h_work;
    #ifdef COMPLEX
    float *rwork;
    #endif
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_PIN( h_B,    magma_minproductFloatComplex, n2    );
            ...
            magma_minproduct_cmake_hpd( N, h_B, N );
            magma_minproduct_cmake_hermitian( N, h_A, N );

            if ( opts.warmup || opts.check ) {
                TESTING_MALLOC_CPU( h_Ainit, magma_minproductFloatComplex, n2 );
                TESTING_MALLOC_CPU( h_Binit, magma_minproductFloatComplex, n2 );
                lapackf77_clacpy( Magma_minproductFullStr, &N, &N, h_A, &N, h_Ainit, &N );
                lapackf77_clacpy( Magma_minproductFullStr, &N, &N, h_B, &N, h_Binit, &N );
            }
            ...
            if (opts.warmup) {
                ...
                // ==================================================================
                magma_minproduct_chegvd_m( opts.ngpu, opts.itype, opts.jobz, opts.uplo,
                                N, h_A, N, h_B, N, w1,
                                h_work, lwork,
                                #ifdef COMPLEX
                                rwork, lrwork,
                                ...
                                iwork, liwork,
                                &info);
                lapackf77_clacpy( Magma_minproductFullStr, &N, &N, h_Ainit, &N, h_A, &N );
                lapackf77_clacpy( Magma_minproductFullStr, &N, &N, h_Binit, &N, h_B, &N );
            }
            ...
            if (info != 0)
                printf("magma_minproduct_chegvd_m returned error %d: %s.\n",
            ...
            if ( opts.lapack ) {
                ...
                magma_minproduct_chegvd(opts.itype, opts.jobz, opts.uplo,
                             N, h_A, N, h_B, N, w2,
                             h_work, lwork,
                             #ifdef COMPLEX
                             rwork, lrwork,
                ...
                if (info != 0)
                    printf("magma_minproduct_chegvd returned error %d: %s.\n",
                           (int) info, magma_minproduct_strerror( info ));
