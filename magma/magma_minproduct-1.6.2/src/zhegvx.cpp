...
magma_minproduct_zhegvx(
    ...
    magma_minproductDoubleComplex *A, magma_minproduct_int_t lda, magma_minproductDoubleComplex *B, magma_minproduct_int_t ldb,
    double vl, double vu, magma_minproduct_int_t il, magma_minproduct_int_t iu, double abstol,
    magma_minproduct_int_t *m, double *w,  magma_minproductDoubleComplex *Z, magma_minproduct_int_t ldz,
    ...
    magma_minproduct_int_t *info)
{
    ...
    magma_minproductDoubleComplex *dB;
    ...
    *info = 0;
    ...
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_zmalloc( &dA, n*ldda ) ||
        ...
        MAGMA_minproduct_SUCCESS != magma_minproduct_zmalloc( &dZ, n*lddz )) {
    ...
    magma_minproduct_zheevx_gpu(jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, abstol, m, w, dZ, lddz, A, lda, Z, ldz, work, lwork, rwork, iwork, ifail, info);
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_minproduct_ztrsm(Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit, n, *m, c_one, dB, lddb, dZ, lddz);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_minproduct_ztrmm(Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit, n, *m, c_one, dB, lddb, dZ, lddz);
        }
        
        magma_minproduct_zgetmatrix( n, *m, dZ, lddz, Z, ldz );
    }
