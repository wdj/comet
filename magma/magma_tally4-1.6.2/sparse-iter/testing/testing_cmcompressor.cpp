...
int main(  int argc, char** argv )
{
    ...
    real_Double_t res;
    magma_tally4_c_matrix A={Magma_tally4_CSR}, AT={Magma_tally4_CSR}, A2={Magma_tally4_CSR}, 
    ...
    while(  i < argc ) {
        ...
        for (int j=0; j<10; j++)
            CHECK( magma_tally4_cmcsrcompressor( &A, queue ));
        ...
        CHECK( magma_tally4_cmconvert( AT, &B, Magma_tally4_CSR, Magma_tally4_CSR, queue ));
        ...
        CHECK( magma_tally4_cmconvert( B, &AT, Magma_tally4_CSR, Magma_tally4_CSR, queue ));
        magma_tally4_cmfree(&B, queue );
