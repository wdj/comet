/*
    -- MAGMA_tally2 (version 1.6.1) --
       ...
       @generated from testing_zgesv_rbt.cpp normal z -> d, Fri Jan 30 19:00:25 2015
       @author Mark Gates
*/
// includes, system
#include <stdio.h>
...
int main(int argc, char **argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally2_dgesv_rbt(Magma_tally2True, N, nrhs, h_LU, lda, h_X, ldb, &info );
            gpu_time = magma_tally2_wtime() - gpu_time;
            gpu_perf = gflops / gpu_time;
            if (info != 0)
                printf("magma_tally2_dgesv_rbt returned error %d: %s.\n",
