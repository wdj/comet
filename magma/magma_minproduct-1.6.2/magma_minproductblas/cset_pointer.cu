...
///////////////////////////////////////////////////////////////////////////////////////
__global__ void kernel_set_pointer(magma_minproductFloatComplex **output_array,
...
extern "C"
void cset_pointer(magma_minproductFloatComplex **output_array,
                 magma_minproductFloatComplex *input,
                 magma_minproduct_int_t lda,
                 magma_minproduct_int_t row, magma_minproduct_int_t column, 
                 magma_minproduct_int_t batchSize,
...
__global__ void zdisplace_pointers_kernel(magma_minproductFloatComplex **output_array,
               magma_minproductFloatComplex **input_array, magma_minproduct_int_t lda,
               magma_minproduct_int_t row, magma_minproduct_int_t column)
{
      magma_minproductFloatComplex *inpt = input_array[blockIdx.x];
      output_array[blockIdx.x] = &inpt[row + column * lda];
}


extern "C"
void cset_array(magma_minproductFloatComplex **output_array,
               magma_minproductFloatComplex **input_array, magma_minproduct_int_t lda,
               magma_minproduct_int_t row, magma_minproduct_int_t column, 
...
extern "C"
void magma_minproduct_cdisplace_pointers(magma_minproductFloatComplex **output_array,
               magma_minproductFloatComplex **input_array, magma_minproduct_int_t lda,
               magma_minproduct_int_t row, magma_minproduct_int_t column, 
               magma_minproduct_int_t batchCount, magma_minproduct_queue_t queue)
