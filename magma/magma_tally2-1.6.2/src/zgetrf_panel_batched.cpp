    ...
    magma_tally2_int_t batchCount,  cublasHandle_t myhandle, magma_tally2_queue_t queue)
{
    ...
    if(panel_nb <= min_recpnb){
        ...
        magma_tally2_zgetf2_batched(m, panel_nb,
                           dA_array, ldda,
        ...
        magma_tally2_zlaswp_rowparallel_batched( n2, dW5_displ, ldda,
                           dX_array, n1,
                           0, n1,
        ...
        cublasZgemmBatched(myhandle, CUBLAS_OP_N, CUBLAS_OP_N, m2, n2, n1,
                                     &neg_one, (const magma_tally2DoubleComplex**) dW1_displ, ldda,
                                               (const magma_tally2DoubleComplex**) dW5_displ, ldda,
        ...
        magma_tally2_zdisplace_pointers(dW1_displ, dA_array, ldda, p2, 0, batchCount, queue); // no need since it is above
        magma_tally2_zlaswp_rowparallel_batched( n1, dW1_displ, ldda,
                           dW1_displ, ldda,
                           n1, n,
                           dpivinfo_array, batchCount, queue);
