    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_minproduct_dsytrd_mgpu(ngpu, 1, uplo, n, A, lda, w, &work[inde],
    ...
    if (! wantz) {
        ...
        magma_minproduct_dormtr_m(ngpu, Magma_minproductLeft, uplo, Magma_minproductNoTrans, n, *m, A, lda, &work[indtau],
