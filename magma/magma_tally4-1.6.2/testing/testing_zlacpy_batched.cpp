...
int main( int argc, char** argv)
{
    ...
    magma_tally4DoubleComplex *h_A, *h_B;
    magma_tally4DoubleComplex_ptr d_A, d_B;
    magma_tally4DoubleComplex **hAarray, **hBarray, **dAarray, **dBarray;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_B, magma_tally4DoubleComplex, lda *N );
            TESTING_MALLOC_DEV( d_A, magma_tally4DoubleComplex, ldda*N );
            TESTING_MALLOC_DEV( d_B, magma_tally4DoubleComplex, ldda*N );
            
            TESTING_MALLOC_CPU( hAarray, magma_tally4DoubleComplex*, ntile );
            TESTING_MALLOC_CPU( hBarray, magma_tally4DoubleComplex*, ntile );
            TESTING_MALLOC_DEV( dAarray, magma_tally4DoubleComplex*, ntile );
            TESTING_MALLOC_DEV( dBarray, magma_tally4DoubleComplex*, ntile );
            ...
            magma_tally4_zsetmatrix( M, N, h_B, lda, d_B, ldda );
            ...
            magma_tally4_setvector( ntile, sizeof(magma_tally4DoubleComplex*), hAarray, 1, dAarray, 1 );
            magma_tally4_setvector( ntile, sizeof(magma_tally4DoubleComplex*), hBarray, 1, dBarray, 1 );
            
            gpu_time = magma_tally4_sync_wtime( 0 );
            magma_tally4blas_zlacpy_batched( Magma_tally4UpperLower, mb, nb, dAarray, ldda, dBarray, ldda, ntile, queue );
            ...
            for( int tile = 0; tile < ntile; ++tile ) {
                ...
                lapackf77_zlacpy( Magma_tally4UpperLowerStr, &mb, &nb,
                                  &h_A[offset], &lda,
                                  &h_B[offset], &lda );
            }
            ...
            /* =====================================================================
               Check the result
               =================================================================== */
            magma_tally4_zgetmatrix( M, N, d_B, ldda, h_A, lda );
