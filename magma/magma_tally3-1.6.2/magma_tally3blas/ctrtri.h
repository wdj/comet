...
caxpy16(
    ...
    const magma_tally3FloatComplex * __restrict__ b,
    magma_tally3FloatComplex       * __restrict__ c )
{
    c[0]  += alpha * b[0];
    c[1]  += alpha * b[1];
    c[2]  += alpha * b[2];
...
cgemm_kernel_16(
    ...
    magma_tally3FloatComplex *B, int ldb,
    magma_tally3FloatComplex *C, int ldc,
    magma_tally3FloatComplex alpha, int jb, int tx, int ty)
{
...
ctrtri_diag_lower_kernel(
    magma_tally3_diag_t diag, int n, const magma_tally3FloatComplex *A, int lda, magma_tally3FloatComplex *d_invA);

__global__ void
triple_cgemm16_part1_lower_kernel(
    int n, const magma_tally3FloatComplex *Ain, int lda, magma_tally3FloatComplex *d_invA, int jb, int npages);
