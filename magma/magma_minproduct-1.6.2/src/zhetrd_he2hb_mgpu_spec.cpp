    ...
    magma_minproduct_int_t *info)
{
    ...
    double  d_one = MAGMA_minproduct_D_ONE;
    ...
    *info = 0;
    ...
    magma_minproductDoubleComplex *dspace[Magma_minproductMaxGPUs];
    magma_minproductDoubleComplex *dwork[Magma_minproductMaxGPUs], *dworkbis[Magma_minproductMaxGPUs];
    magma_minproductDoubleComplex *dvall[Magma_minproductMaxGPUs], *dv[Magma_minproductMaxGPUs], *dw[Magma_minproductMaxGPUs];
    magma_minproductDoubleComplex *workngpu[Magma_minproductMaxGPUs+1];
    ...
    for( magma_minproduct_int_t dev = 0; dev < ngpu; ++dev ) {
        ...
        magma_minproduct_zmalloc( &dspace[dev], devworksiz );
        magma_minproduct_zmalloc_pinned ( &workngpu[dev], worksiz);
    ...
    magma_minproduct_zmalloc_pinned ( &workngpu[ngpu], worksiz);
    magma_minproductDoubleComplex *worktest = NULL;
    //magma_minproduct_zmalloc_cpu( &worktest, n*nb ); // not used
    // ======================
  

    magma_minproductDoubleComplex *hT = work + lwork - nb*nb;
    lwork -= nb*nb;
    memset( hT, 0, nb*nb*sizeof(magma_minproductDoubleComplex));
    ...
    if (upper) {
        ...
        for (i = 1; i <= n-nb; i += nb) {
            ...
            if (i > 1 ) {
                ...
                zpanel_to_q(Magma_minproductUpper, pn-1, A(i, i+1), lda, work);
                ...
                magma_minproduct_zgetmatrix_async( (pm+pn), pn,
                                        dA(idev, i, di+1), ldda,
                ...
                //magma_minproduct_setdevice( 0 );
                zq_to_panel(Magma_minproductUpper, pn-1, A(i, i+1), lda, work);
            }
            ...
            zpanel_to_q(Magma_minproductUpper, pk, A(indi, indj), lda, work);
            ...
            for( magma_minproduct_int_t dev = 0; dev < ngpu; ++dev ) {
                magma_minproduct_setdevice( dev );
                // send V
                magma_minproduct_zsetmatrix_async( pm, pk,
                                        A(indi, indj), lda,
                                        dv[dev], pm, queues[dev][nqueue-1] );

                // Send the triangular factor T to the GPU
                magma_minproduct_zsetmatrix_async( pk, pk,
                                        hT, nb,
            ...
            for( magma_minproduct_int_t dev = 0; dev < ngpu; ++dev ) {
                ...
                magma_minproduct_zgemm(Magma_minproductNoTrans, Magma_minproductNoTrans, pm, pk, pk,
                        c_one, dv[dev], pm,
                        dT(dev, 1, i), lddt,
                        c_zero, dwork[dev], pm);
            }
            ...
            for( magma_minproduct_int_t dev = 0; dev < ngpu; ++dev ) {
                ...
                magma_minproduct_zgemm(Magma_minproductConjTrans, Magma_minproductNoTrans, pk, pk, pm,
                            c_one, dwork[dev], pm,
                            dw[dev], pm,
            ...
            zq_to_panel(Magma_minproductUpper, pk, A(indi, indj), lda, work);
            // ===============================================
            ...
            if (i + nb <= n-nb) {
                ...
                magma_minproduct_zgemm(Magma_minproductNoTrans, Magma_minproductConjTrans, pm, pn, pn, c_neg_one,
                            dv[idev], pm,
                            dw[idev], pm, c_one,
                ...
                magma_minproduct_zher2k(Magma_minproductLower, Magma_minproductNoTrans, pk, pk, c_neg_one,
                             dv[idev], pm,
                             dw[idev], pm, d_one,
                             dA(idev, indi, di+1), ldda);
                ...
                zpanel_to_q(Magma_minproductUpper, pk-1, A(n-pk+1, n-pk+2), lda, work);
                magma_minproduct_zgetmatrix( pk, pk,
                                  dA(idev, indi, di+1), ldda,
                                  A(n-pk+1, n-pk+1),  lda );
                zq_to_panel(Magma_minproductUpper, pk-1, A(n-pk+1, n-pk+2), lda, work);
            }
