...
#define dA(i, j) (dA+(j)*ldda + (i))
    ...
    *info = 0;
    ...
    if (nounit) {
        for (j=0; j < n; ++j) {
            if ( MAGMA_tally2_C_EQUAL( *dA(j,j), c_zero )) {
    ...
    if (nb <= 1 || nb >= n) {
        ...
        if (upper) {
            ...
            for (j=0; j < n; j += nb) {
                ...
                magma_tally2_ctrmm( Magma_tally2Left, Magma_tally2Upper,
                             Magma_tally2NoTrans, Magma_tally2NonUnit, j, jb,
                             c_one, dA(0,0), ldda, dA(0, j), ldda );

                magma_tally2_ctrsm( Magma_tally2Right, Magma_tally2Upper,
                             Magma_tally2NoTrans, Magma_tally2NonUnit, j, jb,
                ...
                lapackf77_ctrtri( Magma_tally2UpperStr, diag_, &jb, work, &jb, info );
            ...
            for (j=nn-1; j >= 0; j -= nb) {
                ...
                /* Compute inverse of current diagonal block */
                lapackf77_ctrtri( Magma_tally2LowerStr, diag_, &jb, work, &jb, info );
