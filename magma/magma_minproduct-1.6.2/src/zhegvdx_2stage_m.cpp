    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_minproduct_zheevdx_2stage_m( ngpu, jobz, range, uplo, n, A, lda, vl, vu, il, iu, mout, w, work, lwork, rwork, lrwork, iwork, liwork, info );
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_minproduct_ztrsm_m( ngpu, Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit, n, *mout, c_one, B, ldb, A, lda );
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            //magma_minproduct_ztrmm_m(ngpu, Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit, n, *mout, c_one, B, ldb, A, lda);
