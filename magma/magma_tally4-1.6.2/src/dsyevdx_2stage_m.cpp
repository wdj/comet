...
/**
    ...
    @ingroup magma_tally4_dsyev_driver
    ********************************************************************/
    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally4_int_t Vblksiz = magma_tally4_dbulge_get_Vblksiz(n, nb, parallel_threads);
    ...
    double *dT1;
    if (MAGMA_tally4_SUCCESS != magma_tally4_dmalloc( &dT1, n*nb)) {
        *info = MAGMA_tally4_ERR_DEVICE_ALLOC;
        return *info;
    }
    magma_tally4_dsytrd_sy2sb(uplo, n, nb, A, lda, &work[indtau1], &work[indwrk], llwork, dT1, info);
    magma_tally4_free(dT1);
#else
    magma_tally4_int_t nstream = max(3,ngpu+2);
    magma_tally4_queue_t streams[Magma_tally4MaxGPUs][20];
    double *dA[Magma_tally4MaxGPUs], *dT1[Magma_tally4MaxGPUs];
    ...
    for( magma_tally4_int_t dev = 0; dev < ngpu; ++dev ) {
        ...
        // TODO check malloc
        magma_tally4_dmalloc(&dA[dev], ldda*mlocal );
        magma_tally4_dmalloc(&dT1[dev], (n*nb) );
    ...
    magma_tally4_dsetmatrix_1D_col_bcyclic( n, n, A, lda, dA, ldda, ngpu, distblk );
    magma_tally4_setdevice(0);
    timer_stop( time_dist );

    timer_start( time_band );
    if (ver == 30) {
        magma_tally4_dsytrd_sy2sb_mgpu_spec(uplo, n, nb, A, lda, &work[indtau1], &work[indwrk], llwork, dA, ldda, dT1, nb, ngpu, distblk, streams, nstream, info);
    } else {
        magma_tally4_dsytrd_sy2sb_mgpu(uplo, n, nb, A, lda, &work[indtau1], &work[indwrk], llwork, dA, ldda, dT1, nb, ngpu, distblk, streams, nstream, info);
    }
    ...
    magma_tally4_dsytrd_sb2st(uplo, n, nb, Vblksiz, A2, lda2, w, &work[inde], &work[indV2], ldv, &work[indTAU2], wantz, &work[indT2], ldt);
    ...
    if (! wantz) {
        ...
        magma_tally4_dstedx_m(ngpu, range, n, vl, vu, il, iu, w, &work[inde],
        ...
        magma_tally4_dbulge_back_m(ngpu, uplo, n, nb, *m, Vblksiz, &work[indwrk + n * (il-1)], n,
        ...
        magma_tally4_dormqr_m(ngpu, Magma_tally4Left, Magma_tally4NoTrans, n-nb, *m, n-nb, A+nb, lda, &work[indtau1],
