...
__global__ void
clascl2_full(int m, int n, const float* D, magma_tally4FloatComplex* A, int lda)
{
...
__global__ void
clascl2_lower(int m, int n, const float* D, magma_tally4FloatComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
__global__ void
clascl2_upper(int m, int n, const float *D, magma_tally4FloatComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
magma_tally4blas_clascl2(
    magma_tally4_type_t type, magma_tally4_int_t m, magma_tally4_int_t n,
    magma_tally4Float_const_ptr dD,
    magma_tally4FloatComplex_ptr dA, magma_tally4_int_t ldda, magma_tally4_int_t *info )
{
    magma_tally4blas_clascl2_q( type, m, n, dD, dA, ldda, magma_tally4_stream, info );
}
