...
#define dA(i,j) (dA + (i) + (j)*ldda)
    ...
    *info = 0;
    ...
    ldda    = ((m + 31) / 32) * 32;
    lddwork = ((n + 31) / 32) * 32;
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_smalloc( &dA, ldda*n + ldda*nb + lddwork*nb + nb*nb)) {
    ...
    if (kk < n) {
        ...
        */
        lapackf77_slacpy( Magma_minproductUpperLowerStr, &m_kk, &k_kk, A(kk,kk), &lda, V, &m_kk);
        lapackf77_slaset( Magma_minproductUpperLowerStr, &m_kk, &n_kk, &c_zero, &c_one, A(kk, kk), &lda );

        lapackf77_slarft( Magma_minproductForwardStr, Magma_minproductColumnwiseStr,
                          &m_kk, &k_kk,
                          V, &m_kk, &tau[kk], work, &k_kk);
        lapackf77_slarfb( Magma_minproductLeftStr, Magma_minproductNoTransStr, Magma_minproductForwardStr, Magma_minproductColumnwiseStr,
                          &m_kk, &n_kk, &k_kk,
    ...
    if (kk > 0) {
        ...
        magma_minproduct_sgetmatrix( m, n,
