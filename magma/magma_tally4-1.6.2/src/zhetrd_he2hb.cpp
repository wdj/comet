    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally4_SUCCESS != magma_tally4_zmalloc( &dA, (n + 2*nb)*ldda )) {
    ...
    magma_tally4DoubleComplex *dwork = dA + n*ldda;
    magma_tally4DoubleComplex *dW    = dwork + nb*ldda;
    ...
    if (upper) {
        ...
        if (1 <= n-nb) {
            ...
            magma_tally4_zsetmatrix_async( (n-nb), (n-nb),
                                    A(nb+1, nb+1),  lda,
        ...
        for (i = 1; i <= n-nb; i += nb) {
             ...
             if (i > 1 ) {
                 // zpanel_to_q_tally4 copy the upper oof diagonal part of
                 ...
                 zpanel_to_q_tally4(Magma_tally4Upper, pn-1, A(i, i+1), lda, work);
                 ...
                 magma_tally4_zher2k(Magma_tally4Lower, Magma_tally4NoTrans, pm_old-pn_old, pn_old, c_neg_one,
                 ...
                 trace_cpu_end( 0 );
                 zq_to_panel_tally4(Magma_tally4Upper, pn-1, A(i, i+1), lda, work);
             }
             ...
             zpanel_to_q_tally4(Magma_tally4Upper, pk, A(indi, indj), lda, work);
             trace_cpu_end( 0 );
             ...
             // because below we made a restore zq_to_panel_tally4 and this restore need
             ...
             magma_tally4_zhemm(Magma_tally4Left, uplo, pm, pk,
                         c_one, dA(indi, indi), ldda,
                         dwork, pm,
                         c_zero, dW, pm);
             trace_gpu_end( 0, 2 );
             /* restore the panel */
             zq_to_panel_tally4(Magma_tally4Upper, pk, A(indi, indj), lda, work);
        ...
        pk = min(pm,pn);
        if (1 <= n-nb) {
            zpanel_to_q_tally4(Magma_tally4Upper, pk-1, A(n-pk+1, n-pk+2), lda, work);
            trace_gpu_start( 0, 2, "get", "get last block" );
            magma_tally4_zgetmatrix( pk, pk,
                              dA(n-pk+1, n-pk+1), ldda,
                              A(n-pk+1, n-pk+1),  lda );
            trace_gpu_end( 0, 2 );
            zq_to_panel_tally4(Magma_tally4Upper, pk-1, A(n-pk+1, n-pk+2), lda, work);
        }
    }// end of LOWER
