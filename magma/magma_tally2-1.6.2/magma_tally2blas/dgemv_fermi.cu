/*
    -- MAGMA_tally2 (version 1.6.1) --
       ...
       @generated from zgemv_fermi.cu normal z -> d, Fri Jan 30 19:00:10 2015
*/
    ...
    double       * __restrict__ y, int incy)
{
    ...
    if ( threadIdx.x < npart ) {
        ...
        sx[threadIdx.x] = MAGMA_tally2_D_ZERO;
    }
    __syncthreads();
...
magma_tally2blas_dgemv(
    magma_tally2_trans_t trans, magma_tally2_int_t m, magma_tally2_int_t n, double alpha,
    ...
    magma_tally2Double_ptr dy, magma_tally2_int_t incy)
{
    ...
    if ( arch < 200  ) {
        ...
        magma_tally2_dgemv( trans, m, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
        #else
        magma_tally2blas_dgemv_tesla( trans, m, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
        #endif
        return;
    }
    ...
    if ( trans == Magma_tally2NoTrans ) {
        ...
        dgemvn_kernel1_fermi<<< grid, threads, 0, magma_tally2_stream >>>
            ( m, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
    }
    else if ( trans == Magma_tally2Trans ) {
        dim3 grid    ( 1, n, 1 );
        dim3 threads ( BLK_X, 1, 1 );
        dgemvt_kernel_fermi<<< grid, threads, 0, magma_tally2_stream >>>
            ( m, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
    }
    else if ( trans == Magma_tally2ConjTrans ) {
        dim3 grid    ( 1, n, 1 );
        dim3 threads ( BLK_X, 1, 1 );
        dgemvc_kernel_fermi<<< grid, threads, 0, magma_tally2_stream >>>
            ( m, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
    }
}
