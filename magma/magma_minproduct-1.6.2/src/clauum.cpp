/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zlauum.cpp normal z -> c, Fri Jan 30 19:00:13 2015
    ...
    if (nb <= 1 || nb >= n)
        ...
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_minproduct_csetmatrix_async( ib, (n-i-ib),
                                        A(i,i+ib),  lda,
                                        dA(i,i+ib), ldda, stream[0] );

                magma_minproduct_queue_sync( stream[1] );

                magma_minproduct_ctrmm( Magma_minproductRight, Magma_minproductUpper,
                             Magma_minproductConjTrans, Magma_minproductNonUnit, i, ib,
                             c_one, dA(i,i), ldda, dA(0, i),ldda);


                lapackf77_clauum(Magma_minproductUpperStr, &ib, A(i,i), &lda, info);
                ...
                if (i+ib < n) {
                    ...
                    magma_minproduct_cherk( Magma_minproductUpper, Magma_minproductNoTrans, ib,(n-i-ib),
                                 d_one, dA(i, i+ib), ldda,
                                 d_one, dA(i, i), ldda);
                }

                magma_minproduct_cgetmatrix( i+ib, ib,
                                  dA(0, i), ldda,
                                  A(0, i),  lda );
            }
        }
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_minproduct_csetmatrix_async( (n-i-ib), ib,
                                        A(i+ib, i),  lda,
                ...
                lapackf77_clauum(Magma_minproductLowerStr, &ib, A(i,i), &lda, info);
                ...
                if (i+ib < n) {
                    ...
                    magma_minproduct_cherk(Magma_minproductLower, Magma_minproductConjTrans, ib, (n-i-ib),
                                    d_one, dA(i+ib, i), ldda,
                                    d_one, dA(i, i), ldda);
                }
                magma_minproduct_cgetmatrix( ib, i+ib,
                                  dA(i, 0), ldda,
                                  A(i, 0),  lda );
            }
        }
