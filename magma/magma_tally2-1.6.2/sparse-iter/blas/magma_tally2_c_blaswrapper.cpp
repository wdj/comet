/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_z_blaswrapper.cpp normal z -> c, Sun May  3 11:22:57 2015
       @author Hartwig Anzt
    ...
    magma_tally2_queue_t queue )
{
    ...
    magma_tally2_c_matrix x2={Magma_tally2_CSR};
    ...
    if ( A.memory_location == Magma_tally2_DEV ) {
        if ( A.num_cols == x.num_rows && x.num_cols == 1 ) {
             ...
             if ( A.storage_type == Magma_tally2_CSR
                 ...
                 //magma_tally2_cgecsrmv( Magma_tally2NoTrans, A.num_rows, A.num_cols, alpha,
                ...
                cusparseCcsrmv( cusparseHandle,CUSPARSE_OPERATION_NON_TRANSPOSE,
                 ...
                 CHECK( magma_tally2_cgeelltmv( Magma_tally2NoTrans, A.num_rows, A.num_cols,
                 ...
                 CHECK( magma_tally2_cgeellmv( Magma_tally2NoTrans, A.num_rows, A.num_cols,
                    A.max_nnz_row, alpha, A.dval, A.dcol, x.dval, beta,
                    y.dval, queue ));
                 //printf("done.\n");
             }
                 ...
                 CHECK( magma_tally2_cgeellrtmv( Magma_tally2NoTrans, A.num_rows, A.num_cols,
                 ...
                 CHECK( magma_tally2_cgesellpmv( Magma_tally2NoTrans, A.num_rows, A.num_cols,
                 ...
                 magma_tally2blas_cgemv( Magma_tally2NoTrans, A.num_rows, A.num_cols, alpha,
                 ...
                 //printf("using DENSE kernel for SpMV: ");
                 CHECK( magma_tally2_ccustomspmv( alpha, x, beta, y, queue ));
                 //printf("done.\n");
             }
            ...
            if ( A.storage_type == Magma_tally2_CSR ) {
                ...
                if ( x.major == Magma_tally2RowMajor) {
                 CHECK( magma_tally2_cmgesellpmv( Magma_tally2NoTrans, A.num_rows, A.num_cols,
                    num_vecs, A.blocksize, A.numblocks, A.alignment,
                    alpha, A.dval, A.dcol, A.drow, x.dval, beta, y.dval, queue ));
                }
                else if ( x.major == Magma_tally2ColMajor) {
                    // transpose first to row major
                    CHECK( magma_tally2_cvtranspose( x, &x2, queue ));
                    CHECK( magma_tally2_cmgesellpmv( Magma_tally2NoTrans, A.num_rows, A.num_cols,
                    num_vecs, A.blocksize, A.numblocks, A.alignment,
             ...
             /*if ( A.storage_type == Magma_tally2_DENSE ) {
                 //printf("using DENSE kernel for SpMV: ");
                 magma_tally2blas_cmgemv( Magma_tally2NoTrans, A.num_rows, A.num_cols,
    ...
    magma_tally2_queue_t queue )
{
    ...
    if ( A.memory_location == Magma_tally2_DEV ) {
         if ( A.storage_type == Magma_tally2_CSR ) {
             //printf("using CSR kernel for SpMV: ");
             CHECK( magma_tally2_cgecsrmv_shift( Magma_tally2NoTrans, A.num_rows, A.num_cols,
             ...
             //printf("using ELLPACKT kernel for SpMV: ");
             CHECK( magma_tally2_cgeellmv_shift( Magma_tally2NoTrans, A.num_rows, A.num_cols,
             ...
             //printf("using ELL kernel for SpMV: ");
             CHECK( magma_tally2_cgeelltmv_shift( Magma_tally2NoTrans, A.num_rows, A.num_cols,
                A.max_nnz_row, alpha, lambda, A.dval, A.dcol, x.dval, beta, offset,
                blocksize, add_rows, y.dval, queue ));
             //printf("done.\n");
         }
    ...
    if ( A.memory_location == Magma_tally2_DEV ) {
        if ( A.num_cols == B.num_rows ) {
             ...
             if ( A.storage_type == Magma_tally2_CSR
                ...
                CHECK( magma_tally2_ccuspmm( A, B, C, queue ));
