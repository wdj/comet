...
void magma_tally4_xerror( CUresult err, const char* func, const char* file, int line )
{
    if ( err != CUDA_SUCCESS ) {
        fprintf( stderr, "CUDA driver error: %s (%d) in %s at %s:%d\n",
                 magma_tally4_cuGetErrorString( err ), err, func, file, line );
    }
}
...
void magma_tally4_xerror( cublasStatus_t err, const char* func, const char* file, int line )
{
    if ( err != CUBLAS_STATUS_SUCCESS ) {
        fprintf( stderr, "CUBLAS error: %s (%d) in %s at %s:%d\n",
                 magma_tally4_cublasGetErrorString( err ), err, func, file, line );
    }
}
...
{
    if ( err != MAGMA_tally4_SUCCESS ) {
        fprintf( stderr, "MAGMA_tally4 error: %s (%d) in %s at %s:%d\n",
                 magma_tally4_strerror( err ), (int) err, func, file, line );
    }
}
...
const char* magma_tally4_strerror( magma_tally4_int_t error )
{
    ...
    else if ( error < 0 && error > MAGMA_tally4_ERR ) {
        return "invalid argument";
    }
    // MAGMA_tally4-specific errors
    switch( error ) {
        case MAGMA_tally4_SUCCESS:
            return "success";
        
        case MAGMA_tally4_ERR:
            return "unknown error";
        
        case MAGMA_tally4_ERR_NOT_INITIALIZED:
            return "not initialized";
        
        case MAGMA_tally4_ERR_REINITIALIZED:
            return "reinitialized";
        
        case MAGMA_tally4_ERR_NOT_SUPPORTED:
            return "not supported";
        
        case MAGMA_tally4_ERR_ILLEGAL_VALUE:
            return "illegal value";
        
        case MAGMA_tally4_ERR_NOT_FOUND:
            return "not found";
        
        case MAGMA_tally4_ERR_ALLOCATION:
            return "allocation";
        
        case MAGMA_tally4_ERR_INTERNAL_LIMIT:
            return "internal limit";
        
        case MAGMA_tally4_ERR_UNALLOCATED:
            return "unallocated error";
        
        case MAGMA_tally4_ERR_FILESYSTEM:
            return "filesystem error";
        
        case MAGMA_tally4_ERR_UNEXPECTED:
            return "unexpected error";
        
        case MAGMA_tally4_ERR_SEQUENCE_FLUSHED:
            return "sequence flushed";
        
        case MAGMA_tally4_ERR_HOST_ALLOC:
            return "cannot allocate memory on CPU host";
        
        case MAGMA_tally4_ERR_DEVICE_ALLOC:
            return "cannot allocate memory on GPU device";
        
        case MAGMA_tally4_ERR_CUDASTREAM:
            return "CUDA stream error";
        
        case MAGMA_tally4_ERR_INVALID_PTR:
            return "invalid pointer";
        
        case MAGMA_tally4_ERR_UNKNOWN:
            return "unknown error";
                        
        case MAGMA_tally4_ERR_NOT_IMPLEMENTED:
            return "not implemented";
        
        // some sparse-iter errors
        case MAGMA_tally4_SLOW_CONVERGENCE:
            return "stopping criterion not reached";
        
        case MAGMA_tally4_DIVERGENCE:
            return "divergence";
        
        case MAGMA_tally4_NONSPD:
            return "not positive definite (SPD/HPD)";
        
        case MAGMA_tally4_ERR_BADPRECOND:
            return "bad preconditioner";
        
        // map cusparse errors to magma_tally4 errors
        case MAGMA_tally4_ERR_CUSPARSE_NOT_INITIALIZED:
            return "cusparse: not initialized";

        case MAGMA_tally4_ERR_CUSPARSE_ALLOC_FAILED:
            return "cusparse: allocation failed";

        case MAGMA_tally4_ERR_CUSPARSE_INVALID_VALUE:
            return "cusparse: invalid value";

        case MAGMA_tally4_ERR_CUSPARSE_ARCH_MISMATCH:
            return "cusparse: architecture mismatch";

        case MAGMA_tally4_ERR_CUSPARSE_MAPPING_ERROR:
            return "cusparse: mapping error";

        case MAGMA_tally4_ERR_CUSPARSE_EXECUTION_FAILED:
            return "cusparse: execution failed";

        case MAGMA_tally4_ERR_CUSPARSE_INTERNAL_ERROR:
            return "cusparse: internal error";

        case MAGMA_tally4_ERR_CUSPARSE_MATRIX_TYPE_NOT_SUPPORTED:
            return "cusparse: matrix type not supported";

        case MAGMA_tally4_ERR_CUSPARSE_ZERO_PIVOT:
            return "cusparse: zero pivot";
        
        default:
            return "unknown MAGMA_tally4 error code";
    }
}
