...
zswapdblk_kernel( int nb,
                  magma_tally4DoubleComplex *dA, int ldda, int inca,
                  magma_tally4DoubleComplex *dB, int lddb, int incb )
{
...
{
    magma_tally4_int_t nblocks = n / nb;
...
/**
    @see magma_tally4blas_zswapdblk_q
    @ingroup magma_tally4_zaux2
    ********************************************************************/
extern "C" void 
magma_tally4blas_zswapdblk(
    ...
    magma_tally4DoubleComplex_ptr dB, magma_tally4_int_t lddb, magma_tally4_int_t incb )
{
    magma_tally4blas_zswapdblk_q( n, nb, dA, ldda, inca, dB, lddb, incb, magma_tally4_stream );
}
