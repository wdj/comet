    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally2_timer_t time_total=0, time=0;
    ...
    if (! wantz) {
        ...
        magma_tally2_sstedx(range, n, vl, vu, il, iu, w, &work[inde],
        ...
        if (MAGMA_tally2_SUCCESS != magma_tally2_smalloc( &dZ, *m*lddz)) {
            *info = MAGMA_tally2_ERR_DEVICE_ALLOC;
            return *info;
        }
        ...
        magma_tally2_sbulge_back(uplo, n, nb, *m, Vblksiz, &work[indwrk + n * (il-1)], n, dZ, lddz,
        ...
        magma_tally2_sormqr_gpu_2stages(Magma_tally2Left, Magma_tally2NoTrans, n-nb, *m, n-nb, dA+nb, ldda,
                                 dZ+nb, n, dT1, nb, info);

        magma_tally2_sgetmatrix( n, *m, dZ, lddz, A, lda );
