/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from magma_minproduct_zvpass.cpp normal z -> d, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
...
magma_minproduct_dvget(
    ...
    magma_minproduct_queue_t queue )
{
    magma_minproduct_d_matrix v_CPU={Magma_minproduct_CSR};
    ...
    if ( v.memory_location == Magma_minproduct_CPU ) {
        ...
        *val = v.val;
        ...
        CHECK( magma_minproduct_dmtransfer( v, &v_CPU, v.memory_location, Magma_minproduct_CPU, queue ));
        CHECK( magma_minproduct_dvget( v_CPU, m, n, val, queue ));
    }
    
cleanup:
    magma_minproduct_dmfree( &v_CPU, queue );
    return info;
}
