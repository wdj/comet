...
magma_tally2_cheevx(
    ...
    magma_tally2FloatComplex *A, magma_tally2_int_t lda, float vl, float vu,
    magma_tally2_int_t il, magma_tally2_int_t iu, float abstol, magma_tally2_int_t *m,
    float *w, magma_tally2FloatComplex *Z, magma_tally2_int_t ldz, magma_tally2FloatComplex *work, magma_tally2_int_t lwork,
    ...
    magma_tally2_int_t *info)
{
    ...
    *m = 0;
    ...
    magma_tally2_chetrd(uplo, n, A, lda, &rwork[indd], &rwork[inde], &work[indtau], &work[indwrk], llwork, &iinfo);
    ...
    if (*m == 0) {
        *info = 0;
        ...
        if (wantz) {
            ...
            magma_tally2_cunmtr(Magma_tally2Left, uplo, Magma_tally2NoTrans, n, *m, A, lda, &work[indtau],
