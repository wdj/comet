...
int main( int argc, char** argv)
{
    ...
    magma_tally4FloatComplex *dA_magma_tally4;
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
      ...
      for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_DEV(  dA_magma_tally4,  magma_tally4FloatComplex, ldda*N * batchCount);
            ...
            magma_tally4_csetmatrix( M, columns, h_R, lda, dA_magma_tally4, ldda );
            ...
            /* ====================================================================
               ...
               =================================================================== */
            cset_pointer(dA_array, dA_magma_tally4, ldda, 0, 0, ldda*N, batchCount, queue);
            magma_tally4_time = magma_tally4_sync_wtime(0);
            info = magma_tally4_cgetrf_nopiv_batched( M, N, dA_array, ldda, dinfo_magma_tally4, batchCount, queue);
            ...
            if ( opts.check ) {
                ...
                magma_tally4_cgetmatrix( M, N*batchCount, dA_magma_tally4, ldda, h_A, lda );
                for(int i=0; i<batchCount; i++)
                {
