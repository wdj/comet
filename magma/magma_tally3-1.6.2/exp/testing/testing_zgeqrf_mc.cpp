...
int main( magma_tally3_int_t argc, char** argv) 
{
    ...
    for(i=0; i<10; i++){
      ...
      lapackf77_zlacpy( Magma_tally3UpperLowerStr, &M, &N, h_A2, &M, h_A3, &M );
     ...
     =================================================================== */
      ...
      start = get_current_time();
      magma_tally3_zgeqrf_mc(context, &M, &N, h_A2, &M, tau, h_work2, &lwork, info);
      end = get_current_time();
