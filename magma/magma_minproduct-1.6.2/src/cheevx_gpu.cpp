...
magma_minproduct_cheevx_gpu(
    ...
    float *rwork, magma_minproduct_int_t *iwork, magma_minproduct_int_t *ifail,
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    work[0] = MAGMA_minproduct_C_MAKE( lopt, 0 );
    ...
    *m = 0;
    ...
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_smalloc( &dwork, n )) {
        fprintf (stderr, "!!!! device memory allocation error (magma_minproduct_cheevx_gpu)\n");
...
#ifdef FAST_HEMV
    magma_minproduct_chetrd2_gpu(uplo, n, dA, ldda, &rwork[indd], &rwork[inde],
                      &work[indtau], wA, ldwa, &work[indwrk], llwork, dZ, lddz*n, &iinfo);
#else
    magma_minproduct_chetrd_gpu (uplo, n, dA, ldda, &rwork[indd], &rwork[inde],
                      &work[indtau], wA, ldwa, &work[indwrk], llwork, &iinfo);
#endif

    lopt = n + (magma_minproduct_int_t)MAGMA_minproduct_C_REAL(work[indwrk]);
    ...
    if ((alleig || (indeig && il == 1 && iu == n)) && abstol <= 0.) {
        ...
        if (! wantz) {
            ...
            if (*info == 0) {
                ...
                magma_minproduct_csetmatrix( n, n, wZ, ldwz, dZ, lddz );
            }
        }
        if (*info == 0) {
            *m = n;
