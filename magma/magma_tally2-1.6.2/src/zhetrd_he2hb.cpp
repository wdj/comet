    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally2_SUCCESS != magma_tally2_zmalloc( &dA, (n + 2*nb)*ldda )) {
    ...
    magma_tally2DoubleComplex *dwork = dA + n*ldda;
    magma_tally2DoubleComplex *dW    = dwork + nb*ldda;
    ...
    if (upper) {
        ...
        if (1 <= n-nb) {
            ...
            magma_tally2_zsetmatrix_async( (n-nb), (n-nb),
                                    A(nb+1, nb+1),  lda,
        ...
        for (i = 1; i <= n-nb; i += nb) {
             ...
             if (i > 1 ) {
                 ...
                 magma_tally2_zher2k(Magma_tally2Lower, Magma_tally2NoTrans, pm_old-pn_old, pn_old, c_neg_one,
             ...
             // because below we made a restore zq_to_panel_tally2 and this restore need
