/*
    -- MAGMA_tally3 (version 1.6.2) --
       ...
       @generated from magma_tally3_zmcsrpass.cpp normal z -> s, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_tally3_queue_t queue )
{
    ...
    magma_tally3_s_matrix A_CPU={Magma_tally3_CSR}, A_CSR={Magma_tally3_CSR};
    ...
    if ( A.memory_location == Magma_tally3_CPU && A.storage_type == Magma_tally3_CSR ) {
        ...
        *row = A.row;
        ...
        CHECK( magma_tally3_smtransfer( A, &A_CPU, A.memory_location, Magma_tally3_CPU, queue ));
        CHECK( magma_tally3_smconvert( A_CPU, &A_CSR, A_CPU.storage_type, Magma_tally3_CSR, queue ));
        CHECK( magma_tally3_scsrget( A_CSR, m, n, row, col, val, queue ));
    }

cleanup:
    magma_tally3_smfree( &A_CSR, queue );
    magma_tally3_smfree( &A_CPU, queue );
    return info;
}
