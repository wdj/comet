...
/**
    ...
    A       COPLEX_16 array, dimension (LDA,N)
            ...
            On exit, if UPLO = Magma_tally3Upper, the upper triangle of A is
            overwritten with the upper triangle of the product U * U';
            if UPLO = Magma_tally3Lower, the lower triangle of A is overwritten with
...
#define dA(i, j) (dA + (j)*ldda + (i))
    ...
    magma_tally3_int_t     ldda, nb;
    magma_tally3_int_t i, ib;
    ...
    if (nb <= 1 || nb >= n)
        ...
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally3_ssetmatrix_async( ib, ib,
                                        A(i,i),   lda,
                                        dA(i, i), ldda, stream[1] );

                magma_tally3_ssetmatrix_async( ib, (n-i-ib),
                                        A(i,i+ib),  lda,
                                        dA(i,i+ib), ldda, stream[0] );

                magma_tally3_queue_sync( stream[1] );

                magma_tally3_strmm( Magma_tally3Right, Magma_tally3Upper,
                             Magma_tally3ConjTrans, Magma_tally3NonUnit, i, ib,
                             c_one, dA(i,i), ldda, dA(0, i),ldda);


                lapackf77_slauum(Magma_tally3UpperStr, &ib, A(i,i), &lda, info);
                ...
                if (i+ib < n) {
                    ...
                    magma_tally3_ssyrk( Magma_tally3Upper, Magma_tally3NoTrans, ib,(n-i-ib),
                                 d_one, dA(i, i+ib), ldda,
                                 d_one, dA(i, i), ldda);
                }

                magma_tally3_sgetmatrix( i+ib, ib,
                                  dA(0, i), ldda,
                                  A(0, i),  lda );
            }
        }
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally3_ssetmatrix_async( (n-i-ib), ib,
                                        A(i+ib, i),  lda,
                                        dA(i+ib, i), ldda, stream[0] );

                magma_tally3_queue_sync( stream[1] );

                magma_tally3_strmm( Magma_tally3Left, Magma_tally3Lower,
                             Magma_tally3ConjTrans, Magma_tally3NonUnit, ib,
                             i, c_one, dA(i,i), ldda,
                             dA(i, 0),ldda);


                lapackf77_slauum(Magma_tally3LowerStr, &ib, A(i,i), &lda, info);
                ...
                if (i+ib < n) {
                    ...
                    magma_tally3_ssyrk(Magma_tally3Lower, Magma_tally3ConjTrans, ib, (n-i-ib),
                                    d_one, dA(i+ib, i), ldda,
                                    d_one, dA(i, i), ldda);
                }
                magma_tally3_sgetmatrix( ib, i+ib,
                                  dA(i, 0), ldda,
                                  A(i, 0),  lda );
            }
        }
