    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally3_cheevdx_2stage_m( ngpu, jobz, range, uplo, n, A, lda, vl, vu, il, iu, mout, w, work, lwork, rwork, lrwork, iwork, liwork, info );
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally3_ctrsm_m( ngpu, Magma_tally3Left, uplo, trans, Magma_tally3NonUnit, n, *mout, c_one, B, ldb, A, lda );
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            //magma_tally3_ctrmm_m(ngpu, Magma_tally3Left, uplo, trans, Magma_tally3NonUnit, n, *mout, c_one, B, ldb, A, lda);
