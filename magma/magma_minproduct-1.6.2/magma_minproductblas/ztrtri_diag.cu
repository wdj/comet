    ...
    magma_minproduct_queue_t queue)
{
    ...
    cudaMemset( d_dinvA, 0, ((n+NB-1)/NB)*NB*NB * sizeof(magma_minproductDoubleComplex) );
...
/**
    @see magma_minproductblas_ztrtri_diag_q
    @ingroup magma_minproduct_zblas3
    ********************************************************************/
extern "C" void
magma_minproductblas_ztrtri_diag(
    ...
    magma_minproductDoubleComplex_ptr d_dinvA)
{
    magma_minproductblas_ztrtri_diag_q( uplo, diag, n, dA, ldda, d_dinvA, magma_minproduct_stream );
}
