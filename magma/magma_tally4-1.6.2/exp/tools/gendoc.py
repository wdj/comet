...
def getlatexdoc(funcdoc):
  latexdoc = "\\textsf{magma_tally4\_int\_t} "
...
def getoutputdoc(fdoc, output):
  ...
  doc += output.ret_type("magma_tally4_int_t")
