    ...
    magma_tally4_int_t batchCount,  cublasHandle_t myhandle, magma_tally4_queue_t queue)
{
    ...
    if(panel_nb <= min_recpnb){
        ...
        //  panel factorization
        //magma_tally4_cdisplace_pointers(dA_displ, dA_array, ldda, 0, 0, batchCount);
        magma_tally4_cgetf2_batched(m, panel_nb,
                           dA_array, ldda,
        ...
        magma_tally4_cdisplace_pointers(dW5_displ, dA_array, ldda, p1, p2, batchCount, queue); 
        magma_tally4_claswp_rowparallel_batched( n2, dW5_displ, ldda,
                           dX_array, n1,
                           0, n1,
        ...
        magma_tally4_cdisplace_pointers(dW1_displ, dA_array, ldda, p2, 0, batchCount, queue); 
        ...
        cublasCgemmBatched(myhandle, CUBLAS_OP_N, CUBLAS_OP_N, m2, n2, n1,
                                     &neg_one, (const magma_tally4FloatComplex**) dW1_displ, ldda,
                                               (const magma_tally4FloatComplex**) dW5_displ, ldda,
                                     &one,  dA_displ, ldda, batchCount );


#else

        magma_tally4blas_cgemm_batched( Magma_tally4NoTrans, Magma_tally4NoTrans, m2, n2, n1, 
                              MAGMA_tally4_C_NEG_ONE, dW1_displ, ldda, 
                              dW5_displ, ldda, 
                              MAGMA_tally4_C_ONE,  dA_displ, ldda, 
                              batchCount, queue);
#endif
        ...
        magma_tally4_cdisplace_pointers(dW1_displ, dA_array, ldda, p2, 0, batchCount, queue); // no need since it is above
        magma_tally4_claswp_rowparallel_batched( n1, dW1_displ, ldda,
                           dW1_displ, ldda,
                           n1, n,
                           dpivinfo_array, batchCount, queue);
