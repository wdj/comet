/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zhesv.cpp normal z -> c, Fri Jan 30 19:00:16 2015
*/
    ...
    magma_minproduct_int_t *info ) 
{
    ...
    *info = 0;
    ...
    magma_minproduct_chetrf( uplo, n, A, lda, ipiv, info );
    if( *info == 0 ) {

        /* Solve the system A*X = B, overwriting B with X. */
        lapackf77_chetrs( (upper ? Magma_minproductUpperStr: Magma_minproductLowerStr), 
