...
//#define ENABLE_TIMER3
    ...
    magma_tally2_malloc_cpu((void**) &cpuAarray, batchCount*sizeof(float*));
   ...
   /* check allocation */
    ...
    magma_tally2_getvector( batchCount, sizeof(float*), dA_array, 1, cpuAarray, 1);
    ...
    for(i = 0; i < min_mn; i+=nb) 
    {
        ...
        magma_tally2_sdisplace_pointers(dA_displ, dA_array, ldda, i, i, batchCount, queue);
        //===============================================
        //  panel factorization
        //===============================================
#if 0
        arginfo = magma_tally2_sgetf2_batched(
                pm, ib,
                dA_displ, ldda,
...
#else
        arginfo = magma_tally2_sgetrf_recpanel_batched(
                pm, ib, 16,
                dA_displ, ldda,
...
#define RUN_ALL
        ...
        magma_tally2_sdisplace_pointers(dW0_displ, dA_array, ldda, i, 0, batchCount, queue);
        magma_tally2_slaswp_rowparallel_batched( i, dA_displ, ldda,
                dW0_displ, ldda,
                i, i+ib,
        ...
        if( (i + ib) < n)
        {
            ...
            magma_tally2_sdisplace_pointers(dA_displ, dA_array, ldda, i, i+ib, batchCount, queue);
            sset_pointer(dwork_array, dwork, nb, 0, 0, dwork_msize, batchCount, queue); // I don't think it is needed Azzam
            magma_tally2_slaswp_rowparallel_batched( n-(i+ib), dA_displ, ldda,
                    dwork_array, nb,
                    i, i+ib,
                    pivinfo_array, batchCount, queue);
            ...
            magma_tally2_sdisplace_pointers(dA_displ, dA_array, ldda, i, i, batchCount, queue);
            magma_tally2_sdisplace_pointers(dW0_displ, dA_array, ldda, i, i+ib, batchCount, queue);
            ...
            {    
                ...
                {
                    magma_tally2_sdisplace_pointers(dA_displ, dA_array,  ldda, i+ib,    i, batchCount, queue);
                    magma_tally2_sdisplace_pointers(dW1_displ, dA_array, ldda,    i, i+ib, batchCount, queue);
                    magma_tally2_sdisplace_pointers(dW2_displ, dA_array, ldda, i+ib, i+ib, batchCount, queue);
                    //printf("caling batched dgemm %d %d %d \n", m-i-ib, n-i-ib, ib);
                    magma_tally2blas_sgemm_batched( Magma_tally2NoTrans, Magma_tally2NoTrans, m-i-ib, n-i-ib, ib, 
