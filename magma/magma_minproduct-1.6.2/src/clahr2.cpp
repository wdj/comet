/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zlahr2.cpp normal z -> c, Fri Jan 30 19:00:18 2015
       @author Stan Tomov
       @author Mark Gates
*/
    ...
    magma_minproductFloatComplex *Y,     magma_minproduct_int_t ldy )
{
    ...
    for (i = 0; i < nb; ++i) {
        ...
        *A(k+i+1,i) = c_one;
        ...
        magma_minproduct_csetvector( n_k_i_1,
                          A(k+i+1,i), 1,
                          dV(i+1,i),  1 );
        
        // Compute Y(k+1:n,i) = A vi
        // dA(k:n-1, i) = dA(k:n-1, i+1:n-k-1) * dV(i+1:n-k-1, i)
        magma_minproduct_cgemv( Magma_minproductNoTrans, n_k, n_k_i_1,
                     c_one,  dA(k,i+1), ldda,
                             dV(i+1,i), ione,
                     c_zero, dA(k,i),   ione );
        ...
        *T(i,i) = tau[i];
        ...
        magma_minproduct_cgetvector( n-k,
                          dA(k,i), 1,
                          Y(k,i),  1 );
    }
