...
*/
__global__ void
zsymmetrize_lower( int m, magma_tally2DoubleComplex *dA, int ldda )
{
...
__global__ void
zsymmetrize_upper( int m, magma_tally2DoubleComplex *dA, int ldda )
{
    // dA iterates across row i and dAT iterates down column i.
    int i = blockIdx.x*NB + threadIdx.x;
    magma_tally2DoubleComplex *dAT = dA;
...
/**
    @see magma_tally2blas_zsymmetrize_q
    @ingroup magma_tally2_zaux2
    ********************************************************************/
extern "C" void
magma_tally2blas_zsymmetrize(
    ...
    magma_tally2DoubleComplex_ptr dA, magma_tally2_int_t ldda )
{
    magma_tally2blas_zsymmetrize_q( uplo, m, dA, ldda, magma_tally2_stream );
}
