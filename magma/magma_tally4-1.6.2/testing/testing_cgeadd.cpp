/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from testing_zgeadd.cpp normal z -> c, Fri Jan 30 19:00:23 2015
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv)
{
    ...
    float          error, work[1];
    magma_tally4FloatComplex *h_A, *h_B, *d_A, *d_B;
     ...
     * magma_tally4_xerbla calls lapack's xerbla to print out error. */
    //magma_tally4blas_cgeadd( -1,  N, alpha, d_A, ldda, d_B, ldda );
    //magma_tally4blas_cgeadd(  M, -1, alpha, d_A, ldda, d_B, ldda );
    //magma_tally4blas_cgeadd(  M,  N, alpha, d_A, M-1,  d_B, ldda );
    //magma_tally4blas_cgeadd(  M,  N, alpha, d_A, ldda, d_B, N-1  );
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally4blas_cgeadd( M, N, alpha, d_A, ldda, d_B, ldda );
