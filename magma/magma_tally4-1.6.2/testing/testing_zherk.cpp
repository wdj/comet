...
int main( int argc, char** argv)
{
    ...
    magma_tally4DoubleComplex *h_A, *h_C, *h_Ccublas;
    magma_tally4DoubleComplex_ptr d_A, d_C;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            cublasZherk( opts.handle, cublas_uplo_const_tally4(opts.uplo), cublas_trans_const_tally4(opts.transA), N, K,
                         &alpha, d_A, ldda,
                         &beta,  d_C, lddc );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_zherk( lapack_uplo_const_tally4(opts.uplo), lapack_trans_const_tally4(opts.transA), &N, &K,
                               &alpha, h_A, &lda,
                               &beta,  h_C, &ldc );
            ...
            if ( opts.lapack ) {
                ...
                Cnorm = lapackf77_zlanhe("fro", lapack_uplo_const_tally4(opts.uplo), &N, h_C, &ldc, work);

                blasf77_zaxpy( &sizeC, &c_neg_one, h_C, &ione, h_Ccublas, &ione );
                cublas_error = lapackf77_zlanhe( "fro", lapack_uplo_const_tally4(opts.uplo), &N, h_Ccublas, &ldc, work ) / Cnorm;
