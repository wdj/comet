...
/**
    ...
    as returned by CGELQF. Q is of order M if SIDE = Magma_tally3Left and of order N
    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb >= k) {
        /* Use CPU code */
        lapackf77_cunmlq( lapack_side_const_tally3(side), lapack_trans_const_tally3(trans),
        ...
        magma_tally3FloatComplex_ptr dwork, dV, dT, dC;
        ...
        magma_tally3_cmalloc_cpu( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_tally3_csetmatrix( m, n, C, ldc, dC(0,0), lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            cpanel_to_q_tally3( Magma_tally3Lower, ib, A(i,i), lda, T2 );
            magma_tally3_csetmatrix( ib, nq_i,  A(i,i), lda, dV(0,0), ib );
            cq_to_panel_tally3( Magma_tally3Lower, ib, A(i,i), lda, T2 );
            ...
            magma_tally3_csetmatrix( ib, ib, T, ib, dT(0,0), ib );
            magma_tally3_clarfb_gpu( side, transt, Magma_tally3Forward, Magma_tally3Rowwise,
                              mi, ni, ib,
                              dV(0,0), ib,
                              dT(0,0), ib,
                              dC(ic,jc), lddc,
        ...
        magma_tally3_cgetmatrix( m, n, dC(0,0), lddc, C, ldc );
