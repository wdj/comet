...
int magma_tally2_get_slaed3_k() { return 512; }

void magma_tally2_svrange(
    ...
    magma_tally2_int_t *info )
{
    ...
    magma_tally2Float_ptr dQ2 = dwork;
    magma_tally2Float_ptr dS  = dQ2  + n*lddq;
    magma_tally2Float_ptr dQ  = dS   + n*lddq;
    ...
    *info = 0;
    ...
    magma_tally2_ssetvector_async( lq2, Q2, 1, dQ2(0,0), 1, NULL );
...
#pragma omp barrier
    ...
    if (rk != 0) {
        if ( n23 != 0 ) {
            if (rk < magma_tally2_get_slaed3_k()) {
                lapackf77_slacpy("A", &n23, &rk, Q(ctot[0],iil-1), &ldq, s, &n23);
                blasf77_sgemm("N", "N", &n2, &rk, &n23, &d_one, &Q2[iq2], &n2,
                              s, &n23, &d_zero, Q(n1,iil-1), &ldq );
            } else {
                magma_tally2_ssetmatrix( n23, rk, Q(ctot[0],iil-1), ldq, dS(0,0), n23 );
                magma_tally2_sgemm( Magma_tally2NoTrans, Magma_tally2NoTrans, n2, rk, n23,
                             d_one,  dQ2(iq2,0), n2,
                                     dS(0,0), n23,
                             d_zero, dQ(0,0), lddq);
                magma_tally2_sgetmatrix( n2, rk, dQ(0,0), lddq, Q(n1,iil-1), ldq );
            }
        } else
        ...
        if ( n12 != 0 ) {
            if (rk < magma_tally2_get_slaed3_k()) {
                ...
                magma_tally2_ssetmatrix( n12, rk, Q(0,iil-1), ldq, dS(0,0), n12 );
                magma_tally2_sgemm( Magma_tally2NoTrans, Magma_tally2NoTrans, n1, rk, n12,
                             d_one,  dQ2(0,0), n1,
                                     dS(0,0), n12,
                             d_zero, dQ(0,0), lddq);
                magma_tally2_sgetmatrix( n1, rk, dQ(0,0), lddq, Q(0,iil-1), ldq );
            }
        } else
