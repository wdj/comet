    ...
    magma_tally2Float_ptr dworkvt,     magma_tally2_int_t ldworkvt)
{
    ...
    if ( side == Magma_tally2Left ) {
        ...
        if (m <= n) {
            // W2 = V T
            magma_tally2_sgemm( notransV, trans,
                         m, k, k,
                         c_one,  dV, lddv,
                                 dT, lddt,
            ...
            // W2 = T W  = T  V^H C
            magma_tally2_sgemm( trans, Magma_tally2NoTrans,
                         k, n, k,
                         c_one,  dT, lddt,
                                 dwork, ldw,
                         c_zero, dworkvt, ldwvt);
            // C = C - V W2 = C - V T V^H C = (I - V T V^H) C = H C
            magma_tally2_sgemm( notransV, Magma_tally2NoTrans,
                         m, n, k,
                         c_neg_one, dV,  lddv,
                                    dworkvt,  ldwvt,
                         c_one,     dC,       lddc);
        ...
        if (m <= n) {
            // W2 = W T = C V T
            magma_tally2_sgemm( Magma_tally2NoTrans, trans,
                         m, k, k,
                         c_one,  dwork, ldw,
                                 dT, lddt,
                         c_zero, dworkvt, ldwvt);
            ...
            // W2 = T V^H
            magma_tally2_sgemm( trans, transV,
                         k, n, k,
                         c_one,  dT, lddt,
                                 dV, lddv,
                         c_zero, dworkvt, ldwvt);
