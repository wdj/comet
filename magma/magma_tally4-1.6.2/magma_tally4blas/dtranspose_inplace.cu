...
__global__ void dtranspose_inplace_odd( int n, double *matrix, int lda )
{
...
__global__ void dtranspose_inplace_even( int n, double *matrix, int lda )
{
    __shared__ double sA[ NB ][ NB+1 ];
    __shared__ double sB[ NB ][ NB+1 ];
    ...
    magma_tally4_queue_t queue )
{
    ...
    if( nblock % 2 == 1 ) {
        ...
        dtranspose_inplace_even<<< grid, threads, 0, queue >>>( n, dA, ldda );
    }
}


/**
    @see magma_tally4blas_dtranspose_inplace_q
    @ingroup magma_tally4_daux2
    ********************************************************************/
extern "C" void
magma_tally4blas_dtranspose_inplace(
    ...
    magma_tally4Double_ptr dA, magma_tally4_int_t ldda )
{
    magma_tally4blas_dtranspose_inplace_q( n, dA, ldda, magma_tally4_stream );
}
