...
magma_tally4blas_delementary_multiplication_devfunc(
...
{    
    magma_tally4blas_delementary_multiplication_devfunc( n, dA+offsetA, ldda, du+offsetu, dv+offsetv);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
__global__ void 
...
{    
    ...
    magma_tally4blas_delementary_multiplication_devfunc( n, dA_array[batchid]+offsetA, ldda, du+offsetu, dv+offsetv);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
static __device__ void 
magma_tally4blas_dapply_vector_devfunc(
    magma_tally4_int_t n,
    double *du, double *db)
{
...
{
    magma_tally4blas_dapply_vector_devfunc(n, du+offsetu, db+offsetb);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
__global__ void 
    ...
    double *du, magma_tally4_int_t offsetu, double **db_array, magma_tally4_int_t offsetb )
{
    ...
    magma_tally4blas_dapply_vector_devfunc(n, du+offsetu, db_array[batchid]+offsetb);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////

static __device__ void 
magma_tally4blas_dapply_transpose_vector_devfunc(
    magma_tally4_int_t n,
    double *du,double *db )
{
    magma_tally4_int_t idx;
...
magma_tally4blas_dapply_transpose_vector_kernel(
    ...
    double *du, magma_tally4_int_t offsetu, double *db, magma_tally4_int_t offsetb )
{
    magma_tally4blas_dapply_transpose_vector_devfunc(n, du+offsetu, db+offsetb);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
__global__ void 
    ...
    double *du, magma_tally4_int_t offsetu, double **db_array, magma_tally4_int_t offsetb )
{
    ...
    int batchid = blockIdx.y;
    magma_tally4blas_dapply_transpose_vector_devfunc(n, du+offsetu, db_array[batchid]+offsetb);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
