...
typedef struct {
  ...
  /* Flags to wake up MAGMA_minproduct threads */
  volatile cuDoubleComplex **p;

  /* Synchronization flag */
  volatile magma_minproduct_int_t sync0;

  /* One synchronization flag for each MAGMA_minproduct thread */
  volatile magma_minproduct_int_t *sync1;
  
  /* Synchronization flag */
  volatile magma_minproduct_int_t sync2;

  /* Work space */
  cuDoubleComplex *w;

} magma_minproduct_qr_params;

//magma_minproduct_qr_params MG;

typedef struct {
  magma_minproduct_int_t tid;
  void *params;
} t_params;
...
extern "C" void *cpu_thread(void *a)
{
  ...
  magma_minproduct_qr_params *mp = (magma_minproduct_qr_params*)tp->params;

  //long magma_minproduct_int_t t = (long int) a;
...
loop:
  ...
  for (i = 0; i < mp->np_gpu; i++) 
  {
    ...
    lapackf77_zlarfb(Magma_minproductLeftStr, Magma_minproductTransStr, Magma_minproductForwardStr, Magma_minproductColumnwiseStr,
...
void magma_minproduct_qr_init(magma_minproduct_qr_params *qr_params,
                   magma_minproduct_int_t m, magma_minproduct_int_t n, cuDoubleComplex *a, magma_minproduct_int_t nthreads)
{
  magma_minproduct_int_t i;
...
/* ////////////////////////////////////////////////////////////////////////////
   -- Testing zgeqrf
*/
int main( magma_minproduct_int_t argc, char** argv) 
{
    magma_minproduct_int_t nquarkthreads=2;
    magma_minproduct_int_t nthreads=2;
    magma_minproduct_int_t num_gpus  = 1;
    TRACE = 0;

    //magma_minproduct_qr_params mp;

    cuDoubleComplex *h_A, *h_R, *h_work, *tau;
    double gpu_perf, cpu_perf, flops;

    magma_minproduct_timestr_t start, end;

    magma_minproduct_qr_params *mp = (magma_minproduct_qr_params*)malloc(sizeof(magma_minproduct_qr_params));

    /* Matrix size */
    magma_minproduct_int_t M=0, N=0, n2;
    magma_minproduct_int_t size[10] = {1024,2048,3072,4032,5184,6016,7040,8064,9088,10112};

    cublasStatus status;
    magma_minproduct_int_t i, j, info;
    ...
    magma_minproduct_int_t loop = argc;
    magma_minproduct_int_t accuracyflag = 1;

    char precision;

    magma_minproduct_int_t nc = -1;
    magma_minproduct_int_t ncps = -1;
...
fprintf(stderr,"%d %d %d %d %d\n",mp->nb,mp->ob,mp->ib,nquarkthreads,nthreads);
    ...
    /* Initialize MAGMA_minproduct hardware context, seeting how many CPU cores
       and how many GPUs to be used in the consequent computations  */
    mp->sync0 = 0;
    magma_minproduct_context *context;
    context = magma_minproduct_init((void*)(mp),cpu_thread, nthreads, nquarkthreads, num_gpus, argc, argv);
    context->params = (void *)(mp);

    mp->sync1 = (volatile magma_minproduct_int_t *) malloc (sizeof(int)*nthreads);
    ...
    magma_minproduct_int_t nb = magma_minproduct_get_zgeqrf_nb(min_mn);
    magma_minproduct_int_t lwork = N*nb;
    ...
    for(i=0; i<10; i++){
        ...
        lapackf77_zlacpy( Magma_minproductUpperLowerStr, &M, &N, h_A, &M, h_R, &M );

        //magma_minproduct_zgeqrf(M, N, h_R, M, tau, h_work, lwork, &info);
        ...
        /* ====================================================================
           ...
           =================================================================== */
        magma_minproduct_qr_init(mp, M, N, h_R, nthreads);

        start = get_current_time();
        magma_minproduct_zgeqrf3(context, M, N, h_R, M, tau, h_work, lwork, &info);
    ...
    /* =====================================================================
      ...
      printf("Argument %d of zgeqrf had an illegal value.\n", -info);
        ...
        cuDoubleComplex mone = MAGMA_minproduct_Z_NEG_ONE;
    ...
    /* Shut down the MAGMA_minproduct context */
    magma_minproduct_finalize(context);
}
