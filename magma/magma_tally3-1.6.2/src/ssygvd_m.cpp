/*
    -- MAGMA_tally3 (version 1.6.1) --
       ...
       @generated from dsygvd_m.cpp normal d -> s, Fri Jan 30 19:00:18 2015
    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally3_ssyevd_m( ngpu, jobz, uplo, n, A, lda, w, work, lwork, iwork, liwork, info );
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally3_strsm_m( ngpu, Magma_tally3Left, uplo, trans, Magma_tally3NonUnit,
