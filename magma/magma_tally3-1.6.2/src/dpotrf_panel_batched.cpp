    ...
    magma_tally3_int_t batchCount, cublasHandle_t myhandle, magma_tally3_queue_t queue)
{
    ...
    //===============================================
    if(n<nb){
        printf("magma_tally3_dpotrf_panel error n < nb %d < %d \n",(int) n, (int) nb);
        return -101;
    }
    ...
    if((n-nb) > 0){
        magma_tally3_ddisplace_pointers(dW0_displ, dA_array, ldda, nb, 0, batchCount, queue);
        magma_tally3blas_dtrsm_work_batched(Magma_tally3Right, Magma_tally3Lower, Magma_tally3ConjTrans, Magma_tally3NonUnit,
                              1, n-nb, nb, 
                              MAGMA_tally3_D_ONE,
                              dA_array,    ldda, 
                              dW0_displ,   ldda, 
    ...
    magma_tally3_int_t batchCount, cublasHandle_t myhandle, magma_tally3_queue_t queue)
{
    ...
    if(panel_nb <= min_recpnb){
        ...
        //magma_tally3_dpotrf_rectile_batched(uplo, m, panel_nb, 16,
        magma_tally3_dpotrf_panel_batched( uplo, m, panel_nb,
                           dA_displ, ldda,
                           dX_array, dX_length,
                           dinvA_array, dinvA_length,
        ...
        magma_tally3_ddisplace_pointers(dA_displ, dA_array, ldda, p1, p1, batchCount, queue);        
        magma_tally3_dpotrf_recpanel_batched(
        ...
        magma_tally3_ddisplace_pointers(dA_displ,  dA_array, ldda, p1+n1, p1, batchCount, queue);        
        magma_tally3_ddisplace_pointers(dW0_displ, dA_array, ldda, p1+n1, p2, batchCount, queue);        
        magma_tally3blas_dgemm_batched(Magma_tally3NoTrans, Magma_tally3ConjTrans, m2, n2, n1,
                              alpha, dA_displ, ldda, 
                              dA_displ, ldda, 
                              beta,  dW0_displ, ldda, 
                              batchCount, queue);
        ...
        magma_tally3_ddisplace_pointers(dA_displ, dA_array, ldda, p2, p2, batchCount, queue);        
        magma_tally3_dpotrf_recpanel_batched(
    ...
    magma_tally3_int_t batchCount, cublasHandle_t myhandle, magma_tally3_queue_t queue)
{
    ...
    if(panel_nb <= min_recpnb){
        ...
        magma_tally3_ddisplace_pointers(dA_displ,  dA_array, ldda, p1, p1, batchCount, queue);        
        magma_tally3_ddisplace_pointers(dW0_displ, dA_array, ldda, p2, p1, batchCount, queue);
        magma_tally3blas_dtrsm_work_batched(Magma_tally3Right, Magma_tally3Lower, Magma_tally3ConjTrans, Magma_tally3NonUnit,
                              1, n2, n1, 
                              MAGMA_tally3_D_ONE,
                              dA_displ,    ldda, 
        ...
        magma_tally3_ddisplace_pointers(dA_displ,  dA_array, ldda, p2, p1, batchCount, queue);        
        magma_tally3_ddisplace_pointers(dW0_displ, dA_array, ldda, p2, p2, batchCount, queue);        
        magma_tally3blas_dgemm_batched(Magma_tally3NoTrans, Magma_tally3ConjTrans, n2, n2, n1,
                              alpha, dA_displ, ldda, 
                              dA_displ, ldda, 
                              beta,  dW0_displ, ldda, 
                              batchCount, queue);
    ...
    if(m>n){
        ...
        magma_tally3_ddisplace_pointers(dA_displ,  dA_array, ldda, 0, 0, batchCount, queue);        
        magma_tally3_ddisplace_pointers(dW0_displ, dA_array, ldda, n, 0, batchCount, queue);
        magma_tally3blas_dtrsm_work_batched(Magma_tally3Right, Magma_tally3Lower, Magma_tally3ConjTrans, Magma_tally3NonUnit,
                              1, m-n, n, 
                              MAGMA_tally3_D_ONE,
                              dA_displ,    ldda, 
