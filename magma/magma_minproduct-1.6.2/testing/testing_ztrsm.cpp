...
int main( int argc, char** argv)
{
    ...
    real_Double_t   gflops, magma_minproduct_perf, magma_minproduct_time=0, cublas_perf, cublas_time, cpu_perf=0, cpu_time=0;
    ...
    printf("    M     N  MAGMA_minproduct Gflop/s (ms)  CUBLAS Gflop/s (ms)   CPU Gflop/s (ms)      MAGMA_minproduct     CUBLAS   LAPACK error\n");
    printf("============================================================================================================\n");
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_A,       magma_minproductDoubleComplex, lda*Ak  );
            TESTING_MALLOC_CPU( h_B,       magma_minproductDoubleComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_X,       magma_minproductDoubleComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_Blapack, magma_minproductDoubleComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_Bcublas, magma_minproductDoubleComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_Bmagma_minproduct,  magma_minproductDoubleComplex, ldb*N   );
            TESTING_MALLOC_CPU( ipiv,      magma_minproduct_int_t,        Ak      );
            
            TESTING_MALLOC_DEV( d_A,       magma_minproductDoubleComplex, ldda*Ak );
            TESTING_MALLOC_DEV( d_B,       magma_minproductDoubleComplex, lddb*N  );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_minproduct_zsetmatrix( Ak, Ak, h_A, lda, d_A, ldda );
            magma_minproduct_zsetmatrix( M, N, h_B, ldb, d_B, lddb );
            
            magma_minproduct_time = magma_minproduct_sync_wtime( NULL );
            magma_minproductblas_ztrsm( opts.side, opts.uplo, opts.transA, opts.diag, 
                             M, N,
                             alpha, d_A, ldda,
                                    d_B, lddb );
            ...
            magma_minproduct_zgetmatrix( M, N, d_B, lddb, h_Bmagma_minproduct, ldb );
            ...
            magma_minproduct_zgetmatrix( M, N, d_B, lddb, h_Bcublas, ldb );
            ...
            normX = lapackf77_zlange( "M", &M, &N, h_Bmagma_minproduct, &ldb, work );
            magma_minproduct_error = normR/(normX*normA);
