...
// ----------------------------------------
// CUDA kernel for magma_tally2_zlarfg.
...
// This was slightly faster (5%) than passing n to magma_tally2_sum_reduce.
// To use number of threads = min( NB, max( 1, n-1 )), pass n as
// argument to magma_tally2_sum_reduce, rather than as template parameter.
__global__ void
zlarfg_kernel(
    int n,
    ...
    magma_tally2DoubleComplex* dtau )
{
    ...
    __shared__ magma_tally2DoubleComplex sscale2;
    ...
    magma_tally2_max_reduce< NB >( tx, swork );
    if ( tx == 0 )
        sscale = swork[0];
    __syncthreads();
    ...
    if ( sscale > 0 ) {
        ...
        magma_tally2_sum_reduce< NB >( tx, swork );
        //magma_tally2_sum_reduce( blockDim.x, tx, swork );
    }
...
/**
    ...
    @ingroup magma_tally2_zaux1
    ********************************************************************/
extern "C"
void magma_tally2blas_zlarfg_q(
...
/**
    @see magma_tally2blas_zlarfg_q
    @ingroup magma_tally2_zaux1
    ********************************************************************/
extern "C"
void magma_tally2blas_zlarfg(
    magma_tally2_int_t n,
    magma_tally2DoubleComplex_ptr dalpha,
    magma_tally2DoubleComplex_ptr dx, magma_tally2_int_t incx,
    magma_tally2DoubleComplex_ptr dtau )
