...
int main( int argc, char** argv)
{
    ...
    magma_minproductFloat_ptr d_A, d_C;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_minproduct_ssetmatrix( An, Ak, h_A, lda, d_A, ldda );
            magma_minproduct_ssetmatrix( N, N, h_C, ldc, d_C, lddc );

            cublas_time = magma_minproduct_sync_wtime( NULL );
            cublasSsyrk( opts.handle, cublas_uplo_const(opts.uplo), cublas_trans_const(opts.transA), N, K,
                         &alpha, d_A, ldda,
                         &beta,  d_C, lddc );
            cublas_time = magma_minproduct_sync_wtime( NULL ) - cublas_time;
            cublas_perf = gflops / cublas_time;
            
            magma_minproduct_sgetmatrix( N, N, d_C, lddc, h_Ccublas, ldc );
