    ...
    magma_minproduct_int_t *info)
{
    ...
    magma_minproductDoubleComplex *work = NULL;
    ...
    *info = 0;
    ...
    magma_minproduct_zmalloc_cpu( &work, n * nrhs );
    if ( work == NULL ) {
    ...
    if (notran) {
        ...
        /* Solve A * X = B. */
        magma_minproduct_zgetmatrix( n, nrhs, dB, lddb, work, n );
        lapackf77_zlaswp(&nrhs, work, &n, &i1, &i2, ipiv, &inc);
        magma_minproduct_zsetmatrix( n, nrhs, work, n, dB, lddb );
