/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from magma_minproduct_z_blaswrapper.cpp normal z -> d, Sun May  3 11:22:57 2015
       @author Hartwig Anzt
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproduct_d_matrix x2={Magma_minproduct_CSR};
    ...
    if ( A.memory_location == Magma_minproduct_DEV ) {
        if ( A.num_cols == x.num_rows && x.num_cols == 1 ) {
             ...
             if ( A.storage_type == Magma_minproduct_CSR
                 ...
                 //magma_minproduct_dgecsrmv( Magma_minproductNoTrans, A.num_rows, A.num_cols, alpha,
                ...
                cusparseDcsrmv( cusparseHandle,CUSPARSE_OPERATION_NON_TRANSPOSE,
                 ...
                 CHECK( magma_minproduct_dgeelltmv( Magma_minproductNoTrans, A.num_rows, A.num_cols,
                 ...
                 CHECK( magma_minproduct_dgeellmv( Magma_minproductNoTrans, A.num_rows, A.num_cols,
                    A.max_nnz_row, alpha, A.dval, A.dcol, x.dval, beta,
                    y.dval, queue ));
                 //printf("done.\n");
             }
                 ...
                 CHECK( magma_minproduct_dgeellrtmv( Magma_minproductNoTrans, A.num_rows, A.num_cols,
                 ...
                 CHECK( magma_minproduct_dgesellpmv( Magma_minproductNoTrans, A.num_rows, A.num_cols,
                 ...
                 magma_minproductblas_dgemv( Magma_minproductNoTrans, A.num_rows, A.num_cols, alpha,
                 ...
                 //printf("using DENSE kernel for SpMV: ");
                 CHECK( magma_minproduct_dcustomspmv( alpha, x, beta, y, queue ));
                 //printf("done.\n");
             }
            ...
            if ( A.storage_type == Magma_minproduct_CSR ) {
                ...
                if ( x.major == Magma_minproductRowMajor) {
                 CHECK( magma_minproduct_dmgesellpmv( Magma_minproductNoTrans, A.num_rows, A.num_cols,
                    num_vecs, A.blocksize, A.numblocks, A.alignment,
                    alpha, A.dval, A.dcol, A.drow, x.dval, beta, y.dval, queue ));
                }
                else if ( x.major == Magma_minproductColMajor) {
                    // transpose first to row major
                    CHECK( magma_minproduct_dvtranspose( x, &x2, queue ));
                    CHECK( magma_minproduct_dmgesellpmv( Magma_minproductNoTrans, A.num_rows, A.num_cols,
                    num_vecs, A.blocksize, A.numblocks, A.alignment,
             ...
             /*if ( A.storage_type == Magma_minproduct_DENSE ) {
                 //printf("using DENSE kernel for SpMV: ");
                 magma_minproductblas_dmgemv( Magma_minproductNoTrans, A.num_rows, A.num_cols,
...
cleanup:
    ...
    cusparseHandle = 0;
    descr = 0;
    magma_minproduct_dmfree(&x2, queue );
    ...
    magma_minproduct_queue_t queue )
{
    ...
    if ( A.memory_location == Magma_minproduct_DEV ) {
         if ( A.storage_type == Magma_minproduct_CSR ) {
             //printf("using CSR kernel for SpMV: ");
             CHECK( magma_minproduct_dgecsrmv_shift( Magma_minproductNoTrans, A.num_rows, A.num_cols,
             ...
             //printf("using ELLPACKT kernel for SpMV: ");
             CHECK( magma_minproduct_dgeellmv_shift( Magma_minproductNoTrans, A.num_rows, A.num_cols,
             ...
             //printf("using ELL kernel for SpMV: ");
             CHECK( magma_minproduct_dgeelltmv_shift( Magma_minproductNoTrans, A.num_rows, A.num_cols,
                A.max_nnz_row, alpha, lambda, A.dval, A.dcol, x.dval, beta, offset,
                blocksize, add_rows, y.dval, queue ));
             //printf("done.\n");
         }
    ...
    if ( A.memory_location == Magma_minproduct_DEV ) {
        if ( A.num_cols == B.num_rows ) {
             ...
             if ( A.storage_type == Magma_minproduct_CSR
                ...
                CHECK( magma_minproduct_dcuspmm( A, B, C, queue ));
