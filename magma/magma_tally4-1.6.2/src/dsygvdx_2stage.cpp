    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally4_dsyevdx_2stage(jobz, range, uplo, n, A, lda, vl, vu, il, iu, m, w, work, lwork, iwork, liwork, info);
    ...
    if (wantz && *info == 0) {
        ...
        magma_tally4_dsetmatrix( n, *m, A, lda, dA, ldda );
        magma_tally4_dsetmatrix( n,  n, B, ldb, dB, lddb );
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally4_dtrsm(Magma_tally4Left, uplo, trans, Magma_tally4NonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally4_dtrmm(Magma_tally4Left, uplo, trans, Magma_tally4NonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }

        magma_tally4_dgetmatrix( n, *m, dA, ldda, A, lda );
