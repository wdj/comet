...
void zlacpy_full_device(
    int m, int n,
    const magma_tally2DoubleComplex *dA, int ldda,
    magma_tally2DoubleComplex       *dB, int lddb )
{
...
void zlacpy_full_kernel_batched(
    int m, int n,
    magma_tally2DoubleComplex const * const *dAarray, int ldda,
...
magma_tally2blas_zlacpy(
    ...
    magma_tally2DoubleComplex_ptr       dB, magma_tally2_int_t lddb )
{
    magma_tally2blas_zlacpy_q( uplo, m, n, dA, ldda, dB, lddb, magma_tally2_stream );
}
