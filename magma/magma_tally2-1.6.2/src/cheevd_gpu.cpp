    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally2_cstedx( Magma_tally2RangeAll, n, 0., 0., 0, 0, w, &rwork[inde],
        ...
        magma_tally2_csetmatrix( n, n, &work[indwrk], n, dC, lddc );

        magma_tally2_cunmtr_gpu( Magma_tally2Left, uplo, Magma_tally2NoTrans, n, n, dA, ldda, &work[indtau],
                          dC, lddc, wA, ldwa, &iinfo );

        magma_tally2_ccopymatrix( n, n, dC, lddc, dA, ldda );
