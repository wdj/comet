    ...
    magma_minproduct_queue_t queue )
{
    ...
    //magma_minproduct_dprint_matrix(A, queue );
    // copy matrix into preconditioner parameter
    magma_minproduct_d_matrix hA={Magma_minproduct_CSR}, hACSR={Magma_minproduct_CSR};
    magma_minproduct_d_matrix hL={Magma_minproduct_CSR}, hU={Magma_minproduct_CSR};
    CHECK( magma_minproduct_dmtransfer( A, &hA, A.memory_location, Magma_minproduct_CPU, queue ));
    CHECK( magma_minproduct_dmconvert( hA, &hACSR, hA.storage_type, Magma_minproduct_CSR, queue ));

        // in case using fill-in
    if( precond->levels > 0 ){
        magma_minproduct_d_matrix hAL={Magma_minproduct_CSR}, hAUt={Magma_minproduct_CSR};
        CHECK( magma_minproduct_dsymbilu( &hACSR, precond->levels, &hAL, &hAUt,  queue ));
        magma_minproduct_dmfree(&hAL, queue);
        magma_minproduct_dmfree(&hAUt, queue);
    }

    CHECK( magma_minproduct_dmtransfer(hACSR, &(precond->M), Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));

    magma_minproduct_dmfree( &hA, queue );
    magma_minproduct_dmfree( &hACSR, queue );
    ...
    CHECK( magma_minproduct_dmtransfer( precond->M, &hA, Magma_minproduct_DEV, Magma_minproduct_CPU, queue ));

    hL.diagorder_type = Magma_minproduct_UNITY;
    CHECK( magma_minproduct_dmconvert( hA, &hL , Magma_minproduct_CSR, Magma_minproduct_CSRL, queue ));
    hU.diagorder_type = Magma_minproduct_VALUE;
    CHECK( magma_minproduct_dmconvert( hA, &hU , Magma_minproduct_CSR, Magma_minproduct_CSRU, queue ));
    CHECK( magma_minproduct_dmtransfer( hL, &(precond->L), Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));
    CHECK( magma_minproduct_dmtransfer( hU, &(precond->U), Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproduct_d_matrix hA={Magma_minproduct_CSR}, hL={Magma_minproduct_CSR}, hU={Magma_minproduct_CSR};
    
    if (precond->L.memory_location != Magma_minproduct_DEV ){
        
        CHECK( magma_minproduct_dmtransfer( precond->M, &hA,
    ...
    if( precond->maxiter < 50 ){
        ...
        // extract the diagonal of L into precond->d
        CHECK( magma_minproduct_djacobisetup_diagscal( precond->L, &precond->d, queue ));
        CHECK( magma_minproduct_dvinit( &precond->work1, Magma_minproduct_DEV, precond->U.num_rows, 1, MAGMA_minproduct_D_ZERO, queue ));
        
        // extract the diagonal of U into precond->d2
        CHECK( magma_minproduct_djacobisetup_diagscal( precond->U, &precond->d2, queue ));
        CHECK( magma_minproduct_dvinit( &precond->work2, Magma_minproduct_DEV, precond->U.num_rows, 1, MAGMA_minproduct_D_ZERO, queue ));
    }
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproduct_d_matrix hA={Magma_minproduct_CSR}, hACSR={Magma_minproduct_CSR}, U={Magma_minproduct_CSR};
    CHECK( magma_minproduct_dmtransfer( A, &hA, A.memory_location, Magma_minproduct_CPU, queue ));
    ...
    CHECK( magma_minproduct_dmconvert( hACSR, &U, Magma_minproduct_CSR, Magma_minproduct_CSRL, queue ));
    magma_minproduct_dmfree( &hACSR, queue );
    CHECK( magma_minproduct_dmtransfer(U, &(precond->M), Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));
...
/*
    ...
    magma_minproduct_d_matrix hD, hR, hAt

    CHECK( magma_minproduct_dcsrsplit( 256, hA, &hD, &hR, queue ));

    CHECK( magma_minproduct_dmtransfer( hD, &precond->LD, Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));
    CHECK( magma_minproduct_dmtransfer( hR, &precond->L, Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));

    magma_minproduct_dmfree(&hD, queue );
    magma_minproduct_dmfree(&hR, queue );

    CHECK( magma_minproduct_d_cucsrtranspose(   hA, &hAt, queue ));

    CHECK( magma_minproduct_dcsrsplit( 256, hAt, &hD, &hR, queue ));

    CHECK( magma_minproduct_dmtransfer( hD, &precond->UD, Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));
    CHECK( magma_minproduct_dmtransfer( hR, &precond->U, Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));
    
    magma_minproduct_dmfree(&hD, queue );
    magma_minproduct_dmfree(&hR, queue );
    magma_minproduct_dmfree(&hA, queue );
    magma_minproduct_dmfree(&hAt, queue );
*/
