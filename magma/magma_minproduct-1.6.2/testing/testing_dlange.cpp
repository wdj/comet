...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            //h_A[ 1 + 1*lda ] = MAGMA_minproduct_D_NAN;
            ...
            norm_magma_minproduct = magma_minproductblas_dlange( norm[inorm], M, N, d_A, ldda, d_work );
            gpu_time = magma_minproduct_wtime() - gpu_time;
            gpu_perf = gbytes / gpu_time;
            if (norm_magma_minproduct < 0)
                printf("magma_minproductblas_dlange returned error %f: %s.\n",
            ...
            //         MAGMA_minproduct_D_REAL( h_A[1+1*lda] ),
            //         MAGMA_minproduct_D_IMAG( h_A[1+1*lda] ) );
