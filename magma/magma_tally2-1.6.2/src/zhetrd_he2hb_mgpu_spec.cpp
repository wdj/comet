    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally2DoubleComplex *dspace[Magma_tally2MaxGPUs];
    magma_tally2DoubleComplex *dwork[Magma_tally2MaxGPUs], *dworkbis[Magma_tally2MaxGPUs];
    magma_tally2DoubleComplex *dvall[Magma_tally2MaxGPUs], *dv[Magma_tally2MaxGPUs], *dw[Magma_tally2MaxGPUs];
    magma_tally2DoubleComplex *workngpu[Magma_tally2MaxGPUs+1];
    ...
    magma_tally2_int_t dwrk2siz    = ldda*nb*3;
    ...
    for( magma_tally2_int_t dev = 0; dev < ngpu; ++dev ) {
        ...
        magma_tally2_zmalloc( &dspace[dev], devworksiz );
        magma_tally2_zmalloc_pinned ( &workngpu[dev], worksiz);
    ...
    magma_tally2_zmalloc_pinned ( &workngpu[ngpu], worksiz);
    magma_tally2DoubleComplex *worktest = NULL;
    //magma_tally2_zmalloc_cpu( &worktest, n*nb ); // not used
    // ======================
  

    magma_tally2DoubleComplex *hT = work + lwork - nb*nb;
    lwork -= nb*nb;
    memset( hT, 0, nb*nb*sizeof(magma_tally2DoubleComplex));
    ...
    if (upper) {
        ...
        for (i = 1; i <= n-nb; i += nb) {
            ...
            if (i > 1 ) {
                // zpanel_to_q_tally2 copy the upper oof diagonal part of
                ...
                zpanel_to_q_tally2(Magma_tally2Upper, pn-1, A(i, i+1), lda, work);
                ...
                magma_tally2_zgetmatrix_async( (pm+pn), pn,
                                        dA(idev, i, di+1), ldda,
                ...
                //magma_tally2_setdevice( 0 );
                zq_to_panel_tally2(Magma_tally2Upper, pn-1, A(i, i+1), lda, work);
            }
            ...
            zpanel_to_q_tally2(Magma_tally2Upper, pk, A(indi, indj), lda, work);
            ...
            for( magma_tally2_int_t dev = 0; dev < ngpu; ++dev ) {
                magma_tally2_setdevice( dev );
                // send V
                magma_tally2_zsetmatrix_async( pm, pk,
                                        A(indi, indj), lda,
                                        dv[dev], pm, queues[dev][nqueue-1] );

                // Send the triangular factor T to the GPU
                magma_tally2_zsetmatrix_async( pk, pk,
                                        hT, nb,
            ...
            for( magma_tally2_int_t dev = 0; dev < ngpu; ++dev ) {
                ...
                magma_tally2_zgemm(Magma_tally2NoTrans, Magma_tally2NoTrans, pm, pk, pk,
                        c_one, dv[dev], pm,
                        dT(dev, 1, i), lddt,
                        c_zero, dwork[dev], pm);
            }
            ...
            for( magma_tally2_int_t dev = 0; dev < ngpu; ++dev ) {
                ...
                magma_tally2_zgemm(Magma_tally2ConjTrans, Magma_tally2NoTrans, pk, pk, pm,
                            c_one, dwork[dev], pm,
                            dw[dev], pm,
            ...
            zq_to_panel_tally2(Magma_tally2Upper, pk, A(indi, indj), lda, work);
            // ===============================================
            ...
            if (i + nb <= n-nb) {
                ...
                magma_tally2_zgemm(Magma_tally2NoTrans, Magma_tally2ConjTrans, pm, pn, pn, c_neg_one,
                            dv[idev], pm,
                            dw[idev], pm, c_one,
                ...
                magma_tally2_zher2k(Magma_tally2Lower, Magma_tally2NoTrans, pk, pk, c_neg_one,
                             dv[idev], pm,
                             dw[idev], pm, d_one,
                             dA(idev, indi, di+1), ldda);
                ...
                zpanel_to_q_tally2(Magma_tally2Upper, pk-1, A(n-pk+1, n-pk+2), lda, work);
                magma_tally2_zgetmatrix( pk, pk,
                                  dA(idev, indi, di+1), ldda,
                                  A(n-pk+1, n-pk+1),  lda );
                zq_to_panel_tally2(Magma_tally2Upper, pk-1, A(n-pk+1, n-pk+2), lda, work);
            }
