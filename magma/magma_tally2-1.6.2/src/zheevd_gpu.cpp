    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally2_zstedx( Magma_tally2RangeAll, n, 0., 0., 0, 0, w, &rwork[inde],
        ...
        magma_tally2_zsetmatrix( n, n, &work[indwrk], n, dC, lddc );

        magma_tally2_zunmtr_gpu( Magma_tally2Left, uplo, Magma_tally2NoTrans, n, n, dA, ldda, &work[indtau],
                          dC, lddc, wA, ldwa, &iinfo );

        magma_tally2_zcopymatrix( n, n, dC, lddc, dA, ldda );
