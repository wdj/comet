/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from testing_zlacpy_batched.cpp normal z -> d, Fri Jan 30 19:00:26 2015
       @author Mark Gates
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_minproduct_dsetmatrix( M, N, h_B, lda, d_B, ldda );
            ...
            magma_minproduct_setvector( ntile, sizeof(double*), hAarray, 1, dAarray, 1 );
            magma_minproduct_setvector( ntile, sizeof(double*), hBarray, 1, dBarray, 1 );
            
            gpu_time = magma_minproduct_sync_wtime( 0 );
            magma_minproductblas_dlacpy_batched( Magma_minproductUpperLower, mb, nb, dAarray, ldda, dBarray, ldda, ntile, queue );
            ...
            for( int tile = 0; tile < ntile; ++tile ) {
                ...
                lapackf77_dlacpy( Magma_minproductUpperLowerStr, &mb, &nb,
                                  &h_A[offset], &lda,
                                  &h_B[offset], &lda );
            }
            ...
            /* =====================================================================
               Check the result
               =================================================================== */
            magma_minproduct_dgetmatrix( M, N, d_B, ldda, h_A, lda );
