    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb >= k) {
        /* Use CPU code */
        lapackf77_dormqr( lapack_side_const_tally2(side), lapack_trans_const_tally2(trans),
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            dpanel_to_q_tally2( Magma_tally2Upper, ib, A(i,i), lda, T2 );
            magma_tally2_dsetmatrix( nq_i,  ib, A(i,i), lda, dV(0,0), nq_i );
            dq_to_panel_tally2( Magma_tally2Upper, ib, A(i,i), lda, T2 );
