...
///////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  #define TRANS_B
  #define batched_herk_kernel_name_(p)  magma_tally4blas_ ## p ## _herk_kernel_fermi_nt_batched
  ...
  #define TRANS_B
  #define CONJ_B
  #define batched_herk_kernel_name_(p)  magma_tally4blas_ ## p ## _herk_kernel_fermi_nc_batched
  ...
  #define TRANS_A
  #define batched_herk_kernel_name_(p)  magma_tally4blas_ ## p ## _herk_kernel_fermi_tn_batched
  ...
  #define TRANS_A
  #define CONJ_A
  #define batched_herk_kernel_name_(p)  magma_tally4blas_ ## p ## _herk_kernel_fermi_cn_batched
...
FloatingPoint_t tally4_compute(
    FloatingPoint_t A,
    FloatingPoint_t B,
    FloatingPoint_t C)
{
        ...
        for (k = 0; k < BLK_K; k++)
        {
            ...
            for (n = 0; n < THR_N; n++) {
                ...
                for (m = 0; m < THR_M; m++) {
                        ...
                        #if (version == trans_tn) && (precision == z)
                          rC[n][m] = tally4_compute(rA[m], rB[n], rC[n][m]);
                        #else
