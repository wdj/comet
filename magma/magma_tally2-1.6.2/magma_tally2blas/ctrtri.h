...
caxpy16(
    ...
    const magma_tally2FloatComplex * __restrict__ b,
    magma_tally2FloatComplex       * __restrict__ c )
{
    c[0]  += alpha * b[0];
    c[1]  += alpha * b[1];
    c[2]  += alpha * b[2];
...
cgemm_kernel_16(
    ...
    magma_tally2FloatComplex *B, int ldb,
    magma_tally2FloatComplex *C, int ldc,
    magma_tally2FloatComplex alpha, int jb, int tx, int ty)
{
...
ctrtri_diag_lower_kernel(
    magma_tally2_diag_t diag, int n, const magma_tally2FloatComplex *A, int lda, magma_tally2FloatComplex *d_invA);

__global__ void
triple_cgemm16_part1_lower_kernel(
    int n, const magma_tally2FloatComplex *Ain, int lda, magma_tally2FloatComplex *d_invA, int jb, int npages);
