    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
...
#else
        magma_minproduct_dstedx_m(ngpu, Magma_minproductRangeAll, n, 0., 0., 0, 0, w, &work[inde],
                       &work[indwrk], n, &work[indwk2],
        ...
        magma_minproduct_dormtr_m(ngpu, Magma_minproductLeft, uplo, Magma_minproductNoTrans, n, n, A, lda, &work[indtau],
