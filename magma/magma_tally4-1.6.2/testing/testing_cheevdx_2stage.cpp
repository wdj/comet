...
static magma_tally4_int_t check_orthogonality(magma_tally4_int_t M, magma_tally4_int_t N, magma_tally4FloatComplex *Q, magma_tally4_int_t LDQ, float eps);
static magma_tally4_int_t check_reduction(magma_tally4_uplo_t uplo, magma_tally4_int_t N, magma_tally4_int_t bw, magma_tally4FloatComplex *A, float *D, magma_tally4_int_t LDA, magma_tally4FloatComplex *Q, float eps );
static magma_tally4_int_t check_solution(magma_tally4_int_t N, float *E1, float *E2, float eps);
...
int main( int argc, char** argv)
{
    ...
    magma_tally4FloatComplex *h_A, *h_R, *h_work;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (opts.warmup) {
                ...
                // ==================================================================
                lapackf77_clacpy( Magma_tally4UpperLowerStr, &N, &N, h_A, &N, h_R, &N );
                if (opts.ngpu == 1) {
                    ...
                    magma_tally4_cheevdx_2stage_m(opts.ngpu, opts.jobz, range, opts.uplo, N, 
                                    h_R, N, 
                                    vl, vu, il, iu, 
                                    &m1, w1, 
                                    h_work, lwork, 
            ...
            if ( opts.check && opts.jobz != Magma_tally4NoVec ) {
                ...
                //printf("\n");
                //printf("------ TESTS FOR MAGMA_tally4 CHEEVD ROUTINE -------  \n");
...
static magma_tally4_int_t check_orthogonality(magma_tally4_int_t M, magma_tally4_int_t N, magma_tally4FloatComplex *Q, magma_tally4_int_t LDQ, float eps)
{
    ...
    float *work;
    magma_tally4_smalloc_cpu( &work, minMN );

    /* Build the idendity matrix */
    magma_tally4FloatComplex *Id;
    magma_tally4_cmalloc_cpu( &Id, minMN*minMN );
...
static magma_tally4_int_t check_reduction(magma_tally4_uplo_t uplo, magma_tally4_int_t N, magma_tally4_int_t bw, magma_tally4FloatComplex *A, float *D, magma_tally4_int_t LDA, magma_tally4FloatComplex *Q, float eps )
{
    ...
    magma_tally4FloatComplex *TEMP, *Residual;
    float *work;
    ...
    magma_tally4_cmalloc_cpu( &TEMP, N*N );
    magma_tally4_cmalloc_cpu( &Residual, N*N );
    ...
    Rnorm = lapackf77_clanhe("1", lapack_uplo_const_tally4(uplo), &N, Residual, &N, work);
    Anorm = lapackf77_clanhe("1", lapack_uplo_const_tally4(uplo), &N, A,        &LDA, work);
