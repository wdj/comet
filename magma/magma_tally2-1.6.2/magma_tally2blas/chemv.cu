...
/**
    Purpose
    -------
    magma_tally2blas_chemv_work performs the matrix-vector operation:
    ...
    MAGMA_tally2 implements chemv through two steps:
    ...
    magma_tally2blas_chemv is a wrapper routine allocating the workspace inside the
    routine and provides the same interface as cublas.
    
    If users need to call chemv frequently, we suggest using
    magma_tally2blas_chemv_work instead of magma_tally2blas_chemv. As the overhead to
    allocate and free in device memory in magma_tally2blas_chemv would hurt performance.
    ...
    magma_tally2_queue_t queue )
{
    ...
    if ( arch < 200 ) {
        magma_tally2_chemv( uplo, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
...
// end magma_tally2blas_chemv_work


/**
    Purpose
    -------
    magma_tally2blas_chemv performs the matrix-vector operation:
    ...
    magma_tally2FloatComplex_ptr dy, magma_tally2_int_t incy)
{
    ...
    magma_tally2blas_chemv_work( uplo, n, alpha, dA, ldda, dx, incx, beta, dy, incy,
