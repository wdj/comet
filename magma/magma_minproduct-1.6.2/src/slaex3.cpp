...
int magma_minproduct_get_slaed3_k() { return 512; }

void magma_minproduct_svrange(
...
magma_minproduct_slaex3(
    magma_minproduct_int_t k, magma_minproduct_int_t n, magma_minproduct_int_t n1,
    float *d,
    ...
    magma_minproduct_int_t *info )
{
    ...
    magma_minproduct_int_t lddq = n/2 + 1;
    magma_minproductFloat_ptr dQ2 = dwork;
    magma_minproductFloat_ptr dS  = dQ2  + n*lddq;
    magma_minproductFloat_ptr dQ  = dS   + n*lddq;

    magma_minproduct_int_t i, iq2, j, n12, n2, n23, tmp, lq2;
    float temp;
    ...
    *info = 0;
    ...
    magma_minproduct_ssetvector_async( lq2, Q2, 1, dQ2(0,0), 1, NULL );
...
#pragma omp barrier
    ...
    if (rk != 0) {
        if ( n23 != 0 ) {
            if (rk < magma_minproduct_get_slaed3_k()) {
                lapackf77_slacpy("A", &n23, &rk, Q(ctot[0],iil-1), &ldq, s, &n23);
                blasf77_sgemm("N", "N", &n2, &rk, &n23, &d_one, &Q2[iq2], &n2,
                              s, &n23, &d_zero, Q(n1,iil-1), &ldq );
            } else {
                magma_minproduct_ssetmatrix( n23, rk, Q(ctot[0],iil-1), ldq, dS(0,0), n23 );
                magma_minproduct_sgemm( Magma_minproductNoTrans, Magma_minproductNoTrans, n2, rk, n23,
                             d_one,  dQ2(iq2,0), n2,
                                     dS(0,0), n23,
                             d_zero, dQ(0,0), lddq);
                magma_minproduct_sgetmatrix( n2, rk, dQ(0,0), lddq, Q(n1,iil-1), ldq );
            }
        } else
        ...
        if ( n12 != 0 ) {
            if (rk < magma_minproduct_get_slaed3_k()) {
                ...
                magma_minproduct_ssetmatrix( n12, rk, Q(0,iil-1), ldq, dS(0,0), n12 );
                magma_minproduct_sgemm( Magma_minproductNoTrans, Magma_minproductNoTrans, n1, rk, n12,
                             d_one,  dQ2(0,0), n1,
                                     dS(0,0), n12,
                             d_zero, dQ(0,0), lddq);
                magma_minproduct_sgetmatrix( n1, rk, dQ(0,0), lddq, Q(0,iil-1), ldq );
            }
        } else
