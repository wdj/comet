...
#include "magma_tally3_task_dev_d.h"
  ...
  void magma_tally3_insert_dev_dmalloc_pinned(magma_tally3_int_t deviceID, magma_tally3_int_t size, double **A, void *A_dep_ptr)
 {
    ...
    //  schedule_Task_Flag_Set (&task_flags, THREAD_SET_TO MANUAL_SCHEDULING, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_tally3_task_dev_dmalloc_pinned, &task_flags,
            sizeof(magma_tally3_int_t),          &deviceID,VALUE,  
            sizeof(magma_tally3_int_t),          &size,       VALUE,
      ...
      //magma_tally3_dmalloc_pinned(A, size);
 ...
 void magma_tally3_insert_dev_dfree_pinned(magma_tally3_int_t deviceID, double *A, void *A_dep_ptr)
 {
    ...
    //  schedule_Task_Flag_Set (&task_flags, THREAD_SET_TO MANUAL_SCHEDULING, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_tally3_task_dev_dfree_pinned, &task_flags,
              ///sizeof(double**),                A,            OUTPUT,//*size
              sizeof(magma_tally3_int_t),             &deviceID,VALUE,
 ...
 void magma_tally3_insert_dev_dfree_pinned_index(magma_tally3_int_t deviceID, double **A, int index, void *A_dep_ptr)
 {
    ...
    //  schedule_Task_Flag_Set (&task_flags, THREAD_SET_TO MANUAL_SCHEDULING, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_tally3_task_dev_dfree_pinned_index, &task_flags,
              ///sizeof(double**),                A,            OUTPUT,//*size
              sizeof(magma_tally3_int_t),             &deviceID,VALUE,
              sizeof(double**),                A,              NODEP,//*size
              sizeof(magma_tally3_int_t),          &index,       VALUE,
              //dependency to set after the allocation is completed
              sizeof(void *),              A_dep_ptr,    INOUT,
              0);
  ...
  void magma_tally3_insert_dev_queue_sync(magma_tally3_int_t deviceID, magma_tally3_queue_t stream1, void *dep_ptr)
 {
   ...
   //  schedule_Task_Flag_Set (&task_flags, TASK_LOCK_TO_THREAD, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"black");
      ...
      schedule_Insert_Task(sched_obj, magma_tally3_task_dev_queue_sync, &task_flags,
              sizeof(magma_tally3_int_t),         &deviceID,    VALUE,
              sizeof(magma_tally3_queue_t),       &stream1,     VALUE,
  ...
  void magma_tally3_insert_dev_dsetmatrix(magma_tally3_int_t deviceID, magma_tally3_int_t m, magma_tally3_int_t nb, double *A_src, magma_tally3_int_t LDA, double *dA_dst, magma_tally3_int_t dA_LD)
 {
    ...
    //  schedule_Task_Flag_Set (&task_flags, THREAD_SET_TO MANUAL_SCHEDULING, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_tally3_task_dev_dsetmatrix, &task_flags,
          sizeof(magma_tally3_int_t),             &deviceID,VALUE,
              sizeof(magma_tally3_int_t),             &m,       VALUE,
              ...
              sizeof(magma_tally3_int_t),             &dA_LD,   VALUE,
              0);
 ...
 schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"indigo");
           ...
           schedule_Insert_Task(sched_obj, magma_tally3_task_dev_dgetmatrix, &task_flags,
               sizeof(magma_tally3_int_t),             &deviceID,VALUE,
              sizeof(magma_tally3_int_t),             &m,       VALUE,
              sizeof(magma_tally3_int_t),             &nb,      VALUE,
 ...
 void magma_tally3_insert_dev_dsetmatrix_transpose(magma_tally3_int_t deviceID, magma_tally3_int_t m, magma_tally3_int_t nb, double *A_src, magma_tally3_int_t LDA, double *dA_dst, magma_tally3_int_t dA_LD, double *dwork, magma_tally3_int_t dwork_LD, void *A_src_dep_ptr, void *dA_dst_dep_ptr)
 {
   ...
   //  schedule_Task_Flag_Set (&task_flags, TASK_LOCK_TO_THREAD, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_tally3_task_dev_dsetmatrix_transpose, &task_flags,
          sizeof(magma_tally3_int_t),             &deviceID,VALUE,
              sizeof(magma_tally3_int_t),             &m,       VALUE,
              sizeof(magma_tally3_int_t),             &nb,      VALUE,
              sizeof(double)*LDA*nb,           A_src,    INPUT,
             ...
             //  sizeof(double)*dwork_LD*nb,      dwork,    NODEP,
              sizeof(magma_tally3_int_t),             &dwork_LD,VALUE,
  ...
  void magma_tally3_insert_dev_dsetmatrix_async_transpose(magma_tally3_int_t deviceID, magma_tally3_int_t m, magma_tally3_int_t nb, double *A_src, magma_tally3_int_t LDA, double *dA_dst, magma_tally3_int_t dA_LD, magma_tally3_queue_t stream1, double *dwork, magma_tally3_int_t dwork_LD, void *A_src_dep_ptr, void *dA_dst_dep_ptr)
 {
   ...
   //  schedule_Task_Flag_Set (&task_flags, TASK_LOCK_TO_THREAD, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_tally3_task_dev_dsetmatrix_async_transpose, &task_flags,
          sizeof(magma_tally3_int_t),             &deviceID,VALUE,
              sizeof(magma_tally3_int_t),             &m,       VALUE,
              sizeof(magma_tally3_int_t),             &nb,      VALUE,
              sizeof(double)*LDA*nb,           A_src,    INPUT,
 ...
 schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"indigo");
           ...
           schedule_Insert_Task(sched_obj, magma_tally3_task_dev_dgetmatrix_transpose, &task_flags,
               sizeof(magma_tally3_int_t),             &deviceID,VALUE,
              sizeof(magma_tally3_int_t),             &m,       VALUE,
              sizeof(magma_tally3_int_t),             &nb,      VALUE,
              sizeof(double)*dA_LD*nb,         dA_src,   INPUT,
 ...
 schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"indigo");
           ...
           schedule_Insert_Task(sched_obj, magma_tally3_task_dev_dgetmatrix_async_transpose, &task_flags,
               sizeof(magma_tally3_int_t),            &deviceID,VALUE,
              sizeof(magma_tally3_int_t),             &m,       VALUE,
              sizeof(magma_tally3_int_t),             &nb,      VALUE,
              sizeof(double)*dA_LD*nb,         dA_src,   INPUT,
...
Schedule_Task_Flags  task_flags = Schedule_Task_Flags_Initializer;
    ...
    //    schedule_Task_Flag_Set(&task_flags, TASK_LOCK_TO_THREAD_MASK,    (intptr_t) str_master_excluded_mask);
        ...
        schedule_Insert_Task(sched_obj, magma_tally3_task_dev_dlaswp, &task_flags,
            sizeof(magma_tally3_int_t),             &deviceID,VALUE,
              sizeof(magma_tally3_int_t),             &n,       VALUE,
              sizeof(double)*lda*n,            dA,       INOUT,
              sizeof(magma_tally3_int_t),             &lda,     VALUE,
              sizeof(magma_tally3_int_t),             &i1,      VALUE,
              sizeof(magma_tally3_int_t),             &i2,      VALUE,
              sizeof(magma_tally3_int_t)*ipiv_size,   ipiv,     INPUT,
              sizeof(magma_tally3_int_t),             &inci,    VALUE,
              /*additional dependency to check before the swap*/
              sizeof(void *),                  dA_dep_ptr,INPUT,
              0);

     //magma_tally3_insert_dlaswp(gpu_ncols, dAT(K,K+A_N), dAT_LD, c_one, nb, &ipiv[K], c_one);
}
/**/
void magma_tally3_insert_dev_dtrsm(magma_tally3_int_t deviceID, magma_tally3_side_t side, magma_tally3_uplo_t uplo, magma_tally3_trans_t trans, magma_tally3_diag_t diag, magma_tally3_int_t m, magma_tally3_int_t n, double alpha, double *dA, magma_tally3_int_t lda, double *dB, magma_tally3_int_t ldb)
{
...
Schedule_Task_Flags  task_flags = Schedule_Task_Flags_Initializer;
     ...
     //        schedule_Task_Flag_Set (&task_flags, TASK_LOCK_TO_THREAD, 1 ) ;
             ...
             schedule_Insert_Task(sched_obj, magma_tally3_task_dev_dtrsm, &task_flags,
                 sizeof(magma_tally3_int_t),          &deviceID,VALUE,
              sizeof(magma_tally3_side_t),            &side,   VALUE,
              sizeof(magma_tally3_uplo_t),            &uplo,   VALUE,
              sizeof(magma_tally3_trans_t),           &trans,  VALUE,
              sizeof(magma_tally3_side_t),            &diag,   VALUE,
              sizeof(magma_tally3_int_t),             &m,      VALUE,
              sizeof(magma_tally3_int_t),             &n,      VALUE,
              ...
              sizeof(magma_tally3_int_t),             &ldb,    VALUE,
              0);
     //magma_tally3_insert_dtrsm('R', 'U', 'N', 'U', gpu_ncols, nb, c_one, dAT(K,K), dAT_LD, dAT(K,K+A_N), dAT_LD);
}

void magma_tally3_insert_dev_dgemm(magma_tally3_int_t deviceID, magma_tally3_trans_t transA, magma_tally3_trans_t transB, magma_tally3_int_t m, magma_tally3_int_t n, magma_tally3_int_t k, double alpha, double *dA, magma_tally3_int_t lda, double *dB, magma_tally3_int_t ldb, double beta, double *dC, magma_tally3_int_t ldc)
{
     magma_tally3_int_t ka, kb;
     Schedule_Task_Flags  task_flags = Schedule_Task_Flags_Initializer;

     ka = (transA==Magma_tally3NoTrans)?k:m;
     kb = (transB==Magma_tally3NoTrans)?n:k;
   ...
   //  schedule_Task_Flag_Set(&task_flags, TASK_LOCK_TO_THREAD_MASK,    (intptr_t) str_master_excluded_mask);
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"greenyellow");
              ...
              schedule_Insert_Task(sched_obj, magma_tally3_task_dev_dgemm, &task_flags,
                  sizeof(magma_tally3_int_t),         &deviceID,VALUE,
              sizeof(magma_tally3_trans_t),           &transA, VALUE,
              sizeof(magma_tally3_trans_t),           &transB, VALUE,
              sizeof(magma_tally3_int_t),             &m,      VALUE,
              sizeof(magma_tally3_int_t),             &n,      VALUE,
              sizeof(magma_tally3_int_t),             &k,      VALUE,
              sizeof(double),                  &alpha,  VALUE,
              ...
              sizeof(magma_tally3_int_t),             &ldc,    VALUE,
              0);

     //magma_tally3_insert_dgemm('N','N', gpu_ncols, gpu_nrows, nb, c_neg_one, dAT(K,K+A_N), dAT_LD, dAT(K+1,K), dAT_LD, c_one, dAT(K+1,K+A_N), dAT_LD);
}
