/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zhetrd_gpu.cpp normal z -> d, Fri Jan 30 19:00:17 2015
    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_dmalloc( &dwork, lddw*nb )) {
    ...
    if (upper) {
        ...
        for (i = n - nb; i >= kk; i -= nb) {
            ...
            magma_minproduct_dlatrd( uplo, i+nb, nb, A(0, 0), lda, e, tau,
        ...
        for (i = 0; i < n-nx; i += nb) {
            ...
            magma_minproduct_dlatrd( uplo, n-i, nb, A(i, i), lda, &e[i], &tau[i],
