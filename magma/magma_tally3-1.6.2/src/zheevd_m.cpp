    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
...
#else
        magma_tally3_zstedx_m(ngpu, Magma_tally3RangeAll, n, 0, 0, 0, 0, w, &rwork[inde],
                       &work[indwrk], n, &rwork[indrwk],
        ...
        magma_tally3_zunmtr_m(ngpu, Magma_tally3Left, uplo, Magma_tally3NoTrans, n, n, A, lda, &work[indtau],
