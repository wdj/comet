/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from testing_zungqr_gpu.cpp normal z -> c, Fri Jan 30 19:00:25 2015
...
int main( int argc, char** argv)
{
    ...
    magma_minproductFloatComplex *hA, *hR, *tau, *h_work;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_minproduct_cungqr_gpu( m, n, k, dA, ldda, tau, dT, nb, &info );
            ...
            magma_minproduct_cgetmatrix( m, n, dA, ldda, hR, lda );
