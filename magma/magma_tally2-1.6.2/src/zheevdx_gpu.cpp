...
/**
    ...
    lwork   INTEGER
            ...
            NB can be obtained through magma_tally2_get_zhetrd_nb(N).
    \n
...
magma_tally2_zheevdx_gpu(
    ...
    magma_tally2_int_t *mout, double *w,
    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    work[0]  = MAGMA_tally2_Z_MAKE( lwmin * one_eps, 0 );
    ...
    if (MAGMA_tally2_SUCCESS != magma_tally2_dmalloc( &dwork, ldwork_real )) {
        *info = MAGMA_tally2_ERR_DEVICE_ALLOC;
        return *info;
    }
    dC = (magma_tally2DoubleComplex*) dwork;
    ...
    if (iscale == 1) {
        magma_tally2blas_zlascl( uplo, 0, 0, 1., sigma, n, n, dA, ldda, info );
    }
...
#ifdef FAST_HEMV
    magma_tally2_zhetrd2_gpu( uplo, n, dA, ldda, w, &rwork[inde],
                       &work[indtau], wA, ldwa, &work[indwrk], llwork,
                       dC, ldwork, &iinfo );
#else
    magma_tally2_zhetrd_gpu ( uplo, n, dA, ldda, w, &rwork[inde],
                       &work[indtau], wA, ldwa, &work[indwrk], llwork,
                       &iinfo );
#endif
    ...
    if (! wantz) {
        ...
        magma_tally2_dmove_eig( range, n, w, &il, &iu, vl, vu, mout );
    }
    else {
        timer_start( time );
        ...
        magma_tally2_zsetmatrix( n, *mout, &work[indwrk + n * (il-1) ], n, dC, lddc );

        magma_tally2_zunmtr_gpu( Magma_tally2Left, uplo, Magma_tally2NoTrans, n, *mout, dA, ldda, &work[indtau],
                          dC, lddc, wA, ldwa, &iinfo );

        magma_tally2_zcopymatrix( n, *mout, dC, lddc, dA, ldda );
