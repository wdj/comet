...
void zlaswp_rowparallel_devfunc(  
                              ...
                              magma_tally3DoubleComplex *dout, int ldo,
                              magma_tally3_int_t* pivinfo)
{
    ...
    magma_tally3DoubleComplex *sdata = shared_data;
...
void zlaswp_rowparallel_kernel( 
                                int n, int width, int height,
                                magma_tally3DoubleComplex *dinput, int ldi, 
                                magma_tally3DoubleComplex *doutput, int ldo,
                                magma_tally3_int_t*  pivinfo)
{
...
void zlaswp_rowparallel_kernel_batched(
                                int n, int width, int height,
                                magma_tally3DoubleComplex **input_array, int ldi, 
                                magma_tally3DoubleComplex **output_array, int ldo,
...
//=================================================================================================
extern "C" void
magma_tally3_zlaswp_rowparallel_batched( magma_tally3_int_t n, 
                       magma_tally3DoubleComplex** input_array, magma_tally3_int_t ldi,
                       ...
                       magma_tally3_int_t batchCount, magma_tally3_queue_t queue)
{
    ...
    if( n < SWP_WIDTH)
    {
        zlaswp_rowparallel_kernel_batched<<<grid, height, sizeof(magma_tally3DoubleComplex) * height * n, queue >>>
                                           ( n, n, height, input_array, ldi, output_array, ldo, pivinfo_array ); 
    }
    else
    {
        zlaswp_rowparallel_kernel_batched<<< grid, height, sizeof(magma_tally3DoubleComplex) * height * SWP_WIDTH , queue >>>
...
//=================================================================================================
extern "C" void
magma_tally3_zlaswp_rowparallel_q( magma_tally3_int_t n, 
                       magma_tally3DoubleComplex* input, magma_tally3_int_t ldi,
                       magma_tally3DoubleComplex* output, magma_tally3_int_t ldo,
                       magma_tally3_int_t k1, magma_tally3_int_t k2,
                       magma_tally3_int_t *pivinfo, 
                       magma_tally3_queue_t queue)
{
    ...
    {
       printf(" height=%d > %d, magma_tally3_zlaswp_rowparallel_q not supported \n", n,MAX_NTHREADS);
    ...
    if( n < SWP_WIDTH)
    {
        zlaswp_rowparallel_kernel<<<grid, height, sizeof(magma_tally3DoubleComplex) * height * n, queue >>>
                                   ( n, n, height, input, ldi, output, ldo, pivinfo ); 
    }
    else
    {
        zlaswp_rowparallel_kernel<<< grid, height, sizeof(magma_tally3DoubleComplex) * height * SWP_WIDTH , queue >>>
...
extern "C" void
magma_tally3_zlaswp_rowparallel( magma_tally3_int_t n, magma_tally3DoubleComplex* input, magma_tally3_int_t ldi,
                   magma_tally3DoubleComplex* output, magma_tally3_int_t ldo,
                   magma_tally3_int_t k1, magma_tally3_int_t k2,
                   magma_tally3_int_t *pivinfo)
{
    magma_tally3_zlaswp_rowparallel_q(n, input, ldi, output, ldo, k1, k2, pivinfo, magma_tally3_stream);
}
...
//=================================================================================================
__global__ void zlaswp_rowserial_kernel_batched( int n, magma_tally3DoubleComplex **dA_array, int lda, int k1, int k2, magma_tally3_int_t** ipiv_array )
{
    magma_tally3DoubleComplex* dA = dA_array[blockIdx.z];
    magma_tally3_int_t *d_ipiv = ipiv_array[blockIdx.z];
...
//=================================================================================================
__global__ void zlaswp_columnserial_kernel_batched( int n, magma_tally3DoubleComplex **dA_array, int lda, int k1, int k2, magma_tally3_int_t** ipiv_array )
{
    magma_tally3DoubleComplex* dA = dA_array[blockIdx.z];
    magma_tally3_int_t *d_ipiv = ipiv_array[blockIdx.z];
