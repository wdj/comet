...
int main( int argc, char** argv)
{
    ...
    magma_tally2_int_t Ak, An, Bk, Bn;
    ...
    magma_tally2FloatComplex *h_A, *h_B, *h_C, *h_Ccublas;
    ...
    float beta  = MAGMA_tally2_D_MAKE( -0.48,  0.38 );
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_B,       magma_tally2FloatComplex, ldb*Bk );
            TESTING_MALLOC_CPU( h_C,       magma_tally2FloatComplex, ldc*N  );
            TESTING_MALLOC_CPU( h_Ccublas, magma_tally2FloatComplex, ldc*N  );
            
            TESTING_MALLOC_DEV( d_A, magma_tally2FloatComplex, ldda*Ak );
            TESTING_MALLOC_DEV( d_B, magma_tally2FloatComplex, lddb*Bk );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally2_csetmatrix( An, Ak, h_A, lda, d_A, ldda );
            magma_tally2_csetmatrix( Bn, Bk, h_B, ldb, d_B, lddb );
            magma_tally2_csetmatrix( N, N, h_C, ldc, d_C, lddc );
            
            cublas_time = magma_tally2_sync_wtime( NULL );
            cublasCher2k( opts.handle, cublas_uplo_const_tally2(opts.uplo), cublas_trans_const_tally2(opts.transA), N, K,
                          &alpha, d_A, ldda,
                                  d_B, lddb,
                          &beta,  d_C, lddc );
            ...
            magma_tally2_cgetmatrix( N, N, d_C, lddc, h_Ccublas, ldc );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_cher2k( lapack_uplo_const_tally2(opts.uplo), lapack_trans_const_tally2(opts.transA), &N, &K,
                               &alpha, h_A, &lda,
                                       h_B, &ldb,
                               &beta,  h_C, &ldc );
