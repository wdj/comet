...
static magma_tally3_int_t check_orthogonality(magma_tally3_int_t M, magma_tally3_int_t N, magma_tally3DoubleComplex *Q, magma_tally3_int_t LDQ, double eps);
static magma_tally3_int_t check_reduction(magma_tally3_uplo_t uplo, magma_tally3_int_t N, magma_tally3_int_t bw, magma_tally3DoubleComplex *A, double *D, magma_tally3_int_t LDA, magma_tally3DoubleComplex *Q, double eps );
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (opts.warmup) {
                ...
                if (opts.ngpu == 1) {
                    ...
                    magma_tally3_zheevdx_2stage_m(opts.ngpu, opts.jobz, range, opts.uplo, N, 
                                    h_R, N, 
                                    vl, vu, il, iu, 
                                    &m1, w1, 
                                    h_work, lwork, 
            ...
            if ( opts.check && opts.jobz != Magma_tally3NoVec ) {
                ...
                //printf("\n");
                //printf("------ TESTS FOR MAGMA_tally3 ZHEEVD ROUTINE -------  \n");
...
static magma_tally3_int_t check_orthogonality(magma_tally3_int_t M, magma_tally3_int_t N, magma_tally3DoubleComplex *Q, magma_tally3_int_t LDQ, double eps)
{
    ...
    magma_tally3DoubleComplex *Id;
    magma_tally3_zmalloc_cpu( &Id, minMN*minMN );
...
static magma_tally3_int_t check_reduction(magma_tally3_uplo_t uplo, magma_tally3_int_t N, magma_tally3_int_t bw, magma_tally3DoubleComplex *A, double *D, magma_tally3_int_t LDA, magma_tally3DoubleComplex *Q, double eps )
{
    ...
    magma_tally3DoubleComplex *TEMP, *Residual;
    double *work;
    ...
    magma_tally3_zmalloc_cpu( &TEMP, N*N );
    magma_tally3_zmalloc_cpu( &Residual, N*N );
    ...
    Rnorm = lapackf77_zlanhe("1", lapack_uplo_const_tally3(uplo), &N, Residual, &N, work);
    Anorm = lapackf77_zlanhe("1", lapack_uplo_const_tally3(uplo), &N, A,        &LDA, work);
