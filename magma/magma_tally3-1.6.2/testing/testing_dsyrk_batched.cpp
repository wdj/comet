...
int main( int argc, char** argv)
{
    ...
    double *h_A, *h_C, *h_Cmagma_tally3;
    double *d_A, *d_C;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally3_dsetmatrix( An, Ak*batchCount, h_A, lda, d_A, ldda );
            magma_tally3_dsetmatrix( N, N*batchCount, h_C, ldc, d_C, lddc );
            ...
            magma_tally3blas_dsyrk_batched(opts.uplo, opts.transA, N, K,
                             alpha, A_array, ldda,
            ...
            magma_tally3_dgetmatrix( N, NN, d_C, lddc, h_Cmagma_tally3, ldc );
            ...
            if ( opts.check ) {
                ...
                for(int i=0; i<batchCount; i++)
                {
                    Cnorm = lapackf77_dlansy("fro", lapack_uplo_const_tally3(opts.uplo), &N, h_C+i*ldc*N, &ldc, work);
                    blasf77_daxpy( &sizeC, &c_neg_one, h_C+i*ldc*N, &ione, h_Cmagma_tally3+i*ldc*N, &ione );
                    current_error = lapackf77_dlansy( "fro", lapack_uplo_const_tally3(opts.uplo), &N, h_Cmagma_tally3+i*ldc*N, &ldc, work ) / Cnorm;
