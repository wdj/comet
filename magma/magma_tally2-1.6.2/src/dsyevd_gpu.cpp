    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally2_dstedx( Magma_tally2RangeAll, n, 0., 0., 0, 0, w, &work[inde],
        ...
        magma_tally2_dsetmatrix( n, n, &work[indwrk], n, dwork, lddc );

        magma_tally2_dormtr_gpu( Magma_tally2Left, uplo, Magma_tally2NoTrans, n, n, dA, ldda, &work[indtau],
                          dwork, lddc, wA, ldwa, &iinfo );

        magma_tally2_dcopymatrix( n, n, dwork, lddc, dA, ldda );
