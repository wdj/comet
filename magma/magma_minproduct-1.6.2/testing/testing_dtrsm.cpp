...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_Bmagma_minproduct,  double, ldb*N   );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_minproduct_dsetmatrix( Ak, Ak, h_A, lda, d_A, ldda );
            magma_minproduct_dsetmatrix( M, N, h_B, ldb, d_B, lddb );
            
            magma_minproduct_time = magma_minproduct_sync_wtime( NULL );
            magma_minproductblas_dtrsm( opts.side, opts.uplo, opts.transA, opts.diag, 
                             M, N,
                             alpha, d_A, ldda,
                                    d_B, lddb );
            ...
            magma_minproduct_dgetmatrix( M, N, d_B, lddb, h_Bmagma_minproduct, ldb );
            ...
            magma_minproduct_dgetmatrix( M, N, d_B, lddb, h_Bcublas, ldb );
            ...
            normX = lapackf77_dlange( "M", &M, &N, h_Bmagma_minproduct, &ldb, work );
