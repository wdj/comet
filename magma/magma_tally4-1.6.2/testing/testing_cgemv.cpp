...
int main(int argc, char **argv)
{
    ...
    float          magma_tally4_error, dev_error, work[1];
    magma_tally4_int_t ione     = 1;
    magma_tally4_int_t ISEED[4] = {0,0,0,1};
    magma_tally4_int_t M, N, Xm, Ym, lda, sizeA, sizeX, sizeY;
    ...
    magma_tally4FloatComplex *A, *X, *Y, *Ydev, *Ymagma_tally4;
    ...
    #ifdef HAVE_CUBLAS
        printf("    M     N   MAGMA_tally4 Gflop/s (ms)  %s Gflop/s (ms)   CPU Gflop/s (ms)  MAGMA_tally4 error  %s error\n",
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( Ydev,    magma_tally4FloatComplex, sizeY );
            TESTING_MALLOC_CPU( Ymagma_tally4,  magma_tally4FloatComplex, sizeY );
            
            TESTING_MALLOC_DEV( dA, magma_tally4FloatComplex, sizeA );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally4_csetmatrix( M, N, A, lda, dA, lda );
            magma_tally4_csetvector( Xm, X, incx, dX, incx );
            magma_tally4_csetvector( Ym, Y, incy, dY, incy );
            
            #ifdef HAVE_CUBLAS
                dev_time = magma_tally4_sync_wtime( 0 );
                cublasCgemv( opts.handle, cublas_trans_const_tally4(opts.transA),
                             M, N, &alpha, dA, lda, dX, incx, &beta, dY, incy );
                dev_time = magma_tally4_sync_wtime( 0 ) - dev_time;
            #else
                dev_time = magma_tally4_sync_wtime( opts.queue );
                magma_tally4_cgemv( opts.transA, M, N,
                             &alpha, dA, lda,
                                     dX, incx,
                             &beta,  dY, incy );
            ...
            magma_tally4_cgetvector( Ym, dY, incy, Ydev, incy );
            ...
            /* =====================================================================
               ...
               =================================================================== */
                ...
                magma_tally4blas_cgemv( opts.transA, M, N, alpha, dA, lda, dX, incx, beta, dY, incy );
                magma_tally4_time = magma_tally4_sync_wtime( 0 ) - magma_tally4_time;
                magma_tally4_perf = gflops / magma_tally4_time;
                
                magma_tally4_cgetvector( Ym, dY, incy, Ymagma_tally4, incy );
            #endif
            ...
            blasf77_cgemv( lapack_trans_const_tally4(opts.transA), &M, &N,
                           &alpha, A, &lda,
                                   X, &incx,
                           &beta,  Y, &incy );
            ...
            #ifdef HAVE_CUBLAS
                blasf77_caxpy( &Ym, &c_neg_one, Y, &incy, Ymagma_tally4, &incy );
                magma_tally4_error = lapackf77_clange( "F", &Ym, &ione, Ymagma_tally4, &Ym, work ) / (Anorm * Xnorm);
