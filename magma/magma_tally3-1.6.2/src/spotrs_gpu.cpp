    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if ( uplo == Magma_tally3Upper ) {
        if ( nrhs == 1) {
            magma_tally3_strsv(Magma_tally3Upper, Magma_tally3ConjTrans, Magma_tally3NonUnit, n, dA, ldda, dB, 1 );
            magma_tally3_strsv(Magma_tally3Upper, Magma_tally3NoTrans,   Magma_tally3NonUnit, n, dA, ldda, dB, 1 );
        } else {
            magma_tally3_strsm(Magma_tally3Left, Magma_tally3Upper, Magma_tally3ConjTrans, Magma_tally3NonUnit, n, nrhs, c_one, dA, ldda, dB, lddb);
        ...
        if ( nrhs == 1) {
            magma_tally3_strsv(Magma_tally3Lower, Magma_tally3NoTrans,   Magma_tally3NonUnit, n, dA, ldda, dB, 1 );
            magma_tally3_strsv(Magma_tally3Lower, Magma_tally3ConjTrans, Magma_tally3NonUnit, n, dA, ldda, dB, 1 );
        } else {
            magma_tally3_strsm(Magma_tally3Left, Magma_tally3Lower, Magma_tally3NoTrans,   Magma_tally3NonUnit, n, nrhs, c_one, dA, ldda, dB, lddb);
            magma_tally3_strsm(Magma_tally3Left, Magma_tally3Lower, Magma_tally3ConjTrans, Magma_tally3NonUnit, n, nrhs, c_one, dA, ldda, dB, lddb);
        }
    }
