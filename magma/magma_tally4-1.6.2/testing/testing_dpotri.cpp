...
int main( int argc, char** argv)
{
    ...
    magma_tally4_int_t N, n2, lda, info;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* ====================================================================
               ...
               =================================================================== */
            if ( opts.warmup ) {
                magma_tally4_dpotrf( opts.uplo, N, h_R, lda, &info );
                magma_tally4_dpotri( opts.uplo, N, h_R, lda, &info );
                lapackf77_dlacpy( Magma_tally4UpperLowerStr, &N, &N, h_A, &lda, h_R, &lda );
            }
            ...
            //h_R[ 10 + 10*lda ] = MAGMA_tally4_D_MAKE( 0.0, 0.0 );
            ...
            if (info != 0)
                printf("magma_tally4_dpotri returned error %d: %s.\n",
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_dpotri( lapack_uplo_const_tally4(opts.uplo), &N, h_A, &lda, &info );
