/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zmcsrpass.cpp normal z -> s, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_tally2_queue_t queue )
{
    ...
    magma_tally2_s_matrix A_CPU={Magma_tally2_CSR}, A_CSR={Magma_tally2_CSR};
    ...
    if ( A.memory_location == Magma_tally2_CPU && A.storage_type == Magma_tally2_CSR ) {
        ...
        *row = A.row;
        ...
        CHECK( magma_tally2_smtransfer( A, &A_CPU, A.memory_location, Magma_tally2_CPU, queue ));
        CHECK( magma_tally2_smconvert( A_CPU, &A_CSR, A_CPU.storage_type, Magma_tally2_CSR, queue ));
        CHECK( magma_tally2_scsrget( A_CSR, m, n, row, col, val, queue ));
    }

cleanup:
    magma_tally2_smfree( &A_CSR, queue );
    magma_tally2_smfree( &A_CPU, queue );
    return info;
}
