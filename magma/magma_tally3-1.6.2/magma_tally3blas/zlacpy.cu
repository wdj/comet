...
void zlacpy_full_device(
    int m, int n,
    const magma_tally3DoubleComplex *dA, int ldda,
    magma_tally3DoubleComplex       *dB, int lddb )
{
...
void zlacpy_full_kernel_batched(
    int m, int n,
    magma_tally3DoubleComplex const * const *dAarray, int ldda,
    magma_tally3DoubleComplex **dBarray, int lddb )
{
...
magma_tally3blas_zlacpy(
    ...
    magma_tally3DoubleComplex_ptr       dB, magma_tally3_int_t lddb )
{
    magma_tally3blas_zlacpy_q( uplo, m, n, dA, ldda, dB, lddb, magma_tally3_stream );
}
