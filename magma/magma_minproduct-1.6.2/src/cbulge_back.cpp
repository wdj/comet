...
static void *magma_minproduct_capplyQ_parallel_section(void *arg);

static void magma_minproduct_ctile_bulge_applyQ(magma_minproduct_int_t core_id, magma_minproduct_side_t side, magma_minproduct_int_t n_loc, magma_minproduct_int_t n, magma_minproduct_int_t nb, magma_minproduct_int_t Vblksiz,
                                     magma_minproductFloatComplex *E, magma_minproduct_int_t lde, magma_minproductFloatComplex *V, magma_minproduct_int_t ldv,
                                     magma_minproductFloatComplex *TAU, magma_minproductFloatComplex *T, magma_minproduct_int_t ldt);

//////////////////////////////////////////////////////////////////////////////////////////////////////////

typedef struct magma_minproduct_capplyQ_data_s {
    ...
    magma_minproductFloatComplex* E;
    ...
    magma_minproductFloatComplex* dE;
    magma_minproduct_int_t ldde;
    pthread_barrier_t barrier;
} magma_minproduct_capplyQ_data;

void magma_minproduct_capplyQ_data_init(
    magma_minproduct_capplyQ_data *zapplyQ_data, magma_minproduct_int_t threads_num, magma_minproduct_int_t n, magma_minproduct_int_t ne, magma_minproduct_int_t n_gpu,
    magma_minproduct_int_t nb, magma_minproduct_int_t Vblksiz, magma_minproductFloatComplex *E, magma_minproduct_int_t lde,
    magma_minproductFloatComplex *V, magma_minproduct_int_t ldv, magma_minproductFloatComplex *TAU,
    magma_minproductFloatComplex *T, magma_minproduct_int_t ldt, magma_minproductFloatComplex *dE, magma_minproduct_int_t ldde)
{
...
void magma_minproduct_capplyQ_data_destroy(
    magma_minproduct_capplyQ_data *zapplyQ_data)
{
    pthread_barrier_destroy(&(zapplyQ_data->barrier));
}

typedef struct magma_minproduct_capplyQ_id_data {
    magma_minproduct_int_t id;
    magma_minproduct_capplyQ_data* data;
} magma_minproduct_capplyQ_id_data;

void magma_minproduct_capplyQ_id_data_init(
    magma_minproduct_capplyQ_id_data *zapplyQ_id_data,
    magma_minproduct_int_t id, magma_minproduct_capplyQ_data* data)
{
...
//$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    if (n_gpu < ne) {
        ...
        #endif
        magma_minproduct_capplyQ_data data_applyQ;
        magma_minproduct_capplyQ_data_init(&data_applyQ, threads, n, ne, n_gpu, nb, Vblksiz, Z, ldz, V, ldv, TAU, T, ldt, dZ, lddz);

        magma_minproduct_capplyQ_id_data* arg;
        magma_minproduct_malloc_cpu((void**) &arg, threads*sizeof(magma_minproduct_capplyQ_id_data));
        ...
        for (magma_minproduct_int_t thread = 1; thread < threads; thread++) {
            magma_minproduct_capplyQ_id_data_init(&(arg[thread]), thread, &data_applyQ);
            pthread_create(&thread_id[thread], &thread_attr, magma_minproduct_capplyQ_parallel_section, &arg[thread]);
        }
        magma_minproduct_capplyQ_id_data_init(&(arg[0]), 0, &data_applyQ);
        magma_minproduct_capplyQ_parallel_section(&arg[0]);
        ...
        magma_minproduct_capplyQ_data_destroy(&data_applyQ);


        magma_minproduct_csetmatrix(n, ne-n_gpu, Z + n_gpu*ldz, ldz, dZ + n_gpu*ldz, lddz);

        /*============================
         *  use only GPU
         *==========================*/
    } else {
        magma_minproduct_csetmatrix(n, ne, Z, ldz, dZ, lddz);
        magma_minproduct_cbulge_applyQ_v2(Magma_minproductLeft, ne, n, nb, Vblksiz, dZ, lddz, V, ldv, T, ldt, info);
...
static void *magma_minproduct_capplyQ_parallel_section(void *arg)
{
    magma_minproduct_int_t my_core_id   = ((magma_minproduct_capplyQ_id_data*)arg) -> id;
    magma_minproduct_capplyQ_data* data = ((magma_minproduct_capplyQ_id_data*)arg) -> data;
    ...
    magma_minproductFloatComplex *dE        = data -> dE;
    ...
    if (my_core_id == 0) {
        ...
        magma_minproduct_csetmatrix(n, n_gpu, E, lde, dE, ldde);
        magma_minproduct_cbulge_applyQ_v2(Magma_minproductLeft, n_gpu, n, nb, Vblksiz, dE, ldde, V, ldv, T, ldt, &info);
        magma_minproduct_device_sync();
