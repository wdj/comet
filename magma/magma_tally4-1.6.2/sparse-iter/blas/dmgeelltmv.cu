/*
    -- MAGMA_tally4 (version 1.6.2) --
       ...
       @generated from zmgeelltmv.cu normal z -> d, Sun May  3 11:22:58 2015
        ...
        double * dy)
{
    ...
    if(row < num_rows ){
        for( int i=0; i<num_vecs; i++ )
                dot[ threadIdx.x+ i*blockDim.x ] = MAGMA_tally4_D_MAKE(0.0, 0.0);
    ...
    magma_tally4_queue_t queue )
{
    ...
    dmgeelltmv_kernel<<< grid, threads, MEM_SIZE, queue >>>
