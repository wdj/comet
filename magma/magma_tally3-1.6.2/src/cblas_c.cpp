/*
    ...
    magma_tally3_cblas_scasum / dasum
    magma_tally3_cblas_scnrm2 / dnrm2
    magma_tally3_cblas_cdotc  / ddot
    magma_tally3_cblas_cdotu  / ddot
    ...
    const magma_tally3FloatComplex *y, magma_tally3_int_t incy )
{
    ...
    magma_tally3FloatComplex value = MAGMA_tally3_C_ZERO;
    ...
    return value;
    //#ifdef COMPLEX
    //magma_tally3FloatComplex value;
