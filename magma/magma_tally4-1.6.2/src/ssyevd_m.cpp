    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
...
#else
        magma_tally4_sstedx_m(ngpu, Magma_tally4RangeAll, n, 0., 0., 0, 0, w, &work[inde],
                       &work[indwrk], n, &work[indwk2],
        ...
        magma_tally4_sormtr_m(ngpu, Magma_tally4Left, uplo, Magma_tally4NoTrans, n, n, A, lda, &work[indtau],
