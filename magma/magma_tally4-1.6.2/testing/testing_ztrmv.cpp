...
int main( int argc, char** argv)
{
    ...
    magma_tally4DoubleComplex *h_A, *h_x, *h_xcublas;
    ...
    printf("uplo = %s, transA = %s, diag = %s \n",
           ...
           lapack_diag_const_tally4(opts.diag) );
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            cublasZtrmv( opts.handle, cublas_uplo_const_tally4(opts.uplo), cublas_trans_const_tally4(opts.transA),
                         cublas_diag_const_tally4(opts.diag),
                         N, 
                         d_A, ldda,
                         d_x, 1 );
