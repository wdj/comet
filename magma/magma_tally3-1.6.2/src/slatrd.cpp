        ...
        for (i = n-1; i >= n - nb; --i) {
            ...
            if (i > 0) {
                ...
                *A(i-1,i) = MAGMA_tally3_S_ONE;
                ...
                magma_tally3_ssetvector( i, A(0, i), 1, dA(0, i), 1 );
                
                magma_tally3_ssymv( Magma_tally3Upper, i, c_one, dA(0, 0), ldda,
        ...
        for (i = 0; i < nb; ++i) {
            ...
            if (i < n-1) {
                ...
                *A(i+1,i) = MAGMA_tally3_S_ONE;
                ...
                magma_tally3_ssetvector( i_n, A(i+1, i), 1, dA(i+1, i), 1 );
                
                magma_tally3_ssymv( Magma_tally3Lower, i_n, c_one, dA(i+1, i+1), ldda,
