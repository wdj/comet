...
/**
    ...
    @ingroup magma_tally3_zposv_driver
    ********************************************************************/
    ...
    magma_tally3_int_t *info)
{
    ...
    magma_tally3_int_t     i, j, iiter, lddsa, lddsx, lddr;
    ...
    *info = 0;
    ...
    Anrm = magma_tally3blas_zlanhe(Magma_tally3InfNorm, uplo, n, dA, ldda, (double*)dworkd );
    cte  = Anrm * eps * pow((double)n, 0.5) * BWDMAX;

    /*
     * Convert to single precision
     */
    magma_tally3blas_zlag2c( n, nrhs, dB, lddb, dSX, lddsx, info );
    if (*info != 0) {
        *iter = -2;
        goto FALLBACK;
    }

    magma_tally3blas_zlat2c( uplo, n, dA, ldda, dSA, lddsa, info );
    if (*info != 0) {
        *iter = -2;
        goto FALLBACK;
    }
    ...
    magma_tally3_cpotrf_gpu( uplo, n, dSA, lddsa, info );
    if (*info != 0) {
        *iter = -3;
        goto FALLBACK;
    }
    ...
    magma_tally3_cpotrs_gpu( uplo, n, nrhs, dSA, lddsa, dSX, lddsx, info );
    ...
    if ( nrhs == 1 ) {
        magma_tally3_zhemv( uplo, n,
                     c_neg_one, dA, ldda,
                                dX, 1,
                     c_one,     dR, 1 );
    }
    else {
        magma_tally3_zhemm( Magma_tally3Left, uplo, n, nrhs,
                     c_neg_one, dA, ldda,
                                dX, lddx,
                     c_one,     dR, lddr );
    }
...
REFINEMENT:
    for( iiter=1; iiter < ITERMAX; ) {
        *info = 0;
        ...
        magma_tally3blas_zlag2c( n, nrhs, dR, lddr, dSX, lddsx, info );
        if (*info != 0) {
            *iter = -2;
            goto FALLBACK;
        }
...
FALLBACK:
    ...
    magma_tally3_zpotrf_gpu( uplo, n, dA, ldda, info );
    if (*info == 0) {
        magma_tally3blas_zlacpy( Magma_tally3UpperLower, n, nrhs, dB, lddb, dX, lddx );
        magma_tally3_zpotrs_gpu( uplo, n, nrhs, dA, ldda, dX, lddx, info );
    }
