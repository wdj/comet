                  ...
                  magma_tally2_int_t batchCount, magma_tally2_queue_t queue)
{
    ...
    info = magma_tally2_zgetrf_batched( n, n, dA_array, ldda, dipiv_array, dinfo_array, batchCount, queue);
    ...
    info = magma_tally2_zgetrs_batched( Magma_tally2NoTrans, n, nrhs, dA_array, ldda, dipiv_array, dB_array, lddb,  batchCount, queue );
    return info;
}
