    ...
    float *A, int lda )
{
    ...
    bool full = (iby + BLK_Y <= n && (ind >= iby + BLK_Y || ind + BLK_X <= iby || MAGMA_tally2_S_EQUAL( offdiag, diag )));
...
/**
    ...
    ********************************************************************/
extern "C"
void magma_tally2blas_slaset_q(
    ...
    magma_tally2_queue_t queue)
{
    ...
    if (uplo == Magma_tally2Lower) {
        ...
        if ( m == ldda &&
             MAGMA_tally2_S_EQUAL( offdiag, MAGMA_tally2_S_ZERO ) &&
             MAGMA_tally2_S_EQUAL( diag,    MAGMA_tally2_S_ZERO ) )
        {
            size_t size = m*n;
...
/**
    @see magma_tally2blas_slaset_q
    @ingroup magma_tally2_saux2
    ********************************************************************/
extern "C"
void magma_tally2blas_slaset(
    magma_tally2_uplo_t uplo, magma_tally2_int_t m, magma_tally2_int_t n,
    float offdiag, float diag,
    magma_tally2Float_ptr dA, magma_tally2_int_t ldda )
{
    magma_tally2blas_slaset_q( uplo, m, n, offdiag, diag, dA, ldda, magma_tally2_stream );
}


////////////////////////////////////////////////////////////////////////////////////////
extern "C"
void magma_tally2blas_slaset_batched(
    magma_tally2_uplo_t uplo, magma_tally2_int_t m, magma_tally2_int_t n,
    float offdiag, float diag,
