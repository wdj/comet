...
///////////////////////////////////////////////////////////////////////////////////////
__global__ void kernel_set_pointer(magma_tally3FloatComplex **output_array,
...
extern "C"
void cset_pointer(magma_tally3FloatComplex **output_array,
                 magma_tally3FloatComplex *input,
                 magma_tally3_int_t lda,
                 magma_tally3_int_t row, magma_tally3_int_t column, 
                 magma_tally3_int_t batchSize,
...
__global__ void zdisplace_pointers_kernel(magma_tally3FloatComplex **output_array,
               magma_tally3FloatComplex **input_array, magma_tally3_int_t lda,
               magma_tally3_int_t row, magma_tally3_int_t column)
{
      magma_tally3FloatComplex *inpt = input_array[blockIdx.x];
      output_array[blockIdx.x] = &inpt[row + column * lda];
}


extern "C"
void cset_array(magma_tally3FloatComplex **output_array,
               magma_tally3FloatComplex **input_array, magma_tally3_int_t lda,
               magma_tally3_int_t row, magma_tally3_int_t column, 
...
extern "C"
void magma_tally3_cdisplace_pointers(magma_tally3FloatComplex **output_array,
               magma_tally3FloatComplex **input_array, magma_tally3_int_t lda,
               magma_tally3_int_t row, magma_tally3_int_t column, 
               magma_tally3_int_t batchCount, magma_tally3_queue_t queue)
