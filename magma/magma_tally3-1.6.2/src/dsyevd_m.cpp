    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally3_dsytrd_mgpu(ngpu, 1, uplo, n, A, lda, w, &work[inde],
    ...
    if (! wantz) {
...
#else
        magma_tally3_dstedx_m(ngpu, Magma_tally3RangeAll, n, 0., 0., 0, 0, w, &work[inde],
                       &work[indwrk], n, &work[indwk2],
        ...
        magma_tally3_dormtr_m(ngpu, Magma_tally3Left, uplo, Magma_tally3NoTrans, n, n, A, lda, &work[indtau],
