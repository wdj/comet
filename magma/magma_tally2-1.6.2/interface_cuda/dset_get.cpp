...
magma_tally2_dsetmatrix_internal(
    ...
    double const* hA_src, magma_tally2_int_t lda,
    magma_tally2Double_ptr    dB_dst, magma_tally2_int_t ldb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
...
magma_tally2_dgetmatrix_internal(
    magma_tally2_int_t m, magma_tally2_int_t n,
    magma_tally2Double_const_ptr dA_src, magma_tally2_int_t lda,
    double*          hB_dst, magma_tally2_int_t ldb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
