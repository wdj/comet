...
magma_tally3_chegvx(
    ...
    magma_tally3FloatComplex *A, magma_tally3_int_t lda, magma_tally3FloatComplex *B, magma_tally3_int_t ldb,
    float vl, float vu, magma_tally3_int_t il, magma_tally3_int_t iu, float abstol,
    magma_tally3_int_t *m, float *w,  magma_tally3FloatComplex *Z, magma_tally3_int_t ldz,
    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally3_SUCCESS != magma_tally3_cmalloc( &dA, n*ldda ) ||
        ...
        MAGMA_tally3_SUCCESS != magma_tally3_cmalloc( &dZ, n*lddz )) {
    ...
    magma_tally3_csetmatrix_async( n, n,
                            A,  lda,
                            dA, ldda, stream );
    
    magma_tally3_cpotrf_gpu(uplo, n, dB, lddb, info);
    if (*info != 0) {
        *info = n + *info;
        return *info;
    }
    ...
    magma_tally3_cgetmatrix_async( n, n,
                            dB, lddb,
                            B,  ldb, stream );
    
    /* Transform problem to standard eigenvalue problem and solve. */
    magma_tally3_chegst_gpu(itype, uplo, n, dA, ldda, dB, lddb, info);
    magma_tally3_cheevx_gpu(jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, abstol, m, w, dZ, lddz, A, lda, Z, ldz, work, lwork, rwork, iwork, ifail, info);
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally3_ctrsm(Magma_tally3Left, uplo, trans, Magma_tally3NonUnit, n, *m, c_one, dB, lddb, dZ, lddz);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally3_ctrmm(Magma_tally3Left, uplo, trans, Magma_tally3NonUnit, n, *m, c_one, dB, lddb, dZ, lddz);
        }
        
        magma_tally3_cgetmatrix( n, *m, dZ, lddz, Z, ldz );
    }
