...
extern "C" void
magma_minproductblas_sgemvt_tesla(
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_minproductblas_sgemv_tesla(
    ...
    if ( incx == 1 && incy == 1 && beta == 0 ) {
        if ( trans == Magma_minproductNoTrans ) {
            if ( alpha == 1. ) {
                ...
                sgemv_kernel_tesla<<< grid, threads, 0, magma_minproduct_stream >>>
                    (m, n, (n/gemv_bs)*gemv_bs, A, lda, x, y);
            }
            else {
                magma_minproduct_sgemv( trans, m, n, alpha, A, lda, x, incx, beta, y, incy);
            }
        }
        else {
            magma_minproductblas_sgemvt_tesla(m, n, alpha, A, lda, x, y);
        }
    }
    else {
        magma_minproduct_sgemv( trans, m, n, alpha, A, lda, x, incx, beta, y, incy);
...
/**
    ...
    @ingroup magma_minproduct_sblas2_internal
    ********************************************************************/
extern "C" void
magma_minproductblas_sgemv2_tesla(
    ...
    float       *y )
{
    ...
    sgemv_kernel2_tesla<<< grid, threads, 0, magma_minproduct_stream >>>
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_minproductblas_sgemvt1_tesla(
    magma_minproduct_int_t m, magma_minproduct_int_t n, float alpha,
    const float *A, magma_minproduct_int_t lda,
    const float *x,
    float       *y )
{
    ...
    dim3 grid( blocks, 1, 1 );
    dim3 threads( 32, 2, 1 );
    sgemvt_kernel1_tesla<<< grid, threads, 0, magma_minproduct_stream >>>
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_minproductblas_sgemvt2_tesla(
    magma_minproduct_int_t m, magma_minproduct_int_t n, float alpha,
    const float *A, magma_minproduct_int_t lda,
    const float *x,
    float       *y )
{
    ...
    dim3 grid( blocks, 1, 1 );
    dim3 threads( 16, 4, 1 );
    sgemvt_kernel2_tesla<<< grid, threads, 0, magma_minproduct_stream >>>
...
{
    if ( n <= 128 )
        magma_minproductblas_sgemvt2_tesla(m, n, alpha, A, lda, x, y);
    else
        magma_minproductblas_sgemvt1_tesla(m, n, alpha, A, lda, x, y);
}
