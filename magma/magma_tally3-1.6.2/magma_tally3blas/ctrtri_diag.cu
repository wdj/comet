    ...
    magma_tally3_queue_t queue)
{
    ...
    cudaMemset( d_dinvA, 0, ((n+NB-1)/NB)*NB*NB * sizeof(magma_tally3FloatComplex) );
...
/**
    @see magma_tally3blas_ctrtri_diag_q
    @ingroup magma_tally3_cblas3
    ********************************************************************/
extern "C" void
magma_tally3blas_ctrtri_diag(
    ...
    magma_tally3FloatComplex_ptr d_dinvA)
{
    magma_tally3blas_ctrtri_diag_q( uplo, diag, n, dA, ldda, d_dinvA, magma_tally3_stream );
}
