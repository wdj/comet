    ...
    magma_tally3_int_t batchCount,  cublasHandle_t myhandle, magma_tally3_queue_t queue)
{
    ...
    if(panel_nb <= min_recpnb){
        ...
        //  panel factorization
        //magma_tally3_ddisplace_pointers(dA_displ, dA_array, ldda, 0, 0, batchCount);
        magma_tally3_dgetf2_batched(m, panel_nb,
                           dA_array, ldda,
        ...
        magma_tally3_ddisplace_pointers(dW5_displ, dA_array, ldda, p1, p2, batchCount, queue); 
        magma_tally3_dlaswp_rowparallel_batched( n2, dW5_displ, ldda,
                           dX_array, n1,
                           0, n1,
        ...
        magma_tally3_ddisplace_pointers(dW1_displ, dA_array, ldda, p2, 0, batchCount, queue); 
        ...
        magma_tally3blas_dgemm_batched( Magma_tally3NoTrans, Magma_tally3NoTrans, m2, n2, n1, 
                              MAGMA_tally3_D_NEG_ONE, dW1_displ, ldda, 
                              dW5_displ, ldda, 
                              MAGMA_tally3_D_ONE,  dA_displ, ldda, 
                              batchCount, queue);
#endif
        ...
        magma_tally3_ddisplace_pointers(dW1_displ, dA_array, ldda, p2, 0, batchCount, queue); // no need since it is above
        magma_tally3_dlaswp_rowparallel_batched( n1, dW1_displ, ldda,
                           dW1_displ, ldda,
                           n1, n,
                           dpivinfo_array, batchCount, queue);
