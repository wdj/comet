...
/**
    ...
    @param[in]
    val         magma_minproductDoubleComplex_ptr
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproduct_z_matrix A_DEV={Magma_minproduct_CSR}, A_CSR={Magma_minproduct_CSR};
    ...
    if ( A.memory_location == Magma_minproduct_DEV && A.storage_type == Magma_minproduct_CSR ) {
        ...
        *row = A.drow;
        ...
        CHECK( magma_minproduct_zmconvert( A, &A_CSR, A.storage_type, Magma_minproduct_CSR, queue ));
        CHECK( magma_minproduct_zmtransfer( A_CSR, &A_DEV, A.memory_location, Magma_minproduct_DEV, queue ));
        magma_minproduct_zcsrget_gpu( A_DEV, m, n, row, col, val, queue );
    }
    
cleanup:
    magma_minproduct_zmfree( &A_CSR, queue );
    magma_minproduct_zmfree( &A_DEV, queue );
    return info;
}
