...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_minproduct_cmake_hpd( N, h_B, lda );
            lapackf77_clacpy( Magma_minproductFullStr, &N, &N, h_A, &lda, h_R, &lda );
            lapackf77_clacpy( Magma_minproductFullStr, &N, &N, h_B, &lda, h_S, &lda );
            ...
            if ( opts.check && opts.jobz != Magma_minproductNoVec ) {
                ...
                */
                ...
                //lapackf77_clacpy( Magma_minproductFullStr, &N, &N, h_B, &lda, h_S, &lda );
                //
                //magma_minproduct_chegvd( opts.itype, Magma_minproductNoVec, opts.uplo,
