    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
      for( int iuplo = 0; iuplo < 3; ++iuplo ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            //printf( "nan %g + %gi\n", MAGMA_minproduct_S_REAL( MAGMA_minproduct_S_NAN ), MAGMA_minproduct_S_REAL( MAGMA_minproduct_S_NAN ) );
            //printf( "inf %g + %gi\n", MAGMA_minproduct_S_REAL( MAGMA_minproduct_S_INF ), MAGMA_minproduct_S_REAL( MAGMA_minproduct_S_INF ) );
            ...
            magma_minproduct_int_t c_cpu = magma_minproduct_snan_inf    ( uplo[iuplo], M, N, hA, lda,  &c_cpu_nan, &c_cpu_inf );
            magma_minproduct_int_t c_gpu = magma_minproduct_snan_inf_gpu( uplo[iuplo], M, N, dA, ldda, &c_gpu_nan, &c_gpu_inf );
            
            magma_minproduct_int_t c_cpu2 = magma_minproduct_snan_inf    ( uplo[iuplo], M, N, hA, lda,  NULL, NULL );
            magma_minproduct_int_t c_gpu2 = magma_minproduct_snan_inf_gpu( uplo[iuplo], M, N, dA, ldda, NULL, NULL );
