    ...
    magma_tally4_queue_t queue )
{
    ...
    if (  A.memory_location == Magma_tally4_CPU &&
        ...
        magma_tally4_z_matrix Ah={Magma_tally4_CSR}, ACSR={Magma_tally4_CSR}, DCSR={Magma_tally4_CSR}, RCSR={Magma_tally4_CSR}, Dh={Magma_tally4_CSR}, Rh={Magma_tally4_CSR};
        CHECK( magma_tally4_zmtransfer( A, &Ah, A.memory_location, Magma_tally4_CPU, queue ));
        CHECK( magma_tally4_zmconvert( Ah, &ACSR, A.storage_type, Magma_tally4_CSR, queue ));

        CHECK( magma_tally4_zcsrsplit( bsize, ACSR, &DCSR, &RCSR, queue ));

        CHECK( magma_tally4_zmconvert( DCSR, &Dh, Magma_tally4_CSR, A.storage_type, queue ));
        CHECK( magma_tally4_zmconvert( RCSR, &Rh, Magma_tally4_CSR, A.storage_type, queue ));

        CHECK( magma_tally4_zmtransfer( Dh, D, Magma_tally4_CPU, A.memory_location, queue ));
        CHECK( magma_tally4_zmtransfer( Rh, R, Magma_tally4_CPU, A.memory_location, queue ));

        magma_tally4_zmfree( &Ah, queue );
        magma_tally4_zmfree( &ACSR, queue );
        magma_tally4_zmfree( &Dh, queue );
        magma_tally4_zmfree( &DCSR, queue );
        magma_tally4_zmfree( &Rh, queue );
        magma_tally4_zmfree( &RCSR, queue );
    }
cleanup:
    if( info != 0 ){
