...
caxpy16(
    ...
    const magma_minproductFloatComplex * __restrict__ b,
    magma_minproductFloatComplex       * __restrict__ c )
{
    c[0]  += alpha * b[0];
    c[1]  += alpha * b[1];
    c[2]  += alpha * b[2];
...
cgemm_kernel_16(
    ...
    magma_minproductFloatComplex *B, int ldb,
    magma_minproductFloatComplex *C, int ldc,
    magma_minproductFloatComplex alpha, int jb, int tx, int ty)
{
...
ctrtri_diag_lower_kernel(
    magma_minproduct_diag_t diag, int n, const magma_minproductFloatComplex *A, int lda, magma_minproductFloatComplex *d_invA);

__global__ void
triple_cgemm16_part1_lower_kernel(
    int n, const magma_minproductFloatComplex *Ain, int lda, magma_minproductFloatComplex *d_invA, int jb, int npages);
