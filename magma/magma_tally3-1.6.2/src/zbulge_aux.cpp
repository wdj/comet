...
//////////////////////////////////////////////////////////////
extern "C" void  magma_tally3_zstedc_withZ(magma_tally3_vec_t JOBZ, magma_tally3_int_t N, double *D, double * E, magma_tally3DoubleComplex *Z, magma_tally3_int_t LDZ)
{
    ...
    if (JOBZ == Magma_tally3Vec) {
        LWORK  = N*N;
        LRWORK = 1 + 3*N + 3*N*((magma_tally3_int_t)(log( (double)N )/log_2) + 1) + 4*N*N + 256*N;
    ...
    magma_tally3_dmalloc_cpu( &RWORK, LRWORK );
    magma_tally3_zmalloc_cpu( &WORK,  LWORK  );
    magma_tally3_imalloc_cpu( &IWORK, LIWORK );
    
    lapackf77_zstedc( lapack_vec_const_tally3(JOBZ), &N, D, E, Z, &LDZ, WORK, &LWORK, RWORK, &LRWORK, IWORK, &LIWORK, &INFO);
...
//          ZSTEDC          Divide and Conquer for tridiag
//////////////////////////////////////////////////////////////
extern "C" void  magma_tally3_zstedx_withZ(magma_tally3_int_t N, magma_tally3_int_t NE, double *D, double * E, magma_tally3DoubleComplex *Z, magma_tally3_int_t LDZ)
{
    double *RWORK;
    double *dwork;
    magma_tally3_int_t *IWORK;
    ...
    printf("using magma_tally3_zstedx\n");
    ...
    magma_tally3_zstedx(job, N, 0., 0., 1, NE, D, E, Z, LDZ, RWORK, LRWORK, IWORK, LIWORK, dwork, &INFO);
