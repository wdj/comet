    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally3_chetrd_mgpu(ngpu, 1, uplo, n, A, lda, w, &rwork[inde],
    ...
    if (! wantz) {
...
#else
        magma_tally3_cstedx_m(ngpu, Magma_tally3RangeAll, n, 0, 0, 0, 0, w, &rwork[inde],
                       &work[indwrk], n, &rwork[indrwk],
        ...
        magma_tally3_cunmtr_m(ngpu, Magma_tally3Left, uplo, Magma_tally3NoTrans, n, n, A, lda, &work[indtau],
