...
static magma_minproduct_int_t check_orthogonality(magma_minproduct_int_t M, magma_minproduct_int_t N, float *Q, magma_minproduct_int_t LDQ, float eps);
static magma_minproduct_int_t check_reduction(magma_minproduct_uplo_t uplo, magma_minproduct_int_t N, magma_minproduct_int_t bw, float *A, float *D, magma_minproduct_int_t LDA, float *Q, float eps );
static magma_minproduct_int_t check_solution(magma_minproduct_int_t N, float *E1, float *E2, float eps);
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_minproduct_smake_symmetric( N, h_A, N );
            ...
            if (opts.warmup) {
                ...
                // ==================================================================
                lapackf77_slacpy( Magma_minproductUpperLowerStr, &N, &N, h_A, &N, h_R, &N );
                if (opts.ngpu == 1) {
                    ...
                    magma_minproduct_ssyevdx_2stage_m(opts.ngpu, opts.jobz, range, opts.uplo, N, 
                                    h_R, N, 
                                    vl, vu, il, iu, 
                                    &m1, w1, 
                                    h_work, lwork, 
            ...
            if ( opts.check && opts.jobz != Magma_minproductNoVec ) {
                ...
                //printf("\n");
                //printf("------ TESTS FOR MAGMA_minproduct SSYEVD ROUTINE -------  \n");
...
static magma_minproduct_int_t check_orthogonality(magma_minproduct_int_t M, magma_minproduct_int_t N, float *Q, magma_minproduct_int_t LDQ, float eps)
{
    ...
    float *work;
    magma_minproduct_smalloc_cpu( &work, minMN );

    /* Build the idendity matrix */
    float *Id;
    magma_minproduct_smalloc_cpu( &Id, minMN*minMN );
...
static magma_minproduct_int_t check_reduction(magma_minproduct_uplo_t uplo, magma_minproduct_int_t N, magma_minproduct_int_t bw, float *A, float *D, magma_minproduct_int_t LDA, float *Q, float eps )
{
    ...
    magma_minproduct_smalloc_cpu( &TEMP, N*N );
    magma_minproduct_smalloc_cpu( &Residual, N*N );
    ...
    Rnorm = lapackf77_slansy("1", lapack_uplo_const(uplo), &N, Residual, &N, work);
    Anorm = lapackf77_slansy("1", lapack_uplo_const(uplo), &N, A,        &LDA, work);
