...
/**
    @see magma_tally4blas_stranspose_q
    @ingroup magma_tally4_saux2
    ********************************************************************/
extern "C" void
magma_tally4blas_stranspose(
    ...
    magma_tally4Float_ptr       dAT, magma_tally4_int_t lddat )
{
    magma_tally4blas_stranspose_q( m, n, dA, ldda, dAT, lddat, magma_tally4_stream );
}
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_tally4blas_stranspose_batched_q(
    magma_tally4_int_t m, magma_tally4_int_t n,
    float **dA_array,  magma_tally4_int_t ldda,
    float **dAT_array, magma_tally4_int_t lddat, magma_tally4_int_t batchCount, magma_tally4_queue_t queue )
{
    magma_tally4_int_t info = 0;
    if ( m < 0 )
        info = -1;
...
/**
    @see magma_tally4blas_stranspose_batched_q
    @ingroup magma_tally4_saux2
    ********************************************************************/
extern "C" void
...
{
    magma_tally4blas_stranspose_batched_q( m, n, dA_array, ldda, dAT_array, lddat, batchCount, magma_tally4_stream );
}
