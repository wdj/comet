...
static magma_tally2_int_t check_orthogonality(magma_tally2_int_t M, magma_tally2_int_t N, magma_tally2DoubleComplex *Q, magma_tally2_int_t LDQ, double eps);
static magma_tally2_int_t check_reduction(magma_tally2_uplo_t uplo, magma_tally2_int_t N, magma_tally2_int_t bw, magma_tally2DoubleComplex *A, double *D, magma_tally2_int_t LDA, magma_tally2DoubleComplex *Q, double eps );
static magma_tally2_int_t check_solution(magma_tally2_int_t N, double *E1, double *E2, double eps);
...
int main( int argc, char** argv)
{
    ...
    magma_tally2DoubleComplex *h_A, *h_R, *h_work;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (opts.warmup) {
                ...
                // ==================================================================
                lapackf77_zlacpy( Magma_tally2UpperLowerStr, &N, &N, h_A, &N, h_R, &N );
                if (opts.ngpu == 1) {
                    ...
                    magma_tally2_zheevdx_2stage_m(opts.ngpu, opts.jobz, range, opts.uplo, N, 
                                    h_R, N, 
                                    vl, vu, il, iu, 
                                    &m1, w1, 
                                    h_work, lwork, 
            ...
            if ( opts.check && opts.jobz != Magma_tally2NoVec ) {
                ...
                //printf("\n");
                //printf("------ TESTS FOR MAGMA_tally2 ZHEEVD ROUTINE -------  \n");
...
static magma_tally2_int_t check_orthogonality(magma_tally2_int_t M, magma_tally2_int_t N, magma_tally2DoubleComplex *Q, magma_tally2_int_t LDQ, double eps)
{
    ...
    double *work;
    magma_tally2_dmalloc_cpu( &work, minMN );

    /* Build the idendity matrix */
    magma_tally2DoubleComplex *Id;
    magma_tally2_zmalloc_cpu( &Id, minMN*minMN );
...
static magma_tally2_int_t check_reduction(magma_tally2_uplo_t uplo, magma_tally2_int_t N, magma_tally2_int_t bw, magma_tally2DoubleComplex *A, double *D, magma_tally2_int_t LDA, magma_tally2DoubleComplex *Q, double eps )
{
    ...
    magma_tally2DoubleComplex *TEMP, *Residual;
    double *work;
    ...
    magma_tally2_zmalloc_cpu( &TEMP, N*N );
    magma_tally2_zmalloc_cpu( &Residual, N*N );
    ...
    Rnorm = lapackf77_zlanhe("1", lapack_uplo_const_tally2(uplo), &N, Residual, &N, work);
    Anorm = lapackf77_zlanhe("1", lapack_uplo_const_tally2(uplo), &N, A,        &LDA, work);
