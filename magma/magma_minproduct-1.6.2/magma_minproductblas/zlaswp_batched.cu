...
void zlaswp_rowparallel_devfunc(  
                              ...
                              magma_minproductDoubleComplex *dout, int ldo,
                              magma_minproduct_int_t* pivinfo)
{
    ...
    magma_minproductDoubleComplex *sdata = shared_data;
...
void zlaswp_rowparallel_kernel( 
                                int n, int width, int height,
                                magma_minproductDoubleComplex *dinput, int ldi, 
                                magma_minproductDoubleComplex *doutput, int ldo,
                                magma_minproduct_int_t*  pivinfo)
{
...
void zlaswp_rowparallel_kernel_batched(
                                int n, int width, int height,
                                magma_minproductDoubleComplex **input_array, int ldi, 
                                magma_minproductDoubleComplex **output_array, int ldo,
...
//=================================================================================================
extern "C" void
magma_minproduct_zlaswp_rowparallel_batched( magma_minproduct_int_t n, 
                       magma_minproductDoubleComplex** input_array, magma_minproduct_int_t ldi,
                       ...
                       magma_minproduct_int_t batchCount, magma_minproduct_queue_t queue)
{
    ...
    if( n < SWP_WIDTH)
    {
        zlaswp_rowparallel_kernel_batched<<<grid, height, sizeof(magma_minproductDoubleComplex) * height * n, queue >>>
                                           ( n, n, height, input_array, ldi, output_array, ldo, pivinfo_array ); 
    }
    else
    {
        zlaswp_rowparallel_kernel_batched<<< grid, height, sizeof(magma_minproductDoubleComplex) * height * SWP_WIDTH , queue >>>
...
//=================================================================================================
extern "C" void
magma_minproduct_zlaswp_rowparallel_q( magma_minproduct_int_t n, 
                       magma_minproductDoubleComplex* input, magma_minproduct_int_t ldi,
                       magma_minproductDoubleComplex* output, magma_minproduct_int_t ldo,
                       magma_minproduct_int_t k1, magma_minproduct_int_t k2,
                       magma_minproduct_int_t *pivinfo, 
                       magma_minproduct_queue_t queue)
{
    ...
    {
       printf(" height=%d > %d, magma_minproduct_zlaswp_rowparallel_q not supported \n", n,MAX_NTHREADS);
    ...
    if( n < SWP_WIDTH)
    {
        zlaswp_rowparallel_kernel<<<grid, height, sizeof(magma_minproductDoubleComplex) * height * n, queue >>>
                                   ( n, n, height, input, ldi, output, ldo, pivinfo ); 
    }
    else
    {
        zlaswp_rowparallel_kernel<<< grid, height, sizeof(magma_minproductDoubleComplex) * height * SWP_WIDTH , queue >>>
...
extern "C" void
magma_minproduct_zlaswp_rowparallel( magma_minproduct_int_t n, magma_minproductDoubleComplex* input, magma_minproduct_int_t ldi,
                   magma_minproductDoubleComplex* output, magma_minproduct_int_t ldo,
                   magma_minproduct_int_t k1, magma_minproduct_int_t k2,
                   magma_minproduct_int_t *pivinfo)
{
    magma_minproduct_zlaswp_rowparallel_q(n, input, ldi, output, ldo, k1, k2, pivinfo, magma_minproduct_stream);
}
...
//=================================================================================================
__global__ void zlaswp_rowserial_kernel_batched( int n, magma_minproductDoubleComplex **dA_array, int lda, int k1, int k2, magma_minproduct_int_t** ipiv_array )
{
    magma_minproductDoubleComplex* dA = dA_array[blockIdx.z];
    magma_minproduct_int_t *d_ipiv = ipiv_array[blockIdx.z];
...
//=================================================================================================
__global__ void zlaswp_columnserial_kernel_batched( int n, magma_minproductDoubleComplex **dA_array, int lda, int k1, int k2, magma_minproduct_int_t** ipiv_array )
{
    magma_minproductDoubleComplex* dA = dA_array[blockIdx.z];
    magma_minproduct_int_t *d_ipiv = ipiv_array[blockIdx.z];
