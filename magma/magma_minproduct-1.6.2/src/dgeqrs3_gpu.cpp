    ...
    magma_minproduct_int_t *info)
{
    ...
    */
    magma_minproductblas_dswapdblk(k-1, nb, dA(0,0), ldda, 1, dT(0), nb, 0);
    if ( nrhs == 1 ) {
        magma_minproduct_dtrsv(Magma_minproductUpper, Magma_minproductNoTrans, Magma_minproductNonUnit,
                    n, dA(0,0), ldda, dB, 1);
    } else {
        magma_minproduct_dtrsm(Magma_minproductLeft, Magma_minproductUpper, Magma_minproductNoTrans, Magma_minproductNonUnit,
                    n, nrhs, c_one, dA(0,0), ldda, dB, lddb);
    }
    magma_minproductblas_dswapdblk(k-1, nb, dT(0), nb, 0, dA(0,0), ldda, 1);
