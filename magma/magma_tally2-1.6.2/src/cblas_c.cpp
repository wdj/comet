/*
    ...
    magma_tally2_cblas_scasum / dasum
    magma_tally2_cblas_scnrm2 / dnrm2
    magma_tally2_cblas_cdotc  / ddot
    magma_tally2_cblas_cdotu  / ddot
    ...
    const magma_tally2FloatComplex *y, magma_tally2_int_t incy )
{
    ...
    magma_tally2FloatComplex value = MAGMA_tally2_C_ZERO;
    ...
    return value;
    //#ifdef COMPLEX
    //magma_tally2FloatComplex value;
