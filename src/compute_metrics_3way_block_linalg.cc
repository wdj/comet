...
//        const int is_I1_in_range = I1 >= I_min && I1 < I_max;
        ...
        if (is_I_in_range) {
          ...
          const Tally2x2<MF> matB_permuted =
            matB_buf->elt_const<Tally2x2<MF>>(I0, K);
          MFTTypeIn matB00_permuted, matB01_permuted;
          MFTTypeIn matB10_permuted, matB11_permuted;
          MFT::decode(matB00_permuted, matB01_permuted,
                              matB_permuted.data[0]);
          MFT::decode(matB10_permuted, matB11_permuted,
                              matB_permuted.data[1]);

          MFTTypeIn r000_permuted = r000;
          MFTTypeIn r100_permuted = si->perm0(r100, r010, r001);
          MFTTypeIn r010_permuted = si->perm1(r100, r010, r001);
          MFTTypeIn r001_permuted = si->perm2(r100, r010, r001);
          MFTTypeIn r011_permuted = si->perm0(r011, r101, r110);
          MFTTypeIn r101_permuted = si->perm1(r011, r101, r110);
          MFTTypeIn r110_permuted = si->perm2(r011, r101, r110);
          MFTTypeIn r111_permuted = r111;
...
//printf("Hey1 %i %i %i   %i   %i   %i %i   %i \n", I, J, K, nvl, init_numer, I_min, I_max, step_2way);
              const Tally2x2<MF> matB_permuted =
                matB_buf->elt_const<Tally2x2<MF>>(I1, K);
//printf("Hey2\n");
