    ...
    magma_minproduct_queue_t queue )
{
    ...
    // GPU workspace
    magma_minproduct_z_matrix r={Magma_minproduct_CSR}, p={Magma_minproduct_CSR}, q={Magma_minproduct_CSR};
    ...
    magma_minproduct_zcopy( dofs, r.dval, 1, p.dval, 1 );                    // p = r
    betanom = nom0;
    ...
    {
        solver_par->numiter++;
        alpha = MAGMA_minproduct_Z_MAKE(nom/den, 0.);
        ...
        betanom = magma_minproduct_dznrm2(dofs, r.dval, 1);             // betanom = || r ||
        ...
        beta = MAGMA_minproduct_Z_MAKE(betanomsq/nom, 0.);           // beta = betanoms/nom
