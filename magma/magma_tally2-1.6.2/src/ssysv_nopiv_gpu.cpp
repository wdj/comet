...
/**
    ...
    @ingroup magma_tally2_ssysv_driver
    ********************************************************************/
...
magma_tally2_ssysv_nopiv_gpu(magma_tally2_uplo_t uplo,  magma_tally2_int_t n, magma_tally2_int_t nrhs, 
                 magma_tally2Float_ptr dA, magma_tally2_int_t ldda,
                 magma_tally2Float_ptr dB, magma_tally2_int_t lddb, 
                 magma_tally2_int_t *info)
{
    magma_tally2_int_t ret;
    ...
    *info = 0;
    ...
    ret = magma_tally2_ssytrf_nopiv_tally2_gpu(uplo, n, dA, ldda, info);
    if ( (ret != MAGMA_tally2_SUCCESS) || (*info != 0) ) {
        return ret;
    }
        
    ret = magma_tally2_ssytrs_nopiv_gpu( uplo, n, nrhs, dA, ldda, dB, lddb, info );
    if ( (ret != MAGMA_tally2_SUCCESS) || (*info != 0) ) {
        return ret;
    }
