    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    // TODO: this assumes that, on exit from magma_tally2_cunmqr_gpu, hwork contains
    ...
    // magma_tally2_ctrsm and drop the csetmatrix.
    if ( nrhs == 1 ) {
        blasf77_ctrsv( Magma_tally2UpperStr, Magma_tally2NoTransStr, Magma_tally2NonUnitStr,
                       &ib, hwork,         &rows,
                            hwork+rows*ib, &ione);
    } else {
        blasf77_ctrsm( Magma_tally2LeftStr, Magma_tally2UpperStr, Magma_tally2NoTransStr, Magma_tally2NonUnitStr,
                       &ib, &nrhs,
                       &c_one, hwork,         &rows,
                               hwork+rows*ib, &rows);
    }
    ...
    magma_tally2_csetmatrix( ib, nrhs, hwork+rows*ib, rows, dwork+i, lddwork );

    // update c
    if (nrhs == 1)
        magma_tally2_cgemv( Magma_tally2NoTrans, i, ib,
    ...
    if (nb < k) {
        for (i = start; i >= 0; i -= nb) {
            ...
            if (i + ib < n) {
                if (nrhs == 1) {
                    magma_tally2_cgemv( Magma_tally2NoTrans, ib, ib,
                                 c_one,  dT(i), ib,
                                         dB+i,      1,
                                 c_zero, dwork+i,  1);
                    magma_tally2_cgemv( Magma_tally2NoTrans, i, ib,
    ...
    magma_tally2_ccopymatrix( (n), nrhs,
                       dwork, lddwork,
                       dB,    lddb );
