/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zhesv_nopiv_gpu.cpp normal z -> s, Fri Jan 30 19:00:16 2015
...
/**
    ...
    @ingroup magma_minproduct_ssysv_driver
    ********************************************************************/
...
magma_minproduct_ssysv_nopiv_gpu(magma_minproduct_uplo_t uplo,  magma_minproduct_int_t n, magma_minproduct_int_t nrhs, 
                 magma_minproductFloat_ptr dA, magma_minproduct_int_t ldda,
                 magma_minproductFloat_ptr dB, magma_minproduct_int_t lddb, 
                 magma_minproduct_int_t *info)
{
    magma_minproduct_int_t ret;
    ...
    *info = 0;
    ...
    ret = magma_minproduct_ssytrf_nopiv_gpu(uplo, n, dA, ldda, info);
    if ( (ret != MAGMA_minproduct_SUCCESS) || (*info != 0) ) {
        return ret;
    }
        
    ret = magma_minproduct_ssytrs_nopiv_gpu( uplo, n, nrhs, dA, ldda, dB, lddb, info );
    if ( (ret != MAGMA_minproduct_SUCCESS) || (*info != 0) ) {
        return ret;
    }
