...
/**
    ...
    as returned by ZGEQLF. Q is of order M if SIDE = Magma_tally2Left and of order N
    ...
    magma_tally2_int_t *info)
{
    ...
    *info  = 0;
    ...
    if ( nb >= k ) {
        /* Use CPU code */
        lapackf77_zunmql( lapack_side_const_tally2(side), lapack_trans_const_tally2(trans),
        ...
        magma_tally2DoubleComplex *dwork, *dV, *dT, *dC;
        ...
        magma_tally2_zmalloc_pinned( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_tally2_zsetmatrix( m, n, C, ldc, dC, lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set lower triangle of panel in A to identity,
               ...
               3) restore A                                      */
            zpanel_to_q_tally2( Magma_tally2Lower, ib, A(nq_i-ib,i), lda, T2 );
            magma_tally2_zsetmatrix( nq_i,  ib, A(0,      i), lda, dV, nq_i );
            zq_to_panel_tally2( Magma_tally2Lower, ib, A(nq_i-ib,i), lda, T2 );
            ...
            magma_tally2_zlarfb_gpu( side, trans, Magma_tally2Backward, Magma_tally2Columnwise,
                              mi, ni, ib,
                              dV, nq_i,
                              dT, ib,
                              dC, lddc,
        ...
        magma_tally2_zgetmatrix( m, n, dC, lddc, C, ldc );
