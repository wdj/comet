...
__global__ void
clascl_full(int m, int n, float mul, magma_minproductFloatComplex* A, int lda)
{
...
__global__ void
clascl_lower(int m, int n, float mul, magma_minproductFloatComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
__global__ void
clascl_upper(int m, int n, float mul, magma_minproductFloatComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
/**
    @see magma_minproductblas_clascl_q
    @ingroup magma_minproduct_caux2
    ********************************************************************/
extern "C" void
magma_minproductblas_clascl(
    ...
    magma_minproduct_int_t *info )
{
    magma_minproductblas_clascl_q( type, kl, ku, cfrom, cto, m, n, dA, ldda, magma_minproduct_stream, info );
}
