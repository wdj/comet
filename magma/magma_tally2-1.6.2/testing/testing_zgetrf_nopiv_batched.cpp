...
int main( int argc, char** argv)
{
    ...
    magma_tally2DoubleComplex *dA_magma_tally2;
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
      ...
      for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_DEV(  dA_magma_tally2,  magma_tally2DoubleComplex, ldda*N * batchCount);
            ...
            magma_tally2_zsetmatrix( M, columns, h_R, lda, dA_magma_tally2, ldda );
            ...
            /* ====================================================================
               ...
               =================================================================== */
            zset_pointer(dA_array, dA_magma_tally2, ldda, 0, 0, ldda*N, batchCount, queue);
            magma_tally2_time = magma_tally2_sync_wtime(0);
            info = magma_tally2_zgetrf_nopiv_batched( M, N, dA_array, ldda, dinfo_magma_tally2, batchCount, queue);
            ...
            if ( opts.check ) {
                ...
                magma_tally2_zgetmatrix( M, N*batchCount, dA_magma_tally2, ldda, h_A, lda );
                for(int i=0; i<batchCount; i++)
                {
