...
int main( int argc, char** argv)
{
    ...
    magma_tally4FloatComplex *h_A, *h_Q, *h_PT, *h_work;
    magma_tally4FloatComplex *taup, *tauq;
    float      *diag, *offdiag;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( tauq,    magma_tally4FloatComplex, minmn );
            TESTING_MALLOC_CPU( taup,    magma_tally4FloatComplex, minmn );
            ...
            TESTING_MALLOC_PIN( h_work,  magma_tally4FloatComplex, lhwork );
            
            /* Initialize the matrices */
            lapackf77_clarnv( &ione, ISEED, &n2, h_A );
            lapackf77_clacpy( Magma_tally4UpperLowerStr, &M, &N, h_A, &lda, h_Q, &lda );
            
            /* ====================================================================
               Performs operation using MAGMA_tally4
               =================================================================== */
            gpu_time = magma_tally4_wtime();
            magma_tally4_cgebrd( M, N, h_Q, lda,
            ...
            if ( opts.check ) {
                ...
                TESTING_MALLOC_CPU( h_PT,       magma_tally4FloatComplex, lda*N     );
                ...
                lapackf77_clacpy(Magma_tally4UpperLowerStr, &M, &N, h_Q, &lda, h_PT, &lda);
