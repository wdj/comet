...
__global__ void
slascl_diag_lower(int m, int n, magma_tally3Float_const_ptr D, int ldd, 
                                      magma_tally3Float_ptr A, int lda)
{
...
__global__ void
slascl_diag_upper(int m, int n, magma_tally3Float_const_ptr D, int ldd, 
                                      magma_tally3Float_ptr A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_tally3blas_slascl_diag_q(
...
{
    magma_tally3blas_slascl_diag_q( type, m, n, dD, lddd, dA, ldda, info, magma_tally3_stream );
}
