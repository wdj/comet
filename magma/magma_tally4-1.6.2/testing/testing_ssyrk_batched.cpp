    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally4_ssetmatrix( An, Ak*batchCount, h_A, lda, d_A, ldda );
            magma_tally4_ssetmatrix( N, N*batchCount, h_C, ldc, d_C, lddc );
            ...
            magma_tally4blas_ssyrk_batched(opts.uplo, opts.transA, N, K,
                             alpha, A_array, ldda,
            ...
            magma_tally4_sgetmatrix( N, NN, d_C, lddc, h_Cmagma_tally4, ldc );
            ...
            if ( opts.check ) {
                ...
                for(int i=0; i<batchCount; i++)
                {
                    Cnorm = lapackf77_slansy("fro", lapack_uplo_const_tally4(opts.uplo), &N, h_C+i*ldc*N, &ldc, work);
                    blasf77_saxpy( &sizeC, &c_neg_one, h_C+i*ldc*N, &ione, h_Cmagma_tally4+i*ldc*N, &ione );
                    current_error = lapackf77_slansy( "fro", lapack_uplo_const_tally4(opts.uplo), &N, h_Cmagma_tally4+i*ldc*N, &ldc, work ) / Cnorm;
