...
int main( int argc, char** argv)
{
    ...
    magma_tally3FloatComplex *h_A, *h_R, *d_R, *h_work, aux_work[1];
    #ifdef COMPLEX
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally3_cheevd_gpu( opts.jobz, opts.uplo,
                              N, NULL, ldda, NULL,
                              NULL, lda,
                              aux_work,  -1,
                              #ifdef COMPLEX
                              ...
                              aux_iwork, -1,
                              &info );
            lwork  = (magma_tally3_int_t) MAGMA_tally3_C_REAL( aux_work[0] );
            #ifdef COMPLEX
            ...
            TESTING_MALLOC_CPU( h_A,    magma_tally3FloatComplex, N*lda  );
            ...
            TESTING_MALLOC_PIN( h_R,    magma_tally3FloatComplex, N*lda  );
            TESTING_MALLOC_PIN( h_work, magma_tally3FloatComplex, lwork  );
            
            TESTING_MALLOC_DEV( d_R,    magma_tally3FloatComplex, N*ldda );
            
            /* Initialize the matrix */
            lapackf77_clarnv( &ione, ISEED, &n2, h_A );
            magma_tally3_cmake_hermitian( N, h_A, N );
            
            magma_tally3_csetmatrix( N, N, h_A, lda, d_R, ldda );
            ...
            if ( opts.warmup ) {
                magma_tally3_cheevd_gpu( opts.jobz, opts.uplo,
                                  ...
                                  &info );
                if (info != 0)
                    printf("magma_tally3_cheevd_gpu returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_tally3NoVec ) {
                /* =====================================================================
                   ...
                   =================================================================== */
                magma_tally3_cgetmatrix( N, N, d_R, ldda, h_R, lda );
                ...
                //
                //magma_tally3_csetmatrix( N, N, h_A, lda, d_R, ldda );
                //magma_tally3_cheevd_gpu( Magma_tally3NoVec, opts.uplo,
                //                  N, d_R, ldda, w2,
                //                  h_R, lda,
                //                  h_work, lwork,
                //                  #ifdef COMPLEX
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_cheevd( lapack_vec_const_tally3(opts.jobz), lapack_uplo_const_tally3(opts.uplo),
                                  &N, h_A, &lda, w2,
                                  h_work, &lwork,
                                  #ifdef COMPLEX
                                  rwork, &lrwork,
