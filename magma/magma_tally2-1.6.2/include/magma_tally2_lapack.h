...
magma_tally2_int_t lapackf77_ieeeck( magma_tally2_int_t *ispec, float *zero, float *one );
...
void   lapackf77_zcgesv( const magma_tally2_int_t *n, const magma_tally2_int_t *nrhs,
                         ...
                         magma_tally2DoubleComplex *work, magma_tally2FloatComplex *swork, double *rwork,
                         magma_tally2_int_t *iter,
                         magma_tally2_int_t *info );

void   lapackf77_dsgesv( const magma_tally2_int_t *n, const magma_tally2_int_t *nrhs,
...
void   lapackf77_dsterf( const magma_tally2_int_t *n,
                         double *d, double *e,
                         magma_tally2_int_t *info );

void   lapackf77_ssterf( const magma_tally2_int_t *n,
                         float *d, float *e,
                         magma_tally2_int_t *info );

// precision conversion, general matrix
void   lapackf77_zlag2c( magma_tally2_int_t *m, const magma_tally2_int_t *n,
                         const magma_tally2DoubleComplex *A,  const magma_tally2_int_t *lda,
                               magma_tally2FloatComplex  *SA, const magma_tally2_int_t *ldsa,
                         magma_tally2_int_t *info );

void   lapackf77_clag2z( magma_tally2_int_t *m, const magma_tally2_int_t *n,
                         const magma_tally2FloatComplex  *SA, const magma_tally2_int_t *ldsa,
                               magma_tally2DoubleComplex *A,  const magma_tally2_int_t *lda,
                         magma_tally2_int_t *info );

void   lapackf77_dlag2s( magma_tally2_int_t *m, const magma_tally2_int_t *n,
                         const double *A,  const magma_tally2_int_t *lda,
                               float  *SA, const magma_tally2_int_t *ldsa,
                         magma_tally2_int_t *info );

void   lapackf77_slag2d( magma_tally2_int_t *m, const magma_tally2_int_t *n,
                         const float  *SA, const magma_tally2_int_t *ldsa,
                               double *A,  const magma_tally2_int_t *lda,
                         magma_tally2_int_t *info );

// precision conversion, triangular (or symmetric) matrix
void   lapackf77_zlat2c( const char *uplo, const magma_tally2_int_t *n,
                         const magma_tally2DoubleComplex *A,  const magma_tally2_int_t *lda,
                               magma_tally2FloatComplex  *SA, const magma_tally2_int_t *ldsa,
                         magma_tally2_int_t *info );

void   lapackf77_dlat2s( const char *uplo, const magma_tally2_int_t *n,
                         const double *A,  const magma_tally2_int_t *lda,
                               float  *SA, const magma_tally2_int_t *ldsa,
                         magma_tally2_int_t *info );

// not implemented in LAPACK
//void lapackf77_clat2z(const char *uplo, const magma_tally2_int_t *n,
//                       const magma_tally2FloatComplex  *SA, const magma_tally2_int_t *ldsa,
//                             magma_tally2DoubleComplex *A,  const magma_tally2_int_t *lda,
//                       magma_tally2_int_t *info );
//
//void lapackf77_slat2d( const char *uplo, const magma_tally2_int_t *n,
//                       const float  *SA, const magma_tally2_int_t *ldsa,
//                             double *A,  const magma_tally2_int_t *lda,
//                       magma_tally2_int_t *info );
