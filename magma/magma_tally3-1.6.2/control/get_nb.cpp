...
magma_tally3_int_t magma_tally3_get_zpotrf_right_nb( magma_tally3_int_t m )
{
    return 128;
}

magma_tally3_int_t magma_tally3_get_cpotrf_right_nb( magma_tally3_int_t m )
{
    return 128;
}

magma_tally3_int_t magma_tally3_get_dpotrf_right_nb( magma_tally3_int_t m )
{
    return 320;
}

magma_tally3_int_t magma_tally3_get_spotrf_right_nb( magma_tally3_int_t m )
{
    return 128;
}
