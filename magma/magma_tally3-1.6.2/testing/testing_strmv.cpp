...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally3_ssetvector( N, h_x, 1, d_x, 1 );
            
            cublas_time = magma_tally3_sync_wtime( NULL );
            cublasStrmv( opts.handle, cublas_uplo_const_tally3(opts.uplo), cublas_trans_const_tally3(opts.transA),
            ...
            magma_tally3_sgetvector( N, d_x, 1, h_xcublas, 1 );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_strmv( lapack_uplo_const_tally3(opts.uplo), lapack_trans_const_tally3(opts.transA), lapack_diag_const_tally3(opts.diag), 
                               &N,
                               h_A, &lda,
                               h_x, &ione );
