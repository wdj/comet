subs = {
  ...
  'mixed' : [
    ...
    ('pzgelqf','pdgelqf'),
    ('pzunmlq','pdormlq'),
    ('MAGMA_minproduct_ZC','MAGMA_minproduct_DS'),
    ('MAGMA_minproductBLAS_ZC','MAGMA_minproductBLAS_DS'),
    ('magma_minproduct_z','magma_minproduct_d'),
    ('magma_minproduct_czgetrs','magma_minproduct_sdgetrs'),
    ('magma_minproduct_c','magma_minproduct_s'),
    ('magma_minproductblas_z','magma_minproductblas_d'),
    ('magma_minproductblas_c','magma_minproductblas_s'),
    ('cublasZ','cublasD'),
    ('cublasC','cublasS'),
    ('MAGMA_minproduct_Z','MAGMA_minproduct_D'),
    ('MAGMA_minproduct_C','MAGMA_minproduct_S'),
    ...
    ('cuCabsf','absf'),
    ('zcaxpy','dsaxpy'),
    ('magma_minproduct_get_c','magma_minproduct_get_s'),
    ('magma_minproduct_get_z','magma_minproduct_get_d'),
  ...
  'normal' : [ ## Dictionary is keyed on substitution type
    ...
    ('magma_minproduct_ssqrt','magma_minproduct_dsqrt', 'magma_minproduct_ssqrt','magma_minproduct_dsqrt'),
    ...
    ('Magma_minproductTrans','Magma_minproductTrans','Magma_minproductConjTrans','Magma_minproductConjTrans'),
    ...
    ('MAGMA_minproduct_S','MAGMA_minproduct_D','MAGMA_minproduct_C','MAGMA_minproduct_Z'),
    ('MAGMA_minproductBLAS_S','MAGMA_minproductBLAS_D','MAGMA_minproductBLAS_C','MAGMA_minproductBLAS_Z'),
    ('magma_minproduct_s','magma_minproduct_d','magma_minproduct_c','magma_minproduct_z'),
    ('magma_minproductblas_s','magma_minproductblas_d','magma_minproductblas_c','magma_minproductblas_z'),
    ('magma_minproduct_get_s','magma_minproduct_get_d','magma_minproduct_get_c','magma_minproduct_get_z'),
    ('magma_minproductf_s','magma_minproductf_d','magma_minproductf_c','magma_minproductf_z'),
    ('ger','ger','gerc','gerc'),
    ('ger','ger','geru','geru'),
