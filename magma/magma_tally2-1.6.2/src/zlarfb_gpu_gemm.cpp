    ...
    magma_tally2DoubleComplex_ptr dworkvt,     magma_tally2_int_t ldworkvt)
{
    ...
    if ( side == Magma_tally2Left ) {
        ...
        // W = V^H C
        magma_tally2_zgemm( Magma_tally2_ConjTrans, notransV,
                     k, n, m,
                     c_one,  dV,    lddv,
                             dC,    lddc,
                     c_zero, dwork, ldw);
        ...
        if (m <= n) {
            // W2 = V T
            magma_tally2_zgemm( notransV, trans,
                         m, k, k,
                         c_one,  dV, lddv,
                                 dT, lddt,
            ...
            // W2 = T W  = T  V^H C
            magma_tally2_zgemm( trans, Magma_tally2NoTrans,
                         k, n, k,
                         c_one,  dT, lddt,
                                 dwork, ldw,
                         c_zero, dworkvt, ldwvt);
            // C = C - V W2 = C - V T V^H C = (I - V T V^H) C = H C
            magma_tally2_zgemm( notransV, Magma_tally2NoTrans,
                         m, n, k,
                         c_neg_one, dV,  lddv,
                                    dworkvt,  ldwvt,
                         c_one,     dC,       lddc);
        ...
        // W = C V
        magma_tally2_zgemm( Magma_tally2NoTrans, notransV,
                     m, k, n,
                     c_one,  dC,    lddc,
                             dV,    lddv,
                     c_zero, dwork, ldw);
        if (m <= n) {
            // W2 = W T = C V T
            magma_tally2_zgemm( Magma_tally2NoTrans, trans,
                         m, k, k,
                         c_one,  dwork, ldw,
                                 dT, lddt,
                         c_zero, dworkvt, ldwvt);
            // C = C - W2 V^H = C - C V T V^H = C (I - V T V^H) = C H
            magma_tally2_zgemm( Magma_tally2NoTrans, transV,
                         m, n, k,
                         c_neg_one, dworkvt, ldwvt,
                                    dV,    lddv,
                         c_one,     dC,    lddc);
            ...
            // W2 = T V^H
            magma_tally2_zgemm( trans, transV,
                         k, n, k,
                         c_one,  dT, lddt,
                                 dV, lddv,
                         c_zero, dworkvt, ldwvt);
