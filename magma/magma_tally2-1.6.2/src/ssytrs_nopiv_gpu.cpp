    ...
    magma_tally2_int_t *info)
{
  ...
  if (upper) {
            magma_tally2blas_strsm( Magma_tally2Left, Magma_tally2Upper, 
                           Magma_tally2ConjTrans, Magma_tally2Unit, 
                           n, nrhs, c_one,
                           dA, ldda, dB, lddb );
            magma_tally2blas_slascl_diag(Magma_tally2Upper, 1, n, dA, ldda, dB,1, info);
            magma_tally2blas_strsm( Magma_tally2Left, Magma_tally2Upper, 
            ...
            magma_tally2_strsm( Magma_tally2Left, Magma_tally2Lower, 
                           Magma_tally2NoTrans, Magma_tally2Unit, 
                           n, nrhs, c_one,
                           dA, ldda, dB, lddb );
            magma_tally2blas_slascl_diag(Magma_tally2Lower, 1, n, dA, ldda, dB,1, info);
            magma_tally2blas_strsm( Magma_tally2Left, Magma_tally2Lower, 
                           Magma_tally2ConjTrans, Magma_tally2Unit, 
                           n, nrhs, c_one,
                           dA, ldda, dB, lddb );
        }
