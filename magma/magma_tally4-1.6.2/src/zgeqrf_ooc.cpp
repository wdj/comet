...
/**
    ...
    This is an out-of-core (ooc) version that is similar to magma_tally4_zgeqrf but
    ...
    magma_tally4_int_t *info )
{
    ...
    *info = 0;
    int nb = magma_tally4_get_zgeqrf_nb(min(m, n));
    ...
    if (NB >= n)
        return magma_tally4_zgeqrf(m, n, A, lda, tau, work, lwork, info);
    ...
    if (MAGMA_tally4_SUCCESS != magma_tally4_zmalloc( &dA, (NB + nb)*ldda + nb*lddwork )) {
    ...
    magma_tally4DoubleComplex *ptr = dA + ldda * NB;
    dwork = dA + ldda*(NB + nb);
    ...
    for (int i=0; i < n; i += NB) {
        ...
        magma_tally4_zsetmatrix_async( (m), IB,
                                A(0,i),  lda,
        ...
        if (i < k)
            magma_tally4_zgeqrf2_gpu(m-i, IB, dA(i,0), ldda, tau+i, info);
