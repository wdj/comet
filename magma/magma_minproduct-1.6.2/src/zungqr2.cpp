...
#define dA(i,j) (dA + (i) + (j)*ldda)
    ...
    magma_minproductDoubleComplex *dA, *dV, *dW, *dT, *T;
    ...
    *info = 0;
    ...
    ldda    = ((m + 31) / 32) * 32;
    lddwork = ((n + 31) / 32) * 32;
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_zmalloc( &dA, ldda*n + ldda*nb + lddwork*nb + nb*nb)) {
    ...
    magma_minproductDoubleComplex *V = work + (n+nb)*nb;
    ...
    if (kk < n) {
        ...
        */
        lapackf77_zlacpy( Magma_minproductUpperLowerStr, &m_kk, &k_kk, A(kk,kk), &lda, V, &m_kk);
        lapackf77_zlaset( Magma_minproductUpperLowerStr, &m_kk, &n_kk, &c_zero, &c_one, A(kk, kk), &lda );

        lapackf77_zlarft( Magma_minproductForwardStr, Magma_minproductColumnwiseStr,
                          &m_kk, &k_kk,
                          V, &m_kk, &tau[kk], work, &k_kk);
        lapackf77_zlarfb( Magma_minproductLeftStr, Magma_minproductNoTransStr, Magma_minproductForwardStr, Magma_minproductColumnwiseStr,
                          &m_kk, &n_kk, &k_kk,
                          V, &m_kk, work, &k_kk, A(kk, kk), &lda, work+k_kk*k_kk, &n_kk );
        
        if (kk > 0) {
            magma_minproduct_zsetmatrix( m_kk, n_kk,
                              A(kk, kk),  lda,
                              dA(kk, kk), ldda );
    ...
    if (kk > 0) {
        ...
        for (i = ki; i >= 0; i -= nb) {
            ...
            magma_minproduct_zsetmatrix_async( mi, ib,
                                    A(i, i), lda,
                                    dV,      ldda, stream );
            lapackf77_zlarft( Magma_minproductForwardStr, Magma_minproductColumnwiseStr,
                              &mi, &ib,
            ...
            magma_minproductblas_zlaset( Magma_minproductFull, mi, ib, c_zero, c_one,  dA(i, i), ldda );
        ...
        magma_minproduct_zgetmatrix( m, n,
