/*
    -- MAGMA_tally4 (version 1.6.2) --
       ...
       @generated from magma_tally4_zcsrsplit.cpp normal z -> c, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
    ...
    magma_tally4_queue_t queue )
{
    ...
    if (  A.memory_location == Magma_tally4_CPU &&
        ...
        magma_tally4_c_matrix Ah={Magma_tally4_CSR}, ACSR={Magma_tally4_CSR}, DCSR={Magma_tally4_CSR}, RCSR={Magma_tally4_CSR}, Dh={Magma_tally4_CSR}, Rh={Magma_tally4_CSR};
        CHECK( magma_tally4_cmtransfer( A, &Ah, A.memory_location, Magma_tally4_CPU, queue ));
        CHECK( magma_tally4_cmconvert( Ah, &ACSR, A.storage_type, Magma_tally4_CSR, queue ));

        CHECK( magma_tally4_ccsrsplit( bsize, ACSR, &DCSR, &RCSR, queue ));

        CHECK( magma_tally4_cmconvert( DCSR, &Dh, Magma_tally4_CSR, A.storage_type, queue ));
        CHECK( magma_tally4_cmconvert( RCSR, &Rh, Magma_tally4_CSR, A.storage_type, queue ));

        CHECK( magma_tally4_cmtransfer( Dh, D, Magma_tally4_CPU, A.memory_location, queue ));
        CHECK( magma_tally4_cmtransfer( Rh, R, Magma_tally4_CPU, A.memory_location, queue ));

        magma_tally4_cmfree( &Ah, queue );
        magma_tally4_cmfree( &ACSR, queue );
        magma_tally4_cmfree( &Dh, queue );
        magma_tally4_cmfree( &DCSR, queue );
        magma_tally4_cmfree( &Rh, queue );
        magma_tally4_cmfree( &RCSR, queue );
    }
cleanup:
    if( info != 0 ){
