...
zswapdblk_kernel( int nb,
                  magma_tally2DoubleComplex *dA, int ldda, int inca,
                  magma_tally2DoubleComplex *dB, int lddb, int incb )
{
...
{
    magma_tally2_int_t nblocks = n / nb;
...
/**
    @see magma_tally2blas_zswapdblk_q
    @ingroup magma_tally2_zaux2
    ********************************************************************/
extern "C" void 
magma_tally2blas_zswapdblk(
    ...
    magma_tally2DoubleComplex_ptr dB, magma_tally2_int_t lddb, magma_tally2_int_t incb )
{
    magma_tally2blas_zswapdblk_q( n, nb, dA, ldda, inca, dB, lddb, incb, magma_tally2_stream );
}
