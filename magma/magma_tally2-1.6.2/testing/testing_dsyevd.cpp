/*
    -- MAGMA_tally2 (version 1.6.1) --
       ...
       @generated from testing_zheevd.cpp normal z -> d, Fri Jan 30 19:00:26 2015
...
int main( int argc, char** argv)
{
    ...
    double *h_A, *h_R, *h_work, aux_work[1];
    #ifdef COMPLEX
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally2_dsyevd( opts.jobz, opts.uplo,
                          N, NULL, lda, NULL,
                          aux_work,  -1,
                          #ifdef COMPLEX
                          aux_rwork, -1,
            ...
            if ( opts.warmup ) {
                magma_tally2_dsyevd( opts.jobz, opts.uplo,
                              ...
                              &info );
                if (info != 0)
                    printf("magma_tally2_dsyevd returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_tally2NoVec ) {
                ...
                //
                //lapackf77_dlacpy( Magma_tally2FullStr, &N, &N, h_A, &lda, h_R, &lda );
                //magma_tally2_dsyevd( Magma_tally2NoVec, opts.uplo,
                //              N, h_R, lda, w2,
                //              h_work, lwork,
                //              #ifdef COMPLEX
                //              rwork, lrwork,
