...
#define dB(i, j) (dw + n*ldda + (j)*lddb + (i))
    ...
    *info = 0;
    ...
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_dmalloc( &dw, 2*n*n )) {
        *info = MAGMA_minproduct_ERR_DEVICE_ALLOC;
        return *info;
    }
    
    nb = magma_minproduct_get_dsygst_nb(n);
    
    magma_minproduct_queue_t stream[2];
    magma_minproduct_queue_create( &stream[0] );
    magma_minproduct_queue_create( &stream[1] );
    
    magma_minproduct_dsetmatrix( n, n, A(0, 0), lda, dA(0, 0), ldda );
    magma_minproduct_dsetmatrix( n, n, B(0, 0), ldb, dB(0, 0), lddb );
    ...
    if (itype == 1) {
        if (upper) {
            ...
            for (k = 0; k < n; k += nb) {
                ...
                if (k+kb < n) {
                    ...
                    magma_minproduct_dsymm(Magma_minproductLeft, Magma_minproductUpper,
                                kb, n-k-kb,
                                c_neg_half, dA(k,k), ldda,
                                dB(k,k+kb), lddb,
                                c_one, dA(k, k+kb), ldda);
                    
                    magma_minproduct_dsyr2k(Magma_minproductUpper, Magma_minproductConjTrans,
                                 n-k-kb, kb,
                                 c_neg_one, dA(k,k+kb), ldda,
                                 dB(k,k+kb), lddb,
                                 d_one, dA(k+kb,k+kb), ldda);
                    
                    magma_minproduct_dgetmatrix_async( kb2, kb2,
                                            dA(k+kb, k+kb), ldda,
            ...
            for (k = 0; k < n; k += nb) {
                ...
                if (k+kb < n) {
                    ...
                    magma_minproduct_dsymm(Magma_minproductRight, Magma_minproductLower,
                                n-k-kb, kb,
                                c_neg_half, dA(k,k), ldda,
                                dB(k+kb,k), lddb,
                                c_one, dA(k+kb, k), ldda);
                    
                    magma_minproduct_dsyr2k(Magma_minproductLower, Magma_minproductNoTrans,
                                 n-k-kb, kb,
                    ...
                    magma_minproduct_dtrsm(Magma_minproductLeft, Magma_minproductLower, Magma_minproductNoTrans, Magma_minproductNonUnit,
                                n-k-kb, kb,
                                c_one, dB(k+kb,k+kb), lddb,
                                dA(k+kb,k), ldda);
                }
        ...
        if (upper) {
            ...
            for (k = 0; k < n; k += nb) {
                ...
                if (k > 0) {
                    magma_minproduct_dtrmm(Magma_minproductLeft, Magma_minproductUpper, Magma_minproductNoTrans, Magma_minproductNonUnit,
                                k, kb,
                                c_one, dB(0,0), lddb,
                                dA(0,k), ldda);
                    
                    magma_minproduct_dsymm(Magma_minproductRight, Magma_minproductUpper,
                                k, kb,
                                c_half, dA(k,k), ldda,
                                dB(0,k), lddb,
                                c_one, dA(0, k), ldda);
                    ...
                    magma_minproduct_dsyr2k(Magma_minproductUpper, Magma_minproductNoTrans,
                                 k, kb,
                                 c_one, dA(0,k), ldda,
                                 dB(0,k), lddb,
                                 d_one, dA(0,0), ldda);
                    ...
                    magma_minproduct_dtrmm(Magma_minproductRight, Magma_minproductUpper, Magma_minproductConjTrans, Magma_minproductNonUnit,
                                k, kb,
                                c_one, dB(k,k), lddb,
                                dA(0,k), ldda);
                }
            ...
            for (k = 0; k < n; k += nb) {
                ...
                if (k > 0) {
                    ...
                    magma_minproduct_dtrmm(Magma_minproductRight, Magma_minproductLower, Magma_minproductNoTrans, Magma_minproductNonUnit,
                                kb, k,
                                c_one, dB(0,0), lddb,
                                dA(k,0), ldda);
                    
                    magma_minproduct_dsymm(Magma_minproductLeft, Magma_minproductLower,
                                kb, k,
                                c_half, dA(k,k), ldda,
                                dB(k,0), lddb,
                                c_one, dA(k, 0), ldda);
                    ...
                    magma_minproduct_dsyr2k(Magma_minproductLower, Magma_minproductConjTrans,
                                 k, kb,
                                 c_one, dA(k,0), ldda,
                                 dB(k,0), lddb,
                                 d_one, dA(0,0), ldda);
                    ...
                    magma_minproduct_dtrmm(Magma_minproductLeft, Magma_minproductLower, Magma_minproductConjTrans, Magma_minproductNonUnit,
                                kb, k,
                                c_one, dB(k,k), lddb,
                                dA(k,0), ldda);
                }
    ...
    magma_minproduct_dgetmatrix( n, n, dA(0, 0), ldda, A(0, 0), lda );
