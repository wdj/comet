    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally2_zhetrd_mgpu(ngpu, 1, uplo, n, A, lda, w, &rwork[inde],
    ...
    if (! wantz) {
...
#else
        magma_tally2_zstedx_m(ngpu, Magma_tally2RangeAll, n, 0, 0, 0, 0, w, &rwork[inde],
                       &work[indwrk], n, &rwork[indrwk],
        ...
        magma_tally2_zunmtr_m(ngpu, Magma_tally2Left, uplo, Magma_tally2NoTrans, n, n, A, lda, &work[indtau],
