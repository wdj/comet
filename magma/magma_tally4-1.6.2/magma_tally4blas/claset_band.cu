    ...
    magma_tally4FloatComplex *A, int lda)
{
    ...
    magma_tally4FloatComplex value = offdiag;
    if (threadIdx.x == k-1)
        value = diag;
    ...
    magma_tally4_queue_t queue)
{
    ...
    else if (uplo == Magma_tally4Lower) {
...
/**
    @see magma_tally4blas_claset_band_q
    @ingroup magma_tally4_caux2
    ********************************************************************/
extern "C" void
magma_tally4blas_claset_band(
    ...
    magma_tally4FloatComplex_ptr dA, magma_tally4_int_t ldda)
{
    magma_tally4blas_claset_band_q(uplo, m, n, k, offdiag, diag, dA, ldda, magma_tally4_stream);
}
