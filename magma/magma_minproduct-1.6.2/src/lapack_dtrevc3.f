...
*
      ...
      ELSE IF( LDVR.LT.1 .OR. ( RIGHTV .AND. LDVR.LT.N ) ) THEN
         INFO = -10
      ELSE IF( LWORK.LT.MAX( 1, 3*N ) ) THEN
         INFO = -14
      ELSE
*
...
**       print *, 'dtrevc3 blocked lwork', lwork, 'n', n, 'nb', nb
      ELSE
         VERSION = 1
**       print *, 'dtrevc3 non-blocked lwork', lwork,
**   $            'n', n, 'nbmin', nbmin
      END IF
*
...
*                 back-transform and normalization is done below
               END IF !endif VERSION
            ELSE !else vector is complex
*
*              --------------------------------------------------------
...
*                 back-transform and normalization is done below
               END IF !endif VERSION
            END IF !endif REAL or COMPLEX VECTOR
