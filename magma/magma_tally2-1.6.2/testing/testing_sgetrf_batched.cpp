...
int main( int argc, char** argv)
{
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
      ...
      for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally2_ssetmatrix( M, columns, h_R, lda, dA, ldda );
            ...
            info = magma_tally2_sgetrf_batched( M, N, dA_array, ldda, dipiv_array,  dinfo_magma_tally2, batchCount, queue);
            magma_tally2_time = magma_tally2_sync_wtime(0) - magma_tally2_time;
            magma_tally2_perf = gflops / magma_tally2_time;
            
            magma_tally2_sgetmatrix( M, N*batchCount, dA, ldda, h_Amagma_tally2, lda );
