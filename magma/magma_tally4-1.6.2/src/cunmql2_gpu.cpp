    ...
    magma_tally4_int_t *info)
{
    ...
    magma_tally4_cmalloc( &dwork, 2*(m + 64)*64 );
    ...
    magma_tally4FloatComplex T[2*4160]        /* was [65][64] */;
    ...
    *info  = 0;
    ...
    magma_tally4blas_claset_band( Magma_tally4Lower, k, k, nb, c_zero, c_one, dA, ldda );
    ...
    for (i = i1; (step < 0 ? i >= i2 : i <= i2); i += step) {
        ...
        magma_tally4_csetmatrix( ib, ib, T, ib, dwork+i__4*ib, ib );
