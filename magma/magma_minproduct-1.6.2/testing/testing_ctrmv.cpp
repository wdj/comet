...
int main( int argc, char** argv)
{
    ...
    magma_minproductFloatComplex *h_A, *h_x, *h_xcublas;
    magma_minproductFloatComplex_ptr d_A, d_x;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_x,       magma_minproductFloatComplex, N      );
            TESTING_MALLOC_CPU( h_xcublas, magma_minproductFloatComplex, N      );
            
            TESTING_MALLOC_DEV( d_A, magma_minproductFloatComplex, ldda*Ak );
            TESTING_MALLOC_DEV( d_x, magma_minproductFloatComplex, N       );
            ...
            magma_minproduct_csetvector( N, h_x, 1, d_x, 1 );
            ...
            magma_minproduct_cgetvector( N, d_x, 1, h_xcublas, 1 );
