...
magma_tally4_int_t magma_tally4_get_zpotrf_right_nb( magma_tally4_int_t m )
{
    return 128;
}

magma_tally4_int_t magma_tally4_get_cpotrf_right_nb( magma_tally4_int_t m )
{
    return 128;
}

magma_tally4_int_t magma_tally4_get_dpotrf_right_nb( magma_tally4_int_t m )
{
    return 320;
}

magma_tally4_int_t magma_tally4_get_spotrf_right_nb( magma_tally4_int_t m )
{
    return 128;
}
