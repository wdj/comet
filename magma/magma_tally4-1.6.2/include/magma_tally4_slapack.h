/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from magma_tally4_zlapack.h normal z -> s, Fri Jan 30 19:00:06 2015
*/

#ifndef MAGMA_tally4_SLAPACK_H
#define MAGMA_tally4_SLAPACK_H
 ...
 */
magma_tally4_int_t blasf77_isamax(
                     const magma_tally4_int_t *n,
                     const float *x, const magma_tally4_int_t *incx );

void blasf77_saxpy(  const magma_tally4_int_t *n,
                     const float *alpha,
                     const float *x, const magma_tally4_int_t *incx,
                           float *y, const magma_tally4_int_t *incy );

void blasf77_scopy(  const magma_tally4_int_t *n,
                     const float *x, const magma_tally4_int_t *incx,
                           float *y, const magma_tally4_int_t *incy );
...
void blasf77_sgemm(  const char *transa, const char *transb,
                     ...
                     const float *alpha,
                     const float *A, const magma_tally4_int_t *lda,
                     const float *B, const magma_tally4_int_t *ldb,
                     const float *beta,
                           float *C, const magma_tally4_int_t *ldc );
...
void blasf77_sger(  const magma_tally4_int_t *m, const magma_tally4_int_t *n,
                     const float *alpha,
                     const float *x, const magma_tally4_int_t *incx,
                     const float *y, const magma_tally4_int_t *incy,
                           float *A, const magma_tally4_int_t *lda );
...
void blasf77_sscal(  const magma_tally4_int_t *n,
                     const float *alpha,
                           float *x, const magma_tally4_int_t *incx );

void blasf77_sscal( const magma_tally4_int_t *n,
                     const float *alpha,
                           float *x, const magma_tally4_int_t *incx );

void blasf77_sswap(  const magma_tally4_int_t *n,
                     float *x, const magma_tally4_int_t *incx,
                     float *y, const magma_tally4_int_t *incy );
...
void blasf77_srot(   const magma_tally4_int_t *n,
                     float *x, const magma_tally4_int_t *incx,
                     float *y, const magma_tally4_int_t *incy,
...
void blasf77_strmm(  const char *side, const char *uplo, const char *transa, const char *diag,
                     ...
                     const float *alpha,
                     const float *A, const magma_tally4_int_t *lda,
                           float *B, const magma_tally4_int_t *ldb );
...
float magma_tally4_cblas_sasum(
    magma_tally4_int_t n,
    const float *x, magma_tally4_int_t incx );

float magma_tally4_cblas_snrm2(
    magma_tally4_int_t n,
    const float *x, magma_tally4_int_t incx );

float magma_tally4_cblas_sdot(
    magma_tally4_int_t n,
    const float *x, magma_tally4_int_t incx,
    const float *y, magma_tally4_int_t incy );
...
void   lapackf77_sbdsdc( const char *uplo, const char *compq,
                         const magma_tally4_int_t *n,
                         float *d, float *e,
                         float *U,  const magma_tally4_int_t *ldu,
                         float *VT, const magma_tally4_int_t *ldvt,
                         float *Q, magma_tally4_int_t *IQ,
...
void   lapackf77_sgebak( const char *job, const char *side,
                         ...
                         const float *scale, const magma_tally4_int_t *m,
                         float *V, const magma_tally4_int_t *ldv,
                         magma_tally4_int_t *info );
...
void   lapackf77_sgebd2( const magma_tally4_int_t *m, const magma_tally4_int_t *n,
                         float *A, const magma_tally4_int_t *lda,
                         float *d, float *e,
                         float *tauq,
                         float *taup,
...
void   lapackf77_sgebrd( const magma_tally4_int_t *m, const magma_tally4_int_t *n,
                         float *A, const magma_tally4_int_t *lda,
                         float *d, float *e,
                         float *tauq,
                         float *taup,
                         float *work, const magma_tally4_int_t *lwork,
                         magma_tally4_int_t *info );

void   lapackf77_sgbbrd( const char *vect, const magma_tally4_int_t *m,
                         const magma_tally4_int_t *n, const magma_tally4_int_t *ncc,
                         const magma_tally4_int_t *kl, const magma_tally4_int_t *ku,
                         float *Ab, const magma_tally4_int_t *ldab,
                         float *d, float *e,
                         float *Q, const magma_tally4_int_t *ldq,
                         float *PT, const magma_tally4_int_t *ldpt,
                         float *C, const magma_tally4_int_t *ldc,
                         float *work,
                         #ifdef COMPLEX
                         float *rwork,
...
void   lapackf77_sgeev(  const char *jobvl, const char *jobvr,
                         ...
                         float *wr, float *wi,
                         #endif
                         float *Vl,   const magma_tally4_int_t *ldvl,
                         float *Vr,   const magma_tally4_int_t *ldvr,
                         float *work, const magma_tally4_int_t *lwork,
                         #ifdef COMPLEX
                         float *rwork,
                         #endif
...
void   lapackf77_sgehd2( const magma_tally4_int_t *n,
                         const magma_tally4_int_t *ilo, const magma_tally4_int_t *ihi,
                         float *A, const magma_tally4_int_t *lda,
                         float *tau,
                         float *work,
...
void   lapackf77_sgehrd( const magma_tally4_int_t *n,
                         const magma_tally4_int_t *ilo, const magma_tally4_int_t *ihi,
                         float *A, const magma_tally4_int_t *lda,
                         float *tau,
                         float *work, const magma_tally4_int_t *lwork,
...
void   lapackf77_sgelqf( const magma_tally4_int_t *m, const magma_tally4_int_t *n,
                         float *A, const magma_tally4_int_t *lda,
                         float *tau,
                         float *work, const magma_tally4_int_t *lwork,
                         magma_tally4_int_t *info );
...
void   lapackf77_sgeqlf( const magma_tally4_int_t *m, const magma_tally4_int_t *n,
                         float *A, const magma_tally4_int_t *lda,
                         float *tau,
                         float *work, const magma_tally4_int_t *lwork,
                         magma_tally4_int_t *info );

void   lapackf77_sgeqp3( const magma_tally4_int_t *m, const magma_tally4_int_t *n,
                         float *A, const magma_tally4_int_t *lda,
...
void   lapackf77_sgeqrf( const magma_tally4_int_t *m, const magma_tally4_int_t *n,
                         float *A, const magma_tally4_int_t *lda,
                         float *tau,
                         float *work, const magma_tally4_int_t *lwork,
                         magma_tally4_int_t *info );
...
void   lapackf77_sgesv(  const magma_tally4_int_t *n, const magma_tally4_int_t *nrhs,
                         float *A, const magma_tally4_int_t *lda,
...
void   lapackf77_sgetrf( const magma_tally4_int_t *m, const magma_tally4_int_t *n,
                         float *A, const magma_tally4_int_t *lda,
                         magma_tally4_int_t *ipiv,
                         magma_tally4_int_t *info );

void   lapackf77_sgetri( const magma_tally4_int_t *n,
                         float *A, const magma_tally4_int_t *lda,
...
void   lapackf77_ssytf2( const char*, magma_tally4_int_t*, 
                         float*, magma_tally4_int_t*, magma_tally4_int_t*, magma_tally4_int_t* );
...
void   lapackf77_ssyevd( const char *jobz, const char *uplo,
                         ...
                         float *work, const magma_tally4_int_t *lwork,
                         #ifdef COMPLEX
                         float *rwork, const magma_tally4_int_t *lrwork,
                         #endif
...
void   lapackf77_ssyevr( const char *jobz, const char *range, const char *uplo,
                         ...
                         float *A, const magma_tally4_int_t *lda,
                         float *vl, float *vu, 
                         magma_tally4_int_t *il, magma_tally4_int_t *iu, float *abstol, 
                         magma_tally4_int_t *m, float *w, float *z__, 
...
void   lapackf77_ssyevx( const char *jobz, const char *range, const char *uplo,
                         ...
                         magma_tally4_int_t *il, magma_tally4_int_t *iu, float *abstol,
                         magma_tally4_int_t *m, float *w, float *z__,
                         magma_tally4_int_t *ldz, float *work, magma_tally4_int_t *lwork,
                         float *rwork, magma_tally4_int_t *iwork, magma_tally4_int_t *ifail, magma_tally4_int_t *info);

void   lapackf77_ssygs2( const magma_tally4_int_t *itype, const char *uplo,
                         const magma_tally4_int_t *n,
                         float *A, const magma_tally4_int_t *lda,
                         float *B, const magma_tally4_int_t *ldb,
                         magma_tally4_int_t *info );

void   lapackf77_ssygst( const magma_tally4_int_t *itype, const char *uplo,
                         const magma_tally4_int_t *n,
                         float *A, const magma_tally4_int_t *lda,
                         float *B, const magma_tally4_int_t *ldb,
                         magma_tally4_int_t *info );

void   lapackf77_ssygvd( const magma_tally4_int_t *itype, const char *jobz, const char *uplo,
                         const magma_tally4_int_t *n,
                         float *A, const magma_tally4_int_t *lda,
                         float *B, const magma_tally4_int_t *ldb,
                         float *w,
...
void   lapackf77_ssysv( const char *uplo, 
                        const magma_tally4_int_t *n, const magma_tally4_int_t *nrhs,
                        float *A, const magma_tally4_int_t *lda, magma_tally4_int_t *ipiv,
                        float *B, const magma_tally4_int_t *ldb,
                        float *work, const magma_tally4_int_t *lwork,
                        magma_tally4_int_t *info );
...
void   lapackf77_shseqr( const char *job, const char *compz,
                         const magma_tally4_int_t *n,
                         const magma_tally4_int_t *ilo, const magma_tally4_int_t *ihi,
                         float *H, const magma_tally4_int_t *ldh,
                         #ifdef COMPLEX
                         float *w,
                         #else
                         float *wr, float *wi,
                         #endif
                         float *Z, const magma_tally4_int_t *ldz,
                         float *work, const magma_tally4_int_t *lwork,
                         magma_tally4_int_t *info );

void   lapackf77_slabrd( const magma_tally4_int_t *m, const magma_tally4_int_t *n, const magma_tally4_int_t *nb,
                         float *A, const magma_tally4_int_t *lda,
                         float *d, float *e,
                         float *tauq,
                         float *taup,
                         float *X, const magma_tally4_int_t *ldx,
                         float *Y, const magma_tally4_int_t *ldy );

#ifdef COMPLEX
void   lapackf77_slacgv( const magma_tally4_int_t *n,
                         float *x, const magma_tally4_int_t *incx );
#endif
...
#ifdef COMPLEX
void   lapackf77_slacrm( const magma_tally4_int_t *m, const magma_tally4_int_t *n,
                         const float *A, const magma_tally4_int_t *lda,
                         const float             *B, const magma_tally4_int_t *ldb,
                         float       *C, const magma_tally4_int_t *ldc,
                         float *rwork );
...
void   lapackf77_slasyf( const char *uplo,
                         ...
                         float *A, const magma_tally4_int_t lda,
                         magma_tally4_int_t *ipiv,
                         float *work, const magma_tally4_int_t *ldwork,
                         magma_tally4_int_t *info );
...
float lapackf77_slanst( const char *norm, const magma_tally4_int_t *n,
...
void   lapackf77_slaqp2( magma_tally4_int_t *m, magma_tally4_int_t *n, magma_tally4_int_t *offset,
                         float *a, magma_tally4_int_t *lda, magma_tally4_int_t *jpvt,
                         float *tau,
                         float *vn1, float *vn2,
                         float *work );

#ifdef COMPLEX
void   lapackf77_slarcm( const magma_tally4_int_t *m, const magma_tally4_int_t *n,
                         const float             *A, const magma_tally4_int_t *lda,
                         const float *B, const magma_tally4_int_t *ldb,
                         float       *C, const magma_tally4_int_t *ldc,
                         float *rwork );
...
void   lapackf77_slarf(  const char *side, const magma_tally4_int_t *m, const magma_tally4_int_t *n,
                         float *v, const magma_tally4_int_t *incv,
                         float *tau,
                         float *C, const magma_tally4_int_t *ldc,
                         float *work );
...
void   lapackf77_slarfb( const char *side, const char *trans, const char *direct, const char *storev,
                         const magma_tally4_int_t *m, const magma_tally4_int_t *n, const magma_tally4_int_t *k,
                         const float *V, const magma_tally4_int_t *ldv,
                         const float *T, const magma_tally4_int_t *ldt,
                         float *C, const magma_tally4_int_t *ldc,
                         float *work, const magma_tally4_int_t *ldwork );

void   lapackf77_slarfg( const magma_tally4_int_t *n,
                         float *alpha,
                         float *x, const magma_tally4_int_t *incx,
                         float *tau );
...
void   lapackf77_slarft( const char *direct, const char *storev,
                         ...
                         float *V, const magma_tally4_int_t *ldv,
                         const float *tau,
                         float *T, const magma_tally4_int_t *ldt );

void   lapackf77_slarnv( const magma_tally4_int_t *idist, magma_tally4_int_t *iseed, const magma_tally4_int_t *n,
                         float *x );
...
void   lapackf77_slaswp( const magma_tally4_int_t *n,
                         float *A, const magma_tally4_int_t *lda,
...
void   lapackf77_slatrs( const char *uplo, const char *trans, const char *diag,
                         ...
                         const float *A, const magma_tally4_int_t *lda,
                         float *x, float *scale,
                         float *cnorm, magma_tally4_int_t *info );
...
void   lapackf77_sstein( const magma_tally4_int_t *n,
                         const float *d, const float *e,
                         ...
                         float *Z, const magma_tally4_int_t *ldz,
                         float *work, magma_tally4_int_t *iwork, magma_tally4_int_t *ifailv,
                         magma_tally4_int_t *info );
...
void   lapackf77_sorg2r( const magma_tally4_int_t *m, const magma_tally4_int_t *n, const magma_tally4_int_t *k,
                         float *A, const magma_tally4_int_t *lda,
                         const float *tau,
                         float *work,
                         magma_tally4_int_t *info );
...
void   lapackf77_sorghr( const magma_tally4_int_t *n,
                         const magma_tally4_int_t *ilo, const magma_tally4_int_t *ihi,
                         float *A, const magma_tally4_int_t *lda,
                         const float *tau,
                         float *work, const magma_tally4_int_t *lwork,
...
void   lapackf77_sorglq( const magma_tally4_int_t *m, const magma_tally4_int_t *n, const magma_tally4_int_t *k,
                         float *A, const magma_tally4_int_t *lda,
                         const float *tau,
                         float *work, const magma_tally4_int_t *lwork,
                         magma_tally4_int_t *info );

void   lapackf77_sorgql( const magma_tally4_int_t *m, const magma_tally4_int_t *n, const magma_tally4_int_t *k,
                         float *A, const magma_tally4_int_t *lda,
                         const float *tau,
                         float *work, const magma_tally4_int_t *lwork,
                         magma_tally4_int_t *info );

void   lapackf77_sorgqr( const magma_tally4_int_t *m, const magma_tally4_int_t *n, const magma_tally4_int_t *k,
                         float *A, const magma_tally4_int_t *lda,
                         const float *tau,
                         float *work, const magma_tally4_int_t *lwork,
                         magma_tally4_int_t *info );
...
void   lapackf77_slaln2( const magma_tally4_int_t *ltrans,
                         ...
                         float *x, const magma_tally4_int_t *ldx,
                         float *scale, float *xnorm, magma_tally4_int_t *info );

float lapackf77_slamc3( float *a, float *b );

void   lapackf77_slamrg( magma_tally4_int_t *n1, magma_tally4_int_t *n2,
                         float *a,
                         magma_tally4_int_t *dtrd1, magma_tally4_int_t *dtrd2, magma_tally4_int_t *index );

float lapackf77_slapy3( float *x, float *y, float *z );

void   lapackf77_slaed2( magma_tally4_int_t *k, magma_tally4_int_t *n, magma_tally4_int_t *cutpnt,
                         float *d, float *q, magma_tally4_int_t *ldq, magma_tally4_int_t *indxq,
                         float *rho, float *z,
...
void   lapackf77_slaed4( magma_tally4_int_t *n, magma_tally4_int_t *i,
                         float *d,
                         float *z,
                         float *delta,
                         float *rho,
                         float *dlam, magma_tally4_int_t *info );

void   lapackf77_slasrt( const char *id, const magma_tally4_int_t *n, float *d, magma_tally4_int_t *info );

/*
 * Testing functions
 */
#ifdef COMPLEX
void   lapackf77_sbdt01( const magma_tally4_int_t *m, const magma_tally4_int_t *n, const magma_tally4_int_t *kd,
                         float *A, const magma_tally4_int_t *lda,
                         float *Q, const magma_tally4_int_t *ldq,
                         float *d, float *e,
                         float *Pt, const magma_tally4_int_t *ldpt,
...
void   lapackf77_sget22( const char *transa, const char *transe, const char *transw, const magma_tally4_int_t *n,
                         float *A, const magma_tally4_int_t *lda,
                         float *E, const magma_tally4_int_t *lde,
                         float *w,
                         float *work,
                         float *rwork,
                         float *result );

void   lapackf77_ssyt21( const magma_tally4_int_t *itype, const char *uplo,
...
void   lapackf77_shst01( const magma_tally4_int_t *n, const magma_tally4_int_t *ilo, const magma_tally4_int_t *ihi,
                         float *A, const magma_tally4_int_t *lda,
                         float *H, const magma_tally4_int_t *ldh,
                         float *Q, const magma_tally4_int_t *ldq,
                         float *work, const magma_tally4_int_t *lwork,
...
void   lapackf77_sstt21( const magma_tally4_int_t *n, const magma_tally4_int_t *kband,
                         float *AD,
                         float *AE,
                         float *SD,
                         float *SE,
...
void   lapackf77_sort01( const char *rowcol, const magma_tally4_int_t *m, const magma_tally4_int_t *n,
                         float *U, const magma_tally4_int_t *ldu,
                         float *work, const magma_tally4_int_t *lwork,
                         float *rwork,
                         float *resid );
...
void   lapackf77_ssyt21( magma_tally4_int_t *itype, const char *uplo, const magma_tally4_int_t *n, const magma_tally4_int_t *kband,
                         float *A, const magma_tally4_int_t *lda,
                         float *d, float *e,
                         float *U, const magma_tally4_int_t *ldu,
                         float *V, const magma_tally4_int_t *ldv,
...
void   lapackf77_slarfy( const char *uplo, const magma_tally4_int_t *n,
                         float *V, const magma_tally4_int_t *incv,
                         float *tau,
                         float *C, const magma_tally4_int_t *ldc,
                         float *work );

void   lapackf77_slarfx( const char *side, const magma_tally4_int_t *m, const magma_tally4_int_t *n,
                         float *V,
                         float *tau,
                         float *C, const magma_tally4_int_t *ldc,
                         float *work );

float lapackf77_sqpt01( const magma_tally4_int_t *m, const magma_tally4_int_t *n, const magma_tally4_int_t *k,
                         float *A,
                         float *Af, const magma_tally4_int_t *lda,
                         float *tau, magma_tally4_int_t *jpvt,
                         float *work, const magma_tally4_int_t *lwork );

void   lapackf77_sqrt02( const magma_tally4_int_t *m, const magma_tally4_int_t *n, const magma_tally4_int_t *k,
                         float *A,
                         float *AF,
                         float *Q,
                         float *R, const magma_tally4_int_t *lda,
                         float *tau,
                         float *work, const magma_tally4_int_t *lwork,
                         float *rwork,
                         float *result );

void   lapackf77_slatms( magma_tally4_int_t *m, magma_tally4_int_t *n,
                         ...
                         float *a, magma_tally4_int_t *lda, float *work, magma_tally4_int_t *info );
