    ...
    magma_minproduct_queue_t queue )
{
    ...
    //magma_minproduct_cprint_matrix(A, queue );
    // copy matrix into preconditioner parameter
    magma_minproduct_c_matrix hA={Magma_minproduct_CSR}, hACSR={Magma_minproduct_CSR};
    magma_minproduct_c_matrix hL={Magma_minproduct_CSR}, hU={Magma_minproduct_CSR};
    CHECK( magma_minproduct_cmtransfer( A, &hA, A.memory_location, Magma_minproduct_CPU, queue ));
    CHECK( magma_minproduct_cmconvert( hA, &hACSR, hA.storage_type, Magma_minproduct_CSR, queue ));

        // in case using fill-in
    if( precond->levels > 0 ){
        magma_minproduct_c_matrix hAL={Magma_minproduct_CSR}, hAUt={Magma_minproduct_CSR};
        CHECK( magma_minproduct_csymbilu( &hACSR, precond->levels, &hAL, &hAUt,  queue ));
        magma_minproduct_cmfree(&hAL, queue);
        magma_minproduct_cmfree(&hAUt, queue);
    }

    CHECK( magma_minproduct_cmtransfer(hACSR, &(precond->M), Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));

    magma_minproduct_cmfree( &hA, queue );
    magma_minproduct_cmfree( &hACSR, queue );
    ...
    CHECK( magma_minproduct_cmtransfer( precond->M, &hA, Magma_minproduct_DEV, Magma_minproduct_CPU, queue ));

    hL.diagorder_type = Magma_minproduct_UNITY;
    CHECK( magma_minproduct_cmconvert( hA, &hL , Magma_minproduct_CSR, Magma_minproduct_CSRL, queue ));
    hU.diagorder_type = Magma_minproduct_VALUE;
    CHECK( magma_minproduct_cmconvert( hA, &hU , Magma_minproduct_CSR, Magma_minproduct_CSRU, queue ));
    CHECK( magma_minproduct_cmtransfer( hL, &(precond->L), Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));
    CHECK( magma_minproduct_cmtransfer( hU, &(precond->U), Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproduct_c_matrix hA={Magma_minproduct_CSR}, hL={Magma_minproduct_CSR}, hU={Magma_minproduct_CSR};
    
    if (precond->L.memory_location != Magma_minproduct_DEV ){
        
        CHECK( magma_minproduct_cmtransfer( precond->M, &hA,
    ...
    if( precond->maxiter < 50 ){
        ...
        // extract the diagonal of L into precond->d
        CHECK( magma_minproduct_cjacobisetup_diagscal( precond->L, &precond->d, queue ));
        CHECK( magma_minproduct_cvinit( &precond->work1, Magma_minproduct_DEV, precond->U.num_rows, 1, MAGMA_minproduct_C_ZERO, queue ));
        
        // extract the diagonal of U into precond->d2
        CHECK( magma_minproduct_cjacobisetup_diagscal( precond->U, &precond->d2, queue ));
        CHECK( magma_minproduct_cvinit( &precond->work2, Magma_minproduct_DEV, precond->U.num_rows, 1, MAGMA_minproduct_C_ZERO, queue ));
    }
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproduct_c_matrix hA={Magma_minproduct_CSR}, hACSR={Magma_minproduct_CSR}, U={Magma_minproduct_CSR};
    CHECK( magma_minproduct_cmtransfer( A, &hA, A.memory_location, Magma_minproduct_CPU, queue ));
    ...
    CHECK( magma_minproduct_cmconvert( hACSR, &U, Magma_minproduct_CSR, Magma_minproduct_CSRL, queue ));
    magma_minproduct_cmfree( &hACSR, queue );
    CHECK( magma_minproduct_cmtransfer(U, &(precond->M), Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));
...
/*
    ...
    magma_minproduct_c_matrix hD, hR, hAt

    CHECK( magma_minproduct_ccsrsplit( 256, hA, &hD, &hR, queue ));

    CHECK( magma_minproduct_cmtransfer( hD, &precond->LD, Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));
    CHECK( magma_minproduct_cmtransfer( hR, &precond->L, Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));

    magma_minproduct_cmfree(&hD, queue );
    magma_minproduct_cmfree(&hR, queue );

    CHECK( magma_minproduct_c_cucsrtranspose(   hA, &hAt, queue ));

    CHECK( magma_minproduct_ccsrsplit( 256, hAt, &hD, &hR, queue ));

    CHECK( magma_minproduct_cmtransfer( hD, &precond->UD, Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));
    CHECK( magma_minproduct_cmtransfer( hR, &precond->U, Magma_minproduct_CPU, Magma_minproduct_DEV, queue ));
    
    magma_minproduct_cmfree(&hD, queue );
    magma_minproduct_cmfree(&hR, queue );
    magma_minproduct_cmfree(&hA, queue );
    magma_minproduct_cmfree(&hAt, queue );
*/
