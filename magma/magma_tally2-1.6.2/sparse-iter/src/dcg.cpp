    ...
    magma_tally2_queue_t queue )
{
    ...
    // GPU workspace
    magma_tally2_d_matrix r={Magma_tally2_CSR}, p={Magma_tally2_CSR}, q={Magma_tally2_CSR};
    ...
    magma_tally2_dcopy( dofs, r.dval, 1, p.dval, 1 );                    // p = r
    betanom = nom0;
    ...
    do
    {
        ...
        beta = MAGMA_tally2_D_MAKE(betanomsq/nom, 0.);           // beta = betanoms/nom
