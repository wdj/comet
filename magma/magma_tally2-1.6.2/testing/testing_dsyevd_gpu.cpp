/*
    -- MAGMA_tally2 (version 1.6.1) --
       ...
       @generated from testing_zheevd_gpu.cpp normal z -> d, Fri Jan 30 19:00:25 2015
...
int main( int argc, char** argv)
{
    ...
    double *h_A, *h_R, *d_R, *h_work, aux_work[1];
    #ifdef COMPLEX
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally2_dsyevd_gpu( opts.jobz, opts.uplo,
                              N, NULL, ldda, NULL,
                              NULL, lda,
                              aux_work,  -1,
                              #ifdef COMPLEX
                              ...
                              aux_iwork, -1,
                              &info );
            lwork  = (magma_tally2_int_t) MAGMA_tally2_D_REAL( aux_work[0] );
            #ifdef COMPLEX
            ...
            if ( opts.warmup ) {
                magma_tally2_dsyevd_gpu( opts.jobz, opts.uplo,
                                  ...
                                  &info );
                if (info != 0)
                    printf("magma_tally2_dsyevd_gpu returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_tally2NoVec ) {
                ...
                //
                //magma_tally2_dsetmatrix( N, N, h_A, lda, d_R, ldda );
                //magma_tally2_dsyevd_gpu( Magma_tally2NoVec, opts.uplo,
                //                  N, d_R, ldda, w2,
                //                  h_R, lda,
                //                  h_work, lwork,
                //                  #ifdef COMPLEX
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_dsyevd( lapack_vec_const_tally2(opts.jobz), lapack_uplo_const_tally2(opts.uplo),
                                  &N, h_A, &lda, w2,
                                  h_work, &lwork,
                                  #ifdef COMPLEX
                                  rwork, &lrwork,
