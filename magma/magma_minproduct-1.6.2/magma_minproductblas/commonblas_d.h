...
// Tesla GEMM kernels
#define MAGMA_minproductBLAS_DGEMM( name ) \
void magma_minproductblas_dgemm_##name( \
...
MAGMA_minproductBLAS_DGEMM( a_0  );
MAGMA_minproductBLAS_DGEMM( ab_0 );
MAGMA_minproductBLAS_DGEMM( N_N_64_16_16_16_4_special );
MAGMA_minproductBLAS_DGEMM( N_N_64_16_16_16_4         );
MAGMA_minproductBLAS_DGEMM( N_T_64_16_4_16_4          );
MAGMA_minproductBLAS_DGEMM( T_N_32_32_8_8_8           );
MAGMA_minproductBLAS_DGEMM( T_T_64_16_16_16_4_special );
MAGMA_minproductBLAS_DGEMM( T_T_64_16_16_16_4         );
                   
void magma_minproductblas_dgemm_tesla(
    ...
    const double *B, magma_minproduct_int_t ldb,
    double beta,
    double *C, magma_minproduct_int_t ldc );

void magma_minproductblas_dgemv_tesla(
...
__global__ void
magma_minproduct_dgemv_kernel3(int m, const double * __restrict__ V, int ldv,
                    double *c, double *dwork,
                    double *tau);

__global__ void
magma_minproduct_dtrmv_tkernel(double *T, int ldt, double *v,
                                    double *y);

__global__ void
magma_minproduct_dtrmv_kernel2(const double *T, int ldt,
