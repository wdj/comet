    ...
    float *A, int lda )
{
    ...
    bool full = (iby + BLK_Y <= n && (ind >= iby + BLK_Y || ind + BLK_X <= iby || MAGMA_minproduct_S_EQUAL( offdiag, diag )));
...
/**
    ...
    ********************************************************************/
extern "C"
void magma_minproductblas_slaset_q(
    ...
    magma_minproduct_queue_t queue)
{
    ...
    if (uplo == Magma_minproductLower) {
        ...
        if ( m == ldda &&
             MAGMA_minproduct_S_EQUAL( offdiag, MAGMA_minproduct_S_ZERO ) &&
             MAGMA_minproduct_S_EQUAL( diag,    MAGMA_minproduct_S_ZERO ) )
        {
            size_t size = m*n;
...
/**
    @see magma_minproductblas_slaset_q
    @ingroup magma_minproduct_saux2
    ********************************************************************/
extern "C"
void magma_minproductblas_slaset(
    magma_minproduct_uplo_t uplo, magma_minproduct_int_t m, magma_minproduct_int_t n,
    float offdiag, float diag,
    magma_minproductFloat_ptr dA, magma_minproduct_int_t ldda )
{
    magma_minproductblas_slaset_q( uplo, m, n, offdiag, diag, dA, ldda, magma_minproduct_stream );
}


////////////////////////////////////////////////////////////////////////////////////////
extern "C"
void magma_minproductblas_slaset_batched(
    magma_minproduct_uplo_t uplo, magma_minproduct_int_t m, magma_minproduct_int_t n,
    float offdiag, float diag,
