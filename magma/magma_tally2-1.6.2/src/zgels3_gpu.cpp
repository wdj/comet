    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally2_SUCCESS != magma_tally2_zmalloc( &dT, ldtwork )) {
        *info = MAGMA_tally2_ERR_DEVICE_ALLOC;
        return *info;
    }
    
    magma_tally2_zmalloc_cpu( &tau, k );
    if ( tau == NULL ) {
    ...
    magma_tally2_zgeqrf3_gpu( m, n, dA, ldda, tau, dT, info );
    if ( *info == 0 ) {
