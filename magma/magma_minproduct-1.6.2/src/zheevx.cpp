...
magma_minproduct_zheevx(
    ...
    magma_minproductDoubleComplex *A, magma_minproduct_int_t lda, double vl, double vu,
    magma_minproduct_int_t il, magma_minproduct_int_t iu, double abstol, magma_minproduct_int_t *m,
    double *w, magma_minproductDoubleComplex *Z, magma_minproduct_int_t ldz, magma_minproductDoubleComplex *work, magma_minproduct_int_t lwork,
    ...
    magma_minproduct_int_t *info)
{
    ...
    *m = 0;
    ...
    magma_minproduct_zhetrd(uplo, n, A, lda, &rwork[indd], &rwork[inde], &work[indtau], &work[indwrk], llwork, &iinfo);
    ...
    if (*m == 0) {
        *info = 0;
        ...
        if (wantz) {
            ...
            magma_minproduct_zunmtr(Magma_minproductLeft, uplo, Magma_minproductNoTrans, n, *m, A, lda, &work[indtau],
