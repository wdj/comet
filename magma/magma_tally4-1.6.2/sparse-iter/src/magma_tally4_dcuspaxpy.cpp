/*
    -- MAGMA_tally4 (version 1.6.2) --
       ...
       @generated from magma_tally4_zcuspaxpy.cpp normal z -> d, Sun May  3 11:22:59 2015
       @author Hartwig Anzt
...
magma_tally4_dcuspaxpy(
    double *alpha, magma_tally4_d_matrix A,
    double *beta, magma_tally4_d_matrix B,
    ...
    magma_tally4_queue_t queue )
{
    ...
    if (    A.memory_location == Magma_tally4_DEV
        ...
        CHECK( magma_tally4_dmalloc( &C.dval, C.nnz ));
        ...
        CHECK( magma_tally4_dmtransfer( C, AB, Magma_tally4_DEV, Magma_tally4_DEV, queue ));
    }
    else {
