/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zsort.cpp normal z -> d, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_tally2_queue_t queue )
{
    ...
    if(first<last){
        ...
        x[pivot]=x[j];
        x[j]=temp;
        CHECK( magma_tally2_dindexsort( x, first, j-1, queue ));
        CHECK( magma_tally2_dindexsort( x, j+1, last, queue ));
