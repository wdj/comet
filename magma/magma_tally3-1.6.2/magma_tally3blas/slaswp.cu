...
magma_tally3blas_slaswp(
    ...
    const magma_tally3_int_t *ipiv, magma_tally3_int_t inci )
{
    magma_tally3blas_slaswp_q( n, dAT, ldda, k1, k2, ipiv, inci, magma_tally3_stream );
}
...
/**
    @see magma_tally3blas_slaswpx_q
    @ingroup magma_tally3_saux2
    ********************************************************************/
extern "C" void
magma_tally3blas_slaswpx(
    ...
    const magma_tally3_int_t *ipiv, magma_tally3_int_t inci )
{
    return magma_tally3blas_slaswpx_q( n, dA, ldx, ldy, k1, k2, ipiv, inci, magma_tally3_stream );
}
...
// batches of pivots. On Fermi, it is faster than magma_tally3blas_slaswp
...
/**
    @see magma_tally3blas_slaswp2_q
    @ingroup magma_tally3_saux2
    ********************************************************************/
extern "C" void
magma_tally3blas_slaswp2(
    ...
    magma_tally3Int_const_ptr d_ipiv, magma_tally3_int_t inci )
{
    magma_tally3blas_slaswp2_q( n, dAT, ldda, k1, k2, d_ipiv, inci, magma_tally3_stream );
}
