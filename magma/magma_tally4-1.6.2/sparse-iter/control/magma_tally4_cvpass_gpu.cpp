/*
    -- MAGMA_tally4 (version 1.6.2) --
       ...
       @generated from magma_tally4_zvpass_gpu.cpp normal z -> c, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_tally4_queue_t queue )
{
    ...
    magma_tally4_c_matrix v_DEV={Magma_tally4_CSR};
    ...
    if ( v.memory_location == Magma_tally4_DEV ) {
        ...
        *val = v.dval;
        ...
        CHECK( magma_tally4_cmtransfer( v, &v_DEV, v.memory_location, Magma_tally4_DEV, queue ));
        CHECK( magma_tally4_cvget_dev( v_DEV, m, n, val, queue ));
    }
    
cleanup:
    magma_tally4_cmfree( &v_DEV, queue );
    return info;
}
