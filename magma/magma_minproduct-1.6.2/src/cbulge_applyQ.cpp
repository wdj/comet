...
extern "C" void magma_minproduct_cbulge_applyQ(
    magma_minproduct_int_t WANTZ, magma_minproduct_side_t SIDE, magma_minproduct_int_t NE, magma_minproduct_int_t N, magma_minproduct_int_t NB,
    magma_minproduct_int_t Vblksiz, magma_minproductFloatComplex *E, magma_minproduct_int_t LDE,
    magma_minproductFloatComplex *V, magma_minproductFloatComplex *TAU, magma_minproductFloatComplex *T,
    magma_minproduct_int_t *INFO, magma_minproductFloatComplex *dV, magma_minproductFloatComplex *dT,
    magma_minproductFloatComplex *dE, magma_minproduct_int_t copytype )
{
    //%===========================
    //%   local variables
    //%===========================
    ...
    magma_minproduct_int_t LDT, LDV, firstcolj;
    magma_minproduct_int_t bg, nbGblk, rownbm, k, m, n;
    magma_minproduct_int_t st, ed, fst, vlen, vnb, colj, len;
    magma_minproduct_int_t blkid, vpos, taupos, tpos;
    //magma_minproductFloatComplex *WORK;
    magma_minproduct_int_t LWORK;
    magma_minproduct_int_t  cur_blksiz, avai_blksiz, ncolinvolvd;
    magma_minproduct_int_t  nbgr, colst, coled, versionL, versionR;
    magma_minproduct_int_t blkcnt=-1;
    ...
    *INFO=0;
     ...
     * */
    if (copytype > 0) magma_minproduct_csetmatrix( LDV, blkcnt*Vblksiz, V, LDV, dV, LDV );
    if (copytype > 1) magma_minproduct_csetmatrix( LDT, blkcnt*Vblksiz, T, LDT, dT, LDT );
    if (copytype > 2) magma_minproduct_csetmatrix( N, NE, E, N, dE, N );
    magma_minproductFloatComplex *dwork;
    //ldwork  = NE;
    LWORK   = 2*N*max(Vblksiz, 64);
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_cmalloc( &dwork, LWORK )) {
    ...
    if (WANTZ == 1) {
        ...
        magma_minproductblas_claset( Magma_minproductFull, N, N, c_zero, c_one, dE, N );
    }
    ...
    magma_minproduct_int_t N1=N-N2;
    printf("using stream\n");
            ...
            for (bg = nbGblk; bg > 0; bg--) {
                ...
                for (m = rownbm; m > 0; m--) {
                    ...
                    if ((vlen > 0) && (vnb > 0)) {
                        if (WANTZ == 1) {
                            len =  N-colst;
                            magma_minproduct_clarfb_gpu( Magma_minproductLeft, Magma_minproductNoTrans, Magma_minproductForward, Magma_minproductColumnwise, vlen, len, vnb, dV(vpos), LDV, dT(tpos), LDT, dE(fst,colst), LDE, dwork, len);
                        } else {
                            magma_minproduct_clarfb_gpu( Magma_minproductLeft, Magma_minproductNoTrans, Magma_minproductForward, Magma_minproductColumnwise, vlen, NE, vnb, dV(vpos), LDV, dT(tpos), LDT, dE(fst,0), LDE, dwork, NE);
                        }
                    }
                }
            }
            ...
            for (m = rownbm; m > 0; m--) {
                ...
                for (n = nbgr; n > 0; n--) {
                    ...
                    if ((vlen > 0) && (vnb > 0)) {
                        ...
                        magma_minproduct_clarfb_gpu( Magma_minproductLeft, Magma_minproductNoTrans, Magma_minproductForward, Magma_minproductColumnwise, vlen, N1, vnb, dV(vpos), LDV, dT(tpos), LDT, dE(fst,0), LDE, dwork, N1);
                        magma_minproductblasSetKernelStream(stream[1]);
                        magma_minproduct_clarfb_gpu( Magma_minproductLeft, Magma_minproductNoTrans, Magma_minproductForward, Magma_minproductColumnwise, vlen, N2, vnb, dV(vpos), LDV, dT(tpos), LDT, dE(fst,N1), LDE, &dwork[N1*Vblksiz], N2);
                        #else
                        magma_minproduct_clarfb_gpu( Magma_minproductLeft, Magma_minproductNoTrans, Magma_minproductForward, Magma_minproductColumnwise, vlen, NE, vnb, dV(vpos), LDV, dT(tpos), LDT, dE(fst,0), LDE, dwork, NE);
                        #endif
                    }
            ...
            for (bg =1; bg <= nbGblk; bg++) {
                ...
                for (m = 1; m <= rownbm; m++) {
                    ...
                    if ((vlen > 0) && (vnb > 0)) {
                        #if defined(USESTREAM)
                        magma_minproductblasSetKernelStream(stream[0]);
                        magma_minproduct_clarfb_gpu( Magma_minproductRight, Magma_minproductNoTrans, Magma_minproductForward, Magma_minproductColumnwise, N1, vlen, vnb, dV(vpos), LDV, dT(tpos), LDT, dE(0, fst), LDE, dwork, N1);
                        magma_minproductblasSetKernelStream(stream[1]);
                        magma_minproduct_clarfb_gpu( Magma_minproductRight, Magma_minproductNoTrans, Magma_minproductForward, Magma_minproductColumnwise, N2, vlen, vnb, dV(vpos), LDV, dT(tpos), LDT, dE(N1, fst), LDE, &dwork[N1*Vblksiz], N2);
                        #else
                        magma_minproduct_clarfb_gpu( Magma_minproductRight, Magma_minproductNoTrans, Magma_minproductForward, Magma_minproductColumnwise, NE, vlen, vnb, dV(vpos), LDV, dT(tpos), LDT, dE(0, fst), LDE, dwork, NE);
                        #endif
                    }
                }
            }
