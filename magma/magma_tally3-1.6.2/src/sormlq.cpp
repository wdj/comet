...
/**
    ...
    as returned by SGELQF. Q is of order M if SIDE = Magma_tally3Left and of order N
    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb >= k) {
        /* Use CPU code */
        lapackf77_sormlq( lapack_side_const_tally3(side), lapack_trans_const_tally3(trans),
        ...
        magma_tally3Float_ptr dwork, dV, dT, dC;
        ...
        magma_tally3_smalloc_cpu( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_tally3_ssetmatrix( m, n, C, ldc, dC(0,0), lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            spanel_to_q_tally3( Magma_tally3Lower, ib, A(i,i), lda, T2 );
            magma_tally3_ssetmatrix( ib, nq_i,  A(i,i), lda, dV(0,0), ib );
            sq_to_panel_tally3( Magma_tally3Lower, ib, A(i,i), lda, T2 );
            ...
            magma_tally3_ssetmatrix( ib, ib, T, ib, dT(0,0), ib );
            magma_tally3_slarfb_gpu( side, transt, Magma_tally3Forward, Magma_tally3Rowwise,
                              mi, ni, ib,
                              dV(0,0), ib,
                              dT(0,0), ib,
                              dC(ic,jc), lddc,
        ...
        magma_tally3_sgetmatrix( m, n, dC(0,0), lddc, C, ldc );
