...
magma_tally4_cheevx(
    ...
    magma_tally4FloatComplex *A, magma_tally4_int_t lda, float vl, float vu,
    magma_tally4_int_t il, magma_tally4_int_t iu, float abstol, magma_tally4_int_t *m,
    float *w, magma_tally4FloatComplex *Z, magma_tally4_int_t ldz, magma_tally4FloatComplex *work, magma_tally4_int_t lwork,
    ...
    magma_tally4_int_t *info)
{
    ...
    *m = 0;
    ...
    magma_tally4_chetrd(uplo, n, A, lda, &rwork[indd], &rwork[inde], &work[indtau], &work[indwrk], llwork, &iinfo);
    ...
    if (*m == 0) {
        *info = 0;
        ...
        if (wantz) {
            ...
            magma_tally4_cunmtr(Magma_tally4Left, uplo, Magma_tally4NoTrans, n, *m, A, lda, &work[indtau],
