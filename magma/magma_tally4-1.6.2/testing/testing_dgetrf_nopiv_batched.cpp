...
int main( int argc, char** argv)
{
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
      ...
      for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_DEV(  dA_magma_tally4,  double, ldda*N * batchCount);
            ...
            magma_tally4_dsetmatrix( M, columns, h_R, lda, dA_magma_tally4, ldda );
            ...
            /* ====================================================================
               ...
               =================================================================== */
            dset_pointer(dA_array, dA_magma_tally4, ldda, 0, 0, ldda*N, batchCount, queue);
            magma_tally4_time = magma_tally4_sync_wtime(0);
            info = magma_tally4_dgetrf_nopiv_batched( M, N, dA_array, ldda, dinfo_magma_tally4, batchCount, queue);
            ...
            if ( opts.check ) {
                ...
                magma_tally4_dgetmatrix( M, N*batchCount, dA_magma_tally4, ldda, h_A, lda );
                for(int i=0; i<batchCount; i++)
                {
