                  ...
                  magma_tally3_int_t batchCount,  magma_tally3_queue_t queue)
{
   ...
   /* check allocation */
    ...
    if (notran) {
        ...
        // solve 
        magma_tally3blas_strsm_outofplace_batched(Magma_tally3Left, Magma_tally3Upper, trans, Magma_tally3Unit, 1,
                n, nrhs,
                MAGMA_tally3_S_ONE,
                dA_displ,       ldda, // dA
                dB_displ,      lddb, // dB
        ...
        // solve 
        magma_tally3blas_strsm_outofplace_batched(Magma_tally3Left, Magma_tally3Lower, trans, Magma_tally3NonUnit, 1,
                n, nrhs,
                MAGMA_tally3_S_ONE,
                dA_displ,       ldda, // dA
                dwork_array,        n, // dB 
