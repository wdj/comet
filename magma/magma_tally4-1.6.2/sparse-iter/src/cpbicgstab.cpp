    ...
    magma_tally4_queue_t queue )
{
    ...
    // workspace
    magma_tally4_c_matrix r={Magma_tally4_CSR}, rr={Magma_tally4_CSR}, p={Magma_tally4_CSR}, v={Magma_tally4_CSR}, s={Magma_tally4_CSR}, t={Magma_tally4_CSR}, ms={Magma_tally4_CSR}, mt={Magma_tally4_CSR}, y={Magma_tally4_CSR}, z={Magma_tally4_CSR};
    ...
    CHECK( magma_tally4_cvinit( &ms,Magma_tally4_DEV, A.num_rows, b.num_cols, c_zero, queue ));
    CHECK( magma_tally4_cvinit( &mt,Magma_tally4_DEV, A.num_rows, b.num_cols, c_zero, queue ));
    CHECK( magma_tally4_cvinit( &y, Magma_tally4_DEV, A.num_rows, b.num_cols, c_zero, queue ));
    CHECK( magma_tally4_cvinit( &z, Magma_tally4_DEV, A.num_rows, b.num_cols, c_zero, queue ));
    ...
    betanom = nom0;
    nom = nom0*nom0;
    rho_new = omega = alpha = MAGMA_tally4_C_MAKE( 1.0, 0. );
    ...
    do
    {
        ...
        // preconditioner
        CHECK( magma_tally4_c_applyprecond_left( A, p, &mt, precond_par, queue ));
        CHECK( magma_tally4_c_applyprecond_right( A, mt, &y, precond_par, queue ));

        CHECK( magma_tally4_c_spmv( c_one, A, y, c_zero, v, queue ));      // v = Ap
        ...
        // preconditioner
        CHECK( magma_tally4_c_applyprecond_left( A, s, &ms, precond_par, queue ));
        CHECK( magma_tally4_c_applyprecond_right( A, ms, &z, precond_par, queue ));

        CHECK( magma_tally4_c_spmv( c_one, A, z, c_zero, t, queue ));       // t=As

        // preconditioner
        CHECK( magma_tally4_c_applyprecond_left( A, s, &ms, precond_par, queue ));
        CHECK( magma_tally4_c_applyprecond_left( A, t, &mt, precond_par, queue ));

        // omega = <ms,mt>/<mt,mt>
        omega = magma_tally4_cdotc( dofs, mt.dval, 1, ms.dval, 1 )
                   / magma_tally4_cdotc( dofs, mt.dval, 1, mt.dval, 1 );

        magma_tally4_caxpy( dofs, alpha, y.dval, 1 , x->dval, 1 );     // x=x+alpha*p
        magma_tally4_caxpy( dofs, omega, z.dval, 1 , x->dval, 1 );     // x=x+omega*s
...
cleanup:
    ...
    magma_tally4_cmfree(&ms, queue );
    magma_tally4_cmfree(&mt, queue );
