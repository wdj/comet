...
def getlatexdoc(funcdoc):
  latexdoc = "\\textsf{magma_tally3\_int\_t} "
...
def getoutputdoc(fdoc, output):
  ...
  doc += output.ret_type("magma_tally3_int_t")
