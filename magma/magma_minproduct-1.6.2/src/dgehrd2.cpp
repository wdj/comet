/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zgehrd2.cpp normal z -> d, Fri Jan 30 19:00:19 2015
    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb == 1 || nb > nh) {
        ...
        //   nb*nb   for dT
        double *dwork;
        if (MAGMA_minproduct_SUCCESS != magma_minproduct_dmalloc( &dwork, 2*nb*ldda + n*ldda + nb*nb )) {
        ...
        for (i = ilo; i < ihi-1 - nb; i += nb) {
            ...
            magma_minproduct_dsetmatrix( nb, nb, T, nb, dT, nb );
