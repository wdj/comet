...
__global__ void
magma_minproduct_cbicgmerge1_kernel(  
    int n, 
    ...
    magma_minproductFloatComplex * p )
{
    ...
    magma_minproductFloatComplex beta=skp[1];
...
magma_minproduct_cbicgmerge1(  
    ...
    magma_minproduct_cbicgmerge1_kernel<<<Gs, Bs, 0>>>( n, skp, v, r, p );
...
__global__ void
magma_minproduct_cbicgmerge2_kernel(  
    int n, 
    magma_minproductFloatComplex * skp, 
    magma_minproductFloatComplex * r,
    magma_minproductFloatComplex * v, 
    ...
    magma_minproductFloatComplex_ptr s )
{
    ...
    magma_minproduct_cbicgmerge2_kernel<<<Gs, Bs, 0>>>( n, skp, r, v, s );
...
__global__ void
magma_minproduct_cbicgmerge3_kernel(  
    int n, 
    magma_minproductFloatComplex * skp, 
    magma_minproductFloatComplex * p,
    magma_minproductFloatComplex * se,
    ...
    magma_minproductFloatComplex_ptr r )
{
    ...
    dim3 Bs( BLOCK_SIZE );
    dim3 Gs( magma_minproduct_ceildiv( n, BLOCK_SIZE ) );
    magma_minproduct_cbicgmerge3_kernel<<<Gs, Bs, 0>>>( n, skp, p, s, t, x, r );
...
__global__ void
magma_minproduct_cbicgmerge4_kernel_1(  
    magma_minproductFloatComplex * skp )
{
    int i = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void
magma_minproduct_cbicgmerge4_kernel_2(  
    magma_minproductFloatComplex * skp )
{
    int i = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void
magma_minproduct_cbicgmerge4_kernel_3(  
    magma_minproductFloatComplex * skp )
{
    int i = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    magma_minproductFloatComplex_ptr skp )
{
    ...
    dim3 Gs( 1 );
    if( type == 1 )
        magma_minproduct_cbicgmerge4_kernel_1<<<Gs, Bs, 0>>>( skp );
    else if( type == 2 )
        magma_minproduct_cbicgmerge4_kernel_2<<<Gs, Bs, 0>>>( skp );
    else if( type == 3 )
        magma_minproduct_cbicgmerge4_kernel_3<<<Gs, Bs, 0>>>( skp );
    else
