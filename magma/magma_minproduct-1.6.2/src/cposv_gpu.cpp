/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zposv_gpu.cpp normal z -> c, Fri Jan 30 19:00:12 2015
*/
    ...
    magma_minproduct_int_t *info )
{
    *info = 0;
    ...
    magma_minproduct_cpotrf_gpu( uplo, n, dA, ldda, info );
    if ( *info == 0 ) {
        magma_minproduct_cpotrs_gpu( uplo, n, nrhs, dA, ldda, dB, lddb, info );
    }
