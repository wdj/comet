...
ztranspose_device(
    int m, int n,
    const magma_tally3DoubleComplex *A, int lda,
    magma_tally3DoubleComplex *AT,      int ldat)
{
    __shared__ magma_tally3DoubleComplex sA[NB][NX+1];
...
void ztranspose_kernel_batched(
    ...
    magma_tally3DoubleComplex **dAT_array,      int ldat)
{
...
/**
    @see magma_tally3blas_ztranspose_q
    @ingroup magma_tally3_zaux2
    ********************************************************************/
extern "C" void
magma_tally3blas_ztranspose(
    ...
    magma_tally3DoubleComplex_ptr       dAT, magma_tally3_int_t lddat )
{
    magma_tally3blas_ztranspose_q( m, n, dA, ldda, dAT, lddat, magma_tally3_stream );
}
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_tally3blas_ztranspose_batched_q(
    magma_tally3_int_t m, magma_tally3_int_t n,
    magma_tally3DoubleComplex **dA_array,  magma_tally3_int_t ldda,
    magma_tally3DoubleComplex **dAT_array, magma_tally3_int_t lddat, magma_tally3_int_t batchCount, magma_tally3_queue_t queue )
{
    magma_tally3_int_t info = 0;
    if ( m < 0 )
        info = -1;
...
/**
    @see magma_tally3blas_ztranspose_batched_q
    @ingroup magma_tally3_zaux2
    ********************************************************************/
extern "C" void
...
{
    magma_tally3blas_ztranspose_batched_q( m, n, dA_array, ldda, dAT_array, lddat, batchCount, magma_tally3_stream );
}
