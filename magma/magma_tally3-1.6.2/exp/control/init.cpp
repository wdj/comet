...
extern "C" magma_tally3_context *
magma_tally3_init( void *params, void* (*func)(void *a), magma_tally3_int_t nthread, magma_tally3_int_t ncpu, magma_tally3_int_t ngpu,
...
/*  -- MAGMA_tally3 (version 1.6.1) --
    ...
    subsequent calls to routines in the MAGMA_tally3 library.
    ...
    context  = (magma_tally3_context *)malloc(sizeof(magma_tally3_context));
...
extern "C" void
magma_tally3_finalize( magma_tally3_context *cntxt)
{
/*  -- MAGMA_tally3 (version 1.6.1) --
       Univ. of Tennessee, Knoxville
       Univ. of California, Berkeley
    ...
    Purpose
    =======
    This function finalizes the MAGMA_tally3 hardware context.

    Arguments
    =========
    CNTXT  (input) MAGMA_tally3_CONTEXT
           Pointer to the MAGMA_tally3 hardware context to be closed
    ===================================================================== */
