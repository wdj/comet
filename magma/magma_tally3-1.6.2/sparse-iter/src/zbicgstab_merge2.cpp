...
/**
    ...
    The difference to magma_tally3_zbicgstab is that we use specifically designed kernels
    ...
    magma_tally3_queue_t queue )
{
    ...
    do
    {
        ...
        CHECK( magma_tally3_zbicgmerge_spmv1(  A, d1, d2, q(2), q(0), q(3), skp, queue ));
        CHECK( magma_tally3_zbicgmerge2( dofs, skp, r.dval, v.dval, s.dval, queue )); // s=r-alpha*v
        CHECK( magma_tally3_zbicgmerge_spmv2( A, d1, d2, q(4), q(5), skp, queue ));
        CHECK( magma_tally3_zbicgmerge_xrbeta( dofs, d1, d2, q(0), q(1), q(2),
