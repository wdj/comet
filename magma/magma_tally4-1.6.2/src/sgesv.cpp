    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally4_sgetrf_gpu( n, n, dA, ldda, ipiv, info );
    ...
    if ( *info == 0 ) {
        ...
        magma_tally4_sgetrs_gpu( Magma_tally4NoTrans, n, nrhs, dA, ldda, ipiv, dB, lddb, info );
...
CPU_INTERFACE:
    ...
    magma_tally4_sgetrf( n, n, A, lda, ipiv, info );
    if ( *info == 0 ) {
        lapackf77_sgetrs( Magma_tally4NoTransStr, &n, &nrhs, A, &lda, ipiv, B, &ldb, info );
    }
    return *info;
}
