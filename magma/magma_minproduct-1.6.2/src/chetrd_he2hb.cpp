    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_cmalloc( &dA, (n + 2*nb)*ldda )) {
    ...
    magma_minproductFloatComplex *dwork = dA + n*ldda;
    magma_minproductFloatComplex *dW    = dwork + nb*ldda;
    ...
    if (upper) {
        ...
        if (1 <= n-nb) {
            ...
            magma_minproduct_csetmatrix_async( (n-nb), (n-nb),
                                    A(nb+1, nb+1),  lda,
        ...
        for (i = 1; i <= n-nb; i += nb) {
             ...
             if (i > 1 ) {
                 ...
                 magma_minproduct_cher2k(Magma_minproductLower, Magma_minproductNoTrans, pm_old-pn_old, pn_old, c_neg_one,
