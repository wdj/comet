...
magma_tally3_zheevr_gpu(
    ...
    double *w,
    magma_tally3DoubleComplex_ptr dZ, magma_tally3_int_t lddz, magma_tally3_int_t *isuppz,
    ...
    magma_tally3_int_t *info)
{
    ...
    *m = 0;
    ...
    if (MAGMA_tally3_SUCCESS != magma_tally3_dmalloc( &dwork, n )) {
        fprintf (stderr, "!!!! device memory allocation error (magma_tally3_zheevr_gpu)\n");
...
#ifdef FAST_HEMV
    magma_tally3_zhetrd2_gpu(uplo, n, dA, ldda, &rwork[indrd], &rwork[indre],
                      &work[indtau], wA, ldwa, &work[indwk], llwork, dZ, lddz*n, &iinfo);
#else
    magma_tally3_zhetrd_gpu (uplo, n, dA, ldda, &rwork[indrd], &rwork[indre],
                      &work[indtau], wA, ldwa, &work[indwk], llwork, &iinfo);
#endif

    lopt = n + (magma_tally3_int_t)MAGMA_tally3_Z_REAL(work[indwk]);
