...
magma_tally3_zgeqrf2(magma_tally3_context *cntxt, magma_tally3_int_t m, magma_tally3_int_t n, 
...
/*  -- MAGMA_tally3 (version 1.6.1) --
    ...
    *info = 0;
    ...
    if (nb >= nbmin && nb < k && nx < k) {
        ...
        magma_tally3_zgeqrf_mc(cntxt, &rows, &ib, a_ref(i,i), &lda, 
        ...
        zpanel_to_q_tally3(Magma_tally3Upper, ib, a_ref(i,i), lda, qr_params->w+cnt*qr_params->nb*qr_params->nb);
            cublasSetMatrix(rows, ib, sizeof(cuDoubleComplex),
                            a_ref(i,i), lda, da_ref(i,i), ldda);
        if (qr_params->flag == 1)
          zq_to_panel_tally3(Magma_tally3Upper, ib, a_ref(i,i), lda, qr_params->w+cnt*qr_params->nb*qr_params->nb);
