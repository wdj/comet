    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb == 1 || nb > nh) {
        ...
        if (MAGMA_tally4_SUCCESS != magma_tally4_zmalloc( &dwork, 2*nb*ldda + n*ldda + nb*nb )) {
            *info = MAGMA_tally4_ERR_DEVICE_ALLOC;
            return *info;
        }
        magma_tally4DoubleComplex *dV = dwork + nb*ldda;
        magma_tally4DoubleComplex *dA = dwork + nb*ldda*2;
        magma_tally4DoubleComplex *dT = dwork + nb*ldda*2 + n*ldda;
        ldwork = ldda;
        ...
        for (i = ilo; i < ihi-1 - nb; i += nb) {
            ...
            magma_tally4_zsetmatrix( nb, nb, T, nb, dT, nb );
