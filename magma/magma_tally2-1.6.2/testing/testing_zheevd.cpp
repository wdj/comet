...
int main( int argc, char** argv)
{
    ...
    magma_tally2DoubleComplex *h_A, *h_R, *h_work, aux_work[1];
    #ifdef COMPLEX
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally2_zheevd( opts.jobz, opts.uplo,
                          N, NULL, lda, NULL,
                          aux_work,  -1,
                          #ifdef COMPLEX
                          aux_rwork, -1,
            ...
            if ( opts.warmup ) {
                magma_tally2_zheevd( opts.jobz, opts.uplo,
                              ...
                              &info );
                if (info != 0)
                    printf("magma_tally2_zheevd returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_tally2NoVec ) {
                ...
                //
                //lapackf77_zlacpy( Magma_tally2FullStr, &N, &N, h_A, &lda, h_R, &lda );
                //magma_tally2_zheevd( Magma_tally2NoVec, opts.uplo,
                //              N, h_R, lda, w2,
                //              h_work, lwork,
                //              #ifdef COMPLEX
                //              rwork, lrwork,
