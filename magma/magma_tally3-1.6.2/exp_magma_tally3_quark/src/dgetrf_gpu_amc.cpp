...
/*
*
*  magma_tally3_dgetrf_gpu_amc:
*
*  This function allocate the workspace and call magma_tally3_dgetrf_gpu_work_amc
*  REC: recursif Algorithm
*  ASYNC: asynchronous algorithm
*/

extern "C" magma_tally3_int_t magma_tally3_dgetrf_gpu_amc(magma_tally3_int_t m, magma_tally3_int_t n,  
...
/*  -- MAGMA_tally3 (version 1.6.1) -- 
    ...
    *info = 0; 
    ...
    magma_tally3_dgetrf_gpu_work_amc(m, n, dA, dA_LD, ipiv, info, AWORK, AWORK_LD, AWORK_n);
...
magma_tally3_dgetrf_gpu_work_amc(
     ...
     for(K=0;K<=N-1;K++){ 
          ...
          for(J=K+1;J<=min(K+A_N-1, N-1);J++){ 
           ...
           if(K+A_N<N) { 
              ...
              magma_tally3_insert_dgetmatrix_transpose(gpu_nrows, ncols, dAT(K+1,K+A_N), dAT_LD, A(K+1,K+A_N), A_LD, dAP_get, dAP_LD, colptr(K+A_N)); //blocking
