    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally2_zheevd_m( ngpu, jobz, uplo, n, A, lda, w, work, lwork, rwork, lrwork, iwork, liwork, info );
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally2_ztrsm_m( ngpu, Magma_tally2Left, uplo, trans, Magma_tally2NonUnit,
