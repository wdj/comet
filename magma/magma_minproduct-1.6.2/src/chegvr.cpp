    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_minproduct_cheevr_gpu(jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, abstol,
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_minproduct_ctrsm(Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit, n, *m, c_one,
                          dB, lddb, dZ, lddz);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_minproduct_ctrmm(Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit, n, *m, c_one,
                          dB, lddb, dZ, lddz);
        }
