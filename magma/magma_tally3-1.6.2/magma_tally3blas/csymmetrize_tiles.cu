...
*/
__global__ void
csymmetrize_tiles_lower( int m, magma_tally3FloatComplex *dA, int ldda, int mstride, int nstride )
{
...
__global__ void
csymmetrize_tiles_upper( int m, magma_tally3FloatComplex *dA, int ldda, int mstride, int nstride )
{
    // shift dA to tile's top-left corner
    dA += blockIdx.x*(mstride + nstride*ldda);
...
/**
    @see magma_tally3blas_csymmetrize_tiles_q
    @ingroup magma_tally3_caux2
    ********************************************************************/
extern "C" void
magma_tally3blas_csymmetrize_tiles(
    ...
    magma_tally3_int_t ntile, magma_tally3_int_t mstride, magma_tally3_int_t nstride )
{
    magma_tally3blas_csymmetrize_tiles_q( uplo, m, dA, ldda, ntile, mstride, nstride, magma_tally3_stream );
}
