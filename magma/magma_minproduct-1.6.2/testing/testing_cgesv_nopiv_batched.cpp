...
int main(int argc, char **argv)
{
    ...
    magma_minproductFloatComplex **d_A_array, **d_B_array;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_B, magma_minproductFloatComplex, ldb*nrhs*batchCount );
            TESTING_MALLOC_CPU( h_X, magma_minproductFloatComplex, ldb*nrhs*batchCount );
            ...
            magma_minproduct_cgesv_nopiv_batched( N, nrhs, d_A_array, ldda, d_B_array, lddb, dinfo_magma_minproduct, batchCount, queue );
