    ...
    magma_tally4_queue_t queue )
{
    ...
    if ( src == Magma_tally4_CPU && dst == Magma_tally4_DEV ) {
        ...
        if ( A.storage_type == Magma_tally4_CSR || A.storage_type == Magma_tally4_CSC
            ...
            // data transfer
            magma_tally4_zsetvector( A.nnz, A.val, 1, B->dval, 1 );
        ...
        if ( A.storage_type == Magma_tally4_ELLPACKT || A.storage_type == Magma_tally4_ELL ) {
            ...
            B->diameter = A.diameter;
            // memory allocation
            CHECK( magma_tally4_zmalloc( &B->dval, A.num_rows * A.max_nnz_row ));
            CHECK( magma_tally4_index_malloc( &B->dcol, A.num_rows * A.max_nnz_row ));
            // data transfer
            magma_tally4_zsetvector( A.num_rows * A.max_nnz_row, A.val, 1, B->dval, 1 );
        ...
        if ( A.storage_type == Magma_tally4_ELLRT ) {
            ...
            // memory allocation
            CHECK( magma_tally4_zmalloc( &B->dval, A.num_rows * rowlength ));
            CHECK( magma_tally4_index_malloc( &B->dcol, A.num_rows * rowlength ));
            CHECK( magma_tally4_index_malloc( &B->drow, A.num_rows ));
            // data transfer
            magma_tally4_zsetvector( A.num_rows * rowlength, A.val, 1, B->dval, 1 );
        ...
        if ( A.storage_type == Magma_tally4_BCSR ) {
            ...
            // memory allocation
            CHECK( magma_tally4_zmalloc( &B->dval, size_b*size_b*A.numblocks ));
            CHECK( magma_tally4_index_malloc( &B->drow, r_blocks + 1 ));
            CHECK( magma_tally4_index_malloc( &B->dcol, A.numblocks ));
            // data transfer
            magma_tally4_zsetvector( size_b*size_b*A.numblocks, A.val, 1, B->dval, 1 );
        ...
        if ( A.storage_type == Magma_tally4_DENSE ) {
            ...
            // data transfer
            magma_tally4_zsetvector( A.num_rows*A.num_cols, A.val, 1, B->dval, 1 );
        }
    }
    ...
    if ( src == Magma_tally4_CPU && dst == Magma_tally4_CPU ) {
        ...
        if ( A.storage_type == Magma_tally4_ELLPACKT || A.storage_type == Magma_tally4_ELL ) {
            ...
            B->diameter = A.diameter;
            // memory allocation
            CHECK( magma_tally4_zmalloc_cpu( &B->val, A.num_rows*A.max_nnz_row ));
    ...
    if ( src == Magma_tally4_DEV && dst == Magma_tally4_CPU ) {
        ...
        if ( A.storage_type == Magma_tally4_CSR || A.storage_type == Magma_tally4_CSC
            ...
            CHECK( magma_tally4_index_malloc_cpu( &B->col, A.nnz ));
            // data transfer
            magma_tally4_zgetvector( A.nnz, A.dval, 1, B->val, 1 );
        ...
        if ( A.storage_type == Magma_tally4_ELL || A.storage_type == Magma_tally4_ELLPACKT ) {
            ...
            CHECK( magma_tally4_index_malloc_cpu( &B->col, A.num_rows*A.max_nnz_row ));
            // data transfer
            magma_tally4_zgetvector( A.num_rows*A.max_nnz_row, A.dval, 1, B->val, 1 );
        ...
        if ( A.storage_type == Magma_tally4_ELLRT ) {
            ...
            CHECK( magma_tally4_index_malloc_cpu( &B->col, rowlength*A.num_rows ));
            // data transfer
            magma_tally4_zgetvector( A.num_rows*rowlength, A.dval, 1, B->val, 1 );
        ...
        if ( A.storage_type == Magma_tally4_BCSR ) {
            ...
            magma_tally4_int_t r_blocks = ceil( (float)A.num_rows / (float)size_b );
                    // max number of blocks per column
            // memory allocation
            CHECK( magma_tally4_zmalloc_cpu( &B->val, A.numblocks*A.blocksize*A.blocksize ));
            CHECK( magma_tally4_index_malloc_cpu( &B->row, r_blocks+1 ));
            CHECK( magma_tally4_index_malloc_cpu( &B->col, A.numblocks ));
            // data transfer
            magma_tally4_zgetvector( A.numblocks * A.blocksize * A.blocksize, A.dval, 1, B->val, 1 );
        ...
        if ( A.storage_type == Magma_tally4_DENSE ) {
            ...
            CHECK( magma_tally4_zmalloc_cpu( &B->val, A.num_rows*A.num_cols ));
            // data transfer
            magma_tally4_zgetvector( A.num_rows*A.num_cols, A.dval, 1, B->val, 1 );
        }
    }
    ...
    if ( src == Magma_tally4_DEV && dst == Magma_tally4_DEV ) {
        ...
        if ( A.storage_type == Magma_tally4_ELL || A.storage_type == Magma_tally4_ELLPACKT ) {
            ...
            CHECK( magma_tally4_index_malloc( &B->dcol, A.num_rows * A.max_nnz_row ));
            // data transfer
            magma_tally4_zcopyvector( A.num_rows*A.max_nnz_row, A.dval, 1, B->dval, 1 );
        ...
        if ( A.storage_type == Magma_tally4_ELLRT ) {
            ...
            CHECK( magma_tally4_index_malloc( &B->drow, A.num_rows ));
            // data transfer
            magma_tally4_zcopyvector( A.num_rows * rowlength, A.dval, 1, B->dval, 1 );
        ...
        if ( A.storage_type == Magma_tally4_BCSR ) {
            ...
            CHECK( magma_tally4_index_malloc( &B->dcol, A.numblocks ));
            // data transfer
            magma_tally4_zcopyvector( size_b*size_b*A.numblocks, A.dval, 1, B->dval, 1 );
        ...
        if ( A.storage_type == Magma_tally4_DENSE ) {
            ...
            CHECK( magma_tally4_zmalloc( &B->dval, A.num_rows*A.num_cols ));
            // data transfer
            magma_tally4_zcopyvector( A.num_rows*A.num_cols, A.dval, 1, B->dval, 1 );
        }
    }
