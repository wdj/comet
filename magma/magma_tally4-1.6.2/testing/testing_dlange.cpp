/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from testing_zlange.cpp normal z -> d, Fri Jan 30 19:00:24 2015
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            //h_A[ 1 + 1*lda ] = MAGMA_tally4_D_NAN;
            ...
            norm_magma_tally4 = magma_tally4blas_dlange( norm[inorm], M, N, d_A, ldda, d_work );
            gpu_time = magma_tally4_wtime() - gpu_time;
            gpu_perf = gbytes / gpu_time;
            if (norm_magma_tally4 < 0)
                printf("magma_tally4blas_dlange returned error %f: %s.\n",
            ...
            norm_lapack = lapackf77_dlange( lapack_norm_const_tally4(norm[inorm]), &M, &N, h_A, &lda, h_work );
            ...
            //         MAGMA_tally4_D_REAL( h_A[1+1*lda] ),
            //         MAGMA_tally4_D_IMAG( h_A[1+1*lda] ) );
