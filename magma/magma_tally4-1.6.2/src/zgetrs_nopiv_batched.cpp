                  ...
                  magma_tally4_int_t batchCount,  magma_tally4_queue_t queue)
{
   ...
   /* check allocation */
    ...
    if (notran) {
        ...
        // solve 
        magma_tally4blas_ztrsm_outofplace_batched(Magma_tally4Left, Magma_tally4Upper, trans, Magma_tally4Unit, 1,
                n, nrhs,
                MAGMA_tally4_Z_ONE,
                dA_displ,       ldda, // dA
                dB_displ,      lddb, // dB
        ...
        // solve 
        magma_tally4blas_ztrsm_outofplace_batched(Magma_tally4Left, Magma_tally4Lower, trans, Magma_tally4NonUnit, 1,
                n, nrhs,
                MAGMA_tally4_Z_ONE,
                dA_displ,       ldda, // dA
                dwork_array,        n, // dB 
