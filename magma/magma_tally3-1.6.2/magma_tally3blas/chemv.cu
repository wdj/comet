...
/**
    Purpose
    -------
    magma_tally3blas_chemv_work performs the matrix-vector operation:
    ...
    MAGMA_tally3 implements chemv through two steps:
    ...
    magma_tally3blas_chemv is a wrapper routine allocating the workspace inside the
    routine and provides the same interface as cublas.
    
    If users need to call chemv frequently, we suggest using
    magma_tally3blas_chemv_work instead of magma_tally3blas_chemv. As the overhead to
    allocate and free in device memory in magma_tally3blas_chemv would hurt performance.
    ...
    magma_tally3_queue_t queue )
{
    ...
    if ( arch < 200 ) {
        magma_tally3_chemv( uplo, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
...
// end magma_tally3blas_chemv_work


/**
    Purpose
    -------
    magma_tally3blas_chemv performs the matrix-vector operation:
    ...
    magma_tally3FloatComplex_ptr dy, magma_tally3_int_t incy)
{
    ...
    magma_tally3blas_chemv_work( uplo, n, alpha, dA, ldda, dx, incx, beta, dy, incy,
