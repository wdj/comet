...
/**
    ...
    as returned by ZGEQLF. Q is of order M if SIDE = Magma_minproductLeft and of order N
    ...
    magma_minproduct_int_t *info)
{
    ...
    magma_minproductDoubleComplex *T, *T2;
    ...
    *info  = 0;
    ...
    if (*info == 0) {
        nb = magma_minproduct_get_zgelqf_nb( min( m, n ));
        lwkopt = max(1,nw)*nb;
    ...
    if ( nb >= k ) {
        ...
        magma_minproductDoubleComplex *dwork, *dV, *dT, *dC;
        magma_minproduct_zmalloc( &dwork, (nw + nq + nb)*nb + lddc*n );
        if ( dwork == NULL ) {
        ...
        magma_minproduct_zmalloc_pinned( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_minproduct_zsetmatrix( m, n, C, ldc, dC, lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set lower triangle of panel in A to identity,
               ...
               3) restore A                                      */
            zpanel_to_q( Magma_minproductLower, ib, A(nq_i-ib,i), lda, T2 );
            magma_minproduct_zsetmatrix( nq_i,  ib, A(0,      i), lda, dV, nq_i );
            zq_to_panel( Magma_minproductLower, ib, A(nq_i-ib,i), lda, T2 );
            ...
            magma_minproduct_zlarfb_gpu( side, trans, Magma_minproductBackward, Magma_minproductColumnwise,
                              mi, ni, ib,
                              dV, nq_i,
                              dT, ib,
                              dC, lddc,
        ...
        magma_minproduct_zgetmatrix( m, n, dC, lddc, C, ldc );
