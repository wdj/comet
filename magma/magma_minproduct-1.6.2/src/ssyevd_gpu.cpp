    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_minproduct_sstedx( Magma_minproductRangeAll, n, 0., 0., 0, 0, w, &work[inde],
        ...
        magma_minproduct_ssetmatrix( n, n, &work[indwrk], n, dwork, lddc );

        magma_minproduct_sormtr_gpu( Magma_minproductLeft, uplo, Magma_minproductNoTrans, n, n, dA, ldda, &work[indtau],
                          dwork, lddc, wA, ldwa, &iinfo );

        magma_minproduct_scopymatrix( n, n, dwork, lddc, dA, ldda );
