/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zlahru_m.cpp normal z -> c, Fri Jan 30 19:00:18 2015
       @author Mark Gates
*/
...
/**
    Purpose
    -------
    CLAHRU is an auxiliary MAGMA_minproduct routine that is used in CGEHRD to update
    ...
    struct cgehrd_data *data )
{
    ...
    for( d = 0; d < ngpu; ++d ) {
        ...
        magma_minproduct_cgemm( Magma_minproductNoTrans, Magma_minproductConjTrans, dkhi-dk, nb, nb,
                     c_one,  dVd(d, dk, 0), ldvd,
                             dTi(d),        nb,
                     c_zero, dW (d, dk, 0), ldda );
        
        // Am = Am - Ym Wd' = A(0:k-1, k:ihi-1) - Ym(0:k-1, 0:nb-1) * W(k:ihi-1, 0:nb-1)'
        magma_minproduct_cgemm( Magma_minproductNoTrans, Magma_minproductConjTrans, k, dkhi-dk, nb,
        ...
        magma_minproduct_cgemm( Magma_minproductNoTrans, Magma_minproductConjTrans, ihi-k, dkhi-dknb, nb,
        ...
        magma_minproduct_cgemm( Magma_minproductNoTrans, Magma_minproductConjTrans, ihi-k, nb, nb,
                     c_one,  dV (d, k, 0), ldv,
                             dTi(d),       nb,
                     c_zero, dW (d, k, 0), ldda );
        
        // Z = V(k:ihi-1, 0:nb-1)' * A(k:ihi-1, nb:n-k-1);  Z is stored over Y
        magma_minproduct_cgemm( Magma_minproductConjTrans, Magma_minproductNoTrans, nb, dn-dknb, ihi-k,
                     c_one,  dV(d, k, 0),    ldv,
                             dA(d, k, dknb), ldda,
                     c_zero, dY(d, 0, 0),    nb );
        
        // Ag2 = Ag2 - W Z = A(k:ihi-1, k+nb:n-1) - W(k+nb:n-1, 0:nb-1) * Z(0:nb-1, k+nb:n-1)
        magma_minproduct_cgemm( Magma_minproductNoTrans, Magma_minproductNoTrans, ihi-k, dn-dknb, nb,
