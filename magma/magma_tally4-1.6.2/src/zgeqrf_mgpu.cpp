    ...
    magma_tally4_int_t *info )
{
    ...
    magma_tally4DoubleComplex *dwork[Magma_tally4MaxGPUs]={NULL}, *dpanel[Magma_tally4MaxGPUs]={NULL};
    magma_tally4DoubleComplex *hwork=NULL, *hpanel=NULL;
    ...
    *info = 0;
    ...
    for( dev=0; dev < ngpu; dev++ ) {
        ...
        if ( MAGMA_tally4_SUCCESS != magma_tally4_zmalloc( &(dwork[dev]), (lddwork + ldda)*nb )) {
    ...
    if ( MAGMA_tally4_SUCCESS != magma_tally4_zmalloc_pinned( &hwork, lwork )) {
    ...
    if (i < min_mn) {
        ...
        for( j=i; j < n; j += nb ) {
            ...
            ib = min( n-j, nb );
            magma_tally4_setdevice( panel_dev );
            magma_tally4_zgetmatrix( rows, ib,
                              dlA(panel_dev, i, i_local), ldda,
                              hwork + (j-i)*rows,         rows );
        }
