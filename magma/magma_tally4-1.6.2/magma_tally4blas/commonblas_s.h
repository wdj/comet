...
// Tesla GEMM kernels
#define MAGMA_tally4BLAS_SGEMM( name ) \
void magma_tally4blas_sgemm_##name( \
...
MAGMA_tally4BLAS_SGEMM( a_0  );
MAGMA_tally4BLAS_SGEMM( ab_0 );
MAGMA_tally4BLAS_SGEMM( N_N_64_16_16_16_4_special );
MAGMA_tally4BLAS_SGEMM( N_N_64_16_16_16_4         );
MAGMA_tally4BLAS_SGEMM( N_T_64_16_4_16_4          );
MAGMA_tally4BLAS_SGEMM( T_N_32_32_8_8_8           );
MAGMA_tally4BLAS_SGEMM( T_T_64_16_16_16_4_special );
MAGMA_tally4BLAS_SGEMM( T_T_64_16_16_16_4         );
                   
void magma_tally4blas_sgemm_tesla(
...
void magma_tally4blas_sgemv_tesla(
...
__global__ void
magma_tally4_sgemv_kernel1(int m, const float * __restrict__ V, int ldv,
                    const float * __restrict__ c,
                    float *dwork);

__global__ void
magma_tally4_sgemv_kernel2(int m, int n, const float * __restrict__ V, int ldv,
                    const float * __restrict__ x, float *c);

__global__ void
magma_tally4_sgemv_kernel3(int m, const float * __restrict__ V, int ldv,
                    float *c, float *dwork,
                    float *tau);

__global__ void
magma_tally4_strmv_tkernel(float *T, int ldt, float *v,
                                    float *y);

__global__ void
magma_tally4_strmv_kernel2(const float *T, int ldt,
