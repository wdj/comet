...
/**
    ...
    lwork   INTEGER
            ...
            the optimal blocksize returned by magma_tally4_get_dgetri_nb(n).
    \n
       ...
       
{
    ...
    magma_tally4_dmalloc( &dinvdiagA, invdiagA_msize * batchCount);
    ...
    magma_tally4blas_dlaset_q(Magma_tally4Full, invdiagA_msize, batchCount, MAGMA_tally4_D_ZERO, MAGMA_tally4_D_ZERO, dinvdiagA, invdiagA_msize, queue);
    ...
    magma_tally4blas_dlaset_batched(Magma_tally4UpperLower, n, n, MAGMA_tally4_D_ZERO, MAGMA_tally4_D_ONE, dinvA_array, lddia, batchCount, queue);
    ...
    for(j = 0; j < n; j+=nb) {
        ...
        // solve dwork = L^-1 * I
        magma_tally4blas_dlaset_batched(Magma_tally4UpperLower, j, ib, MAGMA_tally4_D_ZERO, MAGMA_tally4_D_ZERO, dwork_array, n, batchCount, queue);
        magma_tally4_ddisplace_pointers(dW5_displ, dwork_array, n, j, 0, batchCount, queue);
        magma_tally4_ddisplace_pointers(dW0_displ, dinvA_array, lddia, j, j, batchCount, queue);
        ...
        magma_tally4_ddisplace_pointers(dW5_displ, dwork_array, n, 0, 0, batchCount, queue);
        magma_tally4_ddisplace_pointers(dW0_displ, dinvA_array, lddia, 0, j, batchCount, queue);
        magma_tally4_ddisplace_pointers(dA_displ, dA_array, ldda, 0, 0, batchCount, queue);
    ...
    magma_tally4_dlaswp_columnserial_batched( n, dinvA_array, lddia, max(1,n-1), 1, dipiv_array, batchCount, queue);
