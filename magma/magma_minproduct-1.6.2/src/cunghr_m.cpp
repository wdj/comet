/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zunghr_m.cpp normal z -> c, Fri Jan 30 19:00:19 2015
    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nh > 0) {
        ...
        magma_minproduct_cungqr_m( nh, nh, nh,
                        A(ilo, ilo), lda,
