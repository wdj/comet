...
int main(  int argc, char** argv )
{
    ...
    real_Double_t res;
    magma_minproduct_c_matrix A={Magma_minproduct_CSR}, AT={Magma_minproduct_CSR}, A2={Magma_minproduct_CSR}, 
    ...
    while(  i < argc ) {
        ...
        for (int j=0; j<10; j++)
            CHECK( magma_minproduct_cmcsrcompressor( &A, queue ));
        ...
        CHECK( magma_minproduct_cmconvert( AT, &B, Magma_minproduct_CSR, Magma_minproduct_CSR, queue ));
        ...
        CHECK( magma_minproduct_cmconvert( B, &AT, Magma_minproduct_CSR, Magma_minproduct_CSR, queue ));
        magma_minproduct_cmfree(&B, queue );
