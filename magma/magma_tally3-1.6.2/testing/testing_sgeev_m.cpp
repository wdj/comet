...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally3_sgeev_m( opts.jobvl, opts.jobvr,
                           N, h_R, lda, w1, w1i,
                           VL, lda, VR, lda,
                           h_work, lwork, &info );
            ...
            if ( opts.check ) {
                ...
                magma_tally3_sgeev_m( Magma_tally3Vec, Magma_tally3Vec,
                               N, h_R, lda, w1, w1i,
                               VL, lda, VR, lda,
                               h_work, lwork, &info );
                ...
                for( int j = 0; j < N; ++j ) {
                    ...
                    result[2] = max( result[2], min( ulpinv, MAGMA_tally3_S_ABS(tnrm-1.)/ulp ));
                ...
                lapackf77_slacpy( Magma_tally3UpperLowerStr, &N, &N, h_A, &lda, h_R, &lda );
                magma_tally3_sgeev_m( Magma_tally3NoVec, Magma_tally3NoVec,
                               N, h_R, lda, w2, w2i,
                               &DUM, 1, &DUM, 1,
                               h_work, lwork, &info );
                ...
                lapackf77_slacpy( Magma_tally3UpperLowerStr, &N, &N, h_A, &lda, h_R, &lda );
                magma_tally3_sgeev_m( Magma_tally3NoVec, Magma_tally3Vec,
                               N, h_R, lda, w2, w2i,
                               &DUM, 1, LRE, lda,
                               h_work, lwork, &info );
                ...
                lapackf77_slacpy( Magma_tally3UpperLowerStr, &N, &N, h_A, &lda, h_R, &lda );
                magma_tally3_sgeev_m( Magma_tally3Vec, Magma_tally3NoVec,
                               N, h_R, lda, w2, w2i,
                               LRE, lda, &DUM, 1,
                               h_work, lwork, &info );
