...
/**
    ...
    ldwork  INTEGER
            ...
            LDWORK >= ldda*ceil(n/64) + 2*ldda*nb, where nb = magma_tally2_get_dsytrd_nb(n),
            and 64 is for the blocksize of magma_tally2blas_dsymv.
    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        magma_tally2_dsetmatrix( kk, kk, A(0, 0), lda, dA(0, 0), ldda );
    }
    else {
        ...
        magma_tally2_dsetmatrix( n-i, n-i, A(i, i), lda, dA(i, i), ldda );
    }
