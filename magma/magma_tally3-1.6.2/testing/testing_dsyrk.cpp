...
int main( int argc, char** argv)
{
    ...
    magma_tally3Double_ptr d_A, d_C;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            cublasDsyrk( opts.handle, cublas_uplo_const_tally3(opts.uplo), cublas_trans_const_tally3(opts.transA), N, K,
                         &alpha, d_A, ldda,
                         &beta,  d_C, lddc );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_dsyrk( lapack_uplo_const_tally3(opts.uplo), lapack_trans_const_tally3(opts.transA), &N, &K,
                               &alpha, h_A, &lda,
                               &beta,  h_C, &ldc );
            ...
            if ( opts.lapack ) {
                ...
                Cnorm = lapackf77_dlansy("fro", lapack_uplo_const_tally3(opts.uplo), &N, h_C, &ldc, work);

                blasf77_daxpy( &sizeC, &c_neg_one, h_C, &ione, h_Ccublas, &ione );
                cublas_error = lapackf77_dlansy( "fro", lapack_uplo_const_tally3(opts.uplo), &N, h_Ccublas, &ldc, work ) / Cnorm;
