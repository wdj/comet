...
*/
__global__ void
zsymmetrize_lower( int m, magma_tally4DoubleComplex *dA, int ldda )
{
...
__global__ void
zsymmetrize_upper( int m, magma_tally4DoubleComplex *dA, int ldda )
{
    // dA iterates across row i and dAT iterates down column i.
    int i = blockIdx.x*NB + threadIdx.x;
    magma_tally4DoubleComplex *dAT = dA;
...
/**
    @see magma_tally4blas_zsymmetrize_q
    @ingroup magma_tally4_zaux2
    ********************************************************************/
extern "C" void
magma_tally4blas_zsymmetrize(
    ...
    magma_tally4DoubleComplex_ptr dA, magma_tally4_int_t ldda )
{
    magma_tally4blas_zsymmetrize_q( uplo, m, dA, ldda, magma_tally4_stream );
}
