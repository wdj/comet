    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally4_zheevdx_m(ngpu, jobz, range, uplo, n, A, lda, vl, vu, il, iu, m, w, work, lwork, rwork, lrwork, iwork, liwork, info);
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally4_ztrsm_m(ngpu, Magma_tally4Left, uplo, trans, Magma_tally4NonUnit,
