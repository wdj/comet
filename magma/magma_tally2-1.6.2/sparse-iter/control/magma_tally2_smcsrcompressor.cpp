/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zmcsrcompressor.cpp normal z -> s, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
    ...
    magma_tally2_queue_t queue )
{
    ...
    if ( A->memory_location == Magma_tally2_CPU && A->storage_type == Magma_tally2_CSR ) {
        ...
        CHECK( magma_tally2_s_csr_compressor(&B.val, &B.row, &B.col,
        ...
        CHECK( magma_tally2_smconvert( hA, &CSRA, hA.storage_type, Magma_tally2_CSR, queue ));

        CHECK( magma_tally2_smcsrcompressor( &CSRA, queue ));

        magma_tally2_smfree( &hA, queue );
        magma_tally2_smfree( A, queue );
        CHECK( magma_tally2_smconvert( CSRA, &hA, Magma_tally2_CSR, A_storage, queue ));
