...
int main(int argc, char **argv)
{
    ...
    magma_minproductDoubleComplex *A, *X, *Y, *Yatomics, *Ycublas, *Ymagma_minproduct;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( Yatomics, magma_minproductDoubleComplex, sizeY );
            TESTING_MALLOC_CPU( Ycublas,  magma_minproductDoubleComplex, sizeY );
            ...
            magma_minproduct_zgetvector( N, dY, incy, Ycublas, incy );
            ...
            magma_minproduct_zgetvector( N, dY, incy, Yatomics, incy );
            ...
            if ( opts.version == 1 ) {
                magma_minproductblas_zhemv_work( opts.uplo, N, alpha, dA, ldda, dX, incx, beta, dY, incy, dwork, ldwork, opts.queue );
            }
            else {
                // non-work interface (has added overhead)
                magma_minproductblas_zhemv( opts.uplo, N, alpha, dA, ldda, dX, incx, beta, dY, incy );
            }
