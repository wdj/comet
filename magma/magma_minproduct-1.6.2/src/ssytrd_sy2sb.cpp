/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zhetrd_he2hb.cpp normal z -> s, Fri Jan 30 19:00:18 2015
    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    float *dA;
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_smalloc( &dA, (n + 2*nb)*ldda )) {
    ...
    if (upper) {
        ...
        if (1 <= n-nb) {
            ...
            magma_minproduct_ssetmatrix_async( (n-nb), (n-nb),
                                    A(nb+1, nb+1),  lda,
        ...
        for (i = 1; i <= n-nb; i += nb) {
             ...
             if (i > 1 ) {
                 ...
                 magma_minproduct_ssyr2k(Magma_minproductLower, Magma_minproductNoTrans, pm_old-pn_old, pn_old, c_neg_one,
