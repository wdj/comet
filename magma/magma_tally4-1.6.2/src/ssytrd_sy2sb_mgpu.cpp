    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    float *dspace[Magma_tally4MaxGPUs];
    float *dwork[Magma_tally4MaxGPUs], *dworkbis[Magma_tally4MaxGPUs];
    float *dvall[Magma_tally4MaxGPUs], *dv[Magma_tally4MaxGPUs], *dw[Magma_tally4MaxGPUs];
    float *workngpu[Magma_tally4MaxGPUs+1];
    ...
    for( magma_tally4_int_t dev = 0; dev < ngpu; ++dev ) {
        ...
        magma_tally4_smalloc( &dspace[dev], devworksiz );
        magma_tally4_smalloc_pinned ( &workngpu[dev], worksiz);
    ...
    magma_tally4_smalloc_pinned ( &workngpu[ngpu], worksiz);
    float *worktest = NULL;
    //magma_tally4_smalloc_cpu( &worktest, n*nb ); // not used
    // ======================
