    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally2_dsyevdx_2stage(jobz, range, uplo, n, A, lda, vl, vu, il, iu, m, w, work, lwork, iwork, liwork, info);
    ...
    if (wantz && *info == 0) {
        ...
        magma_tally2_dsetmatrix( n, *m, A, lda, dA, ldda );
        magma_tally2_dsetmatrix( n,  n, B, ldb, dB, lddb );
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally2_dtrsm(Magma_tally2Left, uplo, trans, Magma_tally2NonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally2_dtrmm(Magma_tally2Left, uplo, trans, Magma_tally2NonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }

        magma_tally2_dgetmatrix( n, *m, dA, ldda, A, lda );
