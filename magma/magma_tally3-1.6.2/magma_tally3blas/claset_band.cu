    ...
    magma_tally3FloatComplex *A, int lda)
{
    ...
    magma_tally3FloatComplex value = offdiag;
    if (threadIdx.x == k-1)
        value = diag;
...
/**
    @see magma_tally3blas_claset_band_q
    @ingroup magma_tally3_caux2
    ********************************************************************/
extern "C" void
magma_tally3blas_claset_band(
    ...
    magma_tally3FloatComplex_ptr dA, magma_tally3_int_t ldda)
{
    magma_tally3blas_claset_band_q(uplo, m, n, k, offdiag, diag, dA, ldda, magma_tally3_stream);
}
