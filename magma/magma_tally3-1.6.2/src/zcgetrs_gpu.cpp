...
/**
    ...
    by MAGMA_tally3_CGETRF_GPU. B and X are in COMPLEX_16, and A is in COMPLEX.
    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (notran) {
         ...
         */
        //magma_tally3blas_zclaswp(nrhs, dB, lddb, dSX, lddbx, 1, n, dipiv);
        magma_tally3blas_zclaswp(nrhs, dB, lddb, dSX, n, dipiv, inc);
        ...
        magma_tally3_ctrsm( Magma_tally3Left, Magma_tally3Upper, Magma_tally3NoTrans, Magma_tally3NonUnit,
                     n, nrhs, c_one, dA, ldda, dSX, n);
        
        magma_tally3blas_clag2z( n, nrhs, dSX, n, dX, lddx, info );
    }
    else {
        inc = -1;
        
        /* Cast the COMPLEX_16 RHS to COMPLEX */
        magma_tally3blas_zlag2c( n, nrhs, dB, lddb, dSX, n, info );
        
        /* Solve A**T * X = B, or A**H * X = B */
        magma_tally3_ctrsm( Magma_tally3Left, Magma_tally3Upper, trans, Magma_tally3NonUnit,
                     n, nrhs, c_one, dA, ldda, dSX, n );
        magma_tally3_ctrsm( Magma_tally3Left, Magma_tally3Lower, trans, Magma_tally3Unit,
                     n, nrhs, c_one, dA, ldda, dSX, n );
        
        magma_tally3blas_zclaswp( nrhs, dX, lddx, dSX, n, dipiv, inc );
    }

    return *info;
} /* magma_tally3_zcgetrs */
