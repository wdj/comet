...
cswapdblk_kernel( int nb,
                  magma_tally3FloatComplex *dA, int ldda, int inca,
                  magma_tally3FloatComplex *dB, int lddb, int incb )
{
...
/**
    @see magma_tally3blas_cswapdblk_q
    @ingroup magma_tally3_caux2
    ********************************************************************/
extern "C" void 
magma_tally3blas_cswapdblk(
    ...
    magma_tally3FloatComplex_ptr dB, magma_tally3_int_t lddb, magma_tally3_int_t incb )
{
    magma_tally3blas_cswapdblk_q( n, nb, dA, ldda, inca, dB, lddb, incb, magma_tally3_stream );
}
