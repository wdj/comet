/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zcsrsplit.cpp normal z -> s, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
    ...
    magma_tally2_queue_t queue )
{
    ...
    if (  A.memory_location == Magma_tally2_CPU &&
        ...
        magma_tally2_s_matrix Ah={Magma_tally2_CSR}, ACSR={Magma_tally2_CSR}, DCSR={Magma_tally2_CSR}, RCSR={Magma_tally2_CSR}, Dh={Magma_tally2_CSR}, Rh={Magma_tally2_CSR};
        CHECK( magma_tally2_smtransfer( A, &Ah, A.memory_location, Magma_tally2_CPU, queue ));
        CHECK( magma_tally2_smconvert( Ah, &ACSR, A.storage_type, Magma_tally2_CSR, queue ));

        CHECK( magma_tally2_scsrsplit( bsize, ACSR, &DCSR, &RCSR, queue ));

        CHECK( magma_tally2_smconvert( DCSR, &Dh, Magma_tally2_CSR, A.storage_type, queue ));
        CHECK( magma_tally2_smconvert( RCSR, &Rh, Magma_tally2_CSR, A.storage_type, queue ));

        CHECK( magma_tally2_smtransfer( Dh, D, Magma_tally2_CPU, A.memory_location, queue ));
        CHECK( magma_tally2_smtransfer( Rh, R, Magma_tally2_CPU, A.memory_location, queue ));

        magma_tally2_smfree( &Ah, queue );
        magma_tally2_smfree( &ACSR, queue );
        magma_tally2_smfree( &Dh, queue );
        magma_tally2_smfree( &DCSR, queue );
        magma_tally2_smfree( &Rh, queue );
        magma_tally2_smfree( &RCSR, queue );
    }
cleanup:
    if( info != 0 ){
