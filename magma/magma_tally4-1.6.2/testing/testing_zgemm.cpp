...
int main( int argc, char** argv)
{
    ...
    double          magma_tally4_error, dev_error, Cnorm, work[1];
    ...
    magma_tally4DoubleComplex *h_A, *h_B, *h_C, *h_Cmagma_tally4, *h_Cdev;
    magma_tally4DoubleComplex_ptr d_A, d_B, d_C;
    magma_tally4DoubleComplex c_neg_one = MAGMA_tally4_Z_NEG_ONE;
    magma_tally4DoubleComplex alpha = MAGMA_tally4_Z_MAKE(  0.29, -0.86 );
    magma_tally4DoubleComplex beta  = MAGMA_tally4_Z_MAKE( -0.48,  0.38 );
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_A,       magma_tally4DoubleComplex, lda*An );
            TESTING_MALLOC_CPU( h_B,       magma_tally4DoubleComplex, ldb*Bn );
            TESTING_MALLOC_CPU( h_C,       magma_tally4DoubleComplex, ldc*N  );
            TESTING_MALLOC_CPU( h_Cmagma_tally4,  magma_tally4DoubleComplex, ldc*N  );
            TESTING_MALLOC_CPU( h_Cdev,    magma_tally4DoubleComplex, ldc*N  );
            
            TESTING_MALLOC_DEV( d_A, magma_tally4DoubleComplex, ldda*An );
            TESTING_MALLOC_DEV( d_B, magma_tally4DoubleComplex, lddb*Bn );
            TESTING_MALLOC_DEV( d_C, magma_tally4DoubleComplex, lddc*N  );
            ...
            magma_tally4_zsetmatrix( Am, An, h_A, lda, d_A, ldda );
            magma_tally4_zsetmatrix( Bm, Bn, h_B, ldb, d_B, lddb );
            
            /* =====================================================================
               Performs operation using MAGMA_tally4BLAS (currently only with CUDA)
               =================================================================== */
            #ifdef HAVE_CUBLAS
                magma_tally4_zsetmatrix( M, N, h_C, ldc, d_C, lddc );
                
                magma_tally4_time = magma_tally4_sync_wtime( NULL );
                magma_tally4blas_zgemm( opts.transA, opts.transB, M, N, K,
                                 alpha, d_A, ldda,
                                        d_B, lddb,
                                 beta,  d_C, lddc );
                ...
                magma_tally4_zgetmatrix( M, N, d_C, lddc, h_Cmagma_tally4, ldc );
            #endif
            ...
            magma_tally4_zsetmatrix( M, N, h_C, ldc, d_C, lddc );
                ...
                cublasZgemm( opts.handle, cublas_trans_const_tally4(opts.transA), cublas_trans_const_tally4(opts.transB), M, N, K,
                             &alpha, d_A, ldda,
                                     d_B, lddb,
                             &beta,  d_C, lddc );
                ...
                magma_tally4_zgemm( opts.transA, opts.transB, M, N, K,
                             alpha, d_A, 0, ldda,
                                    d_B, 0, lddb,
            ...
            magma_tally4_zgetmatrix( M, N, d_C, lddc, h_Cdev, ldc );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_zgemm( lapack_trans_const_tally4(opts.transA), lapack_trans_const_tally4(opts.transB), &M, &N, &K,
                               &alpha, h_A, &lda,
                                       h_B, &ldb,
                               &beta,  h_C, &ldc );
            ...
            if ( opts.lapack ) {
                ...
                dev_error = lapackf77_zlange( "F", &M, &N, h_Cdev, &ldc, work ) / Cnorm;
                ...
                #ifdef HAVE_CUBLAS
                    blasf77_zaxpy( &sizeC, &c_neg_one, h_C, &ione, h_Cmagma_tally4, &ione );
                    magma_tally4_error = lapackf77_zlange( "F", &M, &N, h_Cmagma_tally4, &ldc, work ) / Cnorm;
                    ...
                    blasf77_zaxpy( &sizeC, &c_neg_one, h_Cdev, &ione, h_Cmagma_tally4, &ione );
                    magma_tally4_error = lapackf77_zlange( "F", &M, &N, h_Cmagma_tally4, &ldc, work ) / Cnorm;
