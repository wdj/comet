...
//  #define cublasZgemm magma_tally3blas_zgemm
#endif
// === End defining what BLAS to use =======================================

extern "C" magma_tally3_int_t
magma_tally3_zlarfb_gpu( char side, char trans, char direct, char storev,
          magma_tally3_int_t m, magma_tally3_int_t n, magma_tally3_int_t k,
          cuDoubleComplex *dV,    magma_tally3_int_t ldv, 
          cuDoubleComplex *dT,    magma_tally3_int_t ldt,
          cuDoubleComplex *dC,    magma_tally3_int_t ldc, 
...
/*  -- MAGMA_tally3 (version 1.6.1) --
    ...
    cuDoubleComplex c_zero    = MAGMA_tally3_Z_ZERO;
    ...
    if ( storev == 'c' || storev == 'C') {
        /*
          ...
          magma_tally3blas_zgemvt(m, k, 1., dv_ref(0,0), ldv, dc_ref(0, 0), dwork);
          printf("m= %d, n = %d, ldwork = %d\n", m, k, ldwork);
          }
          else
        */
        cublasZgemm( Magma_tally3ConjTrans, Magma_tally3NoTrans,
                     n, k, m,
                     c_one,  dC,    ldc,
                             dV,    ldv,
                     c_zero, dwork, ldwork);
        ...
        if (direct == 'F' || direct =='f')
            cublasZtrmm( Magma_tally3Right, Magma_tally3Upper, transt, Magma_tally3NonUnit,
                         n, k, 
                         c_one, dT,    ldt, 
                                dwork, ldwork);
        else
            cublasZtrmm( Magma_tally3Right, Magma_tally3Lower, transt, Magma_tally3NonUnit,
                         n, k, 
                         c_one, dT,    ldt, 
                                dwork, ldwork);

        cublasZgemm( Magma_tally3NoTrans, Magma_tally3ConjTrans, 
                     m, n, k, 
                     c_neg_one, dV,    ldv,
                                dwork, ldwork, 
                     c_one,     dC,    ldc);
        ...
        cublasZgemm( Magma_tally3NoTrans, Magma_tally3NoTrans, 
                     m, n, k, 
