...
/**
    ...
    @ingroup magma_minproduct_zhesv_driver
    ********************************************************************/
...
magma_minproduct_zhesv_nopiv_gpu(magma_minproduct_uplo_t uplo,  magma_minproduct_int_t n, magma_minproduct_int_t nrhs, 
                 ...
                 magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    ret = magma_minproduct_zhetrf_nopiv_gpu(uplo, n, dA, ldda, info);
    if ( (ret != MAGMA_minproduct_SUCCESS) || (*info != 0) ) {
        return ret;
    }
        
    ret = magma_minproduct_zhetrs_nopiv_gpu( uplo, n, nrhs, dA, ldda, dB, lddb, info );
    if ( (ret != MAGMA_minproduct_SUCCESS) || (*info != 0) ) {
        return ret;
    }
