...
__global__ void
zlascl2_full(int m, int n, const double* D, magma_tally4DoubleComplex* A, int lda)
{
...
__global__ void
zlascl2_lower(int m, int n, const double* D, magma_tally4DoubleComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
__global__ void
zlascl2_upper(int m, int n, const double *D, magma_tally4DoubleComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
magma_tally4blas_zlascl2(
    magma_tally4_type_t type, magma_tally4_int_t m, magma_tally4_int_t n,
    magma_tally4Double_const_ptr dD,
    magma_tally4DoubleComplex_ptr dA, magma_tally4_int_t ldda, magma_tally4_int_t *info )
{
    magma_tally4blas_zlascl2_q( type, m, n, dD, dA, ldda, magma_tally4_stream, info );
}
