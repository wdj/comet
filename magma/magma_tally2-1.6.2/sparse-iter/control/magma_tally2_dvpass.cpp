/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zvpass.cpp normal z -> d, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
...
magma_tally2_dvget(
    ...
    magma_tally2_queue_t queue )
{
    magma_tally2_d_matrix v_CPU={Magma_tally2_CSR};
    ...
    if ( v.memory_location == Magma_tally2_CPU ) {
        ...
        *val = v.val;
        ...
        CHECK( magma_tally2_dmtransfer( v, &v_CPU, v.memory_location, Magma_tally2_CPU, queue ));
        CHECK( magma_tally2_dvget( v_CPU, m, n, val, queue ));
    }
    
cleanup:
    magma_tally2_dmfree( &v_CPU, queue );
    return info;
}
