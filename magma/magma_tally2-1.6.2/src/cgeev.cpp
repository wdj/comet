    ...
    magma_tally2_int_t *info )
{
    ...
    magma_tally2_int_t scalea, minwrk, optwrk, irwork, lquery, wantvl, wantvr, select[1];
    ...
    *info = 0;
    ...
    if (*info == 0) {
        minwrk = (1+  nb)*n;
        optwrk = (1+2*nb)*n;
        work[0] = MAGMA_tally2_C_MAKE( optwrk, 0 );
...
CLEANUP:
    ...
    work[0] = MAGMA_tally2_C_MAKE( (float) optwrk, 0. );
