/*
    -- MAGMA_tally2 (version 1.6.1) --
       ...
       @generated from zheevd_m.cpp normal z -> c, Fri Jan 30 19:00:17 2015
    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally2_chetrd_mgpu(ngpu, 1, uplo, n, A, lda, w, &rwork[inde],
    ...
    if (! wantz) {
...
#else
        magma_tally2_cstedx_m(ngpu, Magma_tally2RangeAll, n, 0, 0, 0, 0, w, &rwork[inde],
                       &work[indwrk], n, &rwork[indrwk],
        ...
        magma_tally2_cunmtr_m(ngpu, Magma_tally2Left, uplo, Magma_tally2NoTrans, n, n, A, lda, &work[indtau],
