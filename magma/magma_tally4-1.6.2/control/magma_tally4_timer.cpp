...
#if defined(ADD_)
#  define magma_tally4_wtime_f        magma_tally4_wtime_f_
...
*/
extern "C"
double magma_tally4_wtime( void )
{
    struct timeval t;
    gettimeofday( &t, NULL );
...
extern "C"
double magma_tally4_sync_wtime( magma_tally4_queue_t queue )
{
    magma_tally4_queue_sync( queue );
    return magma_tally4_wtime();
}

// version callable from Fortran stores seconds in time.
extern "C"
void magma_tally4_wtime_f(double *time)
{
