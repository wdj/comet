/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from testing_zgeqp3.cpp normal z -> d, Fri Jan 30 19:00:25 2015
...
int main( int argc, char** argv)
{
    ...
    magma_minproduct_int_t M, N, n2, lda, lwork, j, info, min_mn, nb;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            #if defined(PRECISION_z) || defined(PRECISION_c)
            magma_minproduct_dgeqp3(M, N, h_R, lda, jpvt, tau, h_work, lwork, rwork, &info);
            #else
            magma_minproduct_dgeqp3(M, N, h_R, lda, jpvt, tau, h_work, lwork, &info);
            #endif
