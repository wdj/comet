...
/**
    ...
    ldwork  INTEGER
            ...
            LDWORK >= ldda*ceil(n/64) + 2*ldda*nb, where nb = magma_minproduct_get_zhetrd_nb(n),
            and 64 is for the blocksize of magma_minproductblas_zhemv.
    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        magma_minproduct_zsetmatrix( kk, kk, A(0, 0), lda, dA(0, 0), ldda );
    }
    else {
        ...
        magma_minproduct_zsetmatrix( n-i, n-i, A(i, i), lda, dA(i, i), ldda );
    }
