/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zhegvdx_m.cpp normal z -> c, Fri Jan 30 19:00:18 2015
    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_minproduct_cheevdx_m(ngpu, jobz, range, uplo, n, A, lda, vl, vu, il, iu, m, w, work, lwork, rwork, lrwork, iwork, liwork, info);
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_minproduct_ctrsm_m(ngpu, Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit,
