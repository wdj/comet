...
int main( int argc, char** argv )
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally3_ssetmatrix( m, n, SA, lda, dSA, ldda );
            ...
            /* ====================================================================
               Performs operation using MAGMA_tally3 dlag2s
               =================================================================== */            
            gpu_time = magma_tally3_sync_wtime(0);
            magma_tally3blas_dlag2s( m, n, dA, ldda, dSA, ldda, &info );
            gpu_time = magma_tally3_sync_wtime(0) - gpu_time;
            gpu_perf = gbytes / gpu_time;
            if (info != 0)
                printf("magma_tally3blas_dlag2s returned error %d: %s.\n",
                       (int) info, magma_tally3_strerror( info ));
            
            magma_tally3_sgetmatrix( m, n, dSA, ldda, SR, lda );
            ...
            /* ====================================================================
               Performs operation using MAGMA_tally3 slag2d
               =================================================================== */
            magma_tally3_ssetmatrix( m, n, SA, lda, dSA, ldda );
            
            gpu_time = magma_tally3_sync_wtime(0);
            magma_tally3blas_slag2d( m, n, dSA, ldda, dA, ldda, &info );
            gpu_time = magma_tally3_sync_wtime(0) - gpu_time;
            gpu_perf = gbytes / gpu_time;
            if (info != 0)
                printf("magma_tally3blas_slag2d returned error %d: %s.\n",
                       (int) info, magma_tally3_strerror( info ));
            
            magma_tally3_dgetmatrix( m, n, dA, ldda, R, lda );
