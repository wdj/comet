...
/**
    Purpose
    -------
    magma_tally4blas_chemv_work performs the matrix-vector operation:
    ...
    MAGMA_tally4 implements chemv through two steps:
    ...
    magma_tally4blas_chemv is a wrapper routine allocating the workspace inside the
    routine and provides the same interface as cublas.
    
    If users need to call chemv frequently, we suggest using
    magma_tally4blas_chemv_work instead of magma_tally4blas_chemv. As the overhead to
    allocate and free in device memory in magma_tally4blas_chemv would hurt performance.
    ...
    magma_tally4_queue_t queue )
{
    ...
    if ( arch < 200 ) {
        magma_tally4_chemv( uplo, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
...
// end magma_tally4blas_chemv_work


/**
    Purpose
    -------
    magma_tally4blas_chemv performs the matrix-vector operation:
    ...
    magma_tally4FloatComplex_ptr dy, magma_tally4_int_t incy)
{
    ...
    magma_tally4blas_chemv_work( uplo, n, alpha, dA, ldda, dx, incx, beta, dy, incy,
