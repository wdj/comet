/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from zunmql.cpp normal z -> c, Fri Jan 30 19:00:16 2015
...
/**
    ...
    as returned by CGEQLF. Q is of order M if SIDE = Magma_tally4Left and of order N
    ...
    @ingroup magma_tally4_cgeqlf_comp
    ********************************************************************/
    ...
    magma_tally4_int_t *info)
{
    ...
    *info  = 0;
    ...
    if (*info == 0) {
        nb = magma_tally4_get_cgelqf_nb( min( m, n ));
        lwkopt = max(1,nw)*nb;
    ...
    if ( nb >= k ) {
        /* Use CPU code */
        lapackf77_cunmql( lapack_side_const_tally4(side), lapack_trans_const_tally4(trans),
        ...
        magma_tally4FloatComplex *dwork, *dV, *dT, *dC;
        magma_tally4_cmalloc( &dwork, (nw + nq + nb)*nb + lddc*n );
        if ( dwork == NULL ) {
        ...
        magma_tally4_cmalloc_pinned( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_tally4_csetmatrix( m, n, C, ldc, dC, lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set lower triangle of panel in A to identity,
               ...
               3) restore A                                      */
            cpanel_to_q_tally4( Magma_tally4Lower, ib, A(nq_i-ib,i), lda, T2 );
            magma_tally4_csetmatrix( nq_i,  ib, A(0,      i), lda, dV, nq_i );
            cq_to_panel_tally4( Magma_tally4Lower, ib, A(nq_i-ib,i), lda, T2 );
            ...
            magma_tally4_csetmatrix( ib, ib, T, ib, dT, ib );
            magma_tally4_clarfb_gpu( side, trans, Magma_tally4Backward, Magma_tally4Columnwise,
                              mi, ni, ib,
                              dV, nq_i,
                              dT, ib,
                              dC, lddc,
        ...
        magma_tally4_cgetmatrix( m, n, dC, lddc, C, ldc );
