...
/**
    @see magma_tally3blas_dtranspose_q
    @ingroup magma_tally3_daux2
    ********************************************************************/
extern "C" void
magma_tally3blas_dtranspose(
    ...
    magma_tally3Double_ptr       dAT, magma_tally3_int_t lddat )
{
    magma_tally3blas_dtranspose_q( m, n, dA, ldda, dAT, lddat, magma_tally3_stream );
}
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_tally3blas_dtranspose_batched_q(
    magma_tally3_int_t m, magma_tally3_int_t n,
    double **dA_array,  magma_tally3_int_t ldda,
    double **dAT_array, magma_tally3_int_t lddat, magma_tally3_int_t batchCount, magma_tally3_queue_t queue )
{
    magma_tally3_int_t info = 0;
    if ( m < 0 )
        info = -1;
...
/**
    @see magma_tally3blas_dtranspose_batched_q
    @ingroup magma_tally3_daux2
    ********************************************************************/
extern "C" void
...
{
    magma_tally3blas_dtranspose_batched_q( m, n, dA_array, ldda, dAT_array, lddat, batchCount, magma_tally3_stream );
}
