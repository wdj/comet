    ...
    magma_tally2DoubleComplex *A, int lda)
{
    ...
    magma_tally2DoubleComplex value = offdiag;
    if (threadIdx.x == k-1)
        value = diag;
...
/**
    @see magma_tally2blas_zlaset_band_q
    @ingroup magma_tally2_zaux2
    ********************************************************************/
extern "C" void
magma_tally2blas_zlaset_band(
    ...
    magma_tally2DoubleComplex_ptr dA, magma_tally2_int_t ldda)
{
    magma_tally2blas_zlaset_band_q(uplo, m, n, k, offdiag, diag, dA, ldda, magma_tally2_stream);
}
