...
class magma_tally2_slaqtrsd_task: public magma_tally2_task
{
public:
    magma_tally2_slaqtrsd_task(
        magma_tally2_trans_t in_trans, magma_tally2_int_t in_n,
        const float *in_T, magma_tally2_int_t in_ldt,
        float       *in_x, magma_tally2_int_t in_incx,
    ...
    virtual void run()
    {
        ...
        magma_tally2_slaqtrsd( trans, n, T, ldt, x, incx, cnorm, &info );
        if ( info != 0 ) {
...
class sgemm_task: public magma_tally2_task
{
public:
    sgemm_task(
        ...
        float  in_alpha,
        const float *in_A, magma_tally2_int_t in_lda,
        const float *in_B, magma_tally2_int_t in_ldb,
        float  in_beta,
        float *in_C, magma_tally2_int_t in_ldc
    ):
        transA( in_transA ),
        transB( in_transB ),
        m     ( in_m      ),
    ...
    virtual void run()
    {
        blasf77_sgemm( lapack_trans_const_tally2(transA), lapack_trans_const_tally2(transB),
...
/**
    ...
    @ingroup magma_tally2_sgeev_comp
    ********************************************************************/
extern "C"
magma_tally2_int_t magma_tally2_strevc3_mt(
    ...
    if ( rightv ) {
        ...
        for( ki=n-1; ki >= 0; --ki ) {
            ...
            if ( ip == 0 ) {
                ...
                queue.push_task( new magma_tally2_slaqtrsd_task(
