...
/**
    ...
    @param[in]
    new_values  magma_tally3DoubleComplex**
...
z_transpose_csr(
    ...
    magma_tally3DoubleComplex **new_values,
    ...
    magma_tally3_queue_t queue )
{
    ...
    magma_tally3DoubleComplex *csc_values=NULL;
    ...
    CHECK( magma_tally3_zmalloc_cpu( &csc_values, nnz ) );
    ...
    magma_tally3_queue_t queue )
{
    ...
    magma_tally3_z_matrix ACSR={Magma_tally3_CSR}, BCSR={Magma_tally3_CSR};
    ...
    if( A.storage_type == Magma_tally3_CSR && A.memory_location == Magma_tally3_DEV ) {
        ...
        CHECK( magma_tally3_zmtransfer( A, &A_d, A.memory_location, Magma_tally3_DEV, queue ));
        CHECK( magma_tally3_z_cucsrtranspose( A_d, &B_d, queue ));
        CHECK( magma_tally3_zmtransfer( B_d, B, Magma_tally3_DEV, A.memory_location, queue ));
                
    }else {
        CHECK( magma_tally3_zmconvert( A, &ACSR, A.storage_type, Magma_tally3_CSR, queue ));
        CHECK( magma_tally3_z_cucsrtranspose( ACSR, &BCSR, queue ));
        CHECK( magma_tally3_zmconvert( BCSR, B, Magma_tally3_CSR, A.storage_type, queue ));
    }
cleanup:
    ...
    magma_tally3_zmfree( &BCSR, queue );
    if( info != 0 ){
