...
int main( int argc, char** argv)
{
    ...
    magma_minproduct_int_t N, n2, lda, info;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* ====================================================================
               ...
               =================================================================== */
            if ( opts.warmup ) {
                magma_minproduct_cpotrf( opts.uplo, N, h_R, lda, &info );
                magma_minproduct_cpotri( opts.uplo, N, h_R, lda, &info );
                lapackf77_clacpy( Magma_minproductUpperLowerStr, &N, &N, h_A, &lda, h_R, &lda );
            }
            ...
            if (info != 0)
                printf("magma_minproduct_cpotri returned error %d: %s.\n",
