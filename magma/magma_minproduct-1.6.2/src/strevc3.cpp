/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from dtrevc3.cpp normal d -> s, Fri Jan 30 19:00:19 2015
*/
...
/**
    ...
    ********************************************************************/
extern "C"
magma_minproduct_int_t magma_minproduct_strevc3(
    ...
    if ( rightv ) {
        ...
        for( ki=n-1; ki >= 0; --ki ) {
            ...
            if ( ip == 0 ) {
                ...
                magma_minproduct_slaqtrsd( Magma_minproductNoTrans, ki+1, T(0,0), ldt,
    ...
    if ( leftv ) {
        ...
        for( ki=0; ki < n; ++ki ) {
            ...
            if ( ip == 0 ) {
                ...
                magma_minproduct_slaqtrsd( Magma_minproductTrans, n-ki, T(ki,ki), ldt,
