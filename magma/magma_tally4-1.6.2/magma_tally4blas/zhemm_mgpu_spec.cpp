...
extern "C"
void magma_tally4blas_zhemm_mgpu_spec(
    ...
    magma_tally4_int_t gnode[Magma_tally4MaxGPUs][Magma_tally4MaxGPUs+2], magma_tally4_int_t nbcmplx )
{
    ...
    if(ngpu ==1){
        ...
        magma_tally4_zgemm( Magma_tally4ConjTrans, Magma_tally4NoTrans, m, n, m,
    ...
    for( magma_tally4_int_t cmplxid = 0; cmplxid < nbcmplx; ++cmplxid ) {
        ...
        for( magma_tally4_int_t idev = 0; idev < myngpu; ++idev ) {
            ...
            if(mycolsize>0){
                ...
                magma_tally4_zgemm( Magma_tally4ConjTrans, Magma_tally4NoTrans, mycolsize, n, m,
            ...
            if(mycolsize>0){ // I am an active GPU
                ...
                if(gcolsize>0){
                    ...
                    for( magma_tally4_int_t blki = 0; blki < gblk; ++blki){
                        ...
                        magma_tally4blas_zlacpy( Magma_tally4Full, ib, n, &dwork[dev][maxgsize*gdev+lcblki], gcolsize, &dC[dev][gbblki], lddc);
                    }// end blki
                }
