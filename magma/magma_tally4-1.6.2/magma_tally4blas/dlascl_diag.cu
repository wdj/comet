...
__global__ void
dlascl_diag_lower(int m, int n, magma_tally4Double_const_ptr D, int ldd, 
                                      magma_tally4Double_ptr A, int lda)
{
...
__global__ void
dlascl_diag_upper(int m, int n, magma_tally4Double_const_ptr D, int ldd, 
                                      magma_tally4Double_ptr A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_tally4blas_dlascl_diag_q(
...
{
    magma_tally4blas_dlascl_diag_q( type, m, n, dD, lddd, dA, ldda, info, magma_tally4_stream );
}
