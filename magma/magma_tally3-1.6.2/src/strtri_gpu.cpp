/*
    -- MAGMA_tally3 (version 1.6.1) --
       ...
       @generated from ztrtri_gpu.cpp normal z -> s, Fri Jan 30 19:00:13 2015
...
#define dA(i, j) (dA+(j)*ldda + (i))
    ...
    *info = 0;
    ...
    if (nounit) {
        for (j=0; j < n; ++j) {
            if ( MAGMA_tally3_S_EQUAL( *dA(j,j), c_zero )) {
    ...
    if (nb <= 1 || nb >= n) {
        ...
        if (upper) {
            ...
            for (j=0; j < n; j += nb) {
                ...
                magma_tally3_strmm( Magma_tally3Left, Magma_tally3Upper,
                             Magma_tally3NoTrans, Magma_tally3NonUnit, j, jb,
                             c_one, dA(0,0), ldda, dA(0, j), ldda );

                magma_tally3_strsm( Magma_tally3Right, Magma_tally3Upper,
                             Magma_tally3NoTrans, Magma_tally3NonUnit, j, jb,
                ...
                lapackf77_strtri( Magma_tally3UpperStr, diag_, &jb, work, &jb, info );
            ...
            for (j=nn-1; j >= 0; j -= nb) {
                ...
                /* Compute inverse of current diagonal block */
                lapackf77_strtri( Magma_tally3LowerStr, diag_, &jb, work, &jb, info );
