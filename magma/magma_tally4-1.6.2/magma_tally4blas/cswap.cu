...
__global__ void cswap_kernel(
    int n,
    magma_tally4FloatComplex *x, int incx,
    magma_tally4FloatComplex *y, int incy )
{
...
magma_tally4blas_cswap(
    ...
    magma_tally4FloatComplex_ptr dy, magma_tally4_int_t incy)
{
    magma_tally4blas_cswap_q( n, dx, incx, dy, incy, magma_tally4_stream );
}
