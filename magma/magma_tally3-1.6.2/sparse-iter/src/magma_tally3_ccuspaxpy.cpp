/*
    -- MAGMA_tally3 (version 1.6.2) --
       ...
       @generated from magma_tally3_zcuspaxpy.cpp normal z -> c, Sun May  3 11:22:59 2015
       @author Hartwig Anzt
...
magma_tally3_ccuspaxpy(
    magma_tally3FloatComplex *alpha, magma_tally3_c_matrix A,
    magma_tally3FloatComplex *beta, magma_tally3_c_matrix B,
    ...
    magma_tally3_queue_t queue )
{
    ...
    if (    A.memory_location == Magma_tally3_DEV
        ...
        CHECK( magma_tally3_cmalloc( &C.dval, C.nnz ));
        ...
        CHECK( magma_tally3_cmtransfer( C, AB, Magma_tally3_DEV, Magma_tally3_DEV, queue ));
    }
    else {
