/*
    -- MAGMA_tally3 (version 1.6.1) --
       ...
       @generated from zgeqr2x_gpu.cpp normal z -> s, Fri Jan 30 19:00:14 2015
    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    for (i = 0; i < k; ++i) {
        ...
        magma_tally3_slarfgx_gpu(m-i, dA(i, i), dA(min(i+1,m), i), dtau+i, dnorm+i,
                          ddA + i + i*n, i);
        
        if (i < n) {
            /* Apply H(i)' to A(i:m,i+1:n) from the left */
            magma_tally3_slarfx_gpu(m-i, n-i-1, dA(i, i), dtau+i,
