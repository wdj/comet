/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zgels_gpu.cpp normal z -> c, Fri Jan 30 19:00:15 2015
...
/**
    ...
    @ingroup magma_minproduct_cgels_driver
    ********************************************************************/
    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    k = min(m,n);
    if (k == 0) {
        hwork[0] = MAGMA_minproduct_C_ONE;
        return *info;
    }
    ...
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_cmalloc( &dT, ldtwork )) {
        *info = MAGMA_minproduct_ERR_DEVICE_ALLOC;
        return *info;
    }
    
    magma_minproduct_cmalloc_cpu( &tau, k );
    if ( tau == NULL ) {
    ...
    if ( *info == 0 ) {
        magma_minproduct_cgeqrs_gpu( m, n, nrhs,
                          dA, ldda, tau, dT,
