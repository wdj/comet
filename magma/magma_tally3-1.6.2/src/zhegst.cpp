...
#define dB(i, j) (dw + n*ldda + (j)*lddb + (i))
    ...
    *info = 0;
    ...
    if (MAGMA_tally3_SUCCESS != magma_tally3_zmalloc( &dw, 2*n*n )) {
        *info = MAGMA_tally3_ERR_DEVICE_ALLOC;
        return *info;
    }
    
    nb = magma_tally3_get_zhegst_nb(n);
    ...
    magma_tally3_zsetmatrix( n, n, B(0, 0), ldb, dB(0, 0), lddb );
    ...
    if (itype == 1) {
        if (upper) {
            ...
            for (k = 0; k < n; k += nb) {
                ...
                if (k+kb < n) {
                    ...
                    magma_tally3_zhemm(Magma_tally3Left, Magma_tally3Upper,
                                kb, n-k-kb,
                                c_neg_half, dA(k,k), ldda,
                                dB(k,k+kb), lddb,
                                c_one, dA(k, k+kb), ldda);
                    
                    magma_tally3_zher2k(Magma_tally3Upper, Magma_tally3ConjTrans,
                                 n-k-kb, kb,
                                 c_neg_one, dA(k,k+kb), ldda,
                                 dB(k,k+kb), lddb,
                                 d_one, dA(k+kb,k+kb), ldda);
                    
                    magma_tally3_zgetmatrix_async( kb2, kb2,
                                            dA(k+kb, k+kb), ldda,
            ...
            for (k = 0; k < n; k += nb) {
                ...
                if (k+kb < n) {
                    ...
                    magma_tally3_zhemm(Magma_tally3Right, Magma_tally3Lower,
                                n-k-kb, kb,
                                c_neg_half, dA(k,k), ldda,
                                dB(k+kb,k), lddb,
                                c_one, dA(k+kb, k), ldda);
                    
                    magma_tally3_zher2k(Magma_tally3Lower, Magma_tally3NoTrans,
                                 n-k-kb, kb,
                    ...
                    magma_tally3_ztrsm(Magma_tally3Left, Magma_tally3Lower, Magma_tally3NoTrans, Magma_tally3NonUnit,
                                n-k-kb, kb,
                                c_one, dB(k+kb,k+kb), lddb,
                                dA(k+kb,k), ldda);
                }
        ...
        if (upper) {
            ...
            for (k = 0; k < n; k += nb) {
                ...
                if (k > 0) {
                    magma_tally3_ztrmm(Magma_tally3Left, Magma_tally3Upper, Magma_tally3NoTrans, Magma_tally3NonUnit,
                                k, kb,
                                c_one, dB(0,0), lddb,
                                dA(0,k), ldda);
                    
                    magma_tally3_zhemm(Magma_tally3Right, Magma_tally3Upper,
                                k, kb,
                                c_half, dA(k,k), ldda,
                                dB(0,k), lddb,
                                c_one, dA(0, k), ldda);
                    ...
                    magma_tally3_zher2k(Magma_tally3Upper, Magma_tally3NoTrans,
                                 k, kb,
                                 c_one, dA(0,k), ldda,
                                 dB(0,k), lddb,
                                 d_one, dA(0,0), ldda);
                    ...
                    magma_tally3_ztrmm(Magma_tally3Right, Magma_tally3Upper, Magma_tally3ConjTrans, Magma_tally3NonUnit,
                                k, kb,
                                c_one, dB(k,k), lddb,
                                dA(0,k), ldda);
                }
            ...
            for (k = 0; k < n; k += nb) {
                ...
                if (k > 0) {
                    ...
                    magma_tally3_ztrmm(Magma_tally3Right, Magma_tally3Lower, Magma_tally3NoTrans, Magma_tally3NonUnit,
                                kb, k,
                                c_one, dB(0,0), lddb,
                                dA(k,0), ldda);
                    
                    magma_tally3_zhemm(Magma_tally3Left, Magma_tally3Lower,
                                kb, k,
                                c_half, dA(k,k), ldda,
                                dB(k,0), lddb,
                                c_one, dA(k, 0), ldda);
                    ...
                    magma_tally3_zher2k(Magma_tally3Lower, Magma_tally3ConjTrans,
                                 k, kb,
                                 c_one, dA(k,0), ldda,
                                 dB(k,0), lddb,
                                 d_one, dA(0,0), ldda);
                    ...
                    magma_tally3_ztrmm(Magma_tally3Left, Magma_tally3Lower, Magma_tally3ConjTrans, Magma_tally3NonUnit,
                                kb, k,
                                c_one, dB(k,k), lddb,
                                dA(k,0), ldda);
                }
    ...
    magma_tally3_zgetmatrix( n, n, dA(0, 0), ldda, A(0, 0), lda );
