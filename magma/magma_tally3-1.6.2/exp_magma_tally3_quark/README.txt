...
Notice:
======
exp_magma_tally3_quark is a temporary name. We are still looking for a better name, so if you have a better suggestion, just let us know.

Purpose:
========
exp_magma_tally3_quark proposes a new scheduling strategy for hybrid CPU/GPU computations.
...
magma_tally3_insert: The wrapper for any task insertion. e.g magma_tally3_insert_dgemm(...)
magma_tally3_task: The GPU routines called by the scheduler. e.g magma_tally3_task_dgemm(...)
...
Test:
====
1. Compile magma_tally3
	cd <magma_tally3_dir>/trunk
	make
...
3. Compile magma_tally3_quark
	cd exp_magma_tally3_quark
	make
