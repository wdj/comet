...
int main( int argc, char** argv)
{
    ...
    magma_tally4_int_t N, info;
    magma_tally4_int_t sizeA;
    magma_tally4_int_t lda, ldda;
    magma_tally4_int_t ione     = 1;
    magma_tally4_int_t ISEED[4] = {0,0,0,1};
    magma_tally4_int_t *ipiv;

    magma_tally4FloatComplex *h_A, *h_b, *h_x, *h_xcublas;
    magma_tally4FloatComplex_ptr d_A, d_x;
    ...
    printf("uplo = %s, transA = %s, diag = %s\n",
           lapack_uplo_const_tally4(opts.uplo), lapack_trans_const_tally4(opts.transA), lapack_diag_const_tally4(opts.diag) );
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_b,       magma_tally4FloatComplex, N     );
            TESTING_MALLOC_CPU( h_x,       magma_tally4FloatComplex, N     );
            TESTING_MALLOC_CPU( h_xcublas, magma_tally4FloatComplex, N     );
            
            TESTING_MALLOC_DEV( d_A, magma_tally4FloatComplex, ldda*N );
            TESTING_MALLOC_DEV( d_x, magma_tally4FloatComplex, N      );
            ...
            magma_tally4_csetvector( N, h_x, 1, d_x, 1 );
            
            cublas_time = magma_tally4_sync_wtime( NULL );
            cublasCtrsv( opts.handle, cublas_uplo_const_tally4(opts.uplo),
            ...
            magma_tally4_cgetvector( N, d_x, 1, h_xcublas, 1 );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_ctrsv( lapack_uplo_const_tally4(opts.uplo), lapack_trans_const_tally4(opts.transA), lapack_diag_const_tally4(opts.diag),
                               &N,
                               h_A, &lda,
                               h_x, &ione );
            ...
            blasf77_ctrmv( lapack_uplo_const_tally4(opts.uplo), lapack_trans_const_tally4(opts.transA), lapack_diag_const_tally4(opts.diag),
                           &N,
                           h_A, &lda,
                           h_xcublas, &ione );
