    ...
    if (nb <= 1 || nb >= n) {
        ...
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally4_cgetmatrix( ib, ib,
                                  dA(i, i), ldda,
                                  work,     ib );

                lapackf77_clauum(Magma_tally4UpperStr, &ib, work, &ib, info);

                magma_tally4_csetmatrix( ib, ib,
                                  work,     ib,
                                  dA(i, i), ldda );
            ...
            for (i=0; i < n; i += nb) {
                ...
                lapackf77_clauum(Magma_tally4LowerStr, &ib, work, &ib, info);
