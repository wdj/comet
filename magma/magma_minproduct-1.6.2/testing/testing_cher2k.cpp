...
int main( int argc, char** argv)
{
    ...
    magma_minproductFloatComplex *h_A, *h_B, *h_C, *h_Ccublas;
    ...
    float beta  = MAGMA_minproduct_D_MAKE( -0.48,  0.38 );
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_B,       magma_minproductFloatComplex, ldb*Bk );
            TESTING_MALLOC_CPU( h_C,       magma_minproductFloatComplex, ldc*N  );
            TESTING_MALLOC_CPU( h_Ccublas, magma_minproductFloatComplex, ldc*N  );
            
            TESTING_MALLOC_DEV( d_A, magma_minproductFloatComplex, ldda*Ak );
            TESTING_MALLOC_DEV( d_B, magma_minproductFloatComplex, lddb*Bk );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_minproduct_csetmatrix( An, Ak, h_A, lda, d_A, ldda );
            magma_minproduct_csetmatrix( Bn, Bk, h_B, ldb, d_B, lddb );
            magma_minproduct_csetmatrix( N, N, h_C, ldc, d_C, lddc );
            ...
            magma_minproduct_cgetmatrix( N, N, d_C, lddc, h_Ccublas, ldc );
