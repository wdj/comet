/*
    -- MAGMA_tally4 (version 1.6.2) --
       ...
       @generated from magma_tally4_zmcsrpass_gpu.cpp normal z -> c, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
...
/**
    ...
    @param[in]
    val         magma_tally4FloatComplex_ptr
    ...
    magma_tally4_queue_t queue )
{
    ...
    magma_tally4_c_matrix A_DEV={Magma_tally4_CSR}, A_CSR={Magma_tally4_CSR};
    ...
    if ( A.memory_location == Magma_tally4_DEV && A.storage_type == Magma_tally4_CSR ) {
        ...
        *row = A.drow;
        ...
        CHECK( magma_tally4_cmconvert( A, &A_CSR, A.storage_type, Magma_tally4_CSR, queue ));
        CHECK( magma_tally4_cmtransfer( A_CSR, &A_DEV, A.memory_location, Magma_tally4_DEV, queue ));
        magma_tally4_ccsrget_gpu( A_DEV, m, n, row, col, val, queue );
    }
    
cleanup:
    magma_tally4_cmfree( &A_CSR, queue );
    magma_tally4_cmfree( &A_DEV, queue );
    return info;
}
