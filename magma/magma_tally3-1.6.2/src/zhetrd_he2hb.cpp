    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally3_SUCCESS != magma_tally3_zmalloc( &dA, (n + 2*nb)*ldda )) {
    ...
    magma_tally3DoubleComplex *dwork = dA + n*ldda;
    magma_tally3DoubleComplex *dW    = dwork + nb*ldda;
    ...
    if (upper) {
        ...
        if (1 <= n-nb) {
            ...
            magma_tally3_zsetmatrix_async( (n-nb), (n-nb),
                                    A(nb+1, nb+1),  lda,
        ...
        for (i = 1; i <= n-nb; i += nb) {
             ...
             if (i > 1 ) {
                 ...
                 magma_tally3_zher2k(Magma_tally3Lower, Magma_tally3NoTrans, pm_old-pn_old, pn_old, c_neg_one,
             ...
             // because below we made a restore zq_to_panel_tally3 and this restore need
