/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zmtranspose.cpp normal z -> s, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
       @author Mark Gates
    ...
    magma_tally2_queue_t queue )
{
    ...
    CHECK( magma_tally2_smalloc_cpu( &csc_values, nnz ) );
    ...
    magma_tally2_queue_t queue )
{
    ...
    magma_tally2_s_matrix ACSR={Magma_tally2_CSR}, BCSR={Magma_tally2_CSR};
    ...
    if( A.storage_type == Magma_tally2_CSR && A.memory_location == Magma_tally2_DEV ) {
        ...
        CHECK( magma_tally2_smtransfer( A, &A_d, A.memory_location, Magma_tally2_DEV, queue ));
        CHECK( magma_tally2_s_cucsrtranspose( A_d, &B_d, queue ));
        CHECK( magma_tally2_smtransfer( B_d, B, Magma_tally2_DEV, A.memory_location, queue ));
                
    }else {
        CHECK( magma_tally2_smconvert( A, &ACSR, A.storage_type, Magma_tally2_CSR, queue ));
        CHECK( magma_tally2_s_cucsrtranspose( ACSR, &BCSR, queue ));
        CHECK( magma_tally2_smconvert( BCSR, B, Magma_tally2_CSR, A.storage_type, queue ));
    }
cleanup:
    ...
    magma_tally2_smfree( &BCSR, queue );
    if( info != 0 ){
