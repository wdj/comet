...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_minproduct_ssyevd_gpu( opts.jobz, opts.uplo,
                              N, NULL, ldda, NULL,
                              NULL, lda,
                              aux_work,  -1,
                              #ifdef COMPLEX
                              ...
                              aux_iwork, -1,
                              &info );
            lwork  = (magma_minproduct_int_t) MAGMA_minproduct_S_REAL( aux_work[0] );
            #ifdef COMPLEX
            ...
            magma_minproduct_ssetmatrix( N, N, h_A, lda, d_R, ldda );
            ...
            if ( opts.warmup ) {
                magma_minproduct_ssyevd_gpu( opts.jobz, opts.uplo,
                                  ...
                                  &info );
                if (info != 0)
                    printf("magma_minproduct_ssyevd_gpu returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_minproductNoVec ) {
                /* =====================================================================
                   ...
                   =================================================================== */
                magma_minproduct_sgetmatrix( N, N, d_R, ldda, h_R, lda );
                ...
                //
                //magma_minproduct_ssetmatrix( N, N, h_A, lda, d_R, ldda );
                //magma_minproduct_ssyevd_gpu( Magma_minproductNoVec, opts.uplo,
                //                  N, d_R, ldda, w2,
                //                  h_R, lda,
                //                  h_work, lwork,
                //                  #ifdef COMPLEX
