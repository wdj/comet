...
int main( int argc, char** argv)
{
    ...
    MAGMA_tally3_UNUSED( max_mn );  // used only in real
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (info != 0)
                printf("magma_tally3_dgesdd returned error %d: %s.\n",
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_dgesdd( lapack_vec_const_tally3(jobz), &M, &N,
