...
magma_tally3_ssetmatrix_internal(
    ...
    float const* hA_src, magma_tally3_int_t lda,
    magma_tally3Float_ptr    dB_dst, magma_tally3_int_t ldb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
...
magma_tally3_sgetmatrix_internal(
    magma_tally3_int_t m, magma_tally3_int_t n,
    magma_tally3Float_const_ptr dA_src, magma_tally3_int_t lda,
    float*          hB_dst, magma_tally3_int_t ldb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
