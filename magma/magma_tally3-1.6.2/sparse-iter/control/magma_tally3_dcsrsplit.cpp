/*
    -- MAGMA_tally3 (version 1.6.2) --
       ...
       @generated from magma_tally3_zcsrsplit.cpp normal z -> d, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
    ...
    magma_tally3_queue_t queue )
{
    ...
    if (  A.memory_location == Magma_tally3_CPU &&
        ...
        magma_tally3_d_matrix Ah={Magma_tally3_CSR}, ACSR={Magma_tally3_CSR}, DCSR={Magma_tally3_CSR}, RCSR={Magma_tally3_CSR}, Dh={Magma_tally3_CSR}, Rh={Magma_tally3_CSR};
        CHECK( magma_tally3_dmtransfer( A, &Ah, A.memory_location, Magma_tally3_CPU, queue ));
        CHECK( magma_tally3_dmconvert( Ah, &ACSR, A.storage_type, Magma_tally3_CSR, queue ));

        CHECK( magma_tally3_dcsrsplit( bsize, ACSR, &DCSR, &RCSR, queue ));

        CHECK( magma_tally3_dmconvert( DCSR, &Dh, Magma_tally3_CSR, A.storage_type, queue ));
        CHECK( magma_tally3_dmconvert( RCSR, &Rh, Magma_tally3_CSR, A.storage_type, queue ));

        CHECK( magma_tally3_dmtransfer( Dh, D, Magma_tally3_CPU, A.memory_location, queue ));
        CHECK( magma_tally3_dmtransfer( Rh, R, Magma_tally3_CPU, A.memory_location, queue ));

        magma_tally3_dmfree( &Ah, queue );
        magma_tally3_dmfree( &ACSR, queue );
        magma_tally3_dmfree( &Dh, queue );
        magma_tally3_dmfree( &DCSR, queue );
        magma_tally3_dmfree( &Rh, queue );
        magma_tally3_dmfree( &RCSR, queue );
    }
cleanup:
    if( info != 0 ){
