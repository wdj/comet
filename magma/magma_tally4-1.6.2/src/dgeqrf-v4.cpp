    ...
    magma_tally4_int_t *info )
{
    ...
    *info = 0;
    ...
    for (i=0; i < ngpu; i++) {
        ...
        if (MAGMA_tally4_SUCCESS != magma_tally4_dmalloc( &da[i], ldda*n_local[i] )) {
    ...
    if (m > nb && n > nb) {
        ...
        magma_tally4_dsetmatrix_1D_col_bcyclic(m, n, A, lda, da, ldda, ngpu, nb);

        /* Factor using the GPU interface */
        magma_tally4_dgeqrf2_mgpu( ngpu, m, n, da, ldda, tau, info);
