    ...
    magma_tally3_int_t *info )
{
    ...
    *info = 0;
    ...
    if (*info == 0) {
        minwrk = (1+nb)*n;
        work[0] = MAGMA_tally3_Z_MAKE( minwrk, 0 );
    ...
    if (MAGMA_tally3_SUCCESS != magma_tally3_zmalloc_cpu( &T, nb*n )) {
    ...
    liwrk = lwork - iwrk;
        ...
        magma_tally3_zgehrd_m( n, ilo, ihi, A, lda,
    ...
    if (wantvl) {
         ...
         *  - including N reserved for gebal/gebak, unused by zunghr */
            ...
            magma_tally3_zunghr_m( n, ilo, ihi, VL, ldvl, &work[itau], T, nb, &ierr );
        #endif
        ...
        #elif defined(Version5)
            // Version 5 - Multi-GPU, T on host
            magma_tally3_zunghr_m( n, ilo, ihi, VR, ldvr, &work[itau], T, nb, &ierr );
        #endif
...
CLEANUP:
    ...
    work[0] = MAGMA_tally3_Z_MAKE( (double) minwrk, 0. );  // TODO use optwrk as in dgeev
