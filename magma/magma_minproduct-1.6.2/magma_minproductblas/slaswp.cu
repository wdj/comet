...
/**
    @see magma_minproductblas_slaswp_q
    @ingroup magma_minproduct_saux2
    ********************************************************************/
extern "C" void
magma_minproductblas_slaswp(
    ...
    const magma_minproduct_int_t *ipiv, magma_minproduct_int_t inci )
{
    magma_minproductblas_slaswp_q( n, dAT, ldda, k1, k2, ipiv, inci, magma_minproduct_stream );
}
...
/**
    @see magma_minproductblas_slaswpx_q
    @ingroup magma_minproduct_saux2
    ********************************************************************/
extern "C" void
magma_minproductblas_slaswpx(
    ...
    const magma_minproduct_int_t *ipiv, magma_minproduct_int_t inci )
{
    return magma_minproductblas_slaswpx_q( n, dA, ldx, ldy, k1, k2, ipiv, inci, magma_minproduct_stream );
}
...
// batches of pivots. On Fermi, it is faster than magma_minproductblas_slaswp
...
/**
    @see magma_minproductblas_slaswp2_q
    @ingroup magma_minproduct_saux2
    ********************************************************************/
extern "C" void
magma_minproductblas_slaswp2(
    ...
    magma_minproductInt_const_ptr d_ipiv, magma_minproduct_int_t inci )
{
    magma_minproductblas_slaswp2_q( n, dAT, ldda, k1, k2, d_ipiv, inci, magma_minproduct_stream );
}
