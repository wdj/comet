...
#define dB(i, j) (dw + n*ldda + (j)*lddb + (i))
    ...
    magma_minproductFloatComplex   *dw;
    ...
    *info = 0;
    ...
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_cmalloc( &dw, 2*n*n )) {
    ...
    magma_minproduct_csetmatrix( n, n, B(0, 0), ldb, dB(0, 0), lddb );
    ...
    magma_minproduct_cgetmatrix( n, n, dA(0, 0), ldda, A(0, 0), lda );
