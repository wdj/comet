...
int main(int argc, char **argv)
{
    ...
    magma_tally2FloatComplex **d_A_array, **d_B_array;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_B, magma_tally2FloatComplex, ldb*nrhs*batchCount );
            TESTING_MALLOC_CPU( h_X, magma_tally2FloatComplex, ldb*nrhs*batchCount );
            ...
            magma_tally2_cgesv_nopiv_batched( N, nrhs, d_A_array, ldda, d_B_array, lddb, dinfo_magma_tally2, batchCount, queue );
