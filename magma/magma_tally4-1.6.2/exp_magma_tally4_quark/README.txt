...
Notice:
======
exp_magma_tally4_quark is a temporary name. We are still looking for a better name, so if you have a better suggestion, just let us know.

Purpose:
========
exp_magma_tally4_quark proposes a new scheduling strategy for hybrid CPU/GPU computations.
...
magma_tally4_insert: The wrapper for any task insertion. e.g magma_tally4_insert_dgemm(...)
magma_tally4_task: The GPU routines called by the scheduler. e.g magma_tally4_task_dgemm(...)
...
Test:
====
1. Compile magma_tally4
	cd <magma_tally4_dir>/trunk
	make
...
3. Compile magma_tally4_quark
	cd exp_magma_tally4_quark
	make
