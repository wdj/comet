/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zvtranspose.cpp normal z -> d, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_tally2_queue_t queue )
{
    ...
    magma_tally2_d_matrix x_d={Magma_tally2_CSR}, y_d={Magma_tally2_CSR};
            
    if ( x.memory_location == Magma_tally2_DEV ) {
        CHECK( magma_tally2_dvinit( y, Magma_tally2_DEV, x.num_rows,x.num_cols, MAGMA_tally2_D_ZERO, queue ));
        y->num_rows = x.num_rows;
        y->num_cols = x.num_cols;
        y->storage_type = x.storage_type;
        if ( x.major == Magma_tally2ColMajor) {
            y->major = Magma_tally2RowMajor;
            magma_tally2blas_dtranspose( m, n, x.val, m, y->val, n );
        }
        else {
            y->major = Magma_tally2ColMajor;
            magma_tally2blas_dtranspose( n, m, x.val, n, y->val, m );
        }
    } else {

        CHECK( magma_tally2_dmtransfer( x, &x_d, Magma_tally2_CPU, Magma_tally2_DEV, queue ));
        CHECK( magma_tally2_dvtranspose( x_d, &y_d, queue ));
        CHECK( magma_tally2_dmtransfer( y_d, y, Magma_tally2_DEV, Magma_tally2_CPU, queue ));
    }
...
cleanup:
    ...
    magma_tally2_dmfree( &x_d, queue );
    magma_tally2_dmfree( &y_d, queue );
