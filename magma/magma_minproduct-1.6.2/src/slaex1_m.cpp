/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from dlaex1_m.cpp normal d -> s, Fri Jan 30 19:00:17 2015
*/
...
#define Q(i_,j_) (Q + (i_) + (j_)*ldq)
    ...
    magma_minproduct_int_t coltyp, i, idlmda;
    magma_minproduct_int_t indx, indxc, indxp;
    magma_minproduct_int_t iq2, is, iw, iz, k, tmp;
    ...
    *info = 0;
    ...
    if ( k != 0 ) {
        ...
        magma_minproduct_slaex3_m(ngpu, k, n, cutpnt, d, Q, ldq, rho,
