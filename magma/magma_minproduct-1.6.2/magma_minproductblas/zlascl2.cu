...
__global__ void
zlascl2_full(int m, int n, const double* D, magma_minproductDoubleComplex* A, int lda)
{
...
__global__ void
zlascl2_lower(int m, int n, const double* D, magma_minproductDoubleComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
__global__ void
zlascl2_upper(int m, int n, const double *D, magma_minproductDoubleComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
magma_minproductblas_zlascl2(
    magma_minproduct_type_t type, magma_minproduct_int_t m, magma_minproduct_int_t n,
    magma_minproductDouble_const_ptr dD,
    magma_minproductDoubleComplex_ptr dA, magma_minproduct_int_t ldda, magma_minproduct_int_t *info )
{
    magma_minproductblas_zlascl2_q( type, m, n, dD, dA, ldda, magma_minproduct_stream, info );
}
