    ...
    magma_tally4_queue_t queue )
{
    ...
    magma_tally4_s_matrix hA={Magma_tally4_CSR}, hACSR={Magma_tally4_CSR};
    magma_tally4_s_matrix hL={Magma_tally4_CSR}, hU={Magma_tally4_CSR};
    CHECK( magma_tally4_smtransfer( A, &hA, A.memory_location, Magma_tally4_CPU, queue ));
    CHECK( magma_tally4_smconvert( hA, &hACSR, hA.storage_type, Magma_tally4_CSR, queue ));

        // in case using fill-in
    if( precond->levels > 0 ){
        magma_tally4_s_matrix hAL={Magma_tally4_CSR}, hAUt={Magma_tally4_CSR};
        CHECK( magma_tally4_ssymbilu( &hACSR, precond->levels, &hAL, &hAUt,  queue ));
        magma_tally4_smfree(&hAL, queue);
        magma_tally4_smfree(&hAUt, queue);
    }

    CHECK( magma_tally4_smtransfer(hACSR, &(precond->M), Magma_tally4_CPU, Magma_tally4_DEV, queue ));

    magma_tally4_smfree( &hA, queue );
    magma_tally4_smfree( &hACSR, queue );
    ...
    CHECK( magma_tally4_smtransfer( precond->M, &hA, Magma_tally4_DEV, Magma_tally4_CPU, queue ));

    hL.diagorder_type = Magma_tally4_UNITY;
    CHECK( magma_tally4_smconvert( hA, &hL , Magma_tally4_CSR, Magma_tally4_CSRL, queue ));
    hU.diagorder_type = Magma_tally4_VALUE;
    CHECK( magma_tally4_smconvert( hA, &hU , Magma_tally4_CSR, Magma_tally4_CSRU, queue ));
    CHECK( magma_tally4_smtransfer( hL, &(precond->L), Magma_tally4_CPU, Magma_tally4_DEV, queue ));
    CHECK( magma_tally4_smtransfer( hU, &(precond->U), Magma_tally4_CPU, Magma_tally4_DEV, queue ));
    ...
    magma_tally4_queue_t queue )
{
    ...
    magma_tally4_s_matrix hA={Magma_tally4_CSR}, hL={Magma_tally4_CSR}, hU={Magma_tally4_CSR};
    
    if (precond->L.memory_location != Magma_tally4_DEV ){
        
        CHECK( magma_tally4_smtransfer( precond->M, &hA,
    ...
    if( precond->maxiter < 50 ){
        ...
        // extract the diagonal of L into precond->d
        CHECK( magma_tally4_sjacobisetup_diagscal( precond->L, &precond->d, queue ));
        CHECK( magma_tally4_svinit( &precond->work1, Magma_tally4_DEV, precond->U.num_rows, 1, MAGMA_tally4_S_ZERO, queue ));
        
        // extract the diagonal of U into precond->d2
        CHECK( magma_tally4_sjacobisetup_diagscal( precond->U, &precond->d2, queue ));
        CHECK( magma_tally4_svinit( &precond->work2, Magma_tally4_DEV, precond->U.num_rows, 1, MAGMA_tally4_S_ZERO, queue ));
    }
    ...
    magma_tally4_queue_t queue )
{
    ...
    magma_tally4_s_matrix hA={Magma_tally4_CSR}, hACSR={Magma_tally4_CSR}, U={Magma_tally4_CSR};
    CHECK( magma_tally4_smtransfer( A, &hA, A.memory_location, Magma_tally4_CPU, queue ));
    ...
    CHECK( magma_tally4_smconvert( hACSR, &U, Magma_tally4_CSR, Magma_tally4_CSRL, queue ));
    magma_tally4_smfree( &hACSR, queue );
    CHECK( magma_tally4_smtransfer(U, &(precond->M), Magma_tally4_CPU, Magma_tally4_DEV, queue ));
...
/*
    ...
    magma_tally4_s_matrix hD, hR, hAt

    CHECK( magma_tally4_scsrsplit( 256, hA, &hD, &hR, queue ));

    CHECK( magma_tally4_smtransfer( hD, &precond->LD, Magma_tally4_CPU, Magma_tally4_DEV, queue ));
    CHECK( magma_tally4_smtransfer( hR, &precond->L, Magma_tally4_CPU, Magma_tally4_DEV, queue ));

    magma_tally4_smfree(&hD, queue );
    magma_tally4_smfree(&hR, queue );

    CHECK( magma_tally4_s_cucsrtranspose(   hA, &hAt, queue ));

    CHECK( magma_tally4_scsrsplit( 256, hAt, &hD, &hR, queue ));

    CHECK( magma_tally4_smtransfer( hD, &precond->UD, Magma_tally4_CPU, Magma_tally4_DEV, queue ));
    CHECK( magma_tally4_smtransfer( hR, &precond->U, Magma_tally4_CPU, Magma_tally4_DEV, queue ));
    
    magma_tally4_smfree(&hD, queue );
    magma_tally4_smfree(&hR, queue );
    magma_tally4_smfree(&hA, queue );
    magma_tally4_smfree(&hAt, queue );
*/
