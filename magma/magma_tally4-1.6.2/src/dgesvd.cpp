    ...
    magma_tally4_int_t *info )
{
    ...
    *info = 0;
    ...
    lapackf77_dgesvd(jobu_, jobvt_, &m, &n, A, &lda, s, U, &ldu, VT, &ldvt,
                     work, &ineg_one, info);
    maxwrk = (magma_tally4_int_t) MAGMA_tally4_D_REAL( work[0] );
    if (*info == 0) {
        ...
        work[0] = MAGMA_tally4_D_MAKE( minwrk * one_eps, 0 );
    ...
    if (m >= n) {
        ...
        if (m >= mnthr) {
            if (want_un) {
                ...
                #else
                magma_tally4_dgebrd(n, n, A, lda, s, &work[ie],
                             &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                #endif
                ...
                if (lwork >= n*n + max(wrkbrd, bdspac)) {
                    ...
                    #else
                    magma_tally4_dorgqr2(m, n, n, A, lda, &work[itau], &ierr);
                    #endif
                    ...
                    lapackf77_dgebrd(&n, &n, &work[ir], &ldwrkr, s, &work[ie],
                                 &work[itauq], &work[itaup], &work[iwork], &lwork2, &ierr);
                    #else
                    magma_tally4_dgebrd(n, n, &work[ir], ldwrkr, s, &work[ie],
                                 &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                    #endif
                    ...
                    lapackf77_dgebrd(&m, &n, A, &lda, s, &work[ie],
                                 &work[itauq], &work[itaup], &work[iwork], &lwork2, &ierr);
                    #else
                    magma_tally4_dgebrd(m, n, A, lda, s, &work[ie],
                                 &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                    #endif
                ...
                if (lwork >= n*n + max(wrkbrd, bdspac)) {
                    ...
                    lapackf77_dgebrd(&n, &n, VT, &ldvt, s, &work[ie],
                                 &work[itauq], &work[itaup], &work[iwork], &lwork2, &ierr);
                    #else
                    magma_tally4_dgebrd(n, n, VT, ldvt, s, &work[ie],
                                 &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                    #endif
                ...
                if (want_vn) {
                    ...
                    if (lwork >= n*n + max(wrkbrd, bdspac)) {
                        ...
                        lapackf77_dorgqr(&m, &n, &n, U, &ldu,
                                         &work[itau], &work[iwork], &lwork2, &ierr);
                        #else
                        magma_tally4_dorgqr2(m, n, n, U, ldu, &work[itau], &ierr);
                        #endif
                    ...
                    if (lwork >= 2*n*n + max(wrkbrd, bdspac)) {
                        ...
                        lapackf77_dgebrd(&n, &n, &work[iu], &ldwrku, s, &work[ie],
                                     &work[itauq], &work[itaup], &work[iwork], &lwork2, &ierr);
                        #else
                        magma_tally4_dgebrd(n, n, &work[iu], ldwrku, s, &work[ie],
                                     &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                        #endif
                        lapackf77_dlacpy("U", &n, &n,
                                         &work[iu], &ldwrku,
                ...
                if (want_vn) {
                    ...
                    if (lwork >= n*n + max( max(n + m, wrkbrd), bdspac)) {
                        ...
                        lapackf77_dorgqr(&m, &m, &n, U, &ldu,
                                         &work[itau], &work[iwork], &lwork2, &ierr);
                        #else
                        magma_tally4_dorgqr2(m, m, n, U, ldu, &work[itau], &ierr);
                        #endif
        ...
        if (n >= mnthr) {
            if (want_vn) {
                ...
                lapackf77_dgebrd(&m, &m, A, &lda, s, &work[ie],
                             &work[itauq], &work[itaup], &work[iwork], &lwork2, &ierr);
                #else
                magma_tally4_dgebrd(m, m, A, lda, s, &work[ie],
                             &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                #endif
                ...
                if (lwork >= m*m + max(wrkbrd, bdspac)) {
                    ...
                    lapackf77_dgebrd(&m, &m, &work[ir], &ldwrkr, s, &work[ie],
                                 &work[itauq], &work[itaup], &work[iwork], &lwork2, &ierr);
                    #else
                    magma_tally4_dgebrd(m, m, &work[ir], ldwrkr, s, &work[ie],
                                 &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                    #endif
                ...
                if (lwork >= m*m + max(wrkbrd, bdspac)) {
                    ...
                    lapackf77_dgebrd(&m, &m, U, &ldu, s, &work[ie],
                                 &work[itauq], &work[itaup], &work[iwork], &lwork2, &ierr);
                    #else
                    magma_tally4_dgebrd(m, m, U, ldu, s, &work[ie],
                                 &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                    #endif
                ...
                if (want_un) {
                    ...
                    if (lwork >= 2*m*m + max(wrkbrd, bdspac)) {
                        ...
                        lapackf77_dgebrd(&m, &m, &work[iu], &ldwrku, s, &work[ie],
                                     &work[itauq], &work[itaup], &work[iwork], &lwork2, &ierr);
                        #else
                        magma_tally4_dgebrd(m, m, &work[iu], ldwrku, s, &work[ie],
                                     &work[itauq], &work[itaup], &work[iwork], lwork2, &ierr);
                        #endif
                        lapackf77_dlacpy("L", &m, &m,
                                         &work[iu], &ldwrku,
