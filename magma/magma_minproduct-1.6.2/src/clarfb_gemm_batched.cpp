...
magma_minproduct_clarfb_gemm_batched_magem(
...
extern "C" magma_minproduct_int_t
magma_minproduct_clarfb_gemm_batched_cugem(
    magma_minproduct_side_t side, magma_minproduct_trans_t trans, magma_minproduct_direct_t direct, magma_minproduct_storev_t storev,
    magma_minproduct_int_t m, magma_minproduct_int_t n, magma_minproduct_int_t k,
    magma_minproductFloatComplex_const_ptr dV_array[],    magma_minproduct_int_t lddv,
    magma_minproductFloatComplex_const_ptr dT_array[],    magma_minproduct_int_t lddt,
    ...
    magma_minproduct_int_t batchCount, cublasHandle_t myhandle, magma_minproduct_queue_t queue)
{
    ...
    if(m >= 32 && n >= 32 && k >= 32)
    {
        magma_minproduct_clarfb_gemm_batched_magem(
            ...
            m, n,  k,
            (magma_minproductFloatComplex_const_ptr *) dV_array, lddv,
            (magma_minproductFloatComplex_const_ptr *) dT_array, lddt,
            dC_array, lddc,
            dwork_array, ldwork,
    ...
    magma_minproduct_int_t batchCount, magma_minproduct_queue_t queue)
{
    ...
    if ( side == Magma_minproductLeft ) {
        ...
        // W = V' C                              
        magma_minproductblas_cgemm_batched( Magma_minproduct_ConjTrans,notransV, /*NontransLeft*/
                     k, n, m,
                     c_one,  dV_array,    lddv,
                             dC_array,    lddc,
        ...
        if (m <= n) {
            // W2 = V T
            magma_minproductblas_cgemm_batched( notransV, trans, /* (NoTrans), trans(ConjTrans),*/
                         m, k, k,
                         c_one,  dV_array, lddv,
                                 dT_array, lddt,
        ...
        {
            // W2 = T W  = T  V' C
            magma_minproductblas_cgemm_batched( trans, Magma_minproductNoTrans,
                         k, n, k,
                         c_one,  dT_array, lddt,
                                 dwork_array, ldw,
                         c_zero, dworkvt_array, ldwvt, batchCount, queue);
            ...
            magma_minproductblas_cgemm_batched( notransV, Magma_minproductNoTrans,
                         m, n, k,
        ...
        // W = C V
        magma_minproductblas_cgemm_batched( Magma_minproductNoTrans, notransV,
                     m, k, n,
                     c_one,  dC_array,    lddc,
                             dV_array,    lddv,
                     c_zero, dwork_array, ldw, batchCount, queue);
        if (m <= n) {
            // W2 = W T = C V T
            magma_minproductblas_cgemm_batched( Magma_minproductNoTrans, trans,
                         m, k, k,
            ...
            magma_minproductblas_cgemm_batched( Magma_minproductNoTrans, transV,
                         m, n, k,
                         c_neg_one, dworkvt_array, ldwvt,
                                    dV_array,    lddv,
                         c_one,     dC_array,    lddc, batchCount, queue);
            ...
            // W2 = T V'
            magma_minproductblas_cgemm_batched( trans, transV,
                         k, n, k,
                         c_one,  dT_array, lddt,
                                 dV_array, lddv,
                         c_zero, dworkvt_array, ldwvt, batchCount, queue);
    ...
    magma_minproduct_int_t batchCount, cublasHandle_t myhandle, magma_minproduct_queue_t queue)
{
    ...
    if ( side == Magma_minproductLeft ) {
        ...
        // W = V' C
        cublasCgemmBatched(myhandle, cublas_trans_const(Magma_minproduct_ConjTrans), cublas_trans_const(notransV),
                     k, n, m,
                     &c_one,  (const magma_minproductFloatComplex**)dV_array,    lddv,
                              (const magma_minproductFloatComplex**)dC_array,    lddc,
                     &c_zero, dwork_array, ldw, batchCount);
        if (m <= n) {
            // W2 = V T
            cublasCgemmBatched(myhandle, cublas_trans_const(notransV), cublas_trans_const(trans),
                         m, k, k,
                         &c_one,  (const magma_minproductFloatComplex**)dV_array, lddv,
                                  (const magma_minproductFloatComplex**)dT_array, lddt,
                         &c_zero, dworkvt_array, ldwvt, batchCount);
            // C = C - W2 W = C - V T V' C = (I - V T V') C = H C
            cublasCgemmBatched(myhandle, cublas_trans_const(Magma_minproductNoTrans), cublas_trans_const(Magma_minproductNoTrans),
                         m, n, k,
                         &c_neg_one, (const magma_minproductFloatComplex**)dworkvt_array,  ldwvt,
                                     (const magma_minproductFloatComplex**)dwork_array,    ldw,
                         &c_one,     dC_array,       lddc, batchCount);
        } else {
            // W2 = T W  = T  V' C
            cublasCgemmBatched(myhandle, cublas_trans_const(trans), cublas_trans_const(Magma_minproductNoTrans),
                         k, n, k,
                         &c_one,  (const magma_minproductFloatComplex**)dT_array, lddt,
                                  (const magma_minproductFloatComplex**)dwork_array, ldw,
                         &c_zero, dworkvt_array, ldwvt, batchCount);
            // C = C - V W2 = C - V T V' C = (I - V T V') C = H C
            cublasCgemmBatched(myhandle, cublas_trans_const(notransV), cublas_trans_const(Magma_minproductNoTrans),
                         m, n, k,
                         &c_neg_one, (const magma_minproductFloatComplex**)dV_array,  lddv,
                                     (const magma_minproductFloatComplex**)dworkvt_array,  ldwvt,
                         &c_one,     dC_array,       lddc, batchCount);
        }
    }
    else {
        ...
        // W = C V
        cublasCgemmBatched(myhandle, cublas_trans_const(Magma_minproductNoTrans), cublas_trans_const(notransV),
                     m, k, n,
                     &c_one,  (const magma_minproductFloatComplex**)dC_array,    lddc,
                              (const magma_minproductFloatComplex**)dV_array,    lddv,
                     &c_zero, dwork_array, ldw, batchCount);
        if (m <= n) {
            // W2 = W T = C V T
           cublasCgemmBatched(myhandle, cublas_trans_const(Magma_minproductNoTrans), cublas_trans_const(trans),
                         m, k, k,
                         &c_one,  (const magma_minproductFloatComplex**)dwork_array, ldw,
                                  (const magma_minproductFloatComplex**)dT_array, lddt,
                         &c_zero, dworkvt_array, ldwvt, batchCount);
            // C = C - W2 V' = C - C V T V' = C (I - V T V') = C H
            cublasCgemmBatched(myhandle, cublas_trans_const(Magma_minproductNoTrans), cublas_trans_const(transV),
                         m, n, k,
                         &c_neg_one, (const magma_minproductFloatComplex**)dworkvt_array, ldwvt,
                                     (const magma_minproductFloatComplex**)dV_array,    lddv,
                         &c_one,     dC_array,    lddc, batchCount);
            ...
            // W2 = T V'
            cublasCgemmBatched(myhandle, cublas_trans_const(trans), cublas_trans_const(transV),
                         k, n, k,
                         &c_one,  (const magma_minproductFloatComplex**)dT_array, lddt,
                                  (const magma_minproductFloatComplex**)dV_array, lddv,
                         &c_zero, dworkvt_array, ldwvt, batchCount);
           ...
           cublasCgemmBatched(myhandle, cublas_trans_const(Magma_minproductNoTrans), cublas_trans_const(Magma_minproductNoTrans),
                         m, n, k,
                         &c_neg_one, (const magma_minproductFloatComplex**)dwork_array,   ldw,
                                     (const magma_minproductFloatComplex**)dworkvt_array, ldwvt,
                         &c_one,     dC_array,      lddc, batchCount);
        }
    }
