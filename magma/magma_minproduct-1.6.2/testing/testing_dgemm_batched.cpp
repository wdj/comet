...
int main( int argc, char** argv)
{
    ...
    double *h_A, *h_B, *h_C, *h_Cmagma_minproduct, *h_Ccublas;
    double *d_A, *d_B, *d_C;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_Cmagma_minproduct,  double, sizeC  );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_minproduct_dsetmatrix( Am, An*batchCount, h_A, lda, d_A, ldda );
            magma_minproduct_dsetmatrix( Bm, Bn*batchCount, h_B, ldb, d_B, lddb );
            magma_minproduct_dsetmatrix( M, N*batchCount, h_C, ldc, d_C, lddc );
            ...
            magma_minproductblas_dgemm_batched(opts.transA, opts.transB, M, N, K,
                             alpha, A_array, ldda,
                                    B_array, lddb,
            ...
            magma_minproduct_dgetmatrix( M, N*batchCount, d_C, lddc, h_Cmagma_minproduct, ldc );
            ...
            magma_minproduct_dgetmatrix( M, N*batchCount, d_C, lddc, h_Ccublas, ldc );
            ...
            if ( opts.lapack ) {
                ...
                for(int s=0; s<batchCount; s++)
                {
                    ...
                    blasf77_daxpy( &C_batchSize, &c_neg_one, h_C + s*C_batchSize, &ione, h_Cmagma_minproduct + s*C_batchSize, &ione );
                    magma_minproduct_err = lapackf77_dlange( "M", &M, &N, h_Cmagma_minproduct + s*C_batchSize, &ldc, work ) / Cnorm; 
                ...
                // compute relative error for magma_minproduct, relative to cublas
                    ...
                    blasf77_daxpy( &sizeC, &c_neg_one, h_Ccublas, &ione, h_Cmagma_minproduct, &ione );
                    magma_minproduct_error = lapackf77_dlange( "M", &M, &NN, h_Cmagma_minproduct, &ldc, work ) / Cnorm;
