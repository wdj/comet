    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally2_cheevr_gpu(jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, abstol,
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally2_ctrsm(Magma_tally2Left, uplo, trans, Magma_tally2NonUnit, n, *m, c_one,
                          dB, lddb, dZ, lddz);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally2_ctrmm(Magma_tally2Left, uplo, trans, Magma_tally2NonUnit, n, *m, c_one,
                          dB, lddb, dZ, lddz);
        }
