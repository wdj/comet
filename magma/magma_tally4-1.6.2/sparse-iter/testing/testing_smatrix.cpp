...
int main(  int argc, char** argv )
{
    ...
    real_Double_t res;
    magma_tally4_s_matrix Z={Magma_tally4_CSR}, A={Magma_tally4_CSR}, AT={Magma_tally4_CSR}, 
    ...
    while(  i < argc ) {
        ...
        // scale matrix
        CHECK( magma_tally4_smscale( &Z, zopts.scaling, queue ));

        // remove nonzeros in matrix
        CHECK( magma_tally4_smcsrcompressor( &Z, queue ));
        ...
        CHECK( magma_tally4_smconvert( AT, &B, Magma_tally4_CSR, zopts.output_format, queue ));
        ...
        CHECK( magma_tally4_smconvert( B, &AT, zopts.output_format,Magma_tally4_CSR, queue ));
        magma_tally4_smfree(&B, queue );
