/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from magma_minproduct_zcuspaxpy.cpp normal z -> d, Sun May  3 11:22:59 2015
       @author Hartwig Anzt
...
magma_minproduct_dcuspaxpy(
    double *alpha, magma_minproduct_d_matrix A,
    double *beta, magma_minproduct_d_matrix B,
    ...
    magma_minproduct_queue_t queue )
{
    ...
    if (    A.memory_location == Magma_minproduct_DEV
        ...
        CHECK( magma_minproduct_dmalloc( &C.dval, C.nnz ));
        ...
        CHECK( magma_minproduct_dmtransfer( C, AB, Magma_minproduct_DEV, Magma_minproduct_DEV, queue ));
    }
    else {
