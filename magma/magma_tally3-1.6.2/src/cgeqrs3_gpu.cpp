    ...
    magma_tally3_int_t *info)
{
    ...
    */
    magma_tally3blas_cswapdblk(k-1, nb, dA(0,0), ldda, 1, dT(0), nb, 0);
    if ( nrhs == 1 ) {
        magma_tally3_ctrsv(Magma_tally3Upper, Magma_tally3NoTrans, Magma_tally3NonUnit,
                    n, dA(0,0), ldda, dB, 1);
    } else {
    ...
    magma_tally3blas_cswapdblk(k-1, nb, dT(0), nb, 0, dA(0,0), ldda, 1);
