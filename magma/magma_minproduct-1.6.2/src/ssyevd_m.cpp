    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_minproduct_ssytrd_mgpu(ngpu, 1, uplo, n, A, lda, w, &work[inde],
    ...
    if (! wantz) {
...
#else
        magma_minproduct_sstedx_m(ngpu, Magma_minproductRangeAll, n, 0., 0., 0, 0, w, &work[inde],
                       &work[indwrk], n, &work[indwk2],
        ...
        magma_minproduct_sormtr_m(ngpu, Magma_minproductLeft, uplo, Magma_minproductNoTrans, n, n, A, lda, &work[indtau],
