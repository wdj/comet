...
__global__ void
magma_minproductint_clag2z_sparse(  int M, int N,
...
magma_minproductblas_clag2z_sparse(
    ...
    const magma_minproductFloatComplex *SA, magma_minproduct_int_t ldsa,
    ...
    magma_minproduct_queue_t queue )
{
    ...
    *info = 0;
    ...
    dim3 grid( magma_minproduct_ceildiv( M, blksize ) );
    cudaMemcpyToSymbol( flag, info, sizeof(flag) );    // flag = 0
    magma_minproductint_clag2z_sparse<<< dimGrid , dimBlock, 0, queue >>>
