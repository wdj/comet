/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from testing_zherk_batched.cpp normal z -> c, Fri Jan 30 19:00:26 2015
...
int main( int argc, char** argv)
{
    ...
    float          current_error, magma_tally4_error, Cnorm, work[1];
    ...
    magma_tally4FloatComplex *h_A, *h_C, *h_Cmagma_tally4;
    magma_tally4FloatComplex *d_A, *d_C;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally4_csetmatrix( An, Ak*batchCount, h_A, lda, d_A, ldda );
            magma_tally4_csetmatrix( N, N*batchCount, h_C, ldc, d_C, lddc );
            
            cset_pointer(A_array, d_A, lda, 0, 0, ldda*Ak, batchCount, queue);
            cset_pointer(C_array, d_C, ldc, 0, 0, lddc*N,  batchCount, queue);

            magma_tally4_time = magma_tally4_sync_wtime( NULL );
            magma_tally4blas_cherk_batched(opts.uplo, opts.transA, N, K,
                             alpha, A_array, ldda,
            ...
            magma_tally4_cgetmatrix( N, NN, d_C, lddc, h_Cmagma_tally4, ldc );
            ...
            if ( opts.check ) {
                ...
                for(int i=0; i<batchCount; i++)
                {
                    Cnorm = lapackf77_clanhe("fro", lapack_uplo_const_tally4(opts.uplo), &N, h_C+i*ldc*N, &ldc, work);
                    blasf77_caxpy( &sizeC, &c_neg_one, h_C+i*ldc*N, &ione, h_Cmagma_tally4+i*ldc*N, &ione );
                    current_error = lapackf77_clanhe( "fro", lapack_uplo_const_tally4(opts.uplo), &N, h_Cmagma_tally4+i*ldc*N, &ldc, work ) / Cnorm;
