...
///////////////////////////////////////////////////////////////////////////////////////
static
__global__ void stepinit_ipiv_kernel(magma_tally3_int_t **ipiv_array, int pm)
{
    magma_tally3_int_t *ipiv = ipiv_array[blockIdx.x];
...
///////////////////////////////////////////////////////////////////////////////////////
static
__global__ void set_ipointer_kernel(magma_tally3_int_t **output_array,
...
__global__ void idisplace_pointers_kernel(magma_tally3_int_t **output_array,
               magma_tally3_int_t **input_array, magma_tally3_int_t lda,
               magma_tally3_int_t row, magma_tally3_int_t column)
{
      magma_tally3_int_t *inpt = input_array[blockIdx.x];
