...
void clacpy_full_kernel_batched(
    int m, int n,
    magma_tally4FloatComplex const * const *dAarray, int ldda,
...
magma_tally4blas_clacpy(
    ...
    magma_tally4FloatComplex_ptr       dB, magma_tally4_int_t lddb )
{
    magma_tally4blas_clacpy_q( uplo, m, n, dA, ldda, dB, lddb, magma_tally4_stream );
}
