...
// ----------------------------------------
// CUDA kernel for magma_minproduct_dlarfg.
...
/**
    ...
    @ingroup magma_minproduct_daux1
    ********************************************************************/
extern "C"
void magma_minproductblas_dlarfg_q(
...
/**
    @see magma_minproductblas_dlarfg_q
    @ingroup magma_minproduct_daux1
    ********************************************************************/
extern "C"
void magma_minproductblas_dlarfg(
    magma_minproduct_int_t n,
    magma_minproductDouble_ptr dalpha,
    magma_minproductDouble_ptr dx, magma_minproduct_int_t incx,
    magma_minproductDouble_ptr dtau )
