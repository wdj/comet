...
/**
    ...
    trans    magma_minproduct_trans_t.
      ...
      -     = Magma_minproductTrans:  C := alpha*A**H*B + conj( alpha )*B**H*A + beta*C.
    ...
    k        INTEGER.
             ...
             TRANS = Magma_minproductTrans, K specifies the number of rows of the
    ...
    ********************************************************************/
extern "C"
void magma_minproductblas_dsyr2k_mgpu_spec(
    ...
    magma_minproduct_int_t ngpu, magma_minproduct_int_t nb, magma_minproduct_queue_t queues[][20], magma_minproduct_int_t nqueue )
{
    ...
    for( magma_minproduct_int_t i = 0; i < n; i += ib ) {
        ...
        magma_minproduct_dgemm( Magma_minproductNoTrans, Magma_minproductTrans, n, ib, k,
    ...
    alpha = MAGMA_minproduct_D_CNJG( alpha );
