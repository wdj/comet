    ...
    magma_tally4_int_t *info)
{
    ...
    *info  = 0;
    ...
    if ( nb >= k ) {
        /* Use CPU code */
        lapackf77_zunmql( lapack_side_const_tally4(side), lapack_trans_const_tally4(trans),
        ...
        magma_tally4DoubleComplex *dwork, *dV, *dT, *dC;
        ...
        magma_tally4_zmalloc_pinned( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_tally4_zsetmatrix( m, n, C, ldc, dC, lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set lower triangle of panel in A to identity,
               ...
               3) restore A                                      */
            zpanel_to_q_tally4( Magma_tally4Lower, ib, A(nq_i-ib,i), lda, T2 );
            magma_tally4_zsetmatrix( nq_i,  ib, A(0,      i), lda, dV, nq_i );
            zq_to_panel_tally4( Magma_tally4Lower, ib, A(nq_i-ib,i), lda, T2 );
        ...
        magma_tally4_zgetmatrix( m, n, dC, lddc, C, ldc );
