...
int main( int argc, char** argv)
{
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
      ...
      for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_DEV(  dA_magma_tally3,  float, ldda*N * batchCount);
            ...
            magma_tally3_ssetmatrix( M, columns, h_R, lda, dA_magma_tally3, ldda );
            ...
            /* ====================================================================
               ...
               =================================================================== */
            sset_pointer(dA_array, dA_magma_tally3, ldda, 0, 0, ldda*N, batchCount, queue);
            magma_tally3_time = magma_tally3_sync_wtime(0);
            info = magma_tally3_sgetrf_nopiv_batched( M, N, dA_array, ldda, dinfo_magma_tally3, batchCount, queue);
            ...
            if ( opts.check ) {
                ...
                magma_tally3_sgetmatrix( M, N*batchCount, dA_magma_tally3, ldda, h_A, lda );
                for(int i=0; i<batchCount; i++)
                {
