...
int main( int argc, char** argv)
{
    ...
    float alpha = MAGMA_tally3_S_MAKE( 3.1415, 2.718 );
    ...
    //magma_tally3blas_sgeadd( -1,  N, alpha, d_A, ldda, d_B, ldda );
    //magma_tally3blas_sgeadd(  M, -1, alpha, d_A, ldda, d_B, ldda );
    //magma_tally3blas_sgeadd(  M,  N, alpha, d_A, M-1,  d_B, ldda );
    //magma_tally3blas_sgeadd(  M,  N, alpha, d_A, ldda, d_B, N-1  );
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally3blas_sgeadd( M, N, alpha, d_A, ldda, d_B, ldda );
