...
static    double neg_one = MAGMA_minproduct_D_NEG_ONE;
...

{
    ...
    magma_minproductblas_dgemm_batched(Magma_minproductConjTrans, Magma_minproductNoTrans, k, n, m,
                             one, (const double**) dV_array, ldv,
                                    (const double**) dA_array, lda,
                             zero,  W_array, ldw, batchCount );
    ...
    // W2 = T^H * W        
    magma_minproductblas_dgemm_batched(Magma_minproductConjTrans, Magma_minproductNoTrans, k, n, k,
                             one, (const double**) dT_array, ldt,
                                    (const double**) W_array, ldw,
                             zero,  W2_array, ldw2, batchCount );
    ...
    // A = A - V * W2 
    magma_minproductblas_dgemm_batched(Magma_minproductNoTrans, Magma_minproductNoTrans, m, n, k,
                             neg_one, (const double**) dV_array, ldv,
                                    (const double**) W2_array, ldw2,
                             one,  dA_array, lda, batchCount );
