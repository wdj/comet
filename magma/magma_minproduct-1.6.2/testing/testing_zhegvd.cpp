...
int main( int argc, char** argv)
{
    ...
    magma_minproductDoubleComplex *h_A, *h_R, *h_B, *h_S, *h_work;
    double *w1, *w2;
    double result[4] = {0, 0, 0, 0};
    magma_minproduct_int_t *iwork;
    magma_minproduct_int_t N, n2, info, nb, lwork, liwork, lda;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_B,    magma_minproductDoubleComplex,  n2     );
            ...
            TESTING_MALLOC_PIN( h_S,    magma_minproductDoubleComplex,  n2     );
            ...
            magma_minproduct_zmake_hpd( N, h_B, lda );
            lapackf77_zlacpy( Magma_minproductFullStr, &N, &N, h_A, &lda, h_R, &lda );
            lapackf77_zlacpy( Magma_minproductFullStr, &N, &N, h_B, &lda, h_S, &lda );
            ...
            if ( opts.check && opts.jobz != Magma_minproductNoVec ) {
                ...
                */
                ...
                //lapackf77_zlacpy( Magma_minproductFullStr, &N, &N, h_B, &lda, h_S, &lda );
                //
                //magma_minproduct_zhegvd( opts.itype, Magma_minproductNoVec, opts.uplo,
            ...
            if ( opts.lapack ) {
                printf(    "    | D_magma_minproduct - D_lapack | / |D|  = %8.2e   %s\n\n", result[3], (result[3] < tolulp ? "ok" : "failed") );
