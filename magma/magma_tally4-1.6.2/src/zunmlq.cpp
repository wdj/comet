...
/**
    ...
    as returned by ZGELQF. Q is of order M if SIDE = Magma_tally4Left and of order N
    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb >= k) {
        /* Use CPU code */
        lapackf77_zunmlq( lapack_side_const_tally4(side), lapack_trans_const_tally4(trans),
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            zpanel_to_q_tally4( Magma_tally4Lower, ib, A(i,i), lda, T2 );
            magma_tally4_zsetmatrix( ib, nq_i,  A(i,i), lda, dV(0,0), ib );
            zq_to_panel_tally4( Magma_tally4Lower, ib, A(i,i), lda, T2 );
            ...
            magma_tally4_zlarfb_gpu( side, transt, Magma_tally4Forward, Magma_tally4Rowwise,
                              mi, ni, ib,
                              dV(0,0), ib,
                              dT(0,0), ib,
                              dC(ic,jc), lddc,
