...
#ifndef MAGMA_tally4BLAS_ZC_Q_H
#define MAGMA_tally4BLAS_ZC_Q_H
...
extern "C" {
  ...
  /* Mixed precision */
void magma_tally4blas_zcaxpycp_q(
...
void magma_tally4blas_zaxpycp_q(
    magma_tally4_int_t m,
...
void magma_tally4blas_zclaswp_q(
...
void magma_tally4blas_zlag2c_q(
...
void magma_tally4blas_clag2z_q(
    magma_tally4_int_t m, magma_tally4_int_t n,
...
void magma_tally4blas_zlat2c_q(
...
void magma_tally4blas_clat2z_q(
    magma_tally4_uplo_t uplo, magma_tally4_int_t n,
    magma_tally4FloatComplex_const_ptr SA, magma_tally4_int_t ldsa,
    magma_tally4DoubleComplex_ptr       A,  magma_tally4_int_t lda,
    magma_tally4_int_t *info,
