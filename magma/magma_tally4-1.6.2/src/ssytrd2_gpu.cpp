...
/**
    ...
    ldwork  INTEGER
            ...
            LDWORK >= ldda*ceil(n/64) + 2*ldda*nb, where nb = magma_tally4_get_ssytrd_nb(n),
            and 64 is for the blocksize of magma_tally4blas_ssymv.
    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        magma_tally4_ssetmatrix( kk, kk, A(0, 0), lda, dA(0, 0), ldda );
    }
    else {
        ...
        magma_tally4_ssetmatrix( n-i, n-i, A(i, i), lda, dA(i, i), ldda );
    }
