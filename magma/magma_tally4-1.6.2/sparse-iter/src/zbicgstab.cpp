    ...
    magma_tally4_queue_t queue )
{
    ...
    // workspace
    magma_tally4_z_matrix r={Magma_tally4_CSR}, rr={Magma_tally4_CSR}, p={Magma_tally4_CSR}, v={Magma_tally4_CSR}, s={Magma_tally4_CSR}, t={Magma_tally4_CSR};
    ...
    do
    {
        ...
        omega = magma_tally4_zdotc( dofs, t.dval, 1, s.dval, 1 )   // omega = <s,t>/<t,t>
                   / magma_tally4_zdotc( dofs, t.dval, 1, t.dval, 1 );

        magma_tally4_zaxpy( dofs, alpha, p.dval, 1 , x->dval, 1 );     // x=x+alpha*p
        magma_tally4_zaxpy( dofs, omega, s.dval, 1 , x->dval, 1 );     // x=x+omega*s
