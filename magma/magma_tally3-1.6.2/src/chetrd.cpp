    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    #endif
    if (MAGMA_tally3_SUCCESS != magma_tally3_cmalloc( &dA, ldda*n + 2*lddw*nb + ldwork2 )) {
        *info = MAGMA_tally3_ERR_DEVICE_ALLOC;
        return *info;
    }

    magma_tally3FloatComplex *dwork  = dA + ldda*n;
    #ifdef FAST_HEMV
    magma_tally3FloatComplex *dwork2 = dwork + 2*lddw*nb;
    #endif
