    ...
    magma_tally2_queue_t queue )
{
    ...
    // workspace
    magma_tally2_z_matrix r={Magma_tally2_CSR}, rr={Magma_tally2_CSR}, p={Magma_tally2_CSR}, v={Magma_tally2_CSR}, s={Magma_tally2_CSR}, t={Magma_tally2_CSR};
    ...
    do
    {
        ...
        omega = magma_tally2_zdotc( dofs, t.dval, 1, s.dval, 1 )   // omega = <s,t>/<t,t>
                   / magma_tally2_zdotc( dofs, t.dval, 1, t.dval, 1 );

        magma_tally2_zaxpy( dofs, alpha, p.dval, 1 , x->dval, 1 );     // x=x+alpha*p
        magma_tally2_zaxpy( dofs, omega, s.dval, 1 , x->dval, 1 );     // x=x+omega*s
