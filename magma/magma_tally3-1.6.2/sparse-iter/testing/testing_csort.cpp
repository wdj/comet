...
int main(  int argc, char** argv )
{
    ...
    magma_tally3_c_matrix A={Magma_tally3_CSR};
    ...
    printf("sorting...");
    CHECK( magma_tally3_cindexsort(x, 0, n-1, queue ));
    printf("done.\n\n");
    ...
    while(  i < argc ) {
        ...
        CHECK( magma_tally3_cdomainoverlap( A.num_rows, &num_ind, A.row, A.col, x, queue ));
