    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_minproduct_zhetrd_mgpu(ngpu, 1, uplo, n, A, lda, w, &rwork[inde],
    ...
    if (! wantz) {
...
#else
        magma_minproduct_zstedx_m(ngpu, Magma_minproductRangeAll, n, 0, 0, 0, 0, w, &rwork[inde],
                       &work[indwrk], n, &rwork[indrwk],
        ...
        magma_minproduct_zunmtr_m(ngpu, Magma_minproductLeft, uplo, Magma_minproductNoTrans, n, n, A, lda, &work[indtau],
