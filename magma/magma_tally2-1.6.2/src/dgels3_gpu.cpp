    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally2_SUCCESS != magma_tally2_dmalloc( &dT, ldtwork )) {
        *info = MAGMA_tally2_ERR_DEVICE_ALLOC;
        return *info;
    }
    
    magma_tally2_dmalloc_cpu( &tau, k );
    if ( tau == NULL ) {
    ...
    magma_tally2_dgeqrf3_gpu( m, n, dA, ldda, tau, dT, info );
    if ( *info == 0 ) {
        magma_tally2_dgeqrs3_gpu( m, n, nrhs,
                           dA, ldda, tau, dT,
