                  ...
                  magma_minproduct_int_t batchCount, magma_minproduct_queue_t queue)
{
   ...
   /* check allocation */
    ...
    if (notran) {
        magma_minproduct_dlaswp_rowserial_batched(nrhs, dB_array, lddb, 1, n, dipiv_array, batchCount, queue);
        ...
        // solve 
        magma_minproductblas_dtrsm_outofplace_batched(Magma_minproductLeft, Magma_minproductUpper, trans, Magma_minproductUnit, 1,
                n, nrhs,
                MAGMA_minproduct_D_ONE,
                dA_array,       ldda, // dA
                dB_array,      lddb, // dB
        ...
        // solve 
        magma_minproductblas_dtrsm_outofplace_batched(Magma_minproductLeft, Magma_minproductLower, trans, Magma_minproductNonUnit, 1,
                n, nrhs,
                MAGMA_minproduct_D_ONE,
                dA_array,       ldda, // dA
                dwork_array,        n, // dB 
