...
caxpy16(
    ...
    magma_tally4FloatComplex       * __restrict__ c )
{
    c[0]  += alpha * b[0];
    c[1]  += alpha * b[1];
    c[2]  += alpha * b[2];
...
cgemm_kernel_16(
    ...
    magma_tally4FloatComplex *B, int ldb,
    magma_tally4FloatComplex *C, int ldc,
    magma_tally4FloatComplex alpha, int jb, int tx, int ty)
{
...
ctrtri_diag_lower_kernel(
    magma_tally4_diag_t diag, int n, const magma_tally4FloatComplex *A, int lda, magma_tally4FloatComplex *d_invA);

__global__ void
triple_cgemm16_part1_lower_kernel(
    int n, const magma_tally4FloatComplex *Ain, int lda, magma_tally4FloatComplex *d_invA, int jb, int npages);
