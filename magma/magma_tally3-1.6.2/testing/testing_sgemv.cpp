...
int main(int argc, char **argv)
{
    ...
    float          magma_tally3_error, dev_error, work[1];
    ...
    float *A, *X, *Y, *Ydev, *Ymagma_tally3;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally3_ssetmatrix( M, N, A, lda, dA, lda );
            magma_tally3_ssetvector( Xm, X, incx, dX, incx );
            magma_tally3_ssetvector( Ym, Y, incy, dY, incy );
            
            #ifdef HAVE_CUBLAS
                dev_time = magma_tally3_sync_wtime( 0 );
                cublasSgemv( opts.handle, cublas_trans_const_tally3(opts.transA),
                ...
                magma_tally3_sgemv( opts.transA, M, N,
                             &alpha, dA, lda,
                                     dX, incx,
                             &beta,  dY, incy );
            ...
            magma_tally3_sgetvector( Ym, dY, incy, Ydev, incy );
            ...
            /* =====================================================================
               ...
               =================================================================== */
                ...
                magma_tally3blas_sgemv( opts.transA, M, N, alpha, dA, lda, dX, incx, beta, dY, incy );
                magma_tally3_time = magma_tally3_sync_wtime( 0 ) - magma_tally3_time;
                magma_tally3_perf = gflops / magma_tally3_time;
                
                magma_tally3_sgetvector( Ym, dY, incy, Ymagma_tally3, incy );
            #endif
            ...
            blasf77_sgemv( lapack_trans_const_tally3(opts.transA), &M, &N,
                           &alpha, A, &lda,
                                   X, &incx,
                           &beta,  Y, &incy );
            ...
            #ifdef HAVE_CUBLAS
                blasf77_saxpy( &Ym, &c_neg_one, Y, &incy, Ymagma_tally3, &incy );
                magma_tally3_error = lapackf77_slange( "F", &Ym, &ione, Ymagma_tally3, &Ym, work ) / (Anorm * Xnorm);
