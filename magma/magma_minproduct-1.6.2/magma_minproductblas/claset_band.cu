    ...
    magma_minproductFloatComplex *A, int lda)
{
    ...
    magma_minproductFloatComplex value = offdiag;
    if (threadIdx.x == k-1)
        value = diag;
...
/**
    @see magma_minproductblas_claset_band_q
    @ingroup magma_minproduct_caux2
    ********************************************************************/
extern "C" void
magma_minproductblas_claset_band(
    ...
    magma_minproductFloatComplex_ptr dA, magma_minproduct_int_t ldda)
{
    magma_minproductblas_claset_band_q(uplo, m, n, k, offdiag, diag, dA, ldda, magma_minproduct_stream);
}
