/*
    -- MAGMA_tally3 (version 1.6.1) --
       ...
       @generated from testing_ztrmm.cpp normal z -> c, Fri Jan 30 19:00:23 2015
...
int main( int argc, char** argv)
{
    ...
    magma_tally3FloatComplex *h_A, *h_B, *h_Bcublas;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            cublasCtrmm( opts.handle, cublas_side_const_tally3(opts.side), cublas_uplo_const_tally3(opts.uplo),
