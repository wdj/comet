...
__global__ void
magma_minproduct_dreduce_kernel_spmv1(    
    int Gs,
    int n, 
    double * vtmp,
    double * vtmp2 )
...
__global__ void
magma_minproduct_dbicgmerge_spmv1_kernel(  
    int n,
    double * dval, 
...
__global__ void
magma_minproduct_dbicgstab_alphakernel(  
                    double * skp ){
    ...
    magma_minproduct_queue_t queue )
{
    ...
    if ( A.storage_type == Magma_minproduct_CSR)
        magma_minproduct_dbicgmerge_spmv1_kernel<<<Gs, Bs, Ms>>>
    ...
    while( Gs.x > 1 ) {
        ...
        magma_minproduct_dreduce_kernel_spmv1<<< Gs_next.x/2, Bs.x/2, Ms/2 >>> 
                            ( Gs.x, n, aux1, aux2 );
    ...
    magma_minproduct_dcopyvector( 1, aux1, 1, skp, 1 );
    dim3 Bs2( 2 );
    dim3 Gs2( 1 );
    magma_minproduct_dbicgstab_alphakernel<<<Gs2, Bs2, 0>>>( skp );
...
__global__ void
magma_minproduct_dreduce_kernel_spmv2( 
    int Gs,
    int n, 
    double * vtmp,
    double * vtmp2 )
...
__global__ void
magma_minproduct_dbicgmerge_spmv2_kernel(  
    int n,
    double * dval, 
    magma_minproduct_index_t * drowptr, 
    magma_minproduct_index_t * dcolind,
...
__global__ void
magma_minproduct_dbicgstab_omegakernel(  
                    double * skp ){
    int i = blockIdx.x * blockDim.x + threadIdx.x;
...
/**
    ...
    @param[in]
    ds          magma_minproductDouble_ptr
                input vector s

    @param[in]
    dt          magma_minproductDouble_ptr
                output vector t
    ...
    magma_minproduct_queue_t queue )
{
    ...
    int b = 1;        
    if ( A.storage_type == Magma_minproduct_CSR)
        magma_minproduct_dbicgmerge_spmv2_kernel<<<Gs, Bs, Ms>>>
    ...
    while( Gs.x > 1 ) {
        Gs_next.x = ( Gs.x+Bs.x-1 )/ Bs.x ;
        if ( Gs_next.x == 1 ) Gs_next.x = 2;
        magma_minproduct_dreduce_kernel_spmv2<<< Gs_next.x/2, Bs.x/2, Ms/2 >>> 
                    ( Gs.x, n, aux1, aux2 );
        Gs_next.x = Gs_next.x /2;
        Gs.x = Gs_next.x;
        b = 1 - b;
    ...
    magma_minproduct_dcopyvector( 1, aux1, 1, skp+6, 1 );
    magma_minproduct_dcopyvector( 1, aux1+n, 1, skp+7, 1 );
    dim3 Bs2( 2 );
    dim3 Gs2( 1 );
    magma_minproduct_dbicgstab_omegakernel<<<Gs2, Bs2, 0>>>( skp );
...
__global__ void
magma_minproduct_dbicgmerge_xrbeta_kernel(  
    int n, 
    double * rr,
    double * r,
    double * p,
...
__global__ void
magma_minproduct_dbicgstab_betakernel(  
    double * skp )
{
    int i = blockIdx.x * blockDim.x + threadIdx.x;
...
/**
    ...
    @param[in]
    p           magma_minproductDouble_ptr
                input vector p

    @param[in]
    s           magma_minproductDouble_ptr
                input vector s

    @param[in]
    t           magma_minproductDouble_ptr
                input vector t

    @param[out]
    x           magma_minproductDouble_ptr
                output vector x
...
magma_minproduct_dbicgmerge_xrbeta(
    ...
    magma_minproductDouble_ptr d1,
    magma_minproductDouble_ptr d2,
    magma_minproductDouble_ptr rr,
    magma_minproductDouble_ptr r,
    magma_minproductDouble_ptr p,
    magma_minproductDouble_ptr s,
    magma_minproductDouble_ptr t,
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproductDouble_ptr aux1 = d1, aux2 = d2;
    int b = 1;        
    magma_minproduct_dbicgmerge_xrbeta_kernel<<<Gs, Bs, Ms>>>
    ...
    magma_minproduct_dcopyvector( 1, aux1+n, 1, skp+5, 1 );
    dim3 Bs2( 2 );
    dim3 Gs2( 1 );
    magma_minproduct_dbicgstab_betakernel<<<Gs2, Bs2, 0>>>( skp );
