...
int main(  int argc, char** argv )
{
    ...
    while( i < argc ) {
        ...
        // init CPU vectors
        CHECK( magma_tally4_zvinit( &hx, Magma_tally4_CPU, hA.num_rows, 1, c_zero, queue ));
        CHECK( magma_tally4_zvinit( &hy, Magma_tally4_CPU, hA.num_rows, 1, c_zero, queue ));

        // init DEV vectors
        CHECK( magma_tally4_zvinit( &dx, Magma_tally4_DEV, hA.num_rows, 1, c_one, queue ));
        CHECK( magma_tally4_zvinit( &dy, Magma_tally4_DEV, hA.num_rows, 1, c_zero, queue ));
        ...
        CHECK( magma_tally4_zmconvert(  hA, &hA_ELL, Magma_tally4_CSR, Magma_tally4_ELL, queue ));
        CHECK( magma_tally4_zmtransfer( hA_ELL, &dA_ELL, Magma_tally4_CPU, Magma_tally4_DEV, queue ));
        ...
        start = magma_tally4_sync_wtime( queue );
        for (j=0; j<10; j++)
            CHECK( magma_tally4_z_spmv( c_one, dA_ELL, dx, c_zero, dy, queue ));
        end = magma_tally4_sync_wtime( queue );
