...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_B,       magma_tally2FloatComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_X,       magma_tally2FloatComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_Blapack, magma_tally2FloatComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_Bcublas, magma_tally2FloatComplex, ldb*N   );
            TESTING_MALLOC_CPU( h_Bmagma_tally2,  magma_tally2FloatComplex, ldb*N   );
            TESTING_MALLOC_CPU( ipiv,      magma_tally2_int_t,        Ak      );
            
            TESTING_MALLOC_DEV( d_A,       magma_tally2FloatComplex, ldda*Ak );
            TESTING_MALLOC_DEV( d_B,       magma_tally2FloatComplex, lddb*N  );
            ...
            magma_tally2_csetmatrix( M, N, h_B, ldb, d_B, lddb );
            
            magma_tally2_time = magma_tally2_sync_wtime( NULL );
            magma_tally2blas_ctrsm( opts.side, opts.uplo, opts.transA, opts.diag, 
                             M, N,
                             alpha, d_A, ldda,
                                    d_B, lddb );
            ...
            magma_tally2_cgetmatrix( M, N, d_B, lddb, h_Bmagma_tally2, ldb );
            ...
            cublasCtrsm( opts.handle, cublas_side_const_tally2(opts.side), cublas_uplo_const_tally2(opts.uplo),
            ...
            magma_tally2_cgetmatrix( M, N, d_B, lddb, h_Bcublas, ldb );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_ctrsm( lapack_side_const_tally2(opts.side), lapack_uplo_const_tally2(opts.uplo),
                               lapack_trans_const_tally2(opts.transA), lapack_diag_const_tally2(opts.diag), 
                               &M, &N,
                               &alpha, h_A, &lda,
                                       h_Blapack, &ldb );
            ...
            blasf77_ctrmm( lapack_side_const_tally2(opts.side), lapack_uplo_const_tally2(opts.uplo),
                           lapack_trans_const_tally2(opts.transA), lapack_diag_const_tally2(opts.diag), 
                           &M, &N,
                           &alpha2, h_A, &lda,
                                    h_X, &ldb );
            ...
            normX = lapackf77_clange( "M", &M, &N, h_Bmagma_tally2, &ldb, work );
