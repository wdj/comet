/*
    ...
    magma_tally4_cblas_dzasum / dasum
    magma_tally4_cblas_dznrm2 / dnrm2
    magma_tally4_cblas_zdotc  / ddot
    magma_tally4_cblas_zdotu  / ddot
    ...
    const magma_tally4DoubleComplex *y, magma_tally4_int_t incy )
{
    ...
    magma_tally4DoubleComplex value = MAGMA_tally4_Z_ZERO;
    ...
    return value;
    //#ifdef COMPLEX
    //magma_tally4DoubleComplex value;
