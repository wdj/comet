...
/**
    ...
    ldwork  INTEGER
            ...
            LDWORK >= ldda*ceil(n/64) + 2*ldda*nb, where nb = magma_tally3_get_zhetrd_nb(n),
            and 64 is for the blocksize of magma_tally3blas_zhemv.
    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        magma_tally3_zsetmatrix( kk, kk, A(0, 0), lda, dA(0, 0), ldda );
    }
    else {
        ...
        magma_tally3_zsetmatrix( n-i, n-i, A(i, i), lda, dA(i, i), ldda );
    }
