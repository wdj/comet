    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally4_cheevr_gpu(jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, abstol,
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally4_ctrsm(Magma_tally4Left, uplo, trans, Magma_tally4NonUnit, n, *m, c_one,
                          dB, lddb, dZ, lddz);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally4_ctrmm(Magma_tally4Left, uplo, trans, Magma_tally4NonUnit, n, *m, c_one,
                          dB, lddb, dZ, lddz);
        }
