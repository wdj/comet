    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_smalloc( &dwork, ldwork_real )) {
        *info = MAGMA_minproduct_ERR_DEVICE_ALLOC;
        return *info;
    }
    dC = (magma_minproductFloatComplex*) dwork;
    ...
    if (iscale == 1) {
        magma_minproductblas_clascl( uplo, 0, 0, 1., sigma, n, n, dA, ldda, info );
    }
...
#ifdef FAST_HEMV
    magma_minproduct_chetrd2_gpu( uplo, n, dA, ldda, w, &rwork[inde],
                       &work[indtau], wA, ldwa, &work[indwrk], llwork,
                       dC, ldwork, &iinfo );
#else
    magma_minproduct_chetrd_gpu ( uplo, n, dA, ldda, w, &rwork[inde],
                       &work[indtau], wA, ldwa, &work[indwrk], llwork,
                       &iinfo );
#endif
    ...
    if (! wantz) {
        ...
        magma_minproduct_csetmatrix( n, *mout, &work[indwrk + n * (il-1) ], n, dC, lddc );

        magma_minproduct_cunmtr_gpu( Magma_minproductLeft, uplo, Magma_minproductNoTrans, n, *mout, dA, ldda, &work[indtau],
                          dC, lddc, wA, ldwa, &iinfo );

        magma_minproduct_ccopymatrix( n, *mout, dC, lddc, dA, ldda );
