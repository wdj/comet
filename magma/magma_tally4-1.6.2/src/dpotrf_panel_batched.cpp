    ...
    magma_tally4_int_t batchCount, cublasHandle_t myhandle, magma_tally4_queue_t queue)
{
    ...
    //===============================================
    if(n<nb){
        printf("magma_tally4_dpotrf_panel error n < nb %d < %d \n",(int) n, (int) nb);
        return -101;
    }
    ...
    if((n-nb) > 0){
        ...
        magma_tally4blas_dtrsm_work_batched(Magma_tally4Right, Magma_tally4Lower, Magma_tally4ConjTrans, Magma_tally4NonUnit,
                              1, n-nb, nb, 
                              MAGMA_tally4_D_ONE,
                              dA_array,    ldda, 
                              dW0_displ,   ldda, 
    ...
    magma_tally4_int_t batchCount, cublasHandle_t myhandle, magma_tally4_queue_t queue)
{
    ...
    if(panel_nb <= min_recpnb){
        ...
        //magma_tally4_dpotrf_rectile_batched(uplo, m, panel_nb, 16,
        magma_tally4_dpotrf_panel_batched( uplo, m, panel_nb,
                           dA_displ, ldda,
                           dX_array, dX_length,
                           dinvA_array, dinvA_length,
        ...
        magma_tally4_ddisplace_pointers(dA_displ,  dA_array, ldda, p1+n1, p1, batchCount, queue);        
        magma_tally4_ddisplace_pointers(dW0_displ, dA_array, ldda, p1+n1, p2, batchCount, queue);        
        magma_tally4blas_dgemm_batched(Magma_tally4NoTrans, Magma_tally4ConjTrans, m2, n2, n1,
                              alpha, dA_displ, ldda, 
                              dA_displ, ldda, 
                              beta,  dW0_displ, ldda, 
                              batchCount, queue);
    ...
    magma_tally4_int_t batchCount, cublasHandle_t myhandle, magma_tally4_queue_t queue)
{
    ...
    if(panel_nb <= min_recpnb){
        ...
        magma_tally4_ddisplace_pointers(dA_displ,  dA_array, ldda, p1, p1, batchCount, queue);        
        magma_tally4_ddisplace_pointers(dW0_displ, dA_array, ldda, p2, p1, batchCount, queue);
        magma_tally4blas_dtrsm_work_batched(Magma_tally4Right, Magma_tally4Lower, Magma_tally4ConjTrans, Magma_tally4NonUnit,
                              1, n2, n1, 
                              MAGMA_tally4_D_ONE,
                              dA_displ,    ldda, 
        ...
        magma_tally4_ddisplace_pointers(dA_displ,  dA_array, ldda, p2, p1, batchCount, queue);        
        magma_tally4_ddisplace_pointers(dW0_displ, dA_array, ldda, p2, p2, batchCount, queue);        
        magma_tally4blas_dgemm_batched(Magma_tally4NoTrans, Magma_tally4ConjTrans, n2, n2, n1,
                              alpha, dA_displ, ldda, 
                              dA_displ, ldda, 
                              beta,  dW0_displ, ldda, 
                              batchCount, queue);
    ...
    if(m>n){
        ...
        magma_tally4_ddisplace_pointers(dA_displ,  dA_array, ldda, 0, 0, batchCount, queue);        
        magma_tally4_ddisplace_pointers(dW0_displ, dA_array, ldda, n, 0, batchCount, queue);
        magma_tally4blas_dtrsm_work_batched(Magma_tally4Right, Magma_tally4Lower, Magma_tally4ConjTrans, Magma_tally4NonUnit,
                              1, m-n, n, 
                              MAGMA_tally4_D_ONE,
                              dA_displ,    ldda, 
