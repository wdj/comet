...
int main(int argc, char **argv)
{
    ...
    magma_tally3FloatComplex *A, *X, *Y, *Ydev, *Ymagma_tally3;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( Ydev,    magma_tally3FloatComplex, sizeY );
            TESTING_MALLOC_CPU( Ymagma_tally3,  magma_tally3FloatComplex, sizeY );
            
            TESTING_MALLOC_DEV( dA, magma_tally3FloatComplex, sizeA );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally3_csetmatrix( M, N, A, lda, dA, lda );
            magma_tally3_csetvector( Xm, X, incx, dX, incx );
            magma_tally3_csetvector( Ym, Y, incy, dY, incy );
            
            #ifdef HAVE_CUBLAS
                dev_time = magma_tally3_sync_wtime( 0 );
                cublasCgemv( opts.handle, cublas_trans_const_tally3(opts.transA),
                ...
                magma_tally3_cgemv( opts.transA, M, N,
                             &alpha, dA, lda,
                                     dX, incx,
                             &beta,  dY, incy );
            ...
            magma_tally3_cgetvector( Ym, dY, incy, Ydev, incy );
            ...
            /* =====================================================================
               ...
               =================================================================== */
                ...
                magma_tally3blas_cgemv( opts.transA, M, N, alpha, dA, lda, dX, incx, beta, dY, incy );
                magma_tally3_time = magma_tally3_sync_wtime( 0 ) - magma_tally3_time;
                magma_tally3_perf = gflops / magma_tally3_time;
                
                magma_tally3_cgetvector( Ym, dY, incy, Ymagma_tally3, incy );
            #endif
            ...
            blasf77_cgemv( lapack_trans_const_tally3(opts.transA), &M, &N,
                           &alpha, A, &lda,
                                   X, &incx,
                           &beta,  Y, &incy );
            ...
            #ifdef HAVE_CUBLAS
                blasf77_caxpy( &Ym, &c_neg_one, Y, &incy, Ymagma_tally3, &incy );
                magma_tally3_error = lapackf77_clange( "F", &Ym, &ione, Ymagma_tally3, &Ym, work ) / (Anorm * Xnorm);
