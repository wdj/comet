...
int main( int argc, char** argv)
{
    ...
    magma_tally2DoubleComplex *h_A, *h_R, *U, *VT, *h_work;
    magma_tally2DoubleComplex dummy[1];
    double *S1, *S2;
    #ifdef COMPLEX
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            switch( opts.svd_work ) {
                case 0: {  // query for workspace size
                    lwork = -1;
                    magma_tally2_zgesdd( jobz, M, N,
                                  NULL, lda, NULL, NULL, ldu, NULL, ldv, dummy, lwork,
                                  #ifdef COMPLEX
                                  NULL,
                                  #endif
                                  NULL, &info );
                    lwork = (int) MAGMA_tally2_Z_REAL( dummy[0] );
                    break;
                }
            ...
            TESTING_MALLOC_CPU( VT,    magma_tally2DoubleComplex, ldv*N );   // N x N (jobz=A) or min(M,N) x N
            TESTING_MALLOC_CPU( U,     magma_tally2DoubleComplex, ldu*N_U ); // M x M (jobz=A) or M x min(M,N)
            ...
            if (info != 0)
                printf("magma_tally2_zgesdd returned error %d: %s.\n",
            ...
            if ( opts.check ) {
                ...
                magma_tally2DoubleComplex *U2  = NULL;
                magma_tally2DoubleComplex *VT2 = NULL;
                ...
                magma_tally2DoubleComplex *h_work_err;
                TESTING_MALLOC_CPU( h_work_err, magma_tally2DoubleComplex, lwork_err );
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_zgesdd( lapack_vec_const_tally2(jobz), &M, &N,
