    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally3_dsetmatrix( n, n, &work[indwrk], n, dwork, lddc );

        magma_tally3_dormtr_gpu( Magma_tally3Left, uplo, Magma_tally3NoTrans, n, n, dA, ldda, &work[indtau],
                          dwork, lddc, wA, ldwa, &iinfo );

        magma_tally3_dcopymatrix( n, n, dwork, lddc, dA, ldda );
