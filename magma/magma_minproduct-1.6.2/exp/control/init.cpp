...
extern "C" magma_minproduct_context *
magma_minproduct_init( void *params, void* (*func)(void *a), magma_minproduct_int_t nthread, magma_minproduct_int_t ncpu, magma_minproduct_int_t ngpu,
...
/*  -- MAGMA_minproduct (version 1.6.1) --
    ...
    subsequent calls to routines in the MAGMA_minproduct library.
    ...
    context  = (magma_minproduct_context *)malloc(sizeof(magma_minproduct_context));
...
extern "C" void
magma_minproduct_finalize( magma_minproduct_context *cntxt)
{
/*  -- MAGMA_minproduct (version 1.6.1) --
       Univ. of Tennessee, Knoxville
       Univ. of California, Berkeley
    ...
    Purpose
    =======
    This function finalizes the MAGMA_minproduct hardware context.

    Arguments
    =========
    CNTXT  (input) MAGMA_minproduct_CONTEXT
           Pointer to the MAGMA_minproduct hardware context to be closed
    ===================================================================== */
