    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if ( (nb > 1) && (nb < k) ) {
        ...
        magma_tally3blas_slaset( Magma_tally3Full, m-kk, n-kk, c_zero, c_one,  dA(kk,kk), ldda );
    }
    else {
        ki = 0;
        kk = 0;
    ...
    if (kk < n) {
        ...
        i__2 = n - kk;
        i__3 = k - kk;
        //magma_tally3_sgetmatrix(i__1, i__2, dA(kk, kk), ldda, panel, i__1);
        //lapackf77_sorgqr(&i__1, &i__2, &i__3, panel, &i__1, &tau[kk],
        //                 work, &lwork, &iinfo);
        //
        //magma_tally3_ssetmatrix(i__1, i__2, panel, i__1, dA(kk, kk), ldda);
        ...
        //magma_tally3blas_slaset(Magma_tally3Full, kk-nb,     nb, c_zero, c_zero, dA(0,kk-nb),     ldda);
        //magma_tally3blas_slaset(Magma_tally3Full, m-(kk-nb), nb, c_zero, c_one,  dA(kk-nb,kk-nb), ldda);
    }
    ...
    if (kk > 0) {
        ...
        for (i = ki; i >= nb; i -= nb) {
            ...
            i__2 = m - i;
            //magma_tally3_sgetmatrix_async( i__2, ib, dA(i,i), ldda, panel, i__2, stream[0] );  // verify
            if (i + ib < n) {
                /* Apply H to A(i:m,i+ib:n) from the left */
                i__3 = n - i;

                magma_tally3blas_slaset( Magma_tally3Full, i,   ib, c_zero, c_zero, dA(0,i), ldda );
                magma_tally3blas_slaset( Magma_tally3Full, m-i, ib, c_zero, c_one,  dA(i,i), ldda );
            ...
            //                 work, &lwork, &iinfo);
            //magma_tally3_ssetmatrix_async( i__2, ib, panel, i__2, dA(i,i), ldda, stream[1] );  // verify

            /* Set rows 1:i-1 of current block to zero */
            i__2 = i + ib;
            //magma_tally3blas_slaset(Magma_tally3Full, i-ib,     ib, c_zero, c_zero, dA(0,i-ib),    ldda);
            //magma_tally3blas_slaset(Magma_tally3Full, m-(i-ib), ib, c_zero, c_one,  dA(i-ib,i-ib), ldda);
        }
    }

    magma_tally3blas_slaset( Magma_tally3Full, m, nb, c_zero, c_one, dA(0,0), ldda );
