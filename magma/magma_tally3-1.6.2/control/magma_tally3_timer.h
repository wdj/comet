...
#ifndef MAGMA_tally3_TIMER_H
#define MAGMA_tally3_TIMER_H

#include <stdio.h>

#include "magma_tally3.h"

typedef double    magma_tally3_timer_t;
typedef long long magma_tally3_flops_t;
    ...
    #include <stdarg.h>
        ...
        #include <papi.h>
        extern int gPAPI_flops_set;  // defined in testing/magma_tally3_util.cpp
    #endif
#endif
...
static inline void timer_start( magma_tally3_timer_t &t )
{
    #if defined(ENABLE_TIMER)
    t = magma_tally3_wtime();
    #endif
}
...
//
// magma_tally3_timer_t time, time_sum=0;
// for( ... ) {
//     timer_start( time );
//     ...do timed operations...
...
static inline magma_tally3_timer_t timer_stop( magma_tally3_timer_t &t )
{
    #if defined(ENABLE_TIMER)
    t = magma_tally3_wtime() - t;
    return t;
    #else
    return 0;
    #endif
...
// ------------------------------------------------------------
// see gPAPI_flops_set in testing/magma_tally3_util.cpp

// Set flops counter to current flops.
// If ENABLE_TIMER and HAVE_PAPI are not both defined, does nothing.
static inline void flops_start( magma_tally3_flops_t &flops )
{
...
static inline magma_tally3_flops_t flops_stop( magma_tally3_flops_t &flops )
{
    #if defined(ENABLE_TIMER) && defined(HAVE_PAPI)
    magma_tally3_flops_t end;
...
#endif        //  #ifndef MAGMA_tally3_TIMER_H
