    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if ( *info == 0 ) {
        ...
        magma_minproduct_zgetrs_gpu( Magma_minproductNoTrans, n, nrhs, dA, ldda, ipiv, dB, lddb, info );
...
CPU_INTERFACE:
    ...
    magma_minproduct_zgetrf( n, n, A, lda, ipiv, info );
    if ( *info == 0 ) {
        lapackf77_zgetrs( Magma_minproductNoTransStr, &n, &nrhs, A, &lda, ipiv, B, &ldb, info );
    }
    return *info;
}
