...
int main( int argc, char** argv)
{
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
      ...
      for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_DEV(  dA_magma_minproduct,  double, ldda*N * batchCount);
            ...
            magma_minproduct_dsetmatrix( M, columns, h_R, lda, dA_magma_minproduct, ldda );
            ...
            /* ====================================================================
               ...
               =================================================================== */
            dset_pointer(dA_array, dA_magma_minproduct, ldda, 0, 0, ldda*N, batchCount, queue);
            magma_minproduct_time = magma_minproduct_sync_wtime(0);
            info = magma_minproduct_dgetrf_nopiv_batched( M, N, dA_array, ldda, dinfo_magma_minproduct, batchCount, queue);
            ...
            if ( opts.check ) {
                ...
                magma_minproduct_dgetmatrix( M, N*batchCount, dA_magma_minproduct, ldda, h_A, lda );
                for(int i=0; i<batchCount; i++)
                {
