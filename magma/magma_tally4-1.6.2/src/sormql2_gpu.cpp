    ...
    magma_tally4_int_t *info)
{
    ...
    magma_tally4_smalloc( &dwork, 2*(m + 64)*64 );
    ...
    *info  = 0;
    ...
    magma_tally4blas_slaset_band( Magma_tally4Lower, k, k, nb, c_zero, c_one, dA, ldda );
    ...
    for (i = i1; (step < 0 ? i >= i2 : i <= i2); i += step) {
        ...
        magma_tally4_ssetmatrix( ib, ib, T, ib, dwork+i__4*ib, ib );
