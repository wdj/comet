    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally3_dstedx(range, n, vl, vu, il, iu, w, &work[inde],
        ...
        if (MAGMA_tally3_SUCCESS != magma_tally3_dmalloc( &dZ, *m*lddz)) {
            *info = MAGMA_tally3_ERR_DEVICE_ALLOC;
            return *info;
        }
        ...
        magma_tally3_dbulge_back(uplo, n, nb, *m, Vblksiz, &work[indwrk + n * (il-1)], n, dZ, lddz,
        ...
        magma_tally3_dsetmatrix( n, n, A, lda, dA, ldda );

        magma_tally3_dormqr_gpu_2stages(Magma_tally3Left, Magma_tally3NoTrans, n-nb, *m, n-nb, dA+nb, ldda,
                                 dZ+nb, n, dT1, nb, info);

        magma_tally3_dgetmatrix( n, *m, dZ, lddz, A, lda );
