/*
    -- MAGMA_tally3 (version 1.6.2) --
       ...
       @generated from magma_tally3_zmcsrpass_gpu.cpp normal z -> s, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_tally3_queue_t queue )
{
    ...
    magma_tally3_s_matrix A_DEV={Magma_tally3_CSR}, A_CSR={Magma_tally3_CSR};
    ...
    if ( A.memory_location == Magma_tally3_DEV && A.storage_type == Magma_tally3_CSR ) {
        ...
        *row = A.drow;
        ...
        CHECK( magma_tally3_smconvert( A, &A_CSR, A.storage_type, Magma_tally3_CSR, queue ));
        CHECK( magma_tally3_smtransfer( A_CSR, &A_DEV, A.memory_location, Magma_tally3_DEV, queue ));
        magma_tally3_scsrget_gpu( A_DEV, m, n, row, col, val, queue );
    }
    
cleanup:
    magma_tally3_smfree( &A_CSR, queue );
    magma_tally3_smfree( &A_DEV, queue );
    return info;
}
