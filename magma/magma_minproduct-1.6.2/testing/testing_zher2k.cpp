...
int main( int argc, char** argv)
{
    ...
    magma_minproduct_int_t Ak, An, Bk, Bn;
    ...
    magma_minproductDoubleComplex *h_A, *h_B, *h_C, *h_Ccublas;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_B,       magma_minproductDoubleComplex, ldb*Bk );
            TESTING_MALLOC_CPU( h_C,       magma_minproductDoubleComplex, ldc*N  );
            TESTING_MALLOC_CPU( h_Ccublas, magma_minproductDoubleComplex, ldc*N  );
            
            TESTING_MALLOC_DEV( d_A, magma_minproductDoubleComplex, ldda*Ak );
            TESTING_MALLOC_DEV( d_B, magma_minproductDoubleComplex, lddb*Bk );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_minproduct_zsetmatrix( An, Ak, h_A, lda, d_A, ldda );
            magma_minproduct_zsetmatrix( Bn, Bk, h_B, ldb, d_B, lddb );
            magma_minproduct_zsetmatrix( N, N, h_C, ldc, d_C, lddc );
            ...
            magma_minproduct_zgetmatrix( N, N, d_C, lddc, h_Ccublas, ldc );
