...
int main( int argc, char** argv)
{
    ...
    magma_minproductFloatComplex *h_A, *h_R, *h_B, *h_S, *h_work;
    float *w1, *w2, vl=0, vu=0;
    float result[2] = {0};
    magma_minproduct_int_t *iwork;
    magma_minproduct_int_t N, n2, info, il, iu, m1, nb, lwork, liwork;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            // ==================================================================
            if ( opts.warmup ) {
                lapackf77_clacpy( Magma_minproductFullStr, &N, &N, h_A, &N, h_R, &N );
                lapackf77_clacpy( Magma_minproductFullStr, &N, &N, h_B, &N, h_S, &N );
                
                magma_minproduct_chegvdx( opts.itype, opts.jobz, Magma_minproductRangeI, opts.uplo,
                               ...
                               &info );
                if (info != 0)
                    printf("magma_minproduct_chegvdx returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_minproductNoVec ) {
                ...
                //lapackf77_clacpy( Magma_minproductFullStr, &N, &N, h_B, &N, h_S, &N );
                //
                //magma_minproduct_int_t m2;
                //magma_minproduct_chegvdx( opts.itype, Magma_minproductNoVec, Magma_minproductRangeI, opts.uplo,
