...
__global__ void zswap_kernel(
    int n,
    magma_tally3DoubleComplex *x, int incx,
    magma_tally3DoubleComplex *y, int incy )
{
...
magma_tally3blas_zswap(
    ...
    magma_tally3DoubleComplex_ptr dy, magma_tally3_int_t incy)
{
    magma_tally3blas_zswap_q( n, dx, incx, dy, incy, magma_tally3_stream );
}
