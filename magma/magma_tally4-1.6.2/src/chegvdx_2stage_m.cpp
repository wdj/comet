    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally4_cpotrf_m( ngpu, uplo, n, B, ldb, info );
    if (*info != 0) {
        *info = n + *info;
        return *info;
    }
    ...
    magma_tally4_chegst_m( ngpu, itype, uplo, n, A, lda, B, ldb, info );

    timer_stop( time );
    timer_printf( "time chegst_m = %6.2f\n", time );
    timer_start( time );

    magma_tally4_cheevdx_2stage_m( ngpu, jobz, range, uplo, n, A, lda, vl, vu, il, iu, mout, w, work, lwork, rwork, lrwork, iwork, liwork, info );
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally4_ctrsm_m( ngpu, Magma_tally4Left, uplo, trans, Magma_tally4NonUnit, n, *mout, c_one, B, ldb, A, lda );
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            #endif
            magma_tally4FloatComplex *dA=NULL, *dB=NULL;
            ...
            magma_tally4_ctrmm( Magma_tally4Left, uplo, trans, Magma_tally4NonUnit,
                         n, n, c_one, dB, lddb, dA, ldda );
            magma_tally4_cgetmatrix( n, n, dA, ldda, A, lda );

            //magma_tally4_ctrmm_m(ngpu, Magma_tally4Left, uplo, trans, Magma_tally4NonUnit, n, *mout, c_one, B, ldb, A, lda);
