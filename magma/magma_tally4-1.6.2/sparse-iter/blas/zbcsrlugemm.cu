    ...
    double **Cval)
{
    ...
    double xxB[4];
    magma_tally4Double_ptr B;

    int trackA = __mul24( ty2, lda) + tx2 ;
    magma_tally4Double_ptr Aval = Avals[blockIdx.z];
    ...
    for(int k=0; k<kblocks; k++){
        ...
        magma_tally4Double_ptr C = Cval[blockIdx.z * kblocks + k];
...
/**
    ...
    @param[in]
    dA          magma_tally4DoubleComplex**
                input blocks of matrix A
                
    @param[in]
    dB          magma_tally4DoubleComplex**
                input blocks of matrix B
                
    @param[in]
    dC          magma_tally4DoubleComplex**
    ...
    magma_tally4_queue_t queue )
{
    ...
    if ( arch < 200  ) {
        printf("error: magma_tally4_zbcsrluegemm needs a CUDA architecture"
