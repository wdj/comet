...
#define dA(i, j) (dA+(j)*ldda + (i))
    ...
    *info = 0;
    ...
    if (nounit) {
        for (j=0; j < n; ++j) {
            if ( MAGMA_tally4_C_EQUAL( *dA(j,j), c_zero )) {
    ...
    */
    ...
    if (MAGMA_tally4_SUCCESS != magma_tally4_cmalloc_pinned( &work, nb*nb )) {
    ...
    if (nb <= 1 || nb >= n) {
        magma_tally4_cgetmatrix( n, n, dA, ldda, work, n );
        lapackf77_ctrtri( uplo_, diag_, &n, work, &n, info );
        magma_tally4_csetmatrix( n, n, work, n, dA, ldda );
    }
    else {
        if (upper) {
            ...
            for (j=0; j < n; j += nb) {
                ...
                magma_tally4_ctrmm( Magma_tally4Left, Magma_tally4Upper,
                             Magma_tally4NoTrans, Magma_tally4NonUnit, j, jb,
                             c_one, dA(0,0), ldda, dA(0, j), ldda );

                magma_tally4_ctrsm( Magma_tally4Right, Magma_tally4Upper,
                             Magma_tally4NoTrans, Magma_tally4NonUnit, j, jb,
                ...
                lapackf77_ctrtri( Magma_tally4UpperStr, diag_, &jb, work, &jb, info );
            ...
            for (j=nn-1; j >= 0; j -= nb) {
                ...
                /* Compute inverse of current diagonal block */
                lapackf77_ctrtri( Magma_tally4LowerStr, diag_, &jb, work, &jb, info );
