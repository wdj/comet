/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from testing_zgels_gpu.cpp normal z -> c, Fri Jan 30 19:00:25 2015
...
int main( int argc, char** argv )
{
    ...
    magma_tally4_int_t lworkgpu, lhwork;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally4_cgels_gpu( Magma_tally4NoTrans, M, N, nrhs, d_A, ldda,
                             d_B, lddb, h_work, lworkgpu, &info );
            gpu_time = magma_tally4_wtime() - gpu_time;
            gpu_perf = gflops / gpu_time;
            if (info != 0)
                printf("magma_tally4_cgels_gpu returned error %d: %s.\n",
