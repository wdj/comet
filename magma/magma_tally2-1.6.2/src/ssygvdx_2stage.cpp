    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally2_ssetmatrix_async( n, n,
                            A,  lda,
                            dA, ldda, stream );
    ...
    magma_tally2_spotrf_gpu(uplo, n, dB, lddb, info);
    if (*info != 0) {
        *info = n + *info;
        return *info;
    }
    ...
    magma_tally2_sgetmatrix_async( n, n,
                            dB, lddb,
                            B,  ldb, stream );
    ...
    magma_tally2_ssygst_gpu(itype, uplo, n, dA, ldda, dB, lddb, info);
    ...
    magma_tally2_ssyevdx_2stage(jobz, range, uplo, n, A, lda, vl, vu, il, iu, m, w, work, lwork, iwork, liwork, info);
    ...
    if (wantz && *info == 0) {
        ...
        magma_tally2_ssetmatrix( n, *m, A, lda, dA, ldda );
        magma_tally2_ssetmatrix( n,  n, B, ldb, dB, lddb );
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally2_strsm(Magma_tally2Left, uplo, trans, Magma_tally2NonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally2_strmm(Magma_tally2Left, uplo, trans, Magma_tally2NonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }

        magma_tally2_sgetmatrix( n, *m, dA, ldda, A, lda );
