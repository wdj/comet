        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            switch( opts.svd_work ) {
                case 0: {  // query for workspace size
                    lwork = -1;
                    magma_tally2_dgesvd( jobu, jobvt, M, N,
            ...
            if (info != 0)
                printf("magma_tally2_dgesvd returned error %d: %s.\n",
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_dgesvd( lapack_vec_const_tally2(jobu), lapack_vec_const_tally2(jobvt), &M, &N,
