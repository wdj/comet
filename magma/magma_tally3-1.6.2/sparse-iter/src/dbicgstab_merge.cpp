...
/**
    ...
    The difference to magma_tally3_dbicgstab is that we use specifically designed
    ...
    magma_tally3_queue_t queue )
{
    ...
    do
    {
        ...
        CHECK( magma_tally3_dmdotc( dofs, 1, q.dval, v.dval, d1, d2, skp, queue ));
        CHECK( magma_tally3_dbicgmerge4(  1, skp, queue ));
        ...
        CHECK( magma_tally3_dmdotc( dofs, 2, q.dval+4*dofs, t.dval, d1, d2, skp+6, queue ));
        CHECK( magma_tally3_dbicgmerge4(  2, skp, queue ));

        CHECK( magma_tally3_dbicgmerge_xrbeta( dofs, d1, d2, q.dval, r.dval, p.dval,
