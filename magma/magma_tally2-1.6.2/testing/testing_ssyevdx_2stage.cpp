/*
    -- MAGMA_tally2 (version 1.6.1) --
       ...
       @generated from testing_zheevdx_2stage.cpp normal z -> s, Fri Jan 30 19:00:26 2015
...
static magma_tally2_int_t check_orthogonality(magma_tally2_int_t M, magma_tally2_int_t N, float *Q, magma_tally2_int_t LDQ, float eps);
static magma_tally2_int_t check_reduction(magma_tally2_uplo_t uplo, magma_tally2_int_t N, magma_tally2_int_t bw, float *A, float *D, magma_tally2_int_t LDA, float *Q, float eps );
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            n2     = N*N;
            #if defined(PRECISION_z) || defined(PRECISION_c)
            lwork  = magma_tally2_sbulge_get_lq2(N, threads) + 2*N + N*N;
            lrwork = 1 + 5*N +2*N*N;
            #else
            lwork  = magma_tally2_sbulge_get_lq2(N, threads) + 1 + 6*N + 2*N*N;
            #endif
            liwork = 3 + 5*N;
            ...
            magma_tally2_smake_symmetric( N, h_A, N );
            ...
            if (opts.warmup) {
                ...
                // ==================================================================
                lapackf77_slacpy( Magma_tally2UpperLowerStr, &N, &N, h_A, &N, h_R, &N );
                if (opts.ngpu == 1) {
                    //printf("calling ssyevdx_2stage 1 GPU\n");
                    magma_tally2_ssyevdx_2stage(opts.jobz, range, opts.uplo, N, 
                                    h_R, N, 
                                    vl, vu, il, iu, 
                                    &m1, w1, 
                                    h_work, lwork, 
                    ...
                    magma_tally2_ssyevdx_2stage_m(opts.ngpu, opts.jobz, range, opts.uplo, N, 
                                    h_R, N, 
                                    vl, vu, il, iu, 
                                    &m1, w1, 
                                    h_work, lwork, 
            ...
            if ( opts.check && opts.jobz != Magma_tally2NoVec ) {
                ...
                //printf("\n");
                //printf("------ TESTS FOR MAGMA_tally2 SSYEVD ROUTINE -------  \n");
...
static magma_tally2_int_t check_orthogonality(magma_tally2_int_t M, magma_tally2_int_t N, float *Q, magma_tally2_int_t LDQ, float eps)
{
    ...
    float *Id;
    magma_tally2_smalloc_cpu( &Id, minMN*minMN );
...
static magma_tally2_int_t check_reduction(magma_tally2_uplo_t uplo, magma_tally2_int_t N, magma_tally2_int_t bw, float *A, float *D, magma_tally2_int_t LDA, float *Q, float eps )
{
    ...
    magma_tally2_smalloc_cpu( &TEMP, N*N );
    magma_tally2_smalloc_cpu( &Residual, N*N );
    ...
    Rnorm = lapackf77_slansy("1", lapack_uplo_const_tally2(uplo), &N, Residual, &N, work);
    Anorm = lapackf77_slansy("1", lapack_uplo_const_tally2(uplo), &N, A,        &LDA, work);
