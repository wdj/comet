    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    hwork[0] = MAGMA_minproduct_Z_MAKE( lwkopt, 0 );
    ...
    if ( step < 0 ) {
        ...
        magma_minproductDoubleComplex* hA = hwork;
        magma_minproductDoubleComplex* hC = hwork + ma*ib;
        magma_minproductDoubleComplex* hW = hwork + ma*ib + mi*ni;
        magma_minproduct_int_t lhwork = lwork - (ma*ib + mi*ni);
        
        magma_minproduct_zgetmatrix( ma, ib, dA(i,  i ), ldda, hA, ma );
        magma_minproduct_zgetmatrix( mi, ni, dC(ic, jc), lddc, hC, mi );
        ...
        magma_minproduct_zsetmatrix( mi, ni, hC, mi, dC(ic, jc), lddc );
    }
    ...
    if (nb < k) {
        for( i=i1; (step < 0 ? i >= i2 : i < i2); i += step ) {
            ...
            magma_minproduct_zlarfb_gpu( side, trans, Magma_minproductForward, Magma_minproductColumnwise,
                              mi, ni, ib,
                              dA(i,  i ), ldda, dT(i), nb,
    ...
    // TODO sync. For cases Q*C and C*Q^T, last call is magma_minproduct_zlarfb_gpu,
    // which is async magma_minproduct_gemm calls, so zunmqr can be unfinished.
