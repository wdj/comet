    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
      for( int iuplo = 0; iuplo < 3; ++iuplo ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            //printf( "nan %g + %gi\n", MAGMA_tally2_D_REAL( MAGMA_tally2_D_NAN ), MAGMA_tally2_D_REAL( MAGMA_tally2_D_NAN ) );
            //printf( "inf %g + %gi\n", MAGMA_tally2_D_REAL( MAGMA_tally2_D_INF ), MAGMA_tally2_D_REAL( MAGMA_tally2_D_INF ) );
            //magma_tally2_dprint( M, N, hA, lda );
            
            magma_tally2_dsetmatrix( M, N, hA, lda, dA, ldda );
            ...
            magma_tally2_int_t c_cpu = magma_tally2_dnan_inf    ( uplo[iuplo], M, N, hA, lda,  &c_cpu_nan, &c_cpu_inf );
            magma_tally2_int_t c_gpu = magma_tally2_dnan_inf_gpu( uplo[iuplo], M, N, dA, ldda, &c_gpu_nan, &c_gpu_inf );
            
            magma_tally2_int_t c_cpu2 = magma_tally2_dnan_inf    ( uplo[iuplo], M, N, hA, lda,  NULL, NULL );
            magma_tally2_int_t c_gpu2 = magma_tally2_dnan_inf_gpu( uplo[iuplo], M, N, dA, ldda, NULL, NULL );
