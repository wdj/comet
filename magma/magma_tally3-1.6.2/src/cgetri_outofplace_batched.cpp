...
/**
    ...
    lwork   INTEGER
            ...
            the optimal blocksize returned by magma_tally3_get_cgetri_nb(n).
    \n
       ...
       
{
    ...
    magma_tally3FloatComplex **dinvdiagA_array = NULL;
    ...
    magma_tally3FloatComplex* dinvdiagA;
    magma_tally3FloatComplex* dwork;// dinvdiagA and dwork are workspace in ctrsm
    ...
    magma_tally3_cmalloc( &dinvdiagA, invdiagA_msize * batchCount);
    ...
    magma_tally3blas_claset_q(Magma_tally3Full, invdiagA_msize, batchCount, MAGMA_tally3_C_ZERO, MAGMA_tally3_C_ZERO, dinvdiagA, invdiagA_msize, queue);
    ...
    magma_tally3blas_claset_batched(Magma_tally3UpperLower, n, n, MAGMA_tally3_C_ZERO, MAGMA_tally3_C_ONE, dinvA_array, lddia, batchCount, queue);
    ...
    for(j = 0; j < n; j+=nb) {
        ...
        // solve dwork = L^-1 * I
        magma_tally3blas_claset_batched(Magma_tally3UpperLower, j, ib, MAGMA_tally3_C_ZERO, MAGMA_tally3_C_ZERO, dwork_array, n, batchCount, queue);
        magma_tally3_cdisplace_pointers(dW5_displ, dwork_array, n, j, 0, batchCount, queue);
        magma_tally3_cdisplace_pointers(dW0_displ, dinvA_array, lddia, j, j, batchCount, queue);
        magma_tally3_cdisplace_pointers(dA_displ, dA_array, ldda, j, j, batchCount, queue);
        ...
        magma_tally3_cdisplace_pointers(dW5_displ, dwork_array, n, 0, 0, batchCount, queue);
        magma_tally3_cdisplace_pointers(dW0_displ, dinvA_array, lddia, 0, j, batchCount, queue);
        magma_tally3_cdisplace_pointers(dA_displ, dA_array, ldda, 0, 0, batchCount, queue);
    ...
    magma_tally3_claswp_columnserial_batched( n, dinvA_array, lddia, max(1,n-1), 1, dipiv_array, batchCount, queue);
