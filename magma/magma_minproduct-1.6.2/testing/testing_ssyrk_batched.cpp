...
int main( int argc, char** argv)
{
    ...
    float *h_A, *h_C, *h_Cmagma_minproduct;
    float *d_A, *d_C;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_minproduct_ssetmatrix( An, Ak*batchCount, h_A, lda, d_A, ldda );
            magma_minproduct_ssetmatrix( N, N*batchCount, h_C, ldc, d_C, lddc );
            ...
            magma_minproductblas_ssyrk_batched(opts.uplo, opts.transA, N, K,
                             alpha, A_array, ldda,
            ...
            magma_minproduct_sgetmatrix( N, NN, d_C, lddc, h_Cmagma_minproduct, ldc );
            ...
            if ( opts.check ) {
                ...
                for(int i=0; i<batchCount; i++)
                {
                    ...
                    blasf77_saxpy( &sizeC, &c_neg_one, h_C+i*ldc*N, &ione, h_Cmagma_minproduct+i*ldc*N, &ione );
                    current_error = lapackf77_slansy( "fro", lapack_uplo_const(opts.uplo), &N, h_Cmagma_minproduct+i*ldc*N, &ldc, work ) / Cnorm;
