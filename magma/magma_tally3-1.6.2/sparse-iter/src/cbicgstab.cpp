    ...
    magma_tally3_queue_t queue )
{
    ...
    // workspace
    magma_tally3_c_matrix r={Magma_tally3_CSR}, rr={Magma_tally3_CSR}, p={Magma_tally3_CSR}, v={Magma_tally3_CSR}, s={Magma_tally3_CSR}, t={Magma_tally3_CSR};
    ...
    do
    {
        ...
        omega = magma_tally3_cdotc( dofs, t.dval, 1, s.dval, 1 )   // omega = <s,t>/<t,t>
                   / magma_tally3_cdotc( dofs, t.dval, 1, t.dval, 1 );

        magma_tally3_caxpy( dofs, alpha, p.dval, 1 , x->dval, 1 );     // x=x+alpha*p
        magma_tally3_caxpy( dofs, omega, s.dval, 1 , x->dval, 1 );     // x=x+omega*s
