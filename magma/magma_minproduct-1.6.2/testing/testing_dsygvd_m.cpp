...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_minproduct_dmake_hpd( N, h_B, N );
            magma_minproduct_dmake_symmetric( N, h_A, N );

            if ( opts.warmup || opts.check ) {
                TESTING_MALLOC_CPU( h_Ainit, double, n2 );
                TESTING_MALLOC_CPU( h_Binit, double, n2 );
                lapackf77_dlacpy( Magma_minproductFullStr, &N, &N, h_A, &N, h_Ainit, &N );
                lapackf77_dlacpy( Magma_minproductFullStr, &N, &N, h_B, &N, h_Binit, &N );
            }
            ...
            if (opts.warmup) {
                ...
                // ==================================================================
                magma_minproduct_dsygvd_m( opts.ngpu, opts.itype, opts.jobz, opts.uplo,
                                N, h_A, N, h_B, N, w1,
                                h_work, lwork,
                                #ifdef COMPLEX
                                rwork, lrwork,
                                ...
                                iwork, liwork,
                                &info);
                lapackf77_dlacpy( Magma_minproductFullStr, &N, &N, h_Ainit, &N, h_A, &N );
                lapackf77_dlacpy( Magma_minproductFullStr, &N, &N, h_Binit, &N, h_B, &N );
            }
            ...
            if (info != 0)
                printf("magma_minproduct_dsygvd_m returned error %d: %s.\n",
            ...
            if ( opts.check && opts.jobz != Magma_minproductNoVec ) {
                ...
                result[0] = 1.;
                result[0] /= lapackf77_dlansy("1", lapack_uplo_const(opts.uplo), &N, h_Ainit, &N, rwork);
            ...
            if ( opts.lapack ) {
                ...
                magma_minproduct_dsygvd(opts.itype, opts.jobz, opts.uplo,
                             N, h_A, N, h_B, N, w2,
                             h_work, lwork,
                             #ifdef COMPLEX
                             rwork, lrwork,
                ...
                if (info != 0)
                    printf("magma_minproduct_dsygvd returned error %d: %s.\n",
                           (int) info, magma_minproduct_strerror( info ));
