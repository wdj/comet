    ...
    magma_tally2_int_t batchCount,  cublasHandle_t myhandle, magma_tally2_queue_t queue)
{
    ...
    if(panel_nb <= min_recpnb){
        ...
        magma_tally2_dgetf2_batched(m, panel_nb,
                           dA_array, ldda,
        ...
        magma_tally2_dlaswp_rowparallel_batched( n2, dW5_displ, ldda,
                           dX_array, n1,
                           0, n1,
        ...
        magma_tally2_ddisplace_pointers(dW1_displ, dA_array, ldda, p2, 0, batchCount, queue); // no need since it is above
        magma_tally2_dlaswp_rowparallel_batched( n1, dW1_displ, ldda,
                           dW1_displ, ldda,
                           n1, n,
                           dpivinfo_array, batchCount, queue);
