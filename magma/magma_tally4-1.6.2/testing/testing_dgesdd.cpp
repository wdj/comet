...
int main( int argc, char** argv)
{
    ...
    MAGMA_tally4_UNUSED( max_mn );  // used only in real
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            switch( opts.svd_work ) {
                case 0: {  // query for workspace size
                    lwork = -1;
                    magma_tally4_dgesdd( jobz, M, N,
                                  NULL, lda, NULL, NULL, ldu, NULL, ldv, dummy, lwork,
                                  #ifdef COMPLEX
                                  NULL,
                                  #endif
                                  NULL, &info );
                    lwork = (int) MAGMA_tally4_D_REAL( dummy[0] );
                    break;
                }
            ...
            if (info != 0)
                printf("magma_tally4_dgesdd returned error %d: %s.\n",
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_dgesdd( lapack_vec_const_tally4(jobz), &M, &N,
