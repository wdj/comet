...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            // ==================================================================
            if (opts.warmup) {
                lapackf77_zlacpy( Magma_tally3UpperLowerStr, &N, &N, h_A, &N, h_R, &N );
                lapackf77_zlacpy( Magma_tally3UpperLowerStr, &N, &N, h_B, &N, h_S, &N );

                magma_tally3_zhegvdx_2stage(opts.itype, opts.jobz, range, opts.uplo,
            ...
            if ( opts.check && opts.jobz != Magma_tally3NoVec ) {
                ...
                magma_tally3_int_t m2 = m1;
                lapackf77_zhegvd(&opts.itype, "N", lapack_uplo_const_tally3(opts.uplo), &N,
                              h_R, &N, h_S, &N, w2,
                              h_work, &lwork,
                              #if defined(PRECISION_z) || defined(PRECISION_c)
                              rwork, &lrwork,
