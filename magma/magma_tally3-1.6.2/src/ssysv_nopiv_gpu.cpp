...
/**
    ...
    @ingroup magma_tally3_ssysv_driver
    ********************************************************************/
...
magma_tally3_ssysv_nopiv_gpu(magma_tally3_uplo_t uplo,  magma_tally3_int_t n, magma_tally3_int_t nrhs, 
                 magma_tally3Float_ptr dA, magma_tally3_int_t ldda,
                 magma_tally3Float_ptr dB, magma_tally3_int_t lddb, 
                 magma_tally3_int_t *info)
{
    magma_tally3_int_t ret;
    ...
    *info = 0;
    ...
    ret = magma_tally3_ssytrf_nopiv_tally3_gpu(uplo, n, dA, ldda, info);
    if ( (ret != MAGMA_tally3_SUCCESS) || (*info != 0) ) {
        return ret;
    }
        
    ret = magma_tally3_ssytrs_nopiv_gpu( uplo, n, nrhs, dA, ldda, dB, lddb, info );
    if ( (ret != MAGMA_tally3_SUCCESS) || (*info != 0) ) {
        return ret;
    }
