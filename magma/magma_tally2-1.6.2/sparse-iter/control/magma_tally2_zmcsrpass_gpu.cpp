    ...
    magma_tally2_queue_t queue )
{
    ...
    magma_tally2_z_matrix A_DEV={Magma_tally2_CSR}, A_CSR={Magma_tally2_CSR};
    ...
    if ( A.memory_location == Magma_tally2_DEV && A.storage_type == Magma_tally2_CSR ) {
        ...
        *row = A.drow;
        ...
        CHECK( magma_tally2_zmconvert( A, &A_CSR, A.storage_type, Magma_tally2_CSR, queue ));
        CHECK( magma_tally2_zmtransfer( A_CSR, &A_DEV, A.memory_location, Magma_tally2_DEV, queue ));
        magma_tally2_zcsrget_gpu( A_DEV, m, n, row, col, val, queue );
    }
    
cleanup:
    magma_tally2_zmfree( &A_CSR, queue );
    magma_tally2_zmfree( &A_DEV, queue );
    return info;
}
