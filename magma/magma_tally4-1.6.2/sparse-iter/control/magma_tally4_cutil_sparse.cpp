/*
    -- MAGMA_tally4 (version 1.6.2) --
       ...
       @generated from magma_tally4_zutil_sparse.cpp normal z -> c, Sun May  3 11:23:01 2015

       @author Hartwig Anzt

       Utilities for testing MAGMA_tally4-sparse.
*/
...
/**
    ...
    @param[in,out]
    opts            magma_tally4_copts *
                    magma_tally4 solver options
    ...
    magma_tally4_queue_t queue )
{
    ...
    opts->input_format = Magma_tally4_CSR;
    opts->blocksize = 8;
    opts->alignment = 8;
    opts->output_format = Magma_tally4_CSR;
    opts->input_location = Magma_tally4_CPU;
    opts->output_location = Magma_tally4_CPU;
    opts->scaling = Magma_tally4_NOSCALE;
    ...
    opts->precond_par.solver = Magma_tally4_NONE;
    ...
    opts->solver_par.solver = Magma_tally4_CG;
    ...
    for( int i = 1; i < argc; ++i ) {
        if ( strcmp("--format", argv[i]) == 0 && i+1 < argc ) {
            info = atoi( argv[++i] );
            switch( info ) {
                case 0: opts->output_format = Magma_tally4_CSR; break;
                case 1: opts->output_format = Magma_tally4_ELL; break;
                case 2: opts->output_format = Magma_tally4_SELLP; break;
                //case 2: opts->output_format = Magma_tally4_ELLRT; break;
            }
        } else if ( strcmp("--mscale", argv[i]) == 0 && i+1 < argc ) {
            info = atoi( argv[++i] );
            switch( info ) {
                case 0: opts->scaling = Magma_tally4_NOSCALE; break;
                case 1: opts->scaling = Magma_tally4_UNITDIAG; break;
                case 2: opts->scaling = Magma_tally4_UNITROW; break;
            }

        } else if ( strcmp("--solver", argv[i]) == 0 && i+1 < argc ) {
            info = atoi( argv[++i] );
            switch( info ) {
                case 0: opts->solver_par.solver = Magma_tally4_CG; break;
                case 1: opts->solver_par.solver = Magma_tally4_CGMERGE; break;
                case 2: opts->solver_par.solver = Magma_tally4_PCG; break;
                case 3: opts->solver_par.solver = Magma_tally4_BICGSTAB; break;
                case 4: opts->solver_par.solver = Magma_tally4_BICGSTABMERGE; break;
                case 5: opts->solver_par.solver = Magma_tally4_PBICGSTAB; break;
                case 6: opts->solver_par.solver = Magma_tally4_GMRES; break;
                case 7: opts->solver_par.solver = Magma_tally4_PGMRES; break;
                case 8: opts->solver_par.solver = Magma_tally4_LOBPCG;
                            opts->solver_par.num_eigenvalues = 16;break;
                case 9: opts->solver_par.solver = Magma_tally4_JACOBI; break;
                case 10: opts->solver_par.solver = Magma_tally4_BAITER; break;
                case 21: opts->solver_par.solver = Magma_tally4_ITERREF; break;
            }
            ...
            info = atoi( argv[++i] );
            switch( info ) {
                case 0: opts->precond_par.solver = Magma_tally4_NONE; break;
                case 1: opts->precond_par.solver = Magma_tally4_JACOBI; break;
                case 2: opts->precond_par.solver = Magma_tally4_ILU; break;
                case -2: opts->precond_par.solver = Magma_tally4_AILU; break;
                case 3: opts->precond_par.solver = Magma_tally4_CG; break;
                case 4: opts->precond_par.solver = Magma_tally4_BICGSTAB; break;
                case 5: opts->precond_par.solver = Magma_tally4_GMRES; break;
                case 6: opts->precond_par.solver = Magma_tally4_BAITER; break;
    ...
    if ( opts->solver_par.solver == Magma_tally4_PCG
        && opts->precond_par.solver == Magma_tally4_ILU )
            opts->precond_par.solver = Magma_tally4_ICC;
    if ( opts->solver_par.solver == Magma_tally4_PCG
        && opts->precond_par.solver == Magma_tally4_AILU )
            opts->precond_par.solver = Magma_tally4_AICC;
