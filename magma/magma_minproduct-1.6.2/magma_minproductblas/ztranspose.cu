...
ztranspose_device(
    int m, int n,
    const magma_minproductDoubleComplex *A, int lda,
    magma_minproductDoubleComplex *AT,      int ldat)
{
    __shared__ magma_minproductDoubleComplex sA[NB][NX+1];
...
void ztranspose_kernel_batched(
    ...
    magma_minproductDoubleComplex **dAT_array,      int ldat)
{
...
/**
    @see magma_minproductblas_ztranspose_q
    @ingroup magma_minproduct_zaux2
    ********************************************************************/
extern "C" void
magma_minproductblas_ztranspose(
    ...
    magma_minproductDoubleComplex_ptr       dAT, magma_minproduct_int_t lddat )
{
    magma_minproductblas_ztranspose_q( m, n, dA, ldda, dAT, lddat, magma_minproduct_stream );
}
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_minproductblas_ztranspose_batched_q(
    magma_minproduct_int_t m, magma_minproduct_int_t n,
    magma_minproductDoubleComplex **dA_array,  magma_minproduct_int_t ldda,
    magma_minproductDoubleComplex **dAT_array, magma_minproduct_int_t lddat, magma_minproduct_int_t batchCount, magma_minproduct_queue_t queue )
{
    magma_minproduct_int_t info = 0;
    if ( m < 0 )
        info = -1;
...
/**
    @see magma_minproductblas_ztranspose_batched_q
    @ingroup magma_minproduct_zaux2
    ********************************************************************/
extern "C" void
...
{
    magma_minproductblas_ztranspose_batched_q( m, n, dA_array, ldda, dAT_array, lddat, batchCount, magma_minproduct_stream );
}
