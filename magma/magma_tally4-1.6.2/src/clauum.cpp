    ...
    if (nb <= 1 || nb >= n)
        ...
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally4_csetmatrix_async( ib, (n-i-ib),
                                        A(i,i+ib),  lda,
                                        dA(i,i+ib), ldda, stream[0] );

                magma_tally4_queue_sync( stream[1] );

                magma_tally4_ctrmm( Magma_tally4Right, Magma_tally4Upper,
                             Magma_tally4ConjTrans, Magma_tally4NonUnit, i, ib,
                             c_one, dA(i,i), ldda, dA(0, i),ldda);


                lapackf77_clauum(Magma_tally4UpperStr, &ib, A(i,i), &lda, info);
                ...
                if (i+ib < n) {
                    ...
                    magma_tally4_cherk( Magma_tally4Upper, Magma_tally4NoTrans, ib,(n-i-ib),
                                 d_one, dA(i, i+ib), ldda,
                                 d_one, dA(i, i), ldda);
                }

                magma_tally4_cgetmatrix( i+ib, ib,
                                  dA(0, i), ldda,
                                  A(0, i),  lda );
            }
        }
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally4_csetmatrix_async( (n-i-ib), ib,
                                        A(i+ib, i),  lda,
                                        dA(i+ib, i), ldda, stream[0] );

                magma_tally4_queue_sync( stream[1] );

                magma_tally4_ctrmm( Magma_tally4Left, Magma_tally4Lower,
                             Magma_tally4ConjTrans, Magma_tally4NonUnit, ib,
                             i, c_one, dA(i,i), ldda,
                             dA(i, 0),ldda);


                lapackf77_clauum(Magma_tally4LowerStr, &ib, A(i,i), &lda, info);
                ...
                if (i+ib < n) {
                    ...
                    magma_tally4_cherk(Magma_tally4Lower, Magma_tally4ConjTrans, ib, (n-i-ib),
                                    d_one, dA(i+ib, i), ldda,
                                    d_one, dA(i, i), ldda);
                }
                magma_tally4_cgetmatrix( ib, i+ib,
                                  dA(i, 0), ldda,
                                  A(i, 0),  lda );
            }
        }
