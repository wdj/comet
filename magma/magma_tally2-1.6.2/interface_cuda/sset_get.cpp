...
magma_tally2_ssetmatrix_internal(
    ...
    float const* hA_src, magma_tally2_int_t lda,
    magma_tally2Float_ptr    dB_dst, magma_tally2_int_t ldb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
...
magma_tally2_sgetmatrix_internal(
    magma_tally2_int_t m, magma_tally2_int_t n,
    magma_tally2Float_const_ptr dA_src, magma_tally2_int_t lda,
    float*          hB_dst, magma_tally2_int_t ldb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
