    ...
    magma_tally2_int_t *info)
{
    ...
    magma_tally2_zmalloc( &dwork, 2*(m + 64)*64 );
    ...
    magma_tally2DoubleComplex T[2*4160]        /* was [65][64] */;
    ...
    *info  = 0;
    ...
    magma_tally2blas_zlaset_band( Magma_tally2Lower, k, k, nb, c_zero, c_one, dA, ldda );
    ...
    for (i = i1; (step < 0 ? i >= i2 : i <= i2); i += step) {
        ...
        magma_tally2_zsetmatrix( ib, ib, T, ib, dwork+i__4*ib, ib );
