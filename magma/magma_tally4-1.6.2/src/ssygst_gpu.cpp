...
#define dB(i, j) (dB + (j)*lddb + (i))
    ...
    *info = 0;
    ...
    nb = magma_tally4_get_ssygst_nb(n);
    
    lda = nb;
    ldb = nb;
    
    if (MAGMA_tally4_SUCCESS != magma_tally4_smalloc_pinned( &w, 2*nb*nb )) {
    ...
    if (itype == 1) {
        if (upper) {
            ...
            for (k = 0; k < n; k += nb) {
                ...
                if (k+kb < n) {
                    ...
                    magma_tally4_sgetmatrix_async( kb2, kb2,
                                            dB(k+kb, k+kb), lddb,
                                            B(0, 0),        nb, stream[2] );
                    ...
                    magma_tally4_ssymm(Magma_tally4Left, Magma_tally4Upper,
                                kb, n-k-kb,
                                c_neg_half, dA(k,k), ldda,
                                dB(k,k+kb), lddb,
                                c_one, dA(k, k+kb), ldda);
                    
                    magma_tally4_ssyr2k(Magma_tally4Upper, Magma_tally4ConjTrans,
                                 n-k-kb, kb,
            ...
            for (k = 0; k < n; k += nb) {
                ...
                if (k+kb < n) {
                    ...
                    magma_tally4_ssymm(Magma_tally4Right, Magma_tally4Lower,
                                n-k-kb, kb,
                                c_neg_half, dA(k,k), ldda,
                                dB(k+kb,k), lddb,
                                c_one, dA(k+kb, k), ldda);
                    
                    magma_tally4_ssyr2k(Magma_tally4Lower, Magma_tally4NoTrans,
                                 n-k-kb, kb,
                    ...
                    magma_tally4_strsm(Magma_tally4Left, Magma_tally4Lower, Magma_tally4NoTrans, Magma_tally4NonUnit,
                                n-k-kb, kb,
                                c_one, dB(k+kb,k+kb), lddb,
                                dA(k+kb,k), ldda);
                }
        ...
        if (upper) {
            ...
            for (k = 0; k < n; k += nb) {
                ...
                if (k > 0) {
                    magma_tally4_strmm(Magma_tally4Left, Magma_tally4Upper, Magma_tally4NoTrans, Magma_tally4NonUnit,
                                k, kb,
                                c_one, dB(0,0), lddb,
                                dA(0,k), ldda);
                    
                    magma_tally4_ssymm(Magma_tally4Right, Magma_tally4Upper,
                                k, kb,
                                c_half, dA(k,k), ldda,
                                dB(0,k), lddb,
                                c_one, dA(0, k), ldda);
                ...
                if (k > 0) {
                    magma_tally4_ssyr2k(Magma_tally4Upper, Magma_tally4NoTrans,
                                 k, kb,
                                 c_one, dA(0,k), ldda,
                                 dB(0,k), lddb,
                                 d_one, dA(0,0), ldda);
                    ...
                    magma_tally4_strmm(Magma_tally4Right, Magma_tally4Upper, Magma_tally4ConjTrans, Magma_tally4NonUnit,
                                k, kb,
                                c_one, dB(k,k), lddb,
                                dA(0,k), ldda);
                }
            ...
            for (k = 0; k < n; k += nb) {
                ...
                if (k > 0) {
                    magma_tally4_strmm(Magma_tally4Right, Magma_tally4Lower, Magma_tally4NoTrans, Magma_tally4NonUnit,
                                kb, k,
                                c_one, dB(0,0), lddb,
                                dA(k,0), ldda);
                    
                    magma_tally4_ssymm(Magma_tally4Left, Magma_tally4Lower,
                                kb, k,
                                c_half, dA(k,k), ldda,
                                dB(k,0), lddb,
                                c_one, dA(k, 0), ldda);
                ...
                if (k > 0) {
                    magma_tally4_ssyr2k(Magma_tally4Lower, Magma_tally4ConjTrans,
                                 k, kb,
                                 c_one, dA(k,0), ldda,
                                 dB(k,0), lddb,
                                 d_one, dA(0,0), ldda);
                    ...
                    magma_tally4_strmm(Magma_tally4Left, Magma_tally4Lower, Magma_tally4ConjTrans, Magma_tally4NonUnit,
                                kb, k,
                                c_one, dB(k,k), lddb,
                                dA(k,0), ldda);
                }
