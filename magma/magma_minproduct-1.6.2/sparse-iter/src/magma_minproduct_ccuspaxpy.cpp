/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from magma_minproduct_zcuspaxpy.cpp normal z -> c, Sun May  3 11:22:59 2015
       @author Hartwig Anzt
...
magma_minproduct_ccuspaxpy(
    magma_minproductFloatComplex *alpha, magma_minproduct_c_matrix A,
    magma_minproductFloatComplex *beta, magma_minproduct_c_matrix B,
    ...
    magma_minproduct_queue_t queue )
{
    ...
    if (    A.memory_location == Magma_minproduct_DEV
        ...
        CHECK( magma_minproduct_cmalloc( &C.dval, C.nnz ));
        ...
        CHECK( magma_minproduct_cmtransfer( C, AB, Magma_minproduct_DEV, Magma_minproduct_DEV, queue ));
    }
    else {
