...
magma_minproductblas_slascl2(
    magma_minproduct_type_t type, magma_minproduct_int_t m, magma_minproduct_int_t n,
    magma_minproductFloat_const_ptr dD,
    magma_minproductFloat_ptr dA, magma_minproduct_int_t ldda, magma_minproduct_int_t *info )
{
    magma_minproductblas_slascl2_q( type, m, n, dD, dA, ldda, magma_minproduct_stream, info );
}
