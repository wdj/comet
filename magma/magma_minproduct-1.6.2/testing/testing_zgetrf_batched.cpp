...
int main( int argc, char** argv)
{
    ...
    magma_minproductDoubleComplex *h_A, *h_R, *h_Amagma_minproduct;
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
      ...
      for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_DEV(  dA,  magma_minproductDoubleComplex, ldda*N * batchCount);
            ...
            magma_minproduct_zsetmatrix( M, columns, h_R, lda, dA, ldda );
            ...
            info = magma_minproduct_zgetrf_batched( M, N, dA_array, ldda, dipiv_array,  dinfo_magma_minproduct, batchCount, queue);
            ...
            magma_minproduct_zgetmatrix( M, N*batchCount, dA, ldda, h_Amagma_minproduct, lda );
