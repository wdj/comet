...
int main(  int argc, char** argv )
{
    ...
    magma_tally4_z_matrix a={Magma_tally4_CSR}, b={Magma_tally4_CSR}, x={Magma_tally4_CSR}, y={Magma_tally4_CSR}, skp={Magma_tally4_CSR};
    ...
    for( magma_tally4_int_t num_vecs=5; num_vecs<6; num_vecs+=1 ) {
        for( magma_tally4_int_t n=10000; n<100000001; n=n+10000 ) {
            ...
            CHECK( magma_tally4_zvinit( &a, Magma_tally4_DEV, n, num_vecs, one, queue ));
            CHECK( magma_tally4_zvinit( &b, Magma_tally4_DEV, num_vecs, 1, one, queue ));
            int min_ten = min(num_vecs, 15);
            CHECK( magma_tally4_zvinit( &x, Magma_tally4_DEV, min_ten, n, one, queue ));
            CHECK( magma_tally4_zvinit( &y, Magma_tally4_DEV, min_ten, n, one, queue ));
            CHECK( magma_tally4_zvinit( &skp, Magma_tally4_DEV, num_vecs, 1, zero, queue ));

            // warm up
            CHECK( magma_tally4_zgemvmdot( n, num_vecs, a.dval, b.dval, x.dval, y.dval, skp.dval, queue ));
            ...
            for( int h=0; h<iters; h++) {
                for( int l=0; l<num_vecs; l++)
                    alpha = magma_tally4_zdotc(n, a.dval, 1, b.dval, 1);
            }
            #ifdef ENABLE_TIMER
            ...
            #endif
            for( int h=0; h<iters; h++) {
                magma_tally4_zgemv(Magma_tally4Trans, n, num_vecs, one, a.dval, n, b.dval, 1, zero, skp.dval, 1);
                //h++;
            }
            #ifdef ENABLE_TIMER
            ...
            #endif
            for( int h=0; h<iters; h++) {
                magma_tally4blas_zgemv(Magma_tally4Trans, n, num_vecs, one, a.dval, n, b.dval, 1, zero, skp.dval, 1);
                //h++;
            }
            #ifdef ENABLE_TIMER
            ...
            #endif
            for( int h=0; h<iters; h++) {
                //magma_tally4_zmdotc( n, num_vecs, a.dval, b.dval, x.dval, y.dval, skp.dval, queue );
                CHECK( magma_tally4_zmdotc( n, 2, a.dval, b.dval, x.dval, y.dval, skp.dval, queue ));
                CHECK( magma_tally4_zmdotc( n, 2, a.dval, b.dval, x.dval, y.dval, skp.dval, queue ));
                CHECK( magma_tally4_zmdotc( n, 1, a.dval, b.dval, x.dval, y.dval, skp.dval, queue ));
                //h++;
            }
            #ifdef ENABLE_TIMER
            ...
            //magma_tally4_zprint_gpu(num_vecs,1,skp.dval,num_vecs);
