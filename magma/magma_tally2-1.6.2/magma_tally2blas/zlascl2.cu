...
__global__ void
zlascl2_full(int m, int n, const double* D, magma_tally2DoubleComplex* A, int lda)
{
...
__global__ void
zlascl2_lower(int m, int n, const double* D, magma_tally2DoubleComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
__global__ void
zlascl2_upper(int m, int n, const double *D, magma_tally2DoubleComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
magma_tally2blas_zlascl2(
    magma_tally2_type_t type, magma_tally2_int_t m, magma_tally2_int_t n,
    magma_tally2Double_const_ptr dD,
    magma_tally2DoubleComplex_ptr dA, magma_tally2_int_t ldda, magma_tally2_int_t *info )
{
    magma_tally2blas_zlascl2_q( type, m, n, dD, dA, ldda, magma_tally2_stream, info );
}
