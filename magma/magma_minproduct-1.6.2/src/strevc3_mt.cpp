...
class magma_minproduct_slaqtrsd_task: public magma_minproduct_task
{
public:
    magma_minproduct_slaqtrsd_task(
        magma_minproduct_trans_t in_trans, magma_minproduct_int_t in_n,
        const float *in_T, magma_minproduct_int_t in_ldt,
        float       *in_x, magma_minproduct_int_t in_incx,
    ...
    virtual void run()
    {
        ...
        magma_minproduct_slaqtrsd( trans, n, T, ldt, x, incx, cnorm, &info );
        if ( info != 0 ) {
...
class sgemm_task: public magma_minproduct_task
{
public:
    sgemm_task(
        ...
        float  in_alpha,
        const float *in_A, magma_minproduct_int_t in_lda,
        const float *in_B, magma_minproduct_int_t in_ldb,
        float  in_beta,
        float *in_C, magma_minproduct_int_t in_ldc
    ):
        transA( in_transA ),
        transB( in_transB ),
        m     ( in_m      ),
...
/**
    ...
    @ingroup magma_minproduct_sgeev_comp
    ********************************************************************/
extern "C"
magma_minproduct_int_t magma_minproduct_strevc3_mt(
    ...
    if ( rightv ) {
        ...
        for( ki=n-1; ki >= 0; --ki ) {
            ...
            if ( ip == 0 ) {
                ...
                queue.push_task( new magma_minproduct_slaqtrsd_task(
