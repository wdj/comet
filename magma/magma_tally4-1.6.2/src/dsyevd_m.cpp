    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally4_dsytrd_mgpu(ngpu, 1, uplo, n, A, lda, w, &work[inde],
    ...
    if (! wantz) {
...
#else
        magma_tally4_dstedx_m(ngpu, Magma_tally4RangeAll, n, 0., 0., 0, 0, w, &work[inde],
                       &work[indwrk], n, &work[indwk2],
        ...
        magma_tally4_dormtr_m(ngpu, Magma_tally4Left, uplo, Magma_tally4NoTrans, n, n, A, lda, &work[indtau],
