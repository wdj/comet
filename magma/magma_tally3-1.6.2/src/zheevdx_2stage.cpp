    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally3_zstedx(range, n, vl, vu, il, iu, w, &rwork[inde],
        ...
        magma_tally3_zunmqr_gpu_2stages(Magma_tally3Left, Magma_tally3NoTrans, n-nb, *m, n-nb, da+nb, ldda,
                                 dZ+nb, n, dT1, nb, info);

        magma_tally3_zgetmatrix( n, *m, dZ, lddz, A, lda );
