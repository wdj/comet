...
/**
    ...
    @param[in,out]
    dB       DOUBLE_PRECISION array, dimension (lddb,nrhs)
    ...
    @ingroup magma_minproduct_dsysv_driver
    ********************************************************************/
...
magma_minproduct_dsysv_nopiv_gpu(magma_minproduct_uplo_t uplo,  magma_minproduct_int_t n, magma_minproduct_int_t nrhs, 
                 ...
                 magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    ret = magma_minproduct_dsytrf_nopiv_gpu(uplo, n, dA, ldda, info);
    if ( (ret != MAGMA_minproduct_SUCCESS) || (*info != 0) ) {
        return ret;
    }
        
    ret = magma_minproduct_dsytrs_nopiv_gpu( uplo, n, nrhs, dA, ldda, dB, lddb, info );
    if ( (ret != MAGMA_minproduct_SUCCESS) || (*info != 0) ) {
        return ret;
    }
