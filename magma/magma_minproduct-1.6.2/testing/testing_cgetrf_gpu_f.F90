...
!      @date January 2015
!
!  @generated from testing_zgetrf_gpu_f.F90 normal z -> c, Fri Jan 30 19:00:26 2015
!
      program testing_cgetrf_gpu_f

      use magma_minproduct
      ...
      magma_minproduct_devptr_t                :: devptrA, devptrB
...
!---- Call magma_minproduct LU ----------------
      call magma_minproduct_wtime_f(tstart)
      call magma_minproductf_cgetrf_gpu(n, n, devptrA, ldda, ipiv, info)
      call magma_minproduct_wtime_f(tend)

      if ( info .ne. 0 )  then
         write(*,*) "Info : ", info
      end if

!---- Call magma_minproduct solve -------------
      call magma_minproductf_cgetrs_gpu('n', n, nrhs, devptrA, ldda, ipiv, devptrB, ldda, info)
