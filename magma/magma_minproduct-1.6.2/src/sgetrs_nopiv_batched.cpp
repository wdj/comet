                  ...
                  magma_minproduct_int_t batchCount,  magma_minproduct_queue_t queue)
{
   ...
   /* check allocation */
    ...
    if (notran) {
        ...
        // solve 
        magma_minproductblas_strsm_outofplace_batched(Magma_minproductLeft, Magma_minproductUpper, trans, Magma_minproductUnit, 1,
                n, nrhs,
                MAGMA_minproduct_S_ONE,
                dA_displ,       ldda, // dA
                dB_displ,      lddb, // dB
        ...
        // solve 
        magma_minproductblas_strsm_outofplace_batched(Magma_minproductLeft, Magma_minproductLower, trans, Magma_minproductNonUnit, 1,
                n, nrhs,
                MAGMA_minproduct_S_ONE,
                dA_displ,       ldda, // dA
                dwork_array,        n, // dB 
