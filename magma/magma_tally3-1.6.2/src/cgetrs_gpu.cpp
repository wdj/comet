    ...
    magma_tally3_int_t *info)
{
    ...
    magma_tally3FloatComplex *work = NULL;
    ...
    *info = 0;
    ...
    magma_tally3_cmalloc_cpu( &work, n * nrhs );
    if ( work == NULL ) {
    ...
    if (notran) {
        ...
        /* Solve A * X = B. */
        magma_tally3_cgetmatrix( n, nrhs, dB, lddb, work, n );
        lapackf77_claswp(&nrhs, work, &n, &i1, &i2, ipiv, &inc);
        magma_tally3_csetmatrix( n, nrhs, work, n, dB, lddb );

        if ( nrhs == 1) {
            magma_tally3_ctrsv(Magma_tally3Lower, Magma_tally3NoTrans, Magma_tally3Unit,    n, dA, ldda, dB, 1 );
            magma_tally3_ctrsv(Magma_tally3Upper, Magma_tally3NoTrans, Magma_tally3NonUnit, n, dA, ldda, dB, 1 );
        } else {
            magma_tally3_ctrsm(Magma_tally3Left, Magma_tally3Lower, Magma_tally3NoTrans, Magma_tally3Unit,    n, nrhs, c_one, dA, ldda, dB, lddb );
        ...
        if ( nrhs == 1) {
            magma_tally3_ctrsv(Magma_tally3Upper, trans, Magma_tally3NonUnit, n, dA, ldda, dB, 1 );
            magma_tally3_ctrsv(Magma_tally3Lower, trans, Magma_tally3Unit,    n, dA, ldda, dB, 1 );
        } else {
            magma_tally3_ctrsm(Magma_tally3Left, Magma_tally3Upper, trans, Magma_tally3NonUnit, n, nrhs, c_one, dA, ldda, dB, lddb );
            magma_tally3_ctrsm(Magma_tally3Left, Magma_tally3Lower, trans, Magma_tally3Unit,    n, nrhs, c_one, dA, ldda, dB, lddb );
        }
