...
/**
    ...
    as returned by DGELQF. Q is of order M if SIDE = Magma_tally2Left and of order N
    ...
    @ingroup magma_tally2_dgelqf_comp
    ********************************************************************/
    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb >= k) {
        /* Use CPU code */
        lapackf77_dormlq( lapack_side_const_tally2(side), lapack_trans_const_tally2(trans),
        ...
        magma_tally2Double_ptr dwork, dV, dT, dC;
        ...
        magma_tally2_dmalloc_cpu( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_tally2_dsetmatrix( m, n, C, ldc, dC(0,0), lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            dpanel_to_q_tally2( Magma_tally2Lower, ib, A(i,i), lda, T2 );
            magma_tally2_dsetmatrix( ib, nq_i,  A(i,i), lda, dV(0,0), ib );
            dq_to_panel_tally2( Magma_tally2Lower, ib, A(i,i), lda, T2 );
            ...
            magma_tally2_dsetmatrix( ib, ib, T, ib, dT(0,0), ib );
            magma_tally2_dlarfb_gpu( side, transt, Magma_tally2Forward, Magma_tally2Rowwise,
                              mi, ni, ib,
                              dV(0,0), ib,
                              dT(0,0), ib,
                              dC(ic,jc), lddc,
        ...
        magma_tally2_dgetmatrix( m, n, dC(0,0), lddc, C, ldc );
