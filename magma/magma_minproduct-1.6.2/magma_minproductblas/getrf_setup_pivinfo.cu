...
//=================================================================================================
static __device__ void setup_pivinfo_devfunc(magma_minproduct_int_t *pivinfo, magma_minproduct_int_t *ipiv, int m, int nb)
{
   int tid = threadIdx.x;   
...
//=================================================================================================
__global__ void setup_pivinfo_kernel_batched(magma_minproduct_int_t **pivinfo_array, magma_minproduct_int_t **ipiv_array, int m, int nb)
{
...
//=================================================================================================
__global__ void setup_pivinfo_kernel(magma_minproduct_int_t *pivinfo, magma_minproduct_int_t *ipiv, int m, int nb)
{
...
//=================================================================================================
extern "C" void
setup_pivinfo_batched( magma_minproduct_int_t **pivinfo_array, magma_minproduct_int_t **ipiv_array, 
...
//=================================================================================================
static __device__ void adjust_ipiv_devfunc(magma_minproduct_int_t *ipiv, int m, int offset)
{
   int tid = threadIdx.x;
   if(tid < m)
   {
...
//=================================================================================================
__global__ void adjust_ipiv_kernel_batched(magma_minproduct_int_t **ipiv_array, int m, int offset)
{
   int batchid = blockIdx.x;
...
//=================================================================================================
__global__ void adjust_ipiv_kernel(magma_minproduct_int_t *ipiv, int m, int offset)
{
...
//=================================================================================================
extern "C" void
adjust_ipiv_batched( magma_minproduct_int_t **ipiv_array, 
...
//=================================================================================================
extern "C" void
adjust_ipiv( magma_minproduct_int_t *ipiv, 
                 magma_minproduct_int_t m, magma_minproduct_int_t offset, 
                 magma_minproduct_queue_t queue)
{
    if(offset == 0 ) return ;
