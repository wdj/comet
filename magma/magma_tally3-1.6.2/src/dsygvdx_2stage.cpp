...
/**
    ...
    @ingroup magma_tally3_dsygv_driver
    ********************************************************************/
    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally3_SUCCESS != magma_tally3_dmalloc( &dA, n*ldda ) ||
        MAGMA_tally3_SUCCESS != magma_tally3_dmalloc( &dB, n*lddb )) {
        *info = MAGMA_tally3_ERR_DEVICE_ALLOC;
        return *info;
    }

    /* Form a Cholesky factorization of B. */
    magma_tally3_dsetmatrix( n, n, B, ldb, dB, lddb );
    magma_tally3_dsetmatrix_async( n, n,
                            A,  lda,
                            dA, ldda, stream );
    ...
    magma_tally3_dpotrf_gpu(uplo, n, dB, lddb, info);
    if (*info != 0) {
        *info = n + *info;
        return *info;
    }
    ...
    magma_tally3_dgetmatrix_async( n, n,
                            dB, lddb,
                            B,  ldb, stream );
    ...
    magma_tally3_dsygst_gpu(itype, uplo, n, dA, ldda, dB, lddb, info);
    ...
    magma_tally3_dsyevdx_2stage(jobz, range, uplo, n, A, lda, vl, vu, il, iu, m, w, work, lwork, iwork, liwork, info);
    ...
    if (wantz && *info == 0) {
        ...
        magma_tally3_dsetmatrix( n, *m, A, lda, dA, ldda );
        magma_tally3_dsetmatrix( n,  n, B, ldb, dB, lddb );
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally3_dtrsm(Magma_tally3Left, uplo, trans, Magma_tally3NonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally3_dtrmm(Magma_tally3Left, uplo, trans, Magma_tally3NonUnit, n, *m, d_one, dB, lddb, dA, ldda);
        }

        magma_tally3_dgetmatrix( n, *m, dA, ldda, A, lda );
