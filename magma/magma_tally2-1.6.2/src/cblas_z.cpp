/*
    ...
    Primarily, we use the standard Fortran BLAS interface in MAGMA_tally2. However,
    ...
    magma_tally2_cblas_dzasum / dasum
    magma_tally2_cblas_dznrm2 / dnrm2
    magma_tally2_cblas_zdotc  / ddot
    magma_tally2_cblas_zdotu  / ddot
    ...
    const magma_tally2DoubleComplex *y, magma_tally2_int_t incy )
{
    ...
    magma_tally2DoubleComplex value = MAGMA_tally2_Z_ZERO;
    ...
    return value;
    //#ifdef COMPLEX
    //magma_tally2DoubleComplex value;
