...
__global__ void
zlascl_diag_lower(int m, int n, magma_tally4DoubleComplex_const_ptr D, int ldd, 
                                      magma_tally4DoubleComplex_ptr A, int lda)
{
...
__global__ void
zlascl_diag_upper(int m, int n, magma_tally4DoubleComplex_const_ptr D, int ldd, 
                                      magma_tally4DoubleComplex_ptr A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_tally4blas_zlascl_diag_q(
...
{
    magma_tally4blas_zlascl_diag_q( type, m, n, dD, lddd, dA, ldda, info, magma_tally4_stream );
}
