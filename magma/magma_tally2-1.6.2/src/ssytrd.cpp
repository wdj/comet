    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    #endif
    if (MAGMA_tally2_SUCCESS != magma_tally2_smalloc( &dA, ldda*n + 2*lddw*nb + ldwork2 )) {
    ...
    if (upper) {
        ...
        for (i = n - nb; i >= kk; i -= nb) {
            ...
            #ifdef FAST_HEMV
            magma_tally2_slatrd2( uplo, i+nb, nb, A(0, 0), lda, e, tau,
        ...
        for (i = 0; i < n-nx; i += nb) {
            ...
            #ifdef FAST_HEMV
            magma_tally2_slatrd2( uplo, n-i, nb, A(i, i), lda, &e[i], &tau[i],
