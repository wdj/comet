...
/**
    ...
    as returned by DGELQF. Q is of order M if SIDE = Magma_minproductLeft and of order N
    ...
    if (nb >= k) {
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            dpanel_to_q( Magma_minproductLower, ib, A(i,i), lda, T2 );
            magma_minproduct_dsetmatrix( ib, nq_i,  A(i,i), lda, dV(0,0), ib );
            dq_to_panel( Magma_minproductLower, ib, A(i,i), lda, T2 );
            ...
            magma_minproduct_dlarfb_gpu( side, transt, Magma_minproductForward, Magma_minproductRowwise,
                              mi, ni, ib,
                              dV(0,0), ib,
                              dT(0,0), ib,
                              dC(ic,jc), lddc,
