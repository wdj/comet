    ...
    magma_minproduct_int_t batchCount, cublasHandle_t myhandle, magma_minproduct_queue_t queue)
{
    ...
    //===============================================
    if(n<nb){
        printf("magma_minproduct_zpotrf_panel error n < nb %d < %d \n",(int) n, (int) nb);
        return -101;
    }
    ...
    if((n-nb) > 0){
        ...
        magma_minproductblas_ztrsm_work_batched(Magma_minproductRight, Magma_minproductLower, Magma_minproductConjTrans, Magma_minproductNonUnit,
                              1, n-nb, nb, 
    ...
    magma_minproduct_int_t batchCount, cublasHandle_t myhandle, magma_minproduct_queue_t queue)
{
    ...
    if(panel_nb <= min_recpnb){
        ...
        //magma_minproduct_zpotrf_rectile_batched(uplo, m, panel_nb, 16,
        magma_minproduct_zpotrf_panel_batched( uplo, m, panel_nb,
                           dA_displ, ldda,
                           dX_array, dX_length,
                           dinvA_array, dinvA_length,
        ...
        magma_minproduct_zdisplace_pointers(dA_displ,  dA_array, ldda, p1+n1, p1, batchCount, queue);        
        magma_minproduct_zdisplace_pointers(dW0_displ, dA_array, ldda, p1+n1, p2, batchCount, queue);        
        magma_minproductblas_zgemm_batched(Magma_minproductNoTrans, Magma_minproductConjTrans, m2, n2, n1,
                              alpha, dA_displ, ldda, 
                              dA_displ, ldda, 
                              beta,  dW0_displ, ldda, 
                              batchCount, queue);
    ...
    magma_minproduct_int_t batchCount, cublasHandle_t myhandle, magma_minproduct_queue_t queue)
{
    ...
    if(panel_nb <= min_recpnb){
        ...
        magma_minproduct_zdisplace_pointers(dA_displ,  dA_array, ldda, p1, p1, batchCount, queue);        
        magma_minproduct_zdisplace_pointers(dW0_displ, dA_array, ldda, p2, p1, batchCount, queue);
        magma_minproductblas_ztrsm_work_batched(Magma_minproductRight, Magma_minproductLower, Magma_minproductConjTrans, Magma_minproductNonUnit,
                              1, n2, n1, 
                              MAGMA_minproduct_Z_ONE,
                              dA_displ,    ldda, 
        ...
        magma_minproduct_zdisplace_pointers(dA_displ,  dA_array, ldda, p2, p1, batchCount, queue);        
        magma_minproduct_zdisplace_pointers(dW0_displ, dA_array, ldda, p2, p2, batchCount, queue);        
        magma_minproductblas_zgemm_batched(Magma_minproductNoTrans, Magma_minproductConjTrans, n2, n2, n1,
                              alpha, dA_displ, ldda, 
                              dA_displ, ldda, 
                              beta,  dW0_displ, ldda, 
                              batchCount, queue);
    ...
    if(m>n){
        ...
        magma_minproduct_zdisplace_pointers(dA_displ,  dA_array, ldda, 0, 0, batchCount, queue);        
        magma_minproduct_zdisplace_pointers(dW0_displ, dA_array, ldda, n, 0, batchCount, queue);
        magma_minproductblas_ztrsm_work_batched(Magma_minproductRight, Magma_minproductLower, Magma_minproductConjTrans, Magma_minproductNonUnit,
                              1, m-n, n, 
                              MAGMA_minproduct_Z_ONE,
                              dA_displ,    ldda, 
