...
#include "magma_minproduct_task_dev_d.h"
  ...
  void magma_minproduct_insert_dev_dmalloc_pinned(magma_minproduct_int_t deviceID, magma_minproduct_int_t size, double **A, void *A_dep_ptr)
 {
    ...
    //  schedule_Task_Flag_Set (&task_flags, THREAD_SET_TO MANUAL_SCHEDULING, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_minproduct_task_dev_dmalloc_pinned, &task_flags,
            sizeof(magma_minproduct_int_t),          &deviceID,VALUE,  
            sizeof(magma_minproduct_int_t),          &size,       VALUE,
 ...
 void magma_minproduct_insert_dev_dfree_pinned(magma_minproduct_int_t deviceID, double *A, void *A_dep_ptr)
 {
    ...
    //  schedule_Task_Flag_Set (&task_flags, THREAD_SET_TO MANUAL_SCHEDULING, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_minproduct_task_dev_dfree_pinned, &task_flags,
              ///sizeof(double**),                A,            OUTPUT,//*size
              sizeof(magma_minproduct_int_t),             &deviceID,VALUE,
 ...
 void magma_minproduct_insert_dev_dfree_pinned_index(magma_minproduct_int_t deviceID, double **A, int index, void *A_dep_ptr)
 {
    ...
    //  schedule_Task_Flag_Set (&task_flags, THREAD_SET_TO MANUAL_SCHEDULING, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_minproduct_task_dev_dfree_pinned_index, &task_flags,
              ///sizeof(double**),                A,            OUTPUT,//*size
              sizeof(magma_minproduct_int_t),             &deviceID,VALUE,
              sizeof(double**),                A,              NODEP,//*size
              sizeof(magma_minproduct_int_t),          &index,       VALUE,
              //dependency to set after the allocation is completed
              sizeof(void *),              A_dep_ptr,    INOUT,
              0);
  ...
  void magma_minproduct_insert_dev_queue_sync(magma_minproduct_int_t deviceID, magma_minproduct_queue_t stream1, void *dep_ptr)
 {
   ...
   //  schedule_Task_Flag_Set (&task_flags, TASK_LOCK_TO_THREAD, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"black");
      ...
      schedule_Insert_Task(sched_obj, magma_minproduct_task_dev_queue_sync, &task_flags,
              sizeof(magma_minproduct_int_t),         &deviceID,    VALUE,
              sizeof(magma_minproduct_queue_t),       &stream1,     VALUE,
  ...
  void magma_minproduct_insert_dev_dsetmatrix(magma_minproduct_int_t deviceID, magma_minproduct_int_t m, magma_minproduct_int_t nb, double *A_src, magma_minproduct_int_t LDA, double *dA_dst, magma_minproduct_int_t dA_LD)
 {
    ...
    //  schedule_Task_Flag_Set (&task_flags, THREAD_SET_TO MANUAL_SCHEDULING, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_minproduct_task_dev_dsetmatrix, &task_flags,
          sizeof(magma_minproduct_int_t),             &deviceID,VALUE,
              sizeof(magma_minproduct_int_t),             &m,       VALUE,
              sizeof(magma_minproduct_int_t),             &nb,      VALUE,
              sizeof(double)*LDA*nb,           A_src,    INPUT,
              sizeof(magma_minproduct_int_t),             &LDA,     VALUE,
              sizeof(double)*dA_LD*nb,         dA_dst,   OUTPUT,
              sizeof(magma_minproduct_int_t),             &dA_LD,   VALUE,
              0);
 ...
 schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"indigo");
           ...
           schedule_Insert_Task(sched_obj, magma_minproduct_task_dev_dgetmatrix, &task_flags,
               sizeof(magma_minproduct_int_t),             &deviceID,VALUE,
              sizeof(magma_minproduct_int_t),             &m,       VALUE,
              sizeof(magma_minproduct_int_t),             &nb,      VALUE,
 ...
 void magma_minproduct_insert_dev_dsetmatrix_transpose(magma_minproduct_int_t deviceID, magma_minproduct_int_t m, magma_minproduct_int_t nb, double *A_src, magma_minproduct_int_t LDA, double *dA_dst, magma_minproduct_int_t dA_LD, double *dwork, magma_minproduct_int_t dwork_LD, void *A_src_dep_ptr, void *dA_dst_dep_ptr)
 {
   ...
   //  schedule_Task_Flag_Set (&task_flags, TASK_LOCK_TO_THREAD, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_minproduct_task_dev_dsetmatrix_transpose, &task_flags,
          sizeof(magma_minproduct_int_t),             &deviceID,VALUE,
              sizeof(magma_minproduct_int_t),             &m,       VALUE,
              sizeof(magma_minproduct_int_t),             &nb,      VALUE,
              sizeof(double)*LDA*nb,           A_src,    INPUT,
             ...
             //  sizeof(double)*dwork_LD*nb,      dwork,    NODEP,
              sizeof(magma_minproduct_int_t),             &dwork_LD,VALUE,
  ...
  void magma_minproduct_insert_dev_dsetmatrix_async_transpose(magma_minproduct_int_t deviceID, magma_minproduct_int_t m, magma_minproduct_int_t nb, double *A_src, magma_minproduct_int_t LDA, double *dA_dst, magma_minproduct_int_t dA_LD, magma_minproduct_queue_t stream1, double *dwork, magma_minproduct_int_t dwork_LD, void *A_src_dep_ptr, void *dA_dst_dep_ptr)
 {
   ...
   //  schedule_Task_Flag_Set (&task_flags, TASK_LOCK_TO_THREAD, 1 ) ;
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"blue");
      ...
      schedule_Insert_Task(sched_obj, magma_minproduct_task_dev_dsetmatrix_async_transpose, &task_flags,
          sizeof(magma_minproduct_int_t),             &deviceID,VALUE,
              sizeof(magma_minproduct_int_t),             &m,       VALUE,
              sizeof(magma_minproduct_int_t),             &nb,      VALUE,
              sizeof(double)*LDA*nb,           A_src,    INPUT,
 ...
 schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"indigo");
           ...
           schedule_Insert_Task(sched_obj, magma_minproduct_task_dev_dgetmatrix_transpose, &task_flags,
               sizeof(magma_minproduct_int_t),             &deviceID,VALUE,
              sizeof(magma_minproduct_int_t),             &m,       VALUE,
              sizeof(magma_minproduct_int_t),             &nb,      VALUE,
              sizeof(double)*dA_LD*nb,         dA_src,   INPUT,
 ...
 schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"indigo");
           ...
           schedule_Insert_Task(sched_obj, magma_minproduct_task_dev_dgetmatrix_async_transpose, &task_flags,
               sizeof(magma_minproduct_int_t),            &deviceID,VALUE,
              sizeof(magma_minproduct_int_t),             &m,       VALUE,
              sizeof(magma_minproduct_int_t),             &nb,      VALUE,
              sizeof(double)*dA_LD*nb,         dA_src,   INPUT,
...
{
            magma_minproduct_int_t ipiv_size;
Schedule_Task_Flags  task_flags = Schedule_Task_Flags_Initializer;
    ...
    //    schedule_Task_Flag_Set(&task_flags, TASK_LOCK_TO_THREAD_MASK,    (intptr_t) str_master_excluded_mask);
        ...
        schedule_Insert_Task(sched_obj, magma_minproduct_task_dev_dlaswp, &task_flags,
            sizeof(magma_minproduct_int_t),             &deviceID,VALUE,
              sizeof(magma_minproduct_int_t),             &n,       VALUE,
              sizeof(double)*lda*n,            dA,       INOUT,
              sizeof(magma_minproduct_int_t),             &lda,     VALUE,
              sizeof(magma_minproduct_int_t),             &i1,      VALUE,
              sizeof(magma_minproduct_int_t),             &i2,      VALUE,
              sizeof(magma_minproduct_int_t)*ipiv_size,   ipiv,     INPUT,
              sizeof(magma_minproduct_int_t),             &inci,    VALUE,
              /*additional dependency to check before the swap*/
              sizeof(void *),                  dA_dep_ptr,INPUT,
              0);

     //magma_minproduct_insert_dlaswp(gpu_ncols, dAT(K,K+A_N), dAT_LD, c_one, nb, &ipiv[K], c_one);
}
/**/
void magma_minproduct_insert_dev_dtrsm(magma_minproduct_int_t deviceID, magma_minproduct_side_t side, magma_minproduct_uplo_t uplo, magma_minproduct_trans_t trans, magma_minproduct_diag_t diag, magma_minproduct_int_t m, magma_minproduct_int_t n, double alpha, double *dA, magma_minproduct_int_t lda, double *dB, magma_minproduct_int_t ldb)
{
...
Schedule_Task_Flags  task_flags = Schedule_Task_Flags_Initializer;
     ...
     //        schedule_Task_Flag_Set (&task_flags, TASK_LOCK_TO_THREAD, 1 ) ;
             ...
             schedule_Insert_Task(sched_obj, magma_minproduct_task_dev_dtrsm, &task_flags,
                 sizeof(magma_minproduct_int_t),          &deviceID,VALUE,
              sizeof(magma_minproduct_side_t),            &side,   VALUE,
              sizeof(magma_minproduct_uplo_t),            &uplo,   VALUE,
              sizeof(magma_minproduct_trans_t),           &trans,  VALUE,
              sizeof(magma_minproduct_side_t),            &diag,   VALUE,
              sizeof(magma_minproduct_int_t),             &m,      VALUE,
              sizeof(magma_minproduct_int_t),             &n,      VALUE,
              ...
              sizeof(magma_minproduct_int_t),             &ldb,    VALUE,
              0);
     //magma_minproduct_insert_dtrsm('R', 'U', 'N', 'U', gpu_ncols, nb, c_one, dAT(K,K), dAT_LD, dAT(K,K+A_N), dAT_LD);
}

void magma_minproduct_insert_dev_dgemm(magma_minproduct_int_t deviceID, magma_minproduct_trans_t transA, magma_minproduct_trans_t transB, magma_minproduct_int_t m, magma_minproduct_int_t n, magma_minproduct_int_t k, double alpha, double *dA, magma_minproduct_int_t lda, double *dB, magma_minproduct_int_t ldb, double beta, double *dC, magma_minproduct_int_t ldc)
{
     magma_minproduct_int_t ka, kb;
     Schedule_Task_Flags  task_flags = Schedule_Task_Flags_Initializer;

     ka = (transA==Magma_minproductNoTrans)?k:m;
     kb = (transB==Magma_minproductNoTrans)?n:k;
   ...
   //  schedule_Task_Flag_Set(&task_flags, TASK_LOCK_TO_THREAD_MASK,    (intptr_t) str_master_excluded_mask);
     ...
     schedule_Task_Flag_Set(&task_flags, TASK_COLOR, (intptr_t)"greenyellow");
              ...
              schedule_Insert_Task(sched_obj, magma_minproduct_task_dev_dgemm, &task_flags,
                  sizeof(magma_minproduct_int_t),         &deviceID,VALUE,
              sizeof(magma_minproduct_trans_t),           &transA, VALUE,
              sizeof(magma_minproduct_trans_t),           &transB, VALUE,
              sizeof(magma_minproduct_int_t),             &m,      VALUE,
              sizeof(magma_minproduct_int_t),             &n,      VALUE,
              sizeof(magma_minproduct_int_t),             &k,      VALUE,
              sizeof(double),                  &alpha,  VALUE,
              ...
              sizeof(magma_minproduct_int_t),             &ldc,    VALUE,
              0);

     //magma_minproduct_insert_dgemm('N','N', gpu_ncols, gpu_nrows, nb, c_neg_one, dAT(K,K+A_N), dAT_LD, dAT(K+1,K), dAT_LD, c_one, dAT(K+1,K+A_N), dAT_LD);
}
