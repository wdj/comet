    ...
    magma_tally3_int_t *info)
{
    ...
    magma_tally3_int_t pm_old=0, pn_old=0, indi_old=0, indj_old=0;
    ...
    *info = 0;
    ...
    if (MAGMA_tally3_SUCCESS != magma_tally3_cmalloc( &dA, (n + 2*nb)*ldda )) {
    ...
    magma_tally3FloatComplex *dwork = dA + n*ldda;
    magma_tally3FloatComplex *dW    = dwork + nb*ldda;
    ...
    magma_tally3_event_t Pupdate_event;
    cudaEventCreateWithFlags(&Pupdate_event,cudaEventDisableTiming);
    //magma_tally3_event_create(&Pupdate_event);
    ...
    if (upper) {
        ...
        if (1 <= n-nb) {
            ...
            magma_tally3_csetmatrix_async( (n-nb), (n-nb),
                                    A(nb+1, nb+1),  lda,
        ...
        for (i = 1; i <= n-nb; i += nb) {
             ...
             if (i > 1 ) {
                 ...
                 magma_tally3_queue_wait_event(stream[1], Pupdate_event);  //, 0);
                 ...
                 magma_tally3_cher2k(Magma_tally3Lower, Magma_tally3NoTrans, pm_old-pn_old, pn_old, c_neg_one,
             ...
             // because below we made a restore cq_to_panel_tally3 and this restore need
             ...
             if (i + nb <= n-nb) {
                 ...
                 magma_tally3_cgemm(Magma_tally3NoTrans, Magma_tally3ConjTrans, pm, pn, pn, c_neg_one,
                             ...
                             dA(indi, indi), ldda);
                 trace_gpu_end( 0, 2 );
                 magma_tally3_event_record(Pupdate_event, stream[0]);
             }
             else {
    ...
    magma_tally3_event_destroy( Pupdate_event );
