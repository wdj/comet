    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    timer_start( time );
    magma_tally3_cheevdx_2stage(jobz, range, uplo, n, A, lda, vl, vu, il, iu, m, w, work, lwork, rwork, lrwork, iwork, liwork, info);
    timer_stop( time );
    ...
    if (wantz && *info == 0) {
        ...
        magma_tally3_csetmatrix( n, *m, A, lda, dA, ldda );
        magma_tally3_csetmatrix( n,  n, B, ldb, dB, lddb );
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally3_ctrsm(Magma_tally3Left, uplo, trans, Magma_tally3NonUnit, n, *m, c_one, dB, lddb, dA, ldda);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally3_ctrmm(Magma_tally3Left, uplo, trans, Magma_tally3NonUnit, n, *m, c_one, dB, lddb, dA, ldda);
        }

        magma_tally3_cgetmatrix( n, *m, dA, ldda, A, lda );
