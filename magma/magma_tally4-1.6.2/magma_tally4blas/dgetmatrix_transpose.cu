/*
    -- MAGMA_tally4 (version 1.6.1) --
       ...
       @generated from zgetmatrix_transpose.cu normal z -> d, Fri Jan 30 19:00:09 2015
...
#define dwork(i_, j_) (dwork + (i_) + (j_)*lddwork)
    ...
    for(i=0; i < n; i += nb) {
        ...
        magma_tally4blas_dtranspose_q( ib, m, dAT(i,0), ldda, dwork(0,(j%2)*nb), lddwork, queues[j%2] );
...
// @see magma_tally4blas_dgetmatrix_transpose_q
extern "C" void 
    ...
    magma_tally4Double_ptr       dwork,  magma_tally4_int_t lddwork, magma_tally4_int_t nb )
{
    ...
    magma_tally4blas_dgetmatrix_transpose_q( m, n, dAT, ldda, hA, lda, dwork, lddwork, nb, queues );
