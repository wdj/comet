/*
    -- MAGMA_tally2 (version 1.6.2) --
       ...
       @generated from magma_tally2_zcsrsplit.cpp normal z -> c, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
    ...
    magma_tally2_queue_t queue )
{
    ...
    if (  A.memory_location == Magma_tally2_CPU &&
        ...
        magma_tally2_c_matrix Ah={Magma_tally2_CSR}, ACSR={Magma_tally2_CSR}, DCSR={Magma_tally2_CSR}, RCSR={Magma_tally2_CSR}, Dh={Magma_tally2_CSR}, Rh={Magma_tally2_CSR};
        CHECK( magma_tally2_cmtransfer( A, &Ah, A.memory_location, Magma_tally2_CPU, queue ));
        CHECK( magma_tally2_cmconvert( Ah, &ACSR, A.storage_type, Magma_tally2_CSR, queue ));

        CHECK( magma_tally2_ccsrsplit( bsize, ACSR, &DCSR, &RCSR, queue ));

        CHECK( magma_tally2_cmconvert( DCSR, &Dh, Magma_tally2_CSR, A.storage_type, queue ));
        CHECK( magma_tally2_cmconvert( RCSR, &Rh, Magma_tally2_CSR, A.storage_type, queue ));

        CHECK( magma_tally2_cmtransfer( Dh, D, Magma_tally2_CPU, A.memory_location, queue ));
        CHECK( magma_tally2_cmtransfer( Rh, R, Magma_tally2_CPU, A.memory_location, queue ));

        magma_tally2_cmfree( &Ah, queue );
        magma_tally2_cmfree( &ACSR, queue );
        magma_tally2_cmfree( &Dh, queue );
        magma_tally2_cmfree( &DCSR, queue );
        magma_tally2_cmfree( &Rh, queue );
        magma_tally2_cmfree( &RCSR, queue );
    }
cleanup:
    if( info != 0 ){
