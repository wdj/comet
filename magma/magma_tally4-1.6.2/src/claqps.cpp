    ...
    while( k < nb && lsticc == 0 ) {
        ...
        *A(rk, k) = c_one;
        ...
        if (k > 0) {
            i__1 = m - rk;
            i__2 = k;
            z__1 = MAGMA_tally4_C_NEGATE( tau[k] );
    ...
    *kb = k + 1;
    ...
    while( lsticc > 0 ) {
        ...
        if (lsticc <= nb)
            ...
            //vn1[lsticc] = magma_tally4_scnrm2(i__1, dA(rk + 1, lsticc), ione);
