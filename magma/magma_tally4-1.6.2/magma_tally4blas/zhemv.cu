...
/**
    Purpose
    -------
    magma_tally4blas_zhemv_work performs the matrix-vector operation:
    ...
    MAGMA_tally4 implements zhemv through two steps:
    ...
    magma_tally4blas_zhemv is a wrapper routine allocating the workspace inside the
    routine and provides the same interface as cublas.
    
    If users need to call zhemv frequently, we suggest using
    magma_tally4blas_zhemv_work instead of magma_tally4blas_zhemv. As the overhead to
    allocate and free in device memory in magma_tally4blas_zhemv would hurt performance.
    ...
    magma_tally4_queue_t queue )
{
    ...
    if ( arch < 200 ) {
        magma_tally4_zhemv( uplo, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
...
// end magma_tally4blas_zhemv_work


/**
    Purpose
    -------
    magma_tally4blas_zhemv performs the matrix-vector operation:
    ...
    magma_tally4DoubleComplex_ptr dy, magma_tally4_int_t incy)
{
    ...
    magma_tally4blas_zhemv_work( uplo, n, alpha, dA, ldda, dx, incx, beta, dy, incy,
