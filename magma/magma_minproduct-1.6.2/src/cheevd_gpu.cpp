    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_minproduct_cstedx( Magma_minproductRangeAll, n, 0., 0., 0, 0, w, &rwork[inde],
        ...
        magma_minproduct_csetmatrix( n, n, &work[indwrk], n, dC, lddc );

        magma_minproduct_cunmtr_gpu( Magma_minproductLeft, uplo, Magma_minproductNoTrans, n, n, dA, ldda, &work[indtau],
                          dC, lddc, wA, ldwa, &iinfo );

        magma_minproduct_ccopymatrix( n, n, dC, lddc, dA, ldda );
