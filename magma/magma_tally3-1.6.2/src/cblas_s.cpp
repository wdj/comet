/*
    -- MAGMA_tally3 (version 1.6.1) --
       ...
       @author Mark Gates
       @generated from cblas_z.cpp normal z -> s, Fri Jan 30 19:00:12 2015
    ...
    magma_tally3_cblas_sasum / dasum
    magma_tally3_cblas_snrm2 / dnrm2
    magma_tally3_cblas_sdot  / ddot
    magma_tally3_cblas_sdot  / ddot
    ...
    const float *y, magma_tally3_int_t incy )
{
    ...
    float value = MAGMA_tally3_S_ZERO;
