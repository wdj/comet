...
__global__ void
magma_tally4_clobpcg_maxpy_kernel( 
...
/**
    ...
    It replaces:
            magma_tally4_caxpy(m*n, c_one, Y, 1, X, 1);
    ...
    @param[in/out]
    Y           magma_tally4FloatComplex_ptr 
    ...
    magma_tally4_queue_t queue )
{
    ...
    magma_tally4_clobpcg_maxpy_kernel<<< grid, threads, 0, queue >>>
