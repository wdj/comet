...
void claswp_rowparallel_devfunc(  
                              ...
                              magma_tally2FloatComplex *dout, int ldo,
                              magma_tally2_int_t* pivinfo)
{
    ...
    magma_tally2FloatComplex *sdata = shared_data;
...
void claswp_rowparallel_kernel( 
                                int n, int width, int height,
                                magma_tally2FloatComplex *dinput, int ldi, 
                                magma_tally2FloatComplex *doutput, int ldo,
                                magma_tally2_int_t*  pivinfo)
{
...
void claswp_rowparallel_kernel_batched(
                                int n, int width, int height,
                                magma_tally2FloatComplex **input_array, int ldi, 
                                magma_tally2FloatComplex **output_array, int ldo,
...
//=================================================================================================
extern "C" void
magma_tally2_claswp_rowparallel_batched( magma_tally2_int_t n, 
                       magma_tally2FloatComplex** input_array, magma_tally2_int_t ldi,
                       ...
                       magma_tally2_int_t batchCount, magma_tally2_queue_t queue)
{
    ...
    if( n < SWP_WIDTH)
    {
        claswp_rowparallel_kernel_batched<<<grid, height, sizeof(magma_tally2FloatComplex) * height * n, queue >>>
                                           ( n, n, height, input_array, ldi, output_array, ldo, pivinfo_array ); 
    }
    else
    {
        claswp_rowparallel_kernel_batched<<< grid, height, sizeof(magma_tally2FloatComplex) * height * SWP_WIDTH , queue >>>
...
//=================================================================================================
extern "C" void
magma_tally2_claswp_rowparallel_q( magma_tally2_int_t n, 
                       magma_tally2FloatComplex* input, magma_tally2_int_t ldi,
                       magma_tally2FloatComplex* output, magma_tally2_int_t ldo,
                       magma_tally2_int_t k1, magma_tally2_int_t k2,
                       magma_tally2_int_t *pivinfo, 
                       magma_tally2_queue_t queue)
{
    ...
    {
       printf(" height=%d > %d, magma_tally2_claswp_rowparallel_q not supported \n", n,MAX_NTHREADS);
    ...
    if( n < SWP_WIDTH)
    {
        claswp_rowparallel_kernel<<<grid, height, sizeof(magma_tally2FloatComplex) * height * n, queue >>>
                                   ( n, n, height, input, ldi, output, ldo, pivinfo ); 
    }
    else
    {
        claswp_rowparallel_kernel<<< grid, height, sizeof(magma_tally2FloatComplex) * height * SWP_WIDTH , queue >>>
...
extern "C" void
magma_tally2_claswp_rowparallel( magma_tally2_int_t n, magma_tally2FloatComplex* input, magma_tally2_int_t ldi,
                   magma_tally2FloatComplex* output, magma_tally2_int_t ldo,
                   magma_tally2_int_t k1, magma_tally2_int_t k2,
                   magma_tally2_int_t *pivinfo)
{
    magma_tally2_claswp_rowparallel_q(n, input, ldi, output, ldo, k1, k2, pivinfo, magma_tally2_stream);
}
...
//=================================================================================================
__global__ void claswp_rowserial_kernel_batched( int n, magma_tally2FloatComplex **dA_array, int lda, int k1, int k2, magma_tally2_int_t** ipiv_array )
{
...
//=================================================================================================
__global__ void claswp_columnserial_kernel_batched( int n, magma_tally2FloatComplex **dA_array, int lda, int k1, int k2, magma_tally2_int_t** ipiv_array )
{
    magma_tally2FloatComplex* dA = dA_array[blockIdx.z];
    magma_tally2_int_t *d_ipiv = ipiv_array[blockIdx.z];
