...
// ----------------------------------------
// CUDA kernel for magma_tally3_zlarfg.
    ...
    magma_tally3DoubleComplex* dtau )
{
    ...
    __shared__ magma_tally3DoubleComplex sscale2;
...
/**
    ...
    @ingroup magma_tally3_zaux1
    ********************************************************************/
extern "C"
void magma_tally3blas_zlarfg_q(
...
/**
    @see magma_tally3blas_zlarfg_q
    @ingroup magma_tally3_zaux1
    ********************************************************************/
extern "C"
void magma_tally3blas_zlarfg(
    magma_tally3_int_t n,
    magma_tally3DoubleComplex_ptr dalpha,
    magma_tally3DoubleComplex_ptr dx, magma_tally3_int_t incx,
    magma_tally3DoubleComplex_ptr dtau )
