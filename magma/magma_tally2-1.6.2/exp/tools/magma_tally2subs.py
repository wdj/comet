subs = {
  ...
  'mixed' : [
    ...
    ('pzgelqf','pdgelqf'),
    ('pzunmlq','pdormlq'),
    ('MAGMA_tally2_ZC','MAGMA_tally2_DS'),
    ('MAGMA_tally2BLAS_ZC','MAGMA_tally2BLAS_DS'),
    ('magma_tally2_z','magma_tally2_d'),
    ('magma_tally2_czgetrs','magma_tally2_sdgetrs'),
    ('magma_tally2_c','magma_tally2_s'),
    ('magma_tally2blas_z','magma_tally2blas_d'),
    ('magma_tally2blas_c','magma_tally2blas_s'),
    ('cublasZ','cublasD'),
    ('cublasC','cublasS'),
    ('MAGMA_tally2_Z','MAGMA_tally2_D'),
    ('MAGMA_tally2_C','MAGMA_tally2_S'),
    ...
    ('cuCabsf','absf'),
    ('zcaxpy','dsaxpy'),
    ('magma_tally2_get_c','magma_tally2_get_s'),
    ('magma_tally2_get_z','magma_tally2_get_d'),
  ...
  'normal' : [ ## Dictionary is keyed on substitution type
    ...
    ('magma_tally2_ssqrt','magma_tally2_dsqrt', 'magma_tally2_ssqrt','magma_tally2_dsqrt'),
    ('cpu_gpu_s','cpu_gpu_d','cpu_gpu_c','cpu_gpu_z'),
    ('spanel_to_q_tally2','dpanel_to_q_tally2','cpanel_to_q_tally2','zpanel_to_q_tally2'),
    ('sq_to_panel_tally2','dq_to_panel_tally2','cq_to_panel_tally2','zq_to_panel_tally2'),
    ...
    ('Magma_tally2Trans','Magma_tally2Trans','Magma_tally2ConjTrans','Magma_tally2ConjTrans'),
    ...
    ('MAGMA_tally2_S','MAGMA_tally2_D','MAGMA_tally2_C','MAGMA_tally2_Z'),
    ('MAGMA_tally2BLAS_S','MAGMA_tally2BLAS_D','MAGMA_tally2BLAS_C','MAGMA_tally2BLAS_Z'),
    ('magma_tally2_s','magma_tally2_d','magma_tally2_c','magma_tally2_z'),
    ('magma_tally2blas_s','magma_tally2blas_d','magma_tally2blas_c','magma_tally2blas_z'),
    ('magma_tally2_get_s','magma_tally2_get_d','magma_tally2_get_c','magma_tally2_get_z'),
    ('magma_tally2f_s','magma_tally2f_d','magma_tally2f_c','magma_tally2f_z'),
    ('ger','ger','gerc','gerc'),
    ('ger','ger','geru','geru'),
