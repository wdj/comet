...
int main(int argc, char **argv)
{
    ...
    magma_tally3DoubleComplex *A, *X, *Y, *Ylapack, *Ycublas, *Ymagma_tally3, *Ymagma_tally31, *hwork;
    magma_tally3DoubleComplex_ptr dA, dX, dY;
    magma_tally3DoubleComplex_ptr d_lA[Magma_tally3MaxGPUs], dwork[Magma_tally3MaxGPUs];
    ...
    magma_tally3_int_t nb = 64;  // required by magma_tally3blas_zhemv_mgpu implementation
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
      ...
      for( int ioffset=0; ioffset < noffsets; ioffset += 1 ) {
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( A,       magma_tally3DoubleComplex, matsize );
            TESTING_MALLOC_CPU( Y,       magma_tally3DoubleComplex, vecsize );
            TESTING_MALLOC_CPU( Ycublas, magma_tally3DoubleComplex, vecsize );
            TESTING_MALLOC_CPU( Ymagma_tally3,  magma_tally3DoubleComplex, vecsize );
            TESTING_MALLOC_CPU( Ymagma_tally31, magma_tally3DoubleComplex, vecsize );
            TESTING_MALLOC_CPU( Ylapack, magma_tally3DoubleComplex, vecsize );

            TESTING_MALLOC_PIN( X,       magma_tally3DoubleComplex, vecsize );
            TESTING_MALLOC_PIN( hwork,   magma_tally3DoubleComplex, lhwork  );
            
            magma_tally3_setdevice( opts.device );
            TESTING_MALLOC_DEV( dA, magma_tally3DoubleComplex, matsize );
            TESTING_MALLOC_DEV( dX, magma_tally3DoubleComplex, vecsize );
            TESTING_MALLOC_DEV( dY, magma_tally3DoubleComplex, vecsize );
            
            // TODO make magma_tally3_zmalloc_bcyclic helper function?
            for( dev=0; dev < opts.ngpu; dev++ ) {
                ...
                magma_tally3_setdevice( dev );
                TESTING_MALLOC_DEV( d_lA[dev],  magma_tally3DoubleComplex, ldda*n_local[dev] );
                TESTING_MALLOC_DEV( dwork[dev], magma_tally3DoubleComplex, ldwork );
            }
            ...
            magma_tally3_zmake_hermitian( Noffset, A, lda );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally3_setdevice( opts.device );
            magma_tally3_zsetmatrix( Noffset, Noffset, A, lda, dA, ldda );
            magma_tally3_zsetvector( Noffset, X, incx, dX, incx );
            magma_tally3_zsetvector( Noffset, Y, incx, dY, incx );
            
            cuda_time = magma_tally3_sync_wtime(0);
            cublasZhemv( opts.handle, cublas_uplo_const_tally3(opts.uplo), N,
            ...
            magma_tally3_zgetvector( Noffset, dY, incx, Ycublas, incx );
            ...
            magma_tally3blas_zhemv_work( opts.uplo, N,
                                  alpha, dA + offset + offset*ldda, ldda,
                                         dX + offset, incx,
            ...
            magma_tally3_zgetvector( Noffset, dY, incx, Ymagma_tally31, incx );
            
            /* =====================================================================
               Performs operation using MAGMA_tally3BLAS (multi-GPU)
               =================================================================== */
            magma_tally3_zsetmatrix_1D_col_bcyclic( Noffset, Noffset, A, lda, d_lA, ldda, opts.ngpu, nb );
            blasf77_zcopy( &Noffset, Y, &incx, Ymagma_tally3, &incx );
            
            // workspaces do NOT need to be zero -- set to NAN to prove
            for( dev=0; dev < opts.ngpu; ++dev ) {
                magma_tally3_setdevice( dev );
                magma_tally3blas_zlaset( Magma_tally3Full, ldwork, 1, MAGMA_tally3_Z_NAN, MAGMA_tally3_Z_NAN, dwork[dev], ldwork );
            }
            lapackf77_zlaset( "Full", &lhwork, &ione, &MAGMA_tally3_Z_NAN, &MAGMA_tally3_Z_NAN, hwork, &lhwork );
            
            mgpu_time = magma_tally3_sync_wtime(0);
            
            magma_tally3_int_t info;
            info = magma_tally3blas_zhemv_mgpu(
                opts.uplo, N,
                alpha,
                d_lA, ldda, offset,
                X + offset, incx,
                ...
                opts.ngpu, nb, queues );
            if ( info != 0 )
                printf("magma_tally3blas_zhemv_mgpu returned error %d: %s.\n",
                       (int) info, magma_tally3_strerror( info ));
            
            info = magma_tally3blas_zhemv_mgpu_sync(
                opts.uplo, N,
                alpha,
                d_lA, ldda, offset,
                X + offset, incx,
                ...
                opts.ngpu, nb, queues );
            if ( info != 0 )
                printf("magma_tally3blas_zhemv_sync returned error %d: %s.\n",
                       (int) info, magma_tally3_strerror( info ));
            ...
            if ( opts.lapack ) {
                ...
                blasf77_zhemv( lapack_uplo_const_tally3(opts.uplo), &N,
                ...
                blasf77_zaxpy( &Noffset, &c_neg_one, Ymagma_tally3, &incx, Ylapack, &incx );
            ...
            blasf77_zaxpy( &Noffset, &c_neg_one, Ymagma_tally3, &incx, Ycublas, &incx );
