...
int main( int argc, char** argv)
{
    ...
    magma_tally3FloatComplex *h_A, *h_C, *h_Cmagma_tally3;
    magma_tally3FloatComplex *d_A, *d_C;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally3_csetmatrix( An, Ak*batchCount, h_A, lda, d_A, ldda );
            magma_tally3_csetmatrix( N, N*batchCount, h_C, ldc, d_C, lddc );
            ...
            magma_tally3blas_cherk_batched(opts.uplo, opts.transA, N, K,
                             alpha, A_array, ldda,
            ...
            magma_tally3_cgetmatrix( N, NN, d_C, lddc, h_Cmagma_tally3, ldc );
            ...
            if ( opts.check ) {
                ...
                for(int i=0; i<batchCount; i++)
                {
                    Cnorm = lapackf77_clanhe("fro", lapack_uplo_const_tally3(opts.uplo), &N, h_C+i*ldc*N, &ldc, work);
                    blasf77_caxpy( &sizeC, &c_neg_one, h_C+i*ldc*N, &ione, h_Cmagma_tally3+i*ldc*N, &ione );
                    current_error = lapackf77_clanhe( "fro", lapack_uplo_const_tally3(opts.uplo), &N, h_Cmagma_tally3+i*ldc*N, &ldc, work ) / Cnorm;
