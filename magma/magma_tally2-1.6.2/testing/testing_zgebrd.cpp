...
int main( int argc, char** argv)
{
    ...
    magma_tally2DoubleComplex *h_A, *h_Q, *h_PT, *h_work;
    magma_tally2DoubleComplex *taup, *tauq;
    double      *diag, *offdiag;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( tauq,    magma_tally2DoubleComplex, minmn );
            TESTING_MALLOC_CPU( taup,    magma_tally2DoubleComplex, minmn );
            ...
            TESTING_MALLOC_PIN( h_work,  magma_tally2DoubleComplex, lhwork );
            
            /* Initialize the matrices */
            lapackf77_zlarnv( &ione, ISEED, &n2, h_A );
            lapackf77_zlacpy( Magma_tally2UpperLowerStr, &M, &N, h_A, &lda, h_Q, &lda );
            
            /* ====================================================================
               Performs operation using MAGMA_tally2
               =================================================================== */
            gpu_time = magma_tally2_wtime();
            magma_tally2_zgebrd( M, N, h_Q, lda,
            ...
            if ( opts.check ) {
                ...
                TESTING_MALLOC_CPU( h_PT,       magma_tally2DoubleComplex, lda*N     );
                ...
                lapackf77_zlacpy(Magma_tally2UpperLowerStr, &M, &N, h_Q, &lda, h_PT, &lda);
