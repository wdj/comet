...
#define Q(i_,j_) (Q + (i_) + (j_)*ldq)
    ...
    magma_tally2_int_t coltyp, i, idlmda;
    magma_tally2_int_t indx, indxc, indxp;
    magma_tally2_int_t iq2, is, iw, iz, k, tmp;
    ...
    *info = 0;
    ...
    if ( k != 0 ) {
        ...
        magma_tally2_slaex3_m(ngpu, k, n, cutpnt, d, Q, ldq, rho,
