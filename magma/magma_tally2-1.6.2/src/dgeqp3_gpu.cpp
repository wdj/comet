    ...
    magma_tally2_int_t *info )
{
    ...
    *info = 0;
    ...
    #endif
    magma_tally2Double_ptr df;
    if (MAGMA_tally2_SUCCESS != magma_tally2_dmalloc( &df, (n+1)*nb )) {
    ...
    if (nfxd < minmn) {
        ...
        magma_tally2blas_dnrm2_cols(sm, sn, dA(nfxd,nfxd), ldda, &rwork[nfxd]);
        ...
        //if (nb < sminmn)
        {
            ...
            while(j < topbmn) {
                ...
                //magma_tally2_dlaqps_gpu    // this is a cpp-file
                magma_tally2_dlaqps2_gpu   // this is a cuda-file
                    ( m, n_j, j, jb, &fjb,
                      dA(0, j), ldda,
