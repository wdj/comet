    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally4_ssetmatrix( n, *mout, &work[indwrk + n* (il-1) ], n, dwork, lddc );

        magma_tally4_sormtr_gpu( Magma_tally4Left, uplo, Magma_tally4NoTrans, n, *mout, dA, ldda, &work[indtau],
                          dwork, lddc, wA, ldwa, &iinfo );

        magma_tally4_scopymatrix( n, *mout, dwork, lddc, dA, ldda );
