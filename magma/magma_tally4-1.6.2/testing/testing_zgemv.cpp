...
int main(int argc, char **argv)
{
    ...
    double          magma_tally4_error, dev_error, work[1];
    ...
    magma_tally4DoubleComplex *A, *X, *Y, *Ydev, *Ymagma_tally4;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( Ydev,    magma_tally4DoubleComplex, sizeY );
            TESTING_MALLOC_CPU( Ymagma_tally4,  magma_tally4DoubleComplex, sizeY );
            
            TESTING_MALLOC_DEV( dA, magma_tally4DoubleComplex, sizeA );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally4_zsetmatrix( M, N, A, lda, dA, lda );
            magma_tally4_zsetvector( Xm, X, incx, dX, incx );
            magma_tally4_zsetvector( Ym, Y, incy, dY, incy );
            
            #ifdef HAVE_CUBLAS
                dev_time = magma_tally4_sync_wtime( 0 );
                cublasZgemv( opts.handle, cublas_trans_const_tally4(opts.transA),
                ...
                magma_tally4_zgemv( opts.transA, M, N,
                             &alpha, dA, lda,
                                     dX, incx,
                             &beta,  dY, incy );
            ...
            magma_tally4_zgetvector( Ym, dY, incy, Ydev, incy );
            ...
            /* =====================================================================
               ...
               =================================================================== */
                ...
                magma_tally4blas_zgemv( opts.transA, M, N, alpha, dA, lda, dX, incx, beta, dY, incy );
                magma_tally4_time = magma_tally4_sync_wtime( 0 ) - magma_tally4_time;
                magma_tally4_perf = gflops / magma_tally4_time;
                
                magma_tally4_zgetvector( Ym, dY, incy, Ymagma_tally4, incy );
            #endif
            ...
            blasf77_zgemv( lapack_trans_const_tally4(opts.transA), &M, &N,
                           &alpha, A, &lda,
                                   X, &incx,
                           &beta,  Y, &incy );
            ...
            #ifdef HAVE_CUBLAS
                blasf77_zaxpy( &Ym, &c_neg_one, Y, &incy, Ymagma_tally4, &incy );
                magma_tally4_error = lapackf77_zlange( "F", &Ym, &ione, Ymagma_tally4, &Ym, work ) / (Anorm * Xnorm);
