...
/**
    ...
    as returned by DGEQLF. Q is of order M if SIDE = Magma_minproductLeft and of order N
    ...
    magma_minproduct_int_t *info)
{
    ...
    *info  = 0;
    ...
    if ( nb >= k ) {
        ...
        magma_minproduct_dmalloc_pinned( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_minproduct_dsetmatrix( m, n, C, ldc, dC, lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set lower triangle of panel in A to identity,
               ...
               3) restore A                                      */
            dpanel_to_q( Magma_minproductLower, ib, A(nq_i-ib,i), lda, T2 );
            magma_minproduct_dsetmatrix( nq_i,  ib, A(0,      i), lda, dV, nq_i );
            dq_to_panel( Magma_minproductLower, ib, A(nq_i-ib,i), lda, T2 );
            ...
            magma_minproduct_dlarfb_gpu( side, trans, Magma_minproductBackward, Magma_minproductColumnwise,
                              mi, ni, ib,
                              dV, nq_i,
                              dT, ib,
                              dC, lddc,
        ...
        magma_minproduct_dgetmatrix( m, n, dC, lddc, C, ldc );
