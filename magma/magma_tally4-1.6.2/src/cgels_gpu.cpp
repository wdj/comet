...
/**
    ...
    @ingroup magma_tally4_cgels_driver
    ********************************************************************/
    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally4_SUCCESS != magma_tally4_cmalloc( &dT, ldtwork )) {
        *info = MAGMA_tally4_ERR_DEVICE_ALLOC;
        return *info;
    }
    
    magma_tally4_cmalloc_cpu( &tau, k );
    if ( tau == NULL ) {
    ...
    if ( *info == 0 ) {
        magma_tally4_cgeqrs_gpu( m, n, nrhs,
                          dA, ldda, tau, dT,
