...
//=================================================================================================
extern "C" void
magma_tally3_dlaswp_rowparallel_batched( magma_tally3_int_t n, 
                       double** input_array, magma_tally3_int_t ldi,
...
//=================================================================================================
extern "C" void
magma_tally3_dlaswp_rowparallel_q( magma_tally3_int_t n, 
                       double* input, magma_tally3_int_t ldi,
                       double* output, magma_tally3_int_t ldo,
                       magma_tally3_int_t k1, magma_tally3_int_t k2,
                       magma_tally3_int_t *pivinfo, 
                       magma_tally3_queue_t queue)
{
    ...
    {
       printf(" height=%d > %d, magma_tally3_dlaswp_rowparallel_q not supported \n", n,MAX_NTHREADS);
...
extern "C" void
magma_tally3_dlaswp_rowparallel( magma_tally3_int_t n, double* input, magma_tally3_int_t ldi,
                   double* output, magma_tally3_int_t ldo,
                   magma_tally3_int_t k1, magma_tally3_int_t k2,
                   magma_tally3_int_t *pivinfo)
{
    magma_tally3_dlaswp_rowparallel_q(n, input, ldi, output, ldo, k1, k2, pivinfo, magma_tally3_stream);
}
...
//=================================================================================================
__global__ void dlaswp_rowserial_kernel_batched( int n, double **dA_array, int lda, int k1, int k2, magma_tally3_int_t** ipiv_array )
{
...
//=================================================================================================
__global__ void dlaswp_columnserial_kernel_batched( int n, double **dA_array, int lda, int k1, int k2, magma_tally3_int_t** ipiv_array )
{
    double* dA = dA_array[blockIdx.z];
    magma_tally3_int_t *d_ipiv = ipiv_array[blockIdx.z];
