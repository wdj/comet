...
/* ////////////////////////////////////////////////////////////////////////////
   -- LAPACK Externs used in MAGMA_tally3
*/
...
#define DWORKFORZ_AND_LD double *rwork, magma_tally3_int_t *ldrwork,
...
void    blasf77_ztrsv( const char *, const char *, const char *, const int *, 
   ...
   */
void    lapackf77_zbdsqr(const char *uplo, magma_tally3_int_t *n, magma_tally3_int_t *nvct, 
             magma_tally3_int_t *nru,  magma_tally3_int_t *ncc, double *D, double *E, 
             ...
             double *work, magma_tally3_int_t *info);
void    lapackf77_zgebak(const char *job, const char *side, magma_tally3_int_t *n, 
             magma_tally3_int_t *ilo, magma_tally3_int_t *ihi, 
                         double *scale, magma_tally3_int_t *m,
             cuDoubleComplex *v, magma_tally3_int_t *ldv, magma_tally3_int_t *info);
void    lapackf77_zgebal(const char *job, magma_tally3_int_t *n, cuDoubleComplex *A, magma_tally3_int_t *lda, 
                         magma_tally3_int_t *ilo, magma_tally3_int_t *ihi, double *scale, magma_tally3_int_t *info);
void    lapackf77_zgebd2(magma_tally3_int_t *m, magma_tally3_int_t *n, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, double *d, double *e,
             cuDoubleComplex *tauq, cuDoubleComplex *taup,
             cuDoubleComplex *work, magma_tally3_int_t *info);
void    lapackf77_zgebrd(magma_tally3_int_t *m, magma_tally3_int_t *n, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, double *d, double *e,
             cuDoubleComplex *tauq, cuDoubleComplex *taup, 
             cuDoubleComplex *work, magma_tally3_int_t *lwork, magma_tally3_int_t *info);
void     lapackf77_zgeev(char *jobl, char *jobr, magma_tally3_int_t *n, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, WSPLIT, 
             ...
             DWORKFORZ magma_tally3_int_t *info);
void    lapackf77_zgehd2(magma_tally3_int_t *n, magma_tally3_int_t *ilo, magma_tally3_int_t *ihi, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, cuDoubleComplex *tau, 
             cuDoubleComplex *work, magma_tally3_int_t *info);
void    lapackf77_zgehrd(magma_tally3_int_t *n, magma_tally3_int_t *ilo, magma_tally3_int_t *ihi, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, cuDoubleComplex *tau,
             cuDoubleComplex *work, magma_tally3_int_t *lwork, magma_tally3_int_t *info);
void    lapackf77_zgelqf(magma_tally3_int_t *m, magma_tally3_int_t *n, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, cuDoubleComplex *tau,
             cuDoubleComplex *work, magma_tally3_int_t *lwork, magma_tally3_int_t *info);
void     lapackf77_zgels(const char *trans, 
             ...
             cuDoubleComplex *work, magma_tally3_int_t *lwork, magma_tally3_int_t *info);
void    lapackf77_zgeqlf(magma_tally3_int_t *m, magma_tally3_int_t *n,
             cuDoubleComplex *a, magma_tally3_int_t *lda, cuDoubleComplex *tau, 
             cuDoubleComplex *work, magma_tally3_int_t *lwork, magma_tally3_int_t *info);
void    lapackf77_zgeqrf(magma_tally3_int_t *m, magma_tally3_int_t *n,
             cuDoubleComplex *a, magma_tally3_int_t *lda, cuDoubleComplex *tau,
             cuDoubleComplex *work, magma_tally3_int_t *lwork, magma_tally3_int_t *info);
void    lapackf77_zgetrf(magma_tally3_int_t *m, magma_tally3_int_t *n, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, 
...
void    lapackf77_zgesvd(const char *jobu, const char *jobvt, 
             ...
             cuDoubleComplex *a, magma_tally3_int_t *lda, 
             double *s, cuDoubleComplex *u, magma_tally3_int_t *ldu, 
                         cuDoubleComplex *vt, magma_tally3_int_t *ldvt, 
             cuDoubleComplex *work, magma_tally3_int_t *lwork, 
             DWORKFORZ magma_tally3_int_t *info );
void    lapackf77_zheev(const char *jobz, const char *uplo, magma_tally3_int_t *n, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, double *w, 
                         cuDoubleComplex *work, magma_tally3_int_t *lwork,
             DWORKFORZ_AND_LD magma_tally3_int_t *info);
void    lapackf77_zheevd(const char *jobz, const char *uplo, magma_tally3_int_t *n, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, double *w, 
                         cuDoubleComplex *work, magma_tally3_int_t *lwork,
             DWORKFORZ_AND_LD magma_tally3_int_t *iwork, 
...
void    lapackf77_zhegvd(magma_tally3_int_t *itype, const char *jobz, const char *uplo, 
             magma_tally3_int_t *n, cuDoubleComplex *a, magma_tally3_int_t *lda,
             cuDoubleComplex *b, magma_tally3_int_t *ldb, double *w,
             cuDoubleComplex *work, magma_tally3_int_t *lwork, 
             DWORKFORZ_AND_LD magma_tally3_int_t *iwork, magma_tally3_int_t *liwork,
             magma_tally3_int_t *info);
void    lapackf77_zhetd2(const char *uplo, magma_tally3_int_t *n, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, 
             double *d, double *e, cuDoubleComplex *tau, magma_tally3_int_t *info);
void    lapackf77_zhetrd(const char *uplo, magma_tally3_int_t *n, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, 
             double *d, double *e, cuDoubleComplex *tau, 
             cuDoubleComplex *work, magma_tally3_int_t *lwork, magma_tally3_int_t *info);
void    lapackf77_zhseqr(const char *job, const char *compz, magma_tally3_int_t *n, 
             magma_tally3_int_t *ilo, magma_tally3_int_t *ihi, 
                         cuDoubleComplex *H, magma_tally3_int_t *ldh, WSPLIT, 
                         cuDoubleComplex *Z, magma_tally3_int_t *ldz, 
             cuDoubleComplex *work, magma_tally3_int_t *lwork, magma_tally3_int_t *info);
void    lapackf77_zlacpy(const char *uplo, magma_tally3_int_t *m, magma_tally3_int_t *n, 
             const cuDoubleComplex *a, magma_tally3_int_t *lda, 
             cuDoubleComplex *b, magma_tally3_int_t *ldb);
void    lapackf77_zlacgv(magma_tally3_int_t *n, cuDoubleComplex *x, magma_tally3_int_t *incx);
double  lapackf77_zlange(const char *norm, magma_tally3_int_t *m, magma_tally3_int_t *n, 
             const cuDoubleComplex *a, magma_tally3_int_t *lda, double *work);
double  lapackf77_zlanhe(const char *norm, const char *uplo, magma_tally3_int_t *n, 
             const cuDoubleComplex *a, magma_tally3_int_t *lda, double * work);
double  lapackf77_zlansy(const char *norm, const char *uplo, magma_tally3_int_t *n, 
             const cuDoubleComplex *a, magma_tally3_int_t *lda, double * work);
void    lapackf77_zlarfb(const char *side, const char *trans, const char *direct, 
             const char *storev, magma_tally3_int_t *m, magma_tally3_int_t *n, magma_tally3_int_t *k, 
             const cuDoubleComplex *v, magma_tally3_int_t *ldv, 
             const cuDoubleComplex *t, magma_tally3_int_t *ldt, 
             cuDoubleComplex *c, magma_tally3_int_t *ldc, 
             cuDoubleComplex *work, magma_tally3_int_t *ldwork);
void    lapackf77_zlarfg(magma_tally3_int_t *n, cuDoubleComplex *alpha, 
             cuDoubleComplex *x, magma_tally3_int_t *incx, cuDoubleComplex *tau);
void    lapackf77_zlarft(const char *direct, const char *storev, magma_tally3_int_t *n, magma_tally3_int_t *k, 
             cuDoubleComplex *v, magma_tally3_int_t *ldv, const cuDoubleComplex *tau, 
             cuDoubleComplex *t, magma_tally3_int_t *ldt);
void    lapackf77_zlarnv(magma_tally3_int_t *idist, magma_tally3_int_t *iseed, magma_tally3_int_t *n, 
             cuDoubleComplex *x);
void    lapackf77_zlartg(cuDoubleComplex *F, cuDoubleComplex *G, double *cs, 
             cuDoubleComplex *SN, cuDoubleComplex *R);
void    lapackf77_zlascl(const char *type, magma_tally3_int_t *kl, magma_tally3_int_t *ku, 
             double *cfrom, double *cto, 
                         magma_tally3_int_t *m, magma_tally3_int_t *n, 
             cuDoubleComplex *A, magma_tally3_int_t *lda, magma_tally3_int_t *info);
void    lapackf77_zlaset(const char *uplo, magma_tally3_int_t *m, magma_tally3_int_t *n, 
             cuDoubleComplex *alpha, cuDoubleComplex *beta,
             cuDoubleComplex *A, magma_tally3_int_t *lda);
void    lapackf77_zlaswp(magma_tally3_int_t *n, cuDoubleComplex *a, magma_tally3_int_t *lda, 
             magma_tally3_int_t *k1, magma_tally3_int_t *k2, magma_tally3_int_t *ipiv,
             magma_tally3_int_t *incx);
void    lapackf77_zlatrd(const char *uplo, magma_tally3_int_t *n, magma_tally3_int_t *nb, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, double *e,
             cuDoubleComplex *tau, cuDoubleComplex *work, magma_tally3_int_t *ldwork);
void    lapackf77_zlabrd(magma_tally3_int_t *m, magma_tally3_int_t *n, magma_tally3_int_t *nb, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, double *d__, double *e, 
             cuDoubleComplex *tauq, cuDoubleComplex *taup,
             cuDoubleComplex *x, magma_tally3_int_t *ldx,
             cuDoubleComplex *y, magma_tally3_int_t *ldy);
void    lapackf77_zpotrf(const char *uplo, magma_tally3_int_t *n, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, magma_tally3_int_t *info);
void    lapackf77_zpotrs(const char *uplo, magma_tally3_int_t *n, magma_tally3_int_t *nrhs,
             cuDoubleComplex *a, magma_tally3_int_t *lda,
             cuDoubleComplex *b, magma_tally3_int_t *ldb, magma_tally3_int_t *info);
void    lapackf77_zpotri(const char *uplo, magma_tally3_int_t *n, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, magma_tally3_int_t *info);
void    lapackf77_zlauum(const char *uplo, magma_tally3_int_t *n, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, magma_tally3_int_t *info);
void    lapackf77_ztrevc(const char *side, const char *howmny, magma_tally3_int_t *select, magma_tally3_int_t *n, 
                         cuDoubleComplex *T,  magma_tally3_int_t *ldt,  cuDoubleComplex *VL, magma_tally3_int_t *ldvl,
                         cuDoubleComplex *VR, magma_tally3_int_t *ldvr, magma_tally3_int_t *MM, magma_tally3_int_t *M, 
                         cuDoubleComplex *work, DWORKFORZ magma_tally3_int_t *info);
void    lapackf77_zsteqr(const char *compz, magma_tally3_int_t *n, double *D, double *E, 
                         cuDoubleComplex *Z, magma_tally3_int_t *ldz, 
                         double *work, magma_tally3_int_t *info);
void    lapackf77_zstedc(const char *compz, magma_tally3_int_t *n, double *D, double *E, 
             cuDoubleComplex *Z, magma_tally3_int_t *ldz, 
                         cuDoubleComplex *work, magma_tally3_int_t *ldwork, 
             DWORKFORZ_AND_LD magma_tally3_int_t *iwork, magma_tally3_int_t *liwork,
             magma_tally3_int_t *info);
void    lapackf77_ztrtri(const char *uplo, const char *diag, magma_tally3_int_t *n,
             cuDoubleComplex *a, magma_tally3_int_t *lda, magma_tally3_int_t *info);
#if defined(PRECISION_z) || defined(PRECISION_c)
void    lapackf77_zsymv(const char *uplo, const magma_tally3_int_t *N, const cuDoubleComplex *alpha, 
            const cuDoubleComplex *A, const magma_tally3_int_t *lda, 
            const cuDoubleComplex *X, const magma_tally3_int_t *incX,
            const cuDoubleComplex *beta, 
            cuDoubleComplex *Y, const magma_tally3_int_t *incY);
#endif
void    lapackf77_zung2r(magma_tally3_int_t *m, magma_tally3_int_t *n, magma_tally3_int_t *k, 
             cuDoubleComplex *a, magma_tally3_int_t *lda,
             const cuDoubleComplex *tau, cuDoubleComplex *work,
             magma_tally3_int_t *info);
void    lapackf77_zungbr(const char *vect, magma_tally3_int_t *m, magma_tally3_int_t *n, magma_tally3_int_t *k,
             cuDoubleComplex *a, magma_tally3_int_t *lda, const cuDoubleComplex *tau,
             cuDoubleComplex *work, magma_tally3_int_t *lwork, magma_tally3_int_t *info);
void    lapackf77_zunghr(magma_tally3_int_t *n, magma_tally3_int_t *ilo, magma_tally3_int_t *ihi, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, const cuDoubleComplex *tau,
             cuDoubleComplex *work, magma_tally3_int_t *lwork, magma_tally3_int_t *info);
void    lapackf77_zunglq(magma_tally3_int_t *m, magma_tally3_int_t *n, magma_tally3_int_t *k, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, const cuDoubleComplex *tau, 
             cuDoubleComplex *work, magma_tally3_int_t *ldwork, magma_tally3_int_t *info);
void    lapackf77_zungqr(magma_tally3_int_t *m, magma_tally3_int_t *n, magma_tally3_int_t *k, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, const cuDoubleComplex *tau, 
             cuDoubleComplex *work, magma_tally3_int_t *ldwork, magma_tally3_int_t *info);
void    lapackf77_zungtr(const char *uplo, magma_tally3_int_t *n, 
             cuDoubleComplex *a, magma_tally3_int_t *lda, const cuDoubleComplex *tau, 
             cuDoubleComplex *work, magma_tally3_int_t *lwork, magma_tally3_int_t *info);
void    lapackf77_zunm2r(const char *side, const char *trans, 
             magma_tally3_int_t *m, magma_tally3_int_t *n, magma_tally3_int_t *k, 
             const cuDoubleComplex *a, magma_tally3_int_t *lda, 
             const cuDoubleComplex *tau, cuDoubleComplex *c, magma_tally3_int_t *ldc,
             cuDoubleComplex *work, magma_tally3_int_t *info);
