...
int main( int argc, char** argv )
{
    ...
    magma_tally2DoubleComplex *hA, *hR, *hT, *tau, *h_work;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_PIN( hA,     magma_tally2DoubleComplex, lda*n     );
            TESTING_MALLOC_PIN( h_work, magma_tally2DoubleComplex, lwork     );
            
            TESTING_MALLOC_CPU( hR,     magma_tally2DoubleComplex, lda*n     );
            TESTING_MALLOC_CPU( hT,     magma_tally2DoubleComplex, min_mn*nb );
            ...
            lapackf77_zlacpy( Magma_tally2UpperLowerStr, &m, &n, hA, &lda, hR, &lda );
            ...
            magma_tally2_zgetmatrix( nb, min_mn, dT, nb, hT, nb );
            
            gpu_time = magma_tally2_wtime();
            magma_tally2_zungqr_m( m, n, k, hR, lda, tau, hT, nb, &info );
