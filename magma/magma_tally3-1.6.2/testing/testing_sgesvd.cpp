        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            switch( opts.svd_work ) {
                case 0: {  // query for workspace size
                    lwork = -1;
                    magma_tally3_sgesvd( jobu, jobvt, M, N,
                                  h_R, lda, S1, U, ldu, VT, ldv, dummy, lwork,
                                  #ifdef COMPLEX
                                  rwork,
                                  #endif
                                  &info );
                    lwork = (int) MAGMA_tally3_S_REAL( dummy[0] );
                    break;
                }
            ...
            if (info != 0)
                printf("magma_tally3_sgesvd returned error %d: %s.\n",
            ...
            if ( opts.lapack ) {
                ...
                lapackf77_sgesvd( lapack_vec_const_tally3(jobu), lapack_vec_const_tally3(jobvt), &M, &N,
