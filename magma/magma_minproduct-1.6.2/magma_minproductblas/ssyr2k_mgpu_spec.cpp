...
/**
    ...
    ********************************************************************/
extern "C"
void magma_minproductblas_ssyr2k_mgpu_spec(
    ...
    magma_minproduct_int_t ngpu, magma_minproduct_int_t nb, magma_minproduct_queue_t queues[][20], magma_minproduct_int_t nqueue )
{
    ...
    for( magma_minproduct_int_t i = 0; i < n; i += ib ) {
        ...
        magma_minproduct_sgemm( Magma_minproductNoTrans, Magma_minproductTrans, n, ib, k,
    ...
    alpha = MAGMA_minproduct_S_CNJG( alpha );
