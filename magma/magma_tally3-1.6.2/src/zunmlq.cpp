...
/**
    ...
    as returned by ZGELQF. Q is of order M if SIDE = Magma_tally3Left and of order N
    ...
    @ingroup magma_tally3_zgelqf_comp
    ********************************************************************/
    ...
    magma_tally3_int_t *info)
{
    ...
    magma_tally3DoubleComplex *T, *T2;
    ...
    *info = 0;
    ...
    if (*info == 0) {
        nb = magma_tally3_get_zgelqf_nb( min( m, n ));
        lwkopt = max(1,nw)*nb;
    ...
    if (nb >= k) {
        /* Use CPU code */
        lapackf77_zunmlq( lapack_side_const_tally3(side), lapack_trans_const_tally3(trans),
        ...
        magma_tally3DoubleComplex_ptr dwork, dV, dT, dC;
        magma_tally3_zmalloc( &dwork, (nw + nq + nb)*nb + lddc*n );
        if ( dwork == NULL ) {
        ...
        magma_tally3_zmalloc_cpu( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_tally3_zsetmatrix( m, n, C, ldc, dC(0,0), lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            zpanel_to_q_tally3( Magma_tally3Lower, ib, A(i,i), lda, T2 );
            magma_tally3_zsetmatrix( ib, nq_i,  A(i,i), lda, dV(0,0), ib );
            zq_to_panel_tally3( Magma_tally3Lower, ib, A(i,i), lda, T2 );
            ...
            magma_tally3_zsetmatrix( ib, ib, T, ib, dT(0,0), ib );
            magma_tally3_zlarfb_gpu( side, transt, Magma_tally3Forward, Magma_tally3Rowwise,
                              mi, ni, ib,
                              dV(0,0), ib,
                              dT(0,0), ib,
                              dC(ic,jc), lddc,
        ...
        magma_tally3_zgetmatrix( m, n, dC(0,0), lddc, C, ldc );
