    ...
    if (upper) {
        ...
        for (i = 1; i <= n-nb; i += nb) {
             ...
             if (i > 1 ) {
                 ...
                 spanel_to_q(Magma_tally4Upper, pn-1, A(i, i+1), lda, work);
                 ...
                 trace_cpu_end( 0 );
                 sq_to_panel(Magma_tally4Upper, pn-1, A(i, i+1), lda, work);
             }
             ...
             spanel_to_q(Magma_tally4Upper, pk, A(indi, indj), lda, work);
             trace_cpu_end( 0 );
             ...
             trace_gpu_end( 0, 2 );
             /* restore the panel */
             sq_to_panel(Magma_tally4Upper, pk, A(indi, indj), lda, work);
        ...
        pk = min(pm,pn);
        if (1 <= n-nb) {
            spanel_to_q(Magma_tally4Upper, pk-1, A(n-pk+1, n-pk+2), lda, work);
            trace_gpu_start( 0, 2, "get", "get last block" );
            magma_tally4_sgetmatrix( pk, pk,
                              dA(n-pk+1, n-pk+1), ldda,
                              A(n-pk+1, n-pk+1),  lda );
            trace_gpu_end( 0, 2 );
            sq_to_panel(Magma_tally4Upper, pk-1, A(n-pk+1, n-pk+2), lda, work);
        }
    }// end of LOWER
