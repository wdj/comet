...
/**
    ...
    @ingroup magma_tally2_cgels_driver
    ********************************************************************/
    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally2_SUCCESS != magma_tally2_cmalloc( &dT, ldtwork )) {
        *info = MAGMA_tally2_ERR_DEVICE_ALLOC;
        return *info;
    }
    
    magma_tally2_cmalloc_cpu( &tau, k );
    if ( tau == NULL ) {
    ...
    if ( *info == 0 ) {
        magma_tally2_cgeqrs_gpu( m, n, nrhs,
                          dA, ldda, tau, dT,
