...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally2_zgeev_m( opts.jobvl, opts.jobvr,
                           N, h_R, lda, w1,
                           VL, lda, VR, lda,
            ...
            if ( opts.check ) {
                ...
                magma_tally2_zgeev_m( Magma_tally2Vec, Magma_tally2Vec,
                               N, h_R, lda, w1,
                               VL, lda, VR, lda,
                               h_work, lwork, rwork, &info );
                ...
                for( int j = 0; j < N; ++j ) {
                    ...
                    for( int jj = 0; jj <N; ++jj ) {
                        vtst = MAGMA_tally2_Z_ABS(VR[jj + j*lda]);
                        if (vtst > vmx)
                            vmx = vtst;
                ...
                for( int j = 0; j < N; ++j ) {
                    ...
                    vmx = vrmx = 0.;
                    for( int jj = 0; jj < N; ++jj ) {
                        vtst = MAGMA_tally2_Z_ABS(VL[jj + j*lda]);
                        if (vtst > vmx)
                            vmx = vtst;
                ...
                lapackf77_zlacpy( Magma_tally2UpperLowerStr, &N, &N, h_A, &lda, h_R, &lda );
                magma_tally2_zgeev_m( Magma_tally2NoVec, Magma_tally2NoVec,
                               N, h_R, lda, w2,
                               &DUM, 1, &DUM, 1,
                               h_work, lwork, rwork, &info );
                ...
                lapackf77_zlacpy( Magma_tally2UpperLowerStr, &N, &N, h_A, &lda, h_R, &lda );
                magma_tally2_zgeev_m( Magma_tally2NoVec, Magma_tally2Vec,
                               N, h_R, lda, w2,
                               &DUM, 1, LRE, lda,
                               h_work, lwork, rwork, &info );
                ...
                lapackf77_zlacpy( Magma_tally2UpperLowerStr, &N, &N, h_A, &lda, h_R, &lda );
                magma_tally2_zgeev_m( Magma_tally2Vec, Magma_tally2NoVec,
                               N, h_R, lda, w2,
                               LRE, lda, &DUM, 1,
                               h_work, lwork, rwork, &info );
