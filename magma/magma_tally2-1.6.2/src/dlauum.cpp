    ...
    if (nb <= 1 || nb >= n)
        ...
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally2_dsetmatrix_async( ib, (n-i-ib),
                                        A(i,i+ib),  lda,
                ...
                lapackf77_dlauum(Magma_tally2UpperStr, &ib, A(i,i), &lda, info);
                ...
                magma_tally2_dgetmatrix( i+ib, ib,
                                  dA(0, i), ldda,
                                  A(0, i),  lda );
            }
        }
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally2_dsetmatrix_async( (n-i-ib), ib,
                                        A(i+ib, i),  lda,
                ...
                lapackf77_dlauum(Magma_tally2LowerStr, &ib, A(i,i), &lda, info);
                ...
                magma_tally2_dgetmatrix( ib, i+ib,
                                  dA(i, 0), ldda,
                                  A(i, 0),  lda );
            }
        }
