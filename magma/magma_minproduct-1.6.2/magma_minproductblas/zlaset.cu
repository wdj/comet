    ...
    magma_minproductDoubleComplex *A, int lda )
{
    ...
    bool full = (iby + BLK_Y <= n && (ind >= iby + BLK_Y || ind + BLK_X <= iby || MAGMA_minproduct_Z_EQUAL( offdiag, diag )));
...
void zlaset_full_kernel(
    int m, int n,
    magma_minproductDoubleComplex offdiag, magma_minproductDoubleComplex diag,
    magma_minproductDoubleComplex *dA, int ldda )
{
...
void zlaset_full_kernel_batched(
    int m, int n,
    magma_minproductDoubleComplex offdiag, magma_minproductDoubleComplex diag,
    magma_minproductDoubleComplex **dAarray, int ldda )
{
...
/**
    ...
    ********************************************************************/
extern "C"
void magma_minproductblas_zlaset_q(
    ...
    magma_minproduct_queue_t queue)
{
    ...
    if (uplo == Magma_minproductLower) {
        ...
        if ( m == ldda &&
             MAGMA_minproduct_Z_EQUAL( offdiag, MAGMA_minproduct_Z_ZERO ) &&
             MAGMA_minproduct_Z_EQUAL( diag,    MAGMA_minproduct_Z_ZERO ) )
        {
            size_t size = m*n;
            cudaError_t err = cudaMemsetAsync( dA, 0, size*sizeof(magma_minproductDoubleComplex), queue );
...
/**
    @see magma_minproductblas_zlaset_q
    @ingroup magma_minproduct_zaux2
    ********************************************************************/
extern "C"
void magma_minproductblas_zlaset(
    magma_minproduct_uplo_t uplo, magma_minproduct_int_t m, magma_minproduct_int_t n,
    magma_minproductDoubleComplex offdiag, magma_minproductDoubleComplex diag,
    magma_minproductDoubleComplex_ptr dA, magma_minproduct_int_t ldda )
{
    magma_minproductblas_zlaset_q( uplo, m, n, offdiag, diag, dA, ldda, magma_minproduct_stream );
}


////////////////////////////////////////////////////////////////////////////////////////
extern "C"
void magma_minproductblas_zlaset_batched(
    magma_minproduct_uplo_t uplo, magma_minproduct_int_t m, magma_minproduct_int_t n,
    magma_minproductDoubleComplex offdiag, magma_minproductDoubleComplex diag,
