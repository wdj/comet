    ...
    magma_tally2_int_t *info)
{
    ...
    *info  = 0;
    ...
    if ( nb >= k ) {
        /* Use CPU code */
        lapackf77_cunmql( lapack_side_const_tally2(side), lapack_trans_const_tally2(trans),
        ...
        magma_tally2FloatComplex *dwork, *dV, *dT, *dC;
        ...
        magma_tally2_cmalloc_pinned( &T, 2*nb*nb );
        if ( T == NULL ) {
        ...
        magma_tally2_csetmatrix( m, n, C, ldc, dC, lddc );
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set lower triangle of panel in A to identity,
               ...
               3) restore A                                      */
            cpanel_to_q_tally2( Magma_tally2Lower, ib, A(nq_i-ib,i), lda, T2 );
            magma_tally2_csetmatrix( nq_i,  ib, A(0,      i), lda, dV, nq_i );
            cq_to_panel_tally2( Magma_tally2Lower, ib, A(nq_i-ib,i), lda, T2 );
        ...
        magma_tally2_cgetmatrix( m, n, dC, lddc, C, ldc );
