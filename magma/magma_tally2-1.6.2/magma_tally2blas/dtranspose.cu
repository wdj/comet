...
/**
    @see magma_tally2blas_dtranspose_q
    @ingroup magma_tally2_daux2
    ********************************************************************/
extern "C" void
magma_tally2blas_dtranspose(
    ...
    magma_tally2Double_ptr       dAT, magma_tally2_int_t lddat )
{
    magma_tally2blas_dtranspose_q( m, n, dA, ldda, dAT, lddat, magma_tally2_stream );
}
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_tally2blas_dtranspose_batched_q(
    magma_tally2_int_t m, magma_tally2_int_t n,
    double **dA_array,  magma_tally2_int_t ldda,
    double **dAT_array, magma_tally2_int_t lddat, magma_tally2_int_t batchCount, magma_tally2_queue_t queue )
{
    magma_tally2_int_t info = 0;
    if ( m < 0 )
        info = -1;
...
/**
    @see magma_tally2blas_dtranspose_batched_q
    @ingroup magma_tally2_daux2
    ********************************************************************/
extern "C" void
...
{
    magma_tally2blas_dtranspose_batched_q( m, n, dA_array, ldda, dAT_array, lddat, batchCount, magma_tally2_stream );
}
