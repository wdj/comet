...
__global__ void 
magma_tally4_citerilu_csr_kernel(   
    magma_tally4_int_t num_rows, 
    magma_tally4_int_t nnz,  
    magma_tally4_index_t *rowidxA, 
    magma_tally4_index_t *colidxA,
    const magma_tally4FloatComplex * __restrict__ A, 
    magma_tally4_index_t *rowptrL, 
    magma_tally4_index_t *colidxL, 
    magma_tally4FloatComplex *valL, 
    magma_tally4_index_t *rowptrU, 
    magma_tally4_index_t *rowidxU, 
    magma_tally4FloatComplex *valU ){
...
/**
    ...
    The input format of the matrix is Magma_tally4_CSRCOO for the upper and lower 
...
magma_tally4_citerilu_csr( 
    ...
    magma_tally4_citerilu_csr_kernel<<< grid, block, 0, magma_tally4_stream >>>
        ( A.num_rows, A.nnz, 
