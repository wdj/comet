...
__global__ void
zlascl_diag_lower(int m, int n, magma_minproductDoubleComplex_const_ptr D, int ldd, 
                                      magma_minproductDoubleComplex_ptr A, int lda)
{
...
__global__ void
zlascl_diag_upper(int m, int n, magma_minproductDoubleComplex_const_ptr D, int ldd, 
                                      magma_minproductDoubleComplex_ptr A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
/**
    ...
    ********************************************************************/
extern "C" void
magma_minproductblas_zlascl_diag_q(
...
{
    magma_minproductblas_zlascl_diag_q( type, m, n, dD, lddd, dA, ldda, info, magma_minproduct_stream );
}
