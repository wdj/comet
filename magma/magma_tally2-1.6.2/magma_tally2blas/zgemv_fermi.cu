    ...
    magma_tally2DoubleComplex       * __restrict__ y, int incy)
{
    ...
    __shared__ magma_tally2DoubleComplex sx[BLK_Y];
    ...
    if ( threadIdx.x < npart ) {
        ...
        sx[threadIdx.x] = MAGMA_tally2_Z_ZERO;
    }
    __syncthreads();
    ...
    magma_tally2DoubleComplex       * __restrict__ y, int incy)
{
    ...
    __shared__ magma_tally2DoubleComplex sdata[BLK_X];
...
magma_tally2blas_zgemv(
    magma_tally2_trans_t trans, magma_tally2_int_t m, magma_tally2_int_t n, magma_tally2DoubleComplex alpha,
    ...
    magma_tally2DoubleComplex_ptr dy, magma_tally2_int_t incy)
{
    ...
    if ( arch < 200  ) {
        ...
        magma_tally2_zgemv( trans, m, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
        #else
        magma_tally2blas_zgemv_tesla( trans, m, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
        #endif
        return;
    }
    ...
    if ( trans == Magma_tally2NoTrans ) {
        ...
        zgemvn_kernel1_fermi<<< grid, threads, 0, magma_tally2_stream >>>
            ( m, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
    }
    else if ( trans == Magma_tally2Trans ) {
        dim3 grid    ( 1, n, 1 );
        dim3 threads ( BLK_X, 1, 1 );
        zgemvt_kernel_fermi<<< grid, threads, 0, magma_tally2_stream >>>
            ( m, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
    }
    else if ( trans == Magma_tally2ConjTrans ) {
        dim3 grid    ( 1, n, 1 );
        dim3 threads ( BLK_X, 1, 1 );
        zgemvc_kernel_fermi<<< grid, threads, 0, magma_tally2_stream >>>
            ( m, n, alpha, dA, ldda, dx, incx, beta, dy, incy );
    }
}
