...
__global__ void
clascl2_full(int m, int n, const float* D, magma_minproductFloatComplex* A, int lda)
{
...
__global__ void
clascl2_lower(int m, int n, const float* D, magma_minproductFloatComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
__global__ void
clascl2_upper(int m, int n, const float *D, magma_minproductFloatComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
magma_minproductblas_clascl2(
    magma_minproduct_type_t type, magma_minproduct_int_t m, magma_minproduct_int_t n,
    magma_minproductFloat_const_ptr dD,
    magma_minproductFloatComplex_ptr dA, magma_minproduct_int_t ldda, magma_minproduct_int_t *info )
{
    magma_minproductblas_clascl2_q( type, m, n, dD, dA, ldda, magma_minproduct_stream, info );
}
