/*
    -- MAGMA_tally3 (version 1.6.1) --
       ...
       @generated from zheevr.cpp normal z -> c, Fri Jan 30 19:00:17 2015
    ...
    magma_tally3_int_t *info)
{
    ...
    *m = 0;
    ...
    magma_tally3_chetrd(uplo, n, A, lda, &rwork[indrd], &rwork[indre], &work[indtau], &work[indwk], llwork, &iinfo);
