...
// copying vectors
extern "C" void
magma_minproduct_setvector_internal(
    magma_minproduct_int_t n, magma_minproduct_int_t elemSize,
    void const* hx_src, magma_minproduct_int_t incx,
    magma_minproduct_ptr   dy_dst, magma_minproduct_int_t incy,
...
// --------------------
extern "C" void
magma_minproduct_setvector_async_internal(
    magma_minproduct_int_t n, magma_minproduct_int_t elemSize,
    void const* hx_src, magma_minproduct_int_t incx,
    magma_minproduct_ptr   dy_dst, magma_minproduct_int_t incy,
...
// --------------------
extern "C" void
magma_minproduct_getvector_internal(
    magma_minproduct_int_t n, magma_minproduct_int_t elemSize,
    magma_minproduct_const_ptr dx_src, magma_minproduct_int_t incx,
...
// --------------------
extern "C" void
magma_minproduct_getvector_async_internal(
    magma_minproduct_int_t n, magma_minproduct_int_t elemSize,
    magma_minproduct_const_ptr dx_src, magma_minproduct_int_t incx,
    void*           hy_dst, magma_minproduct_int_t incy,
    magma_minproduct_queue_t queue,
...
extern "C" void
magma_minproduct_copyvector_internal(
    magma_minproduct_int_t n, magma_minproduct_int_t elemSize,
    magma_minproduct_const_ptr dx_src, magma_minproduct_int_t incx,
    magma_minproduct_ptr       dy_dst, magma_minproduct_int_t incy,
    const char* func, const char* file, int line )
{
    if ( incx == 1 && incy == 1 ) {
        ...
        magma_minproduct_copymatrix_internal(
...
// --------------------
extern "C" void
magma_minproduct_copyvector_async_internal(
    magma_minproduct_int_t n, magma_minproduct_int_t elemSize,
    magma_minproduct_const_ptr dx_src, magma_minproduct_int_t incx,
    magma_minproduct_ptr       dy_dst, magma_minproduct_int_t incy,
    magma_minproduct_queue_t queue,
    const char* func, const char* file, int line )
{
    if ( incx == 1 && incy == 1 ) {
        ...
        magma_minproduct_copymatrix_async_internal(
...
extern "C" void
magma_minproduct_setmatrix_internal(
    magma_minproduct_int_t m, magma_minproduct_int_t n, magma_minproduct_int_t elemSize,
    void const* hA_src, magma_minproduct_int_t ldha,
    magma_minproduct_ptr   dB_dst, magma_minproduct_int_t lddb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
...
// --------------------
extern "C" void
magma_minproduct_setmatrix_async_internal(
    magma_minproduct_int_t m, magma_minproduct_int_t n, magma_minproduct_int_t elemSize,
    void const* hA_src, magma_minproduct_int_t ldha,
    magma_minproduct_ptr   dB_dst, magma_minproduct_int_t lddb,
    magma_minproduct_queue_t queue,
...
// --------------------
extern "C" void
magma_minproduct_getmatrix_internal(
    magma_minproduct_int_t m, magma_minproduct_int_t n, magma_minproduct_int_t elemSize,
    magma_minproduct_const_ptr dA_src, magma_minproduct_int_t ldda,
    void*           hB_dst, magma_minproduct_int_t ldhb,
    const char* func, const char* file, int line )
{
    cublasStatus_t status;
...
// --------------------
extern "C" void
magma_minproduct_getmatrix_async_internal(
    magma_minproduct_int_t m, magma_minproduct_int_t n, magma_minproduct_int_t elemSize,
    magma_minproduct_const_ptr dA_src, magma_minproduct_int_t ldda,
    void*           hB_dst, magma_minproduct_int_t ldhb,
    magma_minproduct_queue_t queue,
