    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_smalloc( &dwork, lddw*nb )) {
    ...
    if (upper) {
        ...
        for (i = n - nb; i >= kk; i -= nb) {
            ...
            magma_minproduct_slatrd( uplo, i+nb, nb, A(0, 0), lda, e, tau,
        ...
        for (i = 0; i < n-nx; i += nb) {
            ...
            magma_minproduct_slatrd( uplo, n-i, nb, A(i, i), lda, &e[i], &tau[i],
