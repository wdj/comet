...
__global__ void
zlascl_full(int m, int n, double mul, magma_minproductDoubleComplex* A, int lda)
{
...
__global__ void
zlascl_lower(int m, int n, double mul, magma_minproductDoubleComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
__global__ void
zlascl_upper(int m, int n, double mul, magma_minproductDoubleComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
    ...
    magma_minproduct_int_t *info )
{
    *info = 0;
    ...
    magma_minproduct_int_t done = false;
...
/**
    @see magma_minproductblas_zlascl_q
    @ingroup magma_minproduct_zaux2
    ********************************************************************/
extern "C" void
magma_minproductblas_zlascl(
    ...
    magma_minproduct_int_t *info )
{
    magma_minproductblas_zlascl_q( type, kl, ku, cfrom, cto, m, n, dA, ldda, magma_minproduct_stream, info );
}
