...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            lhwork2 = (magma_tally3_int_t) MAGMA_tally3_D_REAL( tmp[0] );
            
            lhwork = -1;
            lapackf77_dormqr( Magma_tally3LeftStr, Magma_tally3TransStr,
            ...
            magma_tally3_dgels3_gpu( Magma_tally3NoTrans, M, N, nrhs, d_A, ldda,
                              d_B, lddb, h_work, lworkgpu, &info);
            gpu_time = magma_tally3_wtime() - gpu_time;
            gpu_perf = gflops / gpu_time;
            if (info != 0)
                printf("magma_tally3_dgels3_gpu returned error %d: %s.\n",
