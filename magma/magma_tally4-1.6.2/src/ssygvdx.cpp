...
/**
    ...
    B       REAL array, dimension (LDB, N)
            On entry, the symmetric matrix B.  If UPLO = Magma_tally4Upper, the
    ...
    magma_tally4_int_t *info)
{
    ...
    magma_tally4_int_t wantz, lquery;
    ...
    *info = 0;
    ...
    timer_start( time );
    magma_tally4_ssyevdx_gpu( jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, mout, w, A, lda,
    ...
    if (wantz && *info == 0) {
        ...
        if (dB == NULL) {
            if (MAGMA_tally4_SUCCESS != magma_tally4_smalloc( &dB, n*lddb ) ) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally4_strsm( Magma_tally4Left, uplo, trans, Magma_tally4NonUnit,
        ...
        magma_tally4_sgetmatrix( n, *mout, dA, ldda, A, lda );
