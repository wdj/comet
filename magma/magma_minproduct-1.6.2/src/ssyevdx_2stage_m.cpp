/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from dsyevdx_2stage_m.cpp normal d -> s, Fri Jan 30 19:00:19 2015
...
/**
    ...
    lwork   INTEGER
            ...
            If N <= 1,                      LWORK >= 1.
            If JOBZ = Magma_minproductNoVec and N > 1, LWORK >= LQ2 + 2*N + N*NB.
            If JOBZ = Magma_minproductVec   and N > 1, LWORK >= LQ2 + 1 + 6*N + 2*N**2.
    ...
    @ingroup magma_minproduct_ssyev_driver
    ********************************************************************/
    ...
    magma_minproduct_int_t *info)
{
    ...
    float rmin, rmax;
    float sigma;
    magma_minproduct_int_t lwmin, liwmin;
    ...
    *info = 0;
    ...
    magma_minproduct_int_t nb = magma_minproduct_get_sbulge_nb(n, parallel_threads);
    magma_minproduct_int_t Vblksiz = magma_minproduct_sbulge_get_Vblksiz(n, nb, parallel_threads);
    ...
    magma_minproduct_int_t lq2 = magma_minproduct_sbulge_get_lq2(n, parallel_threads);
    ...
    magma_minproduct_int_t indT2   = inde + n;
    ...
    magma_minproduct_timer_t time=0, time_total=0, time_alloc=0, time_sist=0, time_band=0;
    timer_start( time_total );

#ifdef HE2HB_SINGLEGPU
    float *dT1;
    if (MAGMA_minproduct_SUCCESS != magma_minproduct_smalloc( &dT1, n*nb)) {
        *info = MAGMA_minproduct_ERR_DEVICE_ALLOC;
        return *info;
    }
    magma_minproduct_ssytrd_sy2sb(uplo, n, nb, A, lda, &work[indtau1], &work[indwrk], llwork, dT1, info);
    ...
    float *dA[Magma_minproductMaxGPUs], *dT1[Magma_minproductMaxGPUs];
    ...
    for( magma_minproduct_int_t dev = 0; dev < ngpu; ++dev ) {
        ...
        // TODO check malloc
        magma_minproduct_smalloc(&dA[dev], ldda*mlocal );
        magma_minproduct_smalloc(&dT1[dev], (n*nb) );
    ...
    magma_minproduct_ssetmatrix_1D_col_bcyclic( n, n, A, lda, dA, ldda, ngpu, distblk );
    magma_minproduct_setdevice(0);
    timer_stop( time_sist );

    timer_start( time_band );
    if (ver == 30) {
        magma_minproduct_ssytrd_sy2sb_mgpu_spec(uplo, n, nb, A, lda, &work[indtau1], &work[indwrk], llwork, dA, ldda, dT1, nb, ngpu, distblk, streams, nstream, info);
    } else {
        magma_minproduct_ssytrd_sy2sb_mgpu(uplo, n, nb, A, lda, &work[indtau1], &work[indwrk], llwork, dA, ldda, dT1, nb, ngpu, distblk, streams, nstream, info);
    }
    ...
    magma_minproduct_ssytrd_sb2st(uplo, n, nb, Vblksiz, A2, lda2, w, &work[inde], &work[indV2], ldv, &work[indTAU2], wantz, &work[indT2], ldt);
    ...
    if (! wantz) {
        ...
        magma_minproduct_sstedx_m(ngpu, range, n, vl, vu, il, iu, w, &work[inde],
        ...
        magma_minproduct_sbulge_back_m(ngpu, uplo, n, nb, *m, Vblksiz, &work[indwrk + n * (il-1)], n,
        ...
        magma_minproduct_sormqr_m(ngpu, Magma_minproductLeft, Magma_minproductNoTrans, n-nb, *m, n-nb, A+nb, lda, &work[indtau1],
