                  ...
                  magma_minproduct_int_t batchCount, magma_minproduct_queue_t queue)
{
   ...
   /* check allocation */
    ...
    if ( uplo == Magma_minproductUpper) {
        ...
        magma_minproductblas_ztrsm_outofplace_batched(Magma_minproductLeft, Magma_minproductUpper, Magma_minproductConjTrans, Magma_minproductNonUnit, 1,
                n, nrhs,
                c_one,
                dA_array,       ldda, // dA
                dB_array,      lddb, // dB
        ...
        magma_minproductblas_ztrsm_outofplace_batched(Magma_minproductLeft, Magma_minproductLower, Magma_minproductNoTrans, Magma_minproductNonUnit, 1,
                n, nrhs,
                c_one,
                dA_array,       ldda, // dA
                dB_array,      lddb, // dB
        ...
        magma_minproductblas_ztrsm_outofplace_batched(Magma_minproductLeft, Magma_minproductLower, Magma_minproductConjTrans, Magma_minproductNonUnit, 1,
                n, nrhs,
                c_one,
                dA_array,       ldda, // dA
                dwork_array,        n, // dB 
