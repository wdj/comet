...
!      @date January 2015
!
!  @generated from testing_zgetrf_gpu_f.F90 normal z -> d, Fri Jan 30 19:00:26 2015
!
...
!---- Call magma_minproduct LU ----------------
      ...
      call magma_minproductf_dgetrf_gpu(n, n, devptrA, ldda, ipiv, info)
...
!---- Call magma_minproduct solve -------------
      call magma_minproductf_dgetrs_gpu('n', n, nrhs, devptrA, ldda, ipiv, devptrB, ldda, info)
