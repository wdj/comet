...
int main( int argc, char** argv)
{
    ...
    magma_tally4DoubleComplex *h_A, *h_R, *h_Amagma_tally4;
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
      ...
      for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_DEV(  dA,  magma_tally4DoubleComplex, ldda*N * batchCount);
            ...
            magma_tally4_zsetmatrix( M, columns, h_R, lda, dA, ldda );
            ...
            info = magma_tally4_zgetrf_batched( M, N, dA_array, ldda, dipiv_array,  dinfo_magma_tally4, batchCount, queue);
            magma_tally4_time = magma_tally4_sync_wtime(0) - magma_tally4_time;
            magma_tally4_perf = gflops / magma_tally4_time;
            
            magma_tally4_zgetmatrix( M, N*batchCount, dA, ldda, h_Amagma_tally4, lda );
