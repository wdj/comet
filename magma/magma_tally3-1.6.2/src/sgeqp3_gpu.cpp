    ...
    magma_tally3_int_t *info )
{
    ...
    *info = 0;
    ...
    #endif
    magma_tally3Float_ptr df;
    if (MAGMA_tally3_SUCCESS != magma_tally3_smalloc( &df, (n+1)*nb )) {
    ...
    if (nfxd < minmn) {
        ...
        magma_tally3blas_snrm2_cols(sm, sn, dA(nfxd,nfxd), ldda, &rwork[nfxd]);
        magma_tally3_scopymatrix( sn, 1, &rwork[nfxd], sn, &rwork[n+nfxd], sn);
        ...
        //if (nb < sminmn)
        {
            ...
            while(j < topbmn) {
                ...
                //magma_tally3_slaqps_gpu    // this is a cpp-file
                magma_tally3_slaqps2_gpu   // this is a cuda-file
                    ( m, n_j, j, jb, &fjb,
                      dA(0, j), ldda,
