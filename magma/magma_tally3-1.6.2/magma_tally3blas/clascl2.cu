...
__global__ void
clascl2_full(int m, int n, const float* D, magma_tally3FloatComplex* A, int lda)
{
...
__global__ void
clascl2_lower(int m, int n, const float* D, magma_tally3FloatComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
__global__ void
clascl2_upper(int m, int n, const float *D, magma_tally3FloatComplex* A, int lda)
{
    int ind = blockIdx.x * NB + threadIdx.x;
...
magma_tally3blas_clascl2(
    magma_tally3_type_t type, magma_tally3_int_t m, magma_tally3_int_t n,
    magma_tally3Float_const_ptr dD,
    magma_tally3FloatComplex_ptr dA, magma_tally3_int_t ldda, magma_tally3_int_t *info )
{
    magma_tally3blas_clascl2_q( type, m, n, dD, dA, ldda, magma_tally3_stream, info );
}
