...
void zlacpy_full_device(
    int m, int n,
    const magma_minproductDoubleComplex *dA, int ldda,
    magma_minproductDoubleComplex       *dB, int lddb )
{
...
void zlacpy_full_kernel_batched(
    int m, int n,
    magma_minproductDoubleComplex const * const *dAarray, int ldda,
...
/**
    @see magma_minproductblas_zlacpy_q
    @ingroup magma_minproduct_zaux2
    ********************************************************************/
extern "C" void
magma_minproductblas_zlacpy(
    ...
    magma_minproductDoubleComplex_ptr       dB, magma_minproduct_int_t lddb )
{
    magma_minproductblas_zlacpy_q( uplo, m, n, dA, ldda, dB, lddb, magma_minproduct_stream );
}
