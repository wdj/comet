    ...
    if (nb >= k) {
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            cpanel_to_q_tally4( Magma_tally4Upper, ib, A(i,i), lda, T2 );
            magma_tally4_csetmatrix( nq_i,  ib, A(i,i), lda, dV(0,0), nq_i );
            cq_to_panel_tally4( Magma_tally4Upper, ib, A(i,i), lda, T2 );
