...
/**
    ...
    This version stores the T matrices in dT, for later use in magma_tally4_sorghr.
    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb == 1 || nb > nh) {
        ...
        //   n*ldda  for dA
        float *dwork;
        if (MAGMA_tally4_SUCCESS != magma_tally4_smalloc( &dwork, 2*nb*ldda + n*ldda )) {
        ...
        float *T;
        magma_tally4_smalloc_cpu( &T, nb*nb );
        if ( T == NULL ) {
        ...
        magma_tally4blas_slaset( Magma_tally4Full, nb, nb, c_zero, c_zero, dV, ldda );
        ...
        magma_tally4blas_slaset( Magma_tally4Full, nb, n, c_zero, c_zero, dT, nb );
        
        // Copy the matrix to the GPU
        magma_tally4_ssetmatrix( n, n-ilo, A(0,ilo), lda, dA, ldda );
        ...
        for (i = ilo; i < ihi-1 - nb; i += nb) {
            ...
            magma_tally4_slahr2( ihi, i+1, nb,
                          dA(0,i-ilo), ldda,
                          dV,          ldda,
                          A(0,i),      lda,
                          &tau[i], T, nb, work, n);
            ...
            dTi = dT + (i - ilo)*nb;
            magma_tally4_ssetmatrix( nb, nb, T, nb, dTi, nb );
            
            magma_tally4_slahru( n, ihi, i, nb,
                          A(0,i),      lda,
                          dA(0,i-ilo), ldda, // dA
