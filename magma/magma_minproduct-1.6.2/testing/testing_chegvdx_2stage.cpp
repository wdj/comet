    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (opts.warmup) {
                ...
                lapackf77_clacpy( Magma_minproductUpperLowerStr, &N, &N, h_B, &N, h_S, &N );

                magma_minproduct_chegvdx_2stage(opts.itype, opts.jobz, range, opts.uplo,
