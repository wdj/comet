...
magma_tally3_zhegvx(
    ...
    magma_tally3DoubleComplex *A, magma_tally3_int_t lda, magma_tally3DoubleComplex *B, magma_tally3_int_t ldb,
    double vl, double vu, magma_tally3_int_t il, magma_tally3_int_t iu, double abstol,
    magma_tally3_int_t *m, double *w,  magma_tally3DoubleComplex *Z, magma_tally3_int_t ldz,
    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_tally3_zheevx_gpu(jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, abstol, m, w, dZ, lddz, A, lda, Z, ldz, work, lwork, rwork, iwork, ifail, info);
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_tally3_ztrsm(Magma_tally3Left, uplo, trans, Magma_tally3NonUnit, n, *m, c_one, dB, lddb, dZ, lddz);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_tally3_ztrmm(Magma_tally3Left, uplo, trans, Magma_tally3NonUnit, n, *m, c_one, dB, lddb, dZ, lddz);
        }
