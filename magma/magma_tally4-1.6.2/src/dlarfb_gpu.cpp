    ...
    magma_tally4Double_ptr dwork,       magma_tally4_int_t ldwork )
{
    ...
    if ( side == Magma_tally4Left ) {
        ...
        // W = W T^H = C^H V T^H
        magma_tally4_dtrmm( Magma_tally4Right, uplo, transt, Magma_tally4NonUnit,
                     n, k,
                     c_one, dT(0,0),  lddt,
                            dwork(0), ldwork);

        // C = C - V W^H = C - V T V^H C = (I - V T V^H) C = H C
        magma_tally4_dgemm( notransV, Magma_tally4Trans,
                     m, n, k,
        ...
        // W = W T = C V T
        magma_tally4_dtrmm( Magma_tally4Right, uplo, trans, Magma_tally4NonUnit,
                     m, k,
                     c_one, dT(0,0),  lddt,
                            dwork(0), ldwork);
