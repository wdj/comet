/*
    ...
    magma_minproduct_cblas_scasum / dasum
    magma_minproduct_cblas_scnrm2 / dnrm2
    magma_minproduct_cblas_cdotc  / ddot
    magma_minproduct_cblas_cdotu  / ddot
    ...
    const magma_minproductFloatComplex *y, magma_minproduct_int_t incy )
{
    ...
    magma_minproductFloatComplex value = MAGMA_minproduct_C_ZERO;
    ...
    return value;
    //#ifdef COMPLEX
    //magma_minproductFloatComplex value;
