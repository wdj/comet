...
#define dA(i, j) (dA + (j)*ldda + (i))
    ...
    *info = 0;
    ...
    if (nb <= 1 || nb >= n) {
        magma_tally3_sgetmatrix( n, n, dA, ldda, work, n );
        lapackf77_slauum(uplo_, &n, work, &n, info);
        magma_tally3_ssetmatrix( n, n, work, n, dA, ldda );
    }
    else {
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_tally3_sgetmatrix( ib, ib,
                                  dA(i, i), ldda,
                                  work,     ib );

                lapackf77_slauum(Magma_tally3UpperStr, &ib, work, &ib, info);

                magma_tally3_ssetmatrix( ib, ib,
                                  work,     ib,
                                  dA(i, i), ldda );
            ...
            for (i=0; i < n; i += nb) {
                ...
                lapackf77_slauum(Magma_tally3LowerStr, &ib, work, &ib, info);
