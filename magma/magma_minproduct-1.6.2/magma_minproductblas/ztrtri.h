...
zaxpy16(
    ...
    const magma_minproductDoubleComplex * __restrict__ b,
    magma_minproductDoubleComplex       * __restrict__ c )
{
    c[0]  += alpha * b[0];
    c[1]  += alpha * b[1];
    c[2]  += alpha * b[2];
...
zgemm_kernel_16(
    ...
    magma_minproductDoubleComplex *B, int ldb,
    magma_minproductDoubleComplex *C, int ldc,
    magma_minproductDoubleComplex alpha, int jb, int tx, int ty)
{
...
ztrtri_diag_lower_kernel(
    magma_minproduct_diag_t diag, int n, const magma_minproductDoubleComplex *A, int lda, magma_minproductDoubleComplex *d_invA);

__global__ void
triple_zgemm16_part1_lower_kernel(
    int n, const magma_minproductDoubleComplex *Ain, int lda, magma_minproductDoubleComplex *d_invA, int jb, int npages);
