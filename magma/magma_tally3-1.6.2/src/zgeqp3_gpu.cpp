    ...
    magma_tally3_int_t *info )
{
    ...
    *info = 0;
    ...
    #endif
    magma_tally3DoubleComplex_ptr df;
    if (MAGMA_tally3_SUCCESS != magma_tally3_zmalloc( &df, (n+1)*nb )) {
        *info = MAGMA_tally3_ERR_DEVICE_ALLOC;
        return *info;
    }
    cudaMemset( df, 0, (n+1)*nb*sizeof(magma_tally3DoubleComplex) );
    ...
    if (nfxd < minmn) {
        ...
        magma_tally3blas_dznrm2_cols(sm, sn, dA(nfxd,nfxd), ldda, &rwork[nfxd]);
        ...
        //if (nb < sminmn)
        {
            ...
            while(j < topbmn) {
                ...
                //magma_tally3_zlaqps_gpu    // this is a cpp-file
                magma_tally3_zlaqps2_gpu   // this is a cuda-file
                    ( m, n_j, j, jb, &fjb,
                      dA(0, j), ldda,
