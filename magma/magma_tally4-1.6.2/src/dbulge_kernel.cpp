...
void magma_tally4_dtrdtype1cbHLsym_withQ(
...
void magma_tally4_dtrdtype2cbHLsym_withQ(
    magma_tally4_int_t N, magma_tally4_int_t NB,
    double *A, magma_tally4_int_t LDA,
    double *V, double *TAU,
    magma_tally4_int_t st, magma_tally4_int_t ed, magma_tally4_int_t sweep, magma_tally4_int_t Vblksiz);
   
void magma_tally4_dtrdtype3cbHLsym_withQ(
    magma_tally4_int_t N, magma_tally4_int_t NB,
    double *A, magma_tally4_int_t LDA,
    double *V, double *TAU,
    magma_tally4_int_t st, magma_tally4_int_t ed, magma_tally4_int_t sweep, magma_tally4_int_t Vblksiz);

void magma_tally4_dlarfxsym(
    ...
    double *V, double *TAU)
{
    ...
    double dtmp;
    double Z_ZERO =  MAGMA_tally4_D_ZERO;
    //double Z_ONE  =  MAGMA_tally4_D_ONE;
    double Z_MONE =  MAGMA_tally4_D_NEG_ONE;
    double Z_HALF =  MAGMA_tally4_D_HALF;
    //double WORK[N];
    double *WORK;
    magma_tally4_dmalloc_cpu( &WORK, N );
    
    /* apply left and right on A(st:ed,st:ed)*/
    //magma_tally4_dlarfxsym(len,A(st,st),LDX,V(st),TAU(st));
    /* X = AVtau */
    blasf77_dsymv("L",&N, TAU, A, &LDA, V, &IONE, &Z_ZERO, WORK, &IONE);
    /* je calcul dtmp= X'*V */
    dtmp = magma_tally4_cblas_ddot(N, WORK, IONE, V, IONE);
...
#define TAU(m)   &(TAU[(m)])
extern "C" void
magma_tally4_dtrdtype1cbHLsym_withQ(
    magma_tally4_int_t N, magma_tally4_int_t NB,
    double *A, magma_tally4_int_t LDA,
    double *V, double *TAU,
    magma_tally4_int_t st, magma_tally4_int_t ed, magma_tally4_int_t sweep, magma_tally4_int_t Vblksiz)
{
    ...
    *V(vpos)  = Z_ONE;
    ...
    /* apply left and right on A(st:ed,st:ed)*/
    magma_tally4_dlarfxsym(len,A(st,st),LDX,V(vpos),TAU(taupos));
    //conjtmp = MAGMA_tally4_D_CNJG(*TAU(taupos));
    //lapackf77_dlarfy("L", &len, V(vpos), &IONE, &conjtmp, A(st,st), &LDX, WORK); //&(MAGMA_tally4_D_CNJG(*TAU(taupos)))
    magma_tally4_free_cpu(WORK);
}
#undef A
#undef V
...
#define TAU(m)   &(TAU[(m)])
extern "C" void
magma_tally4_dtrdtype2cbHLsym_withQ(
    magma_tally4_int_t N, magma_tally4_int_t NB,
    double *A, magma_tally4_int_t LDA,
    double *V, double *TAU,
    magma_tally4_int_t st, magma_tally4_int_t ed, magma_tally4_int_t sweep, magma_tally4_int_t Vblksiz)
{
    ...
    //double WORK[NB];
    double *WORK;
    magma_tally4_dmalloc_cpu( &WORK, NB );
...
#define TAU(m)   &(TAU[(m)])
extern "C" void
magma_tally4_dtrdtype3cbHLsym_withQ(
    magma_tally4_int_t N, magma_tally4_int_t NB,
    double *A, magma_tally4_int_t LDA,
    double *V, double *TAU,
    magma_tally4_int_t st, magma_tally4_int_t ed, magma_tally4_int_t sweep, magma_tally4_int_t Vblksiz)
{
    ...
    magma_tally4_dlarfxsym(len,A(st,st),LDX,V(vpos),TAU(taupos));
    //conjtmp = MAGMA_tally4_D_CNJG(*TAU(taupos));
    //lapackf77_dlarfy("L", &len, V(vpos), &IONE,  &(MAGMA_tally4_D_CNJG(*TAU(taupos))), A(st,st), &LDX, WORK);
    magma_tally4_free_cpu(WORK);
}
#undef A
#undef V
