/*
    -- MAGMA_minproduct (version 1.6.1) --
       ...
       @generated from zgetrf_nopiv.cpp normal z -> s, Fri Jan 30 19:00:14 2015
    ...
    magma_minproduct_int_t *info)
{
    ...
    magma_minproduct_int_t min_mn, i__3, i__4;
    magma_minproduct_int_t j, jb, nb, iinfo;
    ...
    *info = 0;
    ...
    if (nb <= 1 || nb >= min_mn) {
        /* Use unblocked code. */
        magma_minproduct_sgetf2_nopiv( m, n, A(1,1), lda, info );
    }
    else {
        /* Use blocked code. */
        for (j = 1; j <= min_mn; j += nb) {
            ...
            /* Factor diagonal and subdiagonal blocks and test for exact
               singularity. */
            i__3 = m - j + 1;
            //magma_minproduct_sgetf2_nopiv( i__3, jb, A(j,j), lda, &iinfo );

            i__3 -= jb;
            magma_minproduct_sgetf2_nopiv( jb, jb, A(j,j), lda, &iinfo );
