    ...
    magma_tally4_queue_t queue )
{
    ...
    // GPU workspace
    magma_tally4_c_matrix r={Magma_tally4_CSR}, p={Magma_tally4_CSR}, q={Magma_tally4_CSR};
    ...
    magma_tally4_ccopy( dofs, r.dval, 1, p.dval, 1 );                    // p = r
    betanom = nom0;
    ...
    do
    {
        ...
        beta = MAGMA_tally4_C_MAKE(betanomsq/nom, 0.);           // beta = betanoms/nom
