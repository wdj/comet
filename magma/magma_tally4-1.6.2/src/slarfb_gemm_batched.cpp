...
magma_tally4_slarfb_gemm_batched_magem(
...
extern "C" magma_tally4_int_t
magma_tally4_slarfb_gemm_batched_cugem(
    magma_tally4_side_t side, magma_tally4_trans_t trans, magma_tally4_direct_t direct, magma_tally4_storev_t storev,
    magma_tally4_int_t m, magma_tally4_int_t n, magma_tally4_int_t k,
    magma_tally4Float_const_ptr dV_array[],    magma_tally4_int_t lddv,
    magma_tally4Float_const_ptr dT_array[],    magma_tally4_int_t lddt,
    ...
    magma_tally4_int_t batchCount, cublasHandle_t myhandle, magma_tally4_queue_t queue)
{
    ...
    if(m >= 32 && n >= 32 && k >= 32)
    {
        magma_tally4_slarfb_gemm_batched_magem(
            ...
            m, n,  k,
            (magma_tally4Float_const_ptr *) dV_array, lddv,
            (magma_tally4Float_const_ptr *) dT_array, lddt,
            dC_array, lddc,
            dwork_array, ldwork,
    ...
    magma_tally4_int_t batchCount, magma_tally4_queue_t queue)
{
    ...
    if ( side == Magma_tally4Left ) {
        ...
        // W = V' C                              
        magma_tally4blas_sgemm_batched( Magma_tally4Trans,notransV, /*NontransLeft*/
                     k, n, m,
                     c_one,  dV_array,    lddv,
                             dC_array,    lddc,
        ...
        if (m <= n) {
            // W2 = V T
            magma_tally4blas_sgemm_batched( notransV, trans, /* (NoTrans), trans(ConjTrans),*/
                         m, k, k,
                         c_one,  dV_array, lddv,
                                 dT_array, lddt,
        ...
        {
            // W2 = T W  = T  V' C
            magma_tally4blas_sgemm_batched( trans, Magma_tally4NoTrans,
                         k, n, k,
                         c_one,  dT_array, lddt,
                                 dwork_array, ldw,
                         c_zero, dworkvt_array, ldwvt, batchCount, queue);
            ...
            magma_tally4blas_sgemm_batched( notransV, Magma_tally4NoTrans,
                         m, n, k,
        ...
        // W = C V
        magma_tally4blas_sgemm_batched( Magma_tally4NoTrans, notransV,
                     m, k, n,
                     c_one,  dC_array,    lddc,
                             dV_array,    lddv,
                     c_zero, dwork_array, ldw, batchCount, queue);
        if (m <= n) {
            // W2 = W T = C V T
            magma_tally4blas_sgemm_batched( Magma_tally4NoTrans, trans,
                         m, k, k,
            ...
            magma_tally4blas_sgemm_batched( Magma_tally4NoTrans, transV,
                         m, n, k,
                         c_neg_one, dworkvt_array, ldwvt,
                                    dV_array,    lddv,
                         c_one,     dC_array,    lddc, batchCount, queue);
            ...
            // W2 = T V'
            magma_tally4blas_sgemm_batched( trans, transV,
                         k, n, k,
                         c_one,  dT_array, lddt,
                                 dV_array, lddv,
                         c_zero, dworkvt_array, ldwvt, batchCount, queue);
