...
/**
    ...
    lwork   INTEGER
            ...
            the optimal blocksize returned by magma_minproduct_get_sgetri_nb(n).
    \n
       ...
       
{
    ...
    magma_minproduct_smalloc( &dinvdiagA, invdiagA_msize * batchCount);
    ...
    magma_minproductblas_slaset_q(Magma_minproductFull, invdiagA_msize, batchCount, MAGMA_minproduct_S_ZERO, MAGMA_minproduct_S_ZERO, dinvdiagA, invdiagA_msize, queue);
    ...
    magma_minproductblas_slaset_batched(Magma_minproductUpperLower, n, n, MAGMA_minproduct_S_ZERO, MAGMA_minproduct_S_ONE, dinvA_array, lddia, batchCount, queue);
    ...
    for(j = 0; j < n; j+=nb) {
        ...
        // solve dwork = L^-1 * I
        magma_minproductblas_slaset_batched(Magma_minproductUpperLower, j, ib, MAGMA_minproduct_S_ZERO, MAGMA_minproduct_S_ZERO, dwork_array, n, batchCount, queue);
        magma_minproduct_sdisplace_pointers(dW5_displ, dwork_array, n, j, 0, batchCount, queue);
        magma_minproduct_sdisplace_pointers(dW0_displ, dinvA_array, lddia, j, j, batchCount, queue);
        magma_minproduct_sdisplace_pointers(dA_displ, dA_array, ldda, j, j, batchCount, queue);
        ...
        magma_minproduct_sdisplace_pointers(dW5_displ, dwork_array, n, 0, 0, batchCount, queue);
        magma_minproduct_sdisplace_pointers(dW0_displ, dinvA_array, lddia, 0, j, batchCount, queue);
        magma_minproduct_sdisplace_pointers(dA_displ, dA_array, ldda, 0, 0, batchCount, queue);
    ...
    magma_minproduct_slaswp_columnserial_batched( n, dinvA_array, lddia, max(1,n-1), 1, dipiv_array, batchCount, queue);
