...
extern "C" {
    /////////////////////////////////////////
    magma_minproduct_int_t magma_minproduct_sbulge_get_lq2(magma_minproduct_int_t n, magma_minproduct_int_t threads)
    {
        magma_minproduct_int_t nb = magma_minproduct_get_sbulge_nb(n, threads);
        magma_minproduct_int_t Vblksiz = magma_minproduct_sbulge_get_Vblksiz(n, nb, threads);
        magma_minproduct_int_t ldv = nb + Vblksiz;
        magma_minproduct_int_t ldt = Vblksiz;
        return magma_minproduct_bulge_get_blkcnt(n, nb, Vblksiz) * Vblksiz * (ldt + ldv + 1);
    }

    magma_minproduct_int_t magma_minproduct_dbulge_get_lq2(magma_minproduct_int_t n, magma_minproduct_int_t threads)
    {
        magma_minproduct_int_t nb = magma_minproduct_get_dbulge_nb(n, threads);
        magma_minproduct_int_t Vblksiz = magma_minproduct_dbulge_get_Vblksiz(n, nb, threads);
        magma_minproduct_int_t ldv = nb + Vblksiz;
        magma_minproduct_int_t ldt = Vblksiz;
        return magma_minproduct_bulge_get_blkcnt(n, nb, Vblksiz) * Vblksiz * (ldt + ldv + 1);
    }

    magma_minproduct_int_t magma_minproduct_cbulge_get_lq2(magma_minproduct_int_t n, magma_minproduct_int_t threads)
    {
        magma_minproduct_int_t nb = magma_minproduct_get_cbulge_nb(n, threads);
        magma_minproduct_int_t Vblksiz = magma_minproduct_cbulge_get_Vblksiz(n, nb, threads);
        magma_minproduct_int_t ldv = nb + Vblksiz;
        magma_minproduct_int_t ldt = Vblksiz;
        return magma_minproduct_bulge_get_blkcnt(n, nb, Vblksiz) * Vblksiz * (ldt + ldv + 1);
    }

    magma_minproduct_int_t magma_minproduct_zbulge_get_lq2(magma_minproduct_int_t n, magma_minproduct_int_t threads)
    {
        magma_minproduct_int_t nb = magma_minproduct_get_zbulge_nb(n, threads);
        magma_minproduct_int_t Vblksiz = magma_minproduct_zbulge_get_Vblksiz(n, nb, threads);
        magma_minproduct_int_t ldv = nb + Vblksiz;
        magma_minproduct_int_t ldt = Vblksiz;
        return magma_minproduct_bulge_get_blkcnt(n, nb, Vblksiz) * Vblksiz * (ldt + ldv + 1);
    }
    ...
    {
        magma_minproduct_int_t prevGblkid, mastersweep;
        magma_minproduct_int_t locblknb   = 0;
        magma_minproduct_int_t prevblkcnt = 0;
        magma_minproduct_int_t myblknb    = 0;
        magma_minproduct_int_t lstGblkid  = magma_minproduct_ceildiv((n-1),Vblksiz)-1;//nbGblk-1;
        magma_minproduct_int_t myGblkid   = sweep/Vblksiz;
        ...
        for (prevGblkid = lstGblkid; prevGblkid > myGblkid; prevGblkid--)
        {
            ...
            if(prevGblkid==lstGblkid)
                locblknb = magma_minproduct_ceildiv((n-(mastersweep+1)),nb);
            else
                locblknb = magma_minproduct_ceildiv((n-(mastersweep+2)),nb);
        ...
        //===================================================
        */
        myblknb = magma_minproduct_ceildiv((st-sweep),nb);
    ...
    {
        magma_minproduct_int_t locblknb, prevblkcnt, prevGblkid;
        magma_minproduct_int_t myblknb, nbprevGblk, mastersweep;
    ...
    {
        magma_minproduct_int_t myblkid;
        magma_minproduct_int_t locj = sweep%Vblksiz;

        if(applyQver==113)
            magma_minproduct_bulge_findpos113(n, nb, Vblksiz, sweep, st, &myblkid);
        else
            magma_minproduct_bulge_findpos(n, nb, Vblksiz, sweep, st, &myblkid);
    ...
    {
        magma_minproduct_int_t colblk, nbcolblk;
        magma_minproduct_int_t myblknb, mastersweep;

        magma_minproduct_int_t blkcnt = 0;
        nbcolblk = magma_minproduct_ceildiv((n-1),Vblksiz);
        for (colblk = 0; colblk<nbcolblk; colblk++)
        {
            mastersweep = colblk * Vblksiz;
            if(colblk == (nbcolblk-1))
                myblknb = magma_minproduct_ceildiv((n-(mastersweep+1)),nb);
            else
                myblknb = magma_minproduct_ceildiv((n-(mastersweep+2)),nb);
    ...
    {
        return magma_minproduct_ceildiv(a,b);
    }
    ...
    void findVTpos(magma_minproduct_int_t N, magma_minproduct_int_t NB, magma_minproduct_int_t Vblksiz, magma_minproduct_int_t sweep, magma_minproduct_int_t st, magma_minproduct_int_t *Vpos, magma_minproduct_int_t *TAUpos, magma_minproduct_int_t *Tpos, magma_minproduct_int_t *myblkid)
    {
        ...
        magma_minproduct_int_t ldv = NB + Vblksiz;
        magma_minproduct_int_t ldt = Vblksiz;
        magma_minproduct_bulge_findVTAUTpos(N,  NB, Vblksiz,  sweep,  st,  ldv, ldt,
        ...
        magma_minproduct_int_t locblknb, prevblkcnt, prevGblkid;
        magma_minproduct_int_t myblknb, nbprevGblk, mastersweep;
        magma_minproduct_int_t blkid, locj, LDV;
        locblknb = 0;
        prevblkcnt   = 0;
        myblknb  = 0;
