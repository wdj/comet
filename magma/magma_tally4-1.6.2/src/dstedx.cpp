        ...
        if (alleig) {
            ...
            while ( start < n ) {
                ...
                if (m > smlsiz) {
                    ...
                    magma_tally4_dlaex0( m, &d[start], &e[start], Z(start, start), ldz, work, iwork, dwork, Magma_tally4RangeAll, vl, vu, il, iu, info);
            ...
            magma_tally4_dlaex0( n, d, e, Z, ldz, work, iwork, dwork, range, vl, vu, il, iu, info);
