subs = {
  ...
  'mixed' : [
    ...
    ('pzgelqf','pdgelqf'),
    ('pzunmlq','pdormlq'),
    ('MAGMA_tally3_ZC','MAGMA_tally3_DS'),
    ('MAGMA_tally3BLAS_ZC','MAGMA_tally3BLAS_DS'),
    ('magma_tally3_z','magma_tally3_d'),
    ('magma_tally3_czgetrs','magma_tally3_sdgetrs'),
    ('magma_tally3_c','magma_tally3_s'),
    ('magma_tally3blas_z','magma_tally3blas_d'),
    ('magma_tally3blas_c','magma_tally3blas_s'),
    ('cublasZ','cublasD'),
    ('cublasC','cublasS'),
    ('MAGMA_tally3_Z','MAGMA_tally3_D'),
    ('MAGMA_tally3_C','MAGMA_tally3_S'),
    ...
    ('cuCabsf','absf'),
    ('zcaxpy','dsaxpy'),
    ('magma_tally3_get_c','magma_tally3_get_s'),
    ('magma_tally3_get_z','magma_tally3_get_d'),
  ...
  'normal' : [ ## Dictionary is keyed on substitution type
    ...
    ('magma_tally3_ssqrt','magma_tally3_dsqrt', 'magma_tally3_ssqrt','magma_tally3_dsqrt'),
    ('cpu_gpu_s','cpu_gpu_d','cpu_gpu_c','cpu_gpu_z'),
    ('spanel_to_q_tally3','dpanel_to_q_tally3','cpanel_to_q_tally3','zpanel_to_q_tally3'),
    ('sq_to_panel_tally3','dq_to_panel_tally3','cq_to_panel_tally3','zq_to_panel_tally3'),
    ...
    ('Magma_tally3Trans','Magma_tally3Trans','Magma_tally3ConjTrans','Magma_tally3ConjTrans'),
    ...
    ('MAGMA_tally3_S','MAGMA_tally3_D','MAGMA_tally3_C','MAGMA_tally3_Z'),
    ('MAGMA_tally3BLAS_S','MAGMA_tally3BLAS_D','MAGMA_tally3BLAS_C','MAGMA_tally3BLAS_Z'),
    ('magma_tally3_s','magma_tally3_d','magma_tally3_c','magma_tally3_z'),
    ('magma_tally3blas_s','magma_tally3blas_d','magma_tally3blas_c','magma_tally3blas_z'),
    ('magma_tally3_get_s','magma_tally3_get_d','magma_tally3_get_c','magma_tally3_get_z'),
    ('magma_tally3f_s','magma_tally3f_d','magma_tally3f_c','magma_tally3f_z'),
    ('ger','ger','gerc','gerc'),
    ('ger','ger','geru','geru'),
