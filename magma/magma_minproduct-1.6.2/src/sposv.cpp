...
/**
    ...
    @ingroup magma_minproduct_sposv_driver
    ********************************************************************/
    ...
    magma_minproduct_int_t *info )
{
    ...
    *info = 0;
    ...
    magma_minproduct_spotrf_gpu( uplo, n, dA, ldda, info );
    ...
    if ( *info == 0 ) {
        ...
        magma_minproduct_spotrs_gpu( uplo, n, nrhs, dA, ldda, dB, lddb, info );
...
CPU_INTERFACE:
    ...
    magma_minproduct_spotrf( uplo, n, A, lda, info );
    if ( *info == 0 ) {
