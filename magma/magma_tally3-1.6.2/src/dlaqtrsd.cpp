...
// Version 2 is MAGMA_tally3  dlaln2, which is exactly the same, but thread safe.
#define VERSION 2
...
/**
    ...
    @ingroup magma_tally3_dgeev_aux
    ********************************************************************/
extern "C"
magma_tally3_int_t magma_tally3_dlaqtrsd(
    ...
    if ( notran ) {
        ...
        if ( wi == c_zero ) {
            ...
            *x(n-1,0) = c_one;
            ...
            //magma_tally3_d_snprint( buf, sizeof(buf), n, 1, x, ldx );
            ...
            *x(n-2,1) = c_zero;
            ...
            //magma_tally3_d_snprint( buf, sizeof(buf), n, 2, x, ldx );
            ...
            *x(0,0) = c_one;
            ...
            for( j=1; j < n; ++j ) {
                ...
                if ( j1 == j2 ) {
                    ...
                    len = j-1;
                    *x(j,0) -= magma_tally3_cblas_ddot( len, T(1,j), ione, x(1,0), ione );
                    ...
                    *x(j,0) = *W(0,0);
                    ...
                    len = j-1;
                    *x(j,  0) -= magma_tally3_cblas_ddot( len, T(1,j),   ione, x(1,0), ione );
                    *x(j+1,0) -= magma_tally3_cblas_ddot( len, T(1,j+1), ione, x(1,0), ione );
            ...
            *x(0,1) = c_zero;
            ...
            for( j=2; j < n; ++j ) {
                ...
                if ( j1 == j2 ) {
                    ...
                    len = j-2;
                    *x(j,0) -= magma_tally3_cblas_ddot( len, T(2,j), ione, x(2, 0), ione );
                    *x(j,1) -= magma_tally3_cblas_ddot( len, T(2,j), ione, x(2, 1), ione );
                    ...
                    *x(j,  0) -= magma_tally3_cblas_ddot( len, T(2,j),   ione, x(2,0), ione );
                    *x(j,  1) -= magma_tally3_cblas_ddot( len, T(2,j),   ione, x(2,1), ione );
                    *x(j+1,0) -= magma_tally3_cblas_ddot( len, T(2,j+1), ione, x(2,0), ione );
                    *x(j+1,1) -= magma_tally3_cblas_ddot( len, T(2,j+1), ione, x(2,1), ione );
