...
int main(  int argc, char** argv )
{
    ...
    real_Double_t res;
    magma_tally2_d_matrix A={Magma_tally2_CSR}, AT={Magma_tally2_CSR}, A2={Magma_tally2_CSR}, 
    ...
    while(  i < argc ) {
        ...
        for (int j=0; j<10; j++)
            CHECK( magma_tally2_dmcsrcompressor( &A, queue ));
        ...
        CHECK( magma_tally2_dmconvert( AT, &B, Magma_tally2_CSR, Magma_tally2_CSR, queue ));
        ...
        CHECK( magma_tally2_dmconvert( B, &AT, Magma_tally2_CSR, Magma_tally2_CSR, queue ));
        magma_tally2_dmfree(&B, queue );
