/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from magma_minproduct_zvpass_gpu.cpp normal z -> d, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproduct_d_matrix v_DEV={Magma_minproduct_CSR};
    ...
    if ( v.memory_location == Magma_minproduct_DEV ) {
        ...
        *val = v.dval;
        ...
        CHECK( magma_minproduct_dmtransfer( v, &v_DEV, v.memory_location, Magma_minproduct_DEV, queue ));
        CHECK( magma_minproduct_dvget_dev( v_DEV, m, n, val, queue ));
    }
    
cleanup:
    magma_minproduct_dmfree( &v_DEV, queue );
    return info;
}
