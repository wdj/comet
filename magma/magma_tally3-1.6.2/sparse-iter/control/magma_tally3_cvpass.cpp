/*
    -- MAGMA_tally3 (version 1.6.2) --
       ...
       @generated from magma_tally3_zvpass.cpp normal z -> c, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
*/
...
magma_tally3_cvget(
    ...
    magma_tally3_queue_t queue )
{
    magma_tally3_c_matrix v_CPU={Magma_tally3_CSR};
    ...
    if ( v.memory_location == Magma_tally3_CPU ) {
        ...
        *val = v.val;
        ...
        CHECK( magma_tally3_cmtransfer( v, &v_CPU, v.memory_location, Magma_tally3_CPU, queue ));
        CHECK( magma_tally3_cvget( v_CPU, m, n, val, queue ));
    }
    
cleanup:
    magma_tally3_cmfree( &v_CPU, queue );
    return info;
}
