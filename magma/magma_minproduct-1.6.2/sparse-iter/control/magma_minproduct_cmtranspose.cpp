/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from magma_minproduct_zmtranspose.cpp normal z -> c, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
       @author Mark Gates
...
/**
    ...
    @param[in]
    new_values  magma_minproductFloatComplex**
...
c_transpose_csr(
    ...
    magma_minproductFloatComplex **new_values,
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproductFloatComplex *csc_values=NULL;
    ...
    CHECK( magma_minproduct_cmalloc_cpu( &csc_values, nnz ) );
    ...
    magma_minproduct_queue_t queue )
{
    ...
    magma_minproduct_c_matrix ACSR={Magma_minproduct_CSR}, BCSR={Magma_minproduct_CSR};
    ...
    if( A.storage_type == Magma_minproduct_CSR && A.memory_location == Magma_minproduct_DEV ) {
        ...
        CHECK( magma_minproduct_cmtransfer( A, &A_d, A.memory_location, Magma_minproduct_DEV, queue ));
        CHECK( magma_minproduct_c_cucsrtranspose( A_d, &B_d, queue ));
        CHECK( magma_minproduct_cmtransfer( B_d, B, Magma_minproduct_DEV, A.memory_location, queue ));
                
    }else {
        CHECK( magma_minproduct_cmconvert( A, &ACSR, A.storage_type, Magma_minproduct_CSR, queue ));
        CHECK( magma_minproduct_c_cucsrtranspose( ACSR, &BCSR, queue ));
        CHECK( magma_minproduct_cmconvert( BCSR, B, Magma_minproduct_CSR, A.storage_type, queue ));
    }
cleanup:
    ...
    magma_minproduct_cmfree( &BCSR, queue );
    if( info != 0 ){
