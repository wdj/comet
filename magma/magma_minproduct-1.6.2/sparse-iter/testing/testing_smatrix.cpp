...
int main(  int argc, char** argv )
{
    ...
    real_Double_t res;
    magma_minproduct_s_matrix Z={Magma_minproduct_CSR}, A={Magma_minproduct_CSR}, AT={Magma_minproduct_CSR}, 
    ...
    while(  i < argc ) {
        ...
        // scale matrix
        CHECK( magma_minproduct_smscale( &Z, zopts.scaling, queue ));

        // remove nonzeros in matrix
        CHECK( magma_minproduct_smcsrcompressor( &Z, queue ));
        ...
        CHECK( magma_minproduct_smconvert( AT, &B, Magma_minproduct_CSR, zopts.output_format, queue ));
        ...
        CHECK( magma_minproduct_smconvert( B, &AT, zopts.output_format,Magma_minproduct_CSR, queue ));
        magma_minproduct_smfree(&B, queue );
