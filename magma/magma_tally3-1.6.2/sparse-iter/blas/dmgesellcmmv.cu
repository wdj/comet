/*
    -- MAGMA_tally3 (version 1.6.2) --
       ...
       @generated from zmgesellcmmv.cu normal z -> d, Sun May  3 11:22:58 2015
    ...
    double * dy)
{
    ...
    if(row < num_rows ){
        double dot1 = MAGMA_tally3_D_MAKE(0.0, 0.0);
        double dot2 = MAGMA_tally3_D_MAKE(0.0, 0.0);
        int offset = drowptr[ bdx ];
        int max_ = (drowptr[ bdx+1 ]-offset)/blocksize;  
            // number of elements each thread handles
    ...
    magma_tally3_queue_t queue )
{
    ...
    if ( (texture==1) && (precision==1) && (kepler==1) ) {
        ...
        if ( alignment == 1) {
            ...
            if ( beta == MAGMA_tally3_D_MAKE( 0.0, 0.0 ) )
