...
int main(int argc, char **argv)
{
    ...
    double *A, *X, *Y, *Ydev, *Ymagma_tally4;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_tally4_dsetmatrix( M, N, A, lda, dA, lda );
            magma_tally4_dsetvector( Xm, X, incx, dX, incx );
            magma_tally4_dsetvector( Ym, Y, incy, dY, incy );
            
            #ifdef HAVE_CUBLAS
                dev_time = magma_tally4_sync_wtime( 0 );
                cublasDgemv( opts.handle, cublas_trans_const_tally4(opts.transA),
                ...
                magma_tally4_dgemv( opts.transA, M, N,
                             &alpha, dA, lda,
                                     dX, incx,
                             &beta,  dY, incy );
            ...
            magma_tally4_dgetvector( Ym, dY, incy, Ydev, incy );
            ...
            /* =====================================================================
               ...
               =================================================================== */
                ...
                magma_tally4blas_dgemv( opts.transA, M, N, alpha, dA, lda, dX, incx, beta, dY, incy );
                magma_tally4_time = magma_tally4_sync_wtime( 0 ) - magma_tally4_time;
                magma_tally4_perf = gflops / magma_tally4_time;
                
                magma_tally4_dgetvector( Ym, dY, incy, Ymagma_tally4, incy );
            #endif
            ...
            blasf77_dgemv( lapack_trans_const_tally4(opts.transA), &M, &N,
                           &alpha, A, &lda,
                                   X, &incx,
                           &beta,  Y, &incy );
            ...
            #ifdef HAVE_CUBLAS
                blasf77_daxpy( &Ym, &c_neg_one, Y, &incy, Ymagma_tally4, &incy );
                magma_tally4_error = lapackf77_dlange( "F", &Ym, &ione, Ymagma_tally4, &Ym, work ) / (Anorm * Xnorm);
