    ...
    magma_minproduct_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_minproduct_cpotrf_m( ngpu, uplo, n, B, ldb, info );
    if (*info != 0) {
        *info = n + *info;
        return *info;
    }
    ...
    magma_minproduct_chegst_m( ngpu, itype, uplo, n, A, lda, B, ldb, info );

    timer_stop( time );
    timer_printf( "time chegst_m = %6.2f\n", time );
    timer_start( time );

    magma_minproduct_cheevdx_2stage_m( ngpu, jobz, range, uplo, n, A, lda, vl, vu, il, iu, mout, w, work, lwork, rwork, lrwork, iwork, liwork, info );
    ...
    if (wantz && *info == 0) {
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_minproduct_ctrsm_m( ngpu, Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit, n, *mout, c_one, B, ldb, A, lda );
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            #endif
            magma_minproductFloatComplex *dA=NULL, *dB=NULL;
            ...
            magma_minproduct_ctrmm( Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit,
                         n, n, c_one, dB, lddb, dA, ldda );
            magma_minproduct_cgetmatrix( n, n, dA, ldda, A, lda );

            //magma_minproduct_ctrmm_m(ngpu, Magma_minproductLeft, uplo, trans, Magma_minproductNonUnit, n, *mout, c_one, B, ldb, A, lda);
