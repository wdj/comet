/*
    -- MAGMA_minproduct (version 1.6.2) --
       ...
       @generated from magma_minproduct_zcsrsplit.cpp normal z -> c, Sun May  3 11:23:01 2015
       @author Hartwig Anzt
    ...
    magma_minproduct_queue_t queue )
{
    ...
    if (  A.memory_location == Magma_minproduct_CPU &&
        ...
        magma_minproduct_c_matrix Ah={Magma_minproduct_CSR}, ACSR={Magma_minproduct_CSR}, DCSR={Magma_minproduct_CSR}, RCSR={Magma_minproduct_CSR}, Dh={Magma_minproduct_CSR}, Rh={Magma_minproduct_CSR};
        CHECK( magma_minproduct_cmtransfer( A, &Ah, A.memory_location, Magma_minproduct_CPU, queue ));
        CHECK( magma_minproduct_cmconvert( Ah, &ACSR, A.storage_type, Magma_minproduct_CSR, queue ));

        CHECK( magma_minproduct_ccsrsplit( bsize, ACSR, &DCSR, &RCSR, queue ));

        CHECK( magma_minproduct_cmconvert( DCSR, &Dh, Magma_minproduct_CSR, A.storage_type, queue ));
        CHECK( magma_minproduct_cmconvert( RCSR, &Rh, Magma_minproduct_CSR, A.storage_type, queue ));

        CHECK( magma_minproduct_cmtransfer( Dh, D, Magma_minproduct_CPU, A.memory_location, queue ));
        CHECK( magma_minproduct_cmtransfer( Rh, R, Magma_minproduct_CPU, A.memory_location, queue ));

        magma_minproduct_cmfree( &Ah, queue );
        magma_minproduct_cmfree( &ACSR, queue );
        magma_minproduct_cmfree( &Dh, queue );
        magma_minproduct_cmfree( &DCSR, queue );
        magma_minproduct_cmfree( &Rh, queue );
        magma_minproduct_cmfree( &RCSR, queue );
    }
cleanup:
    if( info != 0 ){
