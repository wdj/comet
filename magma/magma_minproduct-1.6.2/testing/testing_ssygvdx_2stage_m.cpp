...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            //magma_minproduct_int_t sizvblg = magma_minproduct_sbulge_get_lq2(N, threads);        
            ...
            if ( opts.warmup || opts.check ) {
                ...
                lapackf77_slacpy( Magma_minproductUpperLowerStr, &N, &N, h_A, &N, h_Ainit, &N );
                lapackf77_slacpy( Magma_minproductUpperLowerStr, &N, &N, h_B, &N, h_Binit, &N );
            }
            ...
            if ( opts.warmup ) {
                ...
                // ==================================================================
                magma_minproduct_ssygvdx_2stage_m(opts.ngpu, opts.itype, opts.jobz, range, opts.uplo,
                                       ...
                                       iwork, liwork,
                                       &info);
                lapackf77_slacpy( Magma_minproductUpperLowerStr, &N, &N, h_Ainit, &N, h_A, &N );
                lapackf77_slacpy( Magma_minproductUpperLowerStr, &N, &N, h_Binit, &N, h_B, &N );
            }
