    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb >= k) {
        /* Use CPU code */
        lapackf77_cunmqr( lapack_side_const_tally3(side), lapack_trans_const_tally3(trans),
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            cpanel_to_q_tally3( Magma_tally3Upper, ib, A(i,i), lda, T2 );
            magma_tally3_csetmatrix( nq_i,  ib, A(i,i), lda, dV(0,0), nq_i );
            cq_to_panel_tally3( Magma_tally3Upper, ib, A(i,i), lda, T2 );
