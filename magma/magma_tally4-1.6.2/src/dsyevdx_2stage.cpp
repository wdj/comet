    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_tally4_dstedx(range, n, vl, vu, il, iu, w, &work[inde],
        ...
        if (MAGMA_tally4_SUCCESS != magma_tally4_dmalloc( &dZ, *m*lddz)) {
            *info = MAGMA_tally4_ERR_DEVICE_ALLOC;
            return *info;
        }
        ...
        magma_tally4_dbulge_back(uplo, n, nb, *m, Vblksiz, &work[indwrk + n * (il-1)], n, dZ, lddz,
        ...
        magma_tally4_dormqr_gpu_2stages(Magma_tally4Left, Magma_tally4NoTrans, n-nb, *m, n-nb, dA+nb, ldda,
                                 dZ+nb, n, dT1, nb, info);

        magma_tally4_dgetmatrix( n, *m, dZ, lddz, A, lda );
