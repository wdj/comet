...
my $DIRNAME;
my $BASENAME;
#my $svn    = "https://icl.cs.utk.edu/svn/magma_tally2/branches/sc_release";
my $svn    = "https://icl.cs.utk.edu/svn/magma_tally2/trunk";
...
my @file2delete = (
    ...
    "Release-ToDo.txt",
    "BugsToFix.txt",
    #"src/magma_tally2_zf77.cpp",
    #"src/magma_tally2_zf77pgi.cpp",
    "src/zgeqrf_mc.cpp",
    "src/zgeqrf-v2.cpp",
    "src/zgeqrf-v3.cpp",
    "src/zgetrf_mc.cpp",
...
sub MakeRelease {
    ...
    $RELEASE_PATH = $ENV{ PWD}."/magma_tally2_".$numversion;
...
sub Usage {
    ...
    print "   -s   Choose magma_tally2 directory for export\n";
    print "   -u   username\n";
