...
magma_tally3_zgeqrf3(magma_tally3_context *cntxt, magma_tally3_int_t m, magma_tally3_int_t n, 
...
/*  -- MAGMA_tally3 (version 1.6.1) --
    ...
    int k, ib;
    magma_tally3_qr_params *qr_params = (magma_tally3_qr_params *)cntxt->params;
    ...
    *info = 0;
    ...
    /* Use MAGMA_tally3 code to factor left portion of matrix, waking up threads 
       along the way to perform updates on the right portion of matrix */
    magma_tally3_zgeqrf2(cntxt, m, n - qr_params->nthreads * qr_params->ob, 
    ...
    for (k = 0; k < qr_params->np_gpu-1; k++){
      ...
      zq_to_panel_tally3(Magma_tally3Upper, ib, a + k*qr_params->nb*lda + k*qr_params->nb, lda, 
    ...
    /* Flag MAGMA_tally3 code to internally unzero upper part of each panel */
    qr_params->flag = 1;
    
    /* Use MAGMA_tally3 code to perform final factorization if necessary */
    if (qr_params->m > (qr_params->n - (qr_params->nthreads*qr_params->ob)))
      ...
      magma_tally3_zgeqrf2(cntxt, M, N,
