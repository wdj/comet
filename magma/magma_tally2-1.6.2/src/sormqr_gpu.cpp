    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    hwork[0] = MAGMA_tally2_S_MAKE( lwkopt, 0 );
    ...
    if ( step < 0 ) {
        ...
        magma_tally2_sgetmatrix( ma, ib, dA(i,  i ), ldda, hA, ma );
        magma_tally2_sgetmatrix( mi, ni, dC(ic, jc), lddc, hC, mi );
        ...
        magma_tally2_ssetmatrix( mi, ni, hC, mi, dC(ic, jc), lddc );
    }
    ...
    // TODO sync. For cases Q*C and C*Q^T, last call is magma_tally2_slarfb_gpu,
    // which is async magma_tally2_gemm calls, so sormqr can be unfinished.
