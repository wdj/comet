...
void usage() {
  ...
  "\n"
  "    --num_proc_vector\n"
  "        number of processors allocated along the dimension of the\n"
  "        number of vectors (default is the total number of procs requested)\n"
  "\n"
  "    --num_proc_field\n"
  "        number of processors allocated along the dimension of the\n"
  "        number of fields (default is 1) (not available for REF, CPU cases)\n"
  "\n"
  "    ---verbosity <value>\n"
