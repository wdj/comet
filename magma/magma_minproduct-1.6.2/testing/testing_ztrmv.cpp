...
int main( int argc, char** argv)
{
    ...
    magma_minproduct_int_t sizeA;
    magma_minproduct_int_t lda, ldda;
    magma_minproduct_int_t ione     = 1;
    magma_minproduct_int_t ISEED[4] = {0,0,0,1};
    
    magma_minproductDoubleComplex *h_A, *h_x, *h_xcublas;
    magma_minproductDoubleComplex_ptr d_A, d_x;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( h_x,       magma_minproductDoubleComplex, N      );
            TESTING_MALLOC_CPU( h_xcublas, magma_minproductDoubleComplex, N      );
            
            TESTING_MALLOC_DEV( d_A, magma_minproductDoubleComplex, ldda*Ak );
            TESTING_MALLOC_DEV( d_x, magma_minproductDoubleComplex, N       );
            ...
            magma_minproduct_zsetvector( N, h_x, 1, d_x, 1 );
            ...
            magma_minproduct_zgetvector( N, d_x, 1, h_xcublas, 1 );
