    ...
    magma_tally2_queue_t queue )
{
    ...
    magma_tally2_z_matrix A_CPU={Magma_tally2_CSR}, A_CSR={Magma_tally2_CSR};
    ...
    if ( A.memory_location == Magma_tally2_CPU && A.storage_type == Magma_tally2_CSR ) {
        ...
        *row = A.row;
        ...
        CHECK( magma_tally2_zmtransfer( A, &A_CPU, A.memory_location, Magma_tally2_CPU, queue ));
        CHECK( magma_tally2_zmconvert( A_CPU, &A_CSR, A_CPU.storage_type, Magma_tally2_CSR, queue ));
        CHECK( magma_tally2_zcsrget( A_CSR, m, n, row, col, val, queue ));
    }

cleanup:
    magma_tally2_zmfree( &A_CSR, queue );
    magma_tally2_zmfree( &A_CPU, queue );
    return info;
}
