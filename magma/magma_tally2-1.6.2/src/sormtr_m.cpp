    ...
    magma_tally2_int_t *info)
{
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        //magma_tally2_sormql_m(ngpu, side, trans, mi, ni, i__2, A(0,1), lda, tau,
        //               C, ldc, work, lwork, &iinfo);
        magma_tally2_sormql(side, trans, mi, ni, i__2, A(0,1), lda, tau,
                       C, ldc, work, lwork, &iinfo); 
    }
    else {
        ...
        i__2 = nq - 1;
        magma_tally2_sormqr_m(ngpu, side, trans, mi, ni, i__2, A(1,0), lda, tau,
