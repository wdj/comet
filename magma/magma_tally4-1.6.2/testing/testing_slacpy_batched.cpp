...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_tally4_ssetmatrix( M, N, h_B, lda, d_B, ldda );
            ...
            magma_tally4_setvector( ntile, sizeof(float*), hAarray, 1, dAarray, 1 );
            magma_tally4_setvector( ntile, sizeof(float*), hBarray, 1, dBarray, 1 );
            
            gpu_time = magma_tally4_sync_wtime( 0 );
            magma_tally4blas_slacpy_batched( Magma_tally4UpperLower, mb, nb, dAarray, ldda, dBarray, ldda, ntile, queue );
            ...
            for( int tile = 0; tile < ntile; ++tile ) {
                ...
                lapackf77_slacpy( Magma_tally4UpperLowerStr, &mb, &nb,
                                  &h_A[offset], &lda,
                                  &h_B[offset], &lda );
            }
            ...
            /* =====================================================================
               Check the result
               =================================================================== */
            magma_tally4_sgetmatrix( M, N, d_B, ldda, h_A, lda );
