/*
    -- MAGMA_tally4 (version 1.6.2) --
       ...
       @generated from magma_tally4_z_blaswrapper.cpp normal z -> s, Sun May  3 11:22:57 2015
       @author Hartwig Anzt
    ...
    magma_tally4_queue_t queue )
{
    ...
    magma_tally4_s_matrix x2={Magma_tally4_CSR};
    ...
    if ( A.memory_location == Magma_tally4_DEV ) {
        if ( A.num_cols == x.num_rows && x.num_cols == 1 ) {
             ...
             if ( A.storage_type == Magma_tally4_CSR
                 ...
                 //magma_tally4_sgecsrmv( Magma_tally4NoTrans, A.num_rows, A.num_cols, alpha,
                ...
                cusparseScsrmv( cusparseHandle,CUSPARSE_OPERATION_NON_TRANSPOSE,
                 ...
                 CHECK( magma_tally4_sgeelltmv( Magma_tally4NoTrans, A.num_rows, A.num_cols,
                 ...
                 CHECK( magma_tally4_sgeellmv( Magma_tally4NoTrans, A.num_rows, A.num_cols,
                    A.max_nnz_row, alpha, A.dval, A.dcol, x.dval, beta,
                    y.dval, queue ));
                 //printf("done.\n");
             }
                 ...
                 CHECK( magma_tally4_sgeellrtmv( Magma_tally4NoTrans, A.num_rows, A.num_cols,
                 ...
                 CHECK( magma_tally4_sgesellpmv( Magma_tally4NoTrans, A.num_rows, A.num_cols,
                 ...
                 magma_tally4blas_sgemv( Magma_tally4NoTrans, A.num_rows, A.num_cols, alpha,
                 ...
                 //printf("using DENSE kernel for SpMV: ");
                 CHECK( magma_tally4_scustomspmv( alpha, x, beta, y, queue ));
                 //printf("done.\n");
             }
            ...
            if ( A.storage_type == Magma_tally4_CSR ) {
                ...
                if ( x.major == Magma_tally4RowMajor) {
                 CHECK( magma_tally4_smgesellpmv( Magma_tally4NoTrans, A.num_rows, A.num_cols,
                    num_vecs, A.blocksize, A.numblocks, A.alignment,
                    alpha, A.dval, A.dcol, A.drow, x.dval, beta, y.dval, queue ));
                }
                else if ( x.major == Magma_tally4ColMajor) {
                    // transpose first to row major
                    CHECK( magma_tally4_svtranspose( x, &x2, queue ));
                    CHECK( magma_tally4_smgesellpmv( Magma_tally4NoTrans, A.num_rows, A.num_cols,
                    num_vecs, A.blocksize, A.numblocks, A.alignment,
             ...
             /*if ( A.storage_type == Magma_tally4_DENSE ) {
                 //printf("using DENSE kernel for SpMV: ");
                 magma_tally4blas_smgemv( Magma_tally4NoTrans, A.num_rows, A.num_cols,
    ...
    magma_tally4_queue_t queue )
{
    ...
    if ( A.memory_location == Magma_tally4_DEV ) {
         if ( A.storage_type == Magma_tally4_CSR ) {
             //printf("using CSR kernel for SpMV: ");
             CHECK( magma_tally4_sgecsrmv_shift( Magma_tally4NoTrans, A.num_rows, A.num_cols,
             ...
             //printf("using ELLPACKT kernel for SpMV: ");
             CHECK( magma_tally4_sgeellmv_shift( Magma_tally4NoTrans, A.num_rows, A.num_cols,
             ...
             //printf("using ELL kernel for SpMV: ");
             CHECK( magma_tally4_sgeelltmv_shift( Magma_tally4NoTrans, A.num_rows, A.num_cols,
                A.max_nnz_row, alpha, lambda, A.dval, A.dcol, x.dval, beta, offset,
                blocksize, add_rows, y.dval, queue ));
             //printf("done.\n");
         }
    ...
    if ( A.memory_location == Magma_tally4_DEV ) {
        if ( A.num_cols == B.num_rows ) {
             ...
             if ( A.storage_type == Magma_tally4_CSR
                ...
                CHECK( magma_tally4_scuspmm( A, B, C, queue ));
