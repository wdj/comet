...
void magma_tally3_strdtype1cbHLsym_withQ(
...
void magma_tally3_strdtype2cbHLsym_withQ(
    magma_tally3_int_t N, magma_tally3_int_t NB,
    float *A, magma_tally3_int_t LDA,
    float *V, float *TAU,
    magma_tally3_int_t st, magma_tally3_int_t ed, magma_tally3_int_t sweep, magma_tally3_int_t Vblksiz);
   
void magma_tally3_strdtype3cbHLsym_withQ(
    magma_tally3_int_t N, magma_tally3_int_t NB,
    float *A, magma_tally3_int_t LDA,
    float *V, float *TAU,
    magma_tally3_int_t st, magma_tally3_int_t ed, magma_tally3_int_t sweep, magma_tally3_int_t Vblksiz);

void magma_tally3_slarfxsym(
    ...
    float *V, float *TAU)
{
    ...
    float dtmp;
    float Z_ZERO =  MAGMA_tally3_S_ZERO;
    //float Z_ONE  =  MAGMA_tally3_S_ONE;
    float Z_MONE =  MAGMA_tally3_S_NEG_ONE;
    float Z_HALF =  MAGMA_tally3_S_HALF;
    //float WORK[N];
    float *WORK;
    magma_tally3_smalloc_cpu( &WORK, N );
    
    /* apply left and right on A(st:ed,st:ed)*/
    //magma_tally3_slarfxsym(len,A(st,st),LDX,V(st),TAU(st));
    /* X = AVtau */
    blasf77_ssymv("L",&N, TAU, A, &LDA, V, &IONE, &Z_ZERO, WORK, &IONE);
    /* je calcul dtmp= X'*V */
    dtmp = magma_tally3_cblas_sdot(N, WORK, IONE, V, IONE);
...
#define TAU(m)   &(TAU[(m)])
extern "C" void
magma_tally3_strdtype1cbHLsym_withQ(
    magma_tally3_int_t N, magma_tally3_int_t NB,
    float *A, magma_tally3_int_t LDA,
    float *V, float *TAU,
    magma_tally3_int_t st, magma_tally3_int_t ed, magma_tally3_int_t sweep, magma_tally3_int_t Vblksiz)
{
    ...
    *V(vpos)  = Z_ONE;
    ...
    /* apply left and right on A(st:ed,st:ed)*/
    magma_tally3_slarfxsym(len,A(st,st),LDX,V(vpos),TAU(taupos));
    //conjtmp = MAGMA_tally3_S_CNJG(*TAU(taupos));
    //lapackf77_slarfy("L", &len, V(vpos), &IONE, &conjtmp, A(st,st), &LDX, WORK); //&(MAGMA_tally3_S_CNJG(*TAU(taupos)))
    magma_tally3_free_cpu(WORK);
}
#undef A
#undef V
...
#define TAU(m)   &(TAU[(m)])
extern "C" void
magma_tally3_strdtype2cbHLsym_withQ(
    magma_tally3_int_t N, magma_tally3_int_t NB,
    float *A, magma_tally3_int_t LDA,
    float *V, float *TAU,
    magma_tally3_int_t st, magma_tally3_int_t ed, magma_tally3_int_t sweep, magma_tally3_int_t Vblksiz)
{
    ...
    //float WORK[NB];
    float *WORK;
    magma_tally3_smalloc_cpu( &WORK, NB );
...
#define TAU(m)   &(TAU[(m)])
extern "C" void
magma_tally3_strdtype3cbHLsym_withQ(
    magma_tally3_int_t N, magma_tally3_int_t NB,
    float *A, magma_tally3_int_t LDA,
    float *V, float *TAU,
    magma_tally3_int_t st, magma_tally3_int_t ed, magma_tally3_int_t sweep, magma_tally3_int_t Vblksiz)
{
    ...
    magma_tally3_slarfxsym(len,A(st,st),LDX,V(vpos),TAU(taupos));
    //conjtmp = MAGMA_tally3_S_CNJG(*TAU(taupos));
    //lapackf77_slarfy("L", &len, V(vpos), &IONE,  &(MAGMA_tally3_S_CNJG(*TAU(taupos))), A(st,st), &LDX, WORK);
    magma_tally3_free_cpu(WORK);
}
#undef A
#undef V
