...
!
      ...
      magma_tally3_devptr_t                :: devptrA, devptrB
...
!---- Call magma_tally3 LU ----------------
      call magma_tally3_wtime_f(tstart)
      call magma_tally3f_dgetrf_gpu(n, n, devptrA, ldda, ipiv, info)
      call magma_tally3_wtime_f(tend)

      if ( info .ne. 0 )  then
         write(*,*) "Info : ", info
      end if

!---- Call magma_tally3 solve -------------
      call magma_tally3f_dgetrs_gpu('n', n, nrhs, devptrA, ldda, ipiv, devptrB, ldda, info)
