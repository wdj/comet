                  ...
                  magma_tally2_int_t batchCount, magma_tally2_queue_t queue)
{
   ...
   /* check allocation */
    ...
    if (notran) {
        magma_tally2_claswp_rowserial_batched(nrhs, dB_array, lddb, 1, n, dipiv_array, batchCount, queue);
        ...
        // solve 
        magma_tally2blas_ctrsm_outofplace_batched(Magma_tally2Left, Magma_tally2Upper, trans, Magma_tally2Unit, 1,
                n, nrhs,
                MAGMA_tally2_C_ONE,
                dA_array,       ldda, // dA
                dB_array,      lddb, // dB
        ...
        // solve 
        magma_tally2blas_ctrsm_outofplace_batched(Magma_tally2Left, Magma_tally2Lower, trans, Magma_tally2NonUnit, 1,
                n, nrhs,
                MAGMA_tally2_C_ONE,
                dA_array,       ldda, // dA
                dwork_array,        n, // dB 
