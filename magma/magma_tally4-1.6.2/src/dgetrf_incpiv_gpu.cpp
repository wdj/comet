...
#define dL2(j)  (dL2 + (j)*ib*lddl         )
    ...
    *info = 0;
    ...
    if ( ib >= mindim ) {
        ...
        magma_tally4_dsetmatrix( mindim, mindim, hL2, ldhl, dL2, lddl );
#endif
        ...
        for( i=0; i < s; i++ ) {
            ...
            if ( i > 0 ) {
                // download i-th panel
                magma_tally4blas_dtranspose( sb, m, AT(0,i), ldda, dwork, maxm );
                magma_tally4_dgetmatrix( m, sb, dwork, maxm, hA(0, i), ldha );
            ...
            magma_tally4blas_dlaswp( n-ii, AT(0, i), ldda, ii+1, ii+sb, ipiv, 1 );
            ...
            magma_tally4_dsetmatrix( sb, sb, hL2(i), ldhl, dL2(i), lddl );
#endif
            // upload i-th panel
            magma_tally4_dsetmatrix( rows, sb, hA(i, i), ldha, dwork, cols );
            magma_tally4blas_dtranspose( rows, sb, dwork, cols, AT(i,i), ldda );
