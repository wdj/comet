    ...
    magma_tally4_queue_t queue)
{
    ...
    cudaMemset( d_dinvA, 0, ((n+NB-1)/NB)*NB*NB * sizeof(magma_tally4DoubleComplex) );
...
/**
    @see magma_tally4blas_ztrtri_diag_q
    @ingroup magma_tally4_zblas3
    ********************************************************************/
extern "C" void
magma_tally4blas_ztrtri_diag(
    ...
    magma_tally4DoubleComplex_ptr d_dinvA)
{
    magma_tally4blas_ztrtri_diag_q( uplo, diag, n, dA, ldda, d_dinvA, magma_tally4_stream );
}
