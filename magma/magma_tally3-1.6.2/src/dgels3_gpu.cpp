/*
    -- MAGMA_tally3 (version 1.6.1) --
       ...
       @generated from zgels3_gpu.cpp normal z -> d, Fri Jan 30 19:00:14 2015
    ...
    magma_tally3_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_tally3_SUCCESS != magma_tally3_dmalloc( &dT, ldtwork )) {
        *info = MAGMA_tally3_ERR_DEVICE_ALLOC;
        return *info;
    }
    
    magma_tally3_dmalloc_cpu( &tau, k );
    if ( tau == NULL ) {
    ...
    magma_tally3_dgeqrf3_gpu( m, n, dA, ldda, tau, dT, info );
    if ( *info == 0 ) {
        magma_tally3_dgeqrs3_gpu( m, n, nrhs,
                           dA, ldda, tau, dT,
