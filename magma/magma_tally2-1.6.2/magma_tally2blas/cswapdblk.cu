...
cswapdblk_kernel( int nb,
                  magma_tally2FloatComplex *dA, int ldda, int inca,
                  magma_tally2FloatComplex *dB, int lddb, int incb )
{
...
/**
    @see magma_tally2blas_cswapdblk_q
    @ingroup magma_tally2_caux2
    ********************************************************************/
extern "C" void 
magma_tally2blas_cswapdblk(
    ...
    magma_tally2FloatComplex_ptr dB, magma_tally2_int_t lddb, magma_tally2_int_t incb )
{
    magma_tally2blas_cswapdblk_q( n, nb, dA, ldda, inca, dB, lddb, incb, magma_tally2_stream );
}
