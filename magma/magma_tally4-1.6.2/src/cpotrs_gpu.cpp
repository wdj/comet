    ...
    magma_tally4_int_t *info)
{
    ...
    *info = 0;
    ...
    if ( uplo == Magma_tally4Upper ) {
        if ( nrhs == 1) {
            magma_tally4_ctrsv(Magma_tally4Upper, Magma_tally4ConjTrans, Magma_tally4NonUnit, n, dA, ldda, dB, 1 );
            magma_tally4_ctrsv(Magma_tally4Upper, Magma_tally4NoTrans,   Magma_tally4NonUnit, n, dA, ldda, dB, 1 );
        } else {
            magma_tally4_ctrsm(Magma_tally4Left, Magma_tally4Upper, Magma_tally4ConjTrans, Magma_tally4NonUnit, n, nrhs, c_one, dA, ldda, dB, lddb);
        ...
        if ( nrhs == 1) {
            magma_tally4_ctrsv(Magma_tally4Lower, Magma_tally4NoTrans,   Magma_tally4NonUnit, n, dA, ldda, dB, 1 );
            magma_tally4_ctrsv(Magma_tally4Lower, Magma_tally4ConjTrans, Magma_tally4NonUnit, n, dA, ldda, dB, 1 );
        } else {
            magma_tally4_ctrsm(Magma_tally4Left, Magma_tally4Lower, Magma_tally4NoTrans,   Magma_tally4NonUnit, n, nrhs, c_one, dA, ldda, dB, lddb);
            magma_tally4_ctrsm(Magma_tally4Left, Magma_tally4Lower, Magma_tally4ConjTrans, Magma_tally4NonUnit, n, nrhs, c_one, dA, ldda, dB, lddb);
        }
    }
