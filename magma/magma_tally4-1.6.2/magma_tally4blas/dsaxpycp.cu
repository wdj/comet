    ...
    const double *b, double *w )
{
    ...
    if ( i < m ) {
        x[i] = MAGMA_tally4_D_ADD( x[i], (double)( r[i] ) );
        w[i] = b[i];
    }
}
...
magma_tally4blas_dsaxpycp(
    ...
    magma_tally4Double_ptr w)
{
    magma_tally4blas_dsaxpycp_q( m, r, x, b, w, magma_tally4_stream );
}
...
magma_tally4blas_daxpycp(
    ...
    magma_tally4Double_const_ptr b)
{
    magma_tally4blas_daxpycp_q( m, r, x, b, magma_tally4_stream );
}
